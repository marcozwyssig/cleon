...
public class Protocol extends DynamicResource implements IProtocol {
  ...
  public boolean isCifs() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.systemconfiguration.hardware.storage.StoragePackage.Protocol_Cifs);
  }
  
  @Override
  public boolean isNfs() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.systemconfiguration.hardware.storage.StoragePackage.Protocol_Nfs);
  }
  
  @Override
  public boolean isSMB() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.systemconfiguration.hardware.storage.StoragePackage.Protocol_SMB);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,21d2d137-8c92-11eb-a9c0-c3b95abf3470,PFjgpwcY16L6D1vJPqitISAZotI=] */
