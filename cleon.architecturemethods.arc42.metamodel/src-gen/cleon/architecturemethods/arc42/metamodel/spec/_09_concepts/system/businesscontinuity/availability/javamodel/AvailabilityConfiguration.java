...
public class AvailabilityConfiguration extends DynamicResource implements IAvailabilityConfiguration {
  ...
  public java.util.List<java.lang.String> selectStandardDescription() {
    return _getListAttribute(java.lang.String.class, cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.businesscontinuity.availability.AvailabilityPackage.AvailabilityConfiguration_standardDescription);
  }
    
  public void setStandardDescription(java.util.List<java.lang.String> standardDescription) {
     _setListAttribute(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.businesscontinuity.availability.AvailabilityPackage.AvailabilityConfiguration_standardDescription, standardDescription);
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptListAttribute(java.lang.String.class, cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.businesscontinuity.availability.AvailabilityPackage.AvailabilityConfiguration_standardDescription, visitor);
    // relations
  ...
  public boolean isNone() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.businesscontinuity.availability.AvailabilityPackage.AvailabilityConfiguration_None);
  }
  
  @Override
  public boolean isActive__S_Active() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.businesscontinuity.availability.AvailabilityPackage.AvailabilityConfiguration_Active__S_Active);
  }
  
  @Override
  public boolean isActive__F___U___F_Active__F_ohne__F_Daten__S_Synchronisation() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.businesscontinuity.availability.AvailabilityPackage.AvailabilityConfiguration_Active__F___U___F_Active__F_ohne__F_Daten__S_Synchronisation);
  }
  
  @Override
  public boolean isActive__S_Passive__F___N_Failover__O_() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.businesscontinuity.availability.AvailabilityPackage.AvailabilityConfiguration_Active__S_Passive__F___N_Failover__O_);
  }
  
  @Override
  public boolean isSicherung__F_und__F_Wiederherstellung() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.businesscontinuity.availability.AvailabilityPackage.AvailabilityConfiguration_Sicherung__F_und__F_Wiederherstellung);
  }
  
  @Override
  public boolean isReplikation() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.businesscontinuity.availability.AvailabilityPackage.AvailabilityConfiguration_Replikation);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,21408953-1e38-11e9-865e-41ef48a95f70,4pVEgJ+vvG2o5JqUW08xZ92asLY=] */
