...
public class DiskType extends DynamicResource implements IDiskType {
  ...
  public <R> R accept(IValueVisitor<R> visitor) {
    ...
    if (isVMDK__F___S___F_EagerZeroThick__F_Provisioning()) return visitor.visitVMDK__F___S___F_EagerZeroThick__F_Provisioning();
  ...
  public void accept(IValueVoidVisitor visitor) {
    ...
    if (isVMDK__F___S___F_EagerZeroThick__F_Provisioning()) {
      visitor.visitVMDK__F___S___F_EagerZeroThick__F_Provisioning();
      return;
    }
    throw new IllegalStateException("unknown enumvalue: " + fResource);
  }
  ...
  public boolean isSDD() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.resources.buildingblock.BuildingblockPackage.DiskType_SDD);
  }
  
  @Override
  public boolean isHDD() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.resources.buildingblock.BuildingblockPackage.DiskType_HDD);
  }
  
  @Override
  public boolean isVMDK__F___S___F_Thin__F_Provisioning() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.resources.buildingblock.BuildingblockPackage.DiskType_VMDK__F___S___F_Thin__F_Provisioning);
  }
  
  @Override
  public boolean isVMDK__F___S___F_Thick__F_Provisioning() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.resources.buildingblock.BuildingblockPackage.DiskType_VMDK__F___S___F_Thick__F_Provisioning);
  }
  
  @Override
  public boolean isVMDK__F___S___F_EagerZeroThick__F_Provisioning() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.resources.buildingblock.BuildingblockPackage.DiskType_VMDK__F___S___F_EagerZeroThick__F_Provisioning);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,00c36073-2b6b-11e9-90eb-451204ee9d3c,2oCOU3TsR4TJjT93PljN1c1oExc=] */
