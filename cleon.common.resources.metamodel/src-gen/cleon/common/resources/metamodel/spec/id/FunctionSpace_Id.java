package cleon.common.resources.metamodel.spec.id;
...
public class FunctionSpace_Id {
  ...
  public static interface IIntegerBusinessObjectIdFunctions extends IDynamicResourceExtension {
    ...
    public <T extends cleon.common.resources.metamodel.spec.id.javamodel.IIntegerBusinessObjectId> List<T> sortById();
  ...
  public static interface IIntegerBusinessObjectIdFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("fdcf13c6-ea50-11e8-9dfb-85981d867b8c")
    public <T extends cleon.common.resources.metamodel.spec.id.javamodel.IIntegerBusinessObjectId> List<T> sortById(final List<T> integerBusinessObjectIdList);
  ...
  public static class IntegerBusinessObjectIdFunctions {
    ...
    public static <T extends cleon.common.resources.metamodel.spec.id.javamodel.IIntegerBusinessObjectId> List<T> sortById(final List<T> integerBusinessObjectIdList) {
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,b13eb1c7-a551-11e8-8163-815a23011093,29E+wRKIYfRX6k41Ep4N8W3DSuk=] */
