...
public class Observation extends DynamicResource implements IObservation {
  ...
  public boolean isA__F___N_reproduzierbar__O_() {
    return getResource().equals(cleon.projectmethods.hermes.metamodel.spec.modules.projectmanagement.planning.scope.workpackage.backlog.defect.DefectPackage.Observation_A__F___N_reproduzierbar__O_);
  }
  
  @Override
  public boolean isB__F___N_wiederholtes__F_Auftreten__O_() {
    return getResource().equals(cleon.projectmethods.hermes.metamodel.spec.modules.projectmanagement.planning.scope.workpackage.backlog.defect.DefectPackage.Observation_B__F___N_wiederholtes__F_Auftreten__O_);
  }
  
  @Override
  public boolean isC__F___N_seltenes__F_Auftreten__O_() {
    return getResource().equals(cleon.projectmethods.hermes.metamodel.spec.modules.projectmanagement.planning.scope.workpackage.backlog.defect.DefectPackage.Observation_C__F___N_seltenes__F_Auftreten__O_);
  }
