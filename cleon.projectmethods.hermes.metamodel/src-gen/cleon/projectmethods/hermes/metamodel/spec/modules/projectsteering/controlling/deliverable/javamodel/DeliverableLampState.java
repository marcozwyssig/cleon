...
public class DeliverableLampState extends DynamicResource implements IDeliverableLampState {
  ...
  public boolean isRed() {
    return getResource().equals(cleon.projectmethods.hermes.metamodel.spec.modules.projectsteering.controlling.deliverable.DeliverablePackage.DeliverableLampState_Red);
  }
  
  @Override
  public boolean isYellow() {
    return getResource().equals(cleon.projectmethods.hermes.metamodel.spec.modules.projectsteering.controlling.deliverable.DeliverablePackage.DeliverableLampState_Yellow);
  }
  
  @Override
  public boolean isGreen() {
    return getResource().equals(cleon.projectmethods.hermes.metamodel.spec.modules.projectsteering.controlling.deliverable.DeliverablePackage.DeliverableLampState_Green);
  }
