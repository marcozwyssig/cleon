...
==== Applications <Category> (Blackbox)
In diesem Kapitel werden die Blackbox Eigenschaften des Bausteins Applications beschrieben.
...
==== Architecture Methods <Category> (Blackbox)
In diesem Kapitel werden die Blackbox Eigenschaften des Bausteins Architecture Methods beschrieben.
...
==== Architecture Styles and Patterns <Category> (Blackbox)
In diesem Kapitel werden die Blackbox Eigenschaften des Bausteins Architecture Styles and Patterns beschrieben.
...
==== Building <Category> (Blackbox)
In diesem Kapitel werden die Blackbox Eigenschaften des Bausteins Building beschrieben.
...
==== Common <Category> (Blackbox)
In diesem Kapitel werden die Blackbox Eigenschaften des Bausteins Common beschrieben.
...
==== DevOps <Category> (Blackbox)
In diesem Kapitel werden die Blackbox Eigenschaften des Bausteins DevOps beschrieben.
...
==== Modeling Languages <Category> (Blackbox)
In diesem Kapitel werden die Blackbox Eigenschaften des Bausteins Modeling Languages beschrieben.
...
==== Project Methods <Category> (Blackbox)
In diesem Kapitel werden die Blackbox Eigenschaften des Bausteins Project Methods beschrieben.
...
==== Publishing <Category> (Blackbox)
In diesem Kapitel werden die Blackbox Eigenschaften des Bausteins Publishing beschrieben.
...
==== Testing Methods <Category> (Blackbox)
In diesem Kapitel werden die Blackbox Eigenschaften des Bausteins Testing Methods beschrieben.
...
// Actifsource ID=[803ac313-d64b-11ee-8014-c150876d6b6e,9affc401-285e-11e8-9af4-b7d7a3bbddc1,dd7ae0a5-3339-11e8-a9fe-87ba35d8f5c4,9affc401-285e-11e8-9af4-b7d7a3bbddc1,JISPnW2TEYrMFInr51wFtoJ5PRg=]
