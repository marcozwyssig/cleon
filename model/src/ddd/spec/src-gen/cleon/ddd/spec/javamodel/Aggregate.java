...
public class Aggregate extends DynamicResource implements IAggregate {
  ...
  public Aggregate setDecomposeClasses(java.util.List<? extends cleon.uml.spec.structural.packages.javamodel.IClassifierDecomposition> decomposeClasses) {
  ...
  public Aggregate setDocuments(java.util.List<? extends cleon.doc.spec.document.javamodel.IDocument> documents) {
  ...
  public Aggregate setUseDocumentElements(java.util.List<? extends cleon.doc.spec.javamodel.IDocumentElement> useDocumentElements) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,83c13817-10c0-11e3-b60e-ab478a3e1eca,1XblGBN5vxEkvNHnBsJAUatZz2w=] */
