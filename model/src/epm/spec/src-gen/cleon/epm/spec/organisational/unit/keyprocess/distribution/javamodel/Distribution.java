...
public class Distribution extends DynamicResource implements IDistribution {
  ...
  public Distribution setResponsible(cleon.epm.spec.organisational.role.javamodel.ILeader responsible) {
  ...
  public Distribution setStaff(java.util.List<? extends cleon.epm.spec.organisational.role.javamodel.IStaff> staff) {
  ...
  public Distribution setSubOrganisations(java.util.List<? extends cleon.epm.spec.organisational.unit.javamodel.IOrganisationUnit> subOrganisations) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,7546c5a9-daa8-11e3-ae07-89aa80d5ec3d,bl6DM1uqhkl+oNKsTIcYAJVhDls=] */
