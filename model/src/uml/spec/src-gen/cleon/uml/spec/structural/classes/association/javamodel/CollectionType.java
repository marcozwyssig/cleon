...
public class CollectionType extends DynamicResource implements ICollectionType {
  ...
  public boolean isEnumerable() {
    return getResource().equals(cleon.uml.spec.structural.classes.association.AssociationPackage.CollectionType_Enumerable);
  }
  
  @Override
  public boolean isObservableCollection() {
    return getResource().equals(cleon.uml.spec.structural.classes.association.AssociationPackage.CollectionType_ObservableCollection);
  }
  
  @Override
  public boolean isObservableCollectionWithView() {
    return getResource().equals(cleon.uml.spec.structural.classes.association.AssociationPackage.CollectionType_ObservableCollectionWithView);
  }
  
  @Override
  public boolean isList() {
    return getResource().equals(cleon.uml.spec.structural.classes.association.AssociationPackage.CollectionType_List);
  }
  
  @Override
  public boolean isReadOnlyList() {
    return getResource().equals(cleon.uml.spec.structural.classes.association.AssociationPackage.CollectionType_ReadOnlyList);
  }
  
  @Override
  public boolean isCollection() {
    return getResource().equals(cleon.uml.spec.structural.classes.association.AssociationPackage.CollectionType_Collection);
  }
  
  @Override
  public boolean isReadOnlyObservableCollection() {
    return getResource().equals(cleon.uml.spec.structural.classes.association.AssociationPackage.CollectionType_ReadOnlyObservableCollection);
  }
  
  @Override
  public boolean isReadOnlyCollection() {
    return getResource().equals(cleon.uml.spec.structural.classes.association.AssociationPackage.CollectionType_ReadOnlyCollection);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,261182b1-13ca-11e3-bec7-f1e135382475,XF3/VfGkzSZwwaw2Y90aRPny0oQ=] */
