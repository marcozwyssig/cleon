...
public class Component extends DynamicResource implements IComponent {
  ...
  public Component setDocuments(java.util.List<? extends cleon.doc.spec.document.javamodel.IDocument> documents) {
  ...
  public Component setPackages(java.util.List<? extends cleon.uml.spec.structural.packages.javamodel.IPackageDecomposition> packages) {
  ...
  public Component setUseDocumentElements(java.util.List<? extends cleon.doc.spec.javamodel.IDocumentElement> useDocumentElements) {
  ...
  public static cleon.uml.spec.structural.components.javamodel.IComponent selectToMePackages(cleon.uml.spec.structural.packages.javamodel.IPackageDecomposition object) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,2adc4d98-85c1-11e3-be33-79789cf5eae3,qeScnjULDMT/bl6nF1mpTofSkjI=] */
