package cleon.actifsource.spec._05_buildingblockview.feature.plugin.diagram.javamodel;
...
public class Diagram extends DynamicResource implements IDiagram {
  ...
  public Diagram setChapters(java.util.List<? extends cleon.doc.spec.chapter.javamodel.IChapterOwnDocumentElementComposite> chapters) {
  ...
  public Diagram setDependsOn(java.util.List<? extends cleon.actifsource.spec._05_buildingblockview.feature.plugin.javamodel.IPluginDependency> dependsOn) {
  ...
  public Diagram setExportPackage(java.util.List<? extends cleon.actifsource.spec._05_buildingblockview.feature.plugin.javamodel.IPackage> exportPackage) {
  ...
  public Diagram setResources(java.util.List<? extends cleon.actifsource.spec._05_buildingblockview.feature.plugin.javamodel.IResource> resources) {
  ...
  public Diagram setTargetPaths(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.actifsource.spec._05_buildingblockview.feature.plugin.javamodel.ITargetPath> targetPaths) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,f1d5fec5-3f8d-11e5-9616-473ab9b9a1f3,OfUclihfnPiT0gfO6cE0Gwf5WeE=] */
