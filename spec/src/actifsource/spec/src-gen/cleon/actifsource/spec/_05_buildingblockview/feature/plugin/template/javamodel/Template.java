package cleon.actifsource.spec._05_buildingblockview.feature.plugin.template.javamodel;
...
public class Template extends DynamicResource implements ITemplate {
  ...
  public Template setChapters(java.util.List<? extends cleon.doc.spec.chapter.javamodel.IChapterOwnDocumentElementComposite> chapters) {
  ...
  public Template setDependsOn(java.util.List<? extends cleon.actifsource.spec._05_buildingblockview.feature.plugin.javamodel.IPluginDependency> dependsOn) {
  ...
  public Template setExportPackage(java.util.List<? extends cleon.actifsource.spec._05_buildingblockview.feature.plugin.javamodel.IPackage> exportPackage) {
  ...
  public Template setParagraphes(java.util.List<? extends cleon.doc.spec.paragraph.javamodel.IParagraph> paragraphes) {
  ...
  public Template setResources(java.util.List<? extends cleon.actifsource.spec._05_buildingblockview.feature.plugin.javamodel.IResource> resources) {
  ...
  public Template setTargetPaths(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.actifsource.spec._05_buildingblockview.feature.plugin.javamodel.ITargetPath> targetPaths) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,3e687740-e9ba-11e4-848b-0509e3792151,7QOqxXKvr8sMGvDs5DxbnB55Kyc=] */
