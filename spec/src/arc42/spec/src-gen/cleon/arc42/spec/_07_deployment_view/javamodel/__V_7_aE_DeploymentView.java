...
public class __V_7_aE_DeploymentView extends DynamicResource implements I__V_7_aE_DeploymentView {
  ...
  public __V_7_aE_DeploymentView setChapters(java.util.List<? extends cleon.doc.spec.chapter.javamodel.IChapterOwnDocumentElementComposite> chapters) {
  ...
  public __V_7_aE_DeploymentView setDocuments(java.util.List<? extends cleon.doc.spec.document.javamodel.ISubDocument> documents) {
  ...
  public __V_7_aE_DeploymentView setNoDocuments(cleon.doc.spec.document.javamodel.ISubDocument noDocuments) {
  ...
  public __V_7_aE_DeploymentView setParagraphes(java.util.List<? extends cleon.doc.spec.paragraph.javamodel.IParagraph> paragraphes) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,b47acb73-314c-11e5-bd99-eda9ce254b0b,6Iz7XL4IDIANVBBFYsQt8YdW254=] */
