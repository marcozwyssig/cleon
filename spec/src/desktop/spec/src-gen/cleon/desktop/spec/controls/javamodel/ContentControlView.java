...
public class ContentControlView extends DynamicResource implements IContentControlView {
  ...
  public ContentControlView setChapters(java.util.List<? extends cleon.doc.spec.chapter.javamodel.IChapterOwnDocumentElementComposite> chapters) {
  ...
  public ContentControlView setParagraphes(java.util.List<? extends cleon.doc.spec.paragraph.javamodel.IParagraph> paragraphes) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,5620ce54-92f5-11e3-a63e-fb8038f76aec,1OrWqMJXlZlW8i7SwdNgT+TNrks=] */
