...
public class EnvironmentAwareDeploymentArtefact extends DynamicResource implements IEnvironmentAwareDeploymentArtefact {
  ...
  public EnvironmentAwareDeploymentArtefact setDeploymentArtefacts(IMultiMapOrdered<ch.actifsource.core.Resource, ? extends cleon.devops.spec.release.javamodel.IDeploymentArtefact> deploymentArtefacts) {
    _setMultiMap(cleon.devops.spec.release.ReleasePackage.HasDeploymentArtefact_deploymentArtefacts, deploymentArtefacts);
    return this;
  }
    
  @Override
  public cleon.devops.spec.deploy.javamodel.IEnvironment selectEnvironment() {
    return _getSingle(cleon.devops.spec.deploy.javamodel.IEnvironment.class, cleon.devops.spec.release.ReleasePackage.EnvironmentAwareDeploymentArtefact_environment);
  }

  public EnvironmentAwareDeploymentArtefact setEnvironment(cleon.devops.spec.deploy.javamodel.IEnvironment environment) {
    _setSingle(cleon.devops.spec.release.ReleasePackage.EnvironmentAwareDeploymentArtefact_environment, environment);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(cleon.devops.spec.deploy.javamodel.IEnvironment.class, cleon.devops.spec.release.ReleasePackage.EnvironmentAwareDeploymentArtefact_environment, visitor);
  ...
  public static java.util.List<cleon.devops.spec.release.javamodel.IEnvironmentAwareDeploymentArtefact> selectToMeEnvironment(cleon.devops.spec.deploy.javamodel.IEnvironment object) {
    return _getToMeList(object.getRepository(), cleon.devops.spec.release.javamodel.IEnvironmentAwareDeploymentArtefact.class, cleon.devops.spec.release.ReleasePackage.EnvironmentAwareDeploymentArtefact_environment, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,35611355-4507-11e5-84bb-b76bc2368798,m5LY/giqilKvipsTyfzWShhdgQU=] */
