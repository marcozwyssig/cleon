...
public class Document extends DynamicResource implements IDocument {
  ...
  public Document setAutors(java.util.List<? extends cleon.doc.spec.autor.javamodel.IAutor> autors) {
  ...
  public Document setChapters(java.util.List<? extends cleon.doc.spec.chapter.javamodel.IChapterOwnDocumentElementComposite> chapters) {
  ...
  public Document setDocuments(java.util.List<? extends cleon.doc.spec.document.javamodel.ISubDocument> documents) {
  ...
  public Document setParagraphes(java.util.List<? extends cleon.doc.spec.paragraph.javamodel.IParagraph> paragraphes) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,fd0b0ad8-28bc-11e5-bdaf-69a48f49df43,yWhHTVLmmIirvseyO9EZuSngHso=] */
