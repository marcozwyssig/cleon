...
public class Note extends DynamicResource implements INote {
  ...
  public Note setOwnDocumentElements(java.util.List<? extends cleon.doc.spec.javamodel.IDocumentElement> ownDocumentElements) {
  ...
  public Note setParagraphes(java.util.List<? extends cleon.doc.spec.paragraph.javamodel.IParagraph> paragraphes) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,3ec11f20-3087-11e5-8cdc-d5b441c8c3df,ee3z92fV9TAQJsNctccWuju4mp8=] */
