...
public class TestMethod extends DynamicResource implements ITestMethod {
  ...
  public java.lang.Boolean selectIsAsync() {
    return _getSingleAttribute(java.lang.Boolean.class, cleon.qa.spec.unitests.UnitestsPackage.TestMethod_isAsync);
  }
    
  public void setIsAsync(java.lang.Boolean isAsync) {
     _setSingleAttribute(cleon.qa.spec.unitests.UnitestsPackage.TestMethod_isAsync, isAsync);
  }
  ...
  public cleon.uml.spec.structural.classes.method.javamodel.IMethod selectWhen() {
    return _getSingle(cleon.uml.spec.structural.classes.method.javamodel.IMethod.class, cleon.qa.spec.unitests.UnitestsPackage.TestMethod_when);
  }

  public TestMethod setWhen(cleon.uml.spec.structural.classes.method.javamodel.IMethod when) {
    _setSingle(cleon.qa.spec.unitests.UnitestsPackage.TestMethod_when, when);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(cleon.uml.spec.structural.classes.method.javamodel.IMethod.class, cleon.qa.spec.unitests.UnitestsPackage.TestMethod_when, visitor);
  }

  // toMeRelations
  
  public static java.util.List<cleon.qa.spec.unitests.javamodel.ITestMethod> selectToMeWhen(cleon.uml.spec.structural.classes.method.javamodel.IMethod object) {
    return _getToMeList(object.getRepository(), cleon.qa.spec.unitests.javamodel.ITestMethod.class, cleon.qa.spec.unitests.UnitestsPackage.TestMethod_when, object.getResource());
  }
