...
public class Evaluations extends DynamicResource implements IEvaluations {
  ...
  public Evaluations setChapters(java.util.List<? extends cleon.doc.spec.chapter.javamodel.IChapterOwnDocumentElementComposite> chapters) {
  ...
  public java.util.Map<ch.actifsource.core.Resource, ? extends cleon.sda.spec.analysis.solution.evaluation.javamodel.ISolutionsEvaluation> selectEvaluations() {
    return _getMap(cleon.sda.spec.analysis.solution.evaluation.javamodel.ISolutionsEvaluation.class, cleon.sda.spec.analysis.solution.evaluation.EvaluationPackage.Evaluations_evaluations);
  }

  public Evaluations setEvaluations(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.sda.spec.analysis.solution.evaluation.javamodel.ISolutionsEvaluation> evaluations) {
    _setMap(cleon.sda.spec.analysis.solution.evaluation.EvaluationPackage.Evaluations_evaluations, evaluations);
    return this;
  }
  ...
  public cleon.sda.spec.analysis.solution.evaluation.javamodel.IResult selectResult() {
    return _getSingle(cleon.sda.spec.analysis.solution.evaluation.javamodel.IResult.class, cleon.sda.spec.analysis.solution.evaluation.EvaluationPackage.Evaluations_result);
  }

  public Evaluations setResult(cleon.sda.spec.analysis.solution.evaluation.javamodel.IResult result) {
    _setSingle(cleon.sda.spec.analysis.solution.evaluation.EvaluationPackage.Evaluations_result, result);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptMap(cleon.sda.spec.analysis.solution.evaluation.javamodel.ISolutionsEvaluation.class, cleon.sda.spec.analysis.solution.evaluation.EvaluationPackage.Evaluations_evaluations, visitor);
    ...
    _acceptSingle(cleon.sda.spec.analysis.solution.evaluation.javamodel.IResult.class, cleon.sda.spec.analysis.solution.evaluation.EvaluationPackage.Evaluations_result, visitor);
  ...
  public static cleon.sda.spec.analysis.solution.evaluation.javamodel.IEvaluations selectToMeEvaluations(cleon.sda.spec.analysis.solution.evaluation.javamodel.ISolutionsEvaluation object) {
    return _getToMeSingle(object.getRepository(), cleon.sda.spec.analysis.solution.evaluation.javamodel.IEvaluations.class, cleon.sda.spec.analysis.solution.evaluation.EvaluationPackage.Evaluations_evaluations, object.getResource());
  }
  
  public static cleon.sda.spec.analysis.solution.evaluation.javamodel.IEvaluations selectToMeResult(cleon.sda.spec.analysis.solution.evaluation.javamodel.IResult object) {
    return _getToMeSingle(object.getRepository(), cleon.sda.spec.analysis.solution.evaluation.javamodel.IEvaluations.class, cleon.sda.spec.analysis.solution.evaluation.EvaluationPackage.Evaluations_result, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,dcdfa04f-3c19-11e5-9962-cf3035adb922,Hp4eLQzlrppDZfoxJZmWlpcmvng=] */
