...
public class WorkState extends DynamicResource implements IWorkState {
  ...
  public boolean isOpen() {
    return getResource().equals(cleon.sda.spec.SpecPackage.WorkState_Open);
  }
  
  @Override
  public boolean isIn__F_Progress() {
    return getResource().equals(cleon.sda.spec.SpecPackage.WorkState_In__F_Progress);
  }
  
  @Override
  public boolean isDone() {
    return getResource().equals(cleon.sda.spec.SpecPackage.WorkState_Done);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,8f138d00-c58a-11e5-aeea-1db9268c0ee9,A2ztP3ALb7FWTOy5rAxAgzWtmlo=] */
