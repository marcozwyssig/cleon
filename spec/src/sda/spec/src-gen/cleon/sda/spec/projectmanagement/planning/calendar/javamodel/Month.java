...
public class Month extends DynamicResource implements IMonth {
  ...
  public java.util.List<? extends cleon.sda.spec.projectmanagement.planning.calendar.javamodel.IDay> selectDays() {
    return _getList(cleon.sda.spec.projectmanagement.planning.calendar.javamodel.IDay.class, cleon.sda.spec.projectmanagement.planning.calendar.CalendarPackage.Month_days);
  }

  public Month setDays(java.util.List<? extends cleon.sda.spec.projectmanagement.planning.calendar.javamodel.IDay> days) {
    _setList(cleon.sda.spec.projectmanagement.planning.calendar.CalendarPackage.Month_days, days);
    return this;
  }
  ...
  public Month setSubCalendarItems(java.util.List<? extends cleon.sda.spec.projectmanagement.planning.calendar.javamodel.ICalendarItem> subCalendarItems) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    // relations
    _acceptList(cleon.sda.spec.projectmanagement.planning.calendar.javamodel.IDay.class, cleon.sda.spec.projectmanagement.planning.calendar.CalendarPackage.Month_days, visitor);
  ...
  public static cleon.sda.spec.projectmanagement.planning.calendar.javamodel.IMonth selectToMeDays(cleon.sda.spec.projectmanagement.planning.calendar.javamodel.IDay object) {
    return _getToMeSingle(object.getRepository(), cleon.sda.spec.projectmanagement.planning.calendar.javamodel.IMonth.class, cleon.sda.spec.projectmanagement.planning.calendar.CalendarPackage.Month_days, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,59aa44e4-c37c-11e5-9455-d97b1b986284,gtudjKuomtLIGI81TbRnTLG2Bp8=] */
