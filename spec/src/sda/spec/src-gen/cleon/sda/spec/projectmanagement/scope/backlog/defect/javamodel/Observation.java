...
public class Observation extends DynamicResource implements IObservation {
  ...
  public boolean isA__F___N_reproduzierbar__O_() {
    return getResource().equals(cleon.sda.spec.projectmanagement.scope.backlog.defect.DefectPackage.Observation_A__F___N_reproduzierbar__O_);
  }
  
  @Override
  public boolean isB__F___N_wiederholtes__F_Auftreten__O_() {
    return getResource().equals(cleon.sda.spec.projectmanagement.scope.backlog.defect.DefectPackage.Observation_B__F___N_wiederholtes__F_Auftreten__O_);
  }
  
  @Override
  public boolean isC__F___N_seltenes__F_Auftreten__O_() {
    return getResource().equals(cleon.sda.spec.projectmanagement.scope.backlog.defect.DefectPackage.Observation_C__F___N_seltenes__F_Auftreten__O_);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,a6933d32-3765-11e5-95d9-2b04d7ab02d9,4Frd/9nU/BGebkxYmggnfttDqcI=] */
