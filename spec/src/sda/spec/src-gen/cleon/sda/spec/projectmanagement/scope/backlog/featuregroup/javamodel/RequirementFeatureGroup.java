...
public class RequirementFeatureGroup extends DynamicResource implements IRequirementFeatureGroup {
  ...
  public RequirementFeatureGroup setChapters(java.util.List<? extends cleon.doc.spec.chapter.javamodel.IChapter> chapters) {
  ...
  public RequirementFeatureGroup setDocuments(java.util.List<? extends cleon.doc.spec.document.javamodel.ISubDocument> documents) {
  ...
  public RequirementFeatureGroup setNoDocuments(cleon.doc.spec.document.javamodel.ISubDocument noDocuments) {
  ...
  public RequirementFeatureGroup setUseDocumentElements(java.util.List<? extends cleon.doc.spec.javamodel.IDocumentElement> useDocumentElements) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,27c5167e-375a-11e5-95d9-2b04d7ab02d9,I5nLFGfncWMJ+Ld22dz/p9/icNw=] */
