...
public class Effort extends DynamicResource implements IEffort {
  ...
  public boolean is__V_() {
    return getResource().equals(cleon.sda.spec.projectmanagement.scope.backlog.BacklogPackage.Effort___V_);
  }
  
  @Override
  public boolean is__V___T_5() {
    return getResource().equals(cleon.sda.spec.projectmanagement.scope.backlog.BacklogPackage.Effort___V___T_5);
  }
  
  @Override
  public boolean is__W_() {
    return getResource().equals(cleon.sda.spec.projectmanagement.scope.backlog.BacklogPackage.Effort___W_);
  }
  
  @Override
  public boolean is__X_() {
    return getResource().equals(cleon.sda.spec.projectmanagement.scope.backlog.BacklogPackage.Effort___X_);
  }
  
  @Override
  public boolean is__Y_() {
    return getResource().equals(cleon.sda.spec.projectmanagement.scope.backlog.BacklogPackage.Effort___Y_);
  }
  
  @Override
  public boolean is__0_() {
    return getResource().equals(cleon.sda.spec.projectmanagement.scope.backlog.BacklogPackage.Effort___0_);
  }
  
  @Override
  public boolean is__3_() {
    return getResource().equals(cleon.sda.spec.projectmanagement.scope.backlog.BacklogPackage.Effort___3_);
  }
  
  @Override
  public boolean is__W_3() {
    return getResource().equals(cleon.sda.spec.projectmanagement.scope.backlog.BacklogPackage.Effort___W_3);
  }
  
  @Override
  public boolean is__X_0() {
    return getResource().equals(cleon.sda.spec.projectmanagement.scope.backlog.BacklogPackage.Effort___X_0);
  }
  
  @Override
  public boolean is__Z_0() {
    return getResource().equals(cleon.sda.spec.projectmanagement.scope.backlog.BacklogPackage.Effort___Z_0);
  }
  
  @Override
  public boolean is__W_00() {
    return getResource().equals(cleon.sda.spec.projectmanagement.scope.backlog.BacklogPackage.Effort___W_00);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,604db26f-c4d9-11e5-b41d-5d67443850a2,cJDjo0P/mA8YzGeZQYaJFcHvklw=] */
