...
public class Priority extends DynamicResource implements IPriority {
  ...
  public java.lang.Integer selectNumber() {
    return _getSingleAttribute(java.lang.Integer.class, cleon.sda.spec.projectmanagement.scope.backlog.BacklogPackage.Priority_number);
  }
    
  public void setNumber(java.lang.Integer number) {
     _setSingleAttribute(cleon.sda.spec.projectmanagement.scope.backlog.BacklogPackage.Priority_number, number);
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingleAttribute(java.lang.Integer.class, cleon.sda.spec.projectmanagement.scope.backlog.BacklogPackage.Priority_number, visitor);
    // relations
  ...
  public <R> R accept(IValueVisitor<R> visitor) {
    ...
    if (isCould__F_have()) return visitor.visitCould__F_have();
  ...
  public boolean isMust__F_have() {
    return getResource().equals(cleon.sda.spec.projectmanagement.scope.backlog.BacklogPackage.Priority_Must__F_have);
  }
  
  @Override
  public boolean isShould__F_have() {
    return getResource().equals(cleon.sda.spec.projectmanagement.scope.backlog.BacklogPackage.Priority_Should__F_have);
  }
  
  @Override
  public boolean isCould__F_have() {
    return getResource().equals(cleon.sda.spec.projectmanagement.scope.backlog.BacklogPackage.Priority_Could__F_have);
  }
  
  @Override
  public boolean isWon__M_t__F_have() {
    return getResource().equals(cleon.sda.spec.projectmanagement.scope.backlog.BacklogPackage.Priority_Won__M_t__F_have);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,43a964fa-c4f3-11e5-b41d-5d67443850a2,xdNVi5/SG+q9GGNN9ORB/TWBzVU=] */
