...
public class Activity extends DynamicResource implements IActivity {
  ...
  public Activity setChapters(java.util.List<? extends cleon.doc.spec.chapter.javamodel.IChapterOwnDocumentElementComposite> chapters) {
  ...
  public Activity setEstimate(cleon.sda.spec.projectmanagement.scope.backlog.javamodel.IEffort estimate) {
  ...
  public Activity setNoChapters(cleon.doc.spec.chapter.javamodel.IChapter noChapters) {
  ...
  public Activity setNoParagraph(cleon.doc.spec.paragraph.javamodel.IParagraph noParagraph) {
  ...
  public Activity setOwnDocumentElements(java.util.List<? extends cleon.doc.spec.javamodel.IDocumentElement> ownDocumentElements) {
  ...
  public Activity setOwner(java.util.List<? extends cleon.sda.spec.projectmanagement.resourcemanagement.persons.javamodel.IPerson> owner) {
  ...
  public Activity setParagraphes(java.util.List<? extends cleon.doc.spec.paragraph.javamodel.IParagraph> paragraphes) {
  ...
  public Activity setPreconditions(java.util.List<? extends cleon.sda.spec.projectmanagement.scope.backlog.javamodel.IWorkItem> preconditions) {
  ...
  public Activity setRequestedBy(cleon.sda.spec.projectmanagement.resourcemanagement.persons.javamodel.IPerson requestedBy) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,e19c230e-3777-11e5-95d9-2b04d7ab02d9,d84soW1vpkdYR51URkG4jURvP+4=] */
