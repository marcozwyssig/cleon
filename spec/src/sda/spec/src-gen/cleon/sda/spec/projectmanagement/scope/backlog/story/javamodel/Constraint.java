...
public class Constraint extends DynamicResource implements IConstraint {
  ...
  public Constraint setChapters(java.util.List<? extends cleon.doc.spec.chapter.javamodel.IChapterOwnDocumentElementComposite> chapters) {
  ...
  public Constraint setNoChapters(cleon.doc.spec.chapter.javamodel.IChapter noChapters) {
  ...
  public Constraint setNoParagraph(cleon.doc.spec.paragraph.javamodel.IParagraph noParagraph) {
  ...
  public Constraint setOwnDocumentElements(java.util.List<? extends cleon.doc.spec.javamodel.IDocumentElement> ownDocumentElements) {
  ...
  public Constraint setParagraphes(java.util.List<? extends cleon.doc.spec.paragraph.javamodel.IParagraph> paragraphes) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,d9e271ef-3777-11e5-95d9-2b04d7ab02d9,rzZyOoGdZbgXTa/aOsfRIibzXcA=] */
