...
public class Principles extends DynamicResource implements IPrinciples {
  ...
  public Principles setChapters(java.util.List<? extends cleon.doc.spec.chapter.javamodel.IChapterOwnDocumentElementComposite> chapters) {
  ...
  public Principles setDocuments(java.util.List<? extends cleon.doc.spec.document.javamodel.ISubDocument> documents) {
  ...
  public Principles setNoChapters(cleon.doc.spec.chapter.javamodel.IChapter noChapters) {
  ...
  public Principles setNoDocuments(cleon.doc.spec.document.javamodel.ISubDocument noDocuments) {
  ...
  public Principles setOwnDocumentElements(java.util.List<? extends cleon.doc.spec.javamodel.IDocumentElement> ownDocumentElements) {
  ...
  public Principles setParagraphes(java.util.List<? extends cleon.doc.spec.paragraph.javamodel.IParagraph> paragraphes) {
  ...
  public Principles setUseDocumentElements(java.util.List<? extends cleon.doc.spec.javamodel.IDocumentElement> useDocumentElements) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,5d54c5db-a951-11e5-bda2-a7fc3bd7c783,bexgUleSa2D2nRd/Nbzf+u+7RKc=] */
