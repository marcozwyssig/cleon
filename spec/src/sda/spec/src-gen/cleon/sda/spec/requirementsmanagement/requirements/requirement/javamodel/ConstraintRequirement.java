...
public class ConstraintRequirement extends DynamicResource implements IConstraintRequirement {
  ...
  public ConstraintRequirement setAbstractionLevel(cleon.sda.spec.requirementsmanagement.requirements.abstraction_level.javamodel.IAbstractionLevel abstractionLevel) {
  ...
  public ConstraintRequirement setAchieves(java.util.List<? extends cleon.sda.spec.requirementsmanagement.motivation.goals.javamodel.IGoal> achieves) {
  ...
  public ConstraintRequirement setAutors(java.util.List<? extends cleon.doc.spec.autor.javamodel.IAutor> autors) {
  ...
  public ConstraintRequirement setChapters(java.util.List<? extends cleon.doc.spec.chapter.javamodel.IChapterOwnDocumentElementComposite> chapters) {
  ...
  public ConstraintRequirement setConflicts(java.util.List<? extends cleon.sda.spec.requirementsmanagement.requirements.requirement.javamodel.IRequirement> conflicts) {
  ...
  public ConstraintRequirement setDocuments(java.util.List<? extends cleon.doc.spec.document.javamodel.ISubDocument> documents) {
  ...
  public ConstraintRequirement setIssues(java.util.List<? extends cleon.sda.spec.requirementsmanagement.issues.javamodel.IIssue> issues) {
  ...
  public ConstraintRequirement setNoParagraph(cleon.doc.spec.paragraph.javamodel.IParagraph noParagraph) {
  ...
  public ConstraintRequirement setOriginatesFrom(java.util.List<? extends cleon.sda.spec.requirementsmanagement.motivation.sources.javamodel.ISource> originatesFrom) {
  ...
  public ConstraintRequirement setOwnDocumentElements(java.util.List<? extends cleon.doc.spec.javamodel.IDocumentElement> ownDocumentElements) {
  ...
  public ConstraintRequirement setParagraphes(java.util.List<? extends cleon.doc.spec.paragraph.javamodel.IParagraph> paragraphes) {
  ...
  public ConstraintRequirement setTemplate(cleon.sda.spec.requirementsmanagement.requirements.requirement.template.javamodel.INonFunctionalTemplate template) {
  ...
  public ConstraintRequirement setUseDocumentElements(java.util.List<? extends cleon.doc.spec.javamodel.IDocumentElement> useDocumentElements) {
