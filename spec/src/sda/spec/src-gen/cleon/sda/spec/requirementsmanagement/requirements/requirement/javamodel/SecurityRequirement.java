...
public class SecurityRequirement extends DynamicResource implements ISecurityRequirement {
  ...
  public SecurityRequirement setAbstractionLevel(cleon.sda.spec.requirementsmanagement.requirements.abstraction_level.javamodel.IAbstractionLevel abstractionLevel) {
  ...
  public SecurityRequirement setEstimate(cleon.sda.spec.projectmanagement.scope.backlog.javamodel.IEffort estimate) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,8f44a06a-a95d-11e5-bda2-a7fc3bd7c783,h2iEsF0CzzTOfqRp08ZGc9+/joE=] */
