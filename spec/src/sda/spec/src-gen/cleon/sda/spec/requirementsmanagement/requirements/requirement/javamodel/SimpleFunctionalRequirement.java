...
public class SimpleFunctionalRequirement extends DynamicResource implements ISimpleFunctionalRequirement {
  ...
  public SimpleFunctionalRequirement setAbstractionLevel(cleon.sda.spec.requirementsmanagement.requirements.abstraction_level.javamodel.IAbstractionLevel abstractionLevel) {
  ...
  public SimpleFunctionalRequirement setAchieves(java.util.List<? extends cleon.sda.spec.requirementsmanagement.motivation.goals.javamodel.IGoal> achieves) {
  ...
  public SimpleFunctionalRequirement setAggregates(java.util.List<? extends cleon.sda.spec.requirementsmanagement.requirements.requirement.javamodel.IRequirement> aggregates) {
  ...
  public SimpleFunctionalRequirement setAutors(java.util.List<? extends cleon.doc.spec.autor.javamodel.IAutor> autors) {
  ...
  public SimpleFunctionalRequirement setChapters(java.util.List<? extends cleon.doc.spec.chapter.javamodel.IChapterOwnDocumentElementComposite> chapters) {
  ...
  public SimpleFunctionalRequirement setConcretizes(java.util.List<? extends cleon.sda.spec.requirementsmanagement.requirements.requirement.javamodel.IRequirement> concretizes) {
  ...
  public SimpleFunctionalRequirement setConflicts(java.util.List<? extends cleon.sda.spec.requirementsmanagement.requirements.requirement.javamodel.IRequirement> conflicts) {
  ...
  public SimpleFunctionalRequirement setDocuments(java.util.List<? extends cleon.doc.spec.document.javamodel.ISubDocument> documents) {
  ...
  public SimpleFunctionalRequirement setEstimate(cleon.sda.spec.projectmanagement.scope.backlog.javamodel.IEffort estimate) {
  ...
  public SimpleFunctionalRequirement setIssues(java.util.List<? extends cleon.sda.spec.requirementsmanagement.issues.javamodel.IIssue> issues) {
  ...
  public SimpleFunctionalRequirement setNoParagraph(cleon.doc.spec.paragraph.javamodel.IParagraph noParagraph) {
  ...
  public SimpleFunctionalRequirement setOriginatesFrom(java.util.List<? extends cleon.sda.spec.requirementsmanagement.motivation.sources.javamodel.ISource> originatesFrom) {
  ...
  public SimpleFunctionalRequirement setOwnDocumentElements(java.util.List<? extends cleon.doc.spec.javamodel.IDocumentElement> ownDocumentElements) {
  ...
  public SimpleFunctionalRequirement setParagraphes(java.util.List<? extends cleon.doc.spec.paragraph.javamodel.IParagraph> paragraphes) {
  ...
  public SimpleFunctionalRequirement setState(cleon.sda.spec.requirementsmanagement.requirements.requirement.javamodel.IState state) {
  ...
  public SimpleFunctionalRequirement setUseDocumentElements(java.util.List<? extends cleon.doc.spec.javamodel.IDocumentElement> useDocumentElements) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,87710c27-a962-11e5-bda2-a7fc3bd7c783,gJ2Oo0V5FXMEgZu8Hf/iNvug1CQ=] */
