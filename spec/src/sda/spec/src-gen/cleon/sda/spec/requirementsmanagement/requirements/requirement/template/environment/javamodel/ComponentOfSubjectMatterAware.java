...
public abstract class ComponentOfSubjectMatterAware extends DynamicResource implements IComponentOfSubjectMatterAware {
  ...
  public static java.util.List<cleon.sda.spec.requirementsmanagement.requirements.requirement.template.environment.javamodel.IComponentOfSubjectMatterAware> selectToMeComponentOfSubjectMatter(cleon.sda.spec.requirementsmanagement.requirements.requirement.template.environment.javamodel.IComponentOfSubjectMatter object) {
    return _getToMeList(object.getRepository(), cleon.sda.spec.requirementsmanagement.requirements.requirement.template.environment.javamodel.IComponentOfSubjectMatterAware.class, cleon.sda.spec.requirementsmanagement.requirements.requirement.template.environment.EnvironmentPackage.ComponentOfSubjectMatterAware_componentOfSubjectMatter, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,55acb122-d6df-11e5-a98f-afca63b52e04,pwjuirMtyu17DSNBB4JCHy4r41E=] */
