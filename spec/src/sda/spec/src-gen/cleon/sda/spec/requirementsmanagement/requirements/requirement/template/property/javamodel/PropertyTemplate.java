...
public class PropertyTemplate extends DynamicResource implements IPropertyTemplate {
  ...
  public PropertyTemplate setCondition(cleon.sda.spec.requirementsmanagement.requirements.requirement.template.templatepart.condition.javamodel.ICondition condition) {
  ...
  public PropertyTemplate setExpression(cleon.sda.spec.requirementsmanagement.requirements.requirement.template.templatepart.expression.javamodel.IExpression expression) {
  ...
  public PropertyTemplate setImportance(cleon.sda.spec.requirementsmanagement.requirements.requirement.template.templatepart.importance.javamodel.IImportance importance) {
  ...
  public PropertyTemplate setProperty(cleon.sda.spec.requirementsmanagement.requirements.requirement.template.templatepart.property.javamodel.IProperty property) {
  ...
  public PropertyTemplate setSubjectMatter(cleon.sda.spec.requirementsmanagement.requirements.requirement.template.templatepart.subjectmatter.javamodel.ISubjectMatter subjectMatter) {
  ...
  public PropertyTemplate setValue(cleon.sda.spec.requirementsmanagement.requirements.requirement.template.templatepart.value.javamodel.IValue value) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,584b9882-d574-11e5-89ea-2d8d86e9ef89,iA/Zu+MruC+/eb7JWQAWSmMghvM=] */
