...
public class TestPackageDecomposition extends DynamicResource implements ITestPackageDecomposition {
  ...
  public cleon.uml.spec.structural.packages.javamodel.IPackageDecomposition selectPackageUnderTest() {
    return _getSingle(cleon.uml.spec.structural.packages.javamodel.IPackageDecomposition.class, cleon.testing.spec.level.unitests.UnitestsPackage.TestPackageDecomposition_packageUnderTest);
  }
  ...
  public TestPackageDecomposition setPackageUnderTest(cleon.uml.spec.structural.packages.javamodel.IPackageDecomposition packageUnderTest) {
    _setSingle(cleon.testing.spec.level.unitests.UnitestsPackage.TestPackageDecomposition_packageUnderTest, packageUnderTest);
    return this;
  }
  ...
  public cleon.testing.spec.level.unitests.javamodel.ITestPackage selectTestPackages() {
    return _getSingle(cleon.testing.spec.level.unitests.javamodel.ITestPackage.class, cleon.testing.spec.level.unitests.UnitestsPackage.TestPackageDecomposition_testPackages);
  }

  public TestPackageDecomposition setTestPackages(cleon.testing.spec.level.unitests.javamodel.ITestPackage testPackages) {
    _setSingle(cleon.testing.spec.level.unitests.UnitestsPackage.TestPackageDecomposition_testPackages, testPackages);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(cleon.uml.spec.structural.packages.javamodel.IPackageDecomposition.class, cleon.testing.spec.level.unitests.UnitestsPackage.TestPackageDecomposition_packageUnderTest, visitor);
    _acceptList(cleon.doc.spec.paragraph.javamodel.IParagraph.class, cleon.doc.spec.paragraph.ParagraphPackage.ParagraphOwnDocumentElementComposite_paragraphes, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IResource.class, ch.actifsource.core.CorePackage.Decorator_target, visitor);
    _acceptSingle(cleon.testing.spec.level.unitests.javamodel.ITestPackage.class, cleon.testing.spec.level.unitests.UnitestsPackage.TestPackageDecomposition_testPackages, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

  // toMeRelations
  
  public static java.util.List<cleon.testing.spec.level.unitests.javamodel.ITestPackageDecomposition> selectToMePackageUnderTest(cleon.uml.spec.structural.packages.javamodel.IPackageDecomposition object) {
    return _getToMeList(object.getRepository(), cleon.testing.spec.level.unitests.javamodel.ITestPackageDecomposition.class, cleon.testing.spec.level.unitests.UnitestsPackage.TestPackageDecomposition_packageUnderTest, object.getResource());
  }
  
  public static cleon.testing.spec.level.unitests.javamodel.ITestPackageDecomposition selectToMeTestPackages(cleon.testing.spec.level.unitests.javamodel.ITestPackage object) {
    return _getToMeSingle(object.getRepository(), cleon.testing.spec.level.unitests.javamodel.ITestPackageDecomposition.class, cleon.testing.spec.level.unitests.UnitestsPackage.TestPackageDecomposition_testPackages, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,6a1dc86a-18fc-11e5-b505-7b16b1341920,kfvexqdA423SEfWbEx38DuN9eVw=] */
