...
public class TestClassDecomposition extends DynamicResource implements ITestClassDecomposition {
  ...
  public cleon.uml.spec.structural.packages.javamodel.IPackageInClassifierDecomposition selectClassUnderTest() {
    return _getSingle(cleon.uml.spec.structural.packages.javamodel.IPackageInClassifierDecomposition.class, cleon.testing.spec.levels.unitests.UnitestsPackage.TestClassDecomposition_classUnderTest);
  }
  ...
  public TestClassDecomposition setClassUnderTest(cleon.uml.spec.structural.packages.javamodel.IPackageInClassifierDecomposition classUnderTest) {
    _setSingle(cleon.testing.spec.levels.unitests.UnitestsPackage.TestClassDecomposition_classUnderTest, classUnderTest);
    return this;
  }
    
  @Override
  public cleon.testing.spec.levels.unitests.javamodel.ITestClass selectClasses() {
    return _getSingle(cleon.testing.spec.levels.unitests.javamodel.ITestClass.class, cleon.testing.spec.levels.unitests.UnitestsPackage.TestClassDecomposition_classes);
  }

  public TestClassDecomposition setClasses(cleon.testing.spec.levels.unitests.javamodel.ITestClass classes) {
    _setSingle(cleon.testing.spec.levels.unitests.UnitestsPackage.TestClassDecomposition_classes, classes);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(cleon.uml.spec.structural.packages.javamodel.IPackageInClassifierDecomposition.class, cleon.testing.spec.levels.unitests.UnitestsPackage.TestClassDecomposition_classUnderTest, visitor);
    _acceptSingle(cleon.testing.spec.levels.unitests.javamodel.ITestClass.class, cleon.testing.spec.levels.unitests.UnitestsPackage.TestClassDecomposition_classes, visitor);
  ...
  public static java.util.List<cleon.testing.spec.levels.unitests.javamodel.ITestClassDecomposition> selectToMeClassUnderTest(cleon.uml.spec.structural.packages.javamodel.IPackageInClassifierDecomposition object) {
    return _getToMeList(object.getRepository(), cleon.testing.spec.levels.unitests.javamodel.ITestClassDecomposition.class, cleon.testing.spec.levels.unitests.UnitestsPackage.TestClassDecomposition_classUnderTest, object.getResource());
  }
  
  public static cleon.testing.spec.levels.unitests.javamodel.ITestClassDecomposition selectToMeClasses(cleon.testing.spec.levels.unitests.javamodel.ITestClass object) {
    return _getToMeSingle(object.getRepository(), cleon.testing.spec.levels.unitests.javamodel.ITestClassDecomposition.class, cleon.testing.spec.levels.unitests.UnitestsPackage.TestClassDecomposition_classes, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,e43712cd-19f3-11e5-a57b-e324953fb3a6,gNjWc833iBlB6QyJAEv3ynTVtvE=] */
