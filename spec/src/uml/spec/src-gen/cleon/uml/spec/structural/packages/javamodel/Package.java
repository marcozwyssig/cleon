...
public class Package extends DynamicResource implements IPackage {
  ...
  public Package setChapters(java.util.List<? extends cleon.doc.spec.chapter.javamodel.IChapterOwnDocumentElementComposite> chapters) {
  ...
  public Package setDecomposeClasses(java.util.List<? extends cleon.uml.spec.structural.packages.javamodel.IPackageInClassifierDecomposition> decomposeClasses) {
  ...
  public Package setParagraphes(java.util.List<? extends cleon.doc.spec.paragraph.javamodel.IParagraph> paragraphes) {
  ...
  public static cleon.uml.spec.structural.packages.javamodel.IPackage selectToMeDecomposeClasses(cleon.uml.spec.structural.packages.javamodel.IPackageInClassifierDecomposition object) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,2f4eebfb-92f9-11e3-a63e-fb8038f76aec,sUbUYrtoHRwTATine1YtBlpgyBY=] */
