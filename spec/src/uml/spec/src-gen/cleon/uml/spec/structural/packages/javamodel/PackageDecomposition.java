...
public class PackageDecomposition extends DynamicResource implements IPackageDecomposition {
  ...
  public PackageDecomposition setChapters(java.util.List<? extends cleon.doc.spec.chapter.javamodel.IChapterOwnDocumentElementComposite> chapters) {
  ...
  public PackageDecomposition setNoChapters(cleon.doc.spec.chapter.javamodel.IChapter noChapters) {
  ...
  public PackageDecomposition setParagraphes(java.util.List<? extends cleon.doc.spec.paragraph.javamodel.IParagraph> paragraphes) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,392c77b6-1756-11e5-9ca7-d1bb57b73459,n1VYUCkpbiKr/X4lnKqsKX6zj18=] */
