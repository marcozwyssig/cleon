...
public class Model extends DynamicResource implements IModel {
  ...
  public Model setDescription(java.util.List<? extends cleon.doc.spec.paragraph.javamodel.ITextParagraph> description) {
  ...
  public Model setResources(java.util.List<? extends cleon.actifsource.spec.javamodel.IResource> resources) {
  ...
  public Model setTargetPaths(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.actifsource.spec.javamodel.ITargetPath> targetPaths) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,eab1ce0a-1005-11e5-865e-55f33dbc76dc,wJsSFPe6gSmf4dlYIGzGuLIovak=] */
