...
public class Drivers extends DynamicResource implements IDrivers {
  ...
  public cleon.analysis.spec.drivers.javamodel.IContext selectContext() {
    return _getSingle(cleon.analysis.spec.drivers.javamodel.IContext.class, cleon.analysis.spec.drivers.DriversPackage.Drivers_context);
  }

  public Drivers setContext(cleon.analysis.spec.drivers.javamodel.IContext context) {
    _setSingle(cleon.analysis.spec.drivers.DriversPackage.Drivers_context, context);
    return this;
  }
  ...
  public java.util.List<? extends cleon.analysis.spec.drivers.javamodel.ISource> selectSources() {
    return _getList(cleon.analysis.spec.drivers.javamodel.ISource.class, cleon.analysis.spec.drivers.DriversPackage.Drivers_sources);
  }

  public Drivers setSources(java.util.List<? extends cleon.analysis.spec.drivers.javamodel.ISource> sources) {
    _setList(cleon.analysis.spec.drivers.DriversPackage.Drivers_sources, sources);
    return this;
  }
  ...
  public static cleon.analysis.spec.drivers.javamodel.IDrivers selectToMeContext(cleon.analysis.spec.drivers.javamodel.IContext object) {
    return _getToMeSingle(object.getRepository(), cleon.analysis.spec.drivers.javamodel.IDrivers.class, cleon.analysis.spec.drivers.DriversPackage.Drivers_context, object.getResource());
  }
  
  public static cleon.analysis.spec.drivers.javamodel.IDrivers selectToMeGoal(cleon.analysis.spec.drivers.javamodel.IGoals object) {
    return _getToMeSingle(object.getRepository(), cleon.analysis.spec.drivers.javamodel.IDrivers.class, cleon.analysis.spec.drivers.DriversPackage.Drivers_goal, object.getResource());
  }
  
  public static cleon.analysis.spec.drivers.javamodel.IDrivers selectToMeSources(cleon.analysis.spec.drivers.javamodel.ISource object) {
    return _getToMeSingle(object.getRepository(), cleon.analysis.spec.drivers.javamodel.IDrivers.class, cleon.analysis.spec.drivers.DriversPackage.Drivers_sources, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,877f094b-3c14-11e5-9962-cf3035adb922,HMpeIO6O3sukf7iM2IIbQp9EC9o=] */
