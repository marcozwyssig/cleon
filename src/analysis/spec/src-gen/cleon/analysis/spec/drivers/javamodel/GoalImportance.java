...
public class GoalImportance extends DynamicResource implements IGoalImportance {
  ...
  public boolean is__0_() {
    return getResource().equals(cleon.analysis.spec.drivers.DriversPackage.GoalImportance___0_);
  }
  
  @Override
  public boolean is__Y_() {
    return getResource().equals(cleon.analysis.spec.drivers.DriversPackage.GoalImportance___Y_);
  }
  
  @Override
  public boolean is__W_() {
    return getResource().equals(cleon.analysis.spec.drivers.DriversPackage.GoalImportance___W_);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,948ee30d-3cfe-11e5-871f-6beac6a7c24b,RCjDEpY/IyuRK0lvxYRAVvezz2s=] */
