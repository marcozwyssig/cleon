...
public class Score extends DynamicResource implements IScore {
  ...
  public boolean is__V_() {
    return getResource().equals(cleon.analysis.spec.evaluation.EvaluationPackage.Score___V_);
  }
  
  @Override
  public boolean is__X_() {
    return getResource().equals(cleon.analysis.spec.evaluation.EvaluationPackage.Score___X_);
  }
  
  @Override
  public boolean is__Y_() {
    return getResource().equals(cleon.analysis.spec.evaluation.EvaluationPackage.Score___Y_);
  }
  
  @Override
  public boolean is__0_() {
    return getResource().equals(cleon.analysis.spec.evaluation.EvaluationPackage.Score___0_);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,b606e74b-3c1a-11e5-9962-cf3035adb922,Ooh3L/9zebx7c4UaAMnBuiUZONI=] */
