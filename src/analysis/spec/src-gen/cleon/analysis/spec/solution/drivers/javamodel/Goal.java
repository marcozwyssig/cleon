...
public class Goal extends DynamicResource implements IGoal {
  ...
  public cleon.doc.spec.paragraph.javamodel.ITextParagraph selectGoaldescription() {
    return _getSingle(cleon.doc.spec.paragraph.javamodel.ITextParagraph.class, cleon.analysis.spec.solution.drivers.DriversPackage.Goal_goaldescription);
  }

  public Goal setGoaldescription(cleon.doc.spec.paragraph.javamodel.ITextParagraph goaldescription) {
    _setSingle(cleon.analysis.spec.solution.drivers.DriversPackage.Goal_goaldescription, goaldescription);
    return this;
  }
    
  @Override
  public cleon.doc.spec.paragraph.javamodel.ITextParagraph selectGoalname() {
    return _getSingle(cleon.doc.spec.paragraph.javamodel.ITextParagraph.class, cleon.analysis.spec.solution.drivers.DriversPackage.Goal_goalname);
  }

  public Goal setGoalname(cleon.doc.spec.paragraph.javamodel.ITextParagraph goalname) {
    _setSingle(cleon.analysis.spec.solution.drivers.DriversPackage.Goal_goalname, goalname);
    return this;
  }
    
  @Override
  public cleon.analysis.spec.solution.drivers.javamodel.IGoalImportance selectImportance() {
    return _getSingle(cleon.analysis.spec.solution.drivers.javamodel.IGoalImportance.class, cleon.analysis.spec.solution.drivers.DriversPackage.Goal_importance);
  }

  public Goal setImportance(cleon.analysis.spec.solution.drivers.javamodel.IGoalImportance importance) {
    _setSingle(cleon.analysis.spec.solution.drivers.DriversPackage.Goal_importance, importance);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(cleon.doc.spec.paragraph.javamodel.ITextParagraph.class, cleon.analysis.spec.solution.drivers.DriversPackage.Goal_goaldescription, visitor);
    _acceptSingle(cleon.doc.spec.paragraph.javamodel.ITextParagraph.class, cleon.analysis.spec.solution.drivers.DriversPackage.Goal_goalname, visitor);
    _acceptSingle(cleon.analysis.spec.solution.drivers.javamodel.IGoalImportance.class, cleon.analysis.spec.solution.drivers.DriversPackage.Goal_importance, visitor);
  ...
  public static cleon.analysis.spec.solution.drivers.javamodel.IGoal selectToMeGoalname(cleon.doc.spec.paragraph.javamodel.ITextParagraph object) {
    return _getToMeSingle(object.getRepository(), cleon.analysis.spec.solution.drivers.javamodel.IGoal.class, cleon.analysis.spec.solution.drivers.DriversPackage.Goal_goalname, object.getResource());
  }
  
  public static cleon.analysis.spec.solution.drivers.javamodel.IGoal selectToMeGoaldescription(cleon.doc.spec.paragraph.javamodel.ITextParagraph object) {
    return _getToMeSingle(object.getRepository(), cleon.analysis.spec.solution.drivers.javamodel.IGoal.class, cleon.analysis.spec.solution.drivers.DriversPackage.Goal_goaldescription, object.getResource());
  }
  
  public static java.util.List<cleon.analysis.spec.solution.drivers.javamodel.IGoal> selectToMeImportance(cleon.analysis.spec.solution.drivers.javamodel.IGoalImportance object) {
    return _getToMeList(object.getRepository(), cleon.analysis.spec.solution.drivers.javamodel.IGoal.class, cleon.analysis.spec.solution.drivers.DriversPackage.Goal_importance, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,0797167b-3c15-11e5-9962-cf3035adb922,ndVBKV4my0Rkjlg5sd/IxnnhyeM=] */
