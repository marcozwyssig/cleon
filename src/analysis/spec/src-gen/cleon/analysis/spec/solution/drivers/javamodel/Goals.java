...
public class Goals extends DynamicResource implements IGoals {
  ...
  public Goals setDescription(java.util.List<? extends cleon.doc.spec.paragraph.javamodel.ITextParagraph> description) {
  ...
  public java.util.List<? extends cleon.analysis.spec.solution.drivers.javamodel.IGoal> selectGoals() {
    return _getList(cleon.analysis.spec.solution.drivers.javamodel.IGoal.class, cleon.analysis.spec.solution.drivers.DriversPackage.Goals_goals);
  }

  public Goals setGoals(java.util.List<? extends cleon.analysis.spec.solution.drivers.javamodel.IGoal> goals) {
    _setList(cleon.analysis.spec.solution.drivers.DriversPackage.Goals_goals, goals);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptList(cleon.analysis.spec.solution.drivers.javamodel.IGoal.class, cleon.analysis.spec.solution.drivers.DriversPackage.Goals_goals, visitor);
  ...
  public static cleon.analysis.spec.solution.drivers.javamodel.IGoals selectToMeGoals(cleon.analysis.spec.solution.drivers.javamodel.IGoal object) {
    return _getToMeSingle(object.getRepository(), cleon.analysis.spec.solution.drivers.javamodel.IGoals.class, cleon.analysis.spec.solution.drivers.DriversPackage.Goals_goals, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,f6187db1-3c48-11e5-871f-6beac6a7c24b,zsg0Dtmjeltr6yVEpZgVx1Eg17Q=] */
