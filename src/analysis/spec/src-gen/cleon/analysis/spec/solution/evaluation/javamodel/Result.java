...
public class Result extends DynamicResource implements IResult {
  ...
  public cleon.analysis.spec.solution.evaluation.javamodel.IBest selectBest() {
    return _getSingle(cleon.analysis.spec.solution.evaluation.javamodel.IBest.class, cleon.analysis.spec.solution.evaluation.EvaluationPackage.Result_best);
  }

  public Result setBest(cleon.analysis.spec.solution.evaluation.javamodel.IBest best) {
    _setSingle(cleon.analysis.spec.solution.evaluation.EvaluationPackage.Result_best, best);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    // relations
    _acceptSingle(cleon.analysis.spec.solution.evaluation.javamodel.IBest.class, cleon.analysis.spec.solution.evaluation.EvaluationPackage.Result_best, visitor);
  ...
  public static cleon.analysis.spec.solution.evaluation.javamodel.IResult selectToMeBest(cleon.analysis.spec.solution.evaluation.javamodel.IBest object) {
    return _getToMeSingle(object.getRepository(), cleon.analysis.spec.solution.evaluation.javamodel.IResult.class, cleon.analysis.spec.solution.evaluation.EvaluationPackage.Result_best, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,11cf7692-3c2a-11e5-9962-cf3035adb922,lHrEUsCNCTncIIqxvhiZelZZR8Y=] */
