...
public class SolutionAnalysis extends DynamicResource implements ISolutionAnalysis {
  ...
  public SolutionAnalysis setDescription(java.util.List<? extends cleon.doc.spec.paragraph.javamodel.ITextParagraph> description) {
  ...
  public cleon.analysis.spec.solution.drivers.javamodel.IDrivers selectDrivers() {
    return _getSingle(cleon.analysis.spec.solution.drivers.javamodel.IDrivers.class, cleon.analysis.spec.solution.SolutionPackage.SolutionAnalysis_drivers);
  }

  public SolutionAnalysis setDrivers(cleon.analysis.spec.solution.drivers.javamodel.IDrivers drivers) {
    _setSingle(cleon.analysis.spec.solution.SolutionPackage.SolutionAnalysis_drivers, drivers);
    return this;
  }
    
  @Override
  public cleon.analysis.spec.solution.evaluation.javamodel.IEvaluations selectEvaluation() {
    return _getSingle(cleon.analysis.spec.solution.evaluation.javamodel.IEvaluations.class, cleon.analysis.spec.solution.SolutionPackage.SolutionAnalysis_evaluation);
  }

  public SolutionAnalysis setEvaluation(cleon.analysis.spec.solution.evaluation.javamodel.IEvaluations evaluation) {
    _setSingle(cleon.analysis.spec.solution.SolutionPackage.SolutionAnalysis_evaluation, evaluation);
    return this;
  }
  ...
  public cleon.analysis.spec.solution.solutions.javamodel.ISolutions selectSolution() {
    return _getSingle(cleon.analysis.spec.solution.solutions.javamodel.ISolutions.class, cleon.analysis.spec.solution.SolutionPackage.SolutionAnalysis_solution);
  }

  public SolutionAnalysis setSolution(cleon.analysis.spec.solution.solutions.javamodel.ISolutions solution) {
    _setSingle(cleon.analysis.spec.solution.SolutionPackage.SolutionAnalysis_solution, solution);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(cleon.analysis.spec.solution.drivers.javamodel.IDrivers.class, cleon.analysis.spec.solution.SolutionPackage.SolutionAnalysis_drivers, visitor);
    _acceptSingle(cleon.analysis.spec.solution.evaluation.javamodel.IEvaluations.class, cleon.analysis.spec.solution.SolutionPackage.SolutionAnalysis_evaluation, visitor);
    _acceptSingle(cleon.doc.spec.chapter.javamodel.IChapter.class, cleon.doc.spec.chapter.ChapterPackage.NoChapters_noChapters, visitor);
    _acceptList(cleon.doc.spec.javamodel.IDocumentElement.class, cleon.doc.spec.SpecPackage.OwnDocumentElementComposite_ownDocumentElements, visitor);
    _acceptList(cleon.doc.spec.paragraph.javamodel.IParagraph.class, cleon.doc.spec.paragraph.ParagraphPackage.ParagraphOwnDocumentElementComposite_paragraphes, visitor);
    _acceptSingle(cleon.analysis.spec.solution.solutions.javamodel.ISolutions.class, cleon.analysis.spec.solution.SolutionPackage.SolutionAnalysis_solution, visitor);
  ...
  public static cleon.analysis.spec.solution.javamodel.ISolutionAnalysis selectToMeDrivers(cleon.analysis.spec.solution.drivers.javamodel.IDrivers object) {
    return _getToMeSingle(object.getRepository(), cleon.analysis.spec.solution.javamodel.ISolutionAnalysis.class, cleon.analysis.spec.solution.SolutionPackage.SolutionAnalysis_drivers, object.getResource());
  }
  
  public static cleon.analysis.spec.solution.javamodel.ISolutionAnalysis selectToMeSolution(cleon.analysis.spec.solution.solutions.javamodel.ISolutions object) {
    return _getToMeSingle(object.getRepository(), cleon.analysis.spec.solution.javamodel.ISolutionAnalysis.class, cleon.analysis.spec.solution.SolutionPackage.SolutionAnalysis_solution, object.getResource());
  }
  
  public static cleon.analysis.spec.solution.javamodel.ISolutionAnalysis selectToMeEvaluation(cleon.analysis.spec.solution.evaluation.javamodel.IEvaluations object) {
    return _getToMeSingle(object.getRepository(), cleon.analysis.spec.solution.javamodel.ISolutionAnalysis.class, cleon.analysis.spec.solution.SolutionPackage.SolutionAnalysis_evaluation, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,c647eff4-3c0e-11e5-9962-cf3035adb922,O/79DAlEsCgkFA+yQuzgWlF2XXU=] */
