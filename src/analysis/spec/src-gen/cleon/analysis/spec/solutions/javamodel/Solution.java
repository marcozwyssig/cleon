...
public class Solution extends DynamicResource implements ISolution {
  ...
  public Solution setNoParagraph(cleon.doc.spec.chapter.paragraph.javamodel.IParagraph noParagraph) {
  ...
  public Solution setParagraphes(java.util.List<? extends cleon.doc.spec.chapter.paragraph.javamodel.IParagraph> paragraphes) {
