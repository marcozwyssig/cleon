...
public class ActifsourceArc42 extends DynamicResource implements IActifsourceArc42 {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<IActifsourceArc42> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<IActifsourceArc42>() {
    
    @Override
    public IActifsourceArc42 create() {
      return new ActifsourceArc42();
    }
    
    @Override
    public IActifsourceArc42 create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new ActifsourceArc42(resourceRepository, resource);
    }
  
  };

  public ActifsourceArc42() {
    super(IActifsourceArc42.TYPE_ID);
  }
  
  public ActifsourceArc42(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
    super(resourceRepository, resource, IActifsourceArc42.TYPE_ID);
  }
  ...
  public ActifsourceArc42 set__V_1_aE_introduction_aE_and_aE_goals(cleon.architecturemethods.arc42.metamodel.spec._01_introduction_and_goals.javamodel.IIntroductionAndGoals __V_1_aE_introduction_aE_and_aE_goals) {
  ...
  public ActifsourceArc42 set__V_2_aE_architecture_aE_constraints(cleon.architecturemethods.arc42.metamodel.spec._02_architecture_constraints.javamodel.IArchitectureConstraints __V_2_aE_architecture_aE_constraints) {
  ...
  public ActifsourceArc42 set__V_3_aE_system_aE_scope_aE_and_aE_context(cleon.architecturemethods.arc42.metamodel.spec._03_system_scope_and_context.javamodel.ISystemScopeAndContext __V_3_aE_system_aE_scope_aE_and_aE_context) {
  ...
  public ActifsourceArc42 set__V_4_aE_solution_aE_strategy(cleon.architecturemethods.arc42.metamodel.spec._04_solution_strategy.javamodel.ISolutionStrategy __V_4_aE_solution_aE_strategy) {
  ...
  public ActifsourceArc42 set__V_5_aE_buildingblockview(cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.software.javamodel.IBuildingBlockViewSoftware __V_5_aE_buildingblockview) {
  ...
  public ActifsourceArc42 set__V_6_aE_runtimeview(cleon.architecturemethods.arc42.metamodel.spec._06_runtime_view.javamodel.IRuntimeView __V_6_aE_runtimeview) {
  ...
  public ActifsourceArc42 set__V_7_aE_dataview(cleon.architecturemethods.arc42.metamodel.spec._08_data_view.javamodel.IDataView __V_7_aE_dataview) {
  ...
  public ActifsourceArc42 set__V_8_aE_deploymentview(cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.javamodel.IDeploymentView __V_8_aE_deploymentview) {
  ...
  public ActifsourceArc42 set__V_9_aE_concepts(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.javamodel.ICrosscuttingConcepts __V_9_aE_concepts) {
  ...
  public ActifsourceArc42 set__V_9_aE_software_aE_concepts(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.software.javamodel.ISoftwareCrosscuttingConcepts __V_9_aE_software_aE_concepts) {
  ...
  public ActifsourceArc42 set__W_0_aE_architectural_aE_decisions(cleon.architecturemethods.arc42.metamodel.spec._10_design_decisions.javamodel.IArchitecturalDecisions __W_0_aE_architectural_aE_decisions) {
  ...
  public ActifsourceArc42 set__W_0_aE_designdecision(cleon.architecturemethods.arc42.metamodel.spec._10_design_decisions.javamodel.IArchitecturalDecisions __W_0_aE_designdecision) {
  ...
  public ActifsourceArc42 set__W_1_aE_quality_aE_scenarios(cleon.architecturemethods.arc42.metamodel.spec._11_quality_scenarios.javamodel.IQualityRequirements __W_1_aE_quality_aE_scenarios) {
  ...
  public ActifsourceArc42 set__W_2_aE_technical_aE_risks(cleon.architecturemethods.arc42.metamodel.spec._12_technical_risks.javamodel.ITechnicalRisks __W_2_aE_technical_aE_risks) {
  ...
  public ActifsourceArc42 set__W_3_aE_productview(cleon.architecturemethods.arc42.metamodel.spec._13_product_view.javamodel.IProductView __W_3_aE_productview) {
  ...
  public ActifsourceArc42 set__W_4_aE_requirements_aE_coverage(cleon.architecturemethods.arc42.metamodel.spec._14_requirements_coverage.javamodel.IArc42RequirementCoverages __W_4_aE_requirements_aE_coverage) {
  ...
  public ActifsourceArc42 setAbout(cleon.common.doc.metamodel.spec.chapter.about.javamodel.IAbout about) {
  ...
  public ActifsourceArc42 setChapters(java.util.List<? extends cleon.common.doc.metamodel.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public ActifsourceArc42 setDeliverable(cleon.projectmethods.hermes.metamodel.spec.modules.projectmanagement.planning.scope.deliverable.javamodel.IDeliverable deliverable) {
  ...
  public ActifsourceArc42 setDocumentElements(java.util.List<? extends cleon.common.doc.metamodel.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public ActifsourceArc42 setGlossary(cleon.common.glossary.metamodel.spec.javamodel.IGlossary glossary) {
  ...
  public ActifsourceArc42 setLanguageSettings(cleon.common.language.metamodel.spec.language_settings.javamodel.ILanguageSettings languageSettings) {
  ...
  public ActifsourceArc42 setNameTranslation(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.translation.name.javamodel.ILanguageNameTranslation> nameTranslation) {
  ...
  public ActifsourceArc42 setPlanning(cleon.projectmethods.hermes.metamodel.spec.modules.projectmanagement.planning.javamodel.IPlanning planning) {
  ...
  public ActifsourceArc42 setProperties(cleon.common.doc.metamodel.spec.document.properties.javamodel.IProperties properties) {
  ...
  public ActifsourceArc42 setStyle(cleon.common.doc.metamodel.spec.document.style.javamodel.IStyle style) {
  ...
  public ActifsourceArc42 setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,d16b593e-ce8a-11e5-b193-7398541c035e,tQwSmciDd/X1qIDNMJOKPkxVs9s=] */
