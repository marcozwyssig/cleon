...
public class FunctionSpace_Arc42 {
  ...
  public static interface Iarc42DocumentFunctions extends IDynamicResourceExtension {
    ...
    public ch.actifsource.core.javamodel.INamedResource GetRootSystem();

    @IDynamicResourceExtension.MethodId("c9c2693d-2ad6-11e9-b83f-8be423c00623")
    public ch.actifsource.core.javamodel.IResource GetDeployment();
    ...
    public List<ch.actifsource.core.javamodel.IResource> AllExternalComponents();

    @IDynamicResourceExtension.MethodId("2e7618a9-5a01-11ea-b898-0bc71a0508a9")
    public List<ch.actifsource.core.javamodel.IResource> AllBuildComponents();

    @IDynamicResourceExtension.MethodId("1c3a1cb2-6490-11ea-bfcc-4306924cb4fe")
    public List<ch.actifsource.core.javamodel.INamedResource> AllActors();
