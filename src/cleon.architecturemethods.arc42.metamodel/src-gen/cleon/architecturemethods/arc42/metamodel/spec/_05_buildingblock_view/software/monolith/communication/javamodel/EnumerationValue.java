...
public class EnumerationValue extends DynamicResource implements IEnumerationValue {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<IEnumerationValue> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<IEnumerationValue>() {
    
    @Override
    public IEnumerationValue create() {
      return new EnumerationValue();
    }
    
    @Override
    public IEnumerationValue create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new EnumerationValue(resourceRepository, resource);
    }
  
  };

  public EnumerationValue() {
    super(IEnumerationValue.TYPE_ID);
  }
  
  public EnumerationValue(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
    super(resourceRepository, resource, IEnumerationValue.TYPE_ID);
  }
  ...
  public EnumerationValue setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
