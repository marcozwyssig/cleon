...
public class SoftwareMonolithDatabase extends DynamicResource implements ISoftwareMonolithDatabase {
  ...
  public SoftwareMonolithDatabase setDepends(java.util.List<? extends cleon.modelinglanguages.uml.metamodel.spec.structural.components.javamodel.IAbstractComponentDependency> depends) {
  ...
  public SoftwareMonolithDatabase setDependsFrom(java.util.List<? extends cleon.common.modularity.metamodel.spec.javamodel.IDependentBuildingBlock> dependsFrom) {
  ...
  public SoftwareMonolithDatabase setDependsOn(java.util.List<? extends cleon.common.modularity.metamodel.spec.javamodel.IDependency> dependsOn) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,879c1900-bf7f-11ee-b188-131fa688415c,U4EjzSOCuEboHUmIZSBLP25MrAE=] */
