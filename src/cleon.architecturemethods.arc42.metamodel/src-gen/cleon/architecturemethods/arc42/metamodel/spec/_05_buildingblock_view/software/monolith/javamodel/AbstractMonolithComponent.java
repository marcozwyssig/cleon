...
public class AbstractMonolithComponent extends DynamicResource implements IAbstractMonolithComponent {
  ...
  public AbstractMonolithComponent setDepends(java.util.List<? extends cleon.modelinglanguages.uml.metamodel.spec.structural.components.javamodel.IAbstractComponentDependency> depends) {
  ...
  public AbstractMonolithComponent setDependsFrom(java.util.List<? extends cleon.common.modularity.metamodel.spec.javamodel.IDependentBuildingBlock> dependsFrom) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,1b356df1-cdac-11ef-aceb-ed2f5b1a4839,BYK+G94TXId8pd7Q5dU/Ah/J5w0=] */
