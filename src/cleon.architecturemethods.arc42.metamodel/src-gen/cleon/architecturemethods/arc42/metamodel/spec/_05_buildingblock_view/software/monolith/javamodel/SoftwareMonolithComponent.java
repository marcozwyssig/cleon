...
public class SoftwareMonolithComponent extends DynamicResource implements ISoftwareMonolithComponent {
  ...
  public SoftwareMonolithComponent setDecomposeCmp(java.util.List<? extends cleon.modelinglanguages.uml.metamodel.spec.structural.components.javamodel.IAbstractComponent> decomposeCmp) {
  ...
  public SoftwareMonolithComponent setDepends(java.util.List<? extends cleon.modelinglanguages.uml.metamodel.spec.structural.components.javamodel.IAbstractComponentDependency> depends) {
  ...
  public SoftwareMonolithComponent setDependsFrom(java.util.List<? extends cleon.common.modularity.metamodel.spec.javamodel.IDependentBuildingBlock> dependsFrom) {
  ...
  public SoftwareMonolithComponent setDependsOn(java.util.List<? extends cleon.common.modularity.metamodel.spec.javamodel.IDependency> dependsOn) {
  ...
  public SoftwareMonolithComponent setDescriptionTranslation(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.translation.description.javamodel.ILanguageDescriptionTranslation> descriptionTranslation) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,874d49e9-cf1b-11ee-8c06-a5102392725a,r73PZBnOGYObuSENVKs+jI5zB3s=] */
