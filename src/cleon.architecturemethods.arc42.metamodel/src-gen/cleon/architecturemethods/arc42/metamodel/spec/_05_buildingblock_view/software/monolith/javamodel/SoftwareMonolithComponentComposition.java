...
public class SoftwareMonolithComponentComposition extends DynamicResource implements ISoftwareMonolithComponentComposition {
  ...
  public SoftwareMonolithComponentComposition setDecomposeCmp(java.util.List<? extends cleon.modelinglanguages.uml.metamodel.spec.structural.components.javamodel.IAbstractComponent> decomposeCmp) {
  ...
  public SoftwareMonolithComponentComposition setDepends(java.util.List<? extends cleon.modelinglanguages.uml.metamodel.spec.structural.components.javamodel.IAbstractComponentDependency> depends) {
  ...
  public SoftwareMonolithComponentComposition setDependsFrom(java.util.List<? extends cleon.common.modularity.metamodel.spec.javamodel.IDependentBuildingBlock> dependsFrom) {
  ...
  public SoftwareMonolithComponentComposition setDependsOn(java.util.List<? extends cleon.common.modularity.metamodel.spec.javamodel.IDependency> dependsOn) {
  ...
  public SoftwareMonolithComponentComposition setDescriptionTranslation(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.translation.description.javamodel.ILanguageDescriptionTranslation> descriptionTranslation) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,f3fd43df-bf7e-11ee-b188-131fa688415c,HcttKHuEpdsRzy4MmKa3yS/fNRs=] */
