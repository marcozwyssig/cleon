...
public class NamedSystemWithSystemConfiguration extends DynamicResource implements INamedSystemWithSystemConfiguration {
  ...
  public NamedSystemWithSystemConfiguration setDecomposeCmp(java.util.List<? extends cleon.modelinglanguages.uml.metamodel.spec.structural.components.javamodel.IAbstractComponent> decomposeCmp) {
  ...
  public NamedSystemWithSystemConfiguration setDepends(java.util.List<? extends cleon.modelinglanguages.uml.metamodel.spec.structural.components.javamodel.IAbstractComponentDependency> depends) {
  ...
  public NamedSystemWithSystemConfiguration setDependsFrom(java.util.List<? extends cleon.common.modularity.metamodel.spec.javamodel.IDependentBuildingBlock> dependsFrom) {
  ...
  public NamedSystemWithSystemConfiguration setDependsOn(java.util.List<? extends cleon.common.modularity.metamodel.spec.javamodel.IDependency> dependsOn) {
  ...
  public NamedSystemWithSystemConfiguration setDescriptionTranslation(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.translation.description.javamodel.ILanguageDescriptionTranslation> descriptionTranslation) {
  ...
  public NamedSystemWithSystemConfiguration setSystemConfigurations(java.util.List<? extends cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.systemconfiguration.javamodel.ISystemConfiguration> systemConfigurations) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,f6f283bb-45e4-11ea-a150-53212f58490b,nnuzuMZ6AB0ZBNjJMChWnRifBVk=] */
