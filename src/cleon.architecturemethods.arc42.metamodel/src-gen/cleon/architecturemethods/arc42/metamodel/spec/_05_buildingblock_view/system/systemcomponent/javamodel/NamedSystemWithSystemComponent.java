...
public class NamedSystemWithSystemComponent extends DynamicResource implements INamedSystemWithSystemComponent {
  ...
  public NamedSystemWithSystemComponent setDecomposeCmp(java.util.List<? extends cleon.modelinglanguages.uml.metamodel.spec.structural.components.javamodel.IAbstractComponent> decomposeCmp) {
  ...
  public NamedSystemWithSystemComponent setDepends(java.util.List<? extends cleon.modelinglanguages.uml.metamodel.spec.structural.components.javamodel.IAbstractComponentDependency> depends) {
  ...
  public NamedSystemWithSystemComponent setDependsFrom(java.util.List<? extends cleon.common.modularity.metamodel.spec.javamodel.IDependentBuildingBlock> dependsFrom) {
  ...
  public NamedSystemWithSystemComponent setDependsOn(java.util.List<? extends cleon.common.modularity.metamodel.spec.javamodel.IDependency> dependsOn) {
  ...
  public NamedSystemWithSystemComponent setDescriptionTranslation(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.translation.description.javamodel.ILanguageDescriptionTranslation> descriptionTranslation) {
  ...
  public NamedSystemWithSystemComponent setSystemComponents(java.util.List<? extends cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.systemcomponent.javamodel.ISystemComponent> systemComponents) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,e8941a6b-5ca9-11ea-9014-eb1fa518f623,d/0Nc3maT3Q/t+ruJlmmmS7ODBU=] */
