package cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.systemconfiguration.security.proxy.javamodel;
...
public class MailRelaySystemConfiguration extends DynamicResource implements IMailRelaySystemConfiguration {
  ...
  public MailRelaySystemConfiguration setDepends(java.util.List<? extends cleon.modelinglanguages.uml.metamodel.spec.structural.components.javamodel.IAbstractComponentDependency> depends) {
  ...
  public MailRelaySystemConfiguration setDependsFrom(java.util.List<? extends cleon.common.modularity.metamodel.spec.javamodel.IDependentBuildingBlock> dependsFrom) {
  ...
  public MailRelaySystemConfiguration setDependsOn(java.util.List<? extends cleon.common.modularity.metamodel.spec.javamodel.IDependency> dependsOn) {
  ...
  public MailRelaySystemConfiguration setDependsOnSysCfg(java.util.List<? extends cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.systemconfiguration.javamodel.ISystemConfigurationDependency> dependsOnSysCfg) {
  ...
  public MailRelaySystemConfiguration setDescriptionTranslation(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.translation.description.javamodel.ILanguageDescriptionTranslation> descriptionTranslation) {
  ...
  public MailRelaySystemConfiguration setDestinationCommunications(java.util.List<? extends cleon.architecturemethods.arc42.metamodel.spec._06_runtime_view.system.communication.javamodel.ISource> destinationCommunications) {
  ...
  public MailRelaySystemConfiguration setInheritServices(java.util.List<? extends cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.systemconfiguration.javamodel.ISystemConfiguration> inheritServices) {
  ...
  public MailRelaySystemConfiguration setInterface(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.systemconfiguration.javamodel.ISystemConfigurationInterface> interface_) {
  ...
  public MailRelaySystemConfiguration setProperties(java.util.List<? extends cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.systemconfiguration.javamodel.ISystemConfigurationProperty> properties) {
  ...
  public MailRelaySystemConfiguration setProvides(java.util.List<? extends cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.services.javamodel.IAbstractService> provides) {
  ...
  public MailRelaySystemConfiguration setSourceCommunications(java.util.List<? extends cleon.architecturemethods.arc42.metamodel.spec._06_runtime_view.system.communication.javamodel.ISource> sourceCommunications) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,08441628-c7f7-11e9-ba65-a5b6bc4916e7,3NiIsCzVez35TrobUAjb1nwnWiA=] */
