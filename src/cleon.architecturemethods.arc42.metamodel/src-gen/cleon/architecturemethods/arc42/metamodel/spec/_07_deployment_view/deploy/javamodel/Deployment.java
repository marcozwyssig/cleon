package cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy.javamodel;
...
public class Deployment extends DynamicResource implements IDeployment {
  ...
  @Override
  public java.util.List<? extends cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy.javamodel.IEnvironment> selectEnvironments() {
    return _getList(cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy.javamodel.IEnvironment.class, cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy.DeployPackage.Deployment_environments);
  }

  public Deployment setEnvironments(java.util.List<? extends cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy.javamodel.IEnvironment> environments) {
    _setList(cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy.DeployPackage.Deployment_environments, environments);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptList(cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy.javamodel.IEnvironment.class, cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy.DeployPackage.Deployment_environments, visitor);
  ...
  public static cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy.javamodel.IDeployment selectToMeEnvironments(cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy.javamodel.IEnvironment object) {
    return _getToMeSingle(object.getRepository(), cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy.javamodel.IDeployment.class, cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy.DeployPackage.Deployment_environments, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,f642a2f1-9991-11e8-b347-dd2314b02086,L9iLVH7d32F/LSOdu4VL/Q0Ttj8=] */
