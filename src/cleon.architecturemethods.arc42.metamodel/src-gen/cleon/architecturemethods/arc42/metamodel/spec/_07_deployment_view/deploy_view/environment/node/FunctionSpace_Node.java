package cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy_view.environment.node;
...
public class FunctionSpace_Node {
  ...
  public static interface INodeFunctions extends IDynamicResourceExtension {
    ...
    public cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy_view.environment.node.javamodel.INode GetParent();

    @IDynamicResourceExtension.MethodId("66093688-02d5-11e9-9e58-33d596257b14")
    public List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy_view.environment.node.javamodel.ISupplyAndBuildNodeDecomposite> GetParents();

    @IDynamicResourceExtension.MethodId("8dd02a63-02d5-11e9-9e58-33d596257b14")
    public cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy_view.environment.node.supplynode.javamodel.ISupplySiteNode GetSubnetNode();
    ...
    public List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy_view.environment.node.javamodel.INode> GetAllNestedNodes();
    ...
    public List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy_view.environment.node.supplynode.javamodel.ISupplySiteNode> GetAllNestedSiteNodes();
    ...
    public List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy_view.environment.node.buildnode.javamodel.IBuildNode> GetAllNestedBuildNodes();

    @IDynamicResourceExtension.MethodId("73b6c2b1-b25a-11eb-84da-a358b37bb644")
    public List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy_view.environment.node.buildnode.javamodel.IServiceBuildNode> GetAllNestedServiceBuildNodes();
    ...
    public cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy_view.environment.node.javamodel.INode GetNestedNode();

    @IDynamicResourceExtension.MethodId("b12ac911-cdc3-11eb-9255-4575b555e23e")
    public cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy_view.environment.node.buildnode.javamodel.IBuildNode GetNestedBuildNode();

    @IDynamicResourceExtension.MethodId("c674c46c-cdc3-11eb-9255-4575b555e23e")
    public List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy_view.environment.node.buildnode.javamodel.IBuildNode> GetNestedBuildNodes();

    @IDynamicResourceExtension.MethodId("68da6b3e-87f3-11ec-894d-7968efa38b99")
    public List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy_view.environment.node.buildnode.javamodel.IBuildNode> OnlyHyperVisorComponents();

    @IDynamicResourceExtension.MethodId("fadb5261-87f4-11ec-894d-7968efa38b99")
    public List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy_view.environment.node.buildnode.javamodel.IBuildNode> OnlyVMComponents();

    @IDynamicResourceExtension.MethodId("77892a21-8803-11ec-894d-7968efa38b99")
    public List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy_view.environment.node.buildnode.javamodel.IBuildNode> OnlyOSComponents();
  ...
  public static interface INodeFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("68da6b3e-87f3-11ec-894d-7968efa38b99")
    public List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy_view.environment.node.buildnode.javamodel.IBuildNode> OnlyHyperVisorComponents(final List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy_view.environment.node.javamodel.INode> nodeList);

    @IDynamicResourceExtension.MethodId("fadb5261-87f4-11ec-894d-7968efa38b99")
    public List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy_view.environment.node.buildnode.javamodel.IBuildNode> OnlyVMComponents(final List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy_view.environment.node.javamodel.INode> nodeList);

    @IDynamicResourceExtension.MethodId("77892a21-8803-11ec-894d-7968efa38b99")
    public List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy_view.environment.node.buildnode.javamodel.IBuildNode> OnlyOSComponents(final List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy_view.environment.node.javamodel.INode> nodeList);
  ...
  public static class NodeFunctions {
    ...
    public static List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy_view.environment.node.buildnode.javamodel.IBuildNode> OnlyHyperVisorComponents(final List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy_view.environment.node.javamodel.INode> nodeList) {
    ...
    public static List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy_view.environment.node.buildnode.javamodel.IBuildNode> OnlyVMComponents(final List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy_view.environment.node.javamodel.INode> nodeList) {
      return DynamicResourceUtil.invoke(INodeFunctionsImpl.class, NodeFunctionsImpl.INSTANCE, nodeList).OnlyVMComponents(nodeList);
    }

    public static List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy_view.environment.node.buildnode.javamodel.IBuildNode> OnlyOSComponents(final List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy_view.environment.node.javamodel.INode> nodeList) {
