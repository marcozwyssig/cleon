...
public class Stao extends DynamicResource implements IStao {
  ...
  @Override
  public boolean isA() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy_view.environment.node.supplynode.SupplynodePackage.Stao_A);
  }
  
  @Override
  public boolean isB() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy_view.environment.node.supplynode.SupplynodePackage.Stao_B);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,2a148fc4-e28d-11ed-99b7-d1ac0e4a4893,LFHvE4ExcTYoVIdpwG31NMPUdvk=] */
