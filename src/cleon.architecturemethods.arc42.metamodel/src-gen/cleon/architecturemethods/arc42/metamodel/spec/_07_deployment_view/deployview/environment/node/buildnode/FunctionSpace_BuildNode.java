package cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode;
...
import cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.FunctionSpace_Node.INodeFunctions;
...
import cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.resources.buildingblock.FunctionSpace_BuildingBlock.ICoreFunctions;
import cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.resources.buildingblock.FunctionSpace_BuildingBlock.IDiskFunctions;
import cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.resources.buildingblock.FunctionSpace_BuildingBlock.IMemoryFunctions;
import cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.resources.buildingblock.javamodel.CPU;
import cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.resources.buildingblock.javamodel.ICore;
import cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.resources.buildingblock.javamodel.IDisk;
import cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.resources.buildingblock.javamodel.IMemory;
...
import cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.topology.javamodel.IAbstractSiteWithHosts;
...
public class FunctionSpace_BuildNode {
  ...
  public static class HelperFunctionClass {
  	public static cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.topology.javamodel.IAbstractHost GetHost(
  		...
  		final var siteComposition = siteObject;
  		final IList<? extends IAbstractHost> abstractHosts = siteComposition.selectHosts().get(cmp.getResource());
  		for (final IAbstractHost abstractHost : abstractHosts) {
  			final var simpleName = Select.simpleName(abstractHost.getReadJobExecutor(), abstractHost.getResource());
  			final var strings = simpleName.split("-");
  ...
  public static interface IServiceBuildNodeFunctions extends IDynamicResourceExtension {
    ...
    public List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IServiceBuildNode> NoWDC();
  ...
  public static interface IServiceBuildNodeFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("8567abfa-84cc-11ea-aadc-ada99ddb5122")
    public cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.topology.javamodel.IAbstractHost GetHost(final cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.systemconfiguration.javamodel.ISystemConfiguration cmp, final java.lang.String site, final java.lang.String owner, final java.lang.String id, final cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IServiceBuildNode serviceBuildNode);

    @IDynamicResourceExtension.MethodId("88b738ac-5dfa-11ee-aa0e-795a14516714")
    public List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IServiceBuildNode> NoWDC(final List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IServiceBuildNode> serviceBuildNodeList);
  ...
  public static class ServiceBuildNodeFunctionsImpl implements IServiceBuildNodeFunctionsImpl {
    ...
    public cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.topology.javamodel.IAbstractHost GetHost(final cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.systemconfiguration.javamodel.ISystemConfiguration cmp, final java.lang.String site, final java.lang.String owner, final java.lang.String id, final cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IServiceBuildNode serviceBuildNode) {
      ...
      final var environmentFunctions = topologyEnvironment.extension(ITopologyEnvironmentFunctions.class);
      var siteObject = environmentFunctions.AllAbstractSiteHosts().stream()
      		.filter(x -> x.selectName().equalsIgnoreCase(site)).findFirst().orElse(null);
      if( siteObject != null ) {
      	final var abstractHost = HelperFunctionClass.GetHost(site, siteObject, cmp, owner, id);
  ...
  public static class ServiceBuildNodeFunctions {
    ...
    public static List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IServiceBuildNode> NoWDC(final List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IServiceBuildNode> serviceBuildNodeList) {
  ...
  public static interface IBuildNodeFunctions extends IDynamicResourceExtension {
    ...
    public List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode> OnlyOs();

    @IDynamicResourceExtension.MethodId("008ab45f-a433-11ec-a02c-0578282f8413")
    public List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode> OnlyWindows();

    @IDynamicResourceExtension.MethodId("4de742de-7bb1-11e9-94aa-f1ea7ea33f46")
    public List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode> OnlyVMH();

    @IDynamicResourceExtension.MethodId("3cb6a8f3-dff4-11eb-93d3-9f230e4bb32b")
    public List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode> OnlyVMs();
  ...
  public static interface IBuildNodeFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("8ea2102d-2aba-11e9-a3f8-336d9e792e17")
    public java.lang.Boolean IsSupplied(final cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode buildNode);

    @IDynamicResourceExtension.MethodId("c2eb1394-6cef-11e9-a6d3-775c09e81e2d")
    public List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode> OnlyOs(final List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode> buildNodeList);

    @IDynamicResourceExtension.MethodId("008ab45f-a433-11ec-a02c-0578282f8413")
    public List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode> OnlyWindows(final List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode> buildNodeList);

    @IDynamicResourceExtension.MethodId("4de742de-7bb1-11e9-94aa-f1ea7ea33f46")
    public List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode> OnlyVMH(final List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode> buildNodeList);

    @IDynamicResourceExtension.MethodId("3cb6a8f3-dff4-11eb-93d3-9f230e4bb32b")
    public List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode> OnlyVMs(final List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode> buildNodeList);

    @IDynamicResourceExtension.MethodId("e4d0cc56-e070-11eb-85ea-9f2d155d4de3")
    public java.lang.Integer BruttoMHz_Server(final cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode buildNode);

    @IDynamicResourceExtension.MethodId("04240e23-e071-11eb-85ea-9f2d155d4de3")
    public java.lang.Integer NettoMHz_Server(final cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode buildNode);

    @IDynamicResourceExtension.MethodId("401f2e96-e076-11eb-85ea-9f2d155d4de3")
    public java.lang.Integer TotalNettoMGHz_VM(final cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode buildNode);

    @IDynamicResourceExtension.MethodId("5756ac01-e077-11eb-85ea-9f2d155d4de3")
    public java.lang.Integer ReserveNettoMGHz(final cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode buildNode);

    @IDynamicResourceExtension.MethodId("068105b1-e07b-11eb-85ea-9f2d155d4de3")
    public java.lang.Integer TotalNettoMemoryGB_VM(final cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode buildNode);

    @IDynamicResourceExtension.MethodId("068105b3-e07b-11eb-85ea-9f2d155d4de3")
    public java.lang.Integer ReserveNettoMemoryGB(final cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode buildNode);

    @IDynamicResourceExtension.MethodId("032dcf9b-e088-11eb-9584-9144fca99be9")
    public java.lang.Integer TotalNettoDiskGB_Server(final cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode buildNode);

    @IDynamicResourceExtension.MethodId("6dd6f21d-e084-11eb-85ea-9f2d155d4de3")
    public java.lang.Integer TotalNettoDiskGB_VM(final cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode buildNode);

    @IDynamicResourceExtension.MethodId("83c4f8c6-e088-11eb-9584-9144fca99be9")
    public java.lang.Integer ReserveNettoDiskGB(final cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode buildNode);
  ...
  public static class BuildNodeFunctionsImpl implements IBuildNodeFunctionsImpl {
    ...
    public java.lang.Integer ReserveNettoMGHz(final cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode buildNode) {
      ...
      ICore core = null;
      final var cpus = buildNode.selectCpu();
      for( final var cpuConfig : cpus.values()) {
    ...
    public java.lang.Integer TotalNettoMemoryGB_VM(final cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode buildNode) {
      ...
      final var buildNodeFunctions = buildNode.extension(INodeFunctions.class);
      var total = 0;
      for(final var vm : OnlyVMs(buildNodeFunctions.GetAllNestedBuildNodes())) {
      	IMemory memory = null;
      	final var memories = vm.selectMemory();
      	for( final var memoryConfig : memories.values()) {
      		memory = memoryConfig.selectMemory();
      		break;
      	}

      	final var memoryTotal = memory.extension(IMemoryFunctions.class).NettoTotalGB();
      	total += memoryTotal;
      }
    ...
    public java.lang.Integer TotalNettoDiskGB_Server(final cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode buildNode) {
      ...
      for( final var diskConfigKey : disks.keyIterable()) {
      	for( final var diskConfig : disks.get(diskConfigKey) ) {
      		final var disk = diskConfig.selectDisk();
      		total += disk.selectCapacityGB();
      	}
      }

      final Double totalDouble = total * 0.6;
    ...
    public java.lang.Integer TotalNettoDiskGB_VM(final cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode buildNode) {
      ...
      var total = 0;
      for(final var vm : OnlyVMs(buildNodeFunctions.GetAllNestedBuildNodes())) {
      	final var disks = vm.selectDisks();
      	for( final var diskConfigKey : disks.keyIterable()) {
      		for( final var diskConfig : disks.get(diskConfigKey) ) {
      			final var disk = diskConfig.selectDisk();
      			total += disk.selectCapacityGB();
  ...
  public static class BuildNodeFunctions {
    ...
    public static java.lang.Boolean IsSupplied(final cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode buildNode) {
    ...
    public static List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode> OnlyOs(final List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode> buildNodeList) {
    ...
    public static List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode> OnlyWindows(final List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode> buildNodeList) {
    ...
    public static List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode> OnlyVMH(final List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode> buildNodeList) {
    ...
    public static List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode> OnlyVMs(final List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode> buildNodeList) {
    ...
    public static java.lang.Integer BruttoMHz_Server(final cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode buildNode) {
    ...
    public static java.lang.Integer NettoMHz_Server(final cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode buildNode) {
    ...
    public static java.lang.Integer TotalNettoMGHz_VM(final cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode buildNode) {
    ...
    public static java.lang.Integer ReserveNettoMGHz(final cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode buildNode) {
    ...
    public static java.lang.Integer TotalNettoMemoryGB_VM(final cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode buildNode) {
    ...
    public static java.lang.Integer ReserveNettoMemoryGB(final cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode buildNode) {
    ...
    public static java.lang.Integer TotalNettoDiskGB_Server(final cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode buildNode) {
    ...
    public static java.lang.Integer TotalNettoDiskGB_VM(final cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode buildNode) {
    ...
    public static java.lang.Integer ReserveNettoDiskGB(final cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode buildNode) {
  ...
  public static interface IApplicationBuildNodeFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("104621ba-84da-11ea-ade9-0f308d716192")
    public java.lang.String GetSimpleName(final cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IApplicationBuildNode applicationBuildNode);

    @IDynamicResourceExtension.MethodId("1bedfd33-84da-11ea-ade9-0f308d716192")
    public java.lang.String OnlyName(final cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IApplicationBuildNode applicationBuildNode);
  ...
  public static class ApplicationBuildNodeFunctions {
    ...
    public static java.lang.String GetSimpleName(final cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IApplicationBuildNode applicationBuildNode) {
    ...
    public static java.lang.String OnlyName(final cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IApplicationBuildNode applicationBuildNode) {
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,48dec04d-02d8-11e9-9e58-33d596257b14,liS+Ty7La7nN9PWrX77eGxr3Hu8=] */
