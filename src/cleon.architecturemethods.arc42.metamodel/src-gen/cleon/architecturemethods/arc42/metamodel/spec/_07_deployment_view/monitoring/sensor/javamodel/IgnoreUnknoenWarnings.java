...
public class IgnoreUnknoenWarnings extends DynamicResource implements IIgnoreUnknoenWarnings {
  ...
  public boolean isWarn() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.monitoring.sensor.SensorPackage.IgnoreUnknoenWarnings_warn);
  }
  
  @Override
  public boolean isIgnore() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.monitoring.sensor.SensorPackage.IgnoreUnknoenWarnings_ignore);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,2335ec9c-e3ba-11ea-84e3-5dbec94345a4,BK9cqNPyZpH7vk+a4qGSAM6fKzo=] */
