...
public class RequestMethod extends DynamicResource implements IRequestMethod {
  ...
  public boolean isGET() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.monitoring.sensor.SensorPackage.RequestMethod_GET);
  }
  
  @Override
  public boolean isPOST() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.monitoring.sensor.SensorPackage.RequestMethod_POST);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,4c6592d2-dc79-11ea-a169-cb4c6ff66798,rOMwTRP0WZyW6qApHcVSdKY5Kpw=] */
