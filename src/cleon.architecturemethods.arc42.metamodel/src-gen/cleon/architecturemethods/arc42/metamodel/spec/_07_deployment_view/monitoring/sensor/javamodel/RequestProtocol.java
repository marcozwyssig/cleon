...
public class RequestProtocol extends DynamicResource implements IRequestProtocol {
  ...
  public boolean isHttp() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.monitoring.sensor.SensorPackage.RequestProtocol_http);
  }
  
  @Override
  public boolean isHttps() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.monitoring.sensor.SensorPackage.RequestProtocol_https);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,98d01b1c-dc79-11ea-a169-cb4c6ff66798,u3Yi16BQTZucHSIS+3U6M0T3pms=] */
