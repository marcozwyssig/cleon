...
public class Snmpdiskfree extends DynamicResource implements ISnmpdiskfree {
  ...
  public java.util.List<java.lang.String> selectDisks() {
    return _getListAttribute(java.lang.String.class, cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.monitoring.sensor.SensorPackage.snmpdiskfree_disks);
  }
    
  public void setDisks(java.util.List<java.lang.String> disks) {
     _setListAttribute(cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.monitoring.sensor.SensorPackage.snmpdiskfree_disks, disks);
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptListAttribute(java.lang.String.class, cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.monitoring.sensor.SensorPackage.snmpdiskfree_disks, visitor);
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,db4b94aa-c1eb-11ea-820f-9931558a898c,g0GpLQM4RivdguoKYRQDlAee1PE=] */
