package cleon.architecturemethods.arc42.metamodel.spec._09_concepts.software.architecture_and_design_patterns.architecture_pattern.microservice.javamodel;

import ch.actifsource.util.collection.IMultiMapOrdered;
import ch.actifsource.core.dynamic.*;

@edu.umd.cs.findbugs.annotations.SuppressWarnings("EQ_DOESNT_OVERRIDE_EQUALS")
public class ApplicationLayer extends DynamicResource implements IApplicationLayer {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<IApplicationLayer> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<IApplicationLayer>() {
    
    @Override
    public IApplicationLayer create() {
      return new ApplicationLayer();
    }
    
    @Override
    public IApplicationLayer create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new ApplicationLayer(resourceRepository, resource);
    }
  
  };

  public ApplicationLayer() {
    super(IApplicationLayer.TYPE_ID);
  }
  
  public ApplicationLayer(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
    super(resourceRepository, resource, IApplicationLayer.TYPE_ID);
  }
  ...
  public ApplicationLayer setDecompose(java.util.List<? extends cleon.common.modularity.metamodel.spec.javamodel.IBuildingBlock> decompose) {
  ...
  public ApplicationLayer setDecomposeCmp(java.util.List<? extends cleon.modelinglanguages.uml.metamodel.spec.structural.components.javamodel.IAbstractComponent> decomposeCmp) {
  ...
  public ApplicationLayer setDepends(java.util.List<? extends cleon.modelinglanguages.uml.metamodel.spec.structural.components.javamodel.IAbstractComponentDependency> depends) {
  ...
  public ApplicationLayer setDependsFrom(java.util.List<? extends cleon.common.modularity.metamodel.spec.javamodel.IDependentBuildingBlock> dependsFrom) {
  ...
  public ApplicationLayer setDependsOn(java.util.List<? extends cleon.common.modularity.metamodel.spec.javamodel.IDependency> dependsOn) {
  ...
  public ApplicationLayer setDescriptionTranslation(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.translation.description.javamodel.ILanguageDescriptionTranslation> descriptionTranslation) {
  ...
  public ApplicationLayer setInteracts(java.util.List<? extends cleon.common.modularity.metamodel.spec.javamodel.IInteraction> interacts) {
  ...
  public ApplicationLayer setPorts_In(IMultiMapOrdered<ch.actifsource.core.Resource, ? extends cleon.modelinglanguages.uml.metamodel.spec.structural.components.ports.javamodel.IPort_Required> ports_In) {
  ...
  public ApplicationLayer setPorts_Out(java.util.List<? extends cleon.modelinglanguages.uml.metamodel.spec.structural.components.ports.javamodel.IPort_Provider> ports_Out) {
  ...
  public ApplicationLayer setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,fdd22ffb-e28a-11f0-a927-5b9cb523e701,qV7C7VXwjus40fdgBVS4EgUuk2Q=] */
