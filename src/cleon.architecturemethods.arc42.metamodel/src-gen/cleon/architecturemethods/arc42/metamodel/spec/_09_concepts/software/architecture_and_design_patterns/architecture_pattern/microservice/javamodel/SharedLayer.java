...
public class SharedLayer extends DynamicResource implements ISharedLayer {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<ISharedLayer> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<ISharedLayer>() {
    
    @Override
    public ISharedLayer create() {
      return new SharedLayer();
    }
    
    @Override
    public ISharedLayer create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new SharedLayer(resourceRepository, resource);
    }
  
  };

  public SharedLayer() {
    super(ISharedLayer.TYPE_ID);
  }
  
  public SharedLayer(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
    super(resourceRepository, resource, ISharedLayer.TYPE_ID);
  }
  ...
  public SharedLayer setDecompose(java.util.List<? extends cleon.common.modularity.metamodel.spec.javamodel.IBuildingBlock> decompose) {
  ...
  public SharedLayer setDecomposeCmp(java.util.List<? extends cleon.modelinglanguages.uml.metamodel.spec.structural.components.javamodel.IAbstractComponent> decomposeCmp) {
  ...
  public SharedLayer setDepends(java.util.List<? extends cleon.modelinglanguages.uml.metamodel.spec.structural.components.javamodel.IAbstractComponentDependency> depends) {
  ...
  public SharedLayer setDependsFrom(java.util.List<? extends cleon.common.modularity.metamodel.spec.javamodel.IDependentBuildingBlock> dependsFrom) {
  ...
  public SharedLayer setDependsOn(java.util.List<? extends cleon.common.modularity.metamodel.spec.javamodel.IDependency> dependsOn) {
  ...
  public SharedLayer setDescriptionTranslation(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.translation.description.javamodel.ILanguageDescriptionTranslation> descriptionTranslation) {
  ...
  public SharedLayer setInteracts(java.util.List<? extends cleon.common.modularity.metamodel.spec.javamodel.IInteraction> interacts) {
  ...
  public SharedLayer setPorts_In(IMultiMapOrdered<ch.actifsource.core.Resource, ? extends cleon.modelinglanguages.uml.metamodel.spec.structural.components.ports.javamodel.IPort_Required> ports_In) {
  ...
  public SharedLayer setPorts_Out(java.util.List<? extends cleon.modelinglanguages.uml.metamodel.spec.structural.components.ports.javamodel.IPort_Provider> ports_Out) {
  ...
  public SharedLayer setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,116d6a03-e28b-11f0-a927-5b9cb523e701,W0iz63vlPDHFObn0rC+3u5VBxSo=] */
