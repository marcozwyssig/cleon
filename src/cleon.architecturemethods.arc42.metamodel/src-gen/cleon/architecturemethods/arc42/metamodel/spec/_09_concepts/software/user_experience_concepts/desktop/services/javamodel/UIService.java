package cleon.architecturemethods.arc42.metamodel.spec._09_concepts.software.user_experience_concepts.desktop.services.javamodel;
...
public class UIService extends DynamicResource implements IUIService {
  ...
  public UIService setData(java.util.List<? extends cleon.modelinglanguages.uml.metamodel.spec.structural.classes.interfaces.javamodel.IInterfaceData> data) {
  ...
  public UIService setDescriptionTranslation(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.translation.description.javamodel.ILanguageDescriptionTranslation> descriptionTranslation) {
  ...
  public UIService setEvents(java.util.List<? extends cleon.architecturestylesandpatterns.soa.metamodel.spec.javamodel.IEvent> events) {
  ...
  public UIService setMethods(java.util.List<? extends cleon.modelinglanguages.uml.metamodel.spec.structural.classes.method.javamodel.IMethod> methods) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,f4fb9566-a37b-11e3-9113-ffc7f11b0a42,hJUcYIhmAJirz9d0PKkdozYgii0=] */
