...
public class BackupPackage {
  ...
  public static final Resource BackupConcept_backupAndRecoveryStategies = new Resource("00031db4-c1ca-11ea-b956-0ffede25a02d");
  public static final Resource BackupConfiguration_name = new Resource("3e0fd22f-c1ca-11ea-b956-0ffede25a02d");
  public static final Resource BackupConfiguration_retention_aE_days = new Resource("e76e8e37-c1cd-11ea-b956-0ffede25a02d");
  public static final Resource BackupConfiguration_fullBackupEvery = new Resource("1cf84fce-e4ba-11ef-a6bd-497168f25adc");
  public static final Resource BackupConfiguration_usingProductForBackup = new Resource("2a7b7aa1-e4ba-11ef-a6bd-497168f25adc");
  public static final Resource BackupConfiguration_intervalBackupEvery = new Resource("60ce0938-e4ba-11ef-a6bd-497168f25adc");
...
/* Actifsource ID=[c1a07b92-fc09-11e0-b756-0dc1d96a76cb,cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.businesscontinuity.backup,ttyHOjm9cLKKykqqD+lGFl3veX0=] */
