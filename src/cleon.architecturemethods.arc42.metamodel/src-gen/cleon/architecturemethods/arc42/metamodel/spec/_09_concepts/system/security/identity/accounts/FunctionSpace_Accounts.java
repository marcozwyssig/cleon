package cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.security.identity.accounts;
...
public class FunctionSpace_Accounts {
  ...
  public static interface IServiceAccountFunctions extends IDynamicResourceExtension {
    ...
    public List<cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.security.identity.authz.deployment.system.javamodel.IActivityPermission> GetSortedActivePermissionsForServiceAccount();
  ...
  public static interface IServiceAccountFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("b4b25887-3a00-11eb-9823-adf6a3e0c300")
    public java.lang.Integer Id(final cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.security.identity.accounts.javamodel.IServiceAccount serviceAccount);

    @IDynamicResourceExtension.MethodId("edd9abe4-4ff1-11eb-8df9-adb928521f3a")
    public List<cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.topology.javamodel.IAbstractHost> GetAbstractHostsBySite(final cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.security.identity.accounts.javamodel.IServiceAccountEnvironmentSite serviceAccountEnvironmentSite, final cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.security.identity.accounts.javamodel.IServiceAccount serviceAccount);

    @IDynamicResourceExtension.MethodId("0574c273-54af-11eb-8ec7-9b1f37a1ee7d")
    public java.lang.Boolean Value(final cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.security.identity.accounts.javamodel.IServiceAccount serviceAccount);

    @IDynamicResourceExtension.MethodId("2dd63939-54e5-11eb-a33f-e91880debedc")
    public List<cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.security.identity.accounts.javamodel.IServiceAccount> OnlyEnabledServiceAccounts(final List<cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.security.identity.accounts.javamodel.IServiceAccount> serviceAccountList);

    @IDynamicResourceExtension.MethodId("98aef332-9eee-11ec-8d98-a946e0e0308e")
    public java.lang.Boolean PasswordNeverExpires(final cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.security.identity.accounts.javamodel.IServiceAccount serviceAccount);
  ...
  public static class ServiceAccountFunctions {
    ...
    public static java.lang.Integer Id(final cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.security.identity.accounts.javamodel.IServiceAccount serviceAccount) {
    ...
    public static java.lang.Boolean Value(final cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.security.identity.accounts.javamodel.IServiceAccount serviceAccount) {
    ...
    public static java.lang.Boolean PasswordNeverExpires(final cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.security.identity.accounts.javamodel.IServiceAccount serviceAccount) {
  ...
  public static interface IServiceAccount_gMSAFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("763e9dd6-9eef-11ec-8d98-a946e0e0308e")
    public java.lang.Boolean PasswordNeverExpires(final cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.security.identity.accounts.javamodel.IServiceAccount_gMSA serviceAccount_gMSA);
  ...
  public static class ServiceAccount_gMSAFunctions {
    ...
    public static java.lang.Boolean PasswordNeverExpires(final cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.security.identity.accounts.javamodel.IServiceAccount_gMSA serviceAccount_gMSA) {
  ...
  public static interface IServiceAccountEnvironmentSystemFunctions extends IDynamicResourceExtension {
    ...
    public List<cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.systemconfiguration.javamodel.ISystemConfiguration> SystemConfigurations();
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,96deff1f-2830-11eb-a351-0f02534982d8,WJt136yn0SXxPhbbiV29blpLYFw=] */
