...
public class ServiceAccount_Local extends DynamicResource implements IServiceAccount_Local {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<IServiceAccount_Local> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<IServiceAccount_Local>() {
    
    @Override
    public IServiceAccount_Local create() {
      return new ServiceAccount_Local();
    }
    
    @Override
    public IServiceAccount_Local create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new ServiceAccount_Local(resourceRepository, resource);
    }
  
  };

  public ServiceAccount_Local() {
    super(IServiceAccount_Local.TYPE_ID);
  }
  
  public ServiceAccount_Local(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
    super(resourceRepository, resource, IServiceAccount_Local.TYPE_ID);
  }
  ...
  public ServiceAccount_Local setAllocateActivitiesFromSite(java.util.List<? extends cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.topology.javamodel.IAbstractSite> allocateActivitiesFromSite) {
  ...
  public ServiceAccount_Local setExcludeActivities(java.util.List<? extends cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.security.identity.authz.deployment.activity.javamodel.IActivityPermission> excludeActivities) {
  ...
  public ServiceAccount_Local setMemberOfActivityPermissions(java.util.List<? extends cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.security.identity.authz.deployment.activity.javamodel.IActivityPermission> memberOfActivityPermissions) {
  ...
  public ServiceAccount_Local setServiceAccountForSystemConfiguration(cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.systemconfiguration.javamodel.ISystemConfiguration serviceAccountForSystemConfiguration) {
  ...
  public ServiceAccount_Local setServiceAccountTemplate(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.security.identity.accounts.serviceaccounts.javamodel.IServiceAccountTemplate serviceAccountTemplate) {
  ...
  public ServiceAccount_Local setTarget(ch.actifsource.core.javamodel.IResource target) {
  ...
  public ServiceAccount_Local setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,5662084a-2bdc-11f0-8d6d-718895c90832,d1INfcIyo/G0chzg6YuAsdQx5dM=] */
