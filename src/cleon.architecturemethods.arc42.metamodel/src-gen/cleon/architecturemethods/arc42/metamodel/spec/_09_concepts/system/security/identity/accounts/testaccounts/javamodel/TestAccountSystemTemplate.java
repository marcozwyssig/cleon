...
public class TestAccountSystemTemplate extends DynamicResource implements ITestAccountSystemTemplate {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<ITestAccountSystemTemplate> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<ITestAccountSystemTemplate>() {
    
    @Override
    public ITestAccountSystemTemplate create() {
      return new TestAccountSystemTemplate();
    }
    
    @Override
    public ITestAccountSystemTemplate create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new TestAccountSystemTemplate(resourceRepository, resource);
    }
  
  };

  public TestAccountSystemTemplate() {
    super(ITestAccountSystemTemplate.TYPE_ID);
  }
  
  public TestAccountSystemTemplate(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
    super(resourceRepository, resource, ITestAccountSystemTemplate.TYPE_ID);
  }
  ...
  public TestAccountSystemTemplate setChapters(java.util.List<? extends cleon.common.doc.metamodel.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public TestAccountSystemTemplate setDescriptionTranslation(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.translation.description.javamodel.ILanguageDescriptionTranslation> descriptionTranslation) {
  ...
  public TestAccountSystemTemplate setDocumentElements(java.util.List<? extends cleon.common.doc.metamodel.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public TestAccountSystemTemplate setNoChapters(cleon.common.doc.metamodel.spec.chapter.javamodel.IAbstractChapter noChapters) {
  ...
  public TestAccountSystemTemplate setParagraphs(java.util.List<? extends cleon.common.doc.metamodel.spec.paragraph.javamodel.IParagraph> paragraphs) {
  ...
  public TestAccountSystemTemplate setTarget(ch.actifsource.core.javamodel.IResource target) {
  ...
  public TestAccountSystemTemplate setTestAccountTemplate(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.security.identity.accounts.testaccounts.javamodel.ITestAccountTemplate> testAccountTemplate) {
    _setMap(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.security.identity.accounts.testaccounts.TestaccountsPackage.TestAccountSystemTemplate_testAccountTemplate, testAccountTemplate);
    return this;
  }
  ...
  public TestAccountSystemTemplate setTestAccountTemplatesForSystem(cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.system.javamodel.IAbstractSystem testAccountTemplatesForSystem) {
    _setSingle(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.security.identity.accounts.testaccounts.TestaccountsPackage.TestAccountSystemTemplate_testAccountTemplatesForSystem, testAccountTemplatesForSystem);
    return this;
  }
  ...
  public TestAccountSystemTemplate setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
  ...
  public static java.util.List<cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.security.identity.accounts.testaccounts.javamodel.ITestAccountSystemTemplate> selectToMeTestAccountTemplatesForSystem(cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.system.javamodel.IAbstractSystem object) {
    return _getToMeList(object.getRepository(), cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.security.identity.accounts.testaccounts.javamodel.ITestAccountSystemTemplate.class, cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.security.identity.accounts.testaccounts.TestaccountsPackage.TestAccountSystemTemplate_testAccountTemplatesForSystem, object.getResource());
  }
  
  public static cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.security.identity.accounts.testaccounts.javamodel.ITestAccountSystemTemplate selectToMeTestAccountTemplate(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.security.identity.accounts.testaccounts.javamodel.ITestAccountTemplate object) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,4afdd669-2733-11f0-8098-59f455ea82af,8vivQQGmJWUw5MwgpRowCjmphJs=] */
