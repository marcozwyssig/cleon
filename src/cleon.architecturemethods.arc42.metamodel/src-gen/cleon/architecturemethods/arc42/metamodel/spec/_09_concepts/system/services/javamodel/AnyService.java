...
public class AnyService extends DynamicResource implements IAnyService {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<IAnyService> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<IAnyService>() {
    
    @Override
    public IAnyService create() {
      return new AnyService();
    }
    
    @Override
    public IAnyService create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new AnyService(resourceRepository, resource);
    }
  
  };

  public AnyService() {
    super(IAnyService.TYPE_ID);
  }
  
  public AnyService(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
    super(resourceRepository, resource, IAnyService.TYPE_ID);
  }
  ...
  public AnyService setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
  ...
  public AnyService setUsedInCommunication(java.util.List<? extends cleon.architecturemethods.arc42.metamodel.spec._06_runtime_view.system.communication.javamodel.ISource> usedInCommunication) {
  ...
  public AnyService setUsedInGroup(java.util.List<? extends cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.services.javamodel.IAbstractServiceGroup> usedInGroup) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,f5c214a2-b6be-11ea-83ac-afd79efb5e4a,KCj2V8B3gth/zE+lYwN00IkyGcE=] */
