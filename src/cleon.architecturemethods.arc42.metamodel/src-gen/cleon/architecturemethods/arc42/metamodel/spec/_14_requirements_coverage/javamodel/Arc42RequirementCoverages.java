package cleon.architecturemethods.arc42.metamodel.spec._14_requirements_coverage.javamodel;
...
public class Arc42RequirementCoverages extends DynamicResource implements IArc42RequirementCoverages {
  ...
  public Arc42RequirementCoverages setChapters(java.util.List<? extends cleon.common.doc.metamodel.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public Arc42RequirementCoverages setDescriptionTranslation(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.translation.description.javamodel.ILanguageDescriptionTranslation> descriptionTranslation) {
  ...
  public Arc42RequirementCoverages setDocumentElements(java.util.List<? extends cleon.common.doc.metamodel.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public Arc42RequirementCoverages setParagraphs(java.util.List<? extends cleon.common.doc.metamodel.spec.paragraph.javamodel.IParagraph> paragraphs) {
  ...
  public Arc42RequirementCoverages setSubjectAreaCoverage(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.eamod.metamodel.spec.chrv.coverage.javamodel.ISubjectAreaCoverage> subjectAreaCoverage) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,ef7590e5-1be9-11e9-a3c2-fd06554474a5,5gwkO04N+1Io/1/JzlcFIZlfGag=] */
