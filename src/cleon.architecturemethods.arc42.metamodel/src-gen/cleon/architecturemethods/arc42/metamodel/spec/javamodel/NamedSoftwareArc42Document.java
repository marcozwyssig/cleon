...
public class NamedSoftwareArc42Document extends DynamicResource implements INamedSoftwareArc42Document {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<INamedSoftwareArc42Document> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<INamedSoftwareArc42Document>() {
    
    @Override
    public INamedSoftwareArc42Document create() {
      return new NamedSoftwareArc42Document();
    }
    
    @Override
    public INamedSoftwareArc42Document create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new NamedSoftwareArc42Document(resourceRepository, resource);
    }
  
  };

  public NamedSoftwareArc42Document() {
    super(INamedSoftwareArc42Document.TYPE_ID);
  }
  
  public NamedSoftwareArc42Document(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
    super(resourceRepository, resource, INamedSoftwareArc42Document.TYPE_ID);
  }
  ...
  public NamedSoftwareArc42Document set__V_1_aE_introduction_aE_and_aE_goals(cleon.architecturemethods.arc42.metamodel.spec._01_introduction_and_goals.javamodel.IIntroductionAndGoals __V_1_aE_introduction_aE_and_aE_goals) {
  ...
  public NamedSoftwareArc42Document set__V_2_aE_architecture_aE_constraints(cleon.architecturemethods.arc42.metamodel.spec._02_architecture_constraints.javamodel.IArchitectureConstraints __V_2_aE_architecture_aE_constraints) {
  ...
  public NamedSoftwareArc42Document set__V_3_aE_system_aE_scope_aE_and_aE_context(cleon.architecturemethods.arc42.metamodel.spec._03_system_scope_and_context.javamodel.ISystemScopeAndContext __V_3_aE_system_aE_scope_aE_and_aE_context) {
  ...
  public NamedSoftwareArc42Document set__V_5_aE_buildingblockview(cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.software.javamodel.IBuildingBlockViewSoftware __V_5_aE_buildingblockview) {
  ...
  public NamedSoftwareArc42Document set__V_6_aE_runtimeview(cleon.architecturemethods.arc42.metamodel.spec._06_runtime_view.javamodel.IRuntimeView __V_6_aE_runtimeview) {
  ...
  public NamedSoftwareArc42Document set__V_7_aE_dataview(cleon.architecturemethods.arc42.metamodel.spec._08_data_view.javamodel.IDataView __V_7_aE_dataview) {
  ...
  public NamedSoftwareArc42Document set__V_8_aE_deploymentview(cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.javamodel.IDeploymentView __V_8_aE_deploymentview) {
  ...
  public NamedSoftwareArc42Document set__W_0_aE_architectural_aE_decisions(cleon.architecturemethods.arc42.metamodel.spec._10_design_decisions.javamodel.IArchitecturalDecisions __W_0_aE_architectural_aE_decisions) {
  ...
  public NamedSoftwareArc42Document set__W_3_aE_productview(cleon.architecturemethods.arc42.metamodel.spec._13_product_view.javamodel.IProductView __W_3_aE_productview) {
  ...
  public NamedSoftwareArc42Document set__W_4_aE_requirements_aE_coverage(cleon.architecturemethods.arc42.metamodel.spec._14_requirements_coverage.javamodel.IArc42RequirementCoverages __W_4_aE_requirements_aE_coverage) {
  ...
  public NamedSoftwareArc42Document setAbout(cleon.common.doc.metamodel.spec.chapter.about.javamodel.IAbout about) {
  ...
  public NamedSoftwareArc42Document setChapters(java.util.List<? extends cleon.common.doc.metamodel.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public NamedSoftwareArc42Document setDeliverable(cleon.projectmethods.hermes.metamodel.spec.modules.projectmanagement.planning.scope.deliverable.javamodel.IDeliverable deliverable) {
  ...
  public NamedSoftwareArc42Document setDocumentElements(java.util.List<? extends cleon.common.doc.metamodel.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public NamedSoftwareArc42Document setGlossary(cleon.common.glossary.metamodel.spec.javamodel.IGlossary glossary) {
  ...
  public NamedSoftwareArc42Document setLanguageSettings(cleon.common.language.metamodel.spec.language_settings.javamodel.ILanguageSettings languageSettings) {
  ...
  public NamedSoftwareArc42Document setNameTranslation(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.translation.name.javamodel.ILanguageNameTranslation> nameTranslation) {
  ...
  public NamedSoftwareArc42Document setPlanning(cleon.projectmethods.hermes.metamodel.spec.modules.projectmanagement.planning.javamodel.IPlanning planning) {
  ...
  public NamedSoftwareArc42Document setProperties(cleon.common.doc.metamodel.spec.document.properties.javamodel.IProperties properties) {
  ...
  public NamedSoftwareArc42Document setStyle(cleon.common.doc.metamodel.spec.document.style.javamodel.IStyle style) {
  ...
  public NamedSoftwareArc42Document setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,0f92ec08-a28d-11ef-9aea-bfda14a4d373,XWM0ulEWfnaOD1U5K765OfPShKM=] */
