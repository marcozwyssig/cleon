...
import cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.monitoring.sensor.snmpcustomadvanced.javamodel.Snmpcustomadvanced;
import cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.monitoring.sensor.snmpcustomtable.javamodel.Snmpcustomtable;
...
public class profiles__T_yaml {
  ...
  public static class SnmpCustomAdvancedChannelFunctionsImpl implements ISnmpCustomAdvancedChannelFunctionsImpl {
    ...
    public java.lang.Integer Position(final cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.monitoring.sensor.snmpcustomadvanced.javamodel.ISnmpCustomAdvancedChannel snmpCustomAdvancedChannel) {
      ...
      var i = 0;
      for( final var channelIter : functions.AllChannels()) {
      	++i;
  ...
  public static class SnmpCustomTableChannelFunctionsImpl implements ISnmpCustomTableChannelFunctionsImpl {
    ...
    public java.lang.Integer Position(final cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.monitoring.sensor.snmpcustomtable.javamodel.ISnmpCustomTableChannel snmpCustomTableChannel) {
      ...
      var i = 1;
      for( final var channel : parent.selectSnmpCustomTableChannels()) {
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,e4b3c6b7-cce7-11ea-8b73-6b1c6b53a7a6,ssmQVMeFBTl17R3hdtGLoWGBPis=] */
