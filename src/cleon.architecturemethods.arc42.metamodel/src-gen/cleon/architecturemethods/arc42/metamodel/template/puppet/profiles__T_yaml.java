...
public class profiles__T_yaml {
  ...
  public static class SnmpCustomAdvancedChannelFunctionsImpl implements ISnmpCustomAdvancedChannelFunctionsImpl {
    ...
    public java.lang.Integer Position(final cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.monitor.sensor.snmpcustomadvanced.javamodel.ISnmpCustomAdvancedChannel snmpCustomAdvancedChannel) {
      ...
      final var functions = snmpCustomAdvancedChannel.extension(cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.monitor.sensor.snmpcustomadvanced.FunctionSpace_SnmpCustomAdvanced.ISnmpCustomAdvancedChannelFunctions.class);
      var i = 0;
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,e4b3c6b7-cce7-11ea-8b73-6b1c6b53a7a6,lx8IzcuSPcf8HthOqPCy1wetg9E=] */
