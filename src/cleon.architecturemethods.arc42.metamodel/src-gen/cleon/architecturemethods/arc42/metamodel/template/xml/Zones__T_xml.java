...
public class Zones__T_xml {
  ...
  public static interface ISecuritySubZoneFunctions extends IDynamicResourceExtension {
    ...
    public List<ch.actifsource.core.javamodel.INamedResource> UsedInSystemConfiguration();
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,0355721a-9667-11e9-8b76-c3d78b95c27c,7F2qV/XfZhmUuQin5yXQjSBhitA=] */
