...
[#chapter-ebene_1_chess_softwaresystem_whitebox]
=== Ebene_1: Chess <SoftwareSystem> (Whitebox)
Motivation::
...
. <<#chapter-test1_samplebuildingblock_blackbox>>
. <<#chapter-test2_samplebuildingblock_blackbox>>
. <<#chapter-test3_samplebuildingblock_blackbox>>

[#chapter-test1_samplebuildingblock_blackbox]
===== Test1 <SampleBuildingBlock> (Blackbox)
In diesem Kapitel werden die Blackbox Eigenschaften des Bausteins Test1 ((<<#chapter-ebene_2_test1_samplebuildingblock_whitebox>>)) beschrieben.
...
In diesem Kapitel werden die Blackbox Eigenschaften des Bausteins Test2 ((<<#chapter-ebene_2_test2_samplebuildingblock_whitebox>>)) beschrieben.
...
In diesem Kapitel werden die Blackbox Eigenschaften des Bausteins Test3 ((<<#chapter-ebene_2_test3_samplebuildingblock_whitebox>>)) beschrieben.
...
// Actifsource ID=[803ac313-d64b-11ee-8014-c150876d6b6e,ad4be5f2-285a-11e8-9af4-b7d7a3bbddc1,dd7ae0a5-3339-11e8-a9fe-87ba35d8f5c4,ad4be5f2-285a-11e8-9af4-b7d7a3bbddc1,XAdgbcDgb3m0ZdjRFSm/MyU0oEY=]
