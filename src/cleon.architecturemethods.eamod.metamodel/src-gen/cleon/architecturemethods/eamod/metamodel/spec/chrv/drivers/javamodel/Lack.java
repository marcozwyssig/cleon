...
public class Lack extends DynamicResource implements ILack {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<ILack> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<ILack>() {
    ...
    @Override
    public ILack create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new Lack(resourceRepository, resource);
    }
  ...
  public Lack(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
    super(resourceRepository, resource, ILack.TYPE_ID);
  }
  ...
  public Lack setAuthors(cleon.common.doc.metamodel.spec.document.properties.member.javamodel.IMember authors) {
  ...
  public Lack setChapters(java.util.List<? extends cleon.common.doc.metamodel.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public Lack setDescriptionTranslation(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.translation.description.javamodel.ILanguageDescriptionTranslation> descriptionTranslation) {
  ...
  public Lack setDocumentElements(java.util.List<? extends cleon.common.doc.metamodel.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public Lack setNameTranslation(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.translation.name.javamodel.ILanguageNameTranslation> nameTranslation) {
  ...
  public Lack setNoChapters(cleon.common.doc.metamodel.spec.chapter.javamodel.IAbstractChapter noChapters) {
  ...
  public Lack setNoParagraphs(cleon.common.doc.metamodel.spec.paragraph.javamodel.IParagraph noParagraphs) {
  ...
  public Lack setOriginatesFromSource(java.util.List<? extends cleon.architecturemethods.eamod.metamodel.spec.chrv.sources.javamodel.ISource> originatesFromSource) {
  ...
  public Lack setParagraphs(java.util.List<? extends cleon.common.doc.metamodel.spec.paragraph.javamodel.IParagraph> paragraphs) {
  ...
  public Lack setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,340631a2-a95a-11e5-bda2-a7fc3bd7c783,y9B/jA6X+t8UhLn/XBb5c0z7bPk=] */
