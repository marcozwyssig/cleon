...
public class Goal extends DynamicResource implements IGoal {
  ...
  @Override
  public java.util.List<? extends cleon.architecturemethods.eamod.metamodel.spec.chrv.drivers.javamodel.IDriver> selectAddresses() {
    return _getList(cleon.architecturemethods.eamod.metamodel.spec.chrv.drivers.javamodel.IDriver.class, cleon.architecturemethods.eamod.metamodel.spec.chrv.drivers.DriversPackage.DriverAware_addresses);
  }

  public Goal setAddresses(java.util.List<? extends cleon.architecturemethods.eamod.metamodel.spec.chrv.drivers.javamodel.IDriver> addresses) {
    _setList(cleon.architecturemethods.eamod.metamodel.spec.chrv.drivers.DriversPackage.DriverAware_addresses, addresses);
    return this;
  }
  ...
  public Goal setAuthors(cleon.common.doc.metamodel.spec.document.properties.member.javamodel.IMember authors) {
  ...
  public Goal setDescriptionTranslation(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.translation.description.javamodel.ILanguageDescriptionTranslation> descriptionTranslation) {
  ...
  public java.util.List<? extends cleon.architecturemethods.eamod.metamodel.spec.chrv.goals.javamodel.IGoal> selectGoalAggregation() {
    return _getList(cleon.architecturemethods.eamod.metamodel.spec.chrv.goals.javamodel.IGoal.class, cleon.architecturemethods.eamod.metamodel.spec.chrv.goals.GoalsPackage.Goal_goalAggregation);
  }

  public Goal setGoalAggregation(java.util.List<? extends cleon.architecturemethods.eamod.metamodel.spec.chrv.goals.javamodel.IGoal> goalAggregation) {
    _setList(cleon.architecturemethods.eamod.metamodel.spec.chrv.goals.GoalsPackage.Goal_goalAggregation, goalAggregation);
    return this;
  }
  ...
  public Goal setOriginatesFromSource(java.util.List<? extends cleon.architecturemethods.eamod.metamodel.spec.chrv.sources.javamodel.ISource> originatesFromSource) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    // relations
    _acceptList(cleon.architecturemethods.eamod.metamodel.spec.chrv.drivers.javamodel.IDriver.class, cleon.architecturemethods.eamod.metamodel.spec.chrv.drivers.DriversPackage.DriverAware_addresses, visitor);
    ...
    _acceptList(cleon.architecturemethods.eamod.metamodel.spec.chrv.goals.javamodel.IGoal.class, cleon.architecturemethods.eamod.metamodel.spec.chrv.goals.GoalsPackage.Goal_goalAggregation, visitor);
  ...
  public static cleon.architecturemethods.eamod.metamodel.spec.chrv.goals.javamodel.IGoal selectToMeGoalAggregation(cleon.architecturemethods.eamod.metamodel.spec.chrv.goals.javamodel.IGoal object) {
    return _getToMeSingle(object.getRepository(), cleon.architecturemethods.eamod.metamodel.spec.chrv.goals.javamodel.IGoal.class, cleon.architecturemethods.eamod.metamodel.spec.chrv.goals.GoalsPackage.Goal_goalAggregation, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,31468bb8-a951-11e5-bda2-a7fc3bd7c783,vZdlvSI9QTHzAva2jvb5Qcc3SeE=] */
