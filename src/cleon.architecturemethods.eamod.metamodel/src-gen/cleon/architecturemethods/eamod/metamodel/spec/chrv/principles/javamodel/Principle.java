...
public class Principle extends DynamicResource implements IPrinciple {
  ...
  public Principle setAchieves(java.util.List<? extends cleon.architecturemethods.eamod.metamodel.spec.chrv.goals.javamodel.IGoal> achieves) {
  ...
  public java.util.List<? extends cleon.architecturemethods.eamod.metamodel.spec.chrv.principles.javamodel.IPrinciple> selectAggregation() {
    return _getList(cleon.architecturemethods.eamod.metamodel.spec.chrv.principles.javamodel.IPrinciple.class, cleon.architecturemethods.eamod.metamodel.spec.chrv.principles.PrinciplesPackage.Principle_aggregation);
  }

  public Principle setAggregation(java.util.List<? extends cleon.architecturemethods.eamod.metamodel.spec.chrv.principles.javamodel.IPrinciple> aggregation) {
    _setList(cleon.architecturemethods.eamod.metamodel.spec.chrv.principles.PrinciplesPackage.Principle_aggregation, aggregation);
    return this;
  }
  ...
  public Principle setAuthors(cleon.common.doc.metamodel.spec.document.properties.member.javamodel.IMember authors) {
  ...
  public Principle setChapters(java.util.List<? extends cleon.common.doc.metamodel.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public Principle setDescriptionTranslation(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.translation.description.javamodel.ILanguageDescriptionTranslation> descriptionTranslation) {
  ...
  public Principle setDocumentElements(java.util.List<? extends cleon.common.doc.metamodel.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public Principle setNameTranslation(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.translation.name.javamodel.ILanguageNameTranslation> nameTranslation) {
  ...
  public Principle setOriginatesFromSource(java.util.List<? extends cleon.architecturemethods.eamod.metamodel.spec.chrv.sources.javamodel.ISource> originatesFromSource) {
  ...
  public Principle setParagraphs(java.util.List<? extends cleon.common.doc.metamodel.spec.paragraph.javamodel.IParagraph> paragraphs) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptList(cleon.architecturemethods.eamod.metamodel.spec.chrv.principles.javamodel.IPrinciple.class, cleon.architecturemethods.eamod.metamodel.spec.chrv.principles.PrinciplesPackage.Principle_aggregation, visitor);
  ...
  public static cleon.architecturemethods.eamod.metamodel.spec.chrv.principles.javamodel.IPrinciple selectToMeAggregation(cleon.architecturemethods.eamod.metamodel.spec.chrv.principles.javamodel.IPrinciple object) {
    return _getToMeSingle(object.getRepository(), cleon.architecturemethods.eamod.metamodel.spec.chrv.principles.javamodel.IPrinciple.class, cleon.architecturemethods.eamod.metamodel.spec.chrv.principles.PrinciplesPackage.Principle_aggregation, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,6f06a6ec-a951-11e5-bda2-a7fc3bd7c783,cLO+WCSIz+xaIF5OYTVRbFkhg4s=] */
