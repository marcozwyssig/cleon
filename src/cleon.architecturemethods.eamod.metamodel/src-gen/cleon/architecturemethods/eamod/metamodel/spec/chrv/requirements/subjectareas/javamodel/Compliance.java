...
public class Compliance extends DynamicResource implements ICompliance {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<ICompliance> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<ICompliance>() {
    
    @Override
    public ICompliance create() {
      return new Compliance();
    }
    
    @Override
    public ICompliance create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new Compliance(resourceRepository, resource);
    }
  
  };

  public Compliance() {
    super(ICompliance.TYPE_ID);
  }
  
  public Compliance(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
    super(resourceRepository, resource, ICompliance.TYPE_ID);
  }
  ...
  public Compliance setAchieves(java.util.List<? extends cleon.architecturemethods.eamod.metamodel.spec.chrv.goals.javamodel.IGoal> achieves) {
  ...
  public Compliance setAuthors(cleon.common.doc.metamodel.spec.document.properties.member.javamodel.IMember authors) {
  ...
  public Compliance setChapters(java.util.List<? extends cleon.common.doc.metamodel.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public Compliance setDescriptionTranslation(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.translation.description.javamodel.ILanguageDescriptionTranslation> descriptionTranslation) {
  ...
  public Compliance setDocumentElements(java.util.List<? extends cleon.common.doc.metamodel.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public Compliance setOwners(java.util.List<? extends cleon.architecturemethods.eamod.metamodel.spec.chrv.stakeholder.javamodel.IStakeholder> owners) {
  ...
  public Compliance setParagraphs(java.util.List<? extends cleon.common.doc.metamodel.spec.paragraph.javamodel.IParagraph> paragraphs) {
  ...
  public Compliance setRequirements(java.util.List<? extends cleon.architecturemethods.eamod.metamodel.spec.chrv.requirements.subjectareas.requirement.javamodel.IRequirement> requirements) {
  ...
  public Compliance setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,d9f14ce9-0c77-11e6-86c5-87a8b520dd59,ANLatfuCaI54IPwVwqhSFaOo+NM=] */
