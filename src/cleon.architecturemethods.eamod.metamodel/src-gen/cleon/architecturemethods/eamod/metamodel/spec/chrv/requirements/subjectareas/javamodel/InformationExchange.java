...
public class InformationExchange extends DynamicResource implements IInformationExchange {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<IInformationExchange> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<IInformationExchange>() {
    
    @Override
    public IInformationExchange create() {
      return new InformationExchange();
    }
    
    @Override
    public IInformationExchange create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new InformationExchange(resourceRepository, resource);
    }
  
  };

  public InformationExchange() {
    super(IInformationExchange.TYPE_ID);
  }
  
  public InformationExchange(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
    super(resourceRepository, resource, IInformationExchange.TYPE_ID);
  }
  ...
  public InformationExchange setAchieves(java.util.List<? extends cleon.architecturemethods.eamod.metamodel.spec.chrv.goals.javamodel.IGoal> achieves) {
  ...
  public InformationExchange setAuthors(cleon.common.doc.metamodel.spec.document.properties.member.javamodel.IMember authors) {
  ...
  public InformationExchange setChapters(java.util.List<? extends cleon.common.doc.metamodel.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public InformationExchange setDescriptionTranslation(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.translation.description.javamodel.ILanguageDescriptionTranslation> descriptionTranslation) {
  ...
  public InformationExchange setDocumentElements(java.util.List<? extends cleon.common.doc.metamodel.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public InformationExchange setOwners(java.util.List<? extends cleon.architecturemethods.eamod.metamodel.spec.chrv.stakeholder.javamodel.IStakeholder> owners) {
  ...
  public InformationExchange setParagraphs(java.util.List<? extends cleon.common.doc.metamodel.spec.paragraph.javamodel.IParagraph> paragraphs) {
  ...
  public InformationExchange setRequirements(java.util.List<? extends cleon.architecturemethods.eamod.metamodel.spec.chrv.requirements.subjectareas.requirement.javamodel.IRequirement> requirements) {
  ...
  public InformationExchange setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,f2beb4bf-0c75-11e6-86c5-87a8b520dd59,J/vL+cb9zGcr+74MwpdbZNBxSVA=] */
