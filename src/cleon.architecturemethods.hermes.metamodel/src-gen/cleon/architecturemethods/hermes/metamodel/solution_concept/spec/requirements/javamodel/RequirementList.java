...
public class RequirementList extends DynamicResource implements IRequirementList {
  ...
  public java.util.List<? extends cleon.architecturemethods.hermes.metamodel.solution_concept.spec.requirements.javamodel.IRequirement> selectRequirements() {
    return _getList(cleon.architecturemethods.hermes.metamodel.solution_concept.spec.requirements.javamodel.IRequirement.class, cleon.architecturemethods.hermes.metamodel.solution_concept.spec.requirements.RequirementsPackage.RequirementList_requirements);
  }

  public RequirementList setRequirements(java.util.List<? extends cleon.architecturemethods.hermes.metamodel.solution_concept.spec.requirements.javamodel.IRequirement> requirements) {
    _setList(cleon.architecturemethods.hermes.metamodel.solution_concept.spec.requirements.RequirementsPackage.RequirementList_requirements, requirements);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptList(cleon.architecturemethods.hermes.metamodel.solution_concept.spec.requirements.javamodel.IRequirement.class, cleon.architecturemethods.hermes.metamodel.solution_concept.spec.requirements.RequirementsPackage.RequirementList_requirements, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

  // toMeRelations
  
  public static cleon.architecturemethods.hermes.metamodel.solution_concept.spec.requirements.javamodel.IRequirementList selectToMeRequirements(cleon.architecturemethods.hermes.metamodel.solution_concept.spec.requirements.javamodel.IRequirement object) {
    return _getToMeSingle(object.getRepository(), cleon.architecturemethods.hermes.metamodel.solution_concept.spec.requirements.javamodel.IRequirementList.class, cleon.architecturemethods.hermes.metamodel.solution_concept.spec.requirements.RequirementsPackage.RequirementList_requirements, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,db7b0419-d33e-11ef-802e-175af1a41dfa,zqsdILsy7cVmh9DePGeUMieqPj0=] */
