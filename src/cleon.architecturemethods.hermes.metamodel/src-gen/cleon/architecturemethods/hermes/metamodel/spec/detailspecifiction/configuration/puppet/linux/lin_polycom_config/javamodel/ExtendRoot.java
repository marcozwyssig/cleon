...
public class ExtendRoot extends DynamicResource implements IExtendRoot {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<IExtendRoot> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<IExtendRoot>() {
    
    @Override
    public IExtendRoot create() {
      return new ExtendRoot();
    }
    
    @Override
    public IExtendRoot create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new ExtendRoot(resourceRepository, resource);
    }
  
  };

  public ExtendRoot() {
    super(IExtendRoot.TYPE_ID);
  }
  
  public ExtendRoot(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
    super(resourceRepository, resource, IExtendRoot.TYPE_ID);
  }
  ...
  public ExtendRoot setChapters(java.util.List<? extends cleon.common.doc.metamodel.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public ExtendRoot setDescriptionTranslation(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.translation.description.javamodel.ILanguageDescriptionTranslation> descriptionTranslation) {
  ...
  public ExtendRoot setDocumentElements(java.util.List<? extends cleon.common.doc.metamodel.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public ExtendRoot setExtends(java.util.List<? extends cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.javamodel.IPuppetConfiguration> extends_) {
  ...
  public ExtendRoot setNoChapters(cleon.common.doc.metamodel.spec.chapter.javamodel.IAbstractChapter noChapters) {
  ...
  public ExtendRoot setParagraphs(java.util.List<? extends cleon.common.doc.metamodel.spec.paragraph.javamodel.IParagraph> paragraphs) {
  ...
  public ExtendRoot setSpecificationForSystemConfiguration(cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.systemconfiguration.javamodel.ISystemConfiguration specificationForSystemConfiguration) {
  ...
  public ExtendRoot setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,8feaa761-21e6-11f0-94ff-8381b76104b1,NtZiuhtD84upCV/upZqTGy+wzc0=] */
