...
public class LocalLinFw extends DynamicResource implements ILocalLinFw {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<ILocalLinFw> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<ILocalLinFw>() {
    
    @Override
    public ILocalLinFw create() {
      return new LocalLinFw();
    }
    
    @Override
    public ILocalLinFw create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new LocalLinFw(resourceRepository, resource);
    }
  
  };

  public LocalLinFw() {
    super(ILocalLinFw.TYPE_ID);
  }
  
  public LocalLinFw(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
    super(resourceRepository, resource, ILocalLinFw.TYPE_ID);
  }
  ...
  public LocalLinFw setChapters(java.util.List<? extends cleon.common.doc.metamodel.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public LocalLinFw setDescriptionTranslation(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.translation.description.javamodel.ILanguageDescriptionTranslation> descriptionTranslation) {
  ...
  public LocalLinFw setDocumentElements(java.util.List<? extends cleon.common.doc.metamodel.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public LocalLinFw setExtends(java.util.List<? extends cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.javamodel.IPuppetConfiguration> extends_) {
  ...
  public LocalLinFw setNoChapters(cleon.common.doc.metamodel.spec.chapter.javamodel.IAbstractChapter noChapters) {
  ...
  public LocalLinFw setParagraphs(java.util.List<? extends cleon.common.doc.metamodel.spec.paragraph.javamodel.IParagraph> paragraphs) {
  ...
  public LocalLinFw setProgramLocalFirewallRules(java.util.List<? extends cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.windows.win_polycom_operations.javamodel.IProgramLocalFirewallRule> programLocalFirewallRules) {
  ...
  public LocalLinFw setRules(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.windows.win_polycom_operations.javamodel.ILocalFwRule> rules) {
  ...
  public LocalLinFw setSpecificationForSystemConfiguration(cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.systemconfiguration.javamodel.ISystemConfiguration specificationForSystemConfiguration) {
  ...
  public LocalLinFw setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,b67537b6-ba3a-11f0-9349-73cfbb54b949,bjgxjU5yK30+Df1Io1VIGE8ysPk=] */
