...
public class SatelliteRegistration extends DynamicResource implements ISatelliteRegistration {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<ISatelliteRegistration> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<ISatelliteRegistration>() {
    
    @Override
    public ISatelliteRegistration create() {
      return new SatelliteRegistration();
    }
    
    @Override
    public ISatelliteRegistration create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new SatelliteRegistration(resourceRepository, resource);
    }
  
  };

  public SatelliteRegistration() {
    super(ISatelliteRegistration.TYPE_ID);
  }
  
  public SatelliteRegistration(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
    super(resourceRepository, resource, ISatelliteRegistration.TYPE_ID);
  }
  ...
  public java.lang.String selectCa_rpm_url() {
    return _getSingleAttribute(java.lang.String.class, cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.linux.lin_polycom_operations.Lin_polycom_operationsPackage.SatelliteRegistration_ca_aE_rpm_aE_url);
  }
    
  public void setCa_rpm_url(java.lang.String ca_rpm_url) {
     _setSingleAttribute(cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.linux.lin_polycom_operations.Lin_polycom_operationsPackage.SatelliteRegistration_ca_aE_rpm_aE_url, ca_rpm_url);
  }
  ...
  public java.lang.String selectUrl() {
    return _getSingleAttribute(java.lang.String.class, cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.linux.lin_polycom_operations.Lin_polycom_operationsPackage.SatelliteRegistration_url);
  }
    
  public void setUrl(java.lang.String url) {
     _setSingleAttribute(cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.linux.lin_polycom_operations.Lin_polycom_operationsPackage.SatelliteRegistration_url, url);
  }
  ...
  public SatelliteRegistration setChapters(java.util.List<? extends cleon.common.doc.metamodel.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public SatelliteRegistration setDescriptionTranslation(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.translation.description.javamodel.ILanguageDescriptionTranslation> descriptionTranslation) {
  ...
  public SatelliteRegistration setDocumentElements(java.util.List<? extends cleon.common.doc.metamodel.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public SatelliteRegistration setExtends(java.util.List<? extends cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.javamodel.IPuppetConfiguration> extends_) {
  ...
  public SatelliteRegistration setNoChapters(cleon.common.doc.metamodel.spec.chapter.javamodel.IAbstractChapter noChapters) {
  ...
  public SatelliteRegistration setParagraphs(java.util.List<? extends cleon.common.doc.metamodel.spec.paragraph.javamodel.IParagraph> paragraphs) {
  ...
  public cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.topology.javamodel.IAbstractHost selectSatellite_host() {
    return _getSingle(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.topology.javamodel.IAbstractHost.class, cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.linux.lin_polycom_operations.Lin_polycom_operationsPackage.SatelliteRegistration_satellite_aE_host);
  }

  public SatelliteRegistration setSatellite_host(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.topology.javamodel.IAbstractHost satellite_host) {
    _setSingle(cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.linux.lin_polycom_operations.Lin_polycom_operationsPackage.SatelliteRegistration_satellite_aE_host, satellite_host);
    return this;
  }
  ...
  public SatelliteRegistration setSpecificationForSystemConfiguration(cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.systemconfiguration.javamodel.ISystemConfiguration specificationForSystemConfiguration) {
  ...
  public SatelliteRegistration setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingleAttribute(java.lang.String.class, cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.linux.lin_polycom_operations.Lin_polycom_operationsPackage.SatelliteRegistration_url, visitor);
    // relations
