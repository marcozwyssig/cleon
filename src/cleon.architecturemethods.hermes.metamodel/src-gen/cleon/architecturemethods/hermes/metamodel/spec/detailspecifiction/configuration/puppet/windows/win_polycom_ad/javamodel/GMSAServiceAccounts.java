...
public class GMSAServiceAccounts extends DynamicResource implements IGMSAServiceAccounts {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<IGMSAServiceAccounts> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<IGMSAServiceAccounts>() {
    
    @Override
    public IGMSAServiceAccounts create() {
      return new GMSAServiceAccounts();
    }
    
    @Override
    public IGMSAServiceAccounts create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new GMSAServiceAccounts(resourceRepository, resource);
    }
  
  };

  public GMSAServiceAccounts() {
    super(IGMSAServiceAccounts.TYPE_ID);
  }
  
  public GMSAServiceAccounts(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
    super(resourceRepository, resource, IGMSAServiceAccounts.TYPE_ID);
  }
  ...
  public GMSAServiceAccounts setChapters(java.util.List<? extends cleon.common.doc.metamodel.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public GMSAServiceAccounts setDescriptionTranslation(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.translation.description.javamodel.ILanguageDescriptionTranslation> descriptionTranslation) {
  ...
  public GMSAServiceAccounts setDocumentElements(java.util.List<? extends cleon.common.doc.metamodel.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public GMSAServiceAccounts setExtends(java.util.List<? extends cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.javamodel.IPuppetConfiguration> extends_) {
  ...
  public GMSAServiceAccounts setNoChapters(cleon.common.doc.metamodel.spec.chapter.javamodel.IAbstractChapter noChapters) {
  ...
  public GMSAServiceAccounts setParagraphs(java.util.List<? extends cleon.common.doc.metamodel.spec.paragraph.javamodel.IParagraph> paragraphs) {
  ...
  public GMSAServiceAccounts setSpecificationForSystemConfiguration(cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.systemconfiguration.javamodel.ISystemConfiguration specificationForSystemConfiguration) {
  ...
  public GMSAServiceAccounts setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,25ae4e3b-059d-11f0-a294-67d88c30f2e4,flzUUUG3yRV+35dMYrGknLlO5qw=] */
