...
public class InstallFeatures extends DynamicResource implements IInstallFeatures {
  ...
  public java.lang.Boolean selectInclMgmt() {
    return _getSingleAttribute(java.lang.Boolean.class, cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.windows.win_polycom_feature_setup.Win_polycom_feature_setupPackage.InstallFeatures_inclMgmt);
  }
    
  public void setInclMgmt(java.lang.Boolean inclMgmt) {
     _setSingleAttribute(cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.windows.win_polycom_feature_setup.Win_polycom_feature_setupPackage.InstallFeatures_inclMgmt, inclMgmt);
  }
  ...
  public InstallFeatures setExtends(java.util.List<? extends cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.javamodel.IPuppetConfiguration> extends_) {
  ...
  public InstallFeatures setSpecifictionForSystemConfiguration(cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.systemconfiguration.javamodel.ISystemConfiguration specifictionForSystemConfiguration) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingleAttribute(java.lang.Boolean.class, cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.windows.win_polycom_feature_setup.Win_polycom_feature_setupPackage.InstallFeatures_inclMgmt, visitor);
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,0d5be0df-001a-11f0-945c-87b19aec41f4,HYeeBNSyG70h73ovU/NAwxarngM=] */
