...
public class UninstallFeatures extends DynamicResource implements IUninstallFeatures {
  ...
  public java.util.List<java.lang.String> selectFeaturesNames() {
    return _getListAttribute(java.lang.String.class, cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.windows.win_polycom_feature_setup.Win_polycom_feature_setupPackage.UninstallFeatures_featuresNames);
  }
    
  public void setFeaturesNames(java.util.List<java.lang.String> featuresNames) {
     _setListAttribute(cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.windows.win_polycom_feature_setup.Win_polycom_feature_setupPackage.UninstallFeatures_featuresNames, featuresNames);
  }
  ...
  public UninstallFeatures setExtends(java.util.List<? extends cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.javamodel.IPuppetConfiguration> extends_) {
  ...
  public UninstallFeatures setSpecificationForSystemConfiguration(cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.systemconfiguration.javamodel.ISystemConfiguration specificationForSystemConfiguration) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptListAttribute(java.lang.String.class, cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.windows.win_polycom_feature_setup.Win_polycom_feature_setupPackage.UninstallFeatures_featuresNames, visitor);
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,2923e708-0014-11f0-945c-87b19aec41f4,wFa7uuoSSgKl2cweiiaV2s912lw=] */
