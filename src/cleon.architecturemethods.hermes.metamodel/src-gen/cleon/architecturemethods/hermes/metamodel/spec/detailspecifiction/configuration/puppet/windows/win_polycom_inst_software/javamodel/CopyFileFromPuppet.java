...
public class CopyFileFromPuppet extends DynamicResource implements ICopyFileFromPuppet {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<ICopyFileFromPuppet> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<ICopyFileFromPuppet>() {
    
    @Override
    public ICopyFileFromPuppet create() {
      return new CopyFileFromPuppet();
    }
    
    @Override
    public ICopyFileFromPuppet create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new CopyFileFromPuppet(resourceRepository, resource);
    }
  
  };

  public CopyFileFromPuppet() {
    super(ICopyFileFromPuppet.TYPE_ID);
  }
  
  public CopyFileFromPuppet(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
    super(resourceRepository, resource, ICopyFileFromPuppet.TYPE_ID);
  }
  ...
  public CopyFileFromPuppet setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,bced6e66-1b6c-11f0-9c3a-8502b2fb88fb,d278zg+TByighfHVZQw5hmeZWy0=] */
