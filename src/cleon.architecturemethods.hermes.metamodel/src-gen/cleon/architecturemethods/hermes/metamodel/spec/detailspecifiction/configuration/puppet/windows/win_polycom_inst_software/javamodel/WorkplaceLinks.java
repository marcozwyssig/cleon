...
public class WorkplaceLinks extends DynamicResource implements IWorkplaceLinks {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<IWorkplaceLinks> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<IWorkplaceLinks>() {
    
    @Override
    public IWorkplaceLinks create() {
      return new WorkplaceLinks();
    }
    
    @Override
    public IWorkplaceLinks create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new WorkplaceLinks(resourceRepository, resource);
    }
  
  };

  public WorkplaceLinks() {
    super(IWorkplaceLinks.TYPE_ID);
  }
  
  public WorkplaceLinks(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
    super(resourceRepository, resource, IWorkplaceLinks.TYPE_ID);
  }
  ...
  @Override
  public java.lang.String selectTopLevelName() {
    return _getSingleAttribute(java.lang.String.class, cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.windows.win_polycom_inst_software.Win_polycom_inst_softwarePackage.WorkplaceLinks_topLevelName);
  }
    
  public void setTopLevelName(java.lang.String topLevelName) {
     _setSingleAttribute(cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.windows.win_polycom_inst_software.Win_polycom_inst_softwarePackage.WorkplaceLinks_topLevelName, topLevelName);
  }
  ...
  public WorkplaceLinks setChapters(java.util.List<? extends cleon.common.doc.metamodel.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public WorkplaceLinks setDescriptionTranslation(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.translation.description.javamodel.ILanguageDescriptionTranslation> descriptionTranslation) {
  ...
  public WorkplaceLinks setDocumentElements(java.util.List<? extends cleon.common.doc.metamodel.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public WorkplaceLinks setExtends(java.util.List<? extends cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.javamodel.IPuppetConfiguration> extends_) {
  ...
  public WorkplaceLinks setNoChapters(cleon.common.doc.metamodel.spec.chapter.javamodel.IAbstractChapter noChapters) {
  ...
  public WorkplaceLinks setParagraphs(java.util.List<? extends cleon.common.doc.metamodel.spec.paragraph.javamodel.IParagraph> paragraphs) {
  ...
  public WorkplaceLinks setSpecificationForSystemConfiguration(cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.systemconfiguration.javamodel.ISystemConfiguration specificationForSystemConfiguration) {
  ...
  public WorkplaceLinks setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingleAttribute(java.lang.String.class, cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.windows.win_polycom_inst_software.Win_polycom_inst_softwarePackage.WorkplaceLinks_topLevelName, visitor);
    // relations
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,6389fd00-2cac-11f0-851f-3f768d79c0eb,v4erStRhO3XoPnmKra9U11KmDYI=] */
