...
public class Ethernet_8021x extends DynamicResource implements IEthernet_8021x {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<IEthernet_8021x> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<IEthernet_8021x>() {
    
    @Override
    public IEthernet_8021x create() {
      return new Ethernet_8021x();
    }
    
    @Override
    public IEthernet_8021x create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new Ethernet_8021x(resourceRepository, resource);
    }
  
  };

  public Ethernet_8021x() {
    super(IEthernet_8021x.TYPE_ID);
  }
  
  public Ethernet_8021x(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
    super(resourceRepository, resource, IEthernet_8021x.TYPE_ID);
  }
  ...
  public Ethernet_8021x setChapters(java.util.List<? extends cleon.common.doc.metamodel.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public Ethernet_8021x setDescriptionTranslation(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.translation.description.javamodel.ILanguageDescriptionTranslation> descriptionTranslation) {
  ...
  public Ethernet_8021x setDocumentElements(java.util.List<? extends cleon.common.doc.metamodel.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public Ethernet_8021x setExtends(java.util.List<? extends cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.javamodel.IPuppetConfiguration> extends_) {
  ...
  public Ethernet_8021x setNoChapters(cleon.common.doc.metamodel.spec.chapter.javamodel.IAbstractChapter noChapters) {
  ...
  public Ethernet_8021x setParagraphs(java.util.List<? extends cleon.common.doc.metamodel.spec.paragraph.javamodel.IParagraph> paragraphs) {
  ...
  public Ethernet_8021x setSpecificationForSystemConfiguration(cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.systemconfiguration.javamodel.ISystemConfiguration specificationForSystemConfiguration) {
  ...
  public Ethernet_8021x setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,8e48f3a9-ba54-11f0-9349-73cfbb54b949,MVINDHiljNH8WSJWQ4zbdZM0nOc=] */
