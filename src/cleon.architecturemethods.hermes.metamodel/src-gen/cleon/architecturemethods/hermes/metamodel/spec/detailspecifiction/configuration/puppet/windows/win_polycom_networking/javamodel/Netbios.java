...
public class Netbios extends DynamicResource implements INetbios {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<INetbios> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<INetbios>() {
    
    @Override
    public INetbios create() {
      return new Netbios();
    }
    
    @Override
    public INetbios create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new Netbios(resourceRepository, resource);
    }
  
  };

  public Netbios() {
    super(INetbios.TYPE_ID);
  }
  
  public Netbios(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
    super(resourceRepository, resource, INetbios.TYPE_ID);
  }
  ...
  @Override
  public java.lang.String selectSetting() {
    return _getSingleAttribute(java.lang.String.class, cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.windows.win_polycom_networking.Win_polycom_networkingPackage.Netbios_setting);
  }
    
  public void setSetting(java.lang.String setting) {
     _setSingleAttribute(cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.windows.win_polycom_networking.Win_polycom_networkingPackage.Netbios_setting, setting);
  }
  ...
  public Netbios setChapters(java.util.List<? extends cleon.common.doc.metamodel.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public Netbios setDescriptionTranslation(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.translation.description.javamodel.ILanguageDescriptionTranslation> descriptionTranslation) {
  ...
  public Netbios setDocumentElements(java.util.List<? extends cleon.common.doc.metamodel.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public Netbios setExtends(java.util.List<? extends cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.javamodel.IPuppetConfiguration> extends_) {
  ...
  public Netbios setNoChapters(cleon.common.doc.metamodel.spec.chapter.javamodel.IAbstractChapter noChapters) {
  ...
  public Netbios setParagraphs(java.util.List<? extends cleon.common.doc.metamodel.spec.paragraph.javamodel.IParagraph> paragraphs) {
  ...
  public Netbios setSpecificationForSystemConfiguration(cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.systemconfiguration.javamodel.ISystemConfiguration specificationForSystemConfiguration) {
  ...
  public Netbios setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingleAttribute(java.lang.String.class, cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.windows.win_polycom_networking.Win_polycom_networkingPackage.Netbios_setting, visitor);
    // relations
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,b5967b7c-1088-11f0-b378-11a495632127,T69HJCN+B4h5wXm+gTrr7pCMq8A=] */
