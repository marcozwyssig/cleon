...
public class EpoComputerGroups extends DynamicResource implements IEpoComputerGroups {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<IEpoComputerGroups> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<IEpoComputerGroups>() {
    
    @Override
    public IEpoComputerGroups create() {
      return new EpoComputerGroups();
    }
    
    @Override
    public IEpoComputerGroups create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new EpoComputerGroups(resourceRepository, resource);
    }
  
  };

  public EpoComputerGroups() {
    super(IEpoComputerGroups.TYPE_ID);
  }
  
  public EpoComputerGroups(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
    super(resourceRepository, resource, IEpoComputerGroups.TYPE_ID);
  }
  ...
  public EpoComputerGroups setChapters(java.util.List<? extends cleon.common.doc.metamodel.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public EpoComputerGroups setDescriptionTranslation(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.translation.description.javamodel.ILanguageDescriptionTranslation> descriptionTranslation) {
  ...
  public EpoComputerGroups setDocumentElements(java.util.List<? extends cleon.common.doc.metamodel.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public EpoComputerGroups setExtends(java.util.List<? extends cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.javamodel.IPuppetConfiguration> extends_) {
  ...
  public EpoComputerGroups setNoChapters(cleon.common.doc.metamodel.spec.chapter.javamodel.IAbstractChapter noChapters) {
  ...
  public EpoComputerGroups setParagraphs(java.util.List<? extends cleon.common.doc.metamodel.spec.paragraph.javamodel.IParagraph> paragraphs) {
  ...
  public EpoComputerGroups setSpecificationForSystemConfiguration(cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.systemconfiguration.javamodel.ISystemConfiguration specificationForSystemConfiguration) {
  ...
  public EpoComputerGroups setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,ef8ac7bf-2cce-11f0-851f-3f768d79c0eb,qrCBx3uQw6VUfQCTkeMUcaIRQ4E=] */
