...
public class RemoteDesktopLicense extends DynamicResource implements IRemoteDesktopLicense {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<IRemoteDesktopLicense> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<IRemoteDesktopLicense>() {
    
    @Override
    public IRemoteDesktopLicense create() {
      return new RemoteDesktopLicense();
    }
    
    @Override
    public IRemoteDesktopLicense create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new RemoteDesktopLicense(resourceRepository, resource);
    }
  
  };

  public RemoteDesktopLicense() {
    super(IRemoteDesktopLicense.TYPE_ID);
  }
  
  public RemoteDesktopLicense(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
    super(resourceRepository, resource, IRemoteDesktopLicense.TYPE_ID);
  }
  ...
  public RemoteDesktopLicense setChapters(java.util.List<? extends cleon.common.doc.metamodel.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public RemoteDesktopLicense setDescriptionTranslation(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.translation.description.javamodel.ILanguageDescriptionTranslation> descriptionTranslation) {
  ...
  public RemoteDesktopLicense setDocumentElements(java.util.List<? extends cleon.common.doc.metamodel.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public RemoteDesktopLicense setExtends(java.util.List<? extends cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.javamodel.IPuppetConfiguration> extends_) {
  ...
  @Override
  public cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.topology.javamodel.IAbstractHost selectLicenseServer() {
    return _getSingle(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.topology.javamodel.IAbstractHost.class, cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.windows.win_polycom_remote_desktop.Win_polycom_remote_desktopPackage.RemoteDesktopLicense_licenseServer);
  }

  public RemoteDesktopLicense setLicenseServer(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.topology.javamodel.IAbstractHost licenseServer) {
    _setSingle(cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.windows.win_polycom_remote_desktop.Win_polycom_remote_desktopPackage.RemoteDesktopLicense_licenseServer, licenseServer);
    return this;
  }
  ...
  public RemoteDesktopLicense setNoChapters(cleon.common.doc.metamodel.spec.chapter.javamodel.IAbstractChapter noChapters) {
  ...
  public RemoteDesktopLicense setParagraphs(java.util.List<? extends cleon.common.doc.metamodel.spec.paragraph.javamodel.IParagraph> paragraphs) {
  ...
  public RemoteDesktopLicense setSpecificationForSystemConfiguration(cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.systemconfiguration.javamodel.ISystemConfiguration specificationForSystemConfiguration) {
  ...
  public RemoteDesktopLicense setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
  ...
  public static java.util.List<cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.windows.win_polycom_remote_desktop.javamodel.IRemoteDesktopLicense> selectToMeLicenseServer(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.topology.javamodel.IAbstractHost object) {
    return _getToMeList(object.getRepository(), cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.windows.win_polycom_remote_desktop.javamodel.IRemoteDesktopLicense.class, cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.windows.win_polycom_remote_desktop.Win_polycom_remote_desktopPackage.RemoteDesktopLicense_licenseServer, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,503e3255-79da-11f0-be97-ebecaa61a3a3,yhZ9azHGx4Nbe1FOb2Tqhc8giJw=] */
