...
public class WsusApprovalBlacklist extends DynamicResource implements IWsusApprovalBlacklist {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<IWsusApprovalBlacklist> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<IWsusApprovalBlacklist>() {
    
    @Override
    public IWsusApprovalBlacklist create() {
      return new WsusApprovalBlacklist();
    }
    
    @Override
    public IWsusApprovalBlacklist create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new WsusApprovalBlacklist(resourceRepository, resource);
    }
  
  };

  public WsusApprovalBlacklist() {
    super(IWsusApprovalBlacklist.TYPE_ID);
  }
  
  public WsusApprovalBlacklist(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
    super(resourceRepository, resource, IWsusApprovalBlacklist.TYPE_ID);
  }
  ...
  public WsusApprovalBlacklist setChapters(java.util.List<? extends cleon.common.doc.metamodel.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public WsusApprovalBlacklist setDescriptionTranslation(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.translation.description.javamodel.ILanguageDescriptionTranslation> descriptionTranslation) {
  ...
  public WsusApprovalBlacklist setDocumentElements(java.util.List<? extends cleon.common.doc.metamodel.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public WsusApprovalBlacklist setExtends(java.util.List<? extends cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.configuration.puppet.javamodel.IPuppetConfiguration> extends_) {
  ...
  public WsusApprovalBlacklist setNoChapters(cleon.common.doc.metamodel.spec.chapter.javamodel.IAbstractChapter noChapters) {
  ...
  public WsusApprovalBlacklist setParagraphs(java.util.List<? extends cleon.common.doc.metamodel.spec.paragraph.javamodel.IParagraph> paragraphs) {
  ...
  public WsusApprovalBlacklist setSpecificationForSystemConfiguration(cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.systemconfiguration.javamodel.ISystemConfiguration specificationForSystemConfiguration) {
  ...
  public WsusApprovalBlacklist setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,55df32c6-8a6b-11f0-af5e-cd5d044ab02b,ALLULR157gm3EXNMK7VURWZfuP0=] */
