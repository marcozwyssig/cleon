...
public class DataCenterSpecifications extends DynamicResource implements IDataCenterSpecifications {
  ...
  public DataCenterSpecifications setDatacenter(cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy.environment.node.supplynode.javamodel.ISupplyDataCenter datacenter) {
    _setSingle(cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.env.EnvPackage.DataCenterSpecifications_datacenter, datacenter);
    return this;
  }
  ...
  public cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy.environment.javamodel.IDeploymentEnvironmentRootNode selectEnvironment() {
    return _getSingle(cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy.environment.javamodel.IDeploymentEnvironmentRootNode.class, cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.env.EnvPackage.DataCenterSpecifications_environment);
  }
  ...
  public DataCenterSpecifications setEnvironment(cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy.environment.javamodel.IDeploymentEnvironmentRootNode environment) {
    _setSingle(cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.env.EnvPackage.DataCenterSpecifications_environment, environment);
    return this;
  }
  ...
  public java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.env.javamodel.IHostSpecification> selectHostSpecification() {
    return _getMap(cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.env.javamodel.IHostSpecification.class, cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.env.EnvPackage.DataCenterSpecifications_hostSpecification);
  }

  public DataCenterSpecifications setHostSpecification(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.env.javamodel.IHostSpecification> hostSpecification) {
    _setMap(cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.env.EnvPackage.DataCenterSpecifications_hostSpecification, hostSpecification);
    return this;
  }
  ...
  public cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy.environment.node.supplynode.javamodel.ISupplySiteNode selectSite() {
    return _getSingle(cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy.environment.node.supplynode.javamodel.ISupplySiteNode.class, cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.env.EnvPackage.DataCenterSpecifications_site);
  }
  ...
  public static cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.env.javamodel.IDataCenterSpecifications selectToMeHostSpecification(cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.env.javamodel.IHostSpecification object) {
    return _getToMeSingle(object.getRepository(), cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.env.javamodel.IDataCenterSpecifications.class, cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.env.EnvPackage.DataCenterSpecifications_hostSpecification, object.getResource());
  }
  
  public static java.util.List<cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.env.javamodel.IDataCenterSpecifications> selectToMeDatacenter(cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy.environment.node.supplynode.javamodel.ISupplyDataCenter object) {
    return _getToMeList(object.getRepository(), cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.env.javamodel.IDataCenterSpecifications.class, cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.env.EnvPackage.DataCenterSpecifications_datacenter, object.getResource());
  }
  
  public static java.util.List<cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.env.javamodel.IDataCenterSpecifications> selectToMeSite(cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy.environment.node.supplynode.javamodel.ISupplySiteNode object) {
    return _getToMeList(object.getRepository(), cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.env.javamodel.IDataCenterSpecifications.class, cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.env.EnvPackage.DataCenterSpecifications_site, object.getResource());
  }
  
  public static java.util.List<cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.env.javamodel.IDataCenterSpecifications> selectToMeEnvironment(cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy.environment.javamodel.IDeploymentEnvironmentRootNode object) {
    return _getToMeList(object.getRepository(), cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.env.javamodel.IDataCenterSpecifications.class, cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.env.EnvPackage.DataCenterSpecifications_environment, object.getResource());
  }
