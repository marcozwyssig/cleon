...
public class SysCfgSpecification extends DynamicResource implements ISysCfgSpecification {
  ...
  public SysCfgSpecification setApp(cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.specification.cmp.syscfg.application.javamodel.ISysCfgAppCategorySpecification app) {
  ...
  public SysCfgSpecification setHw(cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.specification.cmp.syscfg.hardware.javamodel.ISysCfgHwCategorySpecification hw) {
  ...
  public SysCfgSpecification setOs(cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.specification.cmp.syscfg.os.javamodel.ISysCfgOsCategorySpecification os) {
  ...
  public SysCfgSpecification setSpecificationForSystemConfiguration(cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.systemconfiguration.javamodel.ISystemConfiguration specificationForSystemConfiguration) {
    _setSingle(cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.specification.cmp.syscfg.SyscfgPackage.SysCfgSpecification_specificationForSystemConfiguration, specificationForSystemConfiguration);
    return this;
  }
  ...
  public static java.util.List<cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.specification.cmp.syscfg.javamodel.ISysCfgSpecification> selectToMeSpecificationForSystemConfiguration(cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.systemconfiguration.javamodel.ISystemConfiguration object) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,3f1f77e0-e64c-11e8-9ed8-5f22de89d1df,km08t4Jr5kouMWCp2i6eV67gBQA=] */
