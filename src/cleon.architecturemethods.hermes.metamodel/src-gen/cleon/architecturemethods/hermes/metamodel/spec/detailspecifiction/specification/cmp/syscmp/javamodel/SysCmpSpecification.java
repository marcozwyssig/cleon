...
public class SysCmpSpecification extends DynamicResource implements ISysCmpSpecification {
  ...
  public cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.systemcomponent.javamodel.ISystemComponent selectSpecificationForSystemComponent() {
    return _getSingle(cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.systemcomponent.javamodel.ISystemComponent.class, cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.specification.cmp.syscmp.SyscmpPackage.SysCmpSpecification_specificationForSystemComponent);
  }
  ...
  public SysCmpSpecification setSpecificationForSystemComponent(cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.systemcomponent.javamodel.ISystemComponent specificationForSystemComponent) {
    _setSingle(cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.specification.cmp.syscmp.SyscmpPackage.SysCmpSpecification_specificationForSystemComponent, specificationForSystemComponent);
    return this;
  }
  ...
  public SysCmpSpecification setSystemConfigurationSpecifications(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.specification.cmp.syscfg.javamodel.ISysCfgSpecification> systemConfigurationSpecifications) {
  ...
  public static java.util.List<cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.specification.cmp.syscmp.javamodel.ISysCmpSpecification> selectToMeSpecificationForSystemComponent(cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.systemcomponent.javamodel.ISystemComponent object) {
    return _getToMeList(object.getRepository(), cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.specification.cmp.syscmp.javamodel.ISysCmpSpecification.class, cleon.architecturemethods.hermes.metamodel.spec.detailspecifiction.specification.cmp.syscmp.SyscmpPackage.SysCmpSpecification_specificationForSystemComponent, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,60d7a195-e64b-11e8-9ed8-5f22de89d1df,dchpeEQIbPsKP0WKeV3PQtOHb4s=] */
