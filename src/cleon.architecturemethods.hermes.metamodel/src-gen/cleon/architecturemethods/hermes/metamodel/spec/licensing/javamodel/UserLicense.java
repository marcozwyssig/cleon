...
public class UserLicense extends DynamicResource implements IUserLicense {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<IUserLicense> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<IUserLicense>() {
    
    @Override
    public IUserLicense create() {
      return new UserLicense();
    }
    
    @Override
    public IUserLicense create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new UserLicense(resourceRepository, resource);
    }
  
  };

  public UserLicense() {
    super(IUserLicense.TYPE_ID);
  }
  
  public UserLicense(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
    super(resourceRepository, resource, IUserLicense.TYPE_ID);
  }
  ...
  public UserLicense setChapters(java.util.List<? extends cleon.common.doc.metamodel.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public UserLicense setDescriptionTranslation(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.translation.description.javamodel.ILanguageDescriptionTranslation> descriptionTranslation) {
  ...
  public UserLicense setDocumentElements(java.util.List<? extends cleon.common.doc.metamodel.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public UserLicense setNoChapters(cleon.common.doc.metamodel.spec.chapter.javamodel.IAbstractChapter noChapters) {
  ...
  public UserLicense setParagraphs(java.util.List<? extends cleon.common.doc.metamodel.spec.paragraph.javamodel.IParagraph> paragraphs) {
  ...
  public UserLicense setTarget(ch.actifsource.core.javamodel.IResource target) {
  ...
  public UserLicense setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,c296db3a-dfd1-11ef-b0be-9b4cac321140,3LQvg+IkYxzoZzXSWN7Hqm2n5Q8=] */
