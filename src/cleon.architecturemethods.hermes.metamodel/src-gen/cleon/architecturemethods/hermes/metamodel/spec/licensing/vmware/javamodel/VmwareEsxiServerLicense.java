...
public class VmwareEsxiServerLicense extends DynamicResource implements IVmwareEsxiServerLicense {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<IVmwareEsxiServerLicense> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<IVmwareEsxiServerLicense>() {
    
    @Override
    public IVmwareEsxiServerLicense create() {
      return new VmwareEsxiServerLicense();
    }
    
    @Override
    public IVmwareEsxiServerLicense create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new VmwareEsxiServerLicense(resourceRepository, resource);
    }
  
  };

  public VmwareEsxiServerLicense() {
    super(IVmwareEsxiServerLicense.TYPE_ID);
  }
  
  public VmwareEsxiServerLicense(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
    super(resourceRepository, resource, IVmwareEsxiServerLicense.TYPE_ID);
  }
  ...
  public java.lang.String selectRecommendedLicense() {
    return _getSingleAttribute(java.lang.String.class, cleon.architecturemethods.hermes.metamodel.spec.licensing.vmware.VmwarePackage.VmwareEsxiServerLicense_recommendedLicense);
  }
    
  public void setRecommendedLicense(java.lang.String recommendedLicense) {
     _setSingleAttribute(cleon.architecturemethods.hermes.metamodel.spec.licensing.vmware.VmwarePackage.VmwareEsxiServerLicense_recommendedLicense, recommendedLicense);
  }

  @Override
  public java.lang.Integer selectRequiredLicenses() {
    return _getSingleAttribute(java.lang.Integer.class, cleon.architecturemethods.hermes.metamodel.spec.licensing.vmware.VmwarePackage.VmwareEsxiServerLicense_requiredLicenses);
  }
    
  public void setRequiredLicenses(java.lang.Integer requiredLicenses) {
     _setSingleAttribute(cleon.architecturemethods.hermes.metamodel.spec.licensing.vmware.VmwarePackage.VmwareEsxiServerLicense_requiredLicenses, requiredLicenses);
  }
  ...
  public VmwareEsxiServerLicense setChapters(java.util.List<? extends cleon.common.doc.metamodel.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public VmwareEsxiServerLicense setDescriptionTranslation(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.translation.description.javamodel.ILanguageDescriptionTranslation> descriptionTranslation) {
  ...
  public VmwareEsxiServerLicense setDocumentElements(java.util.List<? extends cleon.common.doc.metamodel.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public VmwareEsxiServerLicense setLicenseForEnvironment(cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deploy.javamodel.IEnvironment licenseForEnvironment) {
  ...
  public VmwareEsxiServerLicense setNoChapters(cleon.common.doc.metamodel.spec.chapter.javamodel.IAbstractChapter noChapters) {
  ...
  public VmwareEsxiServerLicense setParagraphs(java.util.List<? extends cleon.common.doc.metamodel.spec.paragraph.javamodel.IParagraph> paragraphs) {
  ...
  public VmwareEsxiServerLicense setTarget(ch.actifsource.core.javamodel.IResource target) {
  ...
  public VmwareEsxiServerLicense setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
  ...
  public cleon.architecturemethods.hermes.metamodel.spec.licensing.vmware.javamodel.IVMwarevSphereLicense selectVmwareEsxiLicense() {
    return _getSingle(cleon.architecturemethods.hermes.metamodel.spec.licensing.vmware.javamodel.IVMwarevSphereLicense.class, cleon.architecturemethods.hermes.metamodel.spec.licensing.vmware.VmwarePackage.VmwareEsxiServerLicense_vmwareEsxiLicense);
  }

  public VmwareEsxiServerLicense setVmwareEsxiLicense(cleon.architecturemethods.hermes.metamodel.spec.licensing.vmware.javamodel.IVMwarevSphereLicense vmwareEsxiLicense) {
    _setSingle(cleon.architecturemethods.hermes.metamodel.spec.licensing.vmware.VmwarePackage.VmwareEsxiServerLicense_vmwareEsxiLicense, vmwareEsxiLicense);
    return this;
  }
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,b94498f2-e4a2-11ef-a6bd-497168f25adc,G0PoQCdPHw+hWxON0ulc6ADdqIw=] */
