...
public class Requirements extends DynamicResource implements IRequirements {
  ...
  @Override
  public java.util.List<? extends cleon.architecturemethods.hermes.metamodel.spec.solution_concept.requirements.javamodel.IRequirementList> selectRequirements() {
    return _getList(cleon.architecturemethods.hermes.metamodel.spec.solution_concept.requirements.javamodel.IRequirementList.class, cleon.architecturemethods.hermes.metamodel.spec.solution_concept.requirements.RequirementsPackage.Requirements_requirements);
  }

  public Requirements setRequirements(java.util.List<? extends cleon.architecturemethods.hermes.metamodel.spec.solution_concept.requirements.javamodel.IRequirementList> requirements) {
    _setList(cleon.architecturemethods.hermes.metamodel.spec.solution_concept.requirements.RequirementsPackage.Requirements_requirements, requirements);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptList(cleon.architecturemethods.hermes.metamodel.spec.solution_concept.requirements.javamodel.IRequirementList.class, cleon.architecturemethods.hermes.metamodel.spec.solution_concept.requirements.RequirementsPackage.Requirements_requirements, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

  // toMeRelations
  
  public static cleon.architecturemethods.hermes.metamodel.spec.solution_concept.requirements.javamodel.IRequirements selectToMeRequirements(cleon.architecturemethods.hermes.metamodel.spec.solution_concept.requirements.javamodel.IRequirementList object) {
    return _getToMeSingle(object.getRepository(), cleon.architecturemethods.hermes.metamodel.spec.solution_concept.requirements.javamodel.IRequirements.class, cleon.architecturemethods.hermes.metamodel.spec.solution_concept.requirements.RequirementsPackage.Requirements_requirements, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,f6e6f679-d33a-11ef-802e-175af1a41dfa,edIUdiyp+qkkKe5YJZeJlQi90S4=] */
