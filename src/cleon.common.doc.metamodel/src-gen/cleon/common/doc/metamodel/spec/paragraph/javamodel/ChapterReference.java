...
public class ChapterReference extends DynamicResource implements IChapterReference {
  ...
  public ChapterReference setParagraphs(java.util.List<? extends cleon.common.doc.metamodel.spec.paragraph.javamodel.IParagraph> paragraphs) {
  ...
  public static java.util.List<cleon.common.doc.metamodel.spec.paragraph.javamodel.IChapterReference> selectToMeChapterRef(cleon.common.doc.metamodel.spec.chapter.javamodel.IAbstractChapter object) {
    return _getToMeList(object.getRepository(), cleon.common.doc.metamodel.spec.paragraph.javamodel.IChapterReference.class, cleon.common.doc.metamodel.spec.paragraph.ParagraphPackage.ChapterReference_chapterRef, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,5c6eca85-dd88-11ef-9ced-81351e97716a,oCgSKcPxGC7Qv2Z3hDmuvgIHh2s=] */
