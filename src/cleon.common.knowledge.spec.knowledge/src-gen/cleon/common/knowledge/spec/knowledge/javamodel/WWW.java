...
public class WWW extends DynamicResource implements IWWW {
  ...
  public java.net.URL selectUrl() {
    return _getSingleAttribute(java.net.URL.class, cleon.common.knowledge.spec.knowledge.KnowledgePackage.WWW_url);
  }
    
  public void setUrl(java.net.URL url) {
     _setSingleAttribute(cleon.common.knowledge.spec.knowledge.KnowledgePackage.WWW_url, url);
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingleAttribute(java.net.URL.class, cleon.common.knowledge.spec.knowledge.KnowledgePackage.WWW_url, visitor);
    // relations
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,caf61b68-b797-11e6-85e2-39e149963066,3Ku/7Za+D1R4lDYkOZY1EuMdnLw=] */
