...
public class LanguageClass extends DynamicResource implements ILanguageClass {
  ...
  public LanguageClass setLanguageSettings(cleon.common.language.metamodel.spec.language_settings.javamodel.ILanguageSettings languageSettings) {
  ...
  @Override
  public java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.language_class.javamodel.ILanguageNameAspectTranslation> selectTranslations() {
    return _getMap(cleon.common.language.metamodel.spec.language_class.javamodel.ILanguageNameAspectTranslation.class, cleon.common.language.metamodel.spec.language_class.Language_classPackage.LanguageClass_translations);
  }

  public LanguageClass setTranslations(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.language_class.javamodel.ILanguageNameAspectTranslation> translations) {
    _setMap(cleon.common.language.metamodel.spec.language_class.Language_classPackage.LanguageClass_translations, translations);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptMap(cleon.common.language.metamodel.spec.language_class.javamodel.ILanguageNameAspectTranslation.class, cleon.common.language.metamodel.spec.language_class.Language_classPackage.LanguageClass_translations, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

  // toMeRelations
  
  public static cleon.common.language.metamodel.spec.language_class.javamodel.ILanguageClass selectToMeTranslations(cleon.common.language.metamodel.spec.language_class.javamodel.ILanguageNameAspectTranslation object) {
    return _getToMeSingle(object.getRepository(), cleon.common.language.metamodel.spec.language_class.javamodel.ILanguageClass.class, cleon.common.language.metamodel.spec.language_class.Language_classPackage.LanguageClass_translations, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,af81de75-c04e-11ee-bc88-af1934b8c942,AmXTbAkRWO8j6KJV9H3Fzr5eLRc=] */
