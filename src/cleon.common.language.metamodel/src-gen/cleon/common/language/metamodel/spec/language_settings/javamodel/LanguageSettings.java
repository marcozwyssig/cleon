package cleon.common.language.metamodel.spec.language_settings.javamodel;
...
public class LanguageSettings extends DynamicResource implements ILanguageSettings {
  ...
  public static java.util.List<cleon.common.language.metamodel.spec.language_settings.javamodel.ILanguageSettings> selectToMeLanguages(cleon.common.language.metamodel.spec.languages.javamodel.ILanguage object) {
    return _getToMeList(object.getRepository(), cleon.common.language.metamodel.spec.language_settings.javamodel.ILanguageSettings.class, cleon.common.language.metamodel.spec.language_settings.Language_settingsPackage.LanguageSettings_languages, object.getResource());
  }
