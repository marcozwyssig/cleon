...
public class FunctionSpace_Priority {
  ...
  public static interface IPriorityFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("7f692ca3-10a4-11e8-ab55-75346738d444")
    public java.lang.Boolean IsShould(final ch.actifsource.core.javamodel.ICommentable priority);

    @IDynamicResourceExtension.MethodId("ad1b2b84-10a4-11e8-ab55-75346738d444")
    public java.lang.Boolean IsNice(final ch.actifsource.core.javamodel.ICommentable priority);

    @IDynamicResourceExtension.MethodId("c7e8226f-10a4-11e8-ab55-75346738d444")
    public java.lang.Boolean IsMust(final ch.actifsource.core.javamodel.ICommentable priority);

    @IDynamicResourceExtension.MethodId("e2be9c10-8fe7-11e8-a5b5-191902fe097a")
    public java.lang.Boolean IsUrgent(final ch.actifsource.core.javamodel.ICommentable priority);

    @IDynamicResourceExtension.MethodId("ef006d66-8fe7-11e8-a5b5-191902fe097a")
    public java.lang.Boolean IsImportant(final ch.actifsource.core.javamodel.ICommentable priority);

    @IDynamicResourceExtension.MethodId("b0f089ee-1f1c-11e9-9b49-9d767b485444")
    public java.lang.Boolean IsKO(final ch.actifsource.core.javamodel.ICommentable priority);
  ...
  public static class PriorityFunctions {
    ...
    public static java.lang.Boolean IsShould(final ch.actifsource.core.javamodel.ICommentable priority) {
      return DynamicResourceUtil.invoke(IPriorityFunctionsImpl.class, PriorityFunctionsImpl.INSTANCE, priority).IsShould(priority);
    }

    public static java.lang.Boolean IsNice(final ch.actifsource.core.javamodel.ICommentable priority) {
      return DynamicResourceUtil.invoke(IPriorityFunctionsImpl.class, PriorityFunctionsImpl.INSTANCE, priority).IsNice(priority);
    }

    public static java.lang.Boolean IsMust(final ch.actifsource.core.javamodel.ICommentable priority) {
      return DynamicResourceUtil.invoke(IPriorityFunctionsImpl.class, PriorityFunctionsImpl.INSTANCE, priority).IsMust(priority);
    }

    public static java.lang.Boolean IsUrgent(final ch.actifsource.core.javamodel.ICommentable priority) {
      return DynamicResourceUtil.invoke(IPriorityFunctionsImpl.class, PriorityFunctionsImpl.INSTANCE, priority).IsUrgent(priority);
    }

    public static java.lang.Boolean IsImportant(final ch.actifsource.core.javamodel.ICommentable priority) {
    ...
    public static java.lang.Boolean IsKO(final ch.actifsource.core.javamodel.ICommentable priority) {
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,75cf7021-10a4-11e8-ab55-75346738d444,jt68nEMmFSgLzfDZsfkjhxBQX6Q=] */
