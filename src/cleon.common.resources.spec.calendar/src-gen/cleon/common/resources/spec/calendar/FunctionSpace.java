package cleon.common.resources.spec.calendar;
...
public class FunctionSpace {
  ...
  public static interface IDayFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("64248f6f-c391-11e5-a9c9-53d676410f3e")
    public java.util.Date GetDate(final cleon.common.resources.spec.calendar.javamodel.IDay day);

    @IDynamicResourceExtension.MethodId("8f42ec9d-c4c4-11e5-8558-4b8affb7767c")
    public java.lang.String FormattedDate(final cleon.common.resources.spec.calendar.javamodel.IDay day);

    @IDynamicResourceExtension.MethodId("7fe5f4be-c4cb-11e5-8558-4b8affb7767c")
    public java.lang.Boolean IsWeekend(final cleon.common.resources.spec.calendar.javamodel.IDay day);

    @IDynamicResourceExtension.MethodId("3df57966-4e70-11e6-a89e-4beefb17234f")
    public java.lang.String ShortFormattedDate(final cleon.common.resources.spec.calendar.javamodel.IDay day);

    @IDynamicResourceExtension.MethodId("21fe9ba8-d6a9-11e6-a1b8-05a222dbc1bd")
    public java.lang.String FormattedDay(final cleon.common.resources.spec.calendar.javamodel.IDay day);
  ...
  public static class DayFunctions {
    ...
    public static java.util.Date GetDate(final cleon.common.resources.spec.calendar.javamodel.IDay day) {
      return DynamicResourceUtil.invoke(IDayFunctionsImpl.class, DayFunctionsImpl.INSTANCE, day).GetDate(day);
    }

    public static java.lang.String FormattedDate(final cleon.common.resources.spec.calendar.javamodel.IDay day) {
      return DynamicResourceUtil.invoke(IDayFunctionsImpl.class, DayFunctionsImpl.INSTANCE, day).FormattedDate(day);
    }

    public static java.lang.Boolean IsWeekend(final cleon.common.resources.spec.calendar.javamodel.IDay day) {
      return DynamicResourceUtil.invoke(IDayFunctionsImpl.class, DayFunctionsImpl.INSTANCE, day).IsWeekend(day);
    }

    public static java.lang.String ShortFormattedDate(final cleon.common.resources.spec.calendar.javamodel.IDay day) {
      return DynamicResourceUtil.invoke(IDayFunctionsImpl.class, DayFunctionsImpl.INSTANCE, day).ShortFormattedDate(day);
    }

    public static java.lang.String FormattedDay(final cleon.common.resources.spec.calendar.javamodel.IDay day) {
  ...
  public static interface ICalendarFunctions extends IDynamicResourceExtension {
    ...
    public cleon.common.resources.spec.calendar.javamodel.IDay GetDay(final java.util.Date time);

    @IDynamicResourceExtension.MethodId("0098270f-d6a8-11e6-a1b8-05a222dbc1bd")
    public cleon.common.resources.spec.calendar.javamodel.IDay Now();
  ...
  public static interface ICalendarFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("0c672790-8a12-11e6-8085-d9bdba2de943")
    public cleon.common.resources.spec.calendar.javamodel.IDay GetDay(final java.util.Date time, final cleon.common.resources.spec.calendar.javamodel.ICalendar calendar);

    @IDynamicResourceExtension.MethodId("0098270f-d6a8-11e6-a1b8-05a222dbc1bd")
    public cleon.common.resources.spec.calendar.javamodel.IDay Now(final cleon.common.resources.spec.calendar.javamodel.ICalendar calendar);
...
.findFirst().get();
  ...
  public static class CalendarFunctions {
    ...
    public static cleon.common.resources.spec.calendar.javamodel.IDay GetDay(final java.util.Date time, final cleon.common.resources.spec.calendar.javamodel.ICalendar calendar) {
    ...
    public static cleon.common.resources.spec.calendar.javamodel.IDay Now(final cleon.common.resources.spec.calendar.javamodel.ICalendar calendar) {
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,5c700e8e-c391-11e5-a9c9-53d676410f3e,eWxYZeSC6sOFm1fp1OyMJCaJreo=] */
