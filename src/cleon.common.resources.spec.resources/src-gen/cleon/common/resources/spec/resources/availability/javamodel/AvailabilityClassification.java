package cleon.common.resources.spec.resources.availability.javamodel;
...
public class AvailabilityClassification extends DynamicResource implements IAvailabilityClassification {
  ...
  public boolean isVK0() {
    return getResource().equals(cleon.common.resources.spec.resources.availability.AvailabilityPackage.AvailabilityClassification_VK0);
  }
  
  @Override
  public boolean isVK1() {
    return getResource().equals(cleon.common.resources.spec.resources.availability.AvailabilityPackage.AvailabilityClassification_VK1);
  }
  
  @Override
  public boolean isVK2() {
    return getResource().equals(cleon.common.resources.spec.resources.availability.AvailabilityPackage.AvailabilityClassification_VK2);
  }
  
  @Override
  public boolean isVK3() {
    return getResource().equals(cleon.common.resources.spec.resources.availability.AvailabilityPackage.AvailabilityClassification_VK3);
  }
