...
public class FunctionSpace {
  ...
  public static interface IStringLiteralFunctions extends IDynamicResourceExtension {
    ...
    public java.lang.String convertWhitespaceToUnderscoreAndFilterInvalidChars();
  ...
  public static class StringLiteralFunctions {
    ...
    public static java.lang.String convertWhitespaceToUnderscoreAndFilterInvalidChars(final java.lang.String stringLiteral) {
      return DynamicResourceUtil.invoke(IStringLiteralFunctionsImpl.class, StringLiteralFunctionsImpl.INSTANCE, stringLiteral).convertWhitespaceToUnderscoreAndFilterInvalidChars(stringLiteral);
    }
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,37550eeb-f2bd-11e5-8010-7b34e2b59618,GzjslGtbszIMcHYe925Jdyw5cn0=] */
