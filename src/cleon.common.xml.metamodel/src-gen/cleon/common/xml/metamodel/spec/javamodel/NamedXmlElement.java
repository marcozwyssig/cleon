...
public class NamedXmlElement extends DynamicResource implements INamedXmlElement {
  ...
  @Override
  public java.util.List<? extends cleon.common.xml.metamodel.spec.javamodel.IXmlAttribute> selectNodes() {
    return _getList(cleon.common.xml.metamodel.spec.javamodel.IXmlAttribute.class, cleon.common.xml.metamodel.spec.SpecPackage.XmlElement_nodes);
  }

  public NamedXmlElement setNodes(java.util.List<? extends cleon.common.xml.metamodel.spec.javamodel.IXmlAttribute> nodes) {
    _setList(cleon.common.xml.metamodel.spec.SpecPackage.XmlElement_nodes, nodes);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    // relations
    _acceptList(cleon.common.xml.metamodel.spec.javamodel.IXmlAttribute.class, cleon.common.xml.metamodel.spec.SpecPackage.XmlElement_nodes, visitor);
