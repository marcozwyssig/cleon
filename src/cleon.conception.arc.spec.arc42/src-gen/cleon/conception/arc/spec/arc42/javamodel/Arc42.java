package cleon.conception.arc.spec.arc42.javamodel;
...
public class Arc42 extends DynamicResource implements IArc42 {
  ...
  public Arc42 set__V_1_aE_introduction_aE_and_aE_goals(cleon.conception.arc.spec.arc42._01_introduction_and_goals.javamodel.I__V_1_aE_IntroductionAndGoals __V_1_aE_introduction_aE_and_aE_goals) {
  ...
  public Arc42 set__V_2_aE_architecture_aE_constraints(cleon.conception.arc.spec.arc42._02_architecture_constraints.javamodel.I__V_2_aE_Architecture_aE_Constraints __V_2_aE_architecture_aE_constraints) {
  ...
  @Override
  public cleon.conception.arc.spec.arc42._03_system_scope_and_context.javamodel.I__V_3_aE_System_aE_Scope_aE_and_aE_Context select__V_3_aE_system_aE_scope_aE_and_aE_context() {
    return _getSingle(cleon.conception.arc.spec.arc42._03_system_scope_and_context.javamodel.I__V_3_aE_System_aE_Scope_aE_and_aE_Context.class, cleon.conception.arc.spec.arc42.Arc42Package.arc42___V_3_aE_system_aE_scope_aE_and_aE_context);
  }

  public Arc42 set__V_3_aE_system_aE_scope_aE_and_aE_context(cleon.conception.arc.spec.arc42._03_system_scope_and_context.javamodel.I__V_3_aE_System_aE_Scope_aE_and_aE_Context __V_3_aE_system_aE_scope_aE_and_aE_context) {
    _setSingle(cleon.conception.arc.spec.arc42.Arc42Package.arc42___V_3_aE_system_aE_scope_aE_and_aE_context, __V_3_aE_system_aE_scope_aE_and_aE_context);
    return this;
  }
  ...
  public Arc42 set__V_5_aE_buildingblockview(java.util.List<? extends cleon.conception.arc.spec.arc42._05_buildingblock_view.javamodel.I__V_5_aE_BuildingBlockView> __V_5_aE_buildingblockview) {
  ...
  public Arc42 set__V_7_aE_deploymentview(cleon.conception.arc.spec.arc42._07_deployment_view.javamodel.I__V_7_aE_DeploymentView __V_7_aE_deploymentview) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(cleon.conception.arc.spec.arc42._03_system_scope_and_context.javamodel.I__V_3_aE_System_aE_Scope_aE_and_aE_Context.class, cleon.conception.arc.spec.arc42.Arc42Package.arc42___V_3_aE_system_aE_scope_aE_and_aE_context, visitor);
  ...
  public static cleon.conception.arc.spec.arc42.javamodel.IArc42 selectToMe__V_1_aE_introduction_aE_and_aE_goals(cleon.conception.arc.spec.arc42._01_introduction_and_goals.javamodel.I__V_1_aE_IntroductionAndGoals object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.arc.spec.arc42.javamodel.IArc42.class, cleon.conception.arc.spec.arc42.Arc42Package.arc42___V_1_aE_introduction_aE_and_aE_goals, object.getResource());
  }
  
  public static cleon.conception.arc.spec.arc42.javamodel.IArc42 selectToMe__V_2_aE_architecture_aE_constraints(cleon.conception.arc.spec.arc42._02_architecture_constraints.javamodel.I__V_2_aE_Architecture_aE_Constraints object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.arc.spec.arc42.javamodel.IArc42.class, cleon.conception.arc.spec.arc42.Arc42Package.arc42___V_2_aE_architecture_aE_constraints, object.getResource());
  }
  
  public static cleon.conception.arc.spec.arc42.javamodel.IArc42 selectToMe__V_3_aE_system_aE_scope_aE_and_aE_context(cleon.conception.arc.spec.arc42._03_system_scope_and_context.javamodel.I__V_3_aE_System_aE_Scope_aE_and_aE_Context object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.arc.spec.arc42.javamodel.IArc42.class, cleon.conception.arc.spec.arc42.Arc42Package.arc42___V_3_aE_system_aE_scope_aE_and_aE_context, object.getResource());
  }
  
  public static cleon.conception.arc.spec.arc42.javamodel.IArc42 selectToMe__V_5_aE_buildingblockview(cleon.conception.arc.spec.arc42._05_buildingblock_view.javamodel.I__V_5_aE_BuildingBlockView object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.arc.spec.arc42.javamodel.IArc42.class, cleon.conception.arc.spec.arc42.Arc42Package.arc42___V_5_aE_buildingblockview, object.getResource());
  }
  
  public static cleon.conception.arc.spec.arc42.javamodel.IArc42 selectToMe__V_7_aE_deploymentview(cleon.conception.arc.spec.arc42._07_deployment_view.javamodel.I__V_7_aE_DeploymentView object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.arc.spec.arc42.javamodel.IArc42.class, cleon.conception.arc.spec.arc42.Arc42Package.arc42___V_7_aE_deploymentview, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,2cbcf671-ffcc-11e4-ac0a-959b440f987f,ckXEtIDKHzvBtkl5XbZzizNjdec=] */
