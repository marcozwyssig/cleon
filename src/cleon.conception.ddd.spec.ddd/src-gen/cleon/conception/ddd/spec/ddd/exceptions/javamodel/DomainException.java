package cleon.conception.ddd.spec.ddd.exceptions.javamodel;
...
public class DomainException extends DynamicResource implements IDomainException {
  ...
  public DomainException setCustomEvents(java.util.List<? extends cleon.conception.uml.spec.uml.structural.classes.events.javamodel.ICustomEvent> customEvents) {
  ...
  public DomainException setEvents(java.util.List<? extends cleon.conception.uml.spec.uml.structural.classes.events.javamodel.IEvent> events) {
  ...
  public DomainException setExtends(cleon.conception.uml.spec.uml.structural.classes.javamodel.IClass extends_) {
  ...
  public DomainException setFieldEvents(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.conception.uml.spec.uml.structural.classes.events.javamodel.IEventForField> fieldEvents) {
  ...
  public DomainException setFields(java.util.List<? extends cleon.conception.uml.spec.uml.structural.classes.fields.javamodel.IField> fields) {
  ...
  public DomainException setHasDependency(java.util.List<? extends cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IDependency> hasDependency) {
  ...
  public DomainException setMethods(java.util.List<? extends cleon.conception.uml.spec.uml.structural.classes.method.javamodel.IMethod> methods) {
  ...
  public DomainException setRelations(java.util.List<? extends cleon.conception.uml.spec.uml.structural.classes.association.javamodel.IAssociation> relations) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,d23456fc-25e9-11e3-af30-61c5782ee2ab,6jbZyJVsfqZGPlBOKLyin7iQCIY=] */
