...
public class ViewModel extends DynamicResource implements IViewModel {
  ...
  public java.lang.Boolean selectGenerateFieldForDisplay() {
    return _getSingleAttribute(java.lang.Boolean.class, cleon.conception.desktop.spec.desktop.mvvm.MvvmPackage.ViewModel_generateFieldForDisplay);
  }
    
  public void setGenerateFieldForDisplay(java.lang.Boolean generateFieldForDisplay) {
     _setSingleAttribute(cleon.conception.desktop.spec.desktop.mvvm.MvvmPackage.ViewModel_generateFieldForDisplay, generateFieldForDisplay);
  }
  ...
  public java.util.List<? extends cleon.conception.desktop.spec.desktop.mvvm.javamodel.IDelegateCommand> selectDelegateCommands() {
    return _getList(cleon.conception.desktop.spec.desktop.mvvm.javamodel.IDelegateCommand.class, cleon.conception.desktop.spec.desktop.mvvm.MvvmPackage.ViewModel_delegateCommands);
  }

  public ViewModel setDelegateCommands(java.util.List<? extends cleon.conception.desktop.spec.desktop.mvvm.javamodel.IDelegateCommand> delegateCommands) {
    _setList(cleon.conception.desktop.spec.desktop.mvvm.MvvmPackage.ViewModel_delegateCommands, delegateCommands);
    return this;
  }
    
  @Override
  public cleon.conception.uml.spec.uml.structural.classes.javamodel.IClassifier selectDisplay() {
    return _getSingle(cleon.conception.uml.spec.uml.structural.classes.javamodel.IClassifier.class, cleon.conception.desktop.spec.desktop.mvvm.MvvmPackage.ViewModel_display);
  }

  public ViewModel setDisplay(cleon.conception.uml.spec.uml.structural.classes.javamodel.IClassifier display) {
    _setSingle(cleon.conception.desktop.spec.desktop.mvvm.MvvmPackage.ViewModel_display, display);
    return this;
  }
  ...
  public cleon.conception.desktop.spec.desktop.mvvm.javamodel.IViewModel selectExtends() {
    return _getSingle(cleon.conception.desktop.spec.desktop.mvvm.javamodel.IViewModel.class, cleon.conception.desktop.spec.desktop.mvvm.MvvmPackage.ViewModel_extends);
  }

  public ViewModel setExtends(cleon.conception.desktop.spec.desktop.mvvm.javamodel.IViewModel extends_) {
    _setSingle(cleon.conception.desktop.spec.desktop.mvvm.MvvmPackage.ViewModel_extends, extends_);
    return this;
  }
  ...
  public java.util.Map<ch.actifsource.core.Resource, ? extends cleon.conception.desktop.spec.desktop.mvvm.javamodel.IForwardPropertyDependency> selectForwardPropertys() {
    return _getMap(cleon.conception.desktop.spec.desktop.mvvm.javamodel.IForwardPropertyDependency.class, cleon.conception.desktop.spec.desktop.mvvm.MvvmPackage.ViewModel_forwardPropertys);
  }

  public ViewModel setForwardPropertys(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.conception.desktop.spec.desktop.mvvm.javamodel.IForwardPropertyDependency> forwardPropertys) {
    _setMap(cleon.conception.desktop.spec.desktop.mvvm.MvvmPackage.ViewModel_forwardPropertys, forwardPropertys);
    return this;
  }
  ...
  public ViewModel setHasDependency(java.util.List<? extends cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IDependency> hasDependency) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingleAttribute(java.lang.Boolean.class, cleon.conception.desktop.spec.desktop.mvvm.MvvmPackage.ViewModel_generateFieldForDisplay, visitor);
    ...
    _acceptList(cleon.conception.desktop.spec.desktop.mvvm.javamodel.IDelegateCommand.class, cleon.conception.desktop.spec.desktop.mvvm.MvvmPackage.ViewModel_delegateCommands, visitor);
    _acceptSingle(cleon.conception.uml.spec.uml.structural.classes.javamodel.IClassifier.class, cleon.conception.desktop.spec.desktop.mvvm.MvvmPackage.ViewModel_display, visitor);
    ...
    _acceptSingle(cleon.conception.desktop.spec.desktop.mvvm.javamodel.IViewModel.class, cleon.conception.desktop.spec.desktop.mvvm.MvvmPackage.ViewModel_extends, visitor);
    ...
    _acceptMap(cleon.conception.desktop.spec.desktop.mvvm.javamodel.IForwardPropertyDependency.class, cleon.conception.desktop.spec.desktop.mvvm.MvvmPackage.ViewModel_forwardPropertys, visitor);
  ...
  public static java.util.List<cleon.conception.desktop.spec.desktop.mvvm.javamodel.IViewModel> selectToMeDisplay(cleon.conception.uml.spec.uml.structural.classes.javamodel.IClassifier object) {
    return _getToMeList(object.getRepository(), cleon.conception.desktop.spec.desktop.mvvm.javamodel.IViewModel.class, cleon.conception.desktop.spec.desktop.mvvm.MvvmPackage.ViewModel_display, object.getResource());
  }
  
  public static java.util.List<cleon.conception.desktop.spec.desktop.mvvm.javamodel.IViewModel> selectToMeExtends(cleon.conception.desktop.spec.desktop.mvvm.javamodel.IViewModel object) {
    return _getToMeList(object.getRepository(), cleon.conception.desktop.spec.desktop.mvvm.javamodel.IViewModel.class, cleon.conception.desktop.spec.desktop.mvvm.MvvmPackage.ViewModel_extends, object.getResource());
  }
  
  public static cleon.conception.desktop.spec.desktop.mvvm.javamodel.IViewModel selectToMeDelegateCommands(cleon.conception.desktop.spec.desktop.mvvm.javamodel.IDelegateCommand object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.desktop.spec.desktop.mvvm.javamodel.IViewModel.class, cleon.conception.desktop.spec.desktop.mvvm.MvvmPackage.ViewModel_delegateCommands, object.getResource());
  }
  
  public static cleon.conception.desktop.spec.desktop.mvvm.javamodel.IViewModel selectToMeForwardPropertys(cleon.conception.desktop.spec.desktop.mvvm.javamodel.IForwardPropertyDependency object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.desktop.spec.desktop.mvvm.javamodel.IViewModel.class, cleon.conception.desktop.spec.desktop.mvvm.MvvmPackage.ViewModel_forwardPropertys, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,349382f4-5284-11e3-999a-25b1389b65ab,XjDvC2jssnCu/zgV4uKBpqBjghg=] */
