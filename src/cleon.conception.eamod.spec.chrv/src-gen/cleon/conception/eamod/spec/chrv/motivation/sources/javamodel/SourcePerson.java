...
public class SourcePerson extends DynamicResource implements ISourcePerson {
  ...
  public SourcePerson setComposites(java.util.List<? extends cleon.conception.eamod.spec.chrv.motivation.sources.javamodel.ISource> composites) {
  ...
  public java.util.List<? extends cleon.conception.eamod.spec.chrv.motivation.sources.javamodel.ISourceDocument> selectDocuments() {
    return _getList(cleon.conception.eamod.spec.chrv.motivation.sources.javamodel.ISourceDocument.class, cleon.conception.eamod.spec.chrv.motivation.sources.SourcesPackage.SourcePerson_documents);
  }

  public SourcePerson setDocuments(java.util.List<? extends cleon.conception.eamod.spec.chrv.motivation.sources.javamodel.ISourceDocument> documents) {
    _setList(cleon.conception.eamod.spec.chrv.motivation.sources.SourcesPackage.SourcePerson_documents, documents);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptList(cleon.conception.eamod.spec.chrv.motivation.sources.javamodel.ISourceDocument.class, cleon.conception.eamod.spec.chrv.motivation.sources.SourcesPackage.SourcePerson_documents, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

  // toMeRelations
  
  public static cleon.conception.eamod.spec.chrv.motivation.sources.javamodel.ISourcePerson selectToMeDocuments(cleon.conception.eamod.spec.chrv.motivation.sources.javamodel.ISourceDocument object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.eamod.spec.chrv.motivation.sources.javamodel.ISourcePerson.class, cleon.conception.eamod.spec.chrv.motivation.sources.SourcesPackage.SourcePerson_documents, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,1d03bc5b-bb80-11e5-b2f7-f515c847fa35,LFKBjVtDVZ+OnkFPvXLn5d2wtms=] */
