...
public class Logistics extends DynamicResource implements ILogistics {
  ...
  public Logistics setAchieves(java.util.List<? extends cleon.conception.eamod.spec.chrv.motivation.goals.javamodel.IGoal> achieves) {
  ...
  public Logistics setRequirements(java.util.List<? extends cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.javamodel.IRequirement> requirements) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,f6f36819-0c76-11e6-86c5-87a8b520dd59,1s0RGQNHJCDgb/i/6Rvr7+797iU=] */
