...
public class Surroundings extends DynamicResource implements ISurroundings {
  ...
  public Surroundings setAchieves(java.util.List<? extends cleon.conception.eamod.spec.chrv.motivation.goals.javamodel.IGoal> achieves) {
  ...
  public Surroundings setRequirements(java.util.List<? extends cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.javamodel.IRequirement> requirements) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,25da3e53-0c77-11e6-86c5-87a8b520dd59,IqV7iBqsomqURa3hx2uZMm8ePfg=] */
