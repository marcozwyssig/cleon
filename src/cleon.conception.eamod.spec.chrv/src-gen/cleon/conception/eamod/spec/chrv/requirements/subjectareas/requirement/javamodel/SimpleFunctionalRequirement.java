...
public class SimpleFunctionalRequirement extends DynamicResource implements ISimpleFunctionalRequirement {
  ...
  public SimpleFunctionalRequirement setAbstractionLevel(cleon.conception.eamod.spec.chrv.requirements.subjectareas.abstraction_level.javamodel.IAbstractionLevel abstractionLevel) {
  ...
  public SimpleFunctionalRequirement setAchieves(java.util.List<? extends cleon.conception.eamod.spec.chrv.motivation.goals.javamodel.IGoal> achieves) {
  ...
  public SimpleFunctionalRequirement setAggregates(java.util.List<? extends cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.javamodel.IRequirement> aggregates) {
  ...
  public SimpleFunctionalRequirement setConcretizes(java.util.List<? extends cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.javamodel.IRequirement> concretizes) {
  ...
  public SimpleFunctionalRequirement setConflicts(java.util.List<? extends cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.javamodel.IRequirement> conflicts) {
  ...
  public SimpleFunctionalRequirement setIssues(java.util.List<? extends cleon.conception.eamod.spec.chrv.issues.javamodel.IIssue> issues) {
  ...
  public SimpleFunctionalRequirement setOriginatesFromSource(java.util.List<? extends cleon.conception.eamod.spec.chrv.motivation.sources.javamodel.ISource> originatesFromSource) {
  ...
  public SimpleFunctionalRequirement setOwners(java.util.List<? extends cleon.conception.eamod.spec.chrv.motivation.stakeholder.javamodel.IStakeholder> owners) {
  ...
  public SimpleFunctionalRequirement setState(cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.javamodel.IRequirementState state) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,87710c27-a962-11e5-bda2-a7fc3bd7c783,AJhggkpLtEQMmoFhYqH75MgETak=] */
