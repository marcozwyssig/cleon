...
public class CISCapability extends DynamicResource implements ICISCapability {
  ...
  public CISCapability setCapabilityComposition(java.util.List<? extends cleon.conception.eamod.spec.ncv.javamodel.ICapability> capabilityComposition) {
  ...
  public CISCapability setCapabilityDependency(java.util.List<? extends cleon.conception.eamod.spec.ncv.javamodel.ICapability> capabilityDependency) {
  ...
  public CISCapability setCapabilitySpecialisation(cleon.conception.eamod.spec.ncv.javamodel.ICapability capabilitySpecialisation) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,70fc7e57-bc80-11e6-beb6-85da12323ce9,m/pv7EzUjxHjCWRqSqrDckeQ77U=] */
