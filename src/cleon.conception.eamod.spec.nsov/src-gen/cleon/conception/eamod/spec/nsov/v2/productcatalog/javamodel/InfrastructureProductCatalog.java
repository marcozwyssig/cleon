...
public class InfrastructureProductCatalog extends DynamicResource implements IInfrastructureProductCatalog {
  ...
  public java.util.List<? extends cleon.conception.eamod.spec.nsov.v2.productcatalog.productgroup.javamodel.IInfrastructureProductGroup> selectInfrastructureProductGroups() {
    return _getList(cleon.conception.eamod.spec.nsov.v2.productcatalog.productgroup.javamodel.IInfrastructureProductGroup.class, cleon.conception.eamod.spec.nsov.v2.productcatalog.ProductcatalogPackage.InfrastructureProductCatalog_infrastructureProductGroups);
  }

  public InfrastructureProductCatalog setInfrastructureProductGroups(java.util.List<? extends cleon.conception.eamod.spec.nsov.v2.productcatalog.productgroup.javamodel.IInfrastructureProductGroup> infrastructureProductGroups) {
    _setList(cleon.conception.eamod.spec.nsov.v2.productcatalog.ProductcatalogPackage.InfrastructureProductCatalog_infrastructureProductGroups, infrastructureProductGroups);
    return this;
  }
  ...
  public InfrastructureProductCatalog setProductGroups(java.util.List<? extends cleon.conception.eamod.spec.nsov.v2.productcatalog.productgroup.javamodel.IProductGroup> productGroups) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptList(cleon.conception.eamod.spec.nsov.v2.productcatalog.productgroup.javamodel.IInfrastructureProductGroup.class, cleon.conception.eamod.spec.nsov.v2.productcatalog.ProductcatalogPackage.InfrastructureProductCatalog_infrastructureProductGroups, visitor);
  ...
  public static cleon.conception.eamod.spec.nsov.v2.productcatalog.javamodel.IInfrastructureProductCatalog selectToMeInfrastructureProductGroups(cleon.conception.eamod.spec.nsov.v2.productcatalog.productgroup.javamodel.IInfrastructureProductGroup object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.eamod.spec.nsov.v2.productcatalog.javamodel.IInfrastructureProductCatalog.class, cleon.conception.eamod.spec.nsov.v2.productcatalog.ProductcatalogPackage.InfrastructureProductCatalog_infrastructureProductGroups, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,7a7e912c-67c6-11e7-afcc-6df3a81a4d17,ekXzm423YT6hRkAA0uS6dGCIxKg=] */
