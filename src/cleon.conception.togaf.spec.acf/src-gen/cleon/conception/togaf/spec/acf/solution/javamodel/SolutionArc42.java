package cleon.conception.togaf.spec.acf.solution.javamodel;
...
public class SolutionArc42 extends DynamicResource implements ISolutionArc42 {
  ...
  public SolutionArc42 set__V_1_aE_introduction_aE_and_aE_goals(cleon.conception.arc.spec.arc42._01_introduction_and_goals.javamodel.I__V_1_aE_IntroductionAndGoals __V_1_aE_introduction_aE_and_aE_goals) {
  ...
  public SolutionArc42 set__V_2_aE_architecture_aE_constraints(cleon.conception.arc.spec.arc42._02_architecture_constraints.javamodel.I__V_2_aE_Architecture_aE_Constraints __V_2_aE_architecture_aE_constraints) {
  ...
  @Override
  public cleon.conception.togaf.spec.acf.solution._03_system_scope_and_context.javamodel.I__V_3_aE_System_aE_Scope_aE_and_aE_Context select__V_3_aE_system_aE_scope_aE_and_aE_context() {
    return _getSingle(cleon.conception.togaf.spec.acf.solution._03_system_scope_and_context.javamodel.I__V_3_aE_System_aE_Scope_aE_and_aE_Context.class, cleon.conception.togaf.spec.acf.solution.SolutionPackage.SolutionArc42___V_3_aE_system_aE_scope_aE_and_aE_context);
  }

  public SolutionArc42 set__V_3_aE_system_aE_scope_aE_and_aE_context(cleon.conception.togaf.spec.acf.solution._03_system_scope_and_context.javamodel.I__V_3_aE_System_aE_Scope_aE_and_aE_Context __V_3_aE_system_aE_scope_aE_and_aE_context) {
    _setSingle(cleon.conception.togaf.spec.acf.solution.SolutionPackage.SolutionArc42___V_3_aE_system_aE_scope_aE_and_aE_context, __V_3_aE_system_aE_scope_aE_and_aE_context);
    return this;
  }
  ...
  public SolutionArc42 set__V_5_aE_buildingblockview(java.util.List<? extends cleon.conception.arc.spec.arc42._05_buildingblock_view.javamodel.I__V_5_aE_BuildingBlockView> __V_5_aE_buildingblockview) {
    _setList(cleon.conception.arc.spec.arc42.Arc42Package.arc42___V_5_aE_buildingblockview, __V_5_aE_buildingblockview);
    return this;
  }
    
  @Override
  public cleon.conception.togaf.spec.acf.solution._05_solutionbuildingblock_view.javamodel.I__V_5_aE_SolutionBuildingBlockView select__V_5_aE_solutionbuildingblockview() {
    return _getSingle(cleon.conception.togaf.spec.acf.solution._05_solutionbuildingblock_view.javamodel.I__V_5_aE_SolutionBuildingBlockView.class, cleon.conception.togaf.spec.acf.solution.SolutionPackage.SolutionArc42___V_5_aE_solutionbuildingblockview);
  }

  public SolutionArc42 set__V_5_aE_solutionbuildingblockview(cleon.conception.togaf.spec.acf.solution._05_solutionbuildingblock_view.javamodel.I__V_5_aE_SolutionBuildingBlockView __V_5_aE_solutionbuildingblockview) {
    _setSingle(cleon.conception.togaf.spec.acf.solution.SolutionPackage.SolutionArc42___V_5_aE_solutionbuildingblockview, __V_5_aE_solutionbuildingblockview);
    return this;
  }
  ...
  public SolutionArc42 set__V_7_aE_deploymentview(cleon.conception.arc.spec.arc42._07_deployment_view.javamodel.I__V_7_aE_DeploymentView __V_7_aE_deploymentview) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(cleon.conception.togaf.spec.acf.solution._03_system_scope_and_context.javamodel.I__V_3_aE_System_aE_Scope_aE_and_aE_Context.class, cleon.conception.togaf.spec.acf.solution.SolutionPackage.SolutionArc42___V_3_aE_system_aE_scope_aE_and_aE_context, visitor);
    ...
    _acceptSingle(cleon.conception.togaf.spec.acf.solution._05_solutionbuildingblock_view.javamodel.I__V_5_aE_SolutionBuildingBlockView.class, cleon.conception.togaf.spec.acf.solution.SolutionPackage.SolutionArc42___V_5_aE_solutionbuildingblockview, visitor);
  ...
  public static cleon.conception.togaf.spec.acf.solution.javamodel.ISolutionArc42 selectToMe__V_3_aE_system_aE_scope_aE_and_aE_context(cleon.conception.togaf.spec.acf.solution._03_system_scope_and_context.javamodel.I__V_3_aE_System_aE_Scope_aE_and_aE_Context object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.togaf.spec.acf.solution.javamodel.ISolutionArc42.class, cleon.conception.togaf.spec.acf.solution.SolutionPackage.SolutionArc42___V_3_aE_system_aE_scope_aE_and_aE_context, object.getResource());
  }
  
  public static cleon.conception.togaf.spec.acf.solution.javamodel.ISolutionArc42 selectToMe__V_5_aE_solutionbuildingblockview(cleon.conception.togaf.spec.acf.solution._05_solutionbuildingblock_view.javamodel.I__V_5_aE_SolutionBuildingBlockView object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.togaf.spec.acf.solution.javamodel.ISolutionArc42.class, cleon.conception.togaf.spec.acf.solution.SolutionPackage.SolutionArc42___V_5_aE_solutionbuildingblockview, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,c90cdcfd-28f2-11e8-a684-8332c21c2f91,Tp5hNKQOCmF0QJokWNt8drxIyzY=] */
