...
public class Class extends DynamicResource implements IClass {
  ...
  public Class setCustomEvents(java.util.List<? extends cleon.conception.uml.spec.uml.structural.classes.events.javamodel.ICustomEvent> customEvents) {
  ...
  public Class setDocumentElements(java.util.List<? extends cleon.common.doc.spec.doc.javamodel.IDocumentElement> documentElements) {
  ...
  public Class setEvents(java.util.List<? extends cleon.conception.uml.spec.uml.structural.classes.events.javamodel.IEvent> events) {
  ...
  public Class setExtends(cleon.conception.uml.spec.uml.structural.classes.javamodel.IClass extends_) {
  ...
  public Class setFieldEvents(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.conception.uml.spec.uml.structural.classes.events.javamodel.IEventForField> fieldEvents) {
  ...
  public Class setFields(java.util.List<? extends cleon.conception.uml.spec.uml.structural.classes.fields.javamodel.IField> fields) {
  ...
  public Class setHasDependency(java.util.List<? extends cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IDependency> hasDependency) {
  ...
  public Class setMethods(java.util.List<? extends cleon.conception.uml.spec.uml.structural.classes.method.javamodel.IMethod> methods) {
  ...
  public Class setRelations(java.util.List<? extends cleon.conception.uml.spec.uml.structural.classes.association.javamodel.IAssociation> relations) {
  ...
  public static java.util.List<cleon.conception.uml.spec.uml.structural.classes.javamodel.IClass> selectToMeExtends(cleon.conception.uml.spec.uml.structural.classes.javamodel.IClass object) {
    return _getToMeList(object.getRepository(), cleon.conception.uml.spec.uml.structural.classes.javamodel.IClass.class, cleon.conception.uml.spec.uml.structural.classes.ClassesPackage.Class_extends, object.getResource());
  }
  
  public static cleon.conception.uml.spec.uml.structural.classes.javamodel.IClass selectToMeFieldEvents(cleon.conception.uml.spec.uml.structural.classes.events.javamodel.IEventForField object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.uml.spec.uml.structural.classes.javamodel.IClass.class, cleon.conception.uml.spec.uml.structural.classes.ClassesPackage.Class_fieldEvents, object.getResource());
  }
  
  public static cleon.conception.uml.spec.uml.structural.classes.javamodel.IClass selectToMeCustomEvents(cleon.conception.uml.spec.uml.structural.classes.events.javamodel.ICustomEvent object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.uml.spec.uml.structural.classes.javamodel.IClass.class, cleon.conception.uml.spec.uml.structural.classes.ClassesPackage.Class_customEvents, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,accc5089-2f5a-11e3-b966-57aab741cf17,UlKg5TgqtoKy1urZkY/gyn+zXvU=] */
