...
public class TemplateClass extends DynamicResource implements ITemplateClass {
  ...
  public TemplateClass setCustomEvents(java.util.List<? extends cleon.conception.uml.spec.uml.structural.classes.events.javamodel.ICustomEvent> customEvents) {
  ...
  public TemplateClass setEvents(java.util.List<? extends cleon.conception.uml.spec.uml.structural.classes.events.javamodel.IEvent> events) {
  ...
  public cleon.conception.uml.spec.uml.structural.classes.javamodel.IClass selectExtends() {
    return _getSingle(cleon.conception.uml.spec.uml.structural.classes.javamodel.IClass.class, cleon.conception.uml.spec.uml.structural.classes.ClassesPackage.Class_extends);
  }

  public TemplateClass setExtends(cleon.conception.uml.spec.uml.structural.classes.javamodel.IClass extends_) {
    _setSingle(cleon.conception.uml.spec.uml.structural.classes.ClassesPackage.Class_extends, extends_);
    return this;
  }
  ...
  public TemplateClass setFieldEvents(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.conception.uml.spec.uml.structural.classes.events.javamodel.IEventForField> fieldEvents) {
  ...
  public TemplateClass setFields(java.util.List<? extends cleon.conception.uml.spec.uml.structural.classes.fields.javamodel.IField> fields) {
  ...
  public TemplateClass setHasDependency(java.util.List<? extends cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IDependency> hasDependency) {
  ...
  public TemplateClass setMethods(java.util.List<? extends cleon.conception.uml.spec.uml.structural.classes.method.javamodel.IMethod> methods) {
  ...
  public TemplateClass setRelations(java.util.List<? extends cleon.conception.uml.spec.uml.structural.classes.association.javamodel.IAssociation> relations) {
    _setList(cleon.conception.uml.spec.uml.structural.classes.ClassesPackage.AssociationClass_relations, relations);
    return this;
  }
    
  @Override
  public java.util.List<? extends cleon.conception.uml.spec.uml.structural.classes.template.javamodel.ITemplateClassParameter> selectTemplateParameters() {
    return _getList(cleon.conception.uml.spec.uml.structural.classes.template.javamodel.ITemplateClassParameter.class, cleon.conception.uml.spec.uml.structural.classes.template.TemplatePackage.TemplateClass_templateParameters);
  }

  public TemplateClass setTemplateParameters(java.util.List<? extends cleon.conception.uml.spec.uml.structural.classes.template.javamodel.ITemplateClassParameter> templateParameters) {
    _setList(cleon.conception.uml.spec.uml.structural.classes.template.TemplatePackage.TemplateClass_templateParameters, templateParameters);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(cleon.conception.uml.spec.uml.structural.classes.javamodel.IClass.class, cleon.conception.uml.spec.uml.structural.classes.ClassesPackage.Class_extends, visitor);
    ...
    _acceptList(cleon.conception.uml.spec.uml.structural.classes.template.javamodel.ITemplateClassParameter.class, cleon.conception.uml.spec.uml.structural.classes.template.TemplatePackage.TemplateClass_templateParameters, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

  // toMeRelations
  
  public static cleon.conception.uml.spec.uml.structural.classes.template.javamodel.ITemplateClass selectToMeTemplateParameters(cleon.conception.uml.spec.uml.structural.classes.template.javamodel.ITemplateClassParameter object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.uml.spec.uml.structural.classes.template.javamodel.ITemplateClass.class, cleon.conception.uml.spec.uml.structural.classes.template.TemplatePackage.TemplateClass_templateParameters, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,743e6460-a3b9-11e3-8095-f11af53ab806,XiLCM6aTsEy4CIOMB/bijTGWdlU=] */
