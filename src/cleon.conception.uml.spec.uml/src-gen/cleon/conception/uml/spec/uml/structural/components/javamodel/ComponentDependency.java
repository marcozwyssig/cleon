...
public class ComponentDependency extends DynamicResource implements IComponentDependency {
  ...
  public ComponentDependency setTo(java.util.List<? extends cleon.conception.uml.spec.uml.structural.components.javamodel.IComponentWithPackage> to) {
  ...
  public static java.util.List<cleon.conception.uml.spec.uml.structural.components.javamodel.IComponentDependency> selectToMeTo(cleon.conception.uml.spec.uml.structural.components.javamodel.IComponentWithPackage object) {
    return _getToMeList(object.getRepository(), cleon.conception.uml.spec.uml.structural.components.javamodel.IComponentDependency.class, cleon.conception.uml.spec.uml.structural.components.ComponentsPackage.ComponentDependency_to, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,6cacbca2-ffc4-11e4-ac0a-959b440f987f,2VckNjMofi9jDJcIPeToKvq7hHQ=] */
