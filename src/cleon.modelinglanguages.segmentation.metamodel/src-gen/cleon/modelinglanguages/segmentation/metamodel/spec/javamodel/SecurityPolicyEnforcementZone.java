...
public class SecurityPolicyEnforcementZone extends DynamicResource implements ISecurityPolicyEnforcementZone {
  ...
  public SecurityPolicyEnforcementZone setAllowedAccessTo(java.util.List<? extends cleon.modelinglanguages.segmentation.metamodel.spec.javamodel.ISecurityZone> allowedAccessTo) {
  ...
  public SecurityPolicyEnforcementZone setChapters(java.util.List<? extends cleon.common.doc.metamodel.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public SecurityPolicyEnforcementZone setDescriptionTranslation(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.translation.description.javamodel.ILanguageDescriptionTranslation> descriptionTranslation) {
  ...
  public SecurityPolicyEnforcementZone setDocumentElements(java.util.List<? extends cleon.common.doc.metamodel.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public SecurityPolicyEnforcementZone setNoParagraphs(cleon.common.doc.metamodel.spec.paragraph.javamodel.IParagraph noParagraphs) {
  ...
  public SecurityPolicyEnforcementZone setParagraphs(java.util.List<? extends cleon.common.doc.metamodel.spec.paragraph.javamodel.IParagraph> paragraphs) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,5112e54f-0b76-11e9-a136-69d076e48ed1,forWyTkUBF+f2iLGZcw/G5/ja7U=] */
