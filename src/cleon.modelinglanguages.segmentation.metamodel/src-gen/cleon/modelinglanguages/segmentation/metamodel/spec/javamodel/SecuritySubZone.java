...
public class SecuritySubZone extends DynamicResource implements ISecuritySubZone {
  ...
  public cleon.modelinglanguages.segmentation.metamodel.spec.javamodel.IAbstractVlan selectVLANs() {
    return _getSingle(cleon.modelinglanguages.segmentation.metamodel.spec.javamodel.IAbstractVlan.class, cleon.modelinglanguages.segmentation.metamodel.spec.SpecPackage.SecuritySubZone_VLANs);
  }

  public SecuritySubZone setVLANs(cleon.modelinglanguages.segmentation.metamodel.spec.javamodel.IAbstractVlan vLANs) {
    _setSingle(cleon.modelinglanguages.segmentation.metamodel.spec.SpecPackage.SecuritySubZone_VLANs, vLANs);
    return this;
  }
    
  @Override
  public java.util.List<? extends cleon.modelinglanguages.segmentation.metamodel.spec.javamodel.IVlan> selectAllVlans() {
    return _getList(cleon.modelinglanguages.segmentation.metamodel.spec.javamodel.IVlan.class, cleon.modelinglanguages.segmentation.metamodel.spec.SpecPackage.SecuritySubZone_allVlans);
  }

  public SecuritySubZone setAllVlans(java.util.List<? extends cleon.modelinglanguages.segmentation.metamodel.spec.javamodel.IVlan> allVlans) {
    _setList(cleon.modelinglanguages.segmentation.metamodel.spec.SpecPackage.SecuritySubZone_allVlans, allVlans);
    return this;
  }
  ...
  public java.util.List<? extends cleon.modelinglanguages.segmentation.metamodel.spec.javamodel.ISecuritySubZone> selectAllowedAccessFromSecuritySubZone() {
    return _getList(cleon.modelinglanguages.segmentation.metamodel.spec.javamodel.ISecuritySubZone.class, cleon.modelinglanguages.segmentation.metamodel.spec.SpecPackage.SecuritySubZone_allowedAccessFromSecuritySubZone);
  }

  public SecuritySubZone setAllowedAccessFromSecuritySubZone(java.util.List<? extends cleon.modelinglanguages.segmentation.metamodel.spec.javamodel.ISecuritySubZone> allowedAccessFromSecuritySubZone) {
    _setList(cleon.modelinglanguages.segmentation.metamodel.spec.SpecPackage.SecuritySubZone_allowedAccessFromSecuritySubZone, allowedAccessFromSecuritySubZone);
    return this;
  }
  ...
  public SecuritySubZone setAllowedAccessTo(java.util.List<? extends cleon.modelinglanguages.segmentation.metamodel.spec.javamodel.IZone> allowedAccessTo) {
  ...
  public java.util.List<? extends cleon.modelinglanguages.segmentation.metamodel.spec.javamodel.ISecuritySubZone> selectAllowedAccessToSecuritySubZone() {
    return _getList(cleon.modelinglanguages.segmentation.metamodel.spec.javamodel.ISecuritySubZone.class, cleon.modelinglanguages.segmentation.metamodel.spec.SpecPackage.SecuritySubZone_allowedAccessToSecuritySubZone);
  }

  public SecuritySubZone setAllowedAccessToSecuritySubZone(java.util.List<? extends cleon.modelinglanguages.segmentation.metamodel.spec.javamodel.ISecuritySubZone> allowedAccessToSecuritySubZone) {
    _setList(cleon.modelinglanguages.segmentation.metamodel.spec.SpecPackage.SecuritySubZone_allowedAccessToSecuritySubZone, allowedAccessToSecuritySubZone);
    return this;
  }
  ...
  public SecuritySubZone setDescriptionTranslation(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.translation.description.javamodel.ILanguageDescriptionTranslation> descriptionTranslation) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    // relations
    _acceptSingle(cleon.modelinglanguages.segmentation.metamodel.spec.javamodel.IAbstractVlan.class, cleon.modelinglanguages.segmentation.metamodel.spec.SpecPackage.SecuritySubZone_VLANs, visitor);
    _acceptList(cleon.modelinglanguages.segmentation.metamodel.spec.javamodel.IVlan.class, cleon.modelinglanguages.segmentation.metamodel.spec.SpecPackage.SecuritySubZone_allVlans, visitor);
  ...
  public static cleon.modelinglanguages.segmentation.metamodel.spec.javamodel.ISecuritySubZone selectToMeVLANs(cleon.modelinglanguages.segmentation.metamodel.spec.javamodel.IAbstractVlan object) {
    return _getToMeSingle(object.getRepository(), cleon.modelinglanguages.segmentation.metamodel.spec.javamodel.ISecuritySubZone.class, cleon.modelinglanguages.segmentation.metamodel.spec.SpecPackage.SecuritySubZone_VLANs, object.getResource());
  }
  ...
  public static java.util.List<cleon.modelinglanguages.segmentation.metamodel.spec.javamodel.ISecuritySubZone> selectToMeAllVlans(cleon.modelinglanguages.segmentation.metamodel.spec.javamodel.IVlan object) {
    return _getToMeList(object.getRepository(), cleon.modelinglanguages.segmentation.metamodel.spec.javamodel.ISecuritySubZone.class, cleon.modelinglanguages.segmentation.metamodel.spec.SpecPackage.SecuritySubZone_allVlans, object.getResource());
  }
  ...
  public static java.util.List<cleon.modelinglanguages.segmentation.metamodel.spec.javamodel.ISecuritySubZone> selectToMeAllowedAccessFromSecuritySubZone(cleon.modelinglanguages.segmentation.metamodel.spec.javamodel.ISecuritySubZone object) {
    return _getToMeList(object.getRepository(), cleon.modelinglanguages.segmentation.metamodel.spec.javamodel.ISecuritySubZone.class, cleon.modelinglanguages.segmentation.metamodel.spec.SpecPackage.SecuritySubZone_allowedAccessFromSecuritySubZone, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,7f40c131-0b75-11e9-a136-69d076e48ed1,vc3IfLayU0p/6uVQvE8FmGH1H3c=] */
