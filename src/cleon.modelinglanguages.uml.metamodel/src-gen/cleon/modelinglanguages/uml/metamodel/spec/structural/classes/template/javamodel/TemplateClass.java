...
public class TemplateClass extends DynamicResource implements ITemplateClass {
  ...
  public TemplateClass setCustomEvents(java.util.List<? extends cleon.modelinglanguages.uml.metamodel.spec.structural.classes.events.javamodel.ICustomEvent> customEvents) {
  ...
  public TemplateClass setDependsFrom(java.util.List<? extends cleon.common.modularity.metamodel.spec.javamodel.IDependentBuildingBlock> dependsFrom) {
  ...
  public TemplateClass setDependsOn(java.util.List<? extends cleon.common.modularity.metamodel.spec.javamodel.IDependency> dependsOn) {
  ...
  public TemplateClass setDescriptionTranslation(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.translation.description.javamodel.ILanguageDescriptionTranslation> descriptionTranslation) {
  ...
  public TemplateClass setEvents(java.util.List<? extends cleon.modelinglanguages.uml.metamodel.spec.structural.classes.events.javamodel.IEvent> events) {
  ...
  public TemplateClass setExtends(cleon.modelinglanguages.uml.metamodel.spec.structural.classes.javamodel.IClass extends_) {
  ...
  public TemplateClass setFieldEvents(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.modelinglanguages.uml.metamodel.spec.structural.classes.events.javamodel.IEventForField> fieldEvents) {
  ...
  public TemplateClass setFields(java.util.List<? extends cleon.modelinglanguages.uml.metamodel.spec.structural.classes.fields.javamodel.IField> fields) {
  ...
  public TemplateClass setMethods(java.util.List<? extends cleon.modelinglanguages.uml.metamodel.spec.structural.classes.method.javamodel.IMethod> methods) {
  ...
  public TemplateClass setRelations(java.util.List<? extends cleon.modelinglanguages.uml.metamodel.spec.structural.classes.association.javamodel.IAssociation> relations) {
  ...
  @Override
  public java.util.List<? extends cleon.modelinglanguages.uml.metamodel.spec.structural.classes.template.javamodel.ITemplateClassParameter> selectTemplateParameters() {
    return _getList(cleon.modelinglanguages.uml.metamodel.spec.structural.classes.template.javamodel.ITemplateClassParameter.class, cleon.modelinglanguages.uml.metamodel.spec.structural.classes.template.TemplatePackage.TemplateClass_templateParameters);
  }

  public TemplateClass setTemplateParameters(java.util.List<? extends cleon.modelinglanguages.uml.metamodel.spec.structural.classes.template.javamodel.ITemplateClassParameter> templateParameters) {
    _setList(cleon.modelinglanguages.uml.metamodel.spec.structural.classes.template.TemplatePackage.TemplateClass_templateParameters, templateParameters);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptList(cleon.modelinglanguages.uml.metamodel.spec.structural.classes.template.javamodel.ITemplateClassParameter.class, cleon.modelinglanguages.uml.metamodel.spec.structural.classes.template.TemplatePackage.TemplateClass_templateParameters, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

  // toMeRelations
  
  public static cleon.modelinglanguages.uml.metamodel.spec.structural.classes.template.javamodel.ITemplateClass selectToMeTemplateParameters(cleon.modelinglanguages.uml.metamodel.spec.structural.classes.template.javamodel.ITemplateClassParameter object) {
    return _getToMeSingle(object.getRepository(), cleon.modelinglanguages.uml.metamodel.spec.structural.classes.template.javamodel.ITemplateClass.class, cleon.modelinglanguages.uml.metamodel.spec.structural.classes.template.TemplatePackage.TemplateClass_templateParameters, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,743e6460-a3b9-11e3-8095-f11af53ab806,pvp6x2UyXiqy1Fct3rpc7i0dXbk=] */
