...
public class RiskState extends DynamicResource implements IRiskState {
  ...
  public boolean isIn__F_Plan() {
    return getResource().equals(cleon.projectmethods.hermes.metamodel.spec.modules.projectsteering.riskmanagement.risks.RisksPackage.RiskState_In__F_Plan);
  }
  
  @Override
  public boolean isIn__F_Watchlist() {
    return getResource().equals(cleon.projectmethods.hermes.metamodel.spec.modules.projectsteering.riskmanagement.risks.RisksPackage.RiskState_In__F_Watchlist);
  }
  
  @Override
  public boolean isIn__F_Steering() {
    return getResource().equals(cleon.projectmethods.hermes.metamodel.spec.modules.projectsteering.riskmanagement.risks.RisksPackage.RiskState_In__F_Steering);
  }
  
  @Override
  public boolean isMaterialised() {
    return getResource().equals(cleon.projectmethods.hermes.metamodel.spec.modules.projectsteering.riskmanagement.risks.RisksPackage.RiskState_Materialised);
  }
  
  @Override
  public boolean isClosed() {
    return getResource().equals(cleon.projectmethods.hermes.metamodel.spec.modules.projectsteering.riskmanagement.risks.RisksPackage.RiskState_Closed);
  }
