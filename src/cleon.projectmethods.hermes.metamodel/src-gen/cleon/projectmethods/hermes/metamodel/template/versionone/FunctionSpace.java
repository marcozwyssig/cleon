...
public class FunctionSpace {
  ...
  public static interface IReproducibilityFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("2077d5cf-376f-11e5-95d9-2b04d7ab02d9")
    public List<java.lang.String> RenderContent(final cleon.projectmethods.hermes.metamodel.spec.modules.projectmanagement.planning.scope.workpackage.backlog.defect.javamodel.IReproducibility reproducibility);
  ...
  public static class ReproducibilityFunctions {
    ...
    public static List<java.lang.String> RenderContent(final cleon.projectmethods.hermes.metamodel.spec.modules.projectmanagement.planning.scope.workpackage.backlog.defect.javamodel.IReproducibility reproducibility) {
