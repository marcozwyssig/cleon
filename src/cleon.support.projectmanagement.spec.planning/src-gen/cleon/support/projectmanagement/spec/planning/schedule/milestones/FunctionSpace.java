package cleon.support.projectmanagement.spec.planning.schedule.milestones;
...
public class FunctionSpace {
  ...
  public static interface ISprintFunctions extends IDynamicResourceExtension {
    ...
    public List<cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.javamodel.IWorkItem> GetWorkItems();

    @IDynamicResourceExtension.MethodId("da3e9b8e-8a0e-11e6-8085-d9bdba2de943")
    public cleon.support.projectmanagement.spec.planning.schedule.milestones.javamodel.IReleases GetRelasePlanning();

    @IDynamicResourceExtension.MethodId("4f0e534b-8a0f-11e6-8085-d9bdba2de943")
    public cleon.support.projectmanagement.spec.planning.schedule.milestones.javamodel.ISprint LastSprint();
    ...
    public cleon.support.projectmanagement.spec.planning.schedule.milestones.javamodel.IRelease GetMilestone();

    @IDynamicResourceExtension.MethodId("f6a0163b-d66b-11e6-ad1f-c967b4caaf09")
    public cleon.support.projectmanagement.spec.planning.schedule.milestones.javamodel.IReleases GetMilestones();

    @IDynamicResourceExtension.MethodId("455700f4-d71a-11e6-a422-8b5491da3f30")
    public cleon.support.projectmanagement.spec.planning.schedule.milestones.javamodel.IPhase GetPhase();

    @IDynamicResourceExtension.MethodId("0e3853a4-d71b-11e6-a422-8b5491da3f30")
    public List<cleon.support.projectmanagement.spec.planning.schedule.milestones.javamodel.IRelease> GetMilestoneList();
  ...
  public static interface ISprintFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("4f0e534b-8a0f-11e6-8085-d9bdba2de943")
    public cleon.support.projectmanagement.spec.planning.schedule.milestones.javamodel.ISprint LastSprint(final cleon.support.projectmanagement.spec.planning.schedule.milestones.javamodel.ISprint sprint);
  ...
  public static class SprintFunctions {
    ...
    public static cleon.support.projectmanagement.spec.planning.schedule.milestones.javamodel.ISprint LastSprint(final cleon.support.projectmanagement.spec.planning.schedule.milestones.javamodel.ISprint sprint) {
  ...
  public static interface IReleasesFunctions extends IDynamicResourceExtension {
    ...
    public cleon.support.projectmanagement.spec.planning.schedule.milestones.javamodel.ISprint CurrentSprint();

    @IDynamicResourceExtension.MethodId("9cc04b4c-2f22-11e6-8bd9-a77b8d2a3a0e")
    public cleon.support.projectmanagement.spec.planning.schedule.milestones.javamodel.ISprint BeforeCurrentSprint();

    @IDynamicResourceExtension.MethodId("59a78067-34a0-11e6-8839-1f6631cc77ac")
    public List<cleon.support.projectmanagement.spec.planning.schedule.milestones.javamodel.ISprint> GetAllSprints();

    @IDynamicResourceExtension.MethodId("80ddb44e-36c1-11e6-ba0a-8d94de7675ef")
    public cleon.support.projectmanagement.spec.planning.schedule.milestones.javamodel.ISprint GetSprint(final java.lang.Integer sprintId);
  ...
  public static interface IReleasesFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("9f89e48d-2f1d-11e6-8bd9-a77b8d2a3a0e")
    public cleon.support.projectmanagement.spec.planning.schedule.milestones.javamodel.ISprint CurrentSprint(final cleon.support.projectmanagement.spec.planning.schedule.milestones.javamodel.IReleases releases);

    @IDynamicResourceExtension.MethodId("9cc04b4c-2f22-11e6-8bd9-a77b8d2a3a0e")
    public cleon.support.projectmanagement.spec.planning.schedule.milestones.javamodel.ISprint BeforeCurrentSprint(final cleon.support.projectmanagement.spec.planning.schedule.milestones.javamodel.IReleases releases);

    @IDynamicResourceExtension.MethodId("80ddb44e-36c1-11e6-ba0a-8d94de7675ef")
    public cleon.support.projectmanagement.spec.planning.schedule.milestones.javamodel.ISprint GetSprint(final java.lang.Integer sprintId, final cleon.support.projectmanagement.spec.planning.schedule.milestones.javamodel.IReleases releases);
  ...
  public static class ReleasesFunctions {
    ...
    public static cleon.support.projectmanagement.spec.planning.schedule.milestones.javamodel.ISprint CurrentSprint(final cleon.support.projectmanagement.spec.planning.schedule.milestones.javamodel.IReleases releases) {
    ...
    public static cleon.support.projectmanagement.spec.planning.schedule.milestones.javamodel.ISprint BeforeCurrentSprint(final cleon.support.projectmanagement.spec.planning.schedule.milestones.javamodel.IReleases releases) {
    ...
    public static cleon.support.projectmanagement.spec.planning.schedule.milestones.javamodel.ISprint GetSprint(final java.lang.Integer sprintId, final cleon.support.projectmanagement.spec.planning.schedule.milestones.javamodel.IReleases releases) {
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,7833baaa-349b-11e6-8839-1f6631cc77ac,vxJ8NdU/lrSwp/2uNMRJmIo7XQA=] */
