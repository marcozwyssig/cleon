...
public class Reproducibility extends DynamicResource implements IReproducibility {
  ...
  public java.util.List<java.lang.String> selectReproduce() {
    return _getListAttribute(java.lang.String.class, cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.defect.DefectPackage.Reproducibility_reproduce);
  }
    
  public void setReproduce(java.util.List<java.lang.String> reproduce) {
     _setListAttribute(cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.defect.DefectPackage.Reproducibility_reproduce, reproduce);
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    // attributes
    _acceptListAttribute(java.lang.String.class, cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.defect.DefectPackage.Reproducibility_reproduce, visitor);
    // relations
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,f0b01183-36b1-11e5-95d9-2b04d7ab02d9,vBglJQJM9L0pNjWYpiJDTs4P6Ao=] */
