...
public class WorkItemGroup extends DynamicResource implements IWorkItemGroup {
  ...
  public WorkItemGroup setItems(java.util.List<? extends cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.javamodel.IWorkItem> items) {
  ...
  public WorkItemGroup setPreconditions(java.util.List<? extends cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.featuregroup.javamodel.IWorkItemGroup> preconditions) {
  ...
  public WorkItemGroup setState(cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.javamodel.IWorkItemState state) {
  ...
  public static cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.featuregroup.javamodel.IWorkItemGroup selectToMeItems(cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.javamodel.IWorkItem object) {
    return _getToMeSingle(object.getRepository(), cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.featuregroup.javamodel.IWorkItemGroup.class, cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.featuregroup.FeaturegroupPackage.WorkItemGroup_items, object.getResource());
  }
  
  public static java.util.List<cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.featuregroup.javamodel.IWorkItemGroup> selectToMePreconditions(cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.featuregroup.javamodel.IWorkItemGroup object) {
    return _getToMeList(object.getRepository(), cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.featuregroup.javamodel.IWorkItemGroup.class, cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.featuregroup.FeaturegroupPackage.WorkItemGroup_preconditions, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,409913e6-369c-11e5-95d9-2b04d7ab02d9,rXpiIJkBMo4QTsmEeiWUJUoyIoA=] */
