...
public class EffortAware extends DynamicResource implements IEffortAware {
  ...
  public EffortAware setEstimate(cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.javamodel.IEffort estimate) {
  ...
  public static java.util.List<cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.javamodel.IEffortAware> selectToMeEstimate(cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.javamodel.IEffort object) {
    return _getToMeList(object.getRepository(), cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.javamodel.IEffortAware.class, cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.BacklogPackage.EffortAware_estimate, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,a2ffdac0-e6d4-11e5-a502-93f18d5742dc,AnfEF7HLhQ030cXiYfRQs+9fHwY=] */
