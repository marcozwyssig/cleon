...
public class FunctionSpace {
  ...
  public static interface IRiskFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("f99fc537-2f08-11e6-8bd9-a77b8d2a3a0e")
    public java.lang.String GetId(final cleon.support.projectmanagement.spec.steering.riskmanagement.risks.javamodel.IRisk risk);
  ...
  public static class RiskFunctions {
    ...
    public static java.lang.String GetId(final cleon.support.projectmanagement.spec.steering.riskmanagement.risks.javamodel.IRisk risk) {
  ...
  public static interface IRiskStateFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("4fb05fd1-3250-11e6-ab4d-73a9260c8088")
    public java.lang.Boolean IsOpen(final cleon.support.projectmanagement.spec.steering.riskmanagement.risks.javamodel.IRiskState riskState);

    @IDynamicResourceExtension.MethodId("7a8e30af-3250-11e6-ab4d-73a9260c8088")
    public java.lang.Boolean IsClosed(final cleon.support.projectmanagement.spec.steering.riskmanagement.risks.javamodel.IRiskState riskState);
  ...
  public static class RiskStateFunctions {
    ...
    public static java.lang.Boolean IsOpen(final cleon.support.projectmanagement.spec.steering.riskmanagement.risks.javamodel.IRiskState riskState) {
    ...
    public static java.lang.Boolean IsClosed(final cleon.support.projectmanagement.spec.steering.riskmanagement.risks.javamodel.IRiskState riskState) {
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,f25d187d-2f08-11e6-8bd9-a77b8d2a3a0e,8CwEYrXaTbcInNrqVU3SZz8GiLA=] */
