...
public class FunctionSpace_Test_Input_Connection {
  ...
  public static interface ITestInputConnectionFunctions extends IDynamicResourceExtension {
    ...
    public cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.javamodel.ISkipHostGenerationAware GetComponent();

    @IDynamicResourceExtension.MethodId("75e6c9d8-7b63-11eb-b8e5-2d821e359a02")
    public List<cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.javamodel.ISkipHostGenerationAware> GetComponents();

    @IDynamicResourceExtension.MethodId("8e96ac86-7b63-11eb-b8e5-2d821e359a02")
    public List<cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.javamodel.ISkipHostGenerationAware> GetComponentDistinct();
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,012ce424-6d6e-11e9-b84d-d319514e887f,4MNHwOCMThdSis7Z8bWexl0RI3w=] */
