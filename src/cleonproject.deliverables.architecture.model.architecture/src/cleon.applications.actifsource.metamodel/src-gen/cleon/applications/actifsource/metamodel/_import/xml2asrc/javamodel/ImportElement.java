...
public class ImportElement extends DynamicResource implements IImportElement {
  ...
  public java.lang.String selectXml__S_name() {
    return _getSingleAttribute(java.lang.String.class, cleon.applications.actifsource.metamodel._import.xml2asrc.Xml2asrcPackage.AbstractImportAttribute_xml__S_name);
  }
    
  public void setXml__S_name(java.lang.String xml__S_name) {
     _setSingleAttribute(cleon.applications.actifsource.metamodel._import.xml2asrc.Xml2asrcPackage.AbstractImportAttribute_xml__S_name, xml__S_name);
  }
  ...
  public ch.actifsource.core.javamodel.IAttribute selectAttribute() {
    return _getSingle(ch.actifsource.core.javamodel.IAttribute.class, cleon.applications.actifsource.metamodel._import.xml2asrc.Xml2asrcPackage.AbstractImportAttribute_attribute);
  }

  public ImportElement setAttribute(ch.actifsource.core.javamodel.IAttribute attribute) {
    _setSingle(cleon.applications.actifsource.metamodel._import.xml2asrc.Xml2asrcPackage.AbstractImportAttribute_attribute, attribute);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    // attributes
    _acceptSingleAttribute(java.lang.String.class, cleon.applications.actifsource.metamodel._import.xml2asrc.Xml2asrcPackage.AbstractImportAttribute_xml__S_name, visitor);
    // relations
    _acceptSingle(ch.actifsource.core.javamodel.IAttribute.class, cleon.applications.actifsource.metamodel._import.xml2asrc.Xml2asrcPackage.AbstractImportAttribute_attribute, visitor);
