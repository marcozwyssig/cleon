...
public class Xml2Asrc extends DynamicResource implements IXml2Asrc {
  ...
  public Xml2Asrc setMapAssoc(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.applications.actifsource.spec.asrc2xml.javamodel.IImportAssociation> mapAssoc) {
  ...
  public java.util.Map<ch.actifsource.core.Resource, ? extends cleon.applications.actifsource.spec.asrc2xml.javamodel.IAbstractImportAttribute> selectMapAttr() {
    return _getMap(cleon.applications.actifsource.spec.asrc2xml.javamodel.IAbstractImportAttribute.class, cleon.applications.actifsource.spec.asrc2xml.Asrc2xmlPackage.AbstractImportClass_mapAttr);
  }

  public Xml2Asrc setMapAttr(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.applications.actifsource.spec.asrc2xml.javamodel.IAbstractImportAttribute> mapAttr) {
    _setMap(cleon.applications.actifsource.spec.asrc2xml.Asrc2xmlPackage.AbstractImportClass_mapAttr, mapAttr);
    return this;
  }
  ...
  public Xml2Asrc setMapOwnRel(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.applications.actifsource.spec.asrc2xml.javamodel.IImportOwnRelation> mapOwnRel) {
  ...
  public ch.actifsource.ui.wizard.importer.generic.javamodel.IGenericImportWizard selectWizard() {
    return _getSingle(ch.actifsource.ui.wizard.importer.generic.javamodel.IGenericImportWizard.class, cleon.applications.actifsource.spec.asrc2xml.Asrc2xmlPackage.Xml2Asrc_wizard);
  }

  public Xml2Asrc setWizard(ch.actifsource.ui.wizard.importer.generic.javamodel.IGenericImportWizard wizard) {
    _setSingle(cleon.applications.actifsource.spec.asrc2xml.Asrc2xmlPackage.Xml2Asrc_wizard, wizard);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptMap(cleon.applications.actifsource.spec.asrc2xml.javamodel.IAbstractImportAttribute.class, cleon.applications.actifsource.spec.asrc2xml.Asrc2xmlPackage.AbstractImportClass_mapAttr, visitor);
    ...
    _acceptSingle(ch.actifsource.ui.wizard.importer.generic.javamodel.IGenericImportWizard.class, cleon.applications.actifsource.spec.asrc2xml.Asrc2xmlPackage.Xml2Asrc_wizard, visitor);
  }

  // toMeRelations
  
  public static java.util.List<cleon.applications.actifsource.spec.asrc2xml.javamodel.IXml2Asrc> selectToMeWizard(ch.actifsource.ui.wizard.importer.generic.javamodel.IGenericImportWizard object) {
    return _getToMeList(object.getRepository(), cleon.applications.actifsource.spec.asrc2xml.javamodel.IXml2Asrc.class, cleon.applications.actifsource.spec.asrc2xml.Asrc2xmlPackage.Xml2Asrc_wizard, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,9489a1fa-2217-11e8-8247-038452bbec5f,DuYhNIURHcBt+qbmPqnTN/2zMWc=] */
