...
public class FunctionSpace_Eclipse {
  ...
  public static interface IPluginFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("0121d453-41aa-11e8-81d0-774e4d9334dd")
    public java.lang.String RenderNatureName(final cleon.applications.actifsource.spec.actifsource.system.category.feature.plugin.nature.javamodel.IPlugin plugin);

    @IDynamicResourceExtension.MethodId("45bf98ac-41aa-11e8-81d0-774e4d9334dd")
    public java.lang.String RenderBuildCommand(final cleon.applications.actifsource.spec.actifsource.system.category.feature.plugin.nature.javamodel.IPlugin plugin);
  ...
  public static class PluginFunctions {
    ...
    public static java.lang.String RenderNatureName(final cleon.applications.actifsource.spec.actifsource.system.category.feature.plugin.nature.javamodel.IPlugin plugin) {
      return DynamicResourceUtil.invoke(IPluginFunctionsImpl.class, PluginFunctionsImpl.INSTANCE, plugin).RenderNatureName(plugin);
    }

    public static java.lang.String RenderBuildCommand(final cleon.applications.actifsource.spec.actifsource.system.category.feature.plugin.nature.javamodel.IPlugin plugin) {
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,30ec7375-11ea-11e5-b568-55f5f05bd6f6,eolhtmDo6Zb1XEt8vku+yJ4LnJQ=] */
