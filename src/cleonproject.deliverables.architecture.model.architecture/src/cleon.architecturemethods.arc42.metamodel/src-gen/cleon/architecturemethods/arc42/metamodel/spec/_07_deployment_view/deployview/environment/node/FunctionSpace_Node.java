package cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node;
...
import cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode;
...
public class FunctionSpace_Node {
  ...
  public static interface INodeFunctions extends IDynamicResourceExtension {
    ...
    public cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.javamodel.INode GetParent();

    @IDynamicResourceExtension.MethodId("66093688-02d5-11e9-9e58-33d596257b14")
    public List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.javamodel.ISupplyAndBuildNodeDecomposite> GetParents();

    @IDynamicResourceExtension.MethodId("8dd02a63-02d5-11e9-9e58-33d596257b14")
    public cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.supplynode.javamodel.ISupplySiteNode GetSubnetNode();

    @IDynamicResourceExtension.MethodId("bef20cb3-0e2a-11e9-8b4c-f9aec93d8b56")
    public cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.supplynode.javamodel.ISupplyDataCenter GetLocationNode();
    ...
    public List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.javamodel.INode> GetAllNestedNodes();
    ...
    public List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.supplynode.javamodel.ISupplySiteNode> GetAllNestedSiteNodes();
    ...
    public List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode> GetAllNestedBuildNodes();

    @IDynamicResourceExtension.MethodId("73b6c2b1-b25a-11eb-84da-a358b37bb644")
    public List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IServiceBuildNode> GetAllNestedServiceBuildNodes();
    ...
    public List<cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.systemcomponent.javamodel.ISystemComponent> GetAllUsedSystemComponent();

    @IDynamicResourceExtension.MethodId("f7c1ba46-7f15-11e9-9a52-07d4b074defc")
    public List<cleon.architecturemethods.arc42.metamodel.spec._05_buildingblock_view.system.systemconfiguration.javamodel.ISystemConfiguration> GetAllUsedSystemConfiguration();

    @IDynamicResourceExtension.MethodId("8808b193-cdc3-11eb-9255-4575b555e23e")
    public cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.javamodel.INode GetNestedNode();

    @IDynamicResourceExtension.MethodId("b12ac911-cdc3-11eb-9255-4575b555e23e")
    public cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode GetNestedBuildNode();

    @IDynamicResourceExtension.MethodId("c674c46c-cdc3-11eb-9255-4575b555e23e")
    public List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode> GetNestedBuildNodes();

    @IDynamicResourceExtension.MethodId("68da6b3e-87f3-11ec-894d-7968efa38b99")
    public List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode> OnlyHyperVisorComponents();

    @IDynamicResourceExtension.MethodId("fadb5261-87f4-11ec-894d-7968efa38b99")
    public List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode> OnlyVMComponents();

    @IDynamicResourceExtension.MethodId("77892a21-8803-11ec-894d-7968efa38b99")
    public List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode> OnlyOSComponents();
  ...
  public static interface INodeFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("68da6b3e-87f3-11ec-894d-7968efa38b99")
    public List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode> OnlyHyperVisorComponents(final List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.javamodel.INode> nodeList);

    @IDynamicResourceExtension.MethodId("fadb5261-87f4-11ec-894d-7968efa38b99")
    public List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode> OnlyVMComponents(final List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.javamodel.INode> nodeList);

    @IDynamicResourceExtension.MethodId("77892a21-8803-11ec-894d-7968efa38b99")
    public List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode> OnlyOSComponents(final List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.javamodel.INode> nodeList);
  ...
  public static class NodeFunctions {
    ...
    public static List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode> OnlyHyperVisorComponents(final List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.javamodel.INode> nodeList) {
    ...
    public static List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode> OnlyVMComponents(final List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.javamodel.INode> nodeList) {
      return DynamicResourceUtil.invoke(INodeFunctionsImpl.class, NodeFunctionsImpl.INSTANCE, nodeList).OnlyVMComponents(nodeList);
    }

    public static List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode> OnlyOSComponents(final List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.javamodel.INode> nodeList) {
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,41a52ff4-0b73-11e9-a136-69d076e48ed1,LGuBcb2TffgDyk5k0raH2EiXoqw=] */
