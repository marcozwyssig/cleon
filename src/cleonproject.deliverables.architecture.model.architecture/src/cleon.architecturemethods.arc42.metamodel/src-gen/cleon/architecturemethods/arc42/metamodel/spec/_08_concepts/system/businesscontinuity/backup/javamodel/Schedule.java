...
public class Schedule extends DynamicResource implements ISchedule {
  ...
  public boolean isDaily() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._08_concepts.system.businesscontinuity.backup.BackupPackage.Schedule_Daily);
  }
  
  @Override
  public boolean isWeekly() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._08_concepts.system.businesscontinuity.backup.BackupPackage.Schedule_Weekly);
  }
  
  @Override
  public boolean isMonthly() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._08_concepts.system.businesscontinuity.backup.BackupPackage.Schedule_Monthly);
  }
