...
public class Condition extends DynamicResource implements ICondition {
  ...
  public java.lang.String selectValue() {
    return _getSingleAttribute(java.lang.String.class, cleon.architecturemethods.arc42.metamodel.spec._08_data_view.view.ViewPackage.Condition_value);
  }
    
  public void setValue(java.lang.String value) {
     _setSingleAttribute(cleon.architecturemethods.arc42.metamodel.spec._08_data_view.view.ViewPackage.Condition_value, value);
  }
  ...
  public Condition setColumn(cleon.architecturemethods.arc42.metamodel.spec._08_data_view.table.javamodel.IColumn column) {
  ...
  public ch.actifsource.core.validation.javamodel.IConditionalOperator selectOperator() {
    return _getSingle(ch.actifsource.core.validation.javamodel.IConditionalOperator.class, cleon.architecturemethods.arc42.metamodel.spec._08_data_view.view.ViewPackage.Condition_operator);
  }

  public Condition setOperator(ch.actifsource.core.validation.javamodel.IConditionalOperator operator) {
    _setSingle(cleon.architecturemethods.arc42.metamodel.spec._08_data_view.view.ViewPackage.Condition_operator, operator);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    // attributes
    _acceptSingleAttribute(java.lang.String.class, cleon.architecturemethods.arc42.metamodel.spec._08_data_view.view.ViewPackage.Condition_value, visitor);
    // relations
    ...
    _acceptSingle(ch.actifsource.core.validation.javamodel.IConditionalOperator.class, cleon.architecturemethods.arc42.metamodel.spec._08_data_view.view.ViewPackage.Condition_operator, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

  // toMeRelations
  
  public static java.util.List<cleon.architecturemethods.arc42.metamodel.spec._08_data_view.view.javamodel.ICondition> selectToMeOperator(ch.actifsource.core.validation.javamodel.IConditionalOperator object) {
    return _getToMeList(object.getRepository(), cleon.architecturemethods.arc42.metamodel.spec._08_data_view.view.javamodel.ICondition.class, cleon.architecturemethods.arc42.metamodel.spec._08_data_view.view.ViewPackage.Condition_operator, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,f75c24b0-d0d0-11ee-bd60-4767a6be68d4,Oq91kLSkasgQG+qGUwQj47E/UP0=] */
