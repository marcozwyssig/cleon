...
public class SelectColumn extends DynamicResource implements ISelectColumn {
  ...
  public java.lang.Boolean selectDistinct() {
    return _getSingleAttribute(java.lang.Boolean.class, cleon.architecturemethods.arc42.metamodel.spec._08_data_view.view.ViewPackage.SelectColumn_distinct);
  }
    
  public void setDistinct(java.lang.Boolean distinct) {
     _setSingleAttribute(cleon.architecturemethods.arc42.metamodel.spec._08_data_view.view.ViewPackage.SelectColumn_distinct, distinct);
  }
  ...
  public cleon.architecturemethods.arc42.metamodel.spec._08_data_view.view.javamodel.ISelectAggregate selectAggregate() {
    return _getSingle(cleon.architecturemethods.arc42.metamodel.spec._08_data_view.view.javamodel.ISelectAggregate.class, cleon.architecturemethods.arc42.metamodel.spec._08_data_view.view.ViewPackage.SelectColumn_aggregate);
  }

  public SelectColumn setAggregate(cleon.architecturemethods.arc42.metamodel.spec._08_data_view.view.javamodel.ISelectAggregate aggregate) {
    _setSingle(cleon.architecturemethods.arc42.metamodel.spec._08_data_view.view.ViewPackage.SelectColumn_aggregate, aggregate);
    return this;
  }
  ...
  public SelectColumn setColumn(cleon.architecturemethods.arc42.metamodel.spec._08_data_view.table.javamodel.IColumn column) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingleAttribute(java.lang.Boolean.class, cleon.architecturemethods.arc42.metamodel.spec._08_data_view.view.ViewPackage.SelectColumn_distinct, visitor);
    // relations
    _acceptSingle(cleon.architecturemethods.arc42.metamodel.spec._08_data_view.view.javamodel.ISelectAggregate.class, cleon.architecturemethods.arc42.metamodel.spec._08_data_view.view.ViewPackage.SelectColumn_aggregate, visitor);
  ...
  public static java.util.List<cleon.architecturemethods.arc42.metamodel.spec._08_data_view.view.javamodel.ISelectColumn> selectToMeAggregate(cleon.architecturemethods.arc42.metamodel.spec._08_data_view.view.javamodel.ISelectAggregate object) {
    return _getToMeList(object.getRepository(), cleon.architecturemethods.arc42.metamodel.spec._08_data_view.view.javamodel.ISelectColumn.class, cleon.architecturemethods.arc42.metamodel.spec._08_data_view.view.ViewPackage.SelectColumn_aggregate, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,50a4626f-d0cc-11ee-a38e-0b82bafb3097,++AV8rnAEmTL1Ll0PQtnLMfAwHQ=] */
