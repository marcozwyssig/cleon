...
public class AccessConfigurationWebService extends DynamicResource implements IAccessConfigurationWebService {
  ...
  public java.lang.String selectUrlpath() {
    return _getSingleAttribute(java.lang.String.class, cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.access.AccessPackage.AccessConfigurationWebService_urlpath);
  }
    
  public void setUrlpath(java.lang.String urlpath) {
     _setSingleAttribute(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.access.AccessPackage.AccessConfigurationWebService_urlpath, urlpath);
  }
  ...
  public AccessConfigurationWebService setHostAccessMode(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.access.javamodel.IHostAccessMode hostAccessMode) {
  ...
  public AccessConfigurationWebService setService(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.services.javamodel.IPortService service) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    // attributes
    _acceptSingleAttribute(java.lang.String.class, cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.access.AccessPackage.AccessConfigurationWebService_urlpath, visitor);
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,f9a055fc-bfcc-11eb-af9a-7dff6e60ee1f,37fnacM62xq4AbTxHD3A3XogRno=] */
