...
public class DSCP extends DynamicResource implements IDSCP {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<IDSCP> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<IDSCP>() {
    ...
    @Override
    public IDSCP create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new DSCP(resourceRepository, resource);
    }
  ...
  public DSCP(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
    super(resourceRepository, resource, IDSCP.TYPE_ID);
  }
  ...
  @Override
  public java.lang.Integer selectValue() {
    return _getSingleAttribute(java.lang.Integer.class, cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.qos.QosPackage.DSCP_value);
  }
    
  public void setValue(java.lang.Integer value) {
     _setSingleAttribute(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.qos.QosPackage.DSCP_value, value);
  }
  ...
  public DSCP setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingleAttribute(java.lang.Integer.class, cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.qos.QosPackage.DSCP_value, visitor);
    // relations
  ...
  public boolean isAF11__F___S___F_High__F_Throughput__F_Data() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.qos.QosPackage.DSCP_AF11__F___S___F_High__F_Throughput__F_Data);
  }
  
  @Override
  public boolean isAF21__F___S___F_Low__F_Latency__F_Data() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.qos.QosPackage.DSCP_AF21__F___S___F_Low__F_Latency__F_Data);
  }
  
  @Override
  public boolean isAF31__F___S___F_Multimedia__F_Streaming() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.qos.QosPackage.DSCP_AF31__F___S___F_Multimedia__F_Streaming);
  }
  
  @Override
  public boolean isAF41__F___S___F_Multimedia__F_Conferencing() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.qos.QosPackage.DSCP_AF41__F___S___F_Multimedia__F_Conferencing);
  }
  
  @Override
  public boolean isCS1__F___S___F_Low__S_Priority__F_Data() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.qos.QosPackage.DSCP_CS1__F___S___F_Low__S_Priority__F_Data);
  }
  
  @Override
  public boolean isCS2__F___S___F_OAM__F___N_Operation__R___F_Administration__R___F_Maintenance__O_() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.qos.QosPackage.DSCP_CS2__F___S___F_OAM__F___N_Operation__R___F_Administration__R___F_Maintenance__O_);
  }
  
  @Override
  public boolean isCS3__F___S___F_Broadcast__F_Video() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.qos.QosPackage.DSCP_CS3__F___S___F_Broadcast__F_Video);
  }
  
  @Override
  public boolean isCS4__F___S___F_Real__F_time__F_Interactive() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.qos.QosPackage.DSCP_CS4__F___S___F_Real__F_time__F_Interactive);
  }
  
  @Override
  public boolean isCS5__F___S___F_Signalling() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.qos.QosPackage.DSCP_CS5__F___S___F_Signalling);
  }
  
  @Override
  public boolean isCS6__F___S___F_Network__F_Control__F___N_Access__O_() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.qos.QosPackage.DSCP_CS6__F___S___F_Network__F_Control__F___N_Access__O_);
  }
  
  @Override
  public boolean isCS7__F___S___F_Network__F_Control__F___N_Backbone__O___F_() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.qos.QosPackage.DSCP_CS7__F___S___F_Network__F_Control__F___N_Backbone__O___F_);
  }
  
  @Override
  public boolean isDF__F___S___F_Standard() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.qos.QosPackage.DSCP_DF__F___S___F_Standard);
  }
  
  @Override
  public boolean isEF__F___S___F_Telephony() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.qos.QosPackage.DSCP_EF__F___S___F_Telephony);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,af43badb-1d88-11e9-b601-db75aa6f89a4,ayl+4H8Aod9dd/z2nKZaSDWaHcs=] */
