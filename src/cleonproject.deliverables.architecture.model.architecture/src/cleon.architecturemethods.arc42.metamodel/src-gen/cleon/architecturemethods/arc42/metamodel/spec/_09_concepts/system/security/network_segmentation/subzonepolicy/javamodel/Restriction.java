...
public class Restriction extends DynamicResource implements IRestriction {
  ...
  public boolean isRestricted() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.security.network_segmentation.subzonepolicy.SubzonepolicyPackage.Restriction_Restricted);
  }
  
  @Override
  public boolean isAllowed() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.security.network_segmentation.subzonepolicy.SubzonepolicyPackage.Restriction_Allowed);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,f310eb7a-b844-11e9-8760-2d4a9d15ec14,aqE+vcBMrfcxPhX648Pk2/Gw5gw=] */
