...
public class LAGType extends DynamicResource implements ILAGType {
  ...
  @Override
  public boolean isH() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.topology.TopologyPackage.LAGType_H);
  }
  
  @Override
  public boolean isG() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.topology.TopologyPackage.LAGType_G);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,4ded4698-303c-11ed-b561-abe8147b73fc,8ejPjbUnNH9RA/E/zr/XVGawG3Q=] */
