...
public class Location extends DynamicResource implements ILocation {
  ...
  @Override
  public boolean isA() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.topology.TopologyPackage.Location_A);
  }
  
  @Override
  public boolean isB() {
    return getResource().equals(cleon.architecturemethods.arc42.metamodel.spec._09_concepts.system.topology.TopologyPackage.Location_B);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,865b3a4b-57c9-11ea-bd7a-4baf1bc87b3c,gC3wMlLjMyLzrbM0KO1N68fYhT8=] */
