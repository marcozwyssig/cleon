...
import cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.javamodel.INode;
...
public class FunctionSpace_SystemArc42_PlantUml {
  ...
  public static interface INodeFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("5254da7b-18e9-11e9-84df-097eeec74d2d")
    public java.lang.String RenderHidden(final List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.javamodel.INode> nodeList);
  ...
  public static class NodeFunctions {
    ...
    public static java.lang.String RenderHidden(final List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.javamodel.INode> nodeList) {
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,f247dcd9-02db-11e9-9e58-33d596257b14,+0nJg8aRxO0TQDmnM+DFjQh5KGc=] */
