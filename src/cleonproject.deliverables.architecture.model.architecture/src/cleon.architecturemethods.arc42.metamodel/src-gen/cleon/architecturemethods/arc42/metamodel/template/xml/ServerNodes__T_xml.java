...
public class ServerNodes__T_xml {
  ...
  public static interface INodeFunctions extends IDynamicResourceExtension {
    ...
    public List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode> OnlyServerWithWindows();
  ...
  public static interface INodeFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("4697afc3-e37b-11ea-90a0-29b751c6ace9")
    public List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode> OnlyServerWithWindows(final List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.javamodel.INode> nodeList);
      ...
      return nodeList.stream()
      		...
      		.filter(build -> {
      			if( build.selectInstanceOf() instanceof IServerSystemConfiguration ) {
      				final cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.FunctionSpace_Node.INodeFunctions functions = build.extension(cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.FunctionSpace_Node.INodeFunctions.class);
  ...
  public static class NodeFunctions {
    ...
    public static List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.buildnode.javamodel.IBuildNode> OnlyServerWithWindows(final List<cleon.architecturemethods.arc42.metamodel.spec._07_deployment_view.deployview.environment.node.javamodel.INode> nodeList) {
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,b12f0237-e2b4-11ea-a524-1b14d0598ecd,va+Iu2NdVBQfOw2JqvH5vassbGI=] */
