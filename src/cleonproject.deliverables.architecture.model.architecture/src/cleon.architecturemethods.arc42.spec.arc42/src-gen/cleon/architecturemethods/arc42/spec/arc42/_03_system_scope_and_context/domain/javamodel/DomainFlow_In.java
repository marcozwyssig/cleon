...
public class DomainFlow_In extends DynamicResource implements IDomainFlow_In {
  ...
  public cleon.modelinglanguages.uml.spec.uml2.structural.components.ports.javamodel.IPort_Provider selectPort_Provider() {
    return _getSingle(cleon.modelinglanguages.uml.spec.uml2.structural.components.ports.javamodel.IPort_Provider.class, cleon.architecturemethods.arc42.spec.arc42._03_system_scope_and_context.domain.DomainPackage.DomainFlow_aE_In_port_aE_Provider);
  }

  public DomainFlow_In setPort_Provider(cleon.modelinglanguages.uml.spec.uml2.structural.components.ports.javamodel.IPort_Provider port_Provider) {
    _setSingle(cleon.architecturemethods.arc42.spec.arc42._03_system_scope_and_context.domain.DomainPackage.DomainFlow_aE_In_port_aE_Provider, port_Provider);
    return this;
  }
  ...
  public static java.util.List<cleon.architecturemethods.arc42.spec.arc42._03_system_scope_and_context.domain.javamodel.IDomainFlow_In> selectToMePort_Provider(cleon.modelinglanguages.uml.spec.uml2.structural.components.ports.javamodel.IPort_Provider object) {
    return _getToMeList(object.getRepository(), cleon.architecturemethods.arc42.spec.arc42._03_system_scope_and_context.domain.javamodel.IDomainFlow_In.class, cleon.architecturemethods.arc42.spec.arc42._03_system_scope_and_context.domain.DomainPackage.DomainFlow_aE_In_port_aE_Provider, object.getResource());
  }
