...
public class NamedArc42Document extends DynamicResource implements INamedArc42Document {
  ...
  public NamedArc42Document setAbout(cleon.common.doc.doc.spec.chapter.about.javamodel.IAbout about) {
  ...
  public NamedArc42Document setChapters(java.util.List<? extends cleon.common.doc.doc.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public NamedArc42Document setDocumentElements(java.util.List<? extends cleon.common.doc.doc.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public NamedArc42Document setDocumentLanguage(java.util.List<? extends cleon.common.doc.doc.spec.documentlanguage.javamodel.IDocumentLanguage> documentLanguage) {
  ...
  public NamedArc42Document setParagraphs(java.util.List<? extends cleon.common.doc.doc.spec.paragraph.javamodel.IParagraph> paragraphs) {
  ...
  public NamedArc42Document setProperties(cleon.common.doc.doc.spec.document.properties.javamodel.IProperties properties) {
  ...
  public NamedArc42Document setStyle(cleon.common.doc.doc.spec.document.style.javamodel.IStyle style) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,58270d36-45a6-11e5-be7f-05f703299ead,RKKrx+dWVKDAjb/hZ7BH3PFKuu4=] */
