...
public class SoftwareSystem extends DynamicResource implements ISoftwareSystem {
  ...
  public SoftwareSystem setDecompose(java.util.List<? extends cleon.common.modularity.spec.buildingblock.javamodel.IDecomposite> decompose) {
  ...
  public java.util.List<? extends cleon.common.modularity.spec.buildingblock.javamodel.IDependency> selectHasDependency() {
    return _getList(cleon.common.modularity.spec.buildingblock.javamodel.IDependency.class, cleon.conception.architecture.spec.arc42.Arc42Package.SoftwareSystem_hasDependency);
  }

  public SoftwareSystem setHasDependency(java.util.List<? extends cleon.common.modularity.spec.buildingblock.javamodel.IDependency> hasDependency) {
    _setList(cleon.conception.architecture.spec.arc42.Arc42Package.SoftwareSystem_hasDependency, hasDependency);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptList(cleon.common.modularity.spec.buildingblock.javamodel.IDependency.class, cleon.conception.architecture.spec.arc42.Arc42Package.SoftwareSystem_hasDependency, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

  // toMeRelations
  
  public static cleon.conception.architecture.spec.arc42.javamodel.ISoftwareSystem selectToMeHasDependency(cleon.common.modularity.spec.buildingblock.javamodel.IDependency object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.architecture.spec.arc42.javamodel.ISoftwareSystem.class, cleon.conception.architecture.spec.arc42.Arc42Package.SoftwareSystem_hasDependency, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,9237e4d5-4aa3-11e6-9c0f-393d355c5fe3,qGhjNMFt8T66nSRPJglk7KiEE9Y=] */
