...
public class Entity extends DynamicResource implements IEntity {
  ...
  public Entity setCustomEvents(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.classes.events.javamodel.ICustomEvent> customEvents) {
  ...
  public Entity setEvents(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.classes.events.javamodel.IEvent> events) {
    _setList(cleon.modelinglanguages.uml.spec.uml2.structural.classes.ClassesPackage.EventClass_events, events);
    return this;
  }
    
  @Override
  public cleon.architecturemethods.arc42.spec.ddd.entities.javamodel.IEntity selectExtends() {
    return _getSingle(cleon.architecturemethods.arc42.spec.ddd.entities.javamodel.IEntity.class, cleon.architecturemethods.arc42.spec.ddd.entities.EntitiesPackage.Entity_extends);
  }

  public Entity setExtends(cleon.architecturemethods.arc42.spec.ddd.entities.javamodel.IEntity extends_) {
    _setSingle(cleon.architecturemethods.arc42.spec.ddd.entities.EntitiesPackage.Entity_extends, extends_);
    return this;
  }
  ...
  public Entity setFieldEvents(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.modelinglanguages.uml.spec.uml2.structural.classes.events.javamodel.IEventForField> fieldEvents) {
  ...
  public Entity setFields(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.classes.fields.javamodel.IField> fields) {
  ...
  public Entity setHasDependency(java.util.List<? extends cleon.common.modularity.spec.buildingblock.javamodel.IDependency> hasDependency) {
  ...
  public Entity setMethods(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.classes.method.javamodel.IMethod> methods) {
  ...
  public Entity setRelations(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.classes.association.javamodel.IAssociation> relations) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(cleon.architecturemethods.arc42.spec.ddd.entities.javamodel.IEntity.class, cleon.architecturemethods.arc42.spec.ddd.entities.EntitiesPackage.Entity_extends, visitor);
  ...
  public static java.util.List<cleon.architecturemethods.arc42.spec.ddd.entities.javamodel.IEntity> selectToMeExtends(cleon.architecturemethods.arc42.spec.ddd.entities.javamodel.IEntity object) {
    return _getToMeList(object.getRepository(), cleon.architecturemethods.arc42.spec.ddd.entities.javamodel.IEntity.class, cleon.architecturemethods.arc42.spec.ddd.entities.EntitiesPackage.Entity_extends, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,8914497d-10c0-11e3-b60e-ab478a3e1eca,c+INBBSyF8p5uIlsxJqwaAUIXp4=] */
