...
public class Repository extends DynamicResource implements IRepository {
  ...
  public java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.classes.method.javamodel.IMethod> selectGetBy() {
    return _getList(cleon.modelinglanguages.uml.spec.uml2.structural.classes.method.javamodel.IMethod.class, cleon.architecturemethods.arc42.spec.ddd.repository.RepositoryPackage.Repository_getBy);
  }
  ...
  public Repository setGetBy(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.classes.method.javamodel.IMethod> getBy) {
    _setList(cleon.architecturemethods.arc42.spec.ddd.repository.RepositoryPackage.Repository_getBy, getBy);
    return this;
  }
  ...
  public cleon.architecturemethods.arc42.spec.ddd.entities.javamodel.IEntity selectSearch() {
    return _getSingle(cleon.architecturemethods.arc42.spec.ddd.entities.javamodel.IEntity.class, cleon.architecturemethods.arc42.spec.ddd.repository.RepositoryPackage.Repository_search);
  }

  public Repository setSearch(cleon.architecturemethods.arc42.spec.ddd.entities.javamodel.IEntity search) {
    _setSingle(cleon.architecturemethods.arc42.spec.ddd.repository.RepositoryPackage.Repository_search, search);
    return this;
  }
  ...
  public java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.classes.method.javamodel.IMethod> selectSearchBy() {
    return _getList(cleon.modelinglanguages.uml.spec.uml2.structural.classes.method.javamodel.IMethod.class, cleon.architecturemethods.arc42.spec.ddd.repository.RepositoryPackage.Repository_searchBy);
  }
  ...
  public Repository setSearchBy(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.classes.method.javamodel.IMethod> searchBy) {
    _setList(cleon.architecturemethods.arc42.spec.ddd.repository.RepositoryPackage.Repository_searchBy, searchBy);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptList(cleon.modelinglanguages.uml.spec.uml2.structural.classes.method.javamodel.IMethod.class, cleon.architecturemethods.arc42.spec.ddd.repository.RepositoryPackage.Repository_getBy, visitor);
    ...
    _acceptSingle(cleon.architecturemethods.arc42.spec.ddd.entities.javamodel.IEntity.class, cleon.architecturemethods.arc42.spec.ddd.repository.RepositoryPackage.Repository_search, visitor);
    _acceptList(cleon.modelinglanguages.uml.spec.uml2.structural.classes.method.javamodel.IMethod.class, cleon.architecturemethods.arc42.spec.ddd.repository.RepositoryPackage.Repository_searchBy, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

  // toMeRelations
  
  public static java.util.List<cleon.architecturemethods.arc42.spec.ddd.repository.javamodel.IRepository> selectToMeSearch(cleon.architecturemethods.arc42.spec.ddd.entities.javamodel.IEntity object) {
    return _getToMeList(object.getRepository(), cleon.architecturemethods.arc42.spec.ddd.repository.javamodel.IRepository.class, cleon.architecturemethods.arc42.spec.ddd.repository.RepositoryPackage.Repository_search, object.getResource());
  }
  
  public static cleon.architecturemethods.arc42.spec.ddd.repository.javamodel.IRepository selectToMeSearchBy(cleon.modelinglanguages.uml.spec.uml2.structural.classes.method.javamodel.IMethod object) {
    return _getToMeSingle(object.getRepository(), cleon.architecturemethods.arc42.spec.ddd.repository.javamodel.IRepository.class, cleon.architecturemethods.arc42.spec.ddd.repository.RepositoryPackage.Repository_searchBy, object.getResource());
  }
  
  public static cleon.architecturemethods.arc42.spec.ddd.repository.javamodel.IRepository selectToMeGetBy(cleon.modelinglanguages.uml.spec.uml2.structural.classes.method.javamodel.IMethod object) {
    return _getToMeSingle(object.getRepository(), cleon.architecturemethods.arc42.spec.ddd.repository.javamodel.IRepository.class, cleon.architecturemethods.arc42.spec.ddd.repository.RepositoryPackage.Repository_getBy, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,5e627f84-10c2-11e3-b60e-ab478a3e1eca,3tnbWOMjuJzh2nh6Kg9eLTGfdG0=] */
