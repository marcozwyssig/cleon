...
public class ContentControlView extends DynamicResource implements IContentControlView {
  ...
  public ContentControlView setCustomEvents(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.classes.events.javamodel.ICustomEvent> customEvents) {
  ...
  public ContentControlView setEvents(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.classes.events.javamodel.IEvent> events) {
  ...
  public ContentControlView setExtends(cleon.architecturemethods.arc42.spec.desktop.mvvm.javamodel.IView extends_) {
  ...
  public ContentControlView setFieldEvents(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.modelinglanguages.uml.spec.uml2.structural.classes.events.javamodel.IEventForField> fieldEvents) {
  ...
  public ContentControlView setFields(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.classes.fields.javamodel.IField> fields) {
  ...
  public ContentControlView setHasDependency(java.util.List<? extends cleon.common.modularity.spec.buildingblock.javamodel.IDependency> hasDependency) {
  ...
  public ContentControlView setMethods(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.classes.method.javamodel.IMethod> methods) {
  ...
  public ContentControlView setRelations(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.classes.association.javamodel.IAssociation> relations) {
  ...
  public ContentControlView setViewModel(cleon.architecturemethods.arc42.spec.desktop.mvvm.javamodel.IViewModelDependency viewModel) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,5620ce54-92f5-11e3-a63e-fb8038f76aec,XtPFafFzMbixNXpwmgASeOfCEs4=] */
