...
public class TemplateControlView extends DynamicResource implements ITemplateControlView {
  ...
  public TemplateControlView setCustomEvents(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.classes.events.javamodel.ICustomEvent> customEvents) {
  ...
  public TemplateControlView setEvents(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.classes.events.javamodel.IEvent> events) {
  ...
  public TemplateControlView setExtends(cleon.architecturemethods.arc42.spec.desktop.mvvm.javamodel.IView extends_) {
  ...
  public TemplateControlView setFieldEvents(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.modelinglanguages.uml.spec.uml2.structural.classes.events.javamodel.IEventForField> fieldEvents) {
  ...
  public TemplateControlView setFields(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.classes.fields.javamodel.IField> fields) {
  ...
  public TemplateControlView setHasDependency(java.util.List<? extends cleon.common.modularity.spec.buildingblock.javamodel.IDependency> hasDependency) {
  ...
  public TemplateControlView setMethods(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.classes.method.javamodel.IMethod> methods) {
  ...
  public TemplateControlView setRelations(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.classes.association.javamodel.IAssociation> relations) {
  ...
  public TemplateControlView setViewModel(cleon.architecturemethods.arc42.spec.desktop.mvvm.javamodel.IViewModelDependency viewModel) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,594575f1-634e-11e3-9288-bdf1907ca1e3,P1nVbmbTst2S5t3Qzf8C6BLJoPM=] */
