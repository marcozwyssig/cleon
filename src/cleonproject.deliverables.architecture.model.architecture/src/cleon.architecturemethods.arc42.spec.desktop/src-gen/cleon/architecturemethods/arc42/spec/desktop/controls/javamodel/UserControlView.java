package cleon.architecturemethods.arc42.spec.desktop.controls.javamodel;
...
public class UserControlView extends DynamicResource implements IUserControlView {
  ...
  public UserControlView setCustomEvents(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.classes.events.javamodel.ICustomEvent> customEvents) {
  ...
  public UserControlView setEvents(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.classes.events.javamodel.IEvent> events) {
    _setList(cleon.modelinglanguages.uml.spec.uml2.structural.classes.ClassesPackage.EventClass_events, events);
    return this;
  }
    
  @Override
  public cleon.architecturemethods.arc42.spec.desktop.mvvm.javamodel.IView selectExtends() {
    return _getSingle(cleon.architecturemethods.arc42.spec.desktop.mvvm.javamodel.IView.class, cleon.architecturemethods.arc42.spec.desktop.mvvm.MvvmPackage.View_extends);
  }

  public UserControlView setExtends(cleon.architecturemethods.arc42.spec.desktop.mvvm.javamodel.IView extends_) {
    _setSingle(cleon.architecturemethods.arc42.spec.desktop.mvvm.MvvmPackage.View_extends, extends_);
    return this;
  }
  ...
  public UserControlView setFieldEvents(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.modelinglanguages.uml.spec.uml2.structural.classes.events.javamodel.IEventForField> fieldEvents) {
  ...
  public UserControlView setFields(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.classes.fields.javamodel.IField> fields) {
  ...
  public UserControlView setHasDependency(java.util.List<? extends cleon.common.modularity.spec.buildingblock.javamodel.IDependency> hasDependency) {
  ...
  public UserControlView setMethods(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.classes.method.javamodel.IMethod> methods) {
  ...
  public UserControlView setRelations(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.classes.association.javamodel.IAssociation> relations) {
  ...
  @Override
  public cleon.architecturemethods.arc42.spec.desktop.mvvm.javamodel.IViewModelDependency selectViewModel() {
    return _getSingle(cleon.architecturemethods.arc42.spec.desktop.mvvm.javamodel.IViewModelDependency.class, cleon.architecturemethods.arc42.spec.desktop.mvvm.MvvmPackage.View_viewModel);
  }

  public UserControlView setViewModel(cleon.architecturemethods.arc42.spec.desktop.mvvm.javamodel.IViewModelDependency viewModel) {
    _setSingle(cleon.architecturemethods.arc42.spec.desktop.mvvm.MvvmPackage.View_viewModel, viewModel);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(cleon.architecturemethods.arc42.spec.desktop.mvvm.javamodel.IView.class, cleon.architecturemethods.arc42.spec.desktop.mvvm.MvvmPackage.View_extends, visitor);
    ...
    _acceptSingle(cleon.architecturemethods.arc42.spec.desktop.mvvm.javamodel.IViewModelDependency.class, cleon.architecturemethods.arc42.spec.desktop.mvvm.MvvmPackage.View_viewModel, visitor);
  }

}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,4947868f-634e-11e3-9288-bdf1907ca1e3,99Z12YeJdpVOxVKnFfSLtzpgoGE=] */
