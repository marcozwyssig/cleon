...
public class ViewModelDependency extends DynamicResource implements IViewModelDependency {
  ...
  @Override
  public cleon.architecturemethods.arc42.spec.desktop.mvvm.javamodel.IViewModel selectTo() {
    return _getSingle(cleon.architecturemethods.arc42.spec.desktop.mvvm.javamodel.IViewModel.class, cleon.architecturemethods.arc42.spec.desktop.mvvm.MvvmPackage.ViewModelDependency_to);
  }

  public ViewModelDependency setTo(cleon.architecturemethods.arc42.spec.desktop.mvvm.javamodel.IViewModel to) {
    _setSingle(cleon.architecturemethods.arc42.spec.desktop.mvvm.MvvmPackage.ViewModelDependency_to, to);
    return this;
  }
  ...
  public static java.util.List<cleon.architecturemethods.arc42.spec.desktop.mvvm.javamodel.IViewModelDependency> selectToMeTo(cleon.architecturemethods.arc42.spec.desktop.mvvm.javamodel.IViewModel object) {
    return _getToMeList(object.getRepository(), cleon.architecturemethods.arc42.spec.desktop.mvvm.javamodel.IViewModelDependency.class, cleon.architecturemethods.arc42.spec.desktop.mvvm.MvvmPackage.ViewModelDependency_to, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,e5f87cbd-3b5e-11e5-86bc-73aedc28563d,JWqscmgs5HUh8MmrxDuuHh+8LdI=] */
