package cleon.architecturemethods.arc42.spec.devops.spec.deploy;
...
public class DeployPackage {
  ...
  public static final String getPackageName() {
    return "cleon.architecturemethods.arc42.spec.devops.spec.deploy";
  }
  
}
/* Actifsource ID=[c1a07b92-fc09-11e0-b756-0dc1d96a76cb,cleon.architecturemethods.arc42.spec.devops.spec.deploy,KbHLWAlpB7/qrchB1FjOpaXcfaA=] */
