...
public class EnvironmentAwareDeploymentArtefact extends DynamicResource implements IEnvironmentAwareDeploymentArtefact {
  ...
  public EnvironmentAwareDeploymentArtefact setDeploymentArtefacts(IMultiMapOrdered<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.arc42.spec.devops.spec.release.javamodel.IDeploymentArtefact> deploymentArtefacts) {
  ...
  @Override
  public cleon.architecturemethods.arc42.spec.devops.spec.deploy.javamodel.IEnvironment selectEnvironment() {
    return _getSingle(cleon.architecturemethods.arc42.spec.devops.spec.deploy.javamodel.IEnvironment.class, cleon.architecturemethods.arc42.spec.devops.spec.release.ReleasePackage.EnvironmentAwareDeploymentArtefact_environment);
  }

  public EnvironmentAwareDeploymentArtefact setEnvironment(cleon.architecturemethods.arc42.spec.devops.spec.deploy.javamodel.IEnvironment environment) {
    _setSingle(cleon.architecturemethods.arc42.spec.devops.spec.release.ReleasePackage.EnvironmentAwareDeploymentArtefact_environment, environment);
    return this;
  }
  ...
  public static java.util.List<cleon.architecturemethods.arc42.spec.devops.spec.release.javamodel.IEnvironmentAwareDeploymentArtefact> selectToMeEnvironment(cleon.architecturemethods.arc42.spec.devops.spec.deploy.javamodel.IEnvironment object) {
    return _getToMeList(object.getRepository(), cleon.architecturemethods.arc42.spec.devops.spec.release.javamodel.IEnvironmentAwareDeploymentArtefact.class, cleon.architecturemethods.arc42.spec.devops.spec.release.ReleasePackage.EnvironmentAwareDeploymentArtefact_environment, object.getResource());
  }
