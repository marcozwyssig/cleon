...
public class FunctionSpace_Driver {
  ...
  public static interface IDriverFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("3ff7c055-c58d-11e5-aeea-1db9268c0ee9")
    public java.lang.String GetId(final cleon.architecturemethods.eamod.metamodel.spec.chrv.motivation.drivers.javamodel.IDriver driver);
  ...
  public static class DriverFunctions {
    ...
    public static java.lang.String GetId(final cleon.architecturemethods.eamod.metamodel.spec.chrv.motivation.drivers.javamodel.IDriver driver) {
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,39e27138-c58d-11e5-aeea-1db9268c0ee9,78TXyRm+PALx+SVmgUQI5j2k5is=] */
