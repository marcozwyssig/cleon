...
public class Guideline extends DynamicResource implements IGuideline {
  ...
  public Guideline setAuthors(java.util.List<? extends cleon.common.doc.metamodel.spec.document.properties.member.javamodel.IMember> authors) {
  ...
  public Guideline setOriginatesFromSource(java.util.List<? extends cleon.architecturemethods.eamod.metamodel.spec.chrv.motivation.sources.javamodel.ISource> originatesFromSource) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,50b8143d-a95a-11e5-bda2-a7fc3bd7c783,0gkA6/RgKBEiRQVNp/ndKdK9Oy0=] */
