...
public class Principle extends DynamicResource implements IPrinciple {
  ...
  public Principle setAchieves(java.util.List<? extends cleon.architecturemethods.eamod.metamodel.spec.chrv.motivation.goals.javamodel.IGoal> achieves) {
    _setList(cleon.architecturemethods.eamod.metamodel.spec.chrv.motivation.goals.GoalsPackage.GoalAware_achieves, achieves);
    return this;
  }
    
  @Override
  public java.util.List<? extends cleon.architecturemethods.eamod.metamodel.spec.chrv.motivation.principles.javamodel.IPrinciple> selectAggregation() {
    return _getList(cleon.architecturemethods.eamod.metamodel.spec.chrv.motivation.principles.javamodel.IPrinciple.class, cleon.architecturemethods.eamod.metamodel.spec.chrv.motivation.principles.PrinciplesPackage.Principle_aggregation);
  }

  public Principle setAggregation(java.util.List<? extends cleon.architecturemethods.eamod.metamodel.spec.chrv.motivation.principles.javamodel.IPrinciple> aggregation) {
    _setList(cleon.architecturemethods.eamod.metamodel.spec.chrv.motivation.principles.PrinciplesPackage.Principle_aggregation, aggregation);
    return this;
  }
  ...
  public Principle setAuthors(java.util.List<? extends cleon.common.doc.metamodel.spec.document.properties.member.javamodel.IMember> authors) {
  ...
  public Principle setOriginatesFromSource(java.util.List<? extends cleon.architecturemethods.eamod.metamodel.spec.chrv.motivation.sources.javamodel.ISource> originatesFromSource) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptList(cleon.architecturemethods.eamod.metamodel.spec.chrv.motivation.principles.javamodel.IPrinciple.class, cleon.architecturemethods.eamod.metamodel.spec.chrv.motivation.principles.PrinciplesPackage.Principle_aggregation, visitor);
  ...
  public static cleon.architecturemethods.eamod.metamodel.spec.chrv.motivation.principles.javamodel.IPrinciple selectToMeAggregation(cleon.architecturemethods.eamod.metamodel.spec.chrv.motivation.principles.javamodel.IPrinciple object) {
    return _getToMeSingle(object.getRepository(), cleon.architecturemethods.eamod.metamodel.spec.chrv.motivation.principles.javamodel.IPrinciple.class, cleon.architecturemethods.eamod.metamodel.spec.chrv.motivation.principles.PrinciplesPackage.Principle_aggregation, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,6f06a6ec-a951-11e5-bda2-a7fc3bd7c783,k8Bdtt5gmeXChpPa4lfRNO+u+04=] */
