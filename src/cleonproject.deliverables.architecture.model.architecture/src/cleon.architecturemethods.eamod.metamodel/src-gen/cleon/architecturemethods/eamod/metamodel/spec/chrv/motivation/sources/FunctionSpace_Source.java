...
public class FunctionSpace_Source {
  ...
  public static interface ISourceFunctions extends IDynamicResourceExtension {
    ...
    public List<cleon.architecturemethods.eamod.metamodel.spec.chrv.motivation.sources.javamodel.ISource> GetAllSources();
    ...
    public List<cleon.architecturemethods.eamod.metamodel.spec.chrv.motivation.sources.javamodel.ISourceAware> GetAllUsedSourceAware();
  ...
  public static interface ISourceFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("4b8d7404-c58d-11e5-aeea-1db9268c0ee9")
    public java.lang.String GetId(final cleon.architecturemethods.eamod.metamodel.spec.chrv.motivation.sources.javamodel.ISource source);
  ...
  public static class SourceFunctions {
    ...
    public static java.lang.String GetId(final cleon.architecturemethods.eamod.metamodel.spec.chrv.motivation.sources.javamodel.ISource source) {
  ...
  public static interface ISourcesFunctions extends IDynamicResourceExtension {
    ...
    public List<cleon.architecturemethods.eamod.metamodel.spec.chrv.motivation.sources.javamodel.ISource> GetAllUsedSources();

    @IDynamicResourceExtension.MethodId("c8154113-ea66-11e8-8092-1f65b9544bbd")
    public List<cleon.architecturemethods.eamod.metamodel.spec.chrv.motivation.sources.javamodel.ISource> GetAllUsedSourcesDistinct();
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,4b8d7402-c58d-11e5-aeea-1db9268c0ee9,QmbWH3z1cwYsDq7QfThwQAz/3y4=] */
