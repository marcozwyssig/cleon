...
public class SourceChapter extends DynamicResource implements ISourceChapter {
  ...
  public SourceChapter setAuthors(java.util.List<? extends cleon.common.doc.metamodel.spec.document.properties.member.javamodel.IMember> authors) {
  ...
  public SourceChapter setComposites(java.util.List<? extends cleon.architecturemethods.eamod.metamodel.spec.chrv.motivation.sources.javamodel.ISource> composites) {
  ...
  public SourceChapter setReferences(java.util.List<? extends cleon.architecturemethods.eamod.metamodel.spec.chrv.motivation.sources.javamodel.ISourceReference> references) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,1165cb74-bb80-11e5-b2f7-f515c847fa35,OeN/hk0xqJgUJNkink/ySYoDBmU=] */
