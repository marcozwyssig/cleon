...
public class SimpleFunctionalRequirement extends DynamicResource implements ISimpleFunctionalRequirement {
  ...
  public SimpleFunctionalRequirement setAchieves(java.util.List<? extends cleon.architecturemethods.eamod.metamodel.spec.chrv.motivation.goals.javamodel.IGoal> achieves) {
  ...
  public SimpleFunctionalRequirement setAuthors(java.util.List<? extends cleon.common.doc.metamodel.spec.document.properties.member.javamodel.IMember> authors) {
  ...
  public SimpleFunctionalRequirement setConcretizes(java.util.List<? extends cleon.architecturemethods.eamod.metamodel.spec.chrv.requirements.subjectareas.requirement.javamodel.IRequirement> concretizes) {
  ...
  public SimpleFunctionalRequirement setOriginatesFromSource(java.util.List<? extends cleon.architecturemethods.eamod.metamodel.spec.chrv.motivation.sources.javamodel.ISource> originatesFromSource) {
  ...
  public SimpleFunctionalRequirement setOwners(java.util.List<? extends cleon.architecturemethods.eamod.metamodel.spec.chrv.motivation.stakeholder.javamodel.IStakeholder> owners) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,87710c27-a962-11e5-bda2-a7fc3bd7c783,8auom9hESfTVXg5ZXcVYdrBCCts=] */
