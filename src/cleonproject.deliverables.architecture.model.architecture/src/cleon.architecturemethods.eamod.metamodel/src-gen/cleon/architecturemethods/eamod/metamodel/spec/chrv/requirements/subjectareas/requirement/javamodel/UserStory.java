...
public class UserStory extends DynamicResource implements IUserStory {
  ...
  public UserStory setAchieves(java.util.List<? extends cleon.architecturemethods.eamod.metamodel.spec.chrv.motivation.goals.javamodel.IGoal> achieves) {
  ...
  public UserStory setAuthors(java.util.List<? extends cleon.common.doc.metamodel.spec.document.properties.member.javamodel.IMember> authors) {
  ...
  public UserStory setConcretizes(java.util.List<? extends cleon.architecturemethods.eamod.metamodel.spec.chrv.requirements.subjectareas.requirement.javamodel.IRequirement> concretizes) {
  ...
  public UserStory setOriginatesFromSource(java.util.List<? extends cleon.architecturemethods.eamod.metamodel.spec.chrv.motivation.sources.javamodel.ISource> originatesFromSource) {
  ...
  public UserStory setOwners(java.util.List<? extends cleon.architecturemethods.eamod.metamodel.spec.chrv.motivation.stakeholder.javamodel.IStakeholder> owners) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,61541f15-a962-11e5-bda2-a7fc3bd7c783,ClCOtF+HpwfrDflEQtNGmXrNJUs=] */
