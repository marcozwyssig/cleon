...
public class SourceReference extends DynamicResource implements ISourceReference {
  ...
  @Override
  public cleon.architecturemethods.eamod.metamodel.spec.chrv.sources.javamodel.ISource selectComposite() {
    return _getSingle(cleon.architecturemethods.eamod.metamodel.spec.chrv.sources.javamodel.ISource.class, cleon.architecturemethods.eamod.metamodel.spec.chrv.sources.SourcesPackage.SourceReference_composite);
  }

  public SourceReference setComposite(cleon.architecturemethods.eamod.metamodel.spec.chrv.sources.javamodel.ISource composite) {
    _setSingle(cleon.architecturemethods.eamod.metamodel.spec.chrv.sources.SourcesPackage.SourceReference_composite, composite);
    return this;
  }
  ...
  public SourceReference setComposites(java.util.List<? extends cleon.architecturemethods.eamod.metamodel.spec.chrv.sources.javamodel.ISource> composites) {
  ...
  public static cleon.architecturemethods.eamod.metamodel.spec.chrv.sources.javamodel.ISourceReference selectToMeComposite(cleon.architecturemethods.eamod.metamodel.spec.chrv.sources.javamodel.ISource object) {
    return _getToMeSingle(object.getRepository(), cleon.architecturemethods.eamod.metamodel.spec.chrv.sources.javamodel.ISourceReference.class, cleon.architecturemethods.eamod.metamodel.spec.chrv.sources.SourcesPackage.SourceReference_composite, object.getResource());
  }
