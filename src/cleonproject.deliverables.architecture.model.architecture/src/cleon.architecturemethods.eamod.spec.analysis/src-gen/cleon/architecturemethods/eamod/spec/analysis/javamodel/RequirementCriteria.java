...
public class RequirementCriteria extends DynamicResource implements IRequirementCriteria {
  ...
  public cleon.architecturemethods.eamod.spec.eamod.chrv.requirements.subjectareas.requirement.javamodel.IAbstractRequirement selectRequirement() {
    return _getSingle(cleon.architecturemethods.eamod.spec.eamod.chrv.requirements.subjectareas.requirement.javamodel.IAbstractRequirement.class, cleon.architecturemethods.eamod.spec.analysis.AnalysisPackage.RequirementCriteria_requirement);
  }

  public RequirementCriteria setRequirement(cleon.architecturemethods.eamod.spec.eamod.chrv.requirements.subjectareas.requirement.javamodel.IAbstractRequirement requirement) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    // relations
    _acceptSingle(cleon.architecturemethods.eamod.spec.eamod.chrv.requirements.subjectareas.requirement.javamodel.IAbstractRequirement.class, cleon.architecturemethods.eamod.spec.analysis.AnalysisPackage.RequirementCriteria_requirement, visitor);
  ...
  public static java.util.List<cleon.architecturemethods.eamod.spec.analysis.javamodel.IRequirementCriteria> selectToMeRequirement(cleon.architecturemethods.eamod.spec.eamod.chrv.requirements.subjectareas.requirement.javamodel.IAbstractRequirement object) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,5f0c4609-a6f8-11e8-9c81-8bd68c62e435,ej2kFADMCY/gYQTFTPa2P+DQJx4=] */
