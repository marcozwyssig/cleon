...
public class KnockoutRequirementManagementAggregate extends DynamicResource implements IKnockoutRequirementManagementAggregate {
  ...
  public KnockoutRequirementManagementAggregate setCriterias(java.util.List<? extends cleon.projectmethods.hermes.spec.detailstudy.drivers.criterias.javamodel.IAbstractCriteria> criterias) {
  ...
  public KnockoutRequirementManagementAggregate setKnockoutCriterias(java.util.List<? extends cleon.projectmethods.hermes.spec.detailstudy.drivers.criterias.knockout.javamodel.IKnockoutCriteria> knockoutCriterias) {
  ...
  public cleon.architecturemethods.eamod.spec.eamod.chrv.javamodel.IRequirementsDocument selectRequirementsManagement() {
    return _getSingle(cleon.architecturemethods.eamod.spec.eamod.chrv.javamodel.IRequirementsDocument.class, cleon.architecturemethods.eamod.spec.analysis.knockout.KnockoutPackage.KnockoutRequirementManagementAggregate_requirementsManagement);
  }

  public KnockoutRequirementManagementAggregate setRequirementsManagement(cleon.architecturemethods.eamod.spec.eamod.chrv.javamodel.IRequirementsDocument requirementsManagement) {
  ...
  public java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.eamod.spec.analysis.knockout.javamodel.IKnockoutSubjectAreaAggregate> selectSubjectAreaAggregate() {
    return _getMap(cleon.architecturemethods.eamod.spec.analysis.knockout.javamodel.IKnockoutSubjectAreaAggregate.class, cleon.architecturemethods.eamod.spec.analysis.knockout.KnockoutPackage.KnockoutRequirementManagementAggregate_subjectAreaAggregate);
  }

  public KnockoutRequirementManagementAggregate setSubjectAreaAggregate(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.eamod.spec.analysis.knockout.javamodel.IKnockoutSubjectAreaAggregate> subjectAreaAggregate) {
    _setMap(cleon.architecturemethods.eamod.spec.analysis.knockout.KnockoutPackage.KnockoutRequirementManagementAggregate_subjectAreaAggregate, subjectAreaAggregate);
    return this;
  }
  ...
  public static java.util.List<cleon.architecturemethods.eamod.spec.analysis.knockout.javamodel.IKnockoutRequirementManagementAggregate> selectToMeRequirementsManagement(cleon.architecturemethods.eamod.spec.eamod.chrv.javamodel.IRequirementsDocument object) {
  ...
  public static cleon.architecturemethods.eamod.spec.analysis.knockout.javamodel.IKnockoutRequirementManagementAggregate selectToMeSubjectAreaAggregate(cleon.architecturemethods.eamod.spec.analysis.knockout.javamodel.IKnockoutSubjectAreaAggregate object) {
    return _getToMeSingle(object.getRepository(), cleon.architecturemethods.eamod.spec.analysis.knockout.javamodel.IKnockoutRequirementManagementAggregate.class, cleon.architecturemethods.eamod.spec.analysis.knockout.KnockoutPackage.KnockoutRequirementManagementAggregate_subjectAreaAggregate, object.getResource());
  }
