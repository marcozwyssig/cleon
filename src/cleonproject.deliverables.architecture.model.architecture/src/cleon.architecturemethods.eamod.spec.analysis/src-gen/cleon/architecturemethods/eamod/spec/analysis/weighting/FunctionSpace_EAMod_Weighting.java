package cleon.architecturemethods.eamod.spec.analysis.weighting;
...
import cleon.architecturemethods.eamod.spec.analysis.weighting.javamodel.IWeightingPriority;
...
public class FunctionSpace_EAMod_Weighting {
  ...
  public static interface IWeightingRequirementManagementAggregateFunctions extends IDynamicResourceExtension {
    ...
    public java.lang.Double GetWeighting(final cleon.architecturemethods.eamod.spec.analysis.weighting.javamodel.IWeightingRequirementCriteria requirementCriteria);

    @IDynamicResourceExtension.MethodId("82998965-1583-11e9-888c-794d92ffc0c6")
    public List<cleon.architecturemethods.eamod.spec.analysis.weighting.javamodel.IWeightingRequirementCriteria> GetAllRequirementCriterias();
  ...
  public static interface IWeightingRequirementManagementAggregateFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("83ce7028-14f8-11e9-ac43-5132797a057a")
    public java.lang.Integer GetRequirementSum(final cleon.architecturemethods.eamod.spec.analysis.weighting.javamodel.IWeightingRequirementManagementAggregate weightingRequirementManagementAggregate);

    @IDynamicResourceExtension.MethodId("1b3ddfa8-14fa-11e9-ac43-5132797a057a")
    public java.lang.Double GetWeighting(final cleon.architecturemethods.eamod.spec.analysis.weighting.javamodel.IWeightingRequirementManagementAggregate weightingRequirementManagementAggregate);

    @IDynamicResourceExtension.MethodId("c5cb0919-1582-11e9-888c-794d92ffc0c6")
    public java.lang.Double GetWeighting(final cleon.architecturemethods.eamod.spec.analysis.weighting.javamodel.IWeightingRequirementCriteria requirementCriteria, final cleon.architecturemethods.eamod.spec.analysis.weighting.javamodel.IWeightingRequirementManagementAggregate weightingRequirementManagementAggregate);
  ...
  public static class WeightingRequirementManagementAggregateFunctions {
    ...
    public static java.lang.Integer GetRequirementSum(final cleon.architecturemethods.eamod.spec.analysis.weighting.javamodel.IWeightingRequirementManagementAggregate weightingRequirementManagementAggregate) {
    ...
    public static java.lang.Double GetWeighting(final cleon.architecturemethods.eamod.spec.analysis.weighting.javamodel.IWeightingRequirementManagementAggregate weightingRequirementManagementAggregate) {
    ...
    public static java.lang.Double GetWeighting(final cleon.architecturemethods.eamod.spec.analysis.weighting.javamodel.IWeightingRequirementCriteria requirementCriteria, final cleon.architecturemethods.eamod.spec.analysis.weighting.javamodel.IWeightingRequirementManagementAggregate weightingRequirementManagementAggregate) {
  ...
  public static interface IWeightingRequirementCriteriaFunctions extends IDynamicResourceExtension {
    ...
    public cleon.architecturemethods.eamod.spec.analysis.weighting.javamodel.IWeightingRequirementManagementAggregate GetRequirementManagement();
  ...
  public static interface IWeightingRequirementCriteriaFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("eb7f44d0-a9d3-11e8-8fa3-5142962ae020")
    public java.lang.Double GetWeighting(final cleon.architecturemethods.eamod.spec.analysis.weighting.javamodel.IWeightingRequirementCriteria weightingRequirementCriteria);
  ...
  public static class WeightingRequirementCriteriaFunctions {
    ...
    public static java.lang.Double GetWeighting(final cleon.architecturemethods.eamod.spec.analysis.weighting.javamodel.IWeightingRequirementCriteria weightingRequirementCriteria) {
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,c51aafe9-a6fc-11e8-9c81-8bd68c62e435,39fzR/6jMlvRXEHcrhDk8BoO2bc=] */
