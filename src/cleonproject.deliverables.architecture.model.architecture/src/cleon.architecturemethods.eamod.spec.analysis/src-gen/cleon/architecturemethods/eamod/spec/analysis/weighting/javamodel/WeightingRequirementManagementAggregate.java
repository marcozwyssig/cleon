...
public class WeightingRequirementManagementAggregate extends DynamicResource implements IWeightingRequirementManagementAggregate {
  ...
  public cleon.architecturemethods.eamod.spec.eamod.chrv.javamodel.IRequirementsDocument selectRequirementsManagement() {
    return _getSingle(cleon.architecturemethods.eamod.spec.eamod.chrv.javamodel.IRequirementsDocument.class, cleon.architecturemethods.eamod.spec.analysis.weighting.WeightingPackage.WeightingRequirementManagementAggregate_requirementsManagement);
  }

  public WeightingRequirementManagementAggregate setRequirementsManagement(cleon.architecturemethods.eamod.spec.eamod.chrv.javamodel.IRequirementsDocument requirementsManagement) {
  ...
  public static java.util.List<cleon.architecturemethods.eamod.spec.analysis.weighting.javamodel.IWeightingRequirementManagementAggregate> selectToMeRequirementsManagement(cleon.architecturemethods.eamod.spec.eamod.chrv.javamodel.IRequirementsDocument object) {
