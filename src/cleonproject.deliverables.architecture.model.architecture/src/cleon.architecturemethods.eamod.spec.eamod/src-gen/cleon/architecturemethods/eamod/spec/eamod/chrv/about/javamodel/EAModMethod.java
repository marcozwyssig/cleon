...
public class EAModMethod extends DynamicResource implements IEAModMethod {
  ...
  public EAModMethod setChapters(java.util.List<? extends cleon.common.doc.doc.spec.chapter.javamodel.IChapter> chapters) {
  ...
  public EAModMethod setDocumentElements(java.util.List<? extends cleon.common.doc.doc.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public EAModMethod setParagraphs(java.util.List<? extends cleon.common.doc.doc.spec.paragraph.javamodel.IStandardParagraph> paragraphs) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,df9ab246-1405-11e9-a836-9d144e5bc2a5,ONRMDfwoSRtFagIEJn3UVcOaZ/M=] */
