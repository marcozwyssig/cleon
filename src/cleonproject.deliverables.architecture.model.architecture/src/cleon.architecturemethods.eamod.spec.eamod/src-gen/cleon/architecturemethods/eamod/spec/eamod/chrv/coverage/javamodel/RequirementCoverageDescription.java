...
public class RequirementCoverageDescription extends DynamicResource implements IRequirementCoverageDescription {
  ...
  @Override
  public cleon.architecturemethods.eamod.spec.eamod.chrv.coverage.javamodel.IRequirementCoverage selectRequirementCoverage() {
    return _getSingle(cleon.architecturemethods.eamod.spec.eamod.chrv.coverage.javamodel.IRequirementCoverage.class, cleon.architecturemethods.eamod.spec.eamod.chrv.coverage.CoveragePackage.RequirementCoverageDescription_requirementCoverage);
  }

  public RequirementCoverageDescription setRequirementCoverage(cleon.architecturemethods.eamod.spec.eamod.chrv.coverage.javamodel.IRequirementCoverage requirementCoverage) {
    _setSingle(cleon.architecturemethods.eamod.spec.eamod.chrv.coverage.CoveragePackage.RequirementCoverageDescription_requirementCoverage, requirementCoverage);
    return this;
  }
  ...
  public static java.util.List<cleon.architecturemethods.eamod.spec.eamod.chrv.coverage.javamodel.IRequirementCoverageDescription> selectToMeRequirementCoverage(cleon.architecturemethods.eamod.spec.eamod.chrv.coverage.javamodel.IRequirementCoverage object) {
    return _getToMeList(object.getRepository(), cleon.architecturemethods.eamod.spec.eamod.chrv.coverage.javamodel.IRequirementCoverageDescription.class, cleon.architecturemethods.eamod.spec.eamod.chrv.coverage.CoveragePackage.RequirementCoverageDescription_requirementCoverage, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,0562087c-01e5-11e9-9c9d-8d52d6745026,EFSQWfWQ3yXgHOQ5FeTER7zkQyM=] */
