...
public class SubjectAreaCoverage extends DynamicResource implements ISubjectAreaCoverage {
  ...
  public SubjectAreaCoverage setChapters(java.util.List<? extends cleon.common.doc.doc.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public SubjectAreaCoverage setDocumentElements(java.util.List<? extends cleon.common.doc.doc.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public SubjectAreaCoverage setParagraphs(java.util.List<? extends cleon.common.doc.doc.spec.paragraph.javamodel.IParagraph> paragraphs) {
  ...
  public java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.eamod.spec.eamod.chrv.coverage.javamodel.IRequirementCoverage> selectRequirementCoverage() {
    return _getMap(cleon.architecturemethods.eamod.spec.eamod.chrv.coverage.javamodel.IRequirementCoverage.class, cleon.architecturemethods.eamod.spec.eamod.chrv.coverage.CoveragePackage.SubjectAreaCoverage_requirementCoverage);
  }

  public SubjectAreaCoverage setRequirementCoverage(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.eamod.spec.eamod.chrv.coverage.javamodel.IRequirementCoverage> requirementCoverage) {
    _setMap(cleon.architecturemethods.eamod.spec.eamod.chrv.coverage.CoveragePackage.SubjectAreaCoverage_requirementCoverage, requirementCoverage);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptMap(cleon.architecturemethods.eamod.spec.eamod.chrv.coverage.javamodel.IRequirementCoverage.class, cleon.architecturemethods.eamod.spec.eamod.chrv.coverage.CoveragePackage.SubjectAreaCoverage_requirementCoverage, visitor);
  ...
  public static java.util.List<cleon.architecturemethods.eamod.spec.eamod.chrv.coverage.javamodel.ISubjectAreaCoverage> selectToMeSubjectArea(cleon.architecturemethods.eamod.spec.eamod.chrv.requirements.subjectareas.javamodel.ISubjectArea object) {
    return _getToMeList(object.getRepository(), cleon.architecturemethods.eamod.spec.eamod.chrv.coverage.javamodel.ISubjectAreaCoverage.class, cleon.architecturemethods.eamod.spec.eamod.chrv.coverage.CoveragePackage.SubjectAreaCoverage_subjectArea, object.getResource());
  }
  
  public static cleon.architecturemethods.eamod.spec.eamod.chrv.coverage.javamodel.ISubjectAreaCoverage selectToMeRequirementCoverage(cleon.architecturemethods.eamod.spec.eamod.chrv.coverage.javamodel.IRequirementCoverage object) {
    return _getToMeSingle(object.getRepository(), cleon.architecturemethods.eamod.spec.eamod.chrv.coverage.javamodel.ISubjectAreaCoverage.class, cleon.architecturemethods.eamod.spec.eamod.chrv.coverage.CoveragePackage.SubjectAreaCoverage_requirementCoverage, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,92347cca-ece1-11e8-8149-8542373915bf,emfKY6Owy4mSHKHFkD7OAFpcn0I=] */
