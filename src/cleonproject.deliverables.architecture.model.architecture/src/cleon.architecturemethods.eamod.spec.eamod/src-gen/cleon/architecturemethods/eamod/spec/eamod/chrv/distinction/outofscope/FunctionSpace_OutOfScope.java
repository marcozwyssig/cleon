package cleon.architecturemethods.eamod.spec.eamod.chrv.distinction.outofscope;
...
public class FunctionSpace_OutOfScope {
  ...
  public static interface IOutOfScopeFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("bf7d10a6-0e17-11e6-ae01-ef640c578b9b")
    public java.lang.String GetId(final cleon.architecturemethods.eamod.spec.eamod.chrv.distinction.outofscope.javamodel.IOutOfScope outOfScope);
  ...
  public static class OutOfScopeFunctions {
    ...
    public static java.lang.String GetId(final cleon.architecturemethods.eamod.spec.eamod.chrv.distinction.outofscope.javamodel.IOutOfScope outOfScope) {
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,b1bd0458-0e17-11e6-ae01-ef640c578b9b,9xb7sGZbklAZBj/2ufrvs8GK6BU=] */
