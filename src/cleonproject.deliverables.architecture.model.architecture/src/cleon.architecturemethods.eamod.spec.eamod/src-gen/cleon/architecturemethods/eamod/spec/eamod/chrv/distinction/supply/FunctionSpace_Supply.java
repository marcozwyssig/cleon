package cleon.architecturemethods.eamod.spec.eamod.chrv.distinction.supply;
...
public class FunctionSpace_Supply {
  ...
  public static interface ISupplyFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("ce37d205-0e17-11e6-ae01-ef640c578b9b")
    public java.lang.String GetId(final cleon.architecturemethods.eamod.spec.eamod.chrv.distinction.supply.javamodel.ISupply supply);
  ...
  public static class SupplyFunctions {
    ...
    public static java.lang.String GetId(final cleon.architecturemethods.eamod.spec.eamod.chrv.distinction.supply.javamodel.ISupply supply) {
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,c733b4c8-0e17-11e6-ae01-ef640c578b9b,/5HeeuffY/5nKb0xe3ZOY1AKq4k=] */
