...
public class Drivers extends DynamicResource implements IDrivers {
  ...
  @Override
  public java.util.List<? extends cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.drivers.javamodel.IDriver> selectDrivers() {
    return _getList(cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.drivers.javamodel.IDriver.class, cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.drivers.DriversPackage.Drivers_drivers);
  }

  public Drivers setDrivers(java.util.List<? extends cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.drivers.javamodel.IDriver> drivers) {
    _setList(cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.drivers.DriversPackage.Drivers_drivers, drivers);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    // relations
    _acceptList(cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.drivers.javamodel.IDriver.class, cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.drivers.DriversPackage.Drivers_drivers, visitor);
  ...
  public static cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.drivers.javamodel.IDrivers selectToMeDrivers(cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.drivers.javamodel.IDriver object) {
    return _getToMeSingle(object.getRepository(), cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.drivers.javamodel.IDrivers.class, cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.drivers.DriversPackage.Drivers_drivers, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,e54f10bf-a950-11e5-bda2-a7fc3bd7c783,uchgWZPwC1hBn8unOnO3MaibRbY=] */
