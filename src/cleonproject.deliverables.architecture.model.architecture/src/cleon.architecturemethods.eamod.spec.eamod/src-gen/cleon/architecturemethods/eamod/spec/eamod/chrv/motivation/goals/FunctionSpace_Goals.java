package cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.goals;
...
public class FunctionSpace_Goals {
  ...
  public static interface IGoalFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("4877cebe-c58d-11e5-aeea-1db9268c0ee9")
    public java.lang.String GetId(final cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.goals.javamodel.IGoal goal);
  ...
  public static class GoalFunctions {
    ...
    public static java.lang.String GetId(final cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.goals.javamodel.IGoal goal) {
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,4877cebc-c58d-11e5-aeea-1db9268c0ee9,/LlnjSA3Nmhm2x9QygzaBKa47+4=] */
