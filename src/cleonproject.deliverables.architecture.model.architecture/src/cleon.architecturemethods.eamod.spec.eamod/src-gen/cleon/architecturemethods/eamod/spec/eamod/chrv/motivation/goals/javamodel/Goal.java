...
public class Goal extends DynamicResource implements IGoal {
  ...
  @Override
  public java.util.List<? extends cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.drivers.javamodel.IDriver> selectAddresses() {
    return _getList(cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.drivers.javamodel.IDriver.class, cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.drivers.DriversPackage.DriverAware_addresses);
  }

  public Goal setAddresses(java.util.List<? extends cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.drivers.javamodel.IDriver> addresses) {
    _setList(cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.drivers.DriversPackage.DriverAware_addresses, addresses);
    return this;
  }
  ...
  public Goal setAuthors(java.util.List<? extends cleon.common.doc.doc.spec.document.properties.member.javamodel.IMember> authors) {
  ...
  public Goal setChapters(java.util.List<? extends cleon.common.doc.doc.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public Goal setDocumentElements(java.util.List<? extends cleon.common.doc.doc.spec.javamodel.IDocumentElement> documentElements) {
    _setList(cleon.common.doc.doc.spec.SpecPackage.DocumentElementComposite_documentElements, documentElements);
    return this;
  }
    
  @Override
  public java.util.List<? extends cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.goals.javamodel.IGoal> selectGoalAggregation() {
    return _getList(cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.goals.javamodel.IGoal.class, cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.goals.GoalsPackage.Goal_goalAggregation);
  }

  public Goal setGoalAggregation(java.util.List<? extends cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.goals.javamodel.IGoal> goalAggregation) {
    _setList(cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.goals.GoalsPackage.Goal_goalAggregation, goalAggregation);
    return this;
  }
  ...
  public Goal setOriginatesFromSource(java.util.List<? extends cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.sources.javamodel.ISource> originatesFromSource) {
  ...
  public Goal setParagraphs(java.util.List<? extends cleon.common.doc.doc.spec.paragraph.javamodel.IParagraph> paragraphs) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    // relations
    _acceptList(cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.drivers.javamodel.IDriver.class, cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.drivers.DriversPackage.DriverAware_addresses, visitor);
    ...
    _acceptList(cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.goals.javamodel.IGoal.class, cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.goals.GoalsPackage.Goal_goalAggregation, visitor);
  ...
  public static cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.goals.javamodel.IGoal selectToMeGoalAggregation(cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.goals.javamodel.IGoal object) {
    return _getToMeSingle(object.getRepository(), cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.goals.javamodel.IGoal.class, cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.goals.GoalsPackage.Goal_goalAggregation, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,31468bb8-a951-11e5-bda2-a7fc3bd7c783,Y0mxxxCrj6rFn6w+gJehiuDSFtY=] */
