...
public class Principle extends DynamicResource implements IPrinciple {
  ...
  public Principle setAchieves(java.util.List<? extends cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.goals.javamodel.IGoal> achieves) {
  ...
  public java.util.List<? extends cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.principles.javamodel.IPrinciple> selectAggregation() {
    return _getList(cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.principles.javamodel.IPrinciple.class, cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.principles.PrinciplesPackage.Principle_aggregation);
  }

  public Principle setAggregation(java.util.List<? extends cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.principles.javamodel.IPrinciple> aggregation) {
    _setList(cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.principles.PrinciplesPackage.Principle_aggregation, aggregation);
    return this;
  }
  ...
  public Principle setAuthors(java.util.List<? extends cleon.common.doc.doc.spec.document.properties.member.javamodel.IMember> authors) {
  ...
  public Principle setChapters(java.util.List<? extends cleon.common.doc.doc.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public Principle setDocumentElements(java.util.List<? extends cleon.common.doc.doc.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public Principle setOriginatesFromSource(java.util.List<? extends cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.sources.javamodel.ISource> originatesFromSource) {
  ...
  public Principle setParagraphs(java.util.List<? extends cleon.common.doc.doc.spec.paragraph.javamodel.IParagraph> paragraphs) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptList(cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.principles.javamodel.IPrinciple.class, cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.principles.PrinciplesPackage.Principle_aggregation, visitor);
  ...
  public static cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.principles.javamodel.IPrinciple selectToMeAggregation(cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.principles.javamodel.IPrinciple object) {
    return _getToMeSingle(object.getRepository(), cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.principles.javamodel.IPrinciple.class, cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.principles.PrinciplesPackage.Principle_aggregation, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,6f06a6ec-a951-11e5-bda2-a7fc3bd7c783,gTE2NiZDdIUhw30OG4Ibldl9M/0=] */
