...
public class InformationExchange extends DynamicResource implements IInformationExchange {
  ...
  public InformationExchange setAchieves(java.util.List<? extends cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.goals.javamodel.IGoal> achieves) {
  ...
  public InformationExchange setAuthors(java.util.List<? extends cleon.common.doc.spec.doc.document.properties.member.javamodel.IMember> authors) {
  ...
  public InformationExchange setChapters(java.util.List<? extends cleon.common.doc.spec.doc.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public InformationExchange setDocumentElements(java.util.List<? extends cleon.common.doc.spec.doc.javamodel.IDocumentElement> documentElements) {
  ...
  public InformationExchange setOwners(java.util.List<? extends cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.stakeholder.javamodel.IStakeholder> owners) {
  ...
  public InformationExchange setParagraphs(java.util.List<? extends cleon.common.doc.spec.doc.paragraph.javamodel.IParagraph> paragraphs) {
  ...
  public InformationExchange setRequirements(java.util.List<? extends cleon.architecturemethods.eamod.spec.eamod.chrv.requirements.subjectareas.requirement.javamodel.IRequirement> requirements) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,f2beb4bf-0c75-11e6-86c5-87a8b520dd59,FjZfmDe04zVHoZUyoAR+3LrT1CQ=] */
