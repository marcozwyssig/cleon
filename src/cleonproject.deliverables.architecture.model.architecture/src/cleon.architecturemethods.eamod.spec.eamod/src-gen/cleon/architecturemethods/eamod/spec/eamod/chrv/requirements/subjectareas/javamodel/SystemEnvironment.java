...
public class SystemEnvironment extends DynamicResource implements ISystemEnvironment {
  ...
  public SystemEnvironment setAchieves(java.util.List<? extends cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.goals.javamodel.IGoal> achieves) {
  ...
  public SystemEnvironment setAuthors(java.util.List<? extends cleon.common.doc.spec.doc.document.properties.member.javamodel.IMember> authors) {
  ...
  public SystemEnvironment setChapters(java.util.List<? extends cleon.common.doc.spec.doc.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public SystemEnvironment setDocumentElements(java.util.List<? extends cleon.common.doc.spec.doc.javamodel.IDocumentElement> documentElements) {
  ...
  public SystemEnvironment setOwners(java.util.List<? extends cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.stakeholder.javamodel.IStakeholder> owners) {
  ...
  public SystemEnvironment setParagraphs(java.util.List<? extends cleon.common.doc.spec.doc.paragraph.javamodel.IParagraph> paragraphs) {
  ...
  public SystemEnvironment setRequirements(java.util.List<? extends cleon.architecturemethods.eamod.spec.eamod.chrv.requirements.subjectareas.requirement.javamodel.IRequirement> requirements) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,eba22e74-0c75-11e6-86c5-87a8b520dd59,00fPj6TQ6+hahTRBSK5D7jWAf/s=] */
