...
public class UserInterface extends DynamicResource implements IUserInterface {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<IUserInterface> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<IUserInterface>() {
    ...
    @Override
    public IUserInterface create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new UserInterface(resourceRepository, resource);
    }
  
  };

  public UserInterface() {
    super(IUserInterface.TYPE_ID);
  }
  
  public UserInterface(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
    super(resourceRepository, resource, IUserInterface.TYPE_ID);
  }
  ...
  public UserInterface setAchieves(java.util.List<? extends cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.goals.javamodel.IGoal> achieves) {
  ...
  public UserInterface setAuthors(java.util.List<? extends cleon.common.doc.spec.doc.document.properties.member.javamodel.IMember> authors) {
  ...
  public UserInterface setChapters(java.util.List<? extends cleon.common.doc.spec.doc.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public UserInterface setDocumentElements(java.util.List<? extends cleon.common.doc.spec.doc.javamodel.IDocumentElement> documentElements) {
  ...
  public UserInterface setOwners(java.util.List<? extends cleon.architecturemethods.eamod.spec.eamod.chrv.motivation.stakeholder.javamodel.IStakeholder> owners) {
  ...
  public UserInterface setParagraphs(java.util.List<? extends cleon.common.doc.spec.doc.paragraph.javamodel.IParagraph> paragraphs) {
  ...
  public UserInterface setRequirements(java.util.List<? extends cleon.architecturemethods.eamod.spec.eamod.chrv.requirements.subjectareas.requirement.javamodel.IRequirement> requirements) {
  ...
  public UserInterface setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,49d92dc4-0c77-11e6-86c5-87a8b520dd59,xS14qdVNsIkzDNeDbYwNWC/hKAM=] */
