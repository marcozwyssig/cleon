...
public class CapabilityDocument extends DynamicResource implements ICapabilityDocument {
  ...
  public CapabilityDocument setChapters(java.util.List<? extends cleon.common.doc.doc.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public CapabilityDocument setDocumentElements(java.util.List<? extends cleon.common.doc.doc.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public CapabilityDocument setDocumentLanguage(java.util.List<? extends cleon.common.doc.doc.spec.documentlanguage.javamodel.IDocumentLanguage> documentLanguage) {
  ...
  public CapabilityDocument setProperties(cleon.common.doc.doc.spec.document.properties.javamodel.IProperties properties) {
  ...
  public CapabilityDocument setStyle(cleon.common.doc.doc.spec.document.style.javamodel.IStyle style) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,40249800-ea1d-11e6-9264-5588938e0d2c,voZwYlSPh7GUg+xqhks+U7NZNMo=] */
