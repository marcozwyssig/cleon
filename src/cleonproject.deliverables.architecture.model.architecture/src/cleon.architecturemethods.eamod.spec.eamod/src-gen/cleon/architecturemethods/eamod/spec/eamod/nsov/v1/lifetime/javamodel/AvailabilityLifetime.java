...
public class AvailabilityLifetime extends DynamicResource implements IAvailabilityLifetime {
  ...
  public cleon.common.resources.spec.resources.availability.javamodel.IAvailabilityClassification selectAvailabilityClassification() {
    return _getSingle(cleon.common.resources.spec.resources.availability.javamodel.IAvailabilityClassification.class, cleon.architecturemethods.eamod.spec.eamod.nsov.v1.lifetime.LifetimePackage.AvailabilityLifetime_availabilityClassification);
  }
  ...
  public AvailabilityLifetime setAvailabilityClassification(cleon.common.resources.spec.resources.availability.javamodel.IAvailabilityClassification availabilityClassification) {
    _setSingle(cleon.architecturemethods.eamod.spec.eamod.nsov.v1.lifetime.LifetimePackage.AvailabilityLifetime_availabilityClassification, availabilityClassification);
    return this;
  }
  ...
  public java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.eamod.spec.eamod.nsov.v1.lifetime.javamodel.IConfidentialityClassification> selectConfidentialityLifetime() {
    return _getMap(cleon.architecturemethods.eamod.spec.eamod.nsov.v1.lifetime.javamodel.IConfidentialityClassification.class, cleon.architecturemethods.eamod.spec.eamod.nsov.v1.lifetime.LifetimePackage.AvailabilityLifetime_confidentialityLifetime);
  }

  public AvailabilityLifetime setConfidentialityLifetime(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.eamod.spec.eamod.nsov.v1.lifetime.javamodel.IConfidentialityClassification> confidentialityLifetime) {
    _setMap(cleon.architecturemethods.eamod.spec.eamod.nsov.v1.lifetime.LifetimePackage.AvailabilityLifetime_confidentialityLifetime, confidentialityLifetime);
    return this;
  }
  ...
  public static java.util.List<cleon.architecturemethods.eamod.spec.eamod.nsov.v1.lifetime.javamodel.IAvailabilityLifetime> selectToMeAvailabilityClassification(cleon.common.resources.spec.resources.availability.javamodel.IAvailabilityClassification object) {
    return _getToMeList(object.getRepository(), cleon.architecturemethods.eamod.spec.eamod.nsov.v1.lifetime.javamodel.IAvailabilityLifetime.class, cleon.architecturemethods.eamod.spec.eamod.nsov.v1.lifetime.LifetimePackage.AvailabilityLifetime_availabilityClassification, object.getResource());
  }
  
  public static cleon.architecturemethods.eamod.spec.eamod.nsov.v1.lifetime.javamodel.IAvailabilityLifetime selectToMeConfidentialityLifetime(cleon.architecturemethods.eamod.spec.eamod.nsov.v1.lifetime.javamodel.IConfidentialityClassification object) {
    return _getToMeSingle(object.getRepository(), cleon.architecturemethods.eamod.spec.eamod.nsov.v1.lifetime.javamodel.IAvailabilityLifetime.class, cleon.architecturemethods.eamod.spec.eamod.nsov.v1.lifetime.LifetimePackage.AvailabilityLifetime_confidentialityLifetime, object.getResource());
  }
