...
public class ConfidentialityClassification extends DynamicResource implements IConfidentialityClassification {
  ...
  public cleon.common.resources.spec.resources.confidentiality.javamodel.IConfidentialityClassification selectConfidentialityClassification() {
    return _getSingle(cleon.common.resources.spec.resources.confidentiality.javamodel.IConfidentialityClassification.class, cleon.architecturemethods.eamod.spec.eamod.nsov.v1.lifetime.LifetimePackage.ConfidentialityClassification_confidentialityClassification);
  }
  ...
  public ConfidentialityClassification setConfidentialityClassification(cleon.common.resources.spec.resources.confidentiality.javamodel.IConfidentialityClassification confidentialityClassification) {
    _setSingle(cleon.architecturemethods.eamod.spec.eamod.nsov.v1.lifetime.LifetimePackage.ConfidentialityClassification_confidentialityClassification, confidentialityClassification);
    return this;
  }
    
  @Override
  public cleon.architecturemethods.eamod.spec.eamod.nsov.v1.lifetime.javamodel.IServiceLifetime selectLifetime() {
    return _getSingle(cleon.architecturemethods.eamod.spec.eamod.nsov.v1.lifetime.javamodel.IServiceLifetime.class, cleon.architecturemethods.eamod.spec.eamod.nsov.v1.lifetime.LifetimePackage.LifetimeAware_lifetime);
  }

  public ConfidentialityClassification setLifetime(cleon.architecturemethods.eamod.spec.eamod.nsov.v1.lifetime.javamodel.IServiceLifetime lifetime) {
    _setSingle(cleon.architecturemethods.eamod.spec.eamod.nsov.v1.lifetime.LifetimePackage.LifetimeAware_lifetime, lifetime);
    return this;
  }
  ...
  public static java.util.List<cleon.architecturemethods.eamod.spec.eamod.nsov.v1.lifetime.javamodel.IConfidentialityClassification> selectToMeConfidentialityClassification(cleon.common.resources.spec.resources.confidentiality.javamodel.IConfidentialityClassification object) {
    return _getToMeList(object.getRepository(), cleon.architecturemethods.eamod.spec.eamod.nsov.v1.lifetime.javamodel.IConfidentialityClassification.class, cleon.architecturemethods.eamod.spec.eamod.nsov.v1.lifetime.LifetimePackage.ConfidentialityClassification_confidentialityClassification, object.getResource());
  }
