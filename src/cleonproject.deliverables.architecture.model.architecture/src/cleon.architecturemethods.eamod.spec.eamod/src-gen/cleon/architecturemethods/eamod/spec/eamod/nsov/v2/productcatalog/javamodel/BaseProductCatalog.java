...
public class BaseProductCatalog extends DynamicResource implements IBaseProductCatalog {
  ...
  @Override
  public java.util.List<? extends cleon.architecturemethods.eamod.spec.eamod.nsov.v2.productcatalog.productgroup.javamodel.IBaseProductGroup> selectBaseProductGroups() {
    return _getList(cleon.architecturemethods.eamod.spec.eamod.nsov.v2.productcatalog.productgroup.javamodel.IBaseProductGroup.class, cleon.architecturemethods.eamod.spec.eamod.nsov.v2.productcatalog.ProductcatalogPackage.BaseProductCatalog_baseProductGroups);
  }

  public BaseProductCatalog setBaseProductGroups(java.util.List<? extends cleon.architecturemethods.eamod.spec.eamod.nsov.v2.productcatalog.productgroup.javamodel.IBaseProductGroup> baseProductGroups) {
    _setList(cleon.architecturemethods.eamod.spec.eamod.nsov.v2.productcatalog.ProductcatalogPackage.BaseProductCatalog_baseProductGroups, baseProductGroups);
    return this;
  }
  ...
  public BaseProductCatalog setProductGroups(java.util.List<? extends cleon.architecturemethods.eamod.spec.eamod.nsov.v2.productcatalog.productgroup.javamodel.IProductGroup> productGroups) {
  ...
  public static cleon.architecturemethods.eamod.spec.eamod.nsov.v2.productcatalog.javamodel.IBaseProductCatalog selectToMeBaseProductGroups(cleon.architecturemethods.eamod.spec.eamod.nsov.v2.productcatalog.productgroup.javamodel.IBaseProductGroup object) {
    return _getToMeSingle(object.getRepository(), cleon.architecturemethods.eamod.spec.eamod.nsov.v2.productcatalog.javamodel.IBaseProductCatalog.class, cleon.architecturemethods.eamod.spec.eamod.nsov.v2.productcatalog.ProductcatalogPackage.BaseProductCatalog_baseProductGroups, object.getResource());
  }
