...
public class ProductFunctionSpace {
  ...
  public static interface IBaseProductFunctions extends IDynamicResourceExtension {
    ...
    public cleon.architecturemethods.eamod.spec.eamod.nsov.v2.productcatalog.product.javamodel.IProduct NotAllowedProduct();
  ...
  public static interface IInfrastructureProductFunctions extends IDynamicResourceExtension {
    ...
    public cleon.architecturemethods.eamod.spec.eamod.nsov.v2.productcatalog.javamodel.IOffering SelectOffering();
  ...
  public static interface IProductGroupFunctions extends IDynamicResourceExtension {
    ...
    public cleon.architecturemethods.eamod.spec.eamod.nsov.v2.productcatalog.javamodel.ICatalog SelectCatalog();
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,2c5ea9ef-67cc-11e7-afcc-6df3a81a4d17,JPjjSWM14SYua+qp8F29Q2DicLA=] */
