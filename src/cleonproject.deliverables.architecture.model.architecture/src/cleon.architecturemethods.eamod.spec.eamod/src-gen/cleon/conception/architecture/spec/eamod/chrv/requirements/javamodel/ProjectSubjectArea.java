package cleon.conception.architecture.spec.eamod.chrv.requirements.javamodel;
...
public class ProjectSubjectArea extends DynamicResource implements IProjectSubjectArea {
  ...
  @Override
  public java.util.List<? extends cleon.conception.architecture.spec.eamod.chrv.requirements.subjectareas.javamodel.ISubSubjectArea> selectSubjectareas() {
    return _getList(cleon.conception.architecture.spec.eamod.chrv.requirements.subjectareas.javamodel.ISubSubjectArea.class, cleon.conception.architecture.spec.eamod.chrv.requirements.RequirementsPackage.ProjectSubjectArea_subjectareas);
  }

  public ProjectSubjectArea setSubjectareas(java.util.List<? extends cleon.conception.architecture.spec.eamod.chrv.requirements.subjectareas.javamodel.ISubSubjectArea> subjectareas) {
    _setList(cleon.conception.architecture.spec.eamod.chrv.requirements.RequirementsPackage.ProjectSubjectArea_subjectareas, subjectareas);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptList(cleon.conception.architecture.spec.eamod.chrv.requirements.subjectareas.javamodel.ISubSubjectArea.class, cleon.conception.architecture.spec.eamod.chrv.requirements.RequirementsPackage.ProjectSubjectArea_subjectareas, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

  // toMeRelations
  
  public static cleon.conception.architecture.spec.eamod.chrv.requirements.javamodel.IProjectSubjectArea selectToMeSubjectareas(cleon.conception.architecture.spec.eamod.chrv.requirements.subjectareas.javamodel.ISubSubjectArea object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.architecture.spec.eamod.chrv.requirements.javamodel.IProjectSubjectArea.class, cleon.conception.architecture.spec.eamod.chrv.requirements.RequirementsPackage.ProjectSubjectArea_subjectareas, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,f92279cc-ff9a-11e4-ac0a-959b440f987f,zxSE0fN4/ZPnj2NDZ62hWCQHdRQ=] */
