...
public class Construction extends DynamicResource implements IConstruction {
  ...
  public Construction setAchieves(java.util.List<? extends cleon.conception.architecture.spec.eamod.chrv.motivation.goals.javamodel.IGoal> achieves) {
  ...
  public Construction setOwners(java.util.List<? extends cleon.conception.architecture.spec.eamod.chrv.motivation.stakeholder.javamodel.IStakeholder> owners) {
  ...
  public Construction setRequirements(java.util.List<? extends cleon.conception.architecture.spec.eamod.chrv.requirements.subjectareas.requirement.javamodel.IRequirement> requirements) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,641a1033-0c77-11e6-86c5-87a8b520dd59,OpbaV8H6fPdeTyuyH7qV+sIfVn8=] */
