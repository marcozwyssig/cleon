...
public class InformationSecurity extends DynamicResource implements IInformationSecurity {
  ...
  public InformationSecurity setAchieves(java.util.List<? extends cleon.conception.architecture.spec.eamod.chrv.motivation.goals.javamodel.IGoal> achieves) {
  ...
  public InformationSecurity setOwners(java.util.List<? extends cleon.conception.architecture.spec.eamod.chrv.motivation.stakeholder.javamodel.IStakeholder> owners) {
  ...
  public InformationSecurity setRequirements(java.util.List<? extends cleon.conception.architecture.spec.eamod.chrv.requirements.subjectareas.requirement.javamodel.IRequirement> requirements) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,a1a57cec-0c76-11e6-86c5-87a8b520dd59,M6hvyIyWLp8ftu6d8+JE76V8Phc=] */
