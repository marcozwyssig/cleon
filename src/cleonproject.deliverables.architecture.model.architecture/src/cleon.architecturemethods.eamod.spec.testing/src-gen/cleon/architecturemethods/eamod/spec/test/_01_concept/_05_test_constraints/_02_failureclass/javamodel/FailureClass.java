package cleon.architecturemethods.eamod.spec.test._01_concept._05_test_constraints._02_failureclass.javamodel;
...
public class FailureClass extends DynamicResource implements IFailureClass {
  ...
  public boolean is__W___F___S___F_Unwesentlicher__F_Mangel() {
    return getResource().equals(cleon.architecturemethods.eamod.spec.test._01_concept._05_test_constraints._02_failureclass._02_failureclassPackage.FailureClass___W___F___S___F_Unwesentlicher__F_Mangel);
  }
  
  @Override
  public boolean is__X___F___S___F_Leichter__F_Mangel() {
    return getResource().equals(cleon.architecturemethods.eamod.spec.test._01_concept._05_test_constraints._02_failureclass._02_failureclassPackage.FailureClass___X___F___S___F_Leichter__F_Mangel);
  }
  
  @Override
  public boolean is__Y___F___S___F_Schwerer__F_Mangel() {
    return getResource().equals(cleon.architecturemethods.eamod.spec.test._01_concept._05_test_constraints._02_failureclass._02_failureclassPackage.FailureClass___Y___F___S___F_Schwerer__F_Mangel);
  }
  
  @Override
  public boolean is__Z___F___S___F_Kritischer__F_Mangel() {
    return getResource().equals(cleon.architecturemethods.eamod.spec.test._01_concept._05_test_constraints._02_failureclass._02_failureclassPackage.FailureClass___Z___F___S___F_Kritischer__F_Mangel);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,882921f6-1db2-11e6-974b-630b7f5d3b95,y+v1sUNiorn9CxtObnQ2lYYj1oU=] */
