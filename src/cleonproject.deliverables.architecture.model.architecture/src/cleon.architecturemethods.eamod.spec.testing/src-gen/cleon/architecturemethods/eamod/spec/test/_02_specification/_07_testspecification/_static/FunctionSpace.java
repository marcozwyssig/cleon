package cleon.architecturemethods.eamod.spec.test._02_specification._07_testspecification._static;
...
import cleon.architecturemethods.eamod.spec.test._03_execution._09_test_execution.FunctionSpace.ITestResultFunctions;
import cleon.architecturemethods.eamod.spec.test._03_execution._09_test_execution.FunctionSpace.ITestResultFunctionsImpl;
import cleon.architecturemethods.eamod.spec.test._03_execution._09_test_execution.FunctionSpace.TestResultFunctions;
import cleon.architecturemethods.eamod.spec.test._03_execution._09_test_execution.FunctionSpace.TestResultFunctionsImpl;
import cleon.architecturemethods.eamod.spec.test._03_execution._09_test_execution.javamodel.ITestResult;
...
public class FunctionSpace {
  ...
  public static interface IStaticTestFunctions extends IDynamicResourceExtension {
    ...
    public cleon.architecturemethods.eamod.spec.test._02_specification._07_testspecification._static.javamodel.ITestSubjectArea GetTestSubjectArea();
    ...
    public List<cleon.architecturemethods.eamod.spec.test._02_specification._07_testspecification._static.javamodel.IStaticTest> AllRequirements();

    @IDynamicResourceExtension.MethodId("4b74c368-2275-11e6-bcc1-f96f0d74dcad")
    public List<cleon.architecturemethods.eamod.spec.test._03_execution._09_test_execution.javamodel.ITestFailure> AllFailedRequirements();

    @IDynamicResourceExtension.MethodId("9780138a-2275-11e6-bcc1-f96f0d74dcad")
    public List<cleon.architecturemethods.eamod.spec.test._03_execution._09_test_execution.javamodel.ITestSuccess> AllSucessfulRequirements();

    @IDynamicResourceExtension.MethodId("5a192049-2276-11e6-bcc1-f96f0d74dcad")
    public List<cleon.architecturemethods.eamod.spec.test._03_execution._09_test_execution.javamodel.ITestResult> AllTestResults();
  ...
  public static interface IStaticTestFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("5dbb0bce-20d9-11e6-9368-9172b77c2cff")
    public java.lang.Boolean AllTestArePassed(final cleon.architecturemethods.eamod.spec.test._02_specification._07_testspecification._static.javamodel.IStaticTest staticTest);
  ...
  public static class StaticTestFunctions {
    ...
    public static java.lang.Boolean AllTestArePassed(final cleon.architecturemethods.eamod.spec.test._02_specification._07_testspecification._static.javamodel.IStaticTest staticTest) {
  ...
  public static interface ITestFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("dbf30cb6-1dba-11e6-974b-630b7f5d3b95")
    public java.lang.String GetId(final cleon.architecturemethods.eamod.spec.test._02_specification._07_testspecification.javamodel.ITest test);
  ...
  public static class TestFunctions {
    ...
    public static java.lang.String GetId(final cleon.architecturemethods.eamod.spec.test._02_specification._07_testspecification.javamodel.ITest test) {
  ...
  public static interface ITestSubjectAreaFunctions extends IDynamicResourceExtension {
    ...
    public List<cleon.architecturemethods.eamod.spec.test._03_execution._09_test_execution.javamodel.ITestSuccess> AllSuccessfulRequirements();
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,61add92d-1cf4-11e6-aaba-9db7fdc64d7e,GY7lEv+1iBHne6QcWo1yPOoq32E=] */
