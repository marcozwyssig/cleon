package cleon.architecturemethods.eamod.spec.test._02_specification.javamodel;
...
public class TestSpecificationDocument extends DynamicResource implements ITestSpecificationDocument {
  ...
  @Override
  public cleon.architecturemethods.eamod.spec.test._01_concept.javamodel.ITestConceptDocument selectTestConceptDocument() {
    return _getSingle(cleon.architecturemethods.eamod.spec.test._01_concept.javamodel.ITestConceptDocument.class, cleon.architecturemethods.eamod.spec.test._02_specification._02_specificationPackage.TestSpecificationDocument_testConceptDocument);
  }

  public TestSpecificationDocument setTestConceptDocument(cleon.architecturemethods.eamod.spec.test._01_concept.javamodel.ITestConceptDocument testConceptDocument) {
    _setSingle(cleon.architecturemethods.eamod.spec.test._02_specification._02_specificationPackage.TestSpecificationDocument_testConceptDocument, testConceptDocument);
    return this;
  }
    
  @Override
  public cleon.architecturemethods.eamod.spec.test._02_specification._07_testspecification.javamodel.ITestSpecifications selectTestSpecifications() {
    return _getSingle(cleon.architecturemethods.eamod.spec.test._02_specification._07_testspecification.javamodel.ITestSpecifications.class, cleon.architecturemethods.eamod.spec.test._02_specification._02_specificationPackage.TestSpecificationDocument_testSpecifications);
  }

  public TestSpecificationDocument setTestSpecifications(cleon.architecturemethods.eamod.spec.test._02_specification._07_testspecification.javamodel.ITestSpecifications testSpecifications) {
    _setSingle(cleon.architecturemethods.eamod.spec.test._02_specification._02_specificationPackage.TestSpecificationDocument_testSpecifications, testSpecifications);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(cleon.architecturemethods.eamod.spec.test._01_concept.javamodel.ITestConceptDocument.class, cleon.architecturemethods.eamod.spec.test._02_specification._02_specificationPackage.TestSpecificationDocument_testConceptDocument, visitor);
    _acceptSingle(cleon.architecturemethods.eamod.spec.test._02_specification._07_testspecification.javamodel.ITestSpecifications.class, cleon.architecturemethods.eamod.spec.test._02_specification._02_specificationPackage.TestSpecificationDocument_testSpecifications, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

  // toMeRelations
  
  public static java.util.List<cleon.architecturemethods.eamod.spec.test._02_specification.javamodel.ITestSpecificationDocument> selectToMeTestConceptDocument(cleon.architecturemethods.eamod.spec.test._01_concept.javamodel.ITestConceptDocument object) {
    return _getToMeList(object.getRepository(), cleon.architecturemethods.eamod.spec.test._02_specification.javamodel.ITestSpecificationDocument.class, cleon.architecturemethods.eamod.spec.test._02_specification._02_specificationPackage.TestSpecificationDocument_testConceptDocument, object.getResource());
  }
  
  public static cleon.architecturemethods.eamod.spec.test._02_specification.javamodel.ITestSpecificationDocument selectToMeTestSpecifications(cleon.architecturemethods.eamod.spec.test._02_specification._07_testspecification.javamodel.ITestSpecifications object) {
    return _getToMeSingle(object.getRepository(), cleon.architecturemethods.eamod.spec.test._02_specification.javamodel.ITestSpecificationDocument.class, cleon.architecturemethods.eamod.spec.test._02_specification._02_specificationPackage.TestSpecificationDocument_testSpecifications, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,88d35210-4f02-11e9-ba59-f1daaff821cc,bYK3qjLwau06pLNE12Zz9tVL8hc=] */
