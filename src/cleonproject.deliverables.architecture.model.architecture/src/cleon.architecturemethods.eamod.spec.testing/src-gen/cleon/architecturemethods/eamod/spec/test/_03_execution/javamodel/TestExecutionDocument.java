...
public class TestExecutionDocument extends DynamicResource implements ITestExecutionDocument {
  ...
  public TestExecutionDocument setAbout(cleon.common.doc.spec.doc.chapter.about.javamodel.IAbout about) {
  ...
  public TestExecutionDocument setChapters(java.util.List<? extends cleon.common.doc.spec.doc.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public TestExecutionDocument setDocumentElements(java.util.List<? extends cleon.common.doc.spec.doc.javamodel.IDocumentElement> documentElements) {
  ...
  public TestExecutionDocument setDocumentLanguage(java.util.List<? extends cleon.common.doc.spec.doc.documentlanguage.javamodel.IDocumentLanguage> documentLanguage) {
  ...
  public TestExecutionDocument setParagraphs(java.util.List<? extends cleon.common.doc.spec.doc.paragraph.javamodel.IParagraph> paragraphs) {
  ...
  public TestExecutionDocument setProperties(cleon.common.doc.spec.doc.document.properties.javamodel.IProperties properties) {
  ...
  public TestExecutionDocument setStyle(cleon.common.doc.spec.doc.document.style.javamodel.IStyle style) {
  ...
  public cleon.architecturemethods.eamod.spec.test._03_execution._09_test_execution.javamodel.ITestExecutions selectTestExecutions() {
    return _getSingle(cleon.architecturemethods.eamod.spec.test._03_execution._09_test_execution.javamodel.ITestExecutions.class, cleon.architecturemethods.eamod.spec.test._03_execution._03_executionPackage.TestExecutionDocument_testExecutions);
  }

  public TestExecutionDocument setTestExecutions(cleon.architecturemethods.eamod.spec.test._03_execution._09_test_execution.javamodel.ITestExecutions testExecutions) {
    _setSingle(cleon.architecturemethods.eamod.spec.test._03_execution._03_executionPackage.TestExecutionDocument_testExecutions, testExecutions);
    return this;
  }
  ...
  public cleon.architecturemethods.eamod.spec.test._02_specification.javamodel.ITestSpecificationDocument selectTestSpecificationDocument() {
    return _getSingle(cleon.architecturemethods.eamod.spec.test._02_specification.javamodel.ITestSpecificationDocument.class, cleon.architecturemethods.eamod.spec.test._03_execution._03_executionPackage.TestExecutionDocument_testSpecificationDocument);
  }

  public TestExecutionDocument setTestSpecificationDocument(cleon.architecturemethods.eamod.spec.test._02_specification.javamodel.ITestSpecificationDocument testSpecificationDocument) {
    _setSingle(cleon.architecturemethods.eamod.spec.test._03_execution._03_executionPackage.TestExecutionDocument_testSpecificationDocument, testSpecificationDocument);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(cleon.architecturemethods.eamod.spec.test._03_execution._09_test_execution.javamodel.ITestExecutions.class, cleon.architecturemethods.eamod.spec.test._03_execution._03_executionPackage.TestExecutionDocument_testExecutions, visitor);
    _acceptSingle(cleon.architecturemethods.eamod.spec.test._02_specification.javamodel.ITestSpecificationDocument.class, cleon.architecturemethods.eamod.spec.test._03_execution._03_executionPackage.TestExecutionDocument_testSpecificationDocument, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

  // toMeRelations
  
  public static cleon.architecturemethods.eamod.spec.test._03_execution.javamodel.ITestExecutionDocument selectToMeTestExecutions(cleon.architecturemethods.eamod.spec.test._03_execution._09_test_execution.javamodel.ITestExecutions object) {
    return _getToMeSingle(object.getRepository(), cleon.architecturemethods.eamod.spec.test._03_execution.javamodel.ITestExecutionDocument.class, cleon.architecturemethods.eamod.spec.test._03_execution._03_executionPackage.TestExecutionDocument_testExecutions, object.getResource());
  }
  
  public static java.util.List<cleon.architecturemethods.eamod.spec.test._03_execution.javamodel.ITestExecutionDocument> selectToMeTestSpecificationDocument(cleon.architecturemethods.eamod.spec.test._02_specification.javamodel.ITestSpecificationDocument object) {
    return _getToMeList(object.getRepository(), cleon.architecturemethods.eamod.spec.test._03_execution.javamodel.ITestExecutionDocument.class, cleon.architecturemethods.eamod.spec.test._03_execution._03_executionPackage.TestExecutionDocument_testSpecificationDocument, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,e85c9091-4f02-11e9-ba59-f1daaff821cc,trUpCePSK5/CnJgBnVd37hjHjxg=] */
