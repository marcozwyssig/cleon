...
public class TestProperty extends DynamicResource implements ITestProperty {
  ...
  public cleon.modelinglanguages.uml.spec.uml2.structural.classes.fields.javamodel.IProperty selectWhen() {
    return _getSingle(cleon.modelinglanguages.uml.spec.uml2.structural.classes.fields.javamodel.IProperty.class, cleon.architecturemethods.eamod.spec.testing._05_test_constraints.testlevels.unitests.UnitestsPackage.TestProperty_when);
  }

  public TestProperty setWhen(cleon.modelinglanguages.uml.spec.uml2.structural.classes.fields.javamodel.IProperty when) {
    _setSingle(cleon.architecturemethods.eamod.spec.testing._05_test_constraints.testlevels.unitests.UnitestsPackage.TestProperty_when, when);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(cleon.modelinglanguages.uml.spec.uml2.structural.classes.fields.javamodel.IProperty.class, cleon.architecturemethods.eamod.spec.testing._05_test_constraints.testlevels.unitests.UnitestsPackage.TestProperty_when, visitor);
  }

  // toMeRelations
  
  public static java.util.List<cleon.architecturemethods.eamod.spec.testing._05_test_constraints.testlevels.unitests.javamodel.ITestProperty> selectToMeWhen(cleon.modelinglanguages.uml.spec.uml2.structural.classes.fields.javamodel.IProperty object) {
    return _getToMeList(object.getRepository(), cleon.architecturemethods.eamod.spec.testing._05_test_constraints.testlevels.unitests.javamodel.ITestProperty.class, cleon.architecturemethods.eamod.spec.testing._05_test_constraints.testlevels.unitests.UnitestsPackage.TestProperty_when, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,aec482bc-a397-11e3-9113-ffc7f11b0a42,Qh/XkQ/kwJdB60EaHWWk0VYUVx4=] */
