...
public class TestExecutions extends DynamicResource implements ITestExecutions {
  ...
  public TestExecutions setChapters(java.util.List<? extends cleon.common.doc.spec.doc.chapter.javamodel.IChapter> chapters) {
  ...
  @Override
  public java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.eamod.spec.testing._09_test_execution._static.javamodel.IStaticTestExecution> selectStaticTestExecutions() {
    return _getMap(cleon.architecturemethods.eamod.spec.testing._09_test_execution._static.javamodel.IStaticTestExecution.class, cleon.architecturemethods.eamod.spec.testing._09_test_execution._09_test_executionPackage.TestExecutions_staticTestExecutions);
  }

  public TestExecutions setStaticTestExecutions(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.eamod.spec.testing._09_test_execution._static.javamodel.IStaticTestExecution> staticTestExecutions) {
    _setMap(cleon.architecturemethods.eamod.spec.testing._09_test_execution._09_test_executionPackage.TestExecutions_staticTestExecutions, staticTestExecutions);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptMap(cleon.architecturemethods.eamod.spec.testing._09_test_execution._static.javamodel.IStaticTestExecution.class, cleon.architecturemethods.eamod.spec.testing._09_test_execution._09_test_executionPackage.TestExecutions_staticTestExecutions, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

  // toMeRelations
  
  public static cleon.architecturemethods.eamod.spec.testing._09_test_execution.javamodel.ITestExecutions selectToMeStaticTestExecutions(cleon.architecturemethods.eamod.spec.testing._09_test_execution._static.javamodel.IStaticTestExecution object) {
    return _getToMeSingle(object.getRepository(), cleon.architecturemethods.eamod.spec.testing._09_test_execution.javamodel.ITestExecutions.class, cleon.architecturemethods.eamod.spec.testing._09_test_execution._09_test_executionPackage.TestExecutions_staticTestExecutions, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,624c64dc-20d7-11e6-9368-9172b77c2cff,h7aokc16Pwdl+gkkpCI2fNg4BrE=] */
