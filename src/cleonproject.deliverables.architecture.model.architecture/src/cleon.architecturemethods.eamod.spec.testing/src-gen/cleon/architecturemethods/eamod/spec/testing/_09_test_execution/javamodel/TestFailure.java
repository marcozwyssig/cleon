...
public class TestFailure extends DynamicResource implements ITestFailure {
  ...
  public java.lang.String selectFailureReason() {
    return _getSingleAttribute(java.lang.String.class, cleon.architecturemethods.eamod.spec.testing._09_test_execution._09_test_executionPackage.TestFailure_failureReason);
  }
    
  public void setFailureReason(java.lang.String failureReason) {
     _setSingleAttribute(cleon.architecturemethods.eamod.spec.testing._09_test_execution._09_test_executionPackage.TestFailure_failureReason, failureReason);
  }
  ...
  public cleon.architecturemethods.eamod.spec.testing._05_test_constraints._02_failureclass.javamodel.IFailureClass selectFailureClass() {
    return _getSingle(cleon.architecturemethods.eamod.spec.testing._05_test_constraints._02_failureclass.javamodel.IFailureClass.class, cleon.architecturemethods.eamod.spec.testing._09_test_execution._09_test_executionPackage.TestFailure_failureClass);
  }

  public TestFailure setFailureClass(cleon.architecturemethods.eamod.spec.testing._05_test_constraints._02_failureclass.javamodel.IFailureClass failureClass) {
    _setSingle(cleon.architecturemethods.eamod.spec.testing._09_test_execution._09_test_executionPackage.TestFailure_failureClass, failureClass);
    return this;
  }
  ...
  public TestFailure setTestQualityCriteria(cleon.architecturemethods.eamod.spec.testing._07_testspecification._static.javamodel.ITestQualityCriteria testQualityCriteria) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    // attributes
    _acceptSingleAttribute(java.lang.String.class, cleon.architecturemethods.eamod.spec.testing._09_test_execution._09_test_executionPackage.TestFailure_failureReason, visitor);
    // relations
    _acceptSingle(cleon.architecturemethods.eamod.spec.testing._05_test_constraints._02_failureclass.javamodel.IFailureClass.class, cleon.architecturemethods.eamod.spec.testing._09_test_execution._09_test_executionPackage.TestFailure_failureClass, visitor);
  ...
  public static java.util.List<cleon.architecturemethods.eamod.spec.testing._09_test_execution.javamodel.ITestFailure> selectToMeFailureClass(cleon.architecturemethods.eamod.spec.testing._05_test_constraints._02_failureclass.javamodel.IFailureClass object) {
    return _getToMeList(object.getRepository(), cleon.architecturemethods.eamod.spec.testing._09_test_execution.javamodel.ITestFailure.class, cleon.architecturemethods.eamod.spec.testing._09_test_execution._09_test_executionPackage.TestFailure_failureClass, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,c78ee45d-1cf3-11e6-aaba-9db7fdc64d7e,6MPA2gBzUcCHB7SO67jeCF5EwS8=] */
