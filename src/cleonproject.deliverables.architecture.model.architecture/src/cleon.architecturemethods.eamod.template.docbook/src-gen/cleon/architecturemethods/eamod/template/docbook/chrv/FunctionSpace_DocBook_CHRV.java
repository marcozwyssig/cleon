...
public class FunctionSpace_DocBook_CHRV {
  ...
  public static interface IRequirementFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("8a8cb15a-3808-11e8-a088-c32925c50d0b")
    public java.lang.String RenderDescriptions(final cleon.architecturemethods.eamod.spec.eamod.chrv.requirements.subjectareas.requirement.javamodel.IRequirement requirement);
  ...
  public static class RequirementFunctions {
    ...
    public static java.lang.String RenderDescriptions(final cleon.architecturemethods.eamod.spec.eamod.chrv.requirements.subjectareas.requirement.javamodel.IRequirement requirement) {
