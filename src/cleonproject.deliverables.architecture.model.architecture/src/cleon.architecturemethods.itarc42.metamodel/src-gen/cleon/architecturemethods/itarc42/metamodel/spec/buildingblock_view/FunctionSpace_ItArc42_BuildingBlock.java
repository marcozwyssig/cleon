package cleon.architecturemethods.itarc42.metamodel.spec.buildingblock_view;
...
public class FunctionSpace_ItArc42_BuildingBlock {
  ...
  public static interface ISystemFunctions extends IDynamicResourceExtension {
    ...
    public List<cleon.architecturemethods.itarc42.metamodel.spec.buildingblock_view.javamodel.ISystemComponent> AllSystemComponents();

    @IDynamicResourceExtension.MethodId("85e60694-9c97-11e9-9b32-35cf2fd07621")
    public List<cleon.architecturemethods.itarc42.metamodel.spec.buildingblock_view.javamodel.ISystemConfiguration> AllSystemConfigurations();
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,8bc3420c-035a-11e9-a251-e3767b78f69f,pscTG2ZpB8P24s8M+KyYzYTmjnM=] */
