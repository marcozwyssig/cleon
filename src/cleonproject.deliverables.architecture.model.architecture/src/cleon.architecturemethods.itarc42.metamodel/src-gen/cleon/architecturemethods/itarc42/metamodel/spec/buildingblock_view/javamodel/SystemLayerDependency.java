...
public class SystemLayerDependency extends DynamicResource implements ISystemLayerDependency {
  ...
  @Override
  public cleon.architecturemethods.itarc42.metamodel.spec.buildingblock_view.javamodel.ISystemLayer selectTo() {
    return _getSingle(cleon.architecturemethods.itarc42.metamodel.spec.buildingblock_view.javamodel.ISystemLayer.class, cleon.architecturemethods.itarc42.metamodel.spec.buildingblock_view.Buildingblock_viewPackage.SystemLayerDependency_to);
  }

  public SystemLayerDependency setTo(cleon.architecturemethods.itarc42.metamodel.spec.buildingblock_view.javamodel.ISystemLayer to) {
    _setSingle(cleon.architecturemethods.itarc42.metamodel.spec.buildingblock_view.Buildingblock_viewPackage.SystemLayerDependency_to, to);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    // relations
    _acceptSingle(cleon.architecturemethods.itarc42.metamodel.spec.buildingblock_view.javamodel.ISystemLayer.class, cleon.architecturemethods.itarc42.metamodel.spec.buildingblock_view.Buildingblock_viewPackage.SystemLayerDependency_to, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

  // toMeRelations
  
  public static java.util.List<cleon.architecturemethods.itarc42.metamodel.spec.buildingblock_view.javamodel.ISystemLayerDependency> selectToMeTo(cleon.architecturemethods.itarc42.metamodel.spec.buildingblock_view.javamodel.ISystemLayer object) {
    return _getToMeList(object.getRepository(), cleon.architecturemethods.itarc42.metamodel.spec.buildingblock_view.javamodel.ISystemLayerDependency.class, cleon.architecturemethods.itarc42.metamodel.spec.buildingblock_view.Buildingblock_viewPackage.SystemLayerDependency_to, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,a670e1bd-01d8-11e9-9c9d-8d52d6745026,Ef/frsPUCNzWFrMUgIx6wn/sAXw=] */
