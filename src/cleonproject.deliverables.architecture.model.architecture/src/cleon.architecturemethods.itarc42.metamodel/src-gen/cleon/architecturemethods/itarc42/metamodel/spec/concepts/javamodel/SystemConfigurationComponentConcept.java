...
public class SystemConfigurationComponentConcept extends DynamicResource implements ISystemConfigurationComponentConcept {
  ...
  public SystemConfigurationComponentConcept setSystemConfiguration(cleon.architecturemethods.itarc42.metamodel.spec.buildingblock_view.javamodel.ISystemConfiguration systemConfiguration) {
  ...
  public static java.util.List<cleon.architecturemethods.itarc42.metamodel.spec.concepts.javamodel.ISystemConfigurationComponentConcept> selectToMeSystemConfiguration(cleon.architecturemethods.itarc42.metamodel.spec.buildingblock_view.javamodel.ISystemConfiguration object) {
    return _getToMeList(object.getRepository(), cleon.architecturemethods.itarc42.metamodel.spec.concepts.javamodel.ISystemConfigurationComponentConcept.class, cleon.architecturemethods.itarc42.metamodel.spec.concepts.ConceptsPackage.SystemConfigurationComponentConcept_systemConfiguration, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,36c27e80-0b86-11e9-a136-69d076e48ed1,PTudpVKHs9rc9lwvtURU7Wt+qVY=] */
