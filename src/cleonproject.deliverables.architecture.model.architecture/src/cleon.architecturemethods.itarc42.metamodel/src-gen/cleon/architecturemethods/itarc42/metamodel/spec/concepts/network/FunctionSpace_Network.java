...
public class FunctionSpace_Network {
  ...
  public static interface INetworkNodeFunctions extends IDynamicResourceExtension {
    ...
    public List<cleon.architecturemethods.itarc42.metamodel.spec.deployment_view.environment.node.javamodel.INode> GetNetworkNodes();

    @IDynamicResourceExtension.MethodId("1d92d94f-7b1a-11e9-a70f-4dc03941a024")
    public List<cleon.architecturemethods.itarc42.metamodel.spec.deployment_view.environment.node.javamodel.INode> GetNetworkNodesFromNetdomain();

    @IDynamicResourceExtension.MethodId("dd95c0b7-7b11-11e9-a70f-4dc03941a024")
    public List<cleon.architecturemethods.itarc42.metamodel.spec.deployment_view.environment.node.javamodel.INode> GetNodesFromSecurityZone();
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,2acb3661-7b0e-11e9-a70f-4dc03941a024,Gb3G2JJiq+JFHl9hw+S0ka8xOl0=] */
