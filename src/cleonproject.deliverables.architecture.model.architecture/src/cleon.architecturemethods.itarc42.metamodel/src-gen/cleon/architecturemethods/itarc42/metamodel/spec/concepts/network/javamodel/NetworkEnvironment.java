...
public class NetworkEnvironment extends DynamicResource implements INetworkEnvironment {
  ...
  public cleon.architecturemethods.itarc42.metamodel.spec.deployment_view.environment.javamodel.IEnvironment selectEnvironment() {
    return _getSingle(cleon.architecturemethods.itarc42.metamodel.spec.deployment_view.environment.javamodel.IEnvironment.class, cleon.architecturemethods.itarc42.metamodel.spec.concepts.network.NetworkPackage.NetworkEnvironment_environment);
  }

  public NetworkEnvironment setEnvironment(cleon.architecturemethods.itarc42.metamodel.spec.deployment_view.environment.javamodel.IEnvironment environment) {
    _setSingle(cleon.architecturemethods.itarc42.metamodel.spec.concepts.network.NetworkPackage.NetworkEnvironment_environment, environment);
    return this;
  }
  ...
  @Override
  public java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.itarc42.metamodel.spec.concepts.network.javamodel.INetworkNetdomain> selectNetworkNetdomain() {
    return _getMap(cleon.architecturemethods.itarc42.metamodel.spec.concepts.network.javamodel.INetworkNetdomain.class, cleon.architecturemethods.itarc42.metamodel.spec.concepts.network.NetworkPackage.NetworkEnvironment_networkNetdomain);
  }

  public NetworkEnvironment setNetworkNetdomain(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.itarc42.metamodel.spec.concepts.network.javamodel.INetworkNetdomain> networkNetdomain) {
    _setMap(cleon.architecturemethods.itarc42.metamodel.spec.concepts.network.NetworkPackage.NetworkEnvironment_networkNetdomain, networkNetdomain);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    // relations
    _acceptSingle(cleon.architecturemethods.itarc42.metamodel.spec.deployment_view.environment.javamodel.IEnvironment.class, cleon.architecturemethods.itarc42.metamodel.spec.concepts.network.NetworkPackage.NetworkEnvironment_environment, visitor);
    ...
    _acceptMap(cleon.architecturemethods.itarc42.metamodel.spec.concepts.network.javamodel.INetworkNetdomain.class, cleon.architecturemethods.itarc42.metamodel.spec.concepts.network.NetworkPackage.NetworkEnvironment_networkNetdomain, visitor);
  ...
  public static java.util.List<cleon.architecturemethods.itarc42.metamodel.spec.concepts.network.javamodel.INetworkEnvironment> selectToMeEnvironment(cleon.architecturemethods.itarc42.metamodel.spec.deployment_view.environment.javamodel.IEnvironment object) {
    return _getToMeList(object.getRepository(), cleon.architecturemethods.itarc42.metamodel.spec.concepts.network.javamodel.INetworkEnvironment.class, cleon.architecturemethods.itarc42.metamodel.spec.concepts.network.NetworkPackage.NetworkEnvironment_environment, object.getResource());
  }
  
  public static cleon.architecturemethods.itarc42.metamodel.spec.concepts.network.javamodel.INetworkEnvironment selectToMeNetworkNetdomain(cleon.architecturemethods.itarc42.metamodel.spec.concepts.network.javamodel.INetworkNetdomain object) {
    return _getToMeSingle(object.getRepository(), cleon.architecturemethods.itarc42.metamodel.spec.concepts.network.javamodel.INetworkEnvironment.class, cleon.architecturemethods.itarc42.metamodel.spec.concepts.network.NetworkPackage.NetworkEnvironment_networkNetdomain, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,7ad5fb03-7adf-11e9-a70f-4dc03941a024,MIW2bRVWHspPBpgLDhrGhw5CAtA=] */
