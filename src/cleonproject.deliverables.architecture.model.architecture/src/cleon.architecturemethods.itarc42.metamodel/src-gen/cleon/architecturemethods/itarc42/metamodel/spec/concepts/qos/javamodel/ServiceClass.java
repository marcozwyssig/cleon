...
public class ServiceClass extends DynamicResource implements IServiceClass {
  ...
  public java.lang.Integer selectDSCP() {
    return _getSingleAttribute(java.lang.Integer.class, cleon.architecturemethods.itarc42.metamodel.spec.concepts.qos.QosPackage.ServiceClass_DSCP);
  }
    
  public void setDSCP(java.lang.Integer dSCP) {
     _setSingleAttribute(cleon.architecturemethods.itarc42.metamodel.spec.concepts.qos.QosPackage.ServiceClass_DSCP, dSCP);
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    // attributes
    _acceptSingleAttribute(java.lang.Integer.class, cleon.architecturemethods.itarc42.metamodel.spec.concepts.qos.QosPackage.ServiceClass_DSCP, visitor);
  ...
  public boolean isAF11__F___S___F_High__F_Throughput__F_Data() {
    return getResource().equals(cleon.architecturemethods.itarc42.metamodel.spec.concepts.qos.QosPackage.ServiceClass_AF11__F___S___F_High__F_Throughput__F_Data);
  }
  
  @Override
  public boolean isAF21__F___S___F_Low__F_Latency__F_Data() {
    return getResource().equals(cleon.architecturemethods.itarc42.metamodel.spec.concepts.qos.QosPackage.ServiceClass_AF21__F___S___F_Low__F_Latency__F_Data);
  }
  
  @Override
  public boolean isAF31__F___S___F_Multimedia__F_Streaming() {
    return getResource().equals(cleon.architecturemethods.itarc42.metamodel.spec.concepts.qos.QosPackage.ServiceClass_AF31__F___S___F_Multimedia__F_Streaming);
  }
  
  @Override
  public boolean isAF41__F___S___F_Multimedia__F_Conferencing() {
    return getResource().equals(cleon.architecturemethods.itarc42.metamodel.spec.concepts.qos.QosPackage.ServiceClass_AF41__F___S___F_Multimedia__F_Conferencing);
  }
  
  @Override
  public boolean isCS1__F___S___F_Low__S_Priority__F_Data() {
    return getResource().equals(cleon.architecturemethods.itarc42.metamodel.spec.concepts.qos.QosPackage.ServiceClass_CS1__F___S___F_Low__S_Priority__F_Data);
  }
  
  @Override
  public boolean isCS2__F___S___F_OAM__F___N_Operation__R___F_Administration__R___F_Maintenance__O_() {
    return getResource().equals(cleon.architecturemethods.itarc42.metamodel.spec.concepts.qos.QosPackage.ServiceClass_CS2__F___S___F_OAM__F___N_Operation__R___F_Administration__R___F_Maintenance__O_);
  }
  
  @Override
  public boolean isCS3__F___S___F_Broadcast__F_Video() {
    return getResource().equals(cleon.architecturemethods.itarc42.metamodel.spec.concepts.qos.QosPackage.ServiceClass_CS3__F___S___F_Broadcast__F_Video);
  }
  
  @Override
  public boolean isCS4__F___S___F_Real__F_time__F_Interactive() {
    return getResource().equals(cleon.architecturemethods.itarc42.metamodel.spec.concepts.qos.QosPackage.ServiceClass_CS4__F___S___F_Real__F_time__F_Interactive);
  }
  
  @Override
  public boolean isCS5__F___S___F_Signalling() {
    return getResource().equals(cleon.architecturemethods.itarc42.metamodel.spec.concepts.qos.QosPackage.ServiceClass_CS5__F___S___F_Signalling);
  }
  
  @Override
  public boolean isCS6__F___S___F_Network__F_Control__F___N_Access__O_() {
    return getResource().equals(cleon.architecturemethods.itarc42.metamodel.spec.concepts.qos.QosPackage.ServiceClass_CS6__F___S___F_Network__F_Control__F___N_Access__O_);
  }
  
  @Override
  public boolean isCS7__F___S___F_Network__F_Control__F___N_Backbone__O___F_() {
    return getResource().equals(cleon.architecturemethods.itarc42.metamodel.spec.concepts.qos.QosPackage.ServiceClass_CS7__F___S___F_Network__F_Control__F___N_Backbone__O___F_);
  }
  
  @Override
  public boolean isDF__F___S___F_Standard() {
    return getResource().equals(cleon.architecturemethods.itarc42.metamodel.spec.concepts.qos.QosPackage.ServiceClass_DF__F___S___F_Standard);
  }
  
  @Override
  public boolean isEF__F___S___F_Telephony() {
    return getResource().equals(cleon.architecturemethods.itarc42.metamodel.spec.concepts.qos.QosPackage.ServiceClass_EF__F___S___F_Telephony);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,af43badb-1d88-11e9-b601-db75aa6f89a4,Ei5Ep9LhYwnmQbE74wdLyQ7pnTM=] */
