package cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac;
...
public class FunctionSpace_RBAC {
  ...
  public static interface IAbstractNetdomainGroupFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("a904cb96-1e19-11e9-865e-41ef48a95f70")
    public java.lang.Integer GetRange(final cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.javamodel.IAbstractNetdomainGroup abstractNetdomainGroup);

    @IDynamicResourceExtension.MethodId("893ebfeb-7f21-11e9-9a52-07d4b074defc")
    public java.lang.Integer GetId(final cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.javamodel.IAbstractNetdomainGroup abstractNetdomainGroup);

    @IDynamicResourceExtension.MethodId("8f1d7786-9c8f-11e9-9b32-35cf2fd07621")
    public java.lang.Integer MaxRounded(final cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.javamodel.IAbstractNetdomainGroup abstractNetdomainGroup);
  ...
  public static class AbstractNetdomainGroupFunctions {
    ...
    public static java.lang.Integer GetRange(final cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.javamodel.IAbstractNetdomainGroup abstractNetdomainGroup) {
    ...
    public static java.lang.Integer GetId(final cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.javamodel.IAbstractNetdomainGroup abstractNetdomainGroup) {
    ...
    public static java.lang.Integer MaxRounded(final cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.javamodel.IAbstractNetdomainGroup abstractNetdomainGroup) {
  ...
  public static interface IAbstractGroupFunctions extends IDynamicResourceExtension {
    ...
    public cleon.architecturemethods.itarc42.metamodel.spec.deployment_view.environment.node.supplynode.javamodel.ISupplyNetDomainNode GetNetdomain();

    @IDynamicResourceExtension.MethodId("ac99f866-7f25-11e9-9a52-07d4b074defc")
    public cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.javamodel.IAbstractNetdomainGroup GetNetdomainGroup();

    @IDynamicResourceExtension.MethodId("cbe6c726-7f24-11e9-9a52-07d4b074defc")
    public List<cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.javamodel.IAbstractGroup> GetParents();

    @IDynamicResourceExtension.MethodId("9755ee05-1e0d-11e9-865e-41ef48a95f70")
    public cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.javamodel.IRBAC GetRBAC();
    ...
    public cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.activity.javamodel.IActivityRootGroups GetRootActivityGroup();

    @IDynamicResourceExtension.MethodId("94ef12db-809c-11e9-8e65-f3f639e40a34")
    public cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.role.javamodel.IRoleRootGroups GetRootRoleGroup();

    @IDynamicResourceExtension.MethodId("34e81fa9-c56f-11e9-9daa-cf9f9f7341e8")
    public List<cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.javamodel.IAbstractGroup> GetAllChildren();

    @IDynamicResourceExtension.MethodId("b4566d55-0deb-11ea-91d3-b3e983305cb0")
    public List<cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.role.javamodel.IRoleSystemComponent> GetAllRoleSystemComponents();

    @IDynamicResourceExtension.MethodId("d55df488-19b9-11ea-bc72-af84f3c76c84")
    public cleon.architecturemethods.itarc42.metamodel.spec.deployment_view.environment.node.supplynode.javamodel.ISupplyNetDomainNode GetNetdomainWithAllowedToManage();
  ...
  public static interface IAbstractRootGroupsFunctions extends IDynamicResourceExtension {
    ...
    public cleon.architecturemethods.itarc42.metamodel.spec.deployment_view.environment.javamodel.IEnvironment GetEnvironment();
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,189e1c41-1e07-11e9-834d-77c41fccc6bf,beHYU7MkGk3OlmOzg/ZY96bg34o=] */
