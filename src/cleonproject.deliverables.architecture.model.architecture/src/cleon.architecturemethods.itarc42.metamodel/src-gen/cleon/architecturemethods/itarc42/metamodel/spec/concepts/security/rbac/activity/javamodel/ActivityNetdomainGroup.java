...
public class ActivityNetdomainGroup extends DynamicResource implements IActivityNetdomainGroup {
  ...
  @Override
  public java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.activity.javamodel.IActivitySystemConfiguration> selectActivitiesForSystemConfiguration() {
    return _getMap(cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.activity.javamodel.IActivitySystemConfiguration.class, cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.activity.ActivityPackage.ActivityNetdomainGroup_activitiesForSystemConfiguration);
  }

  public ActivityNetdomainGroup setActivitiesForSystemConfiguration(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.activity.javamodel.IActivitySystemConfiguration> activitiesForSystemConfiguration) {
    _setMap(cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.activity.ActivityPackage.ActivityNetdomainGroup_activitiesForSystemConfiguration, activitiesForSystemConfiguration);
    return this;
  }
  ...
  public ActivityNetdomainGroup setGroups(java.util.List<? extends cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.javamodel.IAbstractGroup> groups) {
  ...
  public ActivityNetdomainGroup setNetdomain(cleon.architecturemethods.itarc42.metamodel.spec.deployment_view.environment.node.supplynode.javamodel.ISupplyNetDomainNode netdomain) {
  ...
  public ActivityNetdomainGroup setSecurityGroups(java.util.List<? extends cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.javamodel.IAbstractSecurityGroups> securityGroups) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    // relations
    _acceptMap(cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.activity.javamodel.IActivitySystemConfiguration.class, cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.activity.ActivityPackage.ActivityNetdomainGroup_activitiesForSystemConfiguration, visitor);
  ...
  public static cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.activity.javamodel.IActivityNetdomainGroup selectToMeActivitiesForSystemConfiguration(cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.activity.javamodel.IActivitySystemConfiguration object) {
    return _getToMeSingle(object.getRepository(), cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.activity.javamodel.IActivityNetdomainGroup.class, cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.activity.ActivityPackage.ActivityNetdomainGroup_activitiesForSystemConfiguration, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,e3611bf2-1e06-11e9-834d-77c41fccc6bf,ojnFn1qP5I4m48Ckd43o0Ne1h7M=] */
