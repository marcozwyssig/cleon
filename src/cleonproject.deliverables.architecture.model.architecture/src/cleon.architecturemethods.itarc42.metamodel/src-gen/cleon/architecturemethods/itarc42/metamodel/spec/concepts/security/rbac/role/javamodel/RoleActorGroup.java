...
public class RoleActorGroup extends DynamicResource implements IRoleActorGroup {
  ...
  public java.lang.String selectRoleDescription() {
    return _getSingleAttribute(java.lang.String.class, cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.role.RolePackage.RoleActorGroup_roleDescription);
  }
    
  public void setRoleDescription(java.lang.String roleDescription) {
     _setSingleAttribute(cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.role.RolePackage.RoleActorGroup_roleDescription, roleDescription);
  }
  ...
  public cleon.architecturemethods.arc42.metamodel.spec._03_system_scope_and_context.domain.javamodel.IActor selectActor() {
    return _getSingle(cleon.architecturemethods.arc42.metamodel.spec._03_system_scope_and_context.domain.javamodel.IActor.class, cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.role.RolePackage.RoleActorGroup_actor);
  }
  ...
  public RoleActorGroup setActor(cleon.architecturemethods.arc42.metamodel.spec._03_system_scope_and_context.domain.javamodel.IActor actor) {
    _setSingle(cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.role.RolePackage.RoleActorGroup_actor, actor);
    return this;
  }
  ...
  public RoleActorGroup setGroups(java.util.List<? extends cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.javamodel.IAbstractGroup> groups) {
  ...
  @Override
  public java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.role.javamodel.IRoleActorResponsibility> selectRoleActorResponsibilities() {
    return _getMap(cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.role.javamodel.IRoleActorResponsibility.class, cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.role.RolePackage.RoleActorGroup_roleActorResponsibilities);
  }

  public RoleActorGroup setRoleActorResponsibilities(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.role.javamodel.IRoleActorResponsibility> roleActorResponsibilities) {
    _setMap(cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.role.RolePackage.RoleActorGroup_roleActorResponsibilities, roleActorResponsibilities);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingleAttribute(java.lang.String.class, cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.role.RolePackage.RoleActorGroup_roleDescription, visitor);
    // relations
    _acceptSingle(cleon.architecturemethods.arc42.metamodel.spec._03_system_scope_and_context.domain.javamodel.IActor.class, cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.role.RolePackage.RoleActorGroup_actor, visitor);
    ...
    _acceptMap(cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.role.javamodel.IRoleActorResponsibility.class, cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.role.RolePackage.RoleActorGroup_roleActorResponsibilities, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

  // toMeRelations
  
  public static java.util.List<cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.role.javamodel.IRoleActorGroup> selectToMeActor(cleon.architecturemethods.arc42.metamodel.spec._03_system_scope_and_context.domain.javamodel.IActor object) {
    return _getToMeList(object.getRepository(), cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.role.javamodel.IRoleActorGroup.class, cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.role.RolePackage.RoleActorGroup_actor, object.getResource());
  }
  
  public static cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.role.javamodel.IRoleActorGroup selectToMeRoleActorResponsibilities(cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.role.javamodel.IRoleActorResponsibility object) {
    return _getToMeSingle(object.getRepository(), cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.role.javamodel.IRoleActorGroup.class, cleon.architecturemethods.itarc42.metamodel.spec.concepts.security.rbac.role.RolePackage.RoleActorGroup_roleActorResponsibilities, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,88193678-1d9f-11e9-b601-db75aa6f89a4,ZnxZD67zABlR4Xnzqn4gPqxSqtQ=] */
