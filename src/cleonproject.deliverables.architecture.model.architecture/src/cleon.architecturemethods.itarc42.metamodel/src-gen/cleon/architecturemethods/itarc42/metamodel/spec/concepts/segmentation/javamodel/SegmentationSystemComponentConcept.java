...
public class SegmentationSystemComponentConcept extends DynamicResource implements ISegmentationSystemComponentConcept {
  ...
  public java.util.List<? extends cleon.modelinglanguages.network.metamodel.spec.javamodel.ISecurityZone> selectSecurityZones() {
    return _getList(cleon.modelinglanguages.network.metamodel.spec.javamodel.ISecurityZone.class, cleon.architecturemethods.itarc42.metamodel.spec.concepts.segmentation.SegmentationPackage.SegmentationSystemComponentConcept_securityZones);
  }
  ...
  public SegmentationSystemComponentConcept setSecurityZones(java.util.List<? extends cleon.modelinglanguages.network.metamodel.spec.javamodel.ISecurityZone> securityZones) {
    _setList(cleon.architecturemethods.itarc42.metamodel.spec.concepts.segmentation.SegmentationPackage.SegmentationSystemComponentConcept_securityZones, securityZones);
    return this;
  }
  ...
  public cleon.architecturemethods.itarc42.metamodel.spec.buildingblock_view.javamodel.ISystemComponent selectSystemComponent() {
    return _getSingle(cleon.architecturemethods.itarc42.metamodel.spec.buildingblock_view.javamodel.ISystemComponent.class, cleon.architecturemethods.itarc42.metamodel.spec.concepts.ConceptsPackage.SystemComponentConcept_systemComponent);
  }

  public SegmentationSystemComponentConcept setSystemComponent(cleon.architecturemethods.itarc42.metamodel.spec.buildingblock_view.javamodel.ISystemComponent systemComponent) {
    _setSingle(cleon.architecturemethods.itarc42.metamodel.spec.concepts.ConceptsPackage.SystemComponentConcept_systemComponent, systemComponent);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptList(cleon.modelinglanguages.network.metamodel.spec.javamodel.ISecurityZone.class, cleon.architecturemethods.itarc42.metamodel.spec.concepts.segmentation.SegmentationPackage.SegmentationSystemComponentConcept_securityZones, visitor);
    _acceptSingle(cleon.architecturemethods.itarc42.metamodel.spec.buildingblock_view.javamodel.ISystemComponent.class, cleon.architecturemethods.itarc42.metamodel.spec.concepts.ConceptsPackage.SystemComponentConcept_systemComponent, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

  // toMeRelations
  
  public static java.util.List<cleon.architecturemethods.itarc42.metamodel.spec.concepts.segmentation.javamodel.ISegmentationSystemComponentConcept> selectToMeSecurityZones(cleon.modelinglanguages.network.metamodel.spec.javamodel.ISecurityZone object) {
    return _getToMeList(object.getRepository(), cleon.architecturemethods.itarc42.metamodel.spec.concepts.segmentation.javamodel.ISegmentationSystemComponentConcept.class, cleon.architecturemethods.itarc42.metamodel.spec.concepts.segmentation.SegmentationPackage.SegmentationSystemComponentConcept_securityZones, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,19f5852a-4b23-11e9-8338-41c203971ecb,FbBPTIMsR1S5hR6VUjpq8zwHxrw=] */
