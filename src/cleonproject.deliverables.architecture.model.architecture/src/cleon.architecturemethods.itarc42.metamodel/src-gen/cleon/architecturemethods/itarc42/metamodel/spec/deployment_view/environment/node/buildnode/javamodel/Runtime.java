...
public class Runtime extends DynamicResource implements IRuntime {
  ...
  public boolean isPhysical() {
    return getResource().equals(cleon.architecturemethods.itarc42.metamodel.spec.deployment_view.environment.node.buildnode.BuildnodePackage.Runtime_Physical);
  }
  
  @Override
  public boolean isVirtual() {
    return getResource().equals(cleon.architecturemethods.itarc42.metamodel.spec.deployment_view.environment.node.buildnode.BuildnodePackage.Runtime_Virtual);
  }
  
  @Override
  public boolean isContainer() {
    return getResource().equals(cleon.architecturemethods.itarc42.metamodel.spec.deployment_view.environment.node.buildnode.BuildnodePackage.Runtime_Container);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,8a0ef5c9-1bfe-11e9-9896-651e5faa32a4,hFWFlVr0WD1hZ+gAuQnm5/nsg9U=] */
