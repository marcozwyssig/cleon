...
public class ServiceBuildNode extends DynamicResource implements IServiceBuildNode {
  ...
  public ServiceBuildNode setBuildNodes(java.util.List<? extends cleon.architecturemethods.itarc42.metamodel.spec.deployment_view.environment.node.buildnode.javamodel.IBuildNode> buildNodes) {
  ...
  public ServiceBuildNode setCpu(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.itarc42.metamodel.spec.deployment_view.environment.node.buildnode.machineconfiguration.javamodel.ICPU_Configuration> cpu) {
  ...
  public ServiceBuildNode setDisk(IMultiMapOrdered<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.itarc42.metamodel.spec.deployment_view.environment.node.buildnode.machineconfiguration.javamodel.IDisk_Configuration> disk) {
  ...
  public ServiceBuildNode setMemory(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.itarc42.metamodel.spec.deployment_view.environment.node.buildnode.machineconfiguration.javamodel.IMemory_Configuration> memory) {
  ...
  public ServiceBuildNode setNodes(java.util.List<? extends cleon.architecturemethods.itarc42.metamodel.spec.deployment_view.environment.node.javamodel.INode> nodes) {
  ...
  public ServiceBuildNode setSuppliedNodes(java.util.List<? extends cleon.architecturemethods.itarc42.metamodel.spec.deployment_view.environment.node.supplynode.javamodel.ISupplyNode> suppliedNodes) {
  ...
  public ServiceBuildNode setSystemConfiguration(cleon.architecturemethods.itarc42.metamodel.spec.buildingblock_view.javamodel.ISystemConfiguration systemConfiguration) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,1c72395a-02d8-11e9-9e58-33d596257b14,vxkq+xCA86uo8VioozMEHZ3gtYo=] */
