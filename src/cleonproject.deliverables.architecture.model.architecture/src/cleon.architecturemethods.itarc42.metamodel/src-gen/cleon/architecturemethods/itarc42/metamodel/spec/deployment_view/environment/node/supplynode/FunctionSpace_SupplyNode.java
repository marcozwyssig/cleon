package cleon.architecturemethods.itarc42.metamodel.spec.deployment_view.environment.node.supplynode;
...
public class FunctionSpace_SupplyNode {
  ...
  public static interface ISupplyNetDomainNodeFunctions extends IDynamicResourceExtension {
    ...
    public List<cleon.architecturemethods.itarc42.metamodel.spec.deployment_view.environment.node.supplynode.javamodel.ISupplyNetDomainNode> GetAllAllowedManage();
  ...
  public static interface ISupplyNodeFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("74e81056-2aba-11e9-a3f8-336d9e792e17")
    public java.lang.Boolean IsSupplied(final cleon.architecturemethods.itarc42.metamodel.spec.deployment_view.environment.node.supplynode.javamodel.ISupplyNode supplyNode);
  ...
  public static class SupplyNodeFunctions {
    ...
    public static java.lang.Boolean IsSupplied(final cleon.architecturemethods.itarc42.metamodel.spec.deployment_view.environment.node.supplynode.javamodel.ISupplyNode supplyNode) {
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,7d0236d1-0b7f-11e9-a136-69d076e48ed1,hFhWiMoI1jrdksvdvWcrdtSi96M=] */
