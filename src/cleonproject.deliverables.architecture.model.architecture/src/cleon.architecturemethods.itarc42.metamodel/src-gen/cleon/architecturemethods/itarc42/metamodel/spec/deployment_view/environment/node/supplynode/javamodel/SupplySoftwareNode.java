...
public class SupplySoftwareNode extends DynamicResource implements ISupplySoftwareNode {
  ...
  public java.lang.String selectType() {
    return _getSingleAttribute(java.lang.String.class, cleon.architecturemethods.itarc42.metamodel.spec.deployment_view.environment.node.supplynode.SupplynodePackage.SupplySoftwareNode_type);
  }
    
  public void setType(java.lang.String type) {
     _setSingleAttribute(cleon.architecturemethods.itarc42.metamodel.spec.deployment_view.environment.node.supplynode.SupplynodePackage.SupplySoftwareNode_type, type);
  }
  ...
  public SupplySoftwareNode setBuildNodes(java.util.List<? extends cleon.architecturemethods.itarc42.metamodel.spec.deployment_view.environment.node.buildnode.javamodel.IBuildNode> buildNodes) {
  ...
  public SupplySoftwareNode setNodes(java.util.List<? extends cleon.architecturemethods.itarc42.metamodel.spec.deployment_view.environment.node.javamodel.INode> nodes) {
  ...
  public SupplySoftwareNode setSuppliedNodes(java.util.List<? extends cleon.architecturemethods.itarc42.metamodel.spec.deployment_view.environment.node.supplynode.javamodel.ISupplyNode> suppliedNodes) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingleAttribute(java.lang.String.class, cleon.architecturemethods.itarc42.metamodel.spec.deployment_view.environment.node.supplynode.SupplynodePackage.SupplySoftwareNode_type, visitor);
    // relations
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,11345063-0c32-11e9-83ba-4d57b06560a2,bdOQMGOsI8nctFtWOzPwCbO5QJ8=] */
