...
public class DeploymentDiagram extends DynamicResource implements IDeploymentDiagram {
  ...
  public java.lang.Boolean selectOnlyOneLayer() {
    return _getSingleAttribute(java.lang.Boolean.class, cleon.architecturemethods.itarc42.metamodel.spec.diagram.DiagramPackage.DeploymentDiagram_onlyOneLayer);
  }
    
  public void setOnlyOneLayer(java.lang.Boolean onlyOneLayer) {
     _setSingleAttribute(cleon.architecturemethods.itarc42.metamodel.spec.diagram.DiagramPackage.DeploymentDiagram_onlyOneLayer, onlyOneLayer);
  }
  ...
  public java.lang.Boolean selectRenderHidden() {
    return _getSingleAttribute(java.lang.Boolean.class, cleon.architecturemethods.itarc42.metamodel.spec.diagram.DiagramPackage.DeploymentDiagram_renderHidden);
  }
    
  public void setRenderHidden(java.lang.Boolean renderHidden) {
     _setSingleAttribute(cleon.architecturemethods.itarc42.metamodel.spec.diagram.DiagramPackage.DeploymentDiagram_renderHidden, renderHidden);
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingleAttribute(java.lang.Boolean.class, cleon.architecturemethods.itarc42.metamodel.spec.diagram.DiagramPackage.DeploymentDiagram_onlyOneLayer, visitor);
    ...
    _acceptSingleAttribute(java.lang.Boolean.class, cleon.architecturemethods.itarc42.metamodel.spec.diagram.DiagramPackage.DeploymentDiagram_renderHidden, visitor);
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,1cf628c3-0aa0-11e9-8a91-633e556ac68f,il+Kjay7Kj1lnX+95HPRzXCGzeI=] */
