...
import cleon.architecturemethods.itarc42.metamodel.spec.deployment_view.environment.node.javamodel.INode;
...
public class FunctionSpace_Deployment_Plantuml {
  ...
  public static interface IDeploymentDiagramFunctions extends IDynamicResourceExtension {
    ...
    public cleon.architecturemethods.itarc42.metamodel.spec.deployment_view.environment.node.javamodel.INode GetNode();
  ...
  public static interface IDeploymentDiagramFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("d316009e-0eb3-11e9-9f19-6d15636f4ecc")
    public java.lang.Boolean onlyOneLayer(final cleon.architecturemethods.itarc42.metamodel.spec.diagram.javamodel.IDeploymentDiagram deploymentDiagram);

    @IDynamicResourceExtension.MethodId("c044124c-1977-11e9-b3a0-d155f11f9df1")
    public java.lang.Boolean leftToRight(final cleon.architecturemethods.itarc42.metamodel.spec.diagram.javamodel.IDeploymentDiagram deploymentDiagram);

    @IDynamicResourceExtension.MethodId("5104adea-1980-11e9-88a0-1f786f12e4c1")
    public java.lang.Boolean renderHidden(final cleon.architecturemethods.itarc42.metamodel.spec.diagram.javamodel.IDeploymentDiagram deploymentDiagram);
  ...
  public static class DeploymentDiagramFunctions {
    ...
    public static java.lang.Boolean onlyOneLayer(final cleon.architecturemethods.itarc42.metamodel.spec.diagram.javamodel.IDeploymentDiagram deploymentDiagram) {
    ...
    public static java.lang.Boolean leftToRight(final cleon.architecturemethods.itarc42.metamodel.spec.diagram.javamodel.IDeploymentDiagram deploymentDiagram) {
    ...
    public static java.lang.Boolean renderHidden(final cleon.architecturemethods.itarc42.metamodel.spec.diagram.javamodel.IDeploymentDiagram deploymentDiagram) {
  ...
  public static interface INodeFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("5254da7b-18e9-11e9-84df-097eeec74d2d")
    public java.lang.String RenderHidden(final List<cleon.architecturemethods.itarc42.metamodel.spec.deployment_view.environment.node.javamodel.INode> nodeList);
  ...
  public static class NodeFunctions {
    ...
    public static java.lang.String RenderHidden(final List<cleon.architecturemethods.itarc42.metamodel.spec.deployment_view.environment.node.javamodel.INode> nodeList) {
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,3aa83cb8-0aa0-11e9-8a91-633e556ac68f,jgFtdVE2i6/0fjKAut8AUSa03g0=] */
