...
public class Server extends DynamicResource implements IServer {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<IServer> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<IServer>() {
    ...
    @Override
    public IServer create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new Server(resourceRepository, resource);
    }
  
  };

  public Server() {
    super(IServer.TYPE_ID);
  }
  
  public Server(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
    super(resourceRepository, resource, IServer.TYPE_ID);
  }
  ...
  public Server setDecompose(java.util.List<? extends cleon.common.modularity.spec.buildingblock.javamodel.IDecomposite> decompose) {
  ...
  public Server setDecomposePackages(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.packages.javamodel.IPackageDecomposition> decomposePackages) {
  ...
  public Server setHasDependency(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.components.javamodel.IComponentDependency> hasDependency) {
  ...
  public Server setNoPackages(cleon.modelinglanguages.uml.spec.uml2.structural.packages.javamodel.IPackageDecomposition noPackages) {
  ...
  public Server setProduct(cleon.architecturemethods.itarc42.spec.itarc42._12_ProductView.javamodel.IProduct product) {
  ...
  public Server setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,0bcbb0c6-d0b0-11e8-b005-f7630e4c29c0,Ie7Arv/GFDwMwiJlZgvwMm9fZb4=] */
