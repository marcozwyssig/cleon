...
public class Storage extends DynamicResource implements IStorage {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<IStorage> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<IStorage>() {
    ...
    @Override
    public IStorage create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new Storage(resourceRepository, resource);
    }
  
  };

  public Storage() {
    super(IStorage.TYPE_ID);
  }
  
  public Storage(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
    super(resourceRepository, resource, IStorage.TYPE_ID);
  }
  ...
  public Storage setDecompose(java.util.List<? extends cleon.common.modularity.spec.buildingblock.javamodel.IDecomposite> decompose) {
  ...
  public Storage setDecomposePackages(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.packages.javamodel.IPackageDecomposition> decomposePackages) {
  ...
  public Storage setHasDependency(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.components.javamodel.IComponentDependency> hasDependency) {
  ...
  public Storage setNoPackages(cleon.modelinglanguages.uml.spec.uml2.structural.packages.javamodel.IPackageDecomposition noPackages) {
  ...
  public Storage setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
