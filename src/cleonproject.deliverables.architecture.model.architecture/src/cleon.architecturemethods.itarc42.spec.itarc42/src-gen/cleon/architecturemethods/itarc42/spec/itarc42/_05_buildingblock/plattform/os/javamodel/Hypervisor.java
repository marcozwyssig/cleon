...
public class Hypervisor extends DynamicResource implements IHypervisor {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<IHypervisor> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<IHypervisor>() {
    
    @Override
    public IHypervisor create() {
      return new Hypervisor();
    }
    
    @Override
    public IHypervisor create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new Hypervisor(resourceRepository, resource);
    }
  
  };

  public Hypervisor() {
    super(IHypervisor.TYPE_ID);
  }
  
  public Hypervisor(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
    super(resourceRepository, resource, IHypervisor.TYPE_ID);
  }
  ...
  public Hypervisor setDecompose(java.util.List<? extends cleon.common.modularity.spec.buildingblock.javamodel.IDecomposite> decompose) {
  ...
  public Hypervisor setDecomposePackages(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.packages.javamodel.IPackageDecomposition> decomposePackages) {
  ...
  public Hypervisor setHasDependency(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.components.javamodel.IComponentDependency> hasDependency) {
  ...
  public Hypervisor setNoPackages(cleon.modelinglanguages.uml.spec.uml2.structural.packages.javamodel.IPackageDecomposition noPackages) {
  ...
  public Hypervisor setProduct(cleon.architecturemethods.itarc42.spec.itarc42._12_ProductView.javamodel.IProduct product) {
  ...
  public Hypervisor setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,99650610-d0b6-11e8-b005-f7630e4c29c0,nWv5e/T8yUITvQZurysKjrTguag=] */
