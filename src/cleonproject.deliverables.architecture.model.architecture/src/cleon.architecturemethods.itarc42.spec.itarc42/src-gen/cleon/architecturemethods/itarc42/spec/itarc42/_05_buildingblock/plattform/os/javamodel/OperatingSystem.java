...
public class OperatingSystem extends DynamicResource implements IOperatingSystem {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<IOperatingSystem> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<IOperatingSystem>() {
    
    @Override
    public IOperatingSystem create() {
      return new OperatingSystem();
    }
    
    @Override
    public IOperatingSystem create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new OperatingSystem(resourceRepository, resource);
    }
  
  };

  public OperatingSystem() {
    super(IOperatingSystem.TYPE_ID);
  }
  
  public OperatingSystem(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
    super(resourceRepository, resource, IOperatingSystem.TYPE_ID);
  }
  ...
  public OperatingSystem setDecompose(java.util.List<? extends cleon.common.modularity.spec.buildingblock.javamodel.IDecomposite> decompose) {
  ...
  public OperatingSystem setDecomposePackages(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.packages.javamodel.IPackageDecomposition> decomposePackages) {
  ...
  public OperatingSystem setHasDependency(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.components.javamodel.IComponentDependency> hasDependency) {
  ...
  public OperatingSystem setNoPackages(cleon.modelinglanguages.uml.spec.uml2.structural.packages.javamodel.IPackageDecomposition noPackages) {
  ...
  public OperatingSystem setProduct(cleon.architecturemethods.itarc42.spec.itarc42._12_ProductView.javamodel.IProduct product) {
  ...
  public OperatingSystem setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,afd3ab65-d0b6-11e8-b005-f7630e4c29c0,uiZqhKx2pX8LzxpidEG81MfoJ0E=] */
