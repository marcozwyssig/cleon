...
public class NamedSystemComponent extends DynamicResource implements INamedSystemComponent {
  ...
  public NamedSystemComponent setDecomposeSystemConfiguration(java.util.List<? extends cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.javamodel.ISystemConfigurationDecomposite> decomposeSystemConfiguration) {
  ...
  public NamedSystemComponent setHasDependency(java.util.List<? extends cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.javamodel.ISystemComponentDependency> hasDependency) {
  ...
  public NamedSystemComponent setInteracts(java.util.List<? extends cleon.common.modularity.spec.buildingblock.javamodel.IInteraction> interacts) {
  ...
  public NamedSystemComponent setPorts_In(IMultiMapOrdered<ch.actifsource.core.Resource, ? extends cleon.modelinglanguages.uml.spec.uml2.structural.components.ports.javamodel.IPort_Required> ports_In) {
  ...
  public NamedSystemComponent setPorts_Out(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.components.ports.javamodel.IPort_Provider> ports_Out) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,91ada0b6-35f7-11e9-9d58-25409887bb2a,FXb9FiaI4clTAMhqZSxWVPHcekQ=] */
