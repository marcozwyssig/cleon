...
public class System extends DynamicResource implements ISystem {
  ...
  public System setDecomposeComponent(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.components.javamodel.IComponentCompositionDecomposite> decomposeComponent) {
  ...
  @Override
  public java.util.List<? extends cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.javamodel.ILayerDecomposite> selectDecomposeLayer() {
    return _getList(cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.javamodel.ILayerDecomposite.class, cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view._05_buildingblock_viewPackage.System_decomposeLayer);
  }

  public System setDecomposeLayer(java.util.List<? extends cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.javamodel.ILayerDecomposite> decomposeLayer) {
    _setList(cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view._05_buildingblock_viewPackage.System_decomposeLayer, decomposeLayer);
    return this;
  }
  ...
  public System setHasDependency(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.components.javamodel.IComponentCompositionDependency> hasDependency) {
  ...
  public System setInteracts(java.util.List<? extends cleon.common.modularity.spec.buildingblock.javamodel.IInteraction> interacts) {
  ...
  public System setPorts_In(IMultiMapOrdered<ch.actifsource.core.Resource, ? extends cleon.modelinglanguages.uml.spec.uml2.structural.components.ports.javamodel.IPort_Required> ports_In) {
  ...
  public System setPorts_Out(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.components.ports.javamodel.IPort_Provider> ports_Out) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptList(cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.javamodel.ILayerDecomposite.class, cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view._05_buildingblock_viewPackage.System_decomposeLayer, visitor);
  ...
  public static cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.javamodel.ISystem selectToMeDecomposeLayer(cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.javamodel.ILayerDecomposite object) {
    return _getToMeSingle(object.getRepository(), cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.javamodel.ISystem.class, cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view._05_buildingblock_viewPackage.System_decomposeLayer, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,d6859a6c-99aa-11e8-8f58-219af2c5d6d9,+fX3ypT4S/RKqONp7WyCJwh5skM=] */
