...
public class SystemLayer extends DynamicResource implements ISystemLayer {
  ...
  @Override
  public java.util.List<? extends cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.javamodel.ISystemComponentDecomposite> selectDecomposeSystemComponent() {
    return _getList(cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.javamodel.ISystemComponentDecomposite.class, cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view._05_buildingblock_viewPackage.SystemLayer_decomposeSystemComponent);
  }

  public SystemLayer setDecomposeSystemComponent(java.util.List<? extends cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.javamodel.ISystemComponentDecomposite> decomposeSystemComponent) {
    _setList(cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view._05_buildingblock_viewPackage.SystemLayer_decomposeSystemComponent, decomposeSystemComponent);
    return this;
  }
    
  @Override
  public java.util.List<? extends cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.javamodel.ISystemLayerDependency> selectHasDependency() {
    return _getList(cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.javamodel.ISystemLayerDependency.class, cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view._05_buildingblock_viewPackage.SystemLayer_hasDependency);
  }

  public SystemLayer setHasDependency(java.util.List<? extends cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.javamodel.ISystemLayerDependency> hasDependency) {
    _setList(cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view._05_buildingblock_viewPackage.SystemLayer_hasDependency, hasDependency);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptList(cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.javamodel.ISystemComponentDecomposite.class, cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view._05_buildingblock_viewPackage.SystemLayer_decomposeSystemComponent, visitor);
    _acceptList(cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.javamodel.ISystemLayerDependency.class, cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view._05_buildingblock_viewPackage.SystemLayer_hasDependency, visitor);
  ...
  public static cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.javamodel.ISystemLayer selectToMeDecomposeSystemComponent(cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.javamodel.ISystemComponentDecomposite object) {
    return _getToMeSingle(object.getRepository(), cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.javamodel.ISystemLayer.class, cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view._05_buildingblock_viewPackage.SystemLayer_decomposeSystemComponent, object.getResource());
  }
  
  public static cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.javamodel.ISystemLayer selectToMeHasDependency(cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.javamodel.ISystemLayerDependency object) {
    return _getToMeSingle(object.getRepository(), cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.javamodel.ISystemLayer.class, cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view._05_buildingblock_viewPackage.SystemLayer_hasDependency, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,b894901a-d0b2-11e8-b005-f7630e4c29c0,dIUerkJhpGn7uOlw4yLg+9Wuvsc=] */
