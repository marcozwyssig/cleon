...
public class KontronServerSystemConfiguration extends DynamicResource implements IKontronServerSystemConfiguration {
  ...
  @Override
  public java.util.List<? extends cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.systemconfiguration.machinesystemconfiguration.javamodel.ICPU> selectCPUs() {
    return _getList(cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.systemconfiguration.machinesystemconfiguration.javamodel.ICPU.class, cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.systemconfiguration.machinesystemconfiguration.MachinesystemconfigurationPackage.MachineSystemConfiguration_cPUs);
  }

  public KontronServerSystemConfiguration setCPUs(java.util.List<? extends cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.systemconfiguration.machinesystemconfiguration.javamodel.ICPU> cPUs) {
    _setList(cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.systemconfiguration.machinesystemconfiguration.MachinesystemconfigurationPackage.MachineSystemConfiguration_cPUs, cPUs);
    return this;
  }
  ...
  public KontronServerSystemConfiguration setDecompose(java.util.List<? extends cleon.common.modularity.spec.buildingblock.javamodel.IDecomposite> decompose) {
  ...
  public KontronServerSystemConfiguration setDecomposePackages(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.packages.javamodel.IPackageDecomposition> decomposePackages) {
  ...
  @Override
  public java.util.List<? extends cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.systemconfiguration.machinesystemconfiguration.javamodel.IDisk> selectDisks() {
    return _getList(cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.systemconfiguration.machinesystemconfiguration.javamodel.IDisk.class, cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.systemconfiguration.machinesystemconfiguration.MachinesystemconfigurationPackage.MachineSystemConfiguration_disks);
  }

  public KontronServerSystemConfiguration setDisks(java.util.List<? extends cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.systemconfiguration.machinesystemconfiguration.javamodel.IDisk> disks) {
    _setList(cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.systemconfiguration.machinesystemconfiguration.MachinesystemconfigurationPackage.MachineSystemConfiguration_disks, disks);
    return this;
  }
  ...
  public KontronServerSystemConfiguration setHasDependency(java.util.List<? extends cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.javamodel.ISystemConfigurationDependency> hasDependency) {
  ...
  public KontronServerSystemConfiguration setInteracts(java.util.List<? extends cleon.common.modularity.spec.buildingblock.javamodel.IInteraction> interacts) {
    _setList(cleon.common.modularity.spec.buildingblock.BuildingblockPackage.InteractiveBuildingBlock_interacts, interacts);
    return this;
  }
    
  @Override
  public java.util.List<? extends cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.systemconfiguration.machinesystemconfiguration.javamodel.IMemory> selectMemory() {
    return _getList(cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.systemconfiguration.machinesystemconfiguration.javamodel.IMemory.class, cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.systemconfiguration.machinesystemconfiguration.MachinesystemconfigurationPackage.MachineSystemConfiguration_memory);
  }

  public KontronServerSystemConfiguration setMemory(java.util.List<? extends cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.systemconfiguration.machinesystemconfiguration.javamodel.IMemory> memory) {
    _setList(cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.systemconfiguration.machinesystemconfiguration.MachinesystemconfigurationPackage.MachineSystemConfiguration_memory, memory);
    return this;
  }
  ...
  public KontronServerSystemConfiguration setNoPackages(cleon.modelinglanguages.uml.spec.uml2.structural.packages.javamodel.IPackageDecomposition noPackages) {
  ...
  public KontronServerSystemConfiguration setPorts_In(IMultiMapOrdered<ch.actifsource.core.Resource, ? extends cleon.modelinglanguages.uml.spec.uml2.structural.components.ports.javamodel.IPort_Required> ports_In) {
  ...
  public KontronServerSystemConfiguration setPorts_Out(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.components.ports.javamodel.IPort_Provider> ports_Out) {
  ...
  public KontronServerSystemConfiguration setUsingProducts(java.util.List<? extends cleon.architecturemethods.arc42.spec.arc42._13_product_view.javamodel.IProduct> usingProducts) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    // relations
    _acceptList(cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.systemconfiguration.machinesystemconfiguration.javamodel.ICPU.class, cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.systemconfiguration.machinesystemconfiguration.MachinesystemconfigurationPackage.MachineSystemConfiguration_cPUs, visitor);
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,69d06b0a-0295-11e9-9e58-33d596257b14,4nzKmwK2aVq17yWxH77kY98wMTI=] */
