...
public class RedhatSystemConfiguration extends DynamicResource implements IRedhatSystemConfiguration {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<IRedhatSystemConfiguration> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<IRedhatSystemConfiguration>() {
    
    @Override
    public IRedhatSystemConfiguration create() {
      return new RedhatSystemConfiguration();
    }
    
    @Override
    public IRedhatSystemConfiguration create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new RedhatSystemConfiguration(resourceRepository, resource);
    }
  
  };

  public RedhatSystemConfiguration() {
    super(IRedhatSystemConfiguration.TYPE_ID);
  }
  
  public RedhatSystemConfiguration(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
    super(resourceRepository, resource, IRedhatSystemConfiguration.TYPE_ID);
  }
  ...
  public RedhatSystemConfiguration setDecompose(java.util.List<? extends cleon.common.modularity.spec.buildingblock.javamodel.IDecomposite> decompose) {
  ...
  public RedhatSystemConfiguration setDecomposePackages(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.packages.javamodel.IPackageDecomposition> decomposePackages) {
  ...
  public RedhatSystemConfiguration setHasDependency(java.util.List<? extends cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.javamodel.ISystemConfigurationDependency> hasDependency) {
  ...
  public RedhatSystemConfiguration setInteracts(java.util.List<? extends cleon.common.modularity.spec.buildingblock.javamodel.IInteraction> interacts) {
  ...
  public RedhatSystemConfiguration setNoPackages(cleon.modelinglanguages.uml.spec.uml2.structural.packages.javamodel.IPackageDecomposition noPackages) {
  ...
  public RedhatSystemConfiguration setPorts_In(IMultiMapOrdered<ch.actifsource.core.Resource, ? extends cleon.modelinglanguages.uml.spec.uml2.structural.components.ports.javamodel.IPort_Required> ports_In) {
  ...
  public RedhatSystemConfiguration setPorts_Out(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.components.ports.javamodel.IPort_Provider> ports_Out) {
  ...
  public RedhatSystemConfiguration setRuntime(cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.systemconfiguration.javamodel.IRuntime runtime) {
  ...
  public RedhatSystemConfiguration setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
  ...
  public RedhatSystemConfiguration setUsingProducts(java.util.List<? extends cleon.architecturemethods.arc42.spec.arc42._13_product_view.javamodel.IProduct> usingProducts) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,d29cf9f6-0c3a-11e9-83ba-4d57b06560a2,GwR3EwWQM9P2LKeE36zpqXLB3do=] */
