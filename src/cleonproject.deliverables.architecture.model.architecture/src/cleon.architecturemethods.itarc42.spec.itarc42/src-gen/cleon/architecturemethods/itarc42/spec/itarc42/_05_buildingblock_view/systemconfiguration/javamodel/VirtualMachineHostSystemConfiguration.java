...
public class VirtualMachineHostSystemConfiguration extends DynamicResource implements IVirtualMachineHostSystemConfiguration {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<IVirtualMachineHostSystemConfiguration> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<IVirtualMachineHostSystemConfiguration>() {
    
    @Override
    public IVirtualMachineHostSystemConfiguration create() {
      return new VirtualMachineHostSystemConfiguration();
    }
    
    @Override
    public IVirtualMachineHostSystemConfiguration create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new VirtualMachineHostSystemConfiguration(resourceRepository, resource);
    }
  
  };

  public VirtualMachineHostSystemConfiguration() {
    super(IVirtualMachineHostSystemConfiguration.TYPE_ID);
  }
  
  public VirtualMachineHostSystemConfiguration(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
    super(resourceRepository, resource, IVirtualMachineHostSystemConfiguration.TYPE_ID);
  }
  ...
  public VirtualMachineHostSystemConfiguration setDecompose(java.util.List<? extends cleon.common.modularity.spec.buildingblock.javamodel.IDecomposite> decompose) {
  ...
  public VirtualMachineHostSystemConfiguration setDecomposePackages(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.packages.javamodel.IPackageDecomposition> decomposePackages) {
  ...
  public VirtualMachineHostSystemConfiguration setHasDependency(java.util.List<? extends cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.javamodel.ISystemConfigurationDependency> hasDependency) {
  ...
  public VirtualMachineHostSystemConfiguration setInteracts(java.util.List<? extends cleon.common.modularity.spec.buildingblock.javamodel.IInteraction> interacts) {
  ...
  public VirtualMachineHostSystemConfiguration setNoPackages(cleon.modelinglanguages.uml.spec.uml2.structural.packages.javamodel.IPackageDecomposition noPackages) {
  ...
  public VirtualMachineHostSystemConfiguration setPorts_In(IMultiMapOrdered<ch.actifsource.core.Resource, ? extends cleon.modelinglanguages.uml.spec.uml2.structural.components.ports.javamodel.IPort_Required> ports_In) {
  ...
  public VirtualMachineHostSystemConfiguration setPorts_Out(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.components.ports.javamodel.IPort_Provider> ports_Out) {
  ...
  @Override
  public cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.systemconfiguration.javamodel.IRuntime selectRuntime() {
    return _getSingle(cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.systemconfiguration.javamodel.IRuntime.class, cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.systemconfiguration.SystemconfigurationPackage.OperatingSystemConfiguration_runtime);
  }

  public VirtualMachineHostSystemConfiguration setRuntime(cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.systemconfiguration.javamodel.IRuntime runtime) {
    _setSingle(cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.systemconfiguration.SystemconfigurationPackage.OperatingSystemConfiguration_runtime, runtime);
    return this;
  }
  ...
  public VirtualMachineHostSystemConfiguration setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
  ...
  public VirtualMachineHostSystemConfiguration setUsingProducts(java.util.List<? extends cleon.architecturemethods.arc42.spec.arc42._13_product_view.javamodel.IProduct> usingProducts) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.systemconfiguration.javamodel.IRuntime.class, cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.systemconfiguration.SystemconfigurationPackage.OperatingSystemConfiguration_runtime, visitor);
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,7f075e62-0296-11e9-9e58-33d596257b14,+4ni0wvARIJ1eT0bOJfFdb9HKMc=] */
