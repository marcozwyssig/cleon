...
public class DiskType extends DynamicResource implements IDiskType {
  ...
  public boolean isSDD() {
    return getResource().equals(cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.systemconfiguration.machinesystemconfiguration.MachinesystemconfigurationPackage.DiskType_SDD);
  }
  
  @Override
  public boolean isHDD() {
    return getResource().equals(cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.systemconfiguration.machinesystemconfiguration.MachinesystemconfigurationPackage.DiskType_HDD);
  }
  
  @Override
  public boolean isVMDK__F___S___F_Thin__F_Provisioning() {
    return getResource().equals(cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock_view.systemconfiguration.machinesystemconfiguration.MachinesystemconfigurationPackage.DiskType_VMDK__F___S___F_Thin__F_Provisioning);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,00c36073-2b6b-11e9-90eb-451204ee9d3c,s9qUtCtZb3iZw8njzzJbG/UK3oU=] */
