...
public class BackupConfiguration extends DynamicResource implements IBackupConfiguration {
  ...
  public boolean isNone() {
    return getResource().equals(cleon.architecturemethods.itarc42.spec.itarc42._08_concepts.businesscontinuity.backup.BackupPackage.BackupConfiguration_None);
  }
  
  @Override
  public boolean isVM() {
    return getResource().equals(cleon.architecturemethods.itarc42.spec.itarc42._08_concepts.businesscontinuity.backup.BackupPackage.BackupConfiguration_VM);
  }
  
  @Override
  public boolean isWindows() {
    return getResource().equals(cleon.architecturemethods.itarc42.spec.itarc42._08_concepts.businesscontinuity.backup.BackupPackage.BackupConfiguration_Windows);
  }
  
  @Override
  public boolean isSQL__F_Server() {
    return getResource().equals(cleon.architecturemethods.itarc42.spec.itarc42._08_concepts.businesscontinuity.backup.BackupPackage.BackupConfiguration_SQL__F_Server);
  }
  
  @Override
  public boolean isActive__F_Directory() {
    return getResource().equals(cleon.architecturemethods.itarc42.spec.itarc42._08_concepts.businesscontinuity.backup.BackupPackage.BackupConfiguration_Active__F_Directory);
  }
  
  @Override
  public boolean isExchange() {
    return getResource().equals(cleon.architecturemethods.itarc42.spec.itarc42._08_concepts.businesscontinuity.backup.BackupPackage.BackupConfiguration_Exchange);
  }
  
  @Override
  public boolean isDatenablage() {
    return getResource().equals(cleon.architecturemethods.itarc42.spec.itarc42._08_concepts.businesscontinuity.backup.BackupPackage.BackupConfiguration_Datenablage);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,0713be48-1e42-11e9-865e-41ef48a95f70,t+FnI5i/zHWZ6lrtNtZLp1JaqLI=] */
