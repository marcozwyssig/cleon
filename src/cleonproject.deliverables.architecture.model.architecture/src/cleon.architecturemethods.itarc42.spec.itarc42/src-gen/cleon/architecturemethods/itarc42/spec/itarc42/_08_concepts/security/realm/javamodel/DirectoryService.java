package cleon.architecturemethods.itarc42.spec.itarc42._08_concepts.security.realm.javamodel;
...
public class DirectoryService extends DynamicResource implements IDirectoryService {
  ...
  public DirectoryService setChapters(java.util.List<? extends cleon.common.doc.spec.doc.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public DirectoryService setDocumentElements(java.util.List<? extends cleon.common.doc.spec.doc.javamodel.IDocumentElement> documentElements) {
  ...
  public DirectoryService setParagraphs(java.util.List<? extends cleon.common.doc.spec.doc.paragraph.javamodel.IParagraph> paragraphs) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,ebac8bd2-0eaf-11e9-9f19-6d15636f4ecc,lgEzlnInNjGzNxJr0bZv2agSjOQ=] */
