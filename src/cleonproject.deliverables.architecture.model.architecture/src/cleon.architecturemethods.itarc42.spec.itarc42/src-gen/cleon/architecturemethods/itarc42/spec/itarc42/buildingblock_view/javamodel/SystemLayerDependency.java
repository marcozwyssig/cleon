...
public class SystemLayerDependency extends DynamicResource implements ISystemLayerDependency {
  ...
  @Override
  public cleon.architecturemethods.itarc42.spec.itarc42.buildingblock_view.javamodel.ISystemLayer selectTo() {
    return _getSingle(cleon.architecturemethods.itarc42.spec.itarc42.buildingblock_view.javamodel.ISystemLayer.class, cleon.architecturemethods.itarc42.spec.itarc42.buildingblock_view.Buildingblock_viewPackage.SystemLayerDependency_to);
  }

  public SystemLayerDependency setTo(cleon.architecturemethods.itarc42.spec.itarc42.buildingblock_view.javamodel.ISystemLayer to) {
    _setSingle(cleon.architecturemethods.itarc42.spec.itarc42.buildingblock_view.Buildingblock_viewPackage.SystemLayerDependency_to, to);
    return this;
  }
  ...
  public static java.util.List<cleon.architecturemethods.itarc42.spec.itarc42.buildingblock_view.javamodel.ISystemLayerDependency> selectToMeTo(cleon.architecturemethods.itarc42.spec.itarc42.buildingblock_view.javamodel.ISystemLayer object) {
    return _getToMeList(object.getRepository(), cleon.architecturemethods.itarc42.spec.itarc42.buildingblock_view.javamodel.ISystemLayerDependency.class, cleon.architecturemethods.itarc42.spec.itarc42.buildingblock_view.Buildingblock_viewPackage.SystemLayerDependency_to, object.getResource());
  }
