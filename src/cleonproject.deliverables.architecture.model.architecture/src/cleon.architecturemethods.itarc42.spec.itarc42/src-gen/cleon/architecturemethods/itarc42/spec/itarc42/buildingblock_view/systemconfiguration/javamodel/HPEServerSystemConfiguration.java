...
public class HPEServerSystemConfiguration extends DynamicResource implements IHPEServerSystemConfiguration {
  ...
  public HPEServerSystemConfiguration setCPUs(java.util.List<? extends cleon.architecturemethods.itarc42.spec.itarc42.buildingblock_view.systemconfiguration.machinesystemconfiguration.javamodel.ICPU> cPUs) {
  ...
  public HPEServerSystemConfiguration setDisks(java.util.List<? extends cleon.architecturemethods.itarc42.spec.itarc42.buildingblock_view.systemconfiguration.machinesystemconfiguration.javamodel.IDisk> disks) {
  ...
  public HPEServerSystemConfiguration setHasDependency(java.util.List<? extends cleon.architecturemethods.itarc42.spec.itarc42.buildingblock_view.javamodel.ISystemConfigurationDependency> hasDependency) {
  ...
  public HPEServerSystemConfiguration setMemory(java.util.List<? extends cleon.architecturemethods.itarc42.spec.itarc42.buildingblock_view.systemconfiguration.machinesystemconfiguration.javamodel.IMemory> memory) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,447010d9-02d7-11e9-9e58-33d596257b14,nYkfr0fWW9H2BaTyKDpmKr3HMXE=] */
