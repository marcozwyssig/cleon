...
public class LinuxSystemConfiguration extends DynamicResource implements ILinuxSystemConfiguration {
  ...
  public LinuxSystemConfiguration setDecompose(java.util.List<? extends cleon.common.modularity.spec.buildingblock.javamodel.IBuildingBlock> decompose) {
  ...
  public LinuxSystemConfiguration setDecomposePackages(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.packages.javamodel.IPackage> decomposePackages) {
  ...
  public LinuxSystemConfiguration setNoPackages(cleon.modelinglanguages.uml.spec.uml2.structural.packages.javamodel.IPackage noPackages) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,771f415a-1d8a-11e9-b601-db75aa6f89a4,8QvYUhx2eq3HOiHfzBKR7ykQ9j8=] */
