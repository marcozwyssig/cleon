...
public class Memory extends DynamicResource implements IMemory {
  ...
  public java.lang.Integer selectSize() {
    return _getSingleAttribute(java.lang.Integer.class, cleon.architecturemethods.itarc42.spec.itarc42.buildingblock_view.systemconfiguration.machine.MachinePackage.Memory_size);
  }
    
  public void setSize(java.lang.Integer size) {
     _setSingleAttribute(cleon.architecturemethods.itarc42.spec.itarc42.buildingblock_view.systemconfiguration.machine.MachinePackage.Memory_size, size);
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    // attributes
    _acceptSingleAttribute(java.lang.Integer.class, cleon.architecturemethods.itarc42.spec.itarc42.buildingblock_view.systemconfiguration.machine.MachinePackage.Memory_size, visitor);
    // relations
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,46fa8bd7-2b00-11e9-9692-65766bc2daa5,qymanqmCL1CtN79Vu58ALZAloSk=] */
