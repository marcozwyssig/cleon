...
public class AvailabilityConfiguration extends DynamicResource implements IAvailabilityConfiguration {
  ...
  public boolean isNone() {
    return getResource().equals(cleon.architecturemethods.itarc42.spec.itarc42.concepts.businesscontinuity.availability.AvailabilityPackage.AvailabilityConfiguration_None);
  }
  
  @Override
  public boolean isActive__S_Active() {
    return getResource().equals(cleon.architecturemethods.itarc42.spec.itarc42.concepts.businesscontinuity.availability.AvailabilityPackage.AvailabilityConfiguration_Active__S_Active);
  }
  
  @Override
  public boolean isActive__S_Passive__F___N_Failover__O_() {
    return getResource().equals(cleon.architecturemethods.itarc42.spec.itarc42.concepts.businesscontinuity.availability.AvailabilityPackage.AvailabilityConfiguration_Active__S_Passive__F___N_Failover__O_);
  }
  
  @Override
  public boolean isN__Q_1() {
    return getResource().equals(cleon.architecturemethods.itarc42.spec.itarc42.concepts.businesscontinuity.availability.AvailabilityPackage.AvailabilityConfiguration_N__Q_1);
  }
  
  @Override
  public boolean isN__Q_M() {
    return getResource().equals(cleon.architecturemethods.itarc42.spec.itarc42.concepts.businesscontinuity.availability.AvailabilityPackage.AvailabilityConfiguration_N__Q_M);
  }
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,21408953-1e38-11e9-865e-41ef48a95f70,5jvwqQS1Hi3izuhGPyj3+If1Ngg=] */
