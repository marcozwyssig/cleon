...
public class NetworkNode extends DynamicResource implements INetworkNode {
  ...
  public cleon.architecturemethods.itarc42.spec.itarc42.deployment_view.environment.node.javamodel.INode selectNode() {
    return _getSingle(cleon.architecturemethods.itarc42.spec.itarc42.deployment_view.environment.node.javamodel.INode.class, cleon.architecturemethods.itarc42.spec.itarc42.concepts.network.NetworkPackage.NetworkNode_node);
  }

  public NetworkNode setNode(cleon.architecturemethods.itarc42.spec.itarc42.deployment_view.environment.node.javamodel.INode node) {
    _setSingle(cleon.architecturemethods.itarc42.spec.itarc42.concepts.network.NetworkPackage.NetworkNode_node, node);
    return this;
  }
  ...
  public static java.util.List<cleon.architecturemethods.itarc42.spec.itarc42.concepts.network.javamodel.INetworkNode> selectToMeNode(cleon.architecturemethods.itarc42.spec.itarc42.deployment_view.environment.node.javamodel.INode object) {
    return _getToMeList(object.getRepository(), cleon.architecturemethods.itarc42.spec.itarc42.concepts.network.javamodel.INetworkNode.class, cleon.architecturemethods.itarc42.spec.itarc42.concepts.network.NetworkPackage.NetworkNode_node, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,91d106aa-4b2c-11e9-8338-41c203971ecb,MqAJDtuO6I2ZpWoIBEOhXML0478=] */
