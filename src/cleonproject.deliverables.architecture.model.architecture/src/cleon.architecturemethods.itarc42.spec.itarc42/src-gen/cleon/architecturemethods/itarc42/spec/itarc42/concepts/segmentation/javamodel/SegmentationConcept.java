...
public class SegmentationConcept extends DynamicResource implements ISegmentationConcept {
  ...
  public SegmentationConcept setChapters(java.util.List<? extends cleon.common.doc.doc.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public SegmentationConcept setDocumentElements(java.util.List<? extends cleon.common.doc.doc.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public SegmentationConcept setParagraphs(java.util.List<? extends cleon.common.doc.doc.spec.paragraph.javamodel.IParagraph> paragraphs) {
  ...
  public java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.itarc42.spec.itarc42.concepts.segmentation.javamodel.ISegmentationSystemComponentConcept> selectSegmentationSystemComponentConcepts() {
    return _getMap(cleon.architecturemethods.itarc42.spec.itarc42.concepts.segmentation.javamodel.ISegmentationSystemComponentConcept.class, cleon.architecturemethods.itarc42.spec.itarc42.concepts.segmentation.SegmentationPackage.SegmentationConcept_segmentationSystemComponentConcepts);
  }

  public SegmentationConcept setSegmentationSystemComponentConcepts(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.itarc42.spec.itarc42.concepts.segmentation.javamodel.ISegmentationSystemComponentConcept> segmentationSystemComponentConcepts) {
    _setMap(cleon.architecturemethods.itarc42.spec.itarc42.concepts.segmentation.SegmentationPackage.SegmentationConcept_segmentationSystemComponentConcepts, segmentationSystemComponentConcepts);
    return this;
  }
  ...
  public java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.itarc42.spec.itarc42.concepts.segmentation.javamodel.ISegmentationSystemConfigurationComponentConcept> selectSegmentationSystemConfigurationConcepts() {
    return _getMap(cleon.architecturemethods.itarc42.spec.itarc42.concepts.segmentation.javamodel.ISegmentationSystemConfigurationComponentConcept.class, cleon.architecturemethods.itarc42.spec.itarc42.concepts.segmentation.SegmentationPackage.SegmentationConcept_segmentationSystemConfigurationConcepts);
  }

  public SegmentationConcept setSegmentationSystemConfigurationConcepts(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.itarc42.spec.itarc42.concepts.segmentation.javamodel.ISegmentationSystemConfigurationComponentConcept> segmentationSystemConfigurationConcepts) {
    _setMap(cleon.architecturemethods.itarc42.spec.itarc42.concepts.segmentation.SegmentationPackage.SegmentationConcept_segmentationSystemConfigurationConcepts, segmentationSystemConfigurationConcepts);
    return this;
  }
  ...
  public java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.itarc42.spec.itarc42.concepts.javamodel.ISystemComponentConcept> selectSystemComponentConcept() {
    return _getMap(cleon.architecturemethods.itarc42.spec.itarc42.concepts.javamodel.ISystemComponentConcept.class, cleon.architecturemethods.itarc42.spec.itarc42.concepts.ConceptsPackage.ConceptForSystemComponent_systemComponentConcept);
  }

  public SegmentationConcept setSystemComponentConcept(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.itarc42.spec.itarc42.concepts.javamodel.ISystemComponentConcept> systemComponentConcept) {
    _setMap(cleon.architecturemethods.itarc42.spec.itarc42.concepts.ConceptsPackage.ConceptForSystemComponent_systemComponentConcept, systemComponentConcept);
    return this;
  }
  ...
  public SegmentationConcept setSystemConfigurationConcept(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.itarc42.spec.itarc42.concepts.javamodel.ISystemConfigurationComponentConcept> systemConfigurationConcept) {
  ...
  public static cleon.architecturemethods.itarc42.spec.itarc42.concepts.segmentation.javamodel.ISegmentationConcept selectToMeSegmentationSystemComponentConcepts(cleon.architecturemethods.itarc42.spec.itarc42.concepts.segmentation.javamodel.ISegmentationSystemComponentConcept object) {
    return _getToMeSingle(object.getRepository(), cleon.architecturemethods.itarc42.spec.itarc42.concepts.segmentation.javamodel.ISegmentationConcept.class, cleon.architecturemethods.itarc42.spec.itarc42.concepts.segmentation.SegmentationPackage.SegmentationConcept_segmentationSystemComponentConcepts, object.getResource());
  }
  
  public static cleon.architecturemethods.itarc42.spec.itarc42.concepts.segmentation.javamodel.ISegmentationConcept selectToMeSegmentationSystemConfigurationConcepts(cleon.architecturemethods.itarc42.spec.itarc42.concepts.segmentation.javamodel.ISegmentationSystemConfigurationComponentConcept object) {
    return _getToMeSingle(object.getRepository(), cleon.architecturemethods.itarc42.spec.itarc42.concepts.segmentation.javamodel.ISegmentationConcept.class, cleon.architecturemethods.itarc42.spec.itarc42.concepts.segmentation.SegmentationPackage.SegmentationConcept_segmentationSystemConfigurationConcepts, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,d56c10bc-04ed-11e9-8ff2-6313785a338c,FYQEUtuH6Xx/FzJZEPhXJMrlCbg=] */
