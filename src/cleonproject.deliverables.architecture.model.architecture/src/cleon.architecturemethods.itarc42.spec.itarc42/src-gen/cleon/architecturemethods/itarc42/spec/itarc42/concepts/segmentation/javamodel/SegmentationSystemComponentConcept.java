...
public class SegmentationSystemComponentConcept extends DynamicResource implements ISegmentationSystemComponentConcept {
  ...
  public SegmentationSystemComponentConcept setChapters(java.util.List<? extends cleon.common.doc.doc.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public SegmentationSystemComponentConcept setDocumentElements(java.util.List<? extends cleon.common.doc.doc.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public SegmentationSystemComponentConcept setParagraphs(java.util.List<? extends cleon.common.doc.doc.spec.paragraph.javamodel.IParagraph> paragraphs) {
  ...
  public SegmentationSystemComponentConcept setSystemComponent(cleon.architecturemethods.itarc42.spec.itarc42.buildingblock_view.javamodel.ISystemComponent systemComponent) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,19f5852a-4b23-11e9-8338-41c203971ecb,ttgk7363hSlvucUjuSdvZxWYKGU=] */
