...
public class DeploymentLevel extends DynamicResource implements IDeploymentLevel {
  ...
  public DeploymentLevel setChapters(java.util.List<? extends cleon.common.doc.doc.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public DeploymentLevel setDocumentElements(java.util.List<? extends cleon.common.doc.doc.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public cleon.architecturemethods.itarc42.spec.itarc42.deployment_view.environment.node.javamodel.INode selectNode() {
    return _getSingle(cleon.architecturemethods.itarc42.spec.itarc42.deployment_view.environment.node.javamodel.INode.class, cleon.architecturemethods.itarc42.spec.itarc42.deployment_view.environment.EnvironmentPackage.DeploymentLevel_node);
  }

  public DeploymentLevel setNode(cleon.architecturemethods.itarc42.spec.itarc42.deployment_view.environment.node.javamodel.INode node) {
    _setSingle(cleon.architecturemethods.itarc42.spec.itarc42.deployment_view.environment.EnvironmentPackage.DeploymentLevel_node, node);
    return this;
  }
  ...
  public DeploymentLevel setParagraphs(java.util.List<? extends cleon.common.doc.doc.spec.paragraph.javamodel.IParagraph> paragraphs) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(cleon.architecturemethods.itarc42.spec.itarc42.deployment_view.environment.node.javamodel.INode.class, cleon.architecturemethods.itarc42.spec.itarc42.deployment_view.environment.EnvironmentPackage.DeploymentLevel_node, visitor);
  ...
  public static java.util.List<cleon.architecturemethods.itarc42.spec.itarc42.deployment_view.environment.javamodel.IDeploymentLevel> selectToMeNode(cleon.architecturemethods.itarc42.spec.itarc42.deployment_view.environment.node.javamodel.INode object) {
    return _getToMeList(object.getRepository(), cleon.architecturemethods.itarc42.spec.itarc42.deployment_view.environment.javamodel.IDeploymentLevel.class, cleon.architecturemethods.itarc42.spec.itarc42.deployment_view.environment.EnvironmentPackage.DeploymentLevel_node, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,3c812d28-0b6d-11e9-a136-69d076e48ed1,JTqv+1p56F68kJmUlZQWdqGFtEI=] */
