...
public class FunctionSpace_Naming {
  ...
  public static interface INamingFunctions extends IDynamicResourceExtension {
    ...
    public java.lang.String GetSimpleName(final cleon.architecturemethods.itarc42.spec.itarc42.deployment_view.environment.node.javamodel.INode object);
  ...
  public static interface INamingFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("1aac5da3-11b4-11e9-9a7b-590a6369b499")
    public java.lang.String GetSimpleName(final cleon.architecturemethods.itarc42.spec.itarc42.deployment_view.environment.node.javamodel.INode object, final cleon.architecturemethods.itarc42.spec.itarc42.deployment_view.environment.naming.javamodel.INaming naming);
  ...
  public static class NamingFunctions {
    ...
    public static java.lang.String GetSimpleName(final cleon.architecturemethods.itarc42.spec.itarc42.deployment_view.environment.node.javamodel.INode object, final cleon.architecturemethods.itarc42.spec.itarc42.deployment_view.environment.naming.javamodel.INaming naming) {
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,d92c5522-11b3-11e9-9a7b-590a6369b499,vhhnzmXLLmz8NJkKUZUShreSLnA=] */
