...
public class ExecutionEnvironmentBuildNode extends DynamicResource implements IExecutionEnvironmentBuildNode {
  ...
  public ExecutionEnvironmentBuildNode setBuildNodes(java.util.List<? extends cleon.architecturemethods.itarc42.spec.itarc42.deployment_view.environment.node.buildnode.javamodel.IBuildNode> buildNodes) {
  ...
  public ExecutionEnvironmentBuildNode setCpu(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.itarc42.spec.itarc42.deployment_view.environment.node.buildnode.machineconfiguration.javamodel.ICPU_Configuration> cpu) {
  ...
  public ExecutionEnvironmentBuildNode setDisk(IMultiMapOrdered<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.itarc42.spec.itarc42.deployment_view.environment.node.buildnode.machineconfiguration.javamodel.IDisk_Configuration> disk) {
  ...
  public ExecutionEnvironmentBuildNode setMemory(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.itarc42.spec.itarc42.deployment_view.environment.node.buildnode.machineconfiguration.javamodel.IMemory_Configuration> memory) {
  ...
  public ExecutionEnvironmentBuildNode setNodes(java.util.List<? extends cleon.architecturemethods.itarc42.spec.itarc42.deployment_view.environment.node.javamodel.INode> nodes) {
  ...
  public ExecutionEnvironmentBuildNode setSuppliedNodes(java.util.List<? extends cleon.architecturemethods.itarc42.spec.itarc42.deployment_view.environment.node.supplynode.javamodel.ISupplyNode> suppliedNodes) {
  ...
  public ExecutionEnvironmentBuildNode setSystemConfiguration(cleon.architecturemethods.itarc42.spec.itarc42.buildingblock_view.javamodel.ISystemConfiguration systemConfiguration) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,62e7ca85-02d8-11e9-9e58-33d596257b14,JmrCstvguTfzwciIaN54HhOXM2c=] */
