...
public class HPEServerSystemConfiguration extends DynamicResource implements IHPEServerSystemConfiguration {
  ...
  public HPEServerSystemConfiguration setCPUs(java.util.List<? extends ikt.product.documentation.spec.buildingblock.systemconfiguration.machinesystemconfiguration.javamodel.ICPU> cPUs) {
  ...
  public HPEServerSystemConfiguration setDisks(java.util.List<? extends ikt.product.documentation.spec.buildingblock.systemconfiguration.machinesystemconfiguration.javamodel.IDisk> disks) {
  ...
  public HPEServerSystemConfiguration setMemory(java.util.List<? extends ikt.product.documentation.spec.buildingblock.systemconfiguration.machinesystemconfiguration.javamodel.IMemory> memory) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,447010d9-02d7-11e9-9e58-33d596257b14,YAiUPveD+PXoGQNtjDwWt6Fsge0=] */
