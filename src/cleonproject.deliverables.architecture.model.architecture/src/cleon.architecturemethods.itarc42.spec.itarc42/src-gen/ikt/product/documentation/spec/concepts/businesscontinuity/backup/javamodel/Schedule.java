...
public class Schedule extends DynamicResource implements ISchedule {
  ...
  public boolean isDaily() {
    return getResource().equals(ikt.product.documentation.spec.concepts.businesscontinuity.backup.BackupPackage.Schedule_Daily);
  }
  
  @Override
  public boolean isWeekly() {
    return getResource().equals(ikt.product.documentation.spec.concepts.businesscontinuity.backup.BackupPackage.Schedule_Weekly);
  }
  
  @Override
  public boolean isMonthly() {
    return getResource().equals(ikt.product.documentation.spec.concepts.businesscontinuity.backup.BackupPackage.Schedule_Monthly);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,68bd338d-1e44-11e9-865e-41ef48a95f70,7Qu7E2nkyXi5807T03ZtQS+YzIk=] */
