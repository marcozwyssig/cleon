...
public class SystemComponentConcept extends DynamicResource implements ISystemComponentConcept {
  ...
  public static java.util.List<ikt.product.documentation.spec.concepts.javamodel.ISystemComponentConcept> selectToMeSystemComponent(cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock.javamodel.ISystemComponent object) {
    return _getToMeList(object.getRepository(), ikt.product.documentation.spec.concepts.javamodel.ISystemComponentConcept.class, ikt.product.documentation.spec.concepts.ConceptsPackage.SystemComponentConcept_systemComponent, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,ba5e31d6-f190-11e8-b3e7-15e2dd8d9b05,47Z4oHtFmCSBfDRmwTX0h7TXDeE=] */
