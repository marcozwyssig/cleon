...
public class NetworkConcept extends DynamicResource implements INetworkConcept {
  ...
  public java.util.List<? extends ikt.product.documentation.spec.concepts.network.javamodel.INetwork> selectNetworks() {
    return _getList(ikt.product.documentation.spec.concepts.network.javamodel.INetwork.class, ikt.product.documentation.spec.concepts.network.NetworkPackage.NetworkConcept_networks);
  }

  public NetworkConcept setNetworks(java.util.List<? extends ikt.product.documentation.spec.concepts.network.javamodel.INetwork> networks) {
    _setList(ikt.product.documentation.spec.concepts.network.NetworkPackage.NetworkConcept_networks, networks);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptList(ikt.product.documentation.spec.concepts.network.javamodel.INetwork.class, ikt.product.documentation.spec.concepts.network.NetworkPackage.NetworkConcept_networks, visitor);
  ...
  public static ikt.product.documentation.spec.concepts.network.javamodel.INetworkConcept selectToMeNetworks(ikt.product.documentation.spec.concepts.network.javamodel.INetwork object) {
    return _getToMeSingle(object.getRepository(), ikt.product.documentation.spec.concepts.network.javamodel.INetworkConcept.class, ikt.product.documentation.spec.concepts.network.NetworkPackage.NetworkConcept_networks, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,b4d4ca85-4b28-11e9-8338-41c203971ecb,nDIdxmTDiwfNhUDZLZF9YieMBQM=] */
