...
public class FunctionSpace_RBAC {
  ...
  public static interface IGroupsFunctions extends IDynamicResourceExtension {
    ...
    public ikt.product.documentation.spec.concepts.security.rbac.javamodel.IRBAC GetRBAC();
  ...
  public static interface ISubnetGroupFunctions extends IDynamicResourceExtension {
    ...
    public ikt.product.documentation.spec.concepts.security.rbac.javamodel.ISecurityGroups GetSecurityGroup();

    @IDynamicResourceExtension.MethodId("4ea436ac-1e12-11e9-865e-41ef48a95f70")
    public ikt.product.documentation.spec.deployment.environment.node.supplynode.javamodel.ISupplyNetDomainNode GetSubnetNode();
  ...
  public static interface ISecurityGroupsFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("a904cb96-1e19-11e9-865e-41ef48a95f70")
    public java.lang.Integer GetRange(final ikt.product.documentation.spec.concepts.security.rbac.javamodel.ISecurityGroups securityGroups);
  ...
  public static class SecurityGroupsFunctions {
    ...
    public static java.lang.Integer GetRange(final ikt.product.documentation.spec.concepts.security.rbac.javamodel.ISecurityGroups securityGroups) {
  ...
  public static interface IRoleFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("0410dad8-35ef-11e9-9d58-25409887bb2a")
    public java.lang.Integer GetId(final ikt.product.documentation.spec.concepts.security.rbac.javamodel.IRole role);
  ...
  public static class RoleFunctions {
    ...
    public static java.lang.Integer GetId(final ikt.product.documentation.spec.concepts.security.rbac.javamodel.IRole role) {
  ...
  public static interface IActivityFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("228c5f41-1e12-11e9-865e-41ef48a95f70")
    public java.lang.Integer GetId(final ikt.product.documentation.spec.concepts.security.rbac.javamodel.IActivity activity);
  ...
  public static class ActivityFunctions {
    ...
    public static java.lang.Integer GetId(final ikt.product.documentation.spec.concepts.security.rbac.javamodel.IActivity activity) {
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,189e1c41-1e07-11e9-834d-77c41fccc6bf,ahbZ22coJuskdMbwIuw12dNCO4c=] */
