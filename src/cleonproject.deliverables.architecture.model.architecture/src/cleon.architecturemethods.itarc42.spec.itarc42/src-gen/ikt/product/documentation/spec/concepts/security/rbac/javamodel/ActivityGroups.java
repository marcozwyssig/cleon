...
public class ActivityGroups extends DynamicResource implements IActivityGroups {
  ...
  @Override
  public IMultiMapOrdered<ch.actifsource.core.Resource, ? extends ikt.product.documentation.spec.concepts.security.rbac.javamodel.IActivitySecurityGroup> selectActivities() {
    return _getMultiMap(ikt.product.documentation.spec.concepts.security.rbac.javamodel.IActivitySecurityGroup.class, ikt.product.documentation.spec.concepts.security.rbac.RbacPackage.ActivityGroups_activities);
  }

  public ActivityGroups setActivities(IMultiMapOrdered<ch.actifsource.core.Resource, ? extends ikt.product.documentation.spec.concepts.security.rbac.javamodel.IActivitySecurityGroup> activities) {
    _setMultiMap(ikt.product.documentation.spec.concepts.security.rbac.RbacPackage.ActivityGroups_activities, activities);
    return this;
  }
  ...
  public ActivityGroups setSecurityGroups(java.util.List<? extends ikt.product.documentation.spec.concepts.security.rbac.javamodel.ISecurityGroups> securityGroups) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    // relations
    _acceptMultiMap(ikt.product.documentation.spec.concepts.security.rbac.javamodel.IActivitySecurityGroup.class, ikt.product.documentation.spec.concepts.security.rbac.RbacPackage.ActivityGroups_activities, visitor);
  ...
  public static ikt.product.documentation.spec.concepts.security.rbac.javamodel.IActivityGroups selectToMeActivities(ikt.product.documentation.spec.concepts.security.rbac.javamodel.IActivitySecurityGroup object) {
    return _getToMeSingle(object.getRepository(), ikt.product.documentation.spec.concepts.security.rbac.javamodel.IActivityGroups.class, ikt.product.documentation.spec.concepts.security.rbac.RbacPackage.ActivityGroups_activities, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,6c451877-1d99-11e9-b601-db75aa6f89a4,1BeW2Mk5VsGsHUyPHyWJ4pPjsCA=] */
