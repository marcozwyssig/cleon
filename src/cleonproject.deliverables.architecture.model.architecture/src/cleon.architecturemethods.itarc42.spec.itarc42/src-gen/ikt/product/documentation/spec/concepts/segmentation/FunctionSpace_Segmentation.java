...
public class FunctionSpace_Segmentation {
  ...
  public static interface IZoneFunctions extends IDynamicResourceExtension {
    ...
    public List<ikt.product.documentation.spec.concepts.segmentation.javamodel.IZone> GetAllParents();

    @IDynamicResourceExtension.MethodId("72a38c28-0b79-11e9-a136-69d076e48ed1")
    public ikt.product.documentation.spec.concepts.segmentation.javamodel.INetDomain GetNetDomainZone();
    ...
    public List<ikt.product.documentation.spec.concepts.segmentation.javamodel.IZone> GetAllChildrenZone();
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,49bf1abf-0b79-11e9-a136-69d076e48ed1,zH7igcM76FKinhmyO755jgelqik=] */
