...
public class SecurityExternalZone extends DynamicResource implements ISecurityExternalZone {
  ...
  public SecurityExternalZone setSecuritySubZones(java.util.List<? extends ikt.product.documentation.spec.concepts.segmentation.javamodel.ISecuritySubZone> securitySubZones) {
  ...
  public SecurityExternalZone setZones(java.util.List<? extends ikt.product.documentation.spec.concepts.segmentation.javamodel.IZone> zones) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,ae271ab1-0b78-11e9-a136-69d076e48ed1,gCXfVNDDn4hhomQ1VZArNmR4ZMc=] */
