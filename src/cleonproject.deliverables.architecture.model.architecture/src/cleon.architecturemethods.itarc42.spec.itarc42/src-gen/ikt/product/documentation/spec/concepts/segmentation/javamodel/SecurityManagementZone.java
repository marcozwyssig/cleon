...
public class SecurityManagementZone extends DynamicResource implements ISecurityManagementZone {
  ...
  public SecurityManagementZone setSecuritySubZones(java.util.List<? extends ikt.product.documentation.spec.concepts.segmentation.javamodel.ISecuritySubZone> securitySubZones) {
  ...
  public SecurityManagementZone setZones(java.util.List<? extends ikt.product.documentation.spec.concepts.segmentation.javamodel.IZone> zones) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,44286d9e-0b75-11e9-a136-69d076e48ed1,3hzv7LZaKnp+gEMDkbgPcfPJU9g=] */
