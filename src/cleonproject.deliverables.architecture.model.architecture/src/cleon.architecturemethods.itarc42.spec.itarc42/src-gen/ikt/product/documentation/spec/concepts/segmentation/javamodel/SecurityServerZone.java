...
public class SecurityServerZone extends DynamicResource implements ISecurityServerZone {
  ...
  public SecurityServerZone setSecuritySubZones(java.util.List<? extends ikt.product.documentation.spec.concepts.segmentation.javamodel.ISecuritySubZone> securitySubZones) {
  ...
  public SecurityServerZone setZones(java.util.List<? extends ikt.product.documentation.spec.concepts.segmentation.javamodel.IZone> zones) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,3af87037-0b75-11e9-a136-69d076e48ed1,0qWqQK6xtzNhxkpq4FoPUx/BJMc=] */
