...
public class SecuritySubZone extends DynamicResource implements ISecuritySubZone {
  ...
  public ikt.product.documentation.spec.concepts.segmentation.javamodel.IZone selectNoZones() {
    return _getSingle(ikt.product.documentation.spec.concepts.segmentation.javamodel.IZone.class, ikt.product.documentation.spec.concepts.segmentation.SegmentationPackage.SecuritySubZone_noZones);
  }

  public SecuritySubZone setNoZones(ikt.product.documentation.spec.concepts.segmentation.javamodel.IZone noZones) {
    _setSingle(ikt.product.documentation.spec.concepts.segmentation.SegmentationPackage.SecuritySubZone_noZones, noZones);
    return this;
  }
  ...
  public SecuritySubZone setZones(java.util.List<? extends ikt.product.documentation.spec.concepts.segmentation.javamodel.IZone> zones) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(ikt.product.documentation.spec.concepts.segmentation.javamodel.IZone.class, ikt.product.documentation.spec.concepts.segmentation.SegmentationPackage.SecuritySubZone_noZones, visitor);
  ...
  public static ikt.product.documentation.spec.concepts.segmentation.javamodel.ISecuritySubZone selectToMeNoZones(ikt.product.documentation.spec.concepts.segmentation.javamodel.IZone object) {
    return _getToMeSingle(object.getRepository(), ikt.product.documentation.spec.concepts.segmentation.javamodel.ISecuritySubZone.class, ikt.product.documentation.spec.concepts.segmentation.SegmentationPackage.SecuritySubZone_noZones, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,7f40c131-0b75-11e9-a136-69d076e48ed1,nkTHU9VS1XkqfWo0wF2pHlCL+0s=] */
