...
public class Segment extends DynamicResource implements ISegment {
  ...
  public java.util.List<? extends ikt.product.documentation.spec.concepts.segmentation.javamodel.ISecurityZone> selectSecurityZones() {
    return _getList(ikt.product.documentation.spec.concepts.segmentation.javamodel.ISecurityZone.class, ikt.product.documentation.spec.concepts.segmentation.SegmentationPackage.Segment_securityZones);
  }

  public Segment setSecurityZones(java.util.List<? extends ikt.product.documentation.spec.concepts.segmentation.javamodel.ISecurityZone> securityZones) {
    _setList(ikt.product.documentation.spec.concepts.segmentation.SegmentationPackage.Segment_securityZones, securityZones);
    return this;
  }
  ...
  public Segment setZones(java.util.List<? extends ikt.product.documentation.spec.concepts.segmentation.javamodel.IZone> zones) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    // relations
    _acceptList(ikt.product.documentation.spec.concepts.segmentation.javamodel.ISecurityZone.class, ikt.product.documentation.spec.concepts.segmentation.SegmentationPackage.Segment_securityZones, visitor);
  ...
  public static ikt.product.documentation.spec.concepts.segmentation.javamodel.ISegment selectToMeSecurityZones(ikt.product.documentation.spec.concepts.segmentation.javamodel.ISecurityZone object) {
    return _getToMeSingle(object.getRepository(), ikt.product.documentation.spec.concepts.segmentation.javamodel.ISegment.class, ikt.product.documentation.spec.concepts.segmentation.SegmentationPackage.Segment_securityZones, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,e820f880-0b73-11e9-a136-69d076e48ed1,K3ruqxNpIZyy9kSWessdjQBVBgY=] */
