...
public class SegmentationSystemConfigurationComponentConcept extends DynamicResource implements ISegmentationSystemConfigurationComponentConcept {
  ...
  public java.util.List<? extends ikt.product.documentation.spec.concepts.segmentation.javamodel.ISecuritySubZone> selectSecuritySubZones() {
    return _getList(ikt.product.documentation.spec.concepts.segmentation.javamodel.ISecuritySubZone.class, ikt.product.documentation.spec.concepts.segmentation.SegmentationPackage.SegmentationSystemConfigurationComponentConcept_securitySubZones);
  }

  public SegmentationSystemConfigurationComponentConcept setSecuritySubZones(java.util.List<? extends ikt.product.documentation.spec.concepts.segmentation.javamodel.ISecuritySubZone> securitySubZones) {
    _setList(ikt.product.documentation.spec.concepts.segmentation.SegmentationPackage.SegmentationSystemConfigurationComponentConcept_securitySubZones, securitySubZones);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptList(ikt.product.documentation.spec.concepts.segmentation.javamodel.ISecuritySubZone.class, ikt.product.documentation.spec.concepts.segmentation.SegmentationPackage.SegmentationSystemConfigurationComponentConcept_securitySubZones, visitor);
  ...
  public static java.util.List<ikt.product.documentation.spec.concepts.segmentation.javamodel.ISegmentationSystemConfigurationComponentConcept> selectToMeSecuritySubZones(ikt.product.documentation.spec.concepts.segmentation.javamodel.ISecuritySubZone object) {
    return _getToMeList(object.getRepository(), ikt.product.documentation.spec.concepts.segmentation.javamodel.ISegmentationSystemConfigurationComponentConcept.class, ikt.product.documentation.spec.concepts.segmentation.SegmentationPackage.SegmentationSystemConfigurationComponentConcept_securitySubZones, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,be4cba9f-0c2a-11e9-83ba-4d57b06560a2,sm7C/RcBJhkNd2zbVYCvprurc7k=] */
