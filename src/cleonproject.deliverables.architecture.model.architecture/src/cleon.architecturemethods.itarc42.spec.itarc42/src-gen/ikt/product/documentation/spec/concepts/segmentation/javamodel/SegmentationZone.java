...
public class SegmentationZone extends DynamicResource implements ISegmentationZone {
  ...
  @Override
  public ikt.product.documentation.spec.concepts.segmentation.javamodel.IZone selectZone() {
    return _getSingle(ikt.product.documentation.spec.concepts.segmentation.javamodel.IZone.class, ikt.product.documentation.spec.concepts.segmentation.SegmentationPackage.SegmentationZone_zone);
  }

  public SegmentationZone setZone(ikt.product.documentation.spec.concepts.segmentation.javamodel.IZone zone) {
    _setSingle(ikt.product.documentation.spec.concepts.segmentation.SegmentationPackage.SegmentationZone_zone, zone);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(ikt.product.documentation.spec.concepts.segmentation.javamodel.IZone.class, ikt.product.documentation.spec.concepts.segmentation.SegmentationPackage.SegmentationZone_zone, visitor);
  }

  // toMeRelations
  
  public static ikt.product.documentation.spec.concepts.segmentation.javamodel.ISegmentationZone selectToMeZone(ikt.product.documentation.spec.concepts.segmentation.javamodel.IZone object) {
    return _getToMeSingle(object.getRepository(), ikt.product.documentation.spec.concepts.segmentation.javamodel.ISegmentationZone.class, ikt.product.documentation.spec.concepts.segmentation.SegmentationPackage.SegmentationZone_zone, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,ccaeef49-0d1d-11e9-be4f-03130cc057ef,zTRjgxXGC8l0cZBPdRWRX0miQws=] */
