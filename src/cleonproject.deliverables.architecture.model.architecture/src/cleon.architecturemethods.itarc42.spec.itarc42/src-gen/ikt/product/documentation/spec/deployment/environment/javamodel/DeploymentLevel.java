...
public class DeploymentLevel extends DynamicResource implements IDeploymentLevel {
  ...
  public ikt.product.documentation.spec.deployment.environment.node.javamodel.INode selectNode() {
    return _getSingle(ikt.product.documentation.spec.deployment.environment.node.javamodel.INode.class, ikt.product.documentation.spec.deployment.environment.EnvironmentPackage.DeploymentLevel_node);
  }

  public DeploymentLevel setNode(ikt.product.documentation.spec.deployment.environment.node.javamodel.INode node) {
    _setSingle(ikt.product.documentation.spec.deployment.environment.EnvironmentPackage.DeploymentLevel_node, node);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(ikt.product.documentation.spec.deployment.environment.node.javamodel.INode.class, ikt.product.documentation.spec.deployment.environment.EnvironmentPackage.DeploymentLevel_node, visitor);
  ...
  public static java.util.List<ikt.product.documentation.spec.deployment.environment.javamodel.IDeploymentLevel> selectToMeNode(ikt.product.documentation.spec.deployment.environment.node.javamodel.INode object) {
    return _getToMeList(object.getRepository(), ikt.product.documentation.spec.deployment.environment.javamodel.IDeploymentLevel.class, ikt.product.documentation.spec.deployment.environment.EnvironmentPackage.DeploymentLevel_node, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,3c812d28-0b6d-11e9-a136-69d076e48ed1,Rd3sbEMtphgjPq1jmISYHPqcWYQ=] */
