...
public class FunctionSpace_Node {
  ...
  public static interface INodeFunctions extends IDynamicResourceExtension {
    ...
    public ikt.product.documentation.spec.deployment.environment.node.javamodel.INode GetParent();

    @IDynamicResourceExtension.MethodId("66093688-02d5-11e9-9e58-33d596257b14")
    public List<ikt.product.documentation.spec.deployment.environment.node.javamodel.ISupplyAndBuildNodeDecomposite> GetParents();
    ...
    public ikt.product.documentation.spec.deployment.environment.node.supplynode.javamodel.ISupplyLocationNode GetLocationNode();
    ...
    public List<ikt.product.documentation.spec.deployment.environment.node.javamodel.INode> GetAllNestedNodes();
    ...
    public List<ikt.product.documentation.spec.deployment.environment.node.supplynode.javamodel.ISupplyNetDomainNode> GetAllNestedSubnetNodes();
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,41a52ff4-0b73-11e9-a136-69d076e48ed1,gzeJaktbU8WOBkwN1FSmIEwNf2Q=] */
