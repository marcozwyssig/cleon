...
public class BuildnodePackage {
  ...
  public static final String getPackageName() {
    return "ikt.product.documentation.spec.deployment.environment.node.buildnode";
  }
  
}
/* Actifsource ID=[c1a07b92-fc09-11e0-b756-0dc1d96a76cb,ikt.product.documentation.spec.deployment.environment.node.buildnode,Vh3jDX9BHk/BgxziywmeYT4QnY0=] */
