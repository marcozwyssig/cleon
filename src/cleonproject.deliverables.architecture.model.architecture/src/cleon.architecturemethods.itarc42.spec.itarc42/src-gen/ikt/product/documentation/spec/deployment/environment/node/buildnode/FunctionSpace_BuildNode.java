package ikt.product.documentation.spec.deployment.environment.node.buildnode;
...
public class FunctionSpace_BuildNode {
  ...
  public static interface IBuildNodeFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("8ea2102d-2aba-11e9-a3f8-336d9e792e17")
    public java.lang.Boolean IsSupplied(final ikt.product.documentation.spec.deployment.environment.node.buildnode.javamodel.IBuildNode buildNode);
  ...
  public static class BuildNodeFunctions {
    ...
    public static java.lang.Boolean IsSupplied(final ikt.product.documentation.spec.deployment.environment.node.buildnode.javamodel.IBuildNode buildNode) {
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,48dec04d-02d8-11e9-9e58-33d596257b14,mIMxpvPtOUDO0e2D/dOAsiZ+5dc=] */
