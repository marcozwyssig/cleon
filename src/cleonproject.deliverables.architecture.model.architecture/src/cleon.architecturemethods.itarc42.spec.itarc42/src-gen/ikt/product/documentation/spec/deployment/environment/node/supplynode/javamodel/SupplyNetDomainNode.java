...
public class SupplyNetDomainNode extends DynamicResource implements ISupplyNetDomainNode {
  ...
  public java.lang.Integer selectGroupId() {
    return _getSingleAttribute(java.lang.Integer.class, ikt.product.documentation.spec.deployment.environment.node.supplynode.SupplynodePackage.SupplyNetDomainNode_groupId);
  }
    
  public void setGroupId(java.lang.Integer groupId) {
     _setSingleAttribute(ikt.product.documentation.spec.deployment.environment.node.supplynode.SupplynodePackage.SupplyNetDomainNode_groupId, groupId);
  }
  ...
  public SupplyNetDomainNode setBuildNodes(java.util.List<? extends ikt.product.documentation.spec.deployment.environment.node.buildnode.javamodel.IBuildNode> buildNodes) {
  ...
  public SupplyNetDomainNode setCustomer(ikt.product.documentation.spec.deployment.environment.javamodel.ICustomer customer) {
  ...
  public SupplyNetDomainNode setNodes(java.util.List<? extends ikt.product.documentation.spec.deployment.environment.node.javamodel.INode> nodes) {
  ...
  public SupplyNetDomainNode setSuppliedNodes(java.util.List<? extends ikt.product.documentation.spec.deployment.environment.node.supplynode.javamodel.ISupplyNode> suppliedNodes) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingleAttribute(java.lang.Integer.class, ikt.product.documentation.spec.deployment.environment.node.supplynode.SupplynodePackage.SupplyNetDomainNode_groupId, visitor);
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,0674e77a-0aaf-11e9-a8f9-abf1763bbc53,uIvA/ER/4xtMve/f5nq714yBOTg=] */
