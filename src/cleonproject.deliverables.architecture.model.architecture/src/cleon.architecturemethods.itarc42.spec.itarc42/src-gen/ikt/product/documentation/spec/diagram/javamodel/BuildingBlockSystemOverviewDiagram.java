...
public class BuildingBlockSystemOverviewDiagram extends DynamicResource implements IBuildingBlockSystemOverviewDiagram {
  ...
  public cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock.javamodel.ISystem selectSystem() {
    return _getSingle(cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock.javamodel.ISystem.class, ikt.product.documentation.spec.diagram.DiagramPackage.BuildingBlockSystemOverviewDiagram_system);
  }

  public BuildingBlockSystemOverviewDiagram setSystem(cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock.javamodel.ISystem system) {
    _setSingle(ikt.product.documentation.spec.diagram.DiagramPackage.BuildingBlockSystemOverviewDiagram_system, system);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock.javamodel.ISystem.class, ikt.product.documentation.spec.diagram.DiagramPackage.BuildingBlockSystemOverviewDiagram_system, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

  // toMeRelations
  
  public static java.util.List<ikt.product.documentation.spec.diagram.javamodel.IBuildingBlockSystemOverviewDiagram> selectToMeSystem(cleon.architecturemethods.itarc42.spec.itarc42._05_buildingblock.javamodel.ISystem object) {
    return _getToMeList(object.getRepository(), ikt.product.documentation.spec.diagram.javamodel.IBuildingBlockSystemOverviewDiagram.class, ikt.product.documentation.spec.diagram.DiagramPackage.BuildingBlockSystemOverviewDiagram_system, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,dec338dd-02db-11e9-9e58-33d596257b14,gEo48LfNqo/NRujIRB/2Wn4zuEM=] */
