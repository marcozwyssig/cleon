package ikt.product.documentation.spec.diagram.javamodel;
...
public class DeploymentDiagram extends DynamicResource implements IDeploymentDiagram {
  ...
  public java.lang.Boolean selectLeftToRight() {
    return _getSingleAttribute(java.lang.Boolean.class, ikt.product.documentation.spec.diagram.DiagramPackage.DeploymentDiagram_leftToRight);
  }
    
  public void setLeftToRight(java.lang.Boolean leftToRight) {
     _setSingleAttribute(ikt.product.documentation.spec.diagram.DiagramPackage.DeploymentDiagram_leftToRight, leftToRight);
  }

  @Override
  public java.lang.Boolean selectOnlyOneLayer() {
    return _getSingleAttribute(java.lang.Boolean.class, ikt.product.documentation.spec.diagram.DiagramPackage.DeploymentDiagram_onlyOneLayer);
  }
    
  public void setOnlyOneLayer(java.lang.Boolean onlyOneLayer) {
     _setSingleAttribute(ikt.product.documentation.spec.diagram.DiagramPackage.DeploymentDiagram_onlyOneLayer, onlyOneLayer);
  }
  ...
  public java.lang.Boolean selectRenderHidden() {
    return _getSingleAttribute(java.lang.Boolean.class, ikt.product.documentation.spec.diagram.DiagramPackage.DeploymentDiagram_renderHidden);
  }
    
  public void setRenderHidden(java.lang.Boolean renderHidden) {
     _setSingleAttribute(ikt.product.documentation.spec.diagram.DiagramPackage.DeploymentDiagram_renderHidden, renderHidden);
  }

  @Override
  public java.lang.String selectScale() {
    return _getSingleAttribute(java.lang.String.class, ikt.product.documentation.spec.diagram.DiagramPackage.DeploymentDiagram_scale);
  }
    
  public void setScale(java.lang.String scale) {
     _setSingleAttribute(ikt.product.documentation.spec.diagram.DiagramPackage.DeploymentDiagram_scale, scale);
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    // attributes
    _acceptSingleAttribute(java.lang.Boolean.class, ikt.product.documentation.spec.diagram.DiagramPackage.DeploymentDiagram_leftToRight, visitor);
    _acceptSingleAttribute(java.lang.Boolean.class, ikt.product.documentation.spec.diagram.DiagramPackage.DeploymentDiagram_onlyOneLayer, visitor);
    _acceptSingleAttribute(java.lang.String.class, cleon.modelinglanguages.uml.spec.uml2.Uml2Package.UmlDiagram_path, visitor);
    _acceptSingleAttribute(java.lang.Boolean.class, ikt.product.documentation.spec.diagram.DiagramPackage.DeploymentDiagram_renderHidden, visitor);
    _acceptSingleAttribute(java.lang.String.class, ikt.product.documentation.spec.diagram.DiagramPackage.DeploymentDiagram_scale, visitor);
    // relations
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,1cf628c3-0aa0-11e9-8a91-633e556ac68f,EWxN3zB6LBLCa3Av6JhwdCM2pi4=] */
