...
public class FunctionSpace_QoS {
  ...
  public static interface IQoS_ConceptFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("7494a4f9-1d92-11e9-b601-db75aa6f89a4")
    public java.lang.Integer SumQoS(final ikt.product.documentation.spec.concepts.qos.javamodel.IQoS_Concept qoS_Concept);

    @IDynamicResourceExtension.MethodId("9cb503c2-1d92-11e9-b601-db75aa6f89a4")
    public java.lang.Integer SumQoS_Mean(final ikt.product.documentation.spec.concepts.qos.javamodel.IQoS_Concept qoS_Concept);
  ...
  public static class QoS_ConceptFunctions {
    ...
    public static java.lang.Integer SumQoS(final ikt.product.documentation.spec.concepts.qos.javamodel.IQoS_Concept qoS_Concept) {
    ...
    public static java.lang.Integer SumQoS_Mean(final ikt.product.documentation.spec.concepts.qos.javamodel.IQoS_Concept qoS_Concept) {
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,94558f25-1d8d-11e9-b601-db75aa6f89a4,+ePDkdIjHdPFXrlG3YUndhOjorg=] */
