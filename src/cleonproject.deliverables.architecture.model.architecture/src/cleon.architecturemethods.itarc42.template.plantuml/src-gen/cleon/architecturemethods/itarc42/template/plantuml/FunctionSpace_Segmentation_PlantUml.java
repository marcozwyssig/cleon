...
public class FunctionSpace_Segmentation_PlantUml {
  ...
  public static interface ISegmentationDiagramFunctions extends IDynamicResourceExtension {
    ...
    public List<ikt.product.documentation.spec.concepts.segmentation.javamodel.IZone> SelectZone();
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,30168fe9-0e23-11e9-8b4c-f9aec93d8b56,1+xc8oMDelh1fhapiHwswd3dhZA=] */
