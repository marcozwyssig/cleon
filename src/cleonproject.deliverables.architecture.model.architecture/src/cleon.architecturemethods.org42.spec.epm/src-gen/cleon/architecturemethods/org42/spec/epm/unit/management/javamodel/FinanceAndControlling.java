...
public class FinanceAndControlling extends DynamicResource implements IFinanceAndControlling {
  ...
  public FinanceAndControlling setResponsible(cleon.initialization.processlanguage.spec.bpmn.organisational.role.javamodel.IRole responsible) {
  ...
  public FinanceAndControlling setStaff(java.util.List<? extends cleon.initialization.processlanguage.spec.bpmn.organisational.role.javamodel.IRole> staff) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,068d6215-daa3-11e3-ae07-89aa80d5ec3d,yTnxMurAzMGumLFh7MpEFTdBVo4=] */
