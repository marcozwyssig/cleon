...
public class PolticsAndStrategy extends DynamicResource implements IPolticsAndStrategy {
  ...
  public PolticsAndStrategy setResponsible(cleon.modelinglanguages.bpmn.spec.bpmn2.organisational.role.javamodel.IRole responsible) {
  ...
  public PolticsAndStrategy setStaff(java.util.List<? extends cleon.modelinglanguages.bpmn.spec.bpmn2.organisational.role.javamodel.IRole> staff) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,02043012-daa3-11e3-ae07-89aa80d5ec3d,QOeaEU2BUheoGuPBpsGZLpFEdEc=] */
