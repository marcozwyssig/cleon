...
public class FunctionSpace_DisplayNameStrategy {
  ...
  public static interface IDisplayNameStrategyFunctions extends IDynamicResourceExtension {
    ...
    public java.lang.String GetDisplayName(final cleon.architecturemethods.systemarc42.metamodel.spec._07_deployment_view.environment.node.buildnode.javamodel.IServiceBuildNode serviceBuildingNode);

    @IDynamicResourceExtension.MethodId("f3de4db5-2acf-11e9-a3f8-336d9e792e17")
    public java.lang.String GetDisplayName(final cleon.architecturemethods.systemarc42.metamodel.spec._07_deployment_view.environment.node.buildnode.javamodel.IExecutionEnvironmentBuildNode executionEnvironmentBuildNode);

    @IDynamicResourceExtension.MethodId("d4e957e8-2ed3-11e9-9ca2-d7354798e154")
    public java.lang.String OnlyName(final cleon.architecturemethods.systemarc42.metamodel.spec._07_deployment_view.environment.node.buildnode.javamodel.IServiceBuildNode serviceBuildingNode);

    @IDynamicResourceExtension.MethodId("da6f3989-2ed3-11e9-9ca2-d7354798e154")
    public java.lang.String OnlyName(final cleon.architecturemethods.systemarc42.metamodel.spec._07_deployment_view.environment.node.buildnode.javamodel.IExecutionEnvironmentBuildNode executionEnvironmentBuildNode);
