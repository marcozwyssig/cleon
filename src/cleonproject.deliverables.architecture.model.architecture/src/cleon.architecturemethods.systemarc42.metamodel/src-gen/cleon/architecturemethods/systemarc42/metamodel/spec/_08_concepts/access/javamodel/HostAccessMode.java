...
public class HostAccessMode extends DynamicResource implements IHostAccessMode {
  ...
  public boolean isAll() {
    return getResource().equals(cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.access.AccessPackage.HostAccessMode_All);
  }
  
  @Override
  public boolean isOnlyCluster() {
    return getResource().equals(cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.access.AccessPackage.HostAccessMode_OnlyCluster);
  }
  
  @Override
  public boolean isNoCluster() {
    return getResource().equals(cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.access.AccessPackage.HostAccessMode_NoCluster);
  }
