...
public class Purpose extends DynamicResource implements IPurpose {
  ...
  public boolean isManagement() {
    return getResource().equals(cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.access.AccessPackage.Purpose_Management);
  }
  
  @Override
  public boolean isManagement__F___N_Fallback__O_() {
    return getResource().equals(cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.access.AccessPackage.Purpose_Management__F___N_Fallback__O_);
  }
  
  @Override
  public boolean isUser() {
    return getResource().equals(cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.access.AccessPackage.Purpose_User);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,b7bb9567-84df-11ec-8ce3-4fc564ebb802,1d7cb9kU+Z9JvGMXOm4epVCn2Tc=] */
