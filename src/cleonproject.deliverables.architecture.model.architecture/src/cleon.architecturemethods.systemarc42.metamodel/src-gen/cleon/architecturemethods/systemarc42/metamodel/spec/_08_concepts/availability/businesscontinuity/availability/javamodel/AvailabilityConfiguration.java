...
public class AvailabilityConfiguration extends DynamicResource implements IAvailabilityConfiguration {
  ...
  public java.util.List<java.lang.String> selectStandardDescription() {
    return _getListAttribute(java.lang.String.class, cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.availability.businesscontinuity.availability.AvailabilityPackage.AvailabilityConfiguration_standardDescription);
  }
    
  public void setStandardDescription(java.util.List<java.lang.String> standardDescription) {
     _setListAttribute(cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.availability.businesscontinuity.availability.AvailabilityPackage.AvailabilityConfiguration_standardDescription, standardDescription);
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptListAttribute(java.lang.String.class, cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.availability.businesscontinuity.availability.AvailabilityPackage.AvailabilityConfiguration_standardDescription, visitor);
    // relations
  ...
  public boolean isNone() {
    return getResource().equals(cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.availability.businesscontinuity.availability.AvailabilityPackage.AvailabilityConfiguration_None);
  }
  
  @Override
  public boolean isActive__S_Active() {
    return getResource().equals(cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.availability.businesscontinuity.availability.AvailabilityPackage.AvailabilityConfiguration_Active__S_Active);
  }
  
  @Override
  public boolean isActive__S_Passive__F___N_Failover__O_() {
    return getResource().equals(cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.availability.businesscontinuity.availability.AvailabilityPackage.AvailabilityConfiguration_Active__S_Passive__F___N_Failover__O_);
  }
  
  @Override
  public boolean isSicherung__F_und__F_Wiederherstellung() {
    return getResource().equals(cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.availability.businesscontinuity.availability.AvailabilityPackage.AvailabilityConfiguration_Sicherung__F_und__F_Wiederherstellung);
  }
  
  @Override
  public boolean isRedundante__F_Sicherung__F_und__F_Wiederherstellung() {
    return getResource().equals(cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.availability.businesscontinuity.availability.AvailabilityPackage.AvailabilityConfiguration_Redundante__F_Sicherung__F_und__F_Wiederherstellung);
  }
  
  @Override
  public boolean isReplikation() {
    return getResource().equals(cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.availability.businesscontinuity.availability.AvailabilityPackage.AvailabilityConfiguration_Replikation);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,8d623900-c93b-11eb-adc4-d18d1353eb6e,Bia91w1YYP1oXb5xMyIJZ9Yapg8=] */
