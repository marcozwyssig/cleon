...
public class ManualDeploymentConfiguration extends DynamicResource implements IManualDeploymentConfiguration {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<IManualDeploymentConfiguration> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<IManualDeploymentConfiguration>() {
    
    @Override
    public IManualDeploymentConfiguration create() {
      return new ManualDeploymentConfiguration();
    }
    
    @Override
    public IManualDeploymentConfiguration create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new ManualDeploymentConfiguration(resourceRepository, resource);
    }
  
  };

  public ManualDeploymentConfiguration() {
    super(IManualDeploymentConfiguration.TYPE_ID);
  }
  
  public ManualDeploymentConfiguration(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
    super(resourceRepository, resource, IManualDeploymentConfiguration.TYPE_ID);
  }
  ...
  public ManualDeploymentConfiguration setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,8f18724b-fe3f-11ea-892b-df291bae18c5,CihUTdBcmCDmc4Y1VNZmbCL0slw=] */
