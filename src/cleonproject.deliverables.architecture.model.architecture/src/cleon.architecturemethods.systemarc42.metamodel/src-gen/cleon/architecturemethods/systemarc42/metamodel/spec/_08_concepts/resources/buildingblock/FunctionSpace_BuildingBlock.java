...
public class FunctionSpace_BuildingBlock {
  ...
  public static interface ICoreFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("0e05b36b-dff8-11eb-93d3-9f230e4bb32b")
    public java.lang.Integer BruttoTotalMHz(final cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.resources.buildingblock.javamodel.ICore core);

    @IDynamicResourceExtension.MethodId("a16aa1c9-dffa-11eb-93d3-9f230e4bb32b")
    public java.lang.Integer NettoTotalMHz(final cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.resources.buildingblock.javamodel.ICore core);
  ...
  public static class CoreFunctionsImpl implements ICoreFunctionsImpl {
    ...
    public java.lang.Integer BruttoTotalMHz(final cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.resources.buildingblock.javamodel.ICore core) {
      /* Begin Protected Region [[0e05b36b-dff8-11eb-93d3-9f230e4bb32b]] */
    	var cpuCount = CPU.selectToMeCores(core).selectAmount();
    	var coreCount = core.selectAmount();
    ...
    public java.lang.Integer NettoTotalMHz(final cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.resources.buildingblock.javamodel.ICore core) {
      /* Begin Protected Region [[a16aa1c9-dffa-11eb-93d3-9f230e4bb32b]] */
    	Double value = BruttoTotalMHz(core) * 0.8;
  ...
  public static class CoreFunctions {
    ...
    public static java.lang.Integer BruttoTotalMHz(final cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.resources.buildingblock.javamodel.ICore core) {
      return DynamicResourceUtil.invoke(ICoreFunctionsImpl.class, CoreFunctionsImpl.INSTANCE, core).BruttoTotalMHz(core);
    }

    public static java.lang.Integer NettoTotalMHz(final cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.resources.buildingblock.javamodel.ICore core) {
  ...
  public static class MemoryFunctions {
    ...
    public static java.lang.Integer NettoTotalGB(final cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.resources.buildingblock.javamodel.IMemory memory) {
  ...
  public static class DiskFunctions {
    ...
    public static java.lang.Integer NettoTotalGB_60(final cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.resources.buildingblock.javamodel.IDisk disk) {
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,0881f535-dff8-11eb-93d3-9f230e4bb32b,20fGXstC4Z9N1YiK3olNF0FpctM=] */
