...
public class ResourcePlanningNodeConcept extends DynamicResource implements IResourcePlanningNodeConcept {
  ...
  @Override
  public cleon.architecturemethods.systemarc42.metamodel.spec._07_deployment_view.environment.node.buildnode.javamodel.IBuildNode selectResourcePlanningForNode() {
    return _getSingle(cleon.architecturemethods.systemarc42.metamodel.spec._07_deployment_view.environment.node.buildnode.javamodel.IBuildNode.class, cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.resources.planning.PlanningPackage.ResourcePlanningNodeConcept_resourcePlanningForNode);
  }

  public ResourcePlanningNodeConcept setResourcePlanningForNode(cleon.architecturemethods.systemarc42.metamodel.spec._07_deployment_view.environment.node.buildnode.javamodel.IBuildNode resourcePlanningForNode) {
    _setSingle(cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.resources.planning.PlanningPackage.ResourcePlanningNodeConcept_resourcePlanningForNode, resourcePlanningForNode);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(cleon.architecturemethods.systemarc42.metamodel.spec._07_deployment_view.environment.node.buildnode.javamodel.IBuildNode.class, cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.resources.planning.PlanningPackage.ResourcePlanningNodeConcept_resourcePlanningForNode, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

  // toMeRelations
  
  public static java.util.List<cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.resources.planning.javamodel.IResourcePlanningNodeConcept> selectToMeResourcePlanningForNode(cleon.architecturemethods.systemarc42.metamodel.spec._07_deployment_view.environment.node.buildnode.javamodel.IBuildNode object) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,69dd239f-dfef-11eb-93d3-9f230e4bb32b,x4nWrL0YXWA0mOuv8Y1B9aDrBIA=] */
