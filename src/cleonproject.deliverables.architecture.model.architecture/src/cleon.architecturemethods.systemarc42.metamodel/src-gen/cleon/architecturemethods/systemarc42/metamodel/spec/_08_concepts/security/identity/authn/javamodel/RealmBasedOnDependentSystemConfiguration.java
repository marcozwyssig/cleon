...
public class RealmBasedOnDependentSystemConfiguration extends DynamicResource implements IRealmBasedOnDependentSystemConfiguration {
  ...
  @Override
  public cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.security.identity.authn.javamodel.IRealmUsageForDependentSystemConfiguration selectBasedOn() {
    return _getSingle(cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.security.identity.authn.javamodel.IRealmUsageForDependentSystemConfiguration.class, cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.security.identity.authn.AuthnPackage.RealmBasedOnDependentSystemConfiguration_basedOn);
  }

  public RealmBasedOnDependentSystemConfiguration setBasedOn(cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.security.identity.authn.javamodel.IRealmUsageForDependentSystemConfiguration basedOn) {
    _setSingle(cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.security.identity.authn.AuthnPackage.RealmBasedOnDependentSystemConfiguration_basedOn, basedOn);
    return this;
  }
  ...
  public static java.util.List<cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.security.identity.authn.javamodel.IRealmBasedOnDependentSystemConfiguration> selectToMeBasedOn(cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.security.identity.authn.javamodel.IRealmUsageForDependentSystemConfiguration object) {
    return _getToMeList(object.getRepository(), cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.security.identity.authn.javamodel.IRealmBasedOnDependentSystemConfiguration.class, cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.security.identity.authn.AuthnPackage.RealmBasedOnDependentSystemConfiguration_basedOn, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,de1dc42e-fd8d-11ea-8a95-19b98046e6db,L5qRB5wSwMPRKLmw7OIRrKG0JE4=] */
