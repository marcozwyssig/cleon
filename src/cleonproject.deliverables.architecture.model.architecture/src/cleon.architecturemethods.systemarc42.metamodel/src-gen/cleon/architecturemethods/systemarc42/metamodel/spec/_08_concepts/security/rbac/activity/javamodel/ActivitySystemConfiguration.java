...
public class ActivitySystemConfiguration extends DynamicResource implements IActivitySystemConfiguration {
  ...
  public java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.security.rbac.activity.javamodel.IActivityPermission> selectActivitiesForPermissions() {
    return _getMap(cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.security.rbac.activity.javamodel.IActivityPermission.class, cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.security.rbac.activity.ActivityPackage.ActivitySystemConfiguration_activitiesForPermissions);
  }

  public ActivitySystemConfiguration setActivitiesForPermissions(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.security.rbac.activity.javamodel.IActivityPermission> activitiesForPermissions) {
    _setMap(cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.security.rbac.activity.ActivityPackage.ActivitySystemConfiguration_activitiesForPermissions, activitiesForPermissions);
    return this;
  }
  ...
  public ActivitySystemConfiguration setGroups(java.util.List<? extends cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.security.rbac.javamodel.IAbstractGroup> groups) {
