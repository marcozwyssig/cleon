...
public class Location extends DynamicResource implements ILocation {
  ...
  @Override
  public boolean isA() {
    return getResource().equals(cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.topology.TopologyPackage.Location_A);
  }
  
  @Override
  public boolean isB() {
    return getResource().equals(cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.topology.TopologyPackage.Location_B);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,865b3a4b-57c9-11ea-bd7a-4baf1bc87b3c,JbcYsSFW82JN9pAwUZVf48WzzwQ=] */
