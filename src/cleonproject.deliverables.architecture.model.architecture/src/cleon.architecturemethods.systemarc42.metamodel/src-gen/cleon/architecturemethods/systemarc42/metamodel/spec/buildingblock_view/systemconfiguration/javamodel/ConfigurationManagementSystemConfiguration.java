...
public class ConfigurationManagementSystemConfiguration extends DynamicResource implements IConfigurationManagementSystemConfiguration {
  ...
  public ConfigurationManagementSystemConfiguration setHasDependency(java.util.List<? extends cleon.architecturemethods.systemarc42.metamodel.spec.buildingblock_view.javamodel.ISystemConfigurationDependency> hasDependency) {
  ...
  public ConfigurationManagementSystemConfiguration setInheritServices(java.util.List<? extends cleon.architecturemethods.systemarc42.metamodel.spec.buildingblock_view.systemconfiguration.to_move.system.javamodel.ISystemConfiguration> inheritServices) {
  ...
  public ConfigurationManagementSystemConfiguration setInterface(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.systemarc42.metamodel.spec.buildingblock_view.systemconfiguration.javamodel.IInterface> interface_) {
  ...
  public ConfigurationManagementSystemConfiguration setProvides(java.util.List<? extends cleon.architecturemethods.systemarc42.metamodel.spec.concepts.services.javamodel.IAbstractService> provides) {
  ...
  public ConfigurationManagementSystemConfiguration setUsingProducts(java.util.List<? extends cleon.architecturemethods.arc42.metamodel.spec._13_product_view.javamodel.IProduct> usingProducts) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,a0ea27b6-0c39-11e9-83ba-4d57b06560a2,WmQQ7r0xJN16/hajFJ4uXSDaixA=] */
