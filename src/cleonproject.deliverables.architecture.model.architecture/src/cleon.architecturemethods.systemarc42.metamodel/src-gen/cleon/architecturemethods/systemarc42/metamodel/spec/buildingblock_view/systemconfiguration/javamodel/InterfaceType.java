...
public class InterfaceType extends DynamicResource implements IInterfaceType {
  ...
  public boolean isINT() {
    return getResource().equals(cleon.architecturemethods.systemarc42.metamodel.spec.buildingblock_view.systemconfiguration.SystemconfigurationPackage.InterfaceType_INT);
  }
  
  @Override
  public boolean isEXT() {
    return getResource().equals(cleon.architecturemethods.systemarc42.metamodel.spec.buildingblock_view.systemconfiguration.SystemconfigurationPackage.InterfaceType_EXT);
  }
  
  @Override
  public boolean isMGMT() {
    return getResource().equals(cleon.architecturemethods.systemarc42.metamodel.spec.buildingblock_view.systemconfiguration.SystemconfigurationPackage.InterfaceType_MGMT);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,9aa83a3b-878f-11e9-a61b-279ebde48b48,PAUtZVWHgWVQc7QtMBmfifWwBT0=] */
