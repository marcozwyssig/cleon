...
public class IssuingCASystemConfiguration extends DynamicResource implements IIssuingCASystemConfiguration {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<IIssuingCASystemConfiguration> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<IIssuingCASystemConfiguration>() {
    
    @Override
    public IIssuingCASystemConfiguration create() {
      return new IssuingCASystemConfiguration();
    }
    
    @Override
    public IIssuingCASystemConfiguration create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new IssuingCASystemConfiguration(resourceRepository, resource);
    }
  
  };

  public IssuingCASystemConfiguration() {
    super(IIssuingCASystemConfiguration.TYPE_ID);
  }
  
  public IssuingCASystemConfiguration(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
    super(resourceRepository, resource, IIssuingCASystemConfiguration.TYPE_ID);
  }
  ...
  public IssuingCASystemConfiguration setDecompose(java.util.List<? extends cleon.common.modularity.metamodel.spec.javamodel.IBuildingBlock> decompose) {
  ...
  public IssuingCASystemConfiguration setDecomposePackages(java.util.List<? extends cleon.modelinglanguages.uml.metamodel.spec.structural.packages.javamodel.IPackage> decomposePackages) {
  ...
  public IssuingCASystemConfiguration setHasDependency(java.util.List<? extends cleon.architecturemethods.systemarc42.metamodel.spec.buildingblock_view.javamodel.ISystemConfigurationDependency> hasDependency) {
  ...
  public IssuingCASystemConfiguration setInSubZone(java.util.List<? extends cleon.modelinglanguages.segmentation.metamodel.spec.javamodel.ISecuritySubZone> inSubZone) {
  ...
  public IssuingCASystemConfiguration setInheritServices(java.util.List<? extends cleon.architecturemethods.systemarc42.metamodel.spec.buildingblock_view.systemconfiguration.to_move.system.javamodel.ISystemConfiguration> inheritServices) {
  ...
  public IssuingCASystemConfiguration setInteracts(java.util.List<? extends cleon.common.modularity.metamodel.spec.javamodel.IInteraction> interacts) {
  ...
  public IssuingCASystemConfiguration setInterface(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.systemarc42.metamodel.spec.buildingblock_view.systemconfiguration.javamodel.IInterface> interface_) {
  ...
  public IssuingCASystemConfiguration setNoPackages(cleon.modelinglanguages.uml.metamodel.spec.structural.packages.javamodel.IPackage noPackages) {
  ...
  public IssuingCASystemConfiguration setPorts_In(IMultiMapOrdered<ch.actifsource.core.Resource, ? extends cleon.modelinglanguages.uml.metamodel.spec.structural.components.ports.javamodel.IPort_Required> ports_In) {
  ...
  public IssuingCASystemConfiguration setPorts_Out(java.util.List<? extends cleon.modelinglanguages.uml.metamodel.spec.structural.components.ports.javamodel.IPort_Provider> ports_Out) {
  ...
  public IssuingCASystemConfiguration setProvides(java.util.List<? extends cleon.architecturemethods.systemarc42.metamodel.spec.concepts.services.javamodel.IAbstractService> provides) {
  ...
  public IssuingCASystemConfiguration setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
  ...
  public IssuingCASystemConfiguration setUsingProducts(java.util.List<? extends cleon.architecturemethods.arc42.metamodel.spec._13_product_view.javamodel.IProduct> usingProducts) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,bf167f4d-02cb-11e9-9e58-33d596257b14,evUzfn0QvJk2cU200zHqGkdFzK8=] */
