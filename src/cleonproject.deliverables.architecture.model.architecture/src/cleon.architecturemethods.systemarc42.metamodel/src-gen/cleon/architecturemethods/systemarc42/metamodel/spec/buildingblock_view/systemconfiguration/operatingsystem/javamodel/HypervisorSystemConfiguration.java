...
public class HypervisorSystemConfiguration extends DynamicResource implements IHypervisorSystemConfiguration {
  ...
  public HypervisorSystemConfiguration setHasDependency(java.util.List<? extends cleon.architecturemethods.systemarc42.metamodel.spec.buildingblock_view.javamodel.ISystemConfigurationDependency> hasDependency) {
  ...
  public HypervisorSystemConfiguration setInheritServices(java.util.List<? extends cleon.architecturemethods.systemarc42.metamodel.spec.buildingblock_view.systemconfiguration.to_move.system.javamodel.ISystemConfiguration> inheritServices) {
  ...
  public HypervisorSystemConfiguration setInterface(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.systemarc42.metamodel.spec.buildingblock_view.systemconfiguration.javamodel.IInterface> interface_) {
  ...
  public HypervisorSystemConfiguration setProvides(java.util.List<? extends cleon.architecturemethods.systemarc42.metamodel.spec.concepts.services.javamodel.IAbstractService> provides) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,7f075e62-0296-11e9-9e58-33d596257b14,Q0/Jyt3m1D+9xmn0cr1Hx/kS5vM=] */
