...
public class AvailabilitySystemConfiguration extends DynamicResource implements IAvailabilitySystemConfiguration {
  ...
  @Override
  public cleon.architecturemethods.systemarc42.metamodel.spec.concepts.businesscontinuity.availability.javamodel.IAvailabilityConfiguration selectAvailability() {
    return _getSingle(cleon.architecturemethods.systemarc42.metamodel.spec.concepts.businesscontinuity.availability.javamodel.IAvailabilityConfiguration.class, cleon.architecturemethods.systemarc42.metamodel.spec.concepts.businesscontinuity.availability.AvailabilityPackage.AvailabilitySystemConfiguration_availability);
  }

  public AvailabilitySystemConfiguration setAvailability(cleon.architecturemethods.systemarc42.metamodel.spec.concepts.businesscontinuity.availability.javamodel.IAvailabilityConfiguration availability) {
    _setSingle(cleon.architecturemethods.systemarc42.metamodel.spec.concepts.businesscontinuity.availability.AvailabilityPackage.AvailabilitySystemConfiguration_availability, availability);
    return this;
  }
  ...
  public cleon.architecturemethods.systemarc42.metamodel.spec.buildingblock_view.javamodel.ISystemConfiguration selectSystemConfiguration() {
    return _getSingle(cleon.architecturemethods.systemarc42.metamodel.spec.buildingblock_view.javamodel.ISystemConfiguration.class, cleon.architecturemethods.systemarc42.metamodel.spec.concepts.businesscontinuity.availability.AvailabilityPackage.AvailabilitySystemConfiguration_systemConfiguration);
  }

  public AvailabilitySystemConfiguration setSystemConfiguration(cleon.architecturemethods.systemarc42.metamodel.spec.buildingblock_view.javamodel.ISystemConfiguration systemConfiguration) {
    _setSingle(cleon.architecturemethods.systemarc42.metamodel.spec.concepts.businesscontinuity.availability.AvailabilityPackage.AvailabilitySystemConfiguration_systemConfiguration, systemConfiguration);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(cleon.architecturemethods.systemarc42.metamodel.spec.buildingblock_view.javamodel.ISystemConfiguration.class, cleon.architecturemethods.systemarc42.metamodel.spec.concepts.businesscontinuity.availability.AvailabilityPackage.AvailabilitySystemConfiguration_systemConfiguration, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

  // toMeRelations
  
  public static java.util.List<cleon.architecturemethods.systemarc42.metamodel.spec.concepts.businesscontinuity.availability.javamodel.IAvailabilitySystemConfiguration> selectToMeSystemConfiguration(cleon.architecturemethods.systemarc42.metamodel.spec.buildingblock_view.javamodel.ISystemConfiguration object) {
  ...
  public static java.util.List<cleon.architecturemethods.systemarc42.metamodel.spec.concepts.businesscontinuity.availability.javamodel.IAvailabilitySystemConfiguration> selectToMeAvailability(cleon.architecturemethods.systemarc42.metamodel.spec.concepts.businesscontinuity.availability.javamodel.IAvailabilityConfiguration object) {
    return _getToMeList(object.getRepository(), cleon.architecturemethods.systemarc42.metamodel.spec.concepts.businesscontinuity.availability.javamodel.IAvailabilitySystemConfiguration.class, cleon.architecturemethods.systemarc42.metamodel.spec.concepts.businesscontinuity.availability.AvailabilityPackage.AvailabilitySystemConfiguration_availability, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,68803d0a-1e37-11e9-865e-41ef48a95f70,az2sWU/YUjmqxjC4Wa4/rBJAOTE=] */
