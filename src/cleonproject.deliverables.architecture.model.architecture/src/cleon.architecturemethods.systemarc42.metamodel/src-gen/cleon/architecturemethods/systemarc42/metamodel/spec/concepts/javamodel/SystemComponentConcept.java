...
public class SystemComponentConcept extends DynamicResource implements ISystemComponentConcept {
  ...
  public SystemComponentConcept setSystemComponent(cleon.architecturemethods.systemarc42.metamodel.spec.buildingblock_view.javamodel.ISystemComponent systemComponent) {
  ...
  public static java.util.List<cleon.architecturemethods.systemarc42.metamodel.spec.concepts.javamodel.ISystemComponentConcept> selectToMeSystemComponent(cleon.architecturemethods.systemarc42.metamodel.spec.buildingblock_view.javamodel.ISystemComponent object) {
    return _getToMeList(object.getRepository(), cleon.architecturemethods.systemarc42.metamodel.spec.concepts.javamodel.ISystemComponentConcept.class, cleon.architecturemethods.systemarc42.metamodel.spec.concepts.ConceptsPackage.SystemComponentConcept_systemComponent, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,ba5e31d6-f190-11e8-b3e7-15e2dd8d9b05,G/UPIOO0P5T8tnWjuHde93eBz4k=] */
