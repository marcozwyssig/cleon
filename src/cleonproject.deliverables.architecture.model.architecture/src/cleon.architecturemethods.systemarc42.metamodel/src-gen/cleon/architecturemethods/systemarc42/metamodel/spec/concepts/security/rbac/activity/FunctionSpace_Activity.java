package cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.activity;
...
import cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.FunctionSpace_RBAC.*;
import cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.activity.javamodel.IActivityRootGroups;
...
public class FunctionSpace_Activity {
  ...
  public static interface IActivityPermissionFunctions extends IDynamicResourceExtension {
    ...
    public cleon.architecturemethods.systemarc42.metamodel.spec.buildingblock_view.javamodel.ISystemConfiguration GetSystemConfiguration();
    ...
    public List<cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.activity.javamodel.IActivityPermission> AllActivityPermissionInDomain();
    ...
    public List<cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.role.javamodel.IRoleSystemComponent> AllUsedRoleSystemComponent();
  ...
  public static interface IActivityPermissionFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("f97abbec-016b-11ea-8b45-335c84231cb6")
    public java.lang.String GetId(final cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.activity.javamodel.IActivityPermission activityPermission);
  ...
  public static class ActivityPermissionFunctions {
    ...
    public static java.lang.String GetId(final cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.activity.javamodel.IActivityPermission activityPermission) {
  ...
  public static interface IPermissionsFunctions extends IDynamicResourceExtension {
    ...
    public List<cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.activity.javamodel.IPermissions> AllPermissions();
    ...
    public List<cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.activity.javamodel.IPermission> AllPermission();
  ...
  public static interface IActivityNetdomainGroupFunctions extends IDynamicResourceExtension {
    ...
    public List<cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.activity.javamodel.IActivityPermission> AllActivityPermissions();

    @IDynamicResourceExtension.MethodId("40656397-0d2c-11ea-b914-3dd9896c252a")
    public List<cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.activity.javamodel.IActivityPermission> AllAvailableActivityPermissions();
  ...
  public static interface IActivityNetdomainGroupFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("aaa0cf46-9c90-11e9-9b32-35cf2fd07621")
    public java.lang.Integer Max(final cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.activity.javamodel.IActivityNetdomainGroup activityNetdomainGroup);
  ...
  public static class ActivityNetdomainGroupFunctions {
    ...
    public static java.lang.Integer Max(final cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.activity.javamodel.IActivityNetdomainGroup activityNetdomainGroup) {
  ...
  public static interface IActivityRootGroupsFunctions extends IDynamicResourceExtension {
    ...
    public List<cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.activity.javamodel.IActivityNetdomainGroup> AllActivityNetDomaingroups();
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,512e5470-7f07-11e9-98a3-b1bd805f0a31,4myRd9nsFI/398dveVFEV0EFIV0=] */
