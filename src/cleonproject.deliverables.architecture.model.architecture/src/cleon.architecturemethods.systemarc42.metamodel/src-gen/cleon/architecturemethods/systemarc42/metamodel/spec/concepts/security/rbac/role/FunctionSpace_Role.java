package cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.role;
...
import cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.role.javamodel.IRoleRootGroups;
...
public class FunctionSpace_Role {
  ...
  public static interface IRoleSystemComponentFunctions extends IDynamicResourceExtension {
    ...
    public cleon.architecturemethods.systemarc42.metamodel.spec.deployment_view.environment.node.supplynode.javamodel.ISupplyNetDomainNode GetNetdomainNode();
    ...
    public List<cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.activity.javamodel.IActivityPermission> AllAvailalableActivityPermissions();

    @IDynamicResourceExtension.MethodId("40c5b1a6-c5ae-11e9-9daa-cf9f9f7341e8")
    public List<cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.role.javamodel.IRoleSystemComponent> AllRoleSystemComponentInDomain();
    ...
    public List<cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.role.javamodel.IRoleSystemComponent> AllRoleSystemComponentForBasedOn();

    @IDynamicResourceExtension.MethodId("e6a1f2c3-0deb-11ea-91d3-b3e983305cb0")
    public List<cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.role.javamodel.IRoleSystemComponent> OnlySameSystemComponent(final cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.role.javamodel.IRoleSystemComponent rolSysCmp);

    @IDynamicResourceExtension.MethodId("c9c3bdeb-0ded-11ea-91d3-b3e983305cb0")
    public List<cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.role.javamodel.IRoleSystemComponent> AllBasedOnReverse();

    @IDynamicResourceExtension.MethodId("e79cc584-0dee-11ea-91d3-b3e983305cb0")
    public List<cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.activity.javamodel.IActivityPermission> AllActivities();

    @IDynamicResourceExtension.MethodId("1f3413fb-0df0-11ea-91d3-b3e983305cb0")
    public List<cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.role.javamodel.IRoleSystemComponent> AllBasedOn();

    @IDynamicResourceExtension.MethodId("6478ecf0-0df0-11ea-91d3-b3e983305cb0")
    public List<cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.role.javamodel.IRoleSystemComponent> OnlyWithActivityPermission(final cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.activity.javamodel.IActivityPermission src);
  ...
  public static interface IRoleSystemComponentFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("7f5f2902-016c-11ea-8b45-335c84231cb6")
    public java.lang.String GetId(final cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.role.javamodel.IRoleSystemComponent roleSystemComponent);

    @IDynamicResourceExtension.MethodId("e6a1f2c3-0deb-11ea-91d3-b3e983305cb0")
    public List<cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.role.javamodel.IRoleSystemComponent> OnlySameSystemComponent(final cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.role.javamodel.IRoleSystemComponent rolSysCmp, final List<cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.role.javamodel.IRoleSystemComponent> roleSystemComponentList);

    @IDynamicResourceExtension.MethodId("6478ecf0-0df0-11ea-91d3-b3e983305cb0")
    public List<cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.role.javamodel.IRoleSystemComponent> OnlyWithActivityPermission(final cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.activity.javamodel.IActivityPermission src, final List<cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.role.javamodel.IRoleSystemComponent> roleSystemComponentList);
  ...
  public static class RoleSystemComponentFunctions {
    ...
    public static java.lang.String GetId(final cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.role.javamodel.IRoleSystemComponent roleSystemComponent) {
  ...
  public static interface IResponsibilitiesFunctions extends IDynamicResourceExtension {
    ...
    public List<cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.role.javamodel.IResponsibilities> AllResponsibilities();

    @IDynamicResourceExtension.MethodId("d89b4a54-809c-11e9-8e65-f3f639e40a34")
    public List<cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.role.javamodel.IResponsibility> AllResponsibility();
  ...
  public static interface IRoleRootGroupsFunctions extends IDynamicResourceExtension {
    ...
    public List<cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.role.javamodel.IRoleNetDomainGroup> AllRoleNetDomaingroups();
  ...
  public static interface IRoleNetDomainGroupFunctions extends IDynamicResourceExtension {
    ...
    public List<cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.role.javamodel.IRoleSystemComponent> AllRoleSystemComponents();

    @IDynamicResourceExtension.MethodId("274c8b92-07be-11ea-980e-578ab3bc55dc")
    public List<cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.role.javamodel.IRoleActorResponsibility> AllRoleActorResponsiblities();
  ...
  public static interface IRoleNetDomainGroupFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("79ca7b0b-9c8f-11e9-9b32-35cf2fd07621")
    public java.lang.Integer Max(final cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.role.javamodel.IRoleNetDomainGroup roleNetDomainGroup);
  ...
  public static class RoleNetDomainGroupFunctions {
    ...
    public static java.lang.Integer Max(final cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.role.javamodel.IRoleNetDomainGroup roleNetDomainGroup) {
  ...
  public static interface IRoleActorResponsibilityFunctions extends IDynamicResourceExtension {
    ...
    public List<cleon.architecturemethods.systemarc42.metamodel.spec.concepts.security.rbac.role.javamodel.IRoleActorResponsibility> AllRoleActorResponsibilityInDomain();
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,20a523c3-7f08-11e9-98a3-b1bd805f0a31,8nVICyKEY6dMjT4cP59mxz/wNng=] */
