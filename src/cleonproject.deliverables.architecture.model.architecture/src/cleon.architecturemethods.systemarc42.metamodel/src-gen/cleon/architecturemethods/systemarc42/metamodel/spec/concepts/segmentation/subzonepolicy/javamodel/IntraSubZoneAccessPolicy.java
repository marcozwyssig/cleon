...
public class IntraSubZoneAccessPolicy extends DynamicResource implements IIntraSubZoneAccessPolicy {
  ...
  @Override
  public cleon.architecturemethods.systemarc42.metamodel.spec.concepts.segmentation.subzonepolicy.javamodel.IRestriction selectRestriction() {
    return _getSingle(cleon.architecturemethods.systemarc42.metamodel.spec.concepts.segmentation.subzonepolicy.javamodel.IRestriction.class, cleon.architecturemethods.systemarc42.metamodel.spec.concepts.segmentation.subzonepolicy.SubzonepolicyPackage.IntraSubZoneAccessPolicy_restriction);
  }

  public IntraSubZoneAccessPolicy setRestriction(cleon.architecturemethods.systemarc42.metamodel.spec.concepts.segmentation.subzonepolicy.javamodel.IRestriction restriction) {
    _setSingle(cleon.architecturemethods.systemarc42.metamodel.spec.concepts.segmentation.subzonepolicy.SubzonepolicyPackage.IntraSubZoneAccessPolicy_restriction, restriction);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(cleon.architecturemethods.systemarc42.metamodel.spec.concepts.segmentation.subzonepolicy.javamodel.IRestriction.class, cleon.architecturemethods.systemarc42.metamodel.spec.concepts.segmentation.subzonepolicy.SubzonepolicyPackage.IntraSubZoneAccessPolicy_restriction, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

  // toMeRelations
  
  public static java.util.List<cleon.architecturemethods.systemarc42.metamodel.spec.concepts.segmentation.subzonepolicy.javamodel.IIntraSubZoneAccessPolicy> selectToMeRestriction(cleon.architecturemethods.systemarc42.metamodel.spec.concepts.segmentation.subzonepolicy.javamodel.IRestriction object) {
    return _getToMeList(object.getRepository(), cleon.architecturemethods.systemarc42.metamodel.spec.concepts.segmentation.subzonepolicy.javamodel.IIntraSubZoneAccessPolicy.class, cleon.architecturemethods.systemarc42.metamodel.spec.concepts.segmentation.subzonepolicy.SubzonepolicyPackage.IntraSubZoneAccessPolicy_restriction, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,bdd74804-b844-11e9-8760-2d4a9d15ec14,lNO2wPjo4UDpHVXHdEJJ9fFOo7I=] */
