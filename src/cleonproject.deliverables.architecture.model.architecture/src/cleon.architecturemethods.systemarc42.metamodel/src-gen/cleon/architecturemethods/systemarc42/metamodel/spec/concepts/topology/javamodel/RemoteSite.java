...
public class RemoteSite extends DynamicResource implements IRemoteSite {
  ...
  public RemoteSite setHosts(IMultiMapOrdered<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.systemarc42.metamodel.spec.concepts.topology.javamodel.IAbstractHost> hosts) {
  ...
  public RemoteSite setZone(cleon.modelinglanguages.segmentation.metamodel.spec.javamodel.INetDomainZone zone) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,f88f2a07-3635-11ea-b5c2-e3e297a45d39,qzTVdi6gSR7TsG8fOZhFJvMtoDU=] */
