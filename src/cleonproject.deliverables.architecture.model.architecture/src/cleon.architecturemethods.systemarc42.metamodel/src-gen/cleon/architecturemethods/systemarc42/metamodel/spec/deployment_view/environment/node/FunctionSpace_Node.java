package cleon.architecturemethods.systemarc42.metamodel.spec.deployment_view.environment.node;
...
public class FunctionSpace_Node {
  ...
  public static interface INodeFunctions extends IDynamicResourceExtension {
    ...
    public cleon.architecturemethods.systemarc42.metamodel.spec.deployment_view.environment.node.javamodel.INode GetParent();

    @IDynamicResourceExtension.MethodId("66093688-02d5-11e9-9e58-33d596257b14")
    public List<cleon.architecturemethods.systemarc42.metamodel.spec.deployment_view.environment.node.javamodel.ISupplyAndBuildNodeDecomposite> GetParents();

    @IDynamicResourceExtension.MethodId("8dd02a63-02d5-11e9-9e58-33d596257b14")
    public cleon.architecturemethods.systemarc42.metamodel.spec.deployment_view.environment.node.supplynode.javamodel.ISupplyNetDomainNode GetSubnetNode();

    @IDynamicResourceExtension.MethodId("bef20cb3-0e2a-11e9-8b4c-f9aec93d8b56")
    public cleon.architecturemethods.systemarc42.metamodel.spec.deployment_view.environment.node.supplynode.javamodel.ISupplyLocationNode GetLocationNode();
    ...
    public List<cleon.architecturemethods.systemarc42.metamodel.spec.deployment_view.environment.node.javamodel.INode> GetAllNestedNodes();
    ...
    public List<cleon.architecturemethods.systemarc42.metamodel.spec.deployment_view.environment.node.supplynode.javamodel.ISupplyNetDomainNode> GetAllNestedNetdomainNodes();
    ...
    public cleon.architecturemethods.systemarc42.metamodel.spec.deployment_view.environment.naming.javamodel.IDisplayNameStrategy GetDisplayNameStrategy();
    ...
    public cleon.architecturemethods.systemarc42.metamodel.spec.deployment_view.environment.javamodel.ICustomer GetCustomer();

    @IDynamicResourceExtension.MethodId("9e96171b-6d92-11e9-b84d-d319514e887f")
    public List<cleon.architecturemethods.systemarc42.metamodel.spec.deployment_view.environment.node.buildnode.javamodel.IBuildNode> GetAllNestedBuildNodes();

    @IDynamicResourceExtension.MethodId("b402dc7d-7ae0-11e9-a70f-4dc03941a024")
    public List<cleon.architecturemethods.systemarc42.metamodel.spec.deployment_view.environment.node.supplynode.javamodel.ISupplyNetDomainNode> GetAllNestedNetDomain();
    ...
    public List<cleon.architecturemethods.systemarc42.metamodel.spec.buildingblock_view.javamodel.ISystemComponent> GetAllUsedSystemComponent();

    @IDynamicResourceExtension.MethodId("f7c1ba46-7f15-11e9-9a52-07d4b074defc")
    public List<cleon.architecturemethods.systemarc42.metamodel.spec.buildingblock_view.javamodel.ISystemConfiguration> GetAllUsedSystemConfiguration();
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,41a52ff4-0b73-11e9-a136-69d076e48ed1,tWzYWdtkleRH1MYCDISVkhf8D7Y=] */
