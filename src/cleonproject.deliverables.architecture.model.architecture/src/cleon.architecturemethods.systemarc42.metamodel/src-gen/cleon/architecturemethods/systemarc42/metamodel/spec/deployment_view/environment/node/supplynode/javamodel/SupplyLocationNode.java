...
public class SupplyLocationNode extends DynamicResource implements ISupplyLocationNode {
  ...
  public SupplyLocationNode setBuildNodes(java.util.List<? extends cleon.architecturemethods.systemarc42.metamodel.spec.deployment_view.environment.node.buildnode.javamodel.IBuildNode> buildNodes) {
  ...
  public SupplyLocationNode setNodes(java.util.List<? extends cleon.architecturemethods.systemarc42.metamodel.spec.deployment_view.environment.node.javamodel.INode> nodes) {
  ...
  public SupplyLocationNode setSuppliedNodes(java.util.List<? extends cleon.architecturemethods.systemarc42.metamodel.spec.deployment_view.environment.node.supplynode.javamodel.ISupplyNode> suppliedNodes) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,e265052b-0aaa-11e9-8a91-633e556ac68f,CZFQow8UkOYlkm4vY781qE44feU=] */
