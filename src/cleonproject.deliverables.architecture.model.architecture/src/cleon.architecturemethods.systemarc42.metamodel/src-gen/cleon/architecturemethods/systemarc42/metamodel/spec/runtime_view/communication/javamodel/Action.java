...
public class Action extends DynamicResource implements IAction {
  ...
  public boolean isAccept() {
    return getResource().equals(cleon.architecturemethods.systemarc42.metamodel.spec.runtime_view.communication.CommunicationPackage.Action_Accept);
  }
  
  @Override
  public boolean isDrop() {
    return getResource().equals(cleon.architecturemethods.systemarc42.metamodel.spec.runtime_view.communication.CommunicationPackage.Action_Drop);
  }
  
  @Override
  public boolean isReject() {
    return getResource().equals(cleon.architecturemethods.systemarc42.metamodel.spec.runtime_view.communication.CommunicationPackage.Action_Reject);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,e7b78922-dfaa-11e9-9827-a1514ee8d06a,FaSrg6sKJ0C+Y4ZBrP2ZdhHqkus=] */
