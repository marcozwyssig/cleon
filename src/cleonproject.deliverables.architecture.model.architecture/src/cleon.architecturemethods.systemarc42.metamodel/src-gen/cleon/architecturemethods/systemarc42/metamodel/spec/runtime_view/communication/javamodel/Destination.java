...
public class Destination extends DynamicResource implements IDestination {
  ...
  public java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.systemarc42.metamodel.spec.runtime_view.communication.javamodel.IDestinationSubSecurityZone> selectDestinationSubSecurityZone() {
    return _getMap(cleon.architecturemethods.systemarc42.metamodel.spec.runtime_view.communication.javamodel.IDestinationSubSecurityZone.class, cleon.architecturemethods.systemarc42.metamodel.spec.runtime_view.communication.CommunicationPackage.Destination_destinationSubSecurityZone);
  }

  public Destination setDestinationSubSecurityZone(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.architecturemethods.systemarc42.metamodel.spec.runtime_view.communication.javamodel.IDestinationSubSecurityZone> destinationSubSecurityZone) {
    _setMap(cleon.architecturemethods.systemarc42.metamodel.spec.runtime_view.communication.CommunicationPackage.Destination_destinationSubSecurityZone, destinationSubSecurityZone);
    return this;
  }
  ...
  public static cleon.architecturemethods.systemarc42.metamodel.spec.runtime_view.communication.javamodel.IDestination selectToMeDestinationSubSecurityZone(cleon.architecturemethods.systemarc42.metamodel.spec.runtime_view.communication.javamodel.IDestinationSubSecurityZone object) {
    return _getToMeSingle(object.getRepository(), cleon.architecturemethods.systemarc42.metamodel.spec.runtime_view.communication.javamodel.IDestination.class, cleon.architecturemethods.systemarc42.metamodel.spec.runtime_view.communication.CommunicationPackage.Destination_destinationSubSecurityZone, object.getResource());
  }
