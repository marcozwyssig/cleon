...
public class Track extends DynamicResource implements ITrack {
  ...
  public boolean isLog() {
    return getResource().equals(cleon.architecturemethods.systemarc42.metamodel.spec.runtime_view.communication.CommunicationPackage.Track_Log);
  }
  
  @Override
  public boolean isNone() {
    return getResource().equals(cleon.architecturemethods.systemarc42.metamodel.spec.runtime_view.communication.CommunicationPackage.Track_None);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,eb22793b-dfaa-11e9-9827-a1514ee8d06a,u48EwPx4GQq9iuydVVcKCgiidM0=] */
