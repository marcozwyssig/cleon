...
public class FunctionSpace_Deployment_Plantuml {
  ...
  public static interface IDeploymentDiagramFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("d316009e-0eb3-11e9-9f19-6d15636f4ecc")
    public java.lang.Boolean onlyOneLayer(final cleon.architecturemethods.systemarc42.metamodel.spec.diagram.javamodel.IDeploymentDiagram deploymentDiagram);

    @IDynamicResourceExtension.MethodId("c044124c-1977-11e9-b3a0-d155f11f9df1")
    public java.lang.Boolean leftToRight(final cleon.architecturemethods.systemarc42.metamodel.spec.diagram.javamodel.IDeploymentDiagram deploymentDiagram);

    @IDynamicResourceExtension.MethodId("5104adea-1980-11e9-88a0-1f786f12e4c1")
    public java.lang.Boolean renderHidden(final cleon.architecturemethods.systemarc42.metamodel.spec.diagram.javamodel.IDeploymentDiagram deploymentDiagram);
  ...
  public static class DeploymentDiagramFunctions {
    ...
    public static java.lang.Boolean onlyOneLayer(final cleon.architecturemethods.systemarc42.metamodel.spec.diagram.javamodel.IDeploymentDiagram deploymentDiagram) {
    ...
    public static java.lang.Boolean leftToRight(final cleon.architecturemethods.systemarc42.metamodel.spec.diagram.javamodel.IDeploymentDiagram deploymentDiagram) {
    ...
    public static java.lang.Boolean renderHidden(final cleon.architecturemethods.systemarc42.metamodel.spec.diagram.javamodel.IDeploymentDiagram deploymentDiagram) {
