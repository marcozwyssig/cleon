...
public class qos__T_yaml {
  ...
  public static interface IQoSSystemConfigurationSourceFunctions extends IDynamicResourceExtension {
    ...
    public List<cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.qos.javamodel.IQoSSystemConfigurationSource> WithoutDF();
  ...
  public static interface IQoSSystemConfigurationSourceFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("da9e57ef-5289-11ec-9fcc-f3bdcf3059b2")
    public List<cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.qos.javamodel.IQoSSystemConfigurationSource> WithoutDF(final List<cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.qos.javamodel.IQoSSystemConfigurationSource> qoSSystemConfigurationSourceList);
  ...
  public static class QoSSystemConfigurationSourceFunctions {
    ...
    public static List<cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.qos.javamodel.IQoSSystemConfigurationSource> WithoutDF(final List<cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.qos.javamodel.IQoSSystemConfigurationSource> qoSSystemConfigurationSourceList) {
  ...
  public static interface IQoSSystemConfigurationConceptFunctions extends IDynamicResourceExtension {
    ...
    public List<cleon.architecturemethods.systemarc42.metamodel.spec._08_concepts.qos.javamodel.IQoSSystemConfigurationConcept> OnlyWithOperationSystem();
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,7efd3326-a0e1-11ea-8daa-afb4679c3497,RojnZVTZBoC4zJWT6cMC7iuy8HY=] */
