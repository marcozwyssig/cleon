...
public class FunctionSpace_XML {
  ...
  public interface IAbstractLogicalNetworkFunctions extends IDynamicResourceExtension {
    ...
    @IDynamicResourceExtension.MethodId("6bded80b-90d9-11e9-b29b-f1077960b1fa") List<cleon.modelinglanguages.network.metamodel.spec.javamodel.INetworkSubZone> allNetworkSubZone();
  ...
  public interface IAbstractNetworkFunctions extends IDynamicResourceExtension {
    ...
    @IDynamicResourceExtension.MethodId("2cdd8a41-90d9-11e9-b29b-f1077960b1fa") List<cleon.modelinglanguages.network.metamodel.spec.javamodel.INetworkSubZone> allNetworkSubZone();
  ...
  public interface IAbstractNetworkNodeFunctions extends IDynamicResourceExtension {
    ...
    @IDynamicResourceExtension.MethodId("cc27a06d-90da-11e9-b29b-f1077960b1fa") java.lang.String Name();
  ...
  public interface IGatewayNodeFunctions extends IDynamicResourceExtension {
    ...
    @IDynamicResourceExtension.MethodId("d9629f1d-90da-11e9-b29b-f1077960b1fa") java.lang.String Name();
  ...
  public interface IHostNodeFunctions extends IDynamicResourceExtension {
    ...
    @IDynamicResourceExtension.MethodId("de1344bb-4836-11ea-a9d8-93d0ce680cba") java.lang.String Name();
  ...
  public interface INamedNetworkNodeFunctions extends IDynamicResourceExtension {
    ...
    @IDynamicResourceExtension.MethodId("f53b3933-90da-11e9-b29b-f1077960b1fa") java.lang.String Name();
  ...
  public interface INamedPhysicalNetworkFunctions extends IDynamicResourceExtension {

    @IDynamicResourceExtension.MethodId("7f94024f-90d9-11e9-b29b-f1077960b1fa") List<cleon.modelinglanguages.network.metamodel.spec.javamodel.INetworkSubZone> allNetworkSubZone();

  }

  public interface INamedPhysicalNetworkFunctionsImpl extends IDynamicResourceExtensionJavaImpl {

    @IDynamicResourceExtension.MethodId("7f94024f-90d9-11e9-b29b-f1077960b1fa") List<cleon.modelinglanguages.network.metamodel.spec.javamodel.INetworkSubZone> allNetworkSubZone(final cleon.modelinglanguages.network.metamodel.spec.javamodel.INamedPhysicalNetwork namedPhysicalNetwork);

  }

  public interface INetworkNodeFunctions extends IDynamicResourceExtension {

    @IDynamicResourceExtension.MethodId("fd21c5e8-90da-11e9-b29b-f1077960b1fa") java.lang.String Name();
  ...
  public interface INetworkSubZoneFunctions extends IDynamicResourceExtension {

    @IDynamicResourceExtension.MethodId("8bcea7c8-90d9-11e9-b29b-f1077960b1fa") List<cleon.modelinglanguages.network.metamodel.spec.javamodel.INetworkSubZone> allNetworkSubZone();

    @IDynamicResourceExtension.MethodId("388e8b74-b213-11ea-a3a2-e9d3344bee73") cleon.modelinglanguages.network.metamodel.spec.ipv4.javamodel.IIPv4_Mask GetCidr(final java.lang.String cidr);

  }

  public interface INetworkSubZoneFunctionsImpl extends IDynamicResourceExtensionJavaImpl {

    @IDynamicResourceExtension.MethodId("388e8b74-b213-11ea-a3a2-e9d3344bee73") cleon.modelinglanguages.network.metamodel.spec.ipv4.javamodel.IIPv4_Mask GetCidr(final java.lang.String cidr, final cleon.modelinglanguages.network.metamodel.spec.javamodel.INetworkSubZone networkSubZone);
