...
public class ArchitectureSolutionBuildingBlock extends DynamicResource implements IArchitectureSolutionBuildingBlock {
  ...
  public ArchitectureSolutionBuildingBlock setDecompose(java.util.List<? extends cleon.common.modularity.spec.buildingblock.javamodel.IBuildingBlock> decompose) {
  ...
  public ArchitectureSolutionBuildingBlock setDecomposePackages(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.packages.javamodel.IPackage> decomposePackages) {
  ...
  public ArchitectureSolutionBuildingBlock setInteracts(java.util.List<? extends cleon.common.modularity.spec.buildingblock.javamodel.IInteraction> interacts) {
  ...
  public ArchitectureSolutionBuildingBlock setNoPackages(cleon.modelinglanguages.uml.spec.uml2.structural.packages.javamodel.IPackage noPackages) {
  ...
  public ArchitectureSolutionBuildingBlock setPorts_In(IMultiMapOrdered<ch.actifsource.core.Resource, ? extends cleon.modelinglanguages.uml.spec.uml2.structural.components.ports.javamodel.IPort_Required> ports_In) {
  ...
  public ArchitectureSolutionBuildingBlock setPorts_Out(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.components.ports.javamodel.IPort_Provider> ports_Out) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,5b960871-3a07-11e6-a354-253097f89a49,2FYSAcNTlZssvw6dVnP6wEwJnjI=] */
