...
public class SolutionBuildingBlockComponent extends DynamicResource implements ISolutionBuildingBlockComponent {
  ...
  public SolutionBuildingBlockComponent setDecompose(java.util.List<? extends cleon.common.modularity.spec.buildingblock.javamodel.IBuildingBlock> decompose) {
  ...
  public SolutionBuildingBlockComponent setDecomposePackages(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.packages.javamodel.IPackage> decomposePackages) {
  ...
  public SolutionBuildingBlockComponent setNoPackages(cleon.modelinglanguages.uml.spec.uml2.structural.packages.javamodel.IPackage noPackages) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,31890305-33a2-11e6-94cd-fbf6c8ccd08d,9+ZK1nUyCypl2CM/SgITOdkFOWg=] */
