package cleon.building.gradle.spec.plugin.javamodel;
...
public class Plugin extends DynamicResource implements IPlugin {
  ...
  public java.lang.String selectNamespace() {
    return _getSingleAttribute(java.lang.String.class, cleon.building.gradle.spec.plugin.PluginPackage.Plugin_namespace);
  }
    
  public void setNamespace(java.lang.String namespace) {
     _setSingleAttribute(cleon.building.gradle.spec.plugin.PluginPackage.Plugin_namespace, namespace);
  }
  ...
  @Override
  public java.util.List<? extends cleon.building.gradle.spec.plugin.javamodel.ITask> selectTasks() {
    return _getList(cleon.building.gradle.spec.plugin.javamodel.ITask.class, cleon.building.gradle.spec.plugin.PluginPackage.Plugin_tasks);
  }

  public Plugin setTasks(java.util.List<? extends cleon.building.gradle.spec.plugin.javamodel.ITask> tasks) {
    _setList(cleon.building.gradle.spec.plugin.PluginPackage.Plugin_tasks, tasks);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingleAttribute(java.lang.String.class, cleon.building.gradle.spec.plugin.PluginPackage.Plugin_namespace, visitor);
    // relations
    ...
    _acceptList(cleon.building.gradle.spec.plugin.javamodel.ITask.class, cleon.building.gradle.spec.plugin.PluginPackage.Plugin_tasks, visitor);
  ...
  public static cleon.building.gradle.spec.plugin.javamodel.IPlugin selectToMeTasks(cleon.building.gradle.spec.plugin.javamodel.ITask object) {
    return _getToMeSingle(object.getRepository(), cleon.building.gradle.spec.plugin.javamodel.IPlugin.class, cleon.building.gradle.spec.plugin.PluginPackage.Plugin_tasks, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,8ae372cf-c0a8-11e7-a130-7198de5ddf3f,mGMLz/hl4xs4itC15CPSpHrxB9g=] */
