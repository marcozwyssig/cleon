...
public class Result extends DynamicResource implements IResult {
  ...
  @Override
  public cleon.common.analysis.spec.analysis.solution.evaluation.javamodel.IBest selectBest() {
    return _getSingle(cleon.common.analysis.spec.analysis.solution.evaluation.javamodel.IBest.class, cleon.common.analysis.spec.analysis.solution.evaluation.EvaluationPackage.Result_best);
  }

  public Result setBest(cleon.common.analysis.spec.analysis.solution.evaluation.javamodel.IBest best) {
    _setSingle(cleon.common.analysis.spec.analysis.solution.evaluation.EvaluationPackage.Result_best, best);
    return this;
  }
  ...
  public Result setChapters(java.util.List<? extends cleon.common.doc.spec.doc.chapter.javamodel.IChapter> chapters) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    // relations
    _acceptSingle(cleon.common.analysis.spec.analysis.solution.evaluation.javamodel.IBest.class, cleon.common.analysis.spec.analysis.solution.evaluation.EvaluationPackage.Result_best, visitor);
  ...
  public static cleon.common.analysis.spec.analysis.solution.evaluation.javamodel.IResult selectToMeBest(cleon.common.analysis.spec.analysis.solution.evaluation.javamodel.IBest object) {
    return _getToMeSingle(object.getRepository(), cleon.common.analysis.spec.analysis.solution.evaluation.javamodel.IResult.class, cleon.common.analysis.spec.analysis.solution.evaluation.EvaluationPackage.Result_best, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,11cf7692-3c2a-11e5-9962-cf3035adb922,wtuF42vtBMsLo+ueWVd5iiHAu6I=] */
