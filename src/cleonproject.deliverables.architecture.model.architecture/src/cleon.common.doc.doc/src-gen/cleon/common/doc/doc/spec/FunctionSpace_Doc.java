package cleon.common.doc.doc.spec;
...
public class FunctionSpace_Doc {
  ...
  public static interface IDocumentElementFunctions extends IDynamicResourceExtension {
    ...
    public cleon.common.doc.doc.spec.javamodel.IDocumentElement GetParent();

    @IDynamicResourceExtension.MethodId("f6950a72-084c-11e9-9ee8-c54fda7ab431")
    public List<cleon.common.doc.doc.spec.javamodel.IDocumentElement> GetSelfAndParents();

    @IDynamicResourceExtension.MethodId("1dc27d5b-084d-11e9-9ee8-c54fda7ab431")
    public cleon.common.doc.doc.spec.document.javamodel.IDocument GetDocument();

    @IDynamicResourceExtension.MethodId("14db2ced-2235-11e9-a054-db6d80fba790")
    public cleon.common.doc.doc.spec.documentlanguage.javamodel.IDocumentLanguage GetRenderLanguage();
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,cc8dc39e-084c-11e9-9ee8-c54fda7ab431,IY/iMQC6UlPK+r7zk68yvFbemOU=] */
