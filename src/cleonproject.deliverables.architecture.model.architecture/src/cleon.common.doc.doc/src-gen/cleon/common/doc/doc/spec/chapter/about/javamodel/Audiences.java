...
public class Audiences extends DynamicResource implements IAudiences {
  ...
  public Audiences setChapters(java.util.List<? extends cleon.common.doc.doc.spec.chapter.javamodel.IChapter> chapters) {
  ...
  public Audiences setDocumentElements(java.util.List<? extends cleon.common.doc.doc.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public Audiences setParagraphs(java.util.List<? extends cleon.common.doc.doc.spec.paragraph.javamodel.IStandardParagraph> paragraphs) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,166170e0-0785-11e9-99e7-97cc29f85ed6,X7UavzcEFm6zSb7DbD3baDf3oE8=] */
