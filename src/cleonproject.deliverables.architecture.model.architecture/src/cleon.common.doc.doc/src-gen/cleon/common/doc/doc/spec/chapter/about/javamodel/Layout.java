...
public class Layout extends DynamicResource implements ILayout {
  ...
  @Override
  public java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.doc.doc.spec.chapter.about.javamodel.IChapterDescription> selectChapterDescription() {
    return _getMap(cleon.common.doc.doc.spec.chapter.about.javamodel.IChapterDescription.class, cleon.common.doc.doc.spec.chapter.about.AboutPackage.Layout_chapterDescription);
  }

  public Layout setChapterDescription(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.doc.doc.spec.chapter.about.javamodel.IChapterDescription> chapterDescription) {
    _setMap(cleon.common.doc.doc.spec.chapter.about.AboutPackage.Layout_chapterDescription, chapterDescription);
    return this;
  }
  ...
  public Layout setChapters(java.util.List<? extends cleon.common.doc.doc.spec.chapter.javamodel.IChapter> chapters) {
  ...
  public Layout setDocumentElements(java.util.List<? extends cleon.common.doc.doc.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public Layout setParagraphs(java.util.List<? extends cleon.common.doc.doc.spec.paragraph.javamodel.IStandardParagraph> paragraphs) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    // relations
    _acceptMap(cleon.common.doc.doc.spec.chapter.about.javamodel.IChapterDescription.class, cleon.common.doc.doc.spec.chapter.about.AboutPackage.Layout_chapterDescription, visitor);
  ...
  public static cleon.common.doc.doc.spec.chapter.about.javamodel.ILayout selectToMeChapterDescription(cleon.common.doc.doc.spec.chapter.about.javamodel.IChapterDescription object) {
    return _getToMeSingle(object.getRepository(), cleon.common.doc.doc.spec.chapter.about.javamodel.ILayout.class, cleon.common.doc.doc.spec.chapter.about.AboutPackage.Layout_chapterDescription, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,858bbbc1-0786-11e9-99e7-97cc29f85ed6,OEsl/bCOZzw84/11N/dhRcYpBx0=] */
