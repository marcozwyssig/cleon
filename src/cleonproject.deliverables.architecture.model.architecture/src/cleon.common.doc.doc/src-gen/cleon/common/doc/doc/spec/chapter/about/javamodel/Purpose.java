...
public class Purpose extends DynamicResource implements IPurpose {
  ...
  public Purpose setChapters(java.util.List<? extends cleon.common.doc.doc.spec.chapter.javamodel.IChapter> chapters) {
  ...
  public Purpose setDocumentElements(java.util.List<? extends cleon.common.doc.doc.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public Purpose setParagraphs(java.util.List<? extends cleon.common.doc.doc.spec.paragraph.javamodel.IStandardParagraph> paragraphs) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,6b94c4bb-0784-11e9-99e7-97cc29f85ed6,2RqUdXeLd0jQ/UESSO8ZkitW3kg=] */
