...
public class NamedChapter extends DynamicResource implements INamedChapter {
  ...
  public NamedChapter setChapters(java.util.List<? extends cleon.common.doc.doc.spec.chapter.javamodel.IChapter> chapters) {
  ...
  public NamedChapter setDocumentElements(java.util.List<? extends cleon.common.doc.doc.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public NamedChapter setParagraphs(java.util.List<? extends cleon.common.doc.doc.spec.paragraph.javamodel.IStandardParagraph> paragraphs) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,5df8cdae-e98c-11e8-af5c-a5aa9dc47205,TnuWNrQyuy9MSrL0eTSL5tt+3OY=] */
