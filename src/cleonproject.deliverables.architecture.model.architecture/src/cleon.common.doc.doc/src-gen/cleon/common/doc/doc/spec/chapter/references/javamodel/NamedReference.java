...
public class NamedReference extends DynamicResource implements INamedReference {
  ...
  public java.net.URL selectSource() {
    return _getSingleAttribute(java.net.URL.class, cleon.common.doc.doc.spec.chapter.references.ReferencesPackage.Reference_source);
  }
    
  public void setSource(java.net.URL source) {
     _setSingleAttribute(cleon.common.doc.doc.spec.chapter.references.ReferencesPackage.Reference_source, source);
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingleAttribute(java.net.URL.class, cleon.common.doc.doc.spec.chapter.references.ReferencesPackage.Reference_source, visitor);
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,13280843-0766-11e9-9896-ef29067b4914,z7OFoglHDbmT3O+fvyia7M2Kt58=] */
