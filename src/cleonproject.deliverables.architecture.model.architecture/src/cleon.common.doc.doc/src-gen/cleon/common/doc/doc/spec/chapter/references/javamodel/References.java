package cleon.common.doc.doc.spec.chapter.references.javamodel;
...
public class References extends DynamicResource implements IReferences {
  ...
  public References setChapters(java.util.List<? extends cleon.common.doc.doc.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public References setDocumentElements(java.util.List<? extends cleon.common.doc.doc.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public References setNoChapters(cleon.common.doc.doc.spec.chapter.javamodel.IAbstractChapter noChapters) {
  ...
  public References setParagraphs(java.util.List<? extends cleon.common.doc.doc.spec.paragraph.javamodel.IParagraph> paragraphs) {
    _setList(cleon.common.doc.doc.spec.chapter.ChapterPackage.ParagraphAware_paragraphs, paragraphs);
    return this;
  }
    
  @Override
  public java.util.List<? extends cleon.common.doc.doc.spec.chapter.references.javamodel.IReference> selectReferences() {
    return _getList(cleon.common.doc.doc.spec.chapter.references.javamodel.IReference.class, cleon.common.doc.doc.spec.chapter.references.ReferencesPackage.References_references);
  }

  public References setReferences(java.util.List<? extends cleon.common.doc.doc.spec.chapter.references.javamodel.IReference> references) {
    _setList(cleon.common.doc.doc.spec.chapter.references.ReferencesPackage.References_references, references);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptList(cleon.common.doc.doc.spec.chapter.references.javamodel.IReference.class, cleon.common.doc.doc.spec.chapter.references.ReferencesPackage.References_references, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

  // toMeRelations
  
  public static cleon.common.doc.doc.spec.chapter.references.javamodel.IReferences selectToMeReferences(cleon.common.doc.doc.spec.chapter.references.javamodel.IReference object) {
    return _getToMeSingle(object.getRepository(), cleon.common.doc.doc.spec.chapter.references.javamodel.IReferences.class, cleon.common.doc.doc.spec.chapter.references.ReferencesPackage.References_references, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,f490007b-0765-11e9-9896-ef29067b4914,lTUByfXH7PzixPYJt1+kTSyb1Hw=] */
