...
public class Document extends DynamicResource implements IDocument {
  ...
  public Document setChapters(java.util.List<? extends cleon.common.doc.doc.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public Document setDocumentElements(java.util.List<? extends cleon.common.doc.doc.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public Document setDocumentLanguage(java.util.List<? extends cleon.common.doc.doc.spec.documentlanguage.javamodel.IDocumentLanguage> documentLanguage) {
  ...
  public Document setProperties(cleon.common.doc.doc.spec.document.properties.javamodel.IProperties properties) {
  ...
  public Document setStyle(cleon.common.doc.doc.spec.document.style.javamodel.IStyle style) {
  ...
  public static java.util.List<cleon.common.doc.doc.spec.document.javamodel.IDocument> selectToMeStyle(cleon.common.doc.doc.spec.document.style.javamodel.IStyle object) {
    return _getToMeList(object.getRepository(), cleon.common.doc.doc.spec.document.javamodel.IDocument.class, cleon.common.doc.doc.spec.document.DocumentPackage.Document_style, object.getResource());
  }
  
  public static cleon.common.doc.doc.spec.document.javamodel.IDocument selectToMeProperties(cleon.common.doc.doc.spec.document.properties.javamodel.IProperties object) {
    return _getToMeSingle(object.getRepository(), cleon.common.doc.doc.spec.document.javamodel.IDocument.class, cleon.common.doc.doc.spec.document.DocumentPackage.Document_properties, object.getResource());
  }
  
  public static cleon.common.doc.doc.spec.document.javamodel.IDocument selectToMeDocumentLanguage(cleon.common.doc.doc.spec.documentlanguage.javamodel.IDocumentLanguage object) {
    return _getToMeSingle(object.getRepository(), cleon.common.doc.doc.spec.document.javamodel.IDocument.class, cleon.common.doc.doc.spec.document.DocumentPackage.Document_documentLanguage, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,fd0b0ad8-28bc-11e5-bdaf-69a48f49df43,5iy9qAUd23s5q0Az7rIqbQImD2U=] */
