...
public class NamedDocument extends DynamicResource implements INamedDocument {
  ...
  public NamedDocument setChapters(java.util.List<? extends cleon.common.doc.doc.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public NamedDocument setDocumentElements(java.util.List<? extends cleon.common.doc.doc.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public NamedDocument setDocumentLanguage(java.util.List<? extends cleon.common.doc.doc.spec.documentlanguage.javamodel.IDocumentLanguage> documentLanguage) {
  ...
  public NamedDocument setProperties(cleon.common.doc.doc.spec.document.properties.javamodel.IProperties properties) {
  ...
  public NamedDocument setStyle(cleon.common.doc.doc.spec.document.style.javamodel.IStyle style) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,3e870b86-d86d-11e4-aa2f-c11242a92b60,nK2nSqyQqxx9UtC+WssURM4f988=] */
