...
public class Cell extends DynamicResource implements ICell {
  ...
  @Override
  public cleon.common.doc.doc.spec.paragraph.table.javamodel.IColumn selectColumn() {
    return _getSingle(cleon.common.doc.doc.spec.paragraph.table.javamodel.IColumn.class, cleon.common.doc.doc.spec.paragraph.table.TablePackage.Cell_column);
  }

  public Cell setColumn(cleon.common.doc.doc.spec.paragraph.table.javamodel.IColumn column) {
    _setSingle(cleon.common.doc.doc.spec.paragraph.table.TablePackage.Cell_column, column);
    return this;
  }
  ...
  public Cell setDocumentElements(java.util.List<? extends cleon.common.doc.doc.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public Cell setParagraphs(java.util.List<? extends cleon.common.doc.doc.spec.paragraph.javamodel.IParagraph> paragraphs) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    // relations
    _acceptSingle(cleon.common.doc.doc.spec.paragraph.table.javamodel.IColumn.class, cleon.common.doc.doc.spec.paragraph.table.TablePackage.Cell_column, visitor);
  ...
  public static java.util.List<cleon.common.doc.doc.spec.paragraph.table.javamodel.ICell> selectToMeColumn(cleon.common.doc.doc.spec.paragraph.table.javamodel.IColumn object) {
    return _getToMeList(object.getRepository(), cleon.common.doc.doc.spec.paragraph.table.javamodel.ICell.class, cleon.common.doc.doc.spec.paragraph.table.TablePackage.Cell_column, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,37a450a4-3c4a-11e5-871f-6beac6a7c24b,eUyQgmcWErwtYE/h8Sa5utZ3U7Q=] */
