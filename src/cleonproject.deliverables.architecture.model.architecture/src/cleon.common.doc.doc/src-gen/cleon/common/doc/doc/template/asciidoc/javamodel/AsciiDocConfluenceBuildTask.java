package cleon.common.doc.doc.template.asciidoc.javamodel;
...
public class AsciiDocConfluenceBuildTask extends DynamicResource implements IAsciiDocConfluenceBuildTask {
  ...
  public java.lang.String selectHost() {
    return _getSingleAttribute(java.lang.String.class, cleon.common.doc.doc.template.asciidoc.AsciidocPackage.AsciiDocConfluenceBuildTask_host);
  }
    
  public void setHost(java.lang.String host) {
     _setSingleAttribute(cleon.common.doc.doc.template.asciidoc.AsciidocPackage.AsciiDocConfluenceBuildTask_host, host);
  }

  @Override
  public java.lang.String selectSpaceKey() {
    return _getSingleAttribute(java.lang.String.class, cleon.common.doc.doc.template.asciidoc.AsciidocPackage.AsciiDocConfluenceBuildTask_spaceKey);
  }
    
  public void setSpaceKey(java.lang.String spaceKey) {
     _setSingleAttribute(cleon.common.doc.doc.template.asciidoc.AsciidocPackage.AsciiDocConfluenceBuildTask_spaceKey, spaceKey);
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    // attributes
    _acceptSingleAttribute(java.lang.String.class, cleon.common.doc.doc.template.asciidoc.AsciidocPackage.AsciiDocConfluenceBuildTask_host, visitor);
    _acceptSingleAttribute(java.lang.String.class, cleon.common.doc.doc.template.asciidoc.AsciidocPackage.AsciiDocConfluenceBuildTask_spaceKey, visitor);
    // relations
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,de19b8fe-65f5-11e7-a25d-b350312fe5de,dcKfonk6Tsa2A7PdZyE4QEdP4Dw=] */
