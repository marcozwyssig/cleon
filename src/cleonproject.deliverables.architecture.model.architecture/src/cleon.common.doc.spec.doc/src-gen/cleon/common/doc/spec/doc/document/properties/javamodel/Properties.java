...
public class Properties extends DynamicResource implements IProperties {
  ...
  public Properties setAuthors(java.util.List<? extends cleon.common.doc.spec.doc.document.properties.member.javamodel.IMember> authors) {
  ...
  public Properties setCustomer(cleon.common.doc.spec.doc.document.properties.javamodel.ICustomer customer) {
  ...
  public Properties setDistributers(java.util.List<? extends cleon.common.doc.spec.doc.document.properties.member.javamodel.IMember> distributers) {
  ...
  public Properties setProject(cleon.common.doc.spec.doc.document.properties.javamodel.IProject project) {
  ...
  public Properties setReviewers(java.util.List<? extends cleon.common.doc.spec.doc.document.properties.member.javamodel.IMember> reviewers) {
  ...
  public static java.util.List<cleon.common.doc.spec.doc.document.properties.javamodel.IProperties> selectToMeCustomer(cleon.common.doc.spec.doc.document.properties.javamodel.ICustomer object) {
    return _getToMeList(object.getRepository(), cleon.common.doc.spec.doc.document.properties.javamodel.IProperties.class, cleon.common.doc.spec.doc.document.properties.PropertiesPackage.Properties_customer, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,a052f72d-47f5-11e6-b388-8539f6ff7310,67lCeKe7vTIWQxHcfWRM2qg4RPQ=] */
