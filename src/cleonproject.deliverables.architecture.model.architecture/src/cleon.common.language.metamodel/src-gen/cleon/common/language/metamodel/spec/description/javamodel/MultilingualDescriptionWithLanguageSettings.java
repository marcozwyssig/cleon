...
public class MultilingualDescriptionWithLanguageSettings extends DynamicResource implements IMultilingualDescriptionWithLanguageSettings {
  ...
  public MultilingualDescriptionWithLanguageSettings setLanguageSettings(cleon.common.language.metamodel.spec.languagesettings.javamodel.ILanguageSettings languageSettings) {
  ...
  public MultilingualDescriptionWithLanguageSettings setTranslation(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.common.language.metamodel.spec.description.javamodel.ILanguageDescriptionTranslation> translation) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,e33e3da3-cd44-11ec-85c9-011c467ea292,QGQq+MsU+FMxXzWFSylLVARxFYg=] */
