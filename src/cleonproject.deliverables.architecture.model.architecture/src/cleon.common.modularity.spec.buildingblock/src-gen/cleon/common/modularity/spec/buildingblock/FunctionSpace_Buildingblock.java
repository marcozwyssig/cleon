...
import cleon.common.modularity.spec.buildingblock.javamodel.*;
...
public class FunctionSpace_Buildingblock {
  ...
  public static interface IBuildingBlockFunctions extends IDynamicResourceExtension {
    ...
    public cleon.common.modularity.spec.buildingblock.javamodel.IBuildingBlock GetParent();

    @IDynamicResourceExtension.MethodId("ba47ee81-f989-11e5-af79-a55292c8fa9f")
    public List<cleon.common.modularity.spec.buildingblock.javamodel.IBuildingBlock> GetAllParents();

    @IDynamicResourceExtension.MethodId("f37babca-3a03-11e6-a354-253097f89a49")
    public cleon.common.modularity.spec.buildingblock.javamodel.IBuildingBlock GetTopBuildingBlock();
    ...
    public cleon.common.modularity.spec.buildingblock.javamodel.IBuildingBlock GetDecomposingBuildingBlocks();
    ...
    public List<cleon.common.modularity.spec.buildingblock.javamodel.IBuildingBlock> GetDependingBuildingBlocksOutsideParent();

    @IDynamicResourceExtension.MethodId("b07d4c71-894c-11e6-ad04-d1961316644a")
    public List<cleon.common.modularity.spec.buildingblock.javamodel.IBuildingBlock> GetAllDependencies();

    @IDynamicResourceExtension.MethodId("caa2cbf5-8959-11e6-ad04-d1961316644a")
    public List<cleon.common.modularity.spec.buildingblock.javamodel.IBuildingBlock> GetAllDuplicatedDependencies();
  ...
  public static interface IDependencyFunctions extends IDynamicResourceExtension {
    ...
    public List<cleon.common.modularity.spec.buildingblock.javamodel.IBuildingBlock> GetAllAllowedBuildingBlock();

    @IDynamicResourceExtension.MethodId("c5959139-c07c-11e6-beed-bb6789615dd5")
    public List<cleon.common.modularity.spec.buildingblock.javamodel.IBuildingBlock> GetAllNotAllowedDependencies();

    @IDynamicResourceExtension.MethodId("fa54ae2d-c07c-11e6-beed-bb6789615dd5")
    public List<cleon.common.modularity.spec.buildingblock.javamodel.IBuildingBlock> GetDependingBuildingBlocks();
  ...
  public static interface IDecompositionBuildingBlockFunctions extends IDynamicResourceExtension {
    ...
    public cleon.common.modularity.spec.buildingblock.javamodel.IBuildingBlock GetAllDecomposeBuildingBlocks();
  ...
  public static interface IDecompositionBuildingBlockFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("d1d1146d-4394-11e6-a883-1f8f2b17c061")
    public java.lang.Integer GetLevelNr(final cleon.common.modularity.spec.buildingblock.javamodel.IDecompositionBuildingBlock decompositionBuildingBlock);

    @IDynamicResourceExtension.MethodId("83431bc4-4395-11e6-a883-1f8f2b17c061")
    public java.lang.Integer GetLevelNr(final java.lang.Integer level, final cleon.common.modularity.spec.buildingblock.javamodel.IBuildingBlock parent, final cleon.common.modularity.spec.buildingblock.javamodel.IDecompositionBuildingBlock decompositionBuildingBlock);
  ...
  public static class DecompositionBuildingBlockFunctions {
    ...
    public static java.lang.Integer GetLevelNr(final cleon.common.modularity.spec.buildingblock.javamodel.IDecompositionBuildingBlock decompositionBuildingBlock) {
    ...
    public static java.lang.Integer GetLevelNr(final java.lang.Integer level, final cleon.common.modularity.spec.buildingblock.javamodel.IBuildingBlock parent, final cleon.common.modularity.spec.buildingblock.javamodel.IDecompositionBuildingBlock decompositionBuildingBlock) {
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,3aea3d68-44bf-11e5-93ef-c50f9659357a,eOrOrMyNGtU6lUuJG3p3cPdH9DY=] */
