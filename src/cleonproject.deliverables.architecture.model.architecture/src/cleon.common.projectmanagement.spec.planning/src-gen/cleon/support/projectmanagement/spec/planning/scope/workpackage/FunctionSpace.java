package cleon.support.projectmanagement.spec.planning.scope.workpackage;
...
public class FunctionSpace {
  ...
  public static interface IWorkpackageFunctions extends IDynamicResourceExtension {
    ...
    public List<cleon.support.projectmanagement.spec.planning.schedule.milestones.javamodel.ISprint> GetSprintsBetweenStartAndEndMilestone();
    ...
    public List<cleon.support.projectmanagement.spec.planning.scope.module.javamodel.IModule> GetModules();
  ...
  public static interface IWorkpackageFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("f1ec1852-bc86-11e6-b169-a12bde5a1c7c")
    public java.lang.String GetId(final cleon.support.projectmanagement.spec.planning.scope.workpackage.javamodel.IWorkpackage workpackage);

    @IDynamicResourceExtension.MethodId("74637dd8-d66f-11e6-ad1f-c967b4caaf09")
    public List<cleon.support.projectmanagement.spec.planning.schedule.milestones.javamodel.ISprint> GetSprintsBetweenStartAndEndMilestone(final cleon.support.projectmanagement.spec.planning.scope.workpackage.javamodel.IWorkpackage workpackage);

    @IDynamicResourceExtension.MethodId("87d08efa-d6ac-11e6-a1b8-05a222dbc1bd")
    public java.lang.String GetSimpleId(final cleon.support.projectmanagement.spec.planning.scope.workpackage.javamodel.IWorkpackage workpackage);
  ...
  public static class WorkpackageFunctions {
    ...
    public static java.lang.String GetId(final cleon.support.projectmanagement.spec.planning.scope.workpackage.javamodel.IWorkpackage workpackage) {
    ...
    public static List<cleon.support.projectmanagement.spec.planning.schedule.milestones.javamodel.ISprint> GetSprintsBetweenStartAndEndMilestone(final cleon.support.projectmanagement.spec.planning.scope.workpackage.javamodel.IWorkpackage workpackage) {
    ...
    public static java.lang.String GetSimpleId(final cleon.support.projectmanagement.spec.planning.scope.workpackage.javamodel.IWorkpackage workpackage) {
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,f1ec1850-bc86-11e6-b169-a12bde5a1c7c,ezxIdEsooQIzqGPE2WG/m+HjvI8=] */
