...
public class Risk extends DynamicResource implements IRisk {
  ...
  public cleon.common.resources.spec.calendar.javamodel.IDay selectEntryDate() {
    return _getSingle(cleon.common.resources.spec.calendar.javamodel.IDay.class, cleon.support.projectmanagement.spec.steering.riskmanagement.risks.RisksPackage.Risk_entryDate);
  }

  public Risk setEntryDate(cleon.common.resources.spec.calendar.javamodel.IDay entryDate) {
    _setSingle(cleon.support.projectmanagement.spec.steering.riskmanagement.risks.RisksPackage.Risk_entryDate, entryDate);
    return this;
  }
  ...
  public cleon.support.projectmanagement.spec.steering.riskmanagement.risks.impactarea.javamodel.IImpactType selectImpactType() {
    return _getSingle(cleon.support.projectmanagement.spec.steering.riskmanagement.risks.impactarea.javamodel.IImpactType.class, cleon.support.projectmanagement.spec.steering.riskmanagement.risks.RisksPackage.Risk_impactType);
  }

  public Risk setImpactType(cleon.support.projectmanagement.spec.steering.riskmanagement.risks.impactarea.javamodel.IImpactType impactType) {
    _setSingle(cleon.support.projectmanagement.spec.steering.riskmanagement.risks.RisksPackage.Risk_impactType, impactType);
    return this;
  }
  ...
  public cleon.support.projectmanagement.spec.steering.riskmanagement.risks.javamodel.IRiskState selectRiskState() {
    return _getSingle(cleon.support.projectmanagement.spec.steering.riskmanagement.risks.javamodel.IRiskState.class, cleon.support.projectmanagement.spec.steering.riskmanagement.risks.RisksPackage.Risk_riskState);
  }

  public Risk setRiskState(cleon.support.projectmanagement.spec.steering.riskmanagement.risks.javamodel.IRiskState riskState) {
    _setSingle(cleon.support.projectmanagement.spec.steering.riskmanagement.risks.RisksPackage.Risk_riskState, riskState);
    return this;
  }
    
  @Override
  public cleon.support.projectmanagement.spec.steering.riskmanagement.risks.javamodel.IRiskType selectType() {
    return _getSingle(cleon.support.projectmanagement.spec.steering.riskmanagement.risks.javamodel.IRiskType.class, cleon.support.projectmanagement.spec.steering.riskmanagement.risks.RisksPackage.Risk_type);
  }

  public Risk setType(cleon.support.projectmanagement.spec.steering.riskmanagement.risks.javamodel.IRiskType type) {
    _setSingle(cleon.support.projectmanagement.spec.steering.riskmanagement.risks.RisksPackage.Risk_type, type);
    return this;
  }
  ...
  public static java.util.List<cleon.support.projectmanagement.spec.steering.riskmanagement.risks.javamodel.IRisk> selectToMeEntryDate(cleon.common.resources.spec.calendar.javamodel.IDay object) {
    return _getToMeList(object.getRepository(), cleon.support.projectmanagement.spec.steering.riskmanagement.risks.javamodel.IRisk.class, cleon.support.projectmanagement.spec.steering.riskmanagement.risks.RisksPackage.Risk_entryDate, object.getResource());
  }
  
  public static java.util.List<cleon.support.projectmanagement.spec.steering.riskmanagement.risks.javamodel.IRisk> selectToMeImpactType(cleon.support.projectmanagement.spec.steering.riskmanagement.risks.impactarea.javamodel.IImpactType object) {
    return _getToMeList(object.getRepository(), cleon.support.projectmanagement.spec.steering.riskmanagement.risks.javamodel.IRisk.class, cleon.support.projectmanagement.spec.steering.riskmanagement.risks.RisksPackage.Risk_impactType, object.getResource());
  }
  
  public static java.util.List<cleon.support.projectmanagement.spec.steering.riskmanagement.risks.javamodel.IRisk> selectToMeRiskState(cleon.support.projectmanagement.spec.steering.riskmanagement.risks.javamodel.IRiskState object) {
    return _getToMeList(object.getRepository(), cleon.support.projectmanagement.spec.steering.riskmanagement.risks.javamodel.IRisk.class, cleon.support.projectmanagement.spec.steering.riskmanagement.risks.RisksPackage.Risk_riskState, object.getResource());
  }
  
  public static java.util.List<cleon.support.projectmanagement.spec.steering.riskmanagement.risks.javamodel.IRisk> selectToMeType(cleon.support.projectmanagement.spec.steering.riskmanagement.risks.javamodel.IRiskType object) {
    return _getToMeList(object.getRepository(), cleon.support.projectmanagement.spec.steering.riskmanagement.risks.javamodel.IRisk.class, cleon.support.projectmanagement.spec.steering.riskmanagement.risks.RisksPackage.Risk_type, object.getResource());
  }
