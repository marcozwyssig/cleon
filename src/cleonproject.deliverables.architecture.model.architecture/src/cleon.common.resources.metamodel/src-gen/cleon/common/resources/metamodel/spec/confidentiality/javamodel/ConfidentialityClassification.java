...
public class ConfidentialityClassification extends DynamicResource implements IConfidentialityClassification {
  ...
  public boolean isSK0() {
    return getResource().equals(cleon.common.resources.metamodel.spec.confidentiality.ConfidentialityPackage.ConfidentialityClassification_SK0);
  }
  
  @Override
  public boolean isSK1() {
    return getResource().equals(cleon.common.resources.metamodel.spec.confidentiality.ConfidentialityPackage.ConfidentialityClassification_SK1);
  }
  
  @Override
  public boolean isSK2() {
    return getResource().equals(cleon.common.resources.metamodel.spec.confidentiality.ConfidentialityPackage.ConfidentialityClassification_SK2);
  }
  
  @Override
  public boolean isSK3() {
    return getResource().equals(cleon.common.resources.metamodel.spec.confidentiality.ConfidentialityPackage.ConfidentialityClassification_SK3);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,58a88265-c10e-11e6-8f58-ad3c6ee7602f,sO/F6p38xEJ5Xku2buOyDxiZuX0=] */
