...
public class Importance extends DynamicResource implements IImportance {
  ...
  public boolean is__0_() {
    return getResource().equals(cleon.common.resources.spec.resources.importance.ImportancePackage.Importance___0_);
  }
  
  @Override
  public boolean is__Y_() {
    return getResource().equals(cleon.common.resources.spec.resources.importance.ImportancePackage.Importance___Y_);
  }
  
  @Override
  public boolean is__W_() {
    return getResource().equals(cleon.common.resources.spec.resources.importance.ImportancePackage.Importance___W_);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,948ee30d-3cfe-11e5-871f-6beac6a7c24b,3HxbapNrkojE63KEOWQg8xN14JA=] */
