...
public class SystemStage extends DynamicResource implements ISystemStage {
  ...
  public java.lang.String selectShortSystemName() {
    return _getSingleAttribute(java.lang.String.class, cleon.common.resources.spec.resources.versions.VersionsPackage.SystemStage_shortSystemName);
  }
    
  public void setShortSystemName(java.lang.String shortSystemName) {
     _setSingleAttribute(cleon.common.resources.spec.resources.versions.VersionsPackage.SystemStage_shortSystemName, shortSystemName);
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingleAttribute(java.lang.String.class, cleon.common.resources.spec.resources.versions.VersionsPackage.SystemStage_shortSystemName, visitor);
    // relations
  ...
  public boolean isPre__S_alpha__F___N_PA__O_() {
    return getResource().equals(cleon.common.resources.spec.resources.versions.VersionsPackage.SystemStage_Pre__S_alpha__F___N_PA__O_);
  }
  
  @Override
  public boolean isAlpha__F___N_A__O_() {
    return getResource().equals(cleon.common.resources.spec.resources.versions.VersionsPackage.SystemStage_Alpha__F___N_A__O_);
  }
  
  @Override
  public boolean isBeta__F___N_B__O_() {
    return getResource().equals(cleon.common.resources.spec.resources.versions.VersionsPackage.SystemStage_Beta__F___N_B__O_);
  }
  
  @Override
  public boolean isRelease__F_candidate__F___N_RC__O_() {
    return getResource().equals(cleon.common.resources.spec.resources.versions.VersionsPackage.SystemStage_Release__F_candidate__F___N_RC__O_);
  }
  
  @Override
  public boolean isRelease__F_to__F_manufacturing__F___N_RTM__O_() {
    return getResource().equals(cleon.common.resources.spec.resources.versions.VersionsPackage.SystemStage_Release__F_to__F_manufacturing__F___N_RTM__O_);
  }
  
  @Override
  public boolean isGeneral__F_availability__F___N_GA__O___F___N_GA__O_() {
    return getResource().equals(cleon.common.resources.spec.resources.versions.VersionsPackage.SystemStage_General__F_availability__F___N_GA__O___F___N_GA__O_);
  }
  
  @Override
  public boolean isEnd__S_of__S_life__F___N_EOL__O_() {
    return getResource().equals(cleon.common.resources.spec.resources.versions.VersionsPackage.SystemStage_End__S_of__S_life__F___N_EOL__O_);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,21bbfa64-bfea-11e8-a3d0-5394fd9291a1,gliftU0hA84qDE400ib4/Dlmir0=] */
