package cleon.common.resources.spec.resources.workstate;
...
public class FunctionSpace {
  ...
  public static interface IWorkStateFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("53663476-cb74-11e5-bc87-a1fadf56ded8")
    public java.lang.Boolean IsOpenOrInWork(final cleon.common.resources.spec.resources.workstate.javamodel.IWorkState workState);

    @IDynamicResourceExtension.MethodId("ba4c85f4-cb74-11e5-bc87-a1fadf56ded8")
    public java.lang.Boolean IsDone(final cleon.common.resources.spec.resources.workstate.javamodel.IWorkState workState);
  ...
  public static class WorkStateFunctions {
    ...
    public static java.lang.Boolean IsOpenOrInWork(final cleon.common.resources.spec.resources.workstate.javamodel.IWorkState workState) {
    ...
    public static java.lang.Boolean IsDone(final cleon.common.resources.spec.resources.workstate.javamodel.IWorkState workState) {
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,11326bb1-cb74-11e5-bc87-a1fadf56ded8,LueBYIo6jYBsY4gdMq68feCdp8I=] */
