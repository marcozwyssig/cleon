...
public class NamedXmlDocument extends DynamicResource implements INamedXmlDocument {
  ...
  @Override
  public java.util.List<? extends cleon.common.xml.metamodel.spec.javamodel.IXmlElement> selectNodes() {
    return _getList(cleon.common.xml.metamodel.spec.javamodel.IXmlElement.class, cleon.common.xml.metamodel.spec.SpecPackage.XmlDocument_nodes);
  }

  public NamedXmlDocument setNodes(java.util.List<? extends cleon.common.xml.metamodel.spec.javamodel.IXmlElement> nodes) {
    _setList(cleon.common.xml.metamodel.spec.SpecPackage.XmlDocument_nodes, nodes);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    // relations
    _acceptList(cleon.common.xml.metamodel.spec.javamodel.IXmlElement.class, cleon.common.xml.metamodel.spec.SpecPackage.XmlDocument_nodes, visitor);
