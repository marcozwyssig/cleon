...
public class XmlAttribute extends DynamicResource implements IXmlAttribute {
  ...
  @Override
  public java.util.List<? extends cleon.common.xml.metamodel.spec.javamodel.IXmlNode> selectNodes() {
    return _getList(cleon.common.xml.metamodel.spec.javamodel.IXmlNode.class, cleon.common.xml.metamodel.spec.SpecPackage.XmlAttribute_nodes);
  }

  public XmlAttribute setNodes(java.util.List<? extends cleon.common.xml.metamodel.spec.javamodel.IXmlNode> nodes) {
    _setList(cleon.common.xml.metamodel.spec.SpecPackage.XmlAttribute_nodes, nodes);
    return this;
  }
  ...
  public static cleon.common.xml.metamodel.spec.javamodel.IXmlAttribute selectToMeNodes(cleon.common.xml.metamodel.spec.javamodel.IXmlNode object) {
    return _getToMeSingle(object.getRepository(), cleon.common.xml.metamodel.spec.javamodel.IXmlAttribute.class, cleon.common.xml.metamodel.spec.SpecPackage.XmlAttribute_nodes, object.getResource());
  }
