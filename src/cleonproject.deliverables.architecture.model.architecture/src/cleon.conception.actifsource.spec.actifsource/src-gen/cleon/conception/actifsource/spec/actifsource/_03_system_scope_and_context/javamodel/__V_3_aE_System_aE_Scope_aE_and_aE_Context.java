...
public class __V_3_aE_System_aE_Scope_aE_and_aE_Context extends DynamicResource implements I__V_3_aE_System_aE_Scope_aE_and_aE_Context {
  ...
  @Override
  public cleon.conception.applications.spec.architecture.javamodel.ISoftwareSystem selectSoftwareSystem() {
    return _getSingle(cleon.conception.applications.spec.architecture.javamodel.ISoftwareSystem.class, cleon.conception.applications.spec.architecture._03_system_scope_and_context._03_system_scope_and_contextPackage.__V_3_aE_System_aE_Scope_aE_and_aE_Context_softwareSystem);
  }

  public __V_3_aE_System_aE_Scope_aE_and_aE_Context setSoftwareSystem(cleon.conception.applications.spec.architecture.javamodel.ISoftwareSystem softwareSystem) {
    _setSingle(cleon.conception.applications.spec.architecture._03_system_scope_and_context._03_system_scope_and_contextPackage.__V_3_aE_System_aE_Scope_aE_and_aE_Context_softwareSystem, softwareSystem);
    return this;
  }
  ...
  public __V_3_aE_System_aE_Scope_aE_and_aE_Context setSystem(cleon.conception.architecture.spec.arc42._03_system_scope_and_context.javamodel.ISystem system) {
  ...
  public cleon.conception.actifsource.spec.actifsource.system.javamodel.IZoo selectZoo() {
    return _getSingle(cleon.conception.actifsource.spec.actifsource.system.javamodel.IZoo.class, cleon.conception.actifsource.spec.actifsource._03_system_scope_and_context._03_system_scope_and_contextPackage.__V_3_aE_System_aE_Scope_aE_and_aE_Context_zoo);
  }

  public __V_3_aE_System_aE_Scope_aE_and_aE_Context setZoo(cleon.conception.actifsource.spec.actifsource.system.javamodel.IZoo zoo) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(cleon.conception.applications.spec.architecture.javamodel.ISoftwareSystem.class, cleon.conception.applications.spec.architecture._03_system_scope_and_context._03_system_scope_and_contextPackage.__V_3_aE_System_aE_Scope_aE_and_aE_Context_softwareSystem, visitor);
    ...
    _acceptSingle(cleon.conception.actifsource.spec.actifsource.system.javamodel.IZoo.class, cleon.conception.actifsource.spec.actifsource._03_system_scope_and_context._03_system_scope_and_contextPackage.__V_3_aE_System_aE_Scope_aE_and_aE_Context_zoo, visitor);
  }

  // toMeRelations
  
  public static cleon.conception.actifsource.spec.actifsource._03_system_scope_and_context.javamodel.I__V_3_aE_System_aE_Scope_aE_and_aE_Context selectToMeZoo(cleon.conception.actifsource.spec.actifsource.system.javamodel.IZoo object) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,7a904739-3a02-11e6-a354-253097f89a49,W+CFd7kZncSYB3MaNI0XYh2gWQQ=] */
