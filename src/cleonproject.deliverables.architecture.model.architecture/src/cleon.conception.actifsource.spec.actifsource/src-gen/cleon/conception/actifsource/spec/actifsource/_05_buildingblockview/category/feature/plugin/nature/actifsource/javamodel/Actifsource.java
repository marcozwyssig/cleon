...
public class Actifsource extends DynamicResource implements IActifsource {
  ...
  public java.lang.String selectBuildFactoryClassName() {
    return _getSingleAttribute(java.lang.String.class, cleon.conception.actifsource.spec.actifsource._05_buildingblockview.category.feature.plugin.nature.actifsource.ActifsourcePackage.Actifsource_buildFactoryClassName);
  }
    
  public void setBuildFactoryClassName(java.lang.String buildFactoryClassName) {
     _setSingleAttribute(cleon.conception.actifsource.spec.actifsource._05_buildingblockview.category.feature.plugin.nature.actifsource.ActifsourcePackage.Actifsource_buildFactoryClassName, buildFactoryClassName);
  }
  ...
  public void setPluginActivationClassName(java.lang.String pluginActivationClassName) {
     _setSingleAttribute(cleon.conception.actifsource.spec.actifsource._05_buildingblockview.category.feature.plugin.nature.actifsource.ActifsourcePackage.Actifsource_pluginActivationClassName, pluginActivationClassName);
  }

  @Override
  public java.lang.Boolean selectUseSimpleNameForBinding() {
    return _getSingleAttribute(java.lang.Boolean.class, cleon.conception.actifsource.spec.actifsource._05_buildingblockview.category.feature.plugin.nature.actifsource.ActifsourcePackage.Actifsource_useSimpleNameForBinding);
  }
    
  public void setUseSimpleNameForBinding(java.lang.Boolean useSimpleNameForBinding) {
     _setSingleAttribute(cleon.conception.actifsource.spec.actifsource._05_buildingblockview.category.feature.plugin.nature.actifsource.ActifsourcePackage.Actifsource_useSimpleNameForBinding, useSimpleNameForBinding);
  }
  ...
  public java.util.Map<ch.actifsource.core.Resource, ? extends cleon.conception.actifsource.spec.actifsource._05_buildingblockview.category.feature.plugin.nature.actifsource.javamodel.ITargetPath> selectTargetPaths() {
    return _getMap(cleon.conception.actifsource.spec.actifsource._05_buildingblockview.category.feature.plugin.nature.actifsource.javamodel.ITargetPath.class, cleon.conception.actifsource.spec.actifsource._05_buildingblockview.category.feature.plugin.nature.actifsource.ActifsourcePackage.Actifsource_targetPaths);
  }

  public Actifsource setTargetPaths(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.conception.actifsource.spec.actifsource._05_buildingblockview.category.feature.plugin.nature.actifsource.javamodel.ITargetPath> targetPaths) {
    _setMap(cleon.conception.actifsource.spec.actifsource._05_buildingblockview.category.feature.plugin.nature.actifsource.ActifsourcePackage.Actifsource_targetPaths, targetPaths);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    // relations
    _acceptMap(cleon.conception.actifsource.spec.actifsource._05_buildingblockview.category.feature.plugin.nature.actifsource.javamodel.ITargetPath.class, cleon.conception.actifsource.spec.actifsource._05_buildingblockview.category.feature.plugin.nature.actifsource.ActifsourcePackage.Actifsource_targetPaths, visitor);
