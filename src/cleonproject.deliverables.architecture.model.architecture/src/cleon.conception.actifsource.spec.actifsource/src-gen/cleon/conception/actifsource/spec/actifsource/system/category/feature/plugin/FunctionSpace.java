package cleon.conception.actifsource.spec.actifsource.system.category.feature.plugin;
...
public class FunctionSpace {
  ...
  public static interface IPluginFunctions extends IDynamicResourceExtension {
    ...
    public List<cleon.conception.actifsource.spec.actifsource.system.category.feature.plugin.javamodel.IPlugin> GetDirectDependingProjectBuildingBlocks();

    @IDynamicResourceExtension.MethodId("40333452-c10a-11e6-8f58-ad3c6ee7602f")
    public List<cleon.conception.actifsource.spec.actifsource.system.category.feature.plugin.javamodel.IPlugin> GetDirectDependingBuiltinBuildingBlocks();

    @IDynamicResourceExtension.MethodId("bd765b2f-c10b-11e6-8f58-ad3c6ee7602f")
    public List<cleon.conception.actifsource.spec.actifsource.system.category.feature.plugin.javamodel.IPlugin> GetAllDuplicatedBuiltinDependencies();

    @IDynamicResourceExtension.MethodId("3e804d3f-95a8-11e8-8990-bba75387a1ab")
    public List<cleon.conception.actifsource.spec.actifsource.system.category.feature.plugin.javamodel.IPlugin> GetAllDuplicatedProjectDependencies();

    @IDynamicResourceExtension.MethodId("1e20244f-c10c-11e6-8f58-ad3c6ee7602f")
    public List<cleon.conception.actifsource.spec.actifsource.system.category.feature.plugin.javamodel.IPlugin> GetAllBuiltinDependencies();

    @IDynamicResourceExtension.MethodId("32cb0426-95a8-11e8-8990-bba75387a1ab")
    public List<cleon.conception.actifsource.spec.actifsource.system.category.feature.plugin.javamodel.IPlugin> GetAllProjectDependencies();
    ...
    public List<cleon.conception.actifsource.spec.actifsource.system.category.feature.plugin.nature.javamodel.INature> ListNatures();
  ...
  public static interface IPluginFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("22956d62-5b57-11e7-9702-abdab196c2a1")
    public java.lang.Boolean UseSimpleName(final cleon.conception.actifsource.spec.actifsource.system.category.feature.plugin.javamodel.IPlugin plugin);
  ...
  public static class PluginFunctions {
    ...
    public static java.lang.Boolean UseSimpleName(final cleon.conception.actifsource.spec.actifsource.system.category.feature.plugin.javamodel.IPlugin plugin) {
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,7106baaa-3c77-11e6-aafa-bd565efc0ead,giHUOWZdSWEMgLLzYkJgp2/zxTU=] */
