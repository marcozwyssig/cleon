...
public class CategoryAggregateDecomposite extends DynamicResource implements ICategoryAggregateDecomposite {
  ...
  @Override
  public cleon.conception.actifsource.spec.actifsource.system.category.javamodel.ICategory selectInto() {
    return _getSingle(cleon.conception.actifsource.spec.actifsource.system.category.javamodel.ICategory.class, cleon.conception.actifsource.spec.actifsource.system.category.CategoryPackage.CategoryAggregateDecomposite_into);
  }

  public CategoryAggregateDecomposite setInto(cleon.conception.actifsource.spec.actifsource.system.category.javamodel.ICategory into) {
    _setSingle(cleon.conception.actifsource.spec.actifsource.system.category.CategoryPackage.CategoryAggregateDecomposite_into, into);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    // relations
    _acceptSingle(cleon.conception.actifsource.spec.actifsource.system.category.javamodel.ICategory.class, cleon.conception.actifsource.spec.actifsource.system.category.CategoryPackage.CategoryAggregateDecomposite_into, visitor);
  ...
  public static cleon.conception.actifsource.spec.actifsource.system.category.javamodel.ICategoryAggregateDecomposite selectToMeInto(cleon.conception.actifsource.spec.actifsource.system.category.javamodel.ICategory object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.actifsource.spec.actifsource.system.category.javamodel.ICategoryAggregateDecomposite.class, cleon.conception.actifsource.spec.actifsource.system.category.CategoryPackage.CategoryAggregateDecomposite_into, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,27c04266-3c6a-11e6-aafa-bd565efc0ead,Rww2AADCNAhzN4pFVtf0zYvfngI=] */
