...
public class Zoo extends DynamicResource implements IZoo {
  ...
  public java.util.List<? extends cleon.conception.actifsource.spec.actifsource.system.category.javamodel.ICategoryAggregateDecomposite> selectCategories() {
    return _getList(cleon.conception.actifsource.spec.actifsource.system.category.javamodel.ICategoryAggregateDecomposite.class, cleon.conception.actifsource.spec.actifsource.system.SystemPackage.Zoo_categories);
  }

  public Zoo setCategories(java.util.List<? extends cleon.conception.actifsource.spec.actifsource.system.category.javamodel.ICategoryAggregateDecomposite> categories) {
    _setList(cleon.conception.actifsource.spec.actifsource.system.SystemPackage.Zoo_categories, categories);
    return this;
  }
  ...
  public Zoo setDecompose(java.util.List<? extends cleon.conception.architecture.spec.buildingblock.javamodel.IDecomposite> decompose) {
  ...
  public java.util.List<? extends cleon.conception.architecture.spec.buildingblock.javamodel.IDependency> selectHasDependency() {
    return _getList(cleon.conception.architecture.spec.buildingblock.javamodel.IDependency.class, cleon.conception.applications.spec.architecture.ArchitecturePackage.SoftwareSystem_hasDependency);
  }

  public Zoo setHasDependency(java.util.List<? extends cleon.conception.architecture.spec.buildingblock.javamodel.IDependency> hasDependency) {
    _setList(cleon.conception.applications.spec.architecture.ArchitecturePackage.SoftwareSystem_hasDependency, hasDependency);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptList(cleon.conception.architecture.spec.buildingblock.javamodel.IDependency.class, cleon.conception.applications.spec.architecture.ArchitecturePackage.SoftwareSystem_hasDependency, visitor);
  ...
  public static cleon.conception.actifsource.spec.actifsource.system.javamodel.IZoo selectToMeCategories(cleon.conception.actifsource.spec.actifsource.system.category.javamodel.ICategoryAggregateDecomposite object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.actifsource.spec.actifsource.system.javamodel.IZoo.class, cleon.conception.actifsource.spec.actifsource.system.SystemPackage.Zoo_categories, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,7b6b4712-f986-11e5-a7fd-010f93305101,f7ZzuJGr7evxSs3kpijXVViabws=] */
