...
public class NamedSoftwareArc42 extends DynamicResource implements INamedSoftwareArc42 {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<INamedSoftwareArc42> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<INamedSoftwareArc42>() {
    
    @Override
    public INamedSoftwareArc42 create() {
      return new NamedSoftwareArc42();
    }
    
    @Override
    public INamedSoftwareArc42 create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new NamedSoftwareArc42(resourceRepository, resource);
    }
  
  };

  public NamedSoftwareArc42() {
    super(INamedSoftwareArc42.TYPE_ID);
  }
  
  public NamedSoftwareArc42(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
    super(resourceRepository, resource, INamedSoftwareArc42.TYPE_ID);
  }
  ...
  public NamedSoftwareArc42 set__V_1_aE_introduction_aE_and_aE_goals(cleon.conception.architecture.spec.arc42._01_introduction_and_goals.javamodel.I__V_1_aE_IntroductionAndGoals __V_1_aE_introduction_aE_and_aE_goals) {
  ...
  public NamedSoftwareArc42 set__V_2_aE_architecture_aE_constraints(cleon.conception.architecture.spec.arc42._02_architecture_constraints.javamodel.I__V_2_aE_Architecture_aE_Constraints __V_2_aE_architecture_aE_constraints) {
  ...
  public NamedSoftwareArc42 set__V_3_aE_system_aE_scope_aE_and_aE_context(cleon.conception.architecture.spec.arc42._03_system_scope_and_context.javamodel.I__V_3_aE_System_aE_Scope_aE_and_aE_Context __V_3_aE_system_aE_scope_aE_and_aE_context) {
  ...
  public NamedSoftwareArc42 set__V_5_aE_buildingblockview(cleon.conception.architecture.spec.arc42._05_buildingblock_view.javamodel.I__V_5_aE_BuildingBlockView __V_5_aE_buildingblockview) {
  ...
  public NamedSoftwareArc42 set__V_7_aE_deploymentview(cleon.conception.architecture.spec.arc42._07_deployment_view.javamodel.I__V_7_aE_DeploymentView __V_7_aE_deploymentview) {
  ...
  public NamedSoftwareArc42 setDocumentElements(java.util.List<? extends cleon.common.doc.spec.doc.javamodel.IDocumentElement> documentElements) {
  ...
  public NamedSoftwareArc42 setGlossary(cleon.common.glossary.spec.glossary.javamodel.IGlossary glossary) {
  ...
  public NamedSoftwareArc42 setProperties(cleon.common.doc.spec.doc.document.properties.javamodel.IProperties properties) {
  ...
  public NamedSoftwareArc42 setStyle(cleon.common.doc.spec.doc.document.style.javamodel.IStyle style) {
  ...
  public NamedSoftwareArc42 setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,f90dd59b-2d6c-11e6-959f-d1cef44ff5fd,D7cfIwd4f5wWspSrioE4Au1QDvU=] */
