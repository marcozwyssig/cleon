...
public class SoftwareSystem extends DynamicResource implements ISoftwareSystem {
  ...
  public static cleon.conception.applications.spec.architecture.javamodel.ISoftwareSystem selectToMeHasDependency(cleon.conception.architecture.spec.buildingblock.javamodel.IDependency object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.applications.spec.architecture.javamodel.ISoftwareSystem.class, cleon.conception.applications.spec.architecture.ArchitecturePackage.SoftwareSystem_hasDependency, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,9237e4d5-4aa3-11e6-9c0f-393d355c5fe3,TDjmYHurDUPr9H8Yu3VB7l0vrRA=] */
