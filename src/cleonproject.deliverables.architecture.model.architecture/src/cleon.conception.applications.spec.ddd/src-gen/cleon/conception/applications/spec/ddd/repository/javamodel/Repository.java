...
public class Repository extends DynamicResource implements IRepository {
  ...
  public java.util.List<? extends cleon.conception.uml.spec.uml.structural.classes.method.javamodel.IMethod> selectGetBy() {
    return _getList(cleon.conception.uml.spec.uml.structural.classes.method.javamodel.IMethod.class, cleon.conception.applications.spec.ddd.repository.RepositoryPackage.Repository_getBy);
  }
  ...
  public java.util.List<? extends cleon.conception.uml.spec.uml.structural.classes.method.javamodel.IMethod> selectSearchBy() {
    return _getList(cleon.conception.uml.spec.uml.structural.classes.method.javamodel.IMethod.class, cleon.conception.applications.spec.ddd.repository.RepositoryPackage.Repository_searchBy);
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptList(cleon.conception.uml.spec.uml.structural.classes.method.javamodel.IMethod.class, cleon.conception.applications.spec.ddd.repository.RepositoryPackage.Repository_getBy, visitor);
    ...
    _acceptList(cleon.conception.uml.spec.uml.structural.classes.method.javamodel.IMethod.class, cleon.conception.applications.spec.ddd.repository.RepositoryPackage.Repository_searchBy, visitor);
  ...
  public static cleon.conception.applications.spec.ddd.repository.javamodel.IRepository selectToMeSearchBy(cleon.conception.uml.spec.uml.structural.classes.method.javamodel.IMethod object) {
  ...
  public static cleon.conception.applications.spec.ddd.repository.javamodel.IRepository selectToMeGetBy(cleon.conception.uml.spec.uml.structural.classes.method.javamodel.IMethod object) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,5e627f84-10c2-11e3-b60e-ab478a3e1eca,jbueY6X6IwzaPu73VobjyZ4kXFw=] */
