...
public class DomainService extends DynamicResource implements IDomainService {
  ...
  public DomainService setData(java.util.List<? extends cleon.conception.uml.spec.uml.structural.classes.interfaces.javamodel.IInterfaceData> data) {
  ...
  public DomainService setEvents(java.util.List<? extends cleon.conception.soa.spec.soa.javamodel.IEvent> events) {
  ...
  public DomainService setMethods(java.util.List<? extends cleon.conception.uml.spec.uml.structural.classes.method.javamodel.IMethod> methods) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,9d00b1dd-a37b-11e3-9113-ffc7f11b0a42,y+2Uv+V7X1AzEYFUo2PYgOHBb8E=] */
