package cleon.conception.applications.spec.desktop.controls.javamodel;
...
public class UserControlView extends DynamicResource implements IUserControlView {
  ...
  public UserControlView setCustomEvents(java.util.List<? extends cleon.conception.architecture.spec.uml.structural.classes.events.javamodel.ICustomEvent> customEvents) {
  ...
  public UserControlView setDocumentElements(java.util.List<? extends cleon.common.doc.spec.doc.javamodel.IDocumentElement> documentElements) {
  ...
  public UserControlView setEvents(java.util.List<? extends cleon.conception.architecture.spec.uml.structural.classes.events.javamodel.IEvent> events) {
  ...
  public cleon.conception.applications.spec.desktop.mvvm.javamodel.IView selectExtends() {
    return _getSingle(cleon.conception.applications.spec.desktop.mvvm.javamodel.IView.class, cleon.conception.applications.spec.desktop.mvvm.MvvmPackage.View_extends);
  }

  public UserControlView setExtends(cleon.conception.applications.spec.desktop.mvvm.javamodel.IView extends_) {
    _setSingle(cleon.conception.applications.spec.desktop.mvvm.MvvmPackage.View_extends, extends_);
    return this;
  }
  ...
  public UserControlView setFieldEvents(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.conception.architecture.spec.uml.structural.classes.events.javamodel.IEventForField> fieldEvents) {
  ...
  public UserControlView setFields(java.util.List<? extends cleon.conception.architecture.spec.uml.structural.classes.fields.javamodel.IField> fields) {
  ...
  public UserControlView setHasDependency(java.util.List<? extends cleon.conception.architecture.spec.buildingblock.javamodel.IDependency> hasDependency) {
  ...
  public UserControlView setMethods(java.util.List<? extends cleon.conception.architecture.spec.uml.structural.classes.method.javamodel.IMethod> methods) {
  ...
  public UserControlView setRelations(java.util.List<? extends cleon.conception.architecture.spec.uml.structural.classes.association.javamodel.IAssociation> relations) {
  ...
  public cleon.conception.applications.spec.desktop.mvvm.javamodel.IViewModelDependency selectViewModel() {
    return _getSingle(cleon.conception.applications.spec.desktop.mvvm.javamodel.IViewModelDependency.class, cleon.conception.applications.spec.desktop.mvvm.MvvmPackage.View_viewModel);
  }

  public UserControlView setViewModel(cleon.conception.applications.spec.desktop.mvvm.javamodel.IViewModelDependency viewModel) {
    _setSingle(cleon.conception.applications.spec.desktop.mvvm.MvvmPackage.View_viewModel, viewModel);
    return this;
  }
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,4947868f-634e-11e3-9288-bdf1907ca1e3,wCj48/2Mvw1iWLoWxa9IZzy+HX8=] */
