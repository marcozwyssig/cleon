...
public class UserControlView extends DynamicResource implements IUserControlView {
  ...
  public UserControlView setCustomEvents(java.util.List<? extends cleon.conception.uml.spec.uml.structural.classes.events.javamodel.ICustomEvent> customEvents) {
  ...
  public UserControlView setEvents(java.util.List<? extends cleon.conception.uml.spec.uml.structural.classes.events.javamodel.IEvent> events) {
  ...
  public UserControlView setFieldEvents(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.conception.uml.spec.uml.structural.classes.events.javamodel.IEventForField> fieldEvents) {
  ...
  public UserControlView setFields(java.util.List<? extends cleon.conception.uml.spec.uml.structural.classes.fields.javamodel.IField> fields) {
  ...
  public UserControlView setHasDependency(java.util.List<? extends cleon.conception.modelinglanguage.spec.buildingblock.javamodel.IDependency> hasDependency) {
  ...
  public UserControlView setMethods(java.util.List<? extends cleon.conception.uml.spec.uml.structural.classes.method.javamodel.IMethod> methods) {
  ...
  public UserControlView setRelations(java.util.List<? extends cleon.conception.uml.spec.uml.structural.classes.association.javamodel.IAssociation> relations) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,4947868f-634e-11e3-9288-bdf1907ca1e3,JrP0XMUu6PNArK56Z7aZ9JcO10c=] */
