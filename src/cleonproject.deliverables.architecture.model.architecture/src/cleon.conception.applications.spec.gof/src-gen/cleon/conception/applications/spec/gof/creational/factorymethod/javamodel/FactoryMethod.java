...
public class FactoryMethod extends DynamicResource implements IFactoryMethod {
  ...
  public cleon.conception.uml.spec.uml.structural.classes.javamodel.IClassifier selectClassifier() {
    return _getSingle(cleon.conception.uml.spec.uml.structural.classes.javamodel.IClassifier.class, cleon.conception.applications.spec.gof.creational.factorymethod.FactorymethodPackage.FactoryMethod_classifier);
  }
  ...
  public java.util.List<? extends cleon.conception.uml.spec.uml.structural.classes.method.parameter.javamodel.IParameter> selectCtorArgs() {
    return _getList(cleon.conception.uml.spec.uml.structural.classes.method.parameter.javamodel.IParameter.class, cleon.conception.applications.spec.gof.creational.factorymethod.FactorymethodPackage.FactoryMethod_ctorArgs);
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    // relations
    _acceptSingle(cleon.conception.uml.spec.uml.structural.classes.javamodel.IClassifier.class, cleon.conception.applications.spec.gof.creational.factorymethod.FactorymethodPackage.FactoryMethod_classifier, visitor);
    _acceptList(cleon.conception.uml.spec.uml.structural.classes.method.parameter.javamodel.IParameter.class, cleon.conception.applications.spec.gof.creational.factorymethod.FactorymethodPackage.FactoryMethod_ctorArgs, visitor);
  ...
  public static java.util.List<cleon.conception.applications.spec.gof.creational.factorymethod.javamodel.IFactoryMethod> selectToMeClassifier(cleon.conception.uml.spec.uml.structural.classes.javamodel.IClassifier object) {
  ...
  public static cleon.conception.applications.spec.gof.creational.factorymethod.javamodel.IFactoryMethod selectToMeCtorArgs(cleon.conception.uml.spec.uml.structural.classes.method.parameter.javamodel.IParameter object) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,8838d098-ddd3-11e4-b0b5-6911fa4e24e5,Hzd7kUGoKIt7IAjyG8qsue84el8=] */
