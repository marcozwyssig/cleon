package cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock;
...
import cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.*;
...
public class FunctionSpace {
  ...
  public static interface IBuildingBlockFunctions extends IDynamicResourceExtension {
    ...
    public cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IBuildingBlock GetParent();

    @IDynamicResourceExtension.MethodId("ba47ee81-f989-11e5-af79-a55292c8fa9f")
    public List<cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IBuildingBlock> GetAllParents();

    @IDynamicResourceExtension.MethodId("f37babca-3a03-11e6-a354-253097f89a49")
    public cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IBuildingBlock GetTopBuildingBlock();

    @IDynamicResourceExtension.MethodId("abc4f28c-3a04-11e6-a354-253097f89a49")
    public cleon.common.doc.spec.doc.chapter.javamodel.IChapter GetBuildingBlockView();

    @IDynamicResourceExtension.MethodId("4814ee23-3a04-11e6-a354-253097f89a49")
    public cleon.conception.arc.spec.arc42._03_system_scope_and_context.javamodel.ISystem GetSystem();
    ...
    public List<cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IBuildingBlock> GetDependingBuildingBlocksFromParent();

    @IDynamicResourceExtension.MethodId("2d309b24-4355-11e6-a9d7-97cf4f7c398b")
    public cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IBuildingBlock GetDecomposingBuildingBlocksFromParent();

    @IDynamicResourceExtension.MethodId("2d309b3b-4355-11e6-a9d7-97cf4f7c398b")
    public List<cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IBuildingBlock> GetAllAllowedBuildingBlockFromParent();

    @IDynamicResourceExtension.MethodId("3b3cfddc-4356-11e6-a9d7-97cf4f7c398b")
    public List<cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IBuildingBlock> GetDecomposeBuildingBlockOfDependingBuildingBlocksFromParent();

    @IDynamicResourceExtension.MethodId("5f8b2abd-4823-11e6-82f6-0f210765495b")
    public cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IBuildingBlock GetDecomposingBuildingBlocks();

    @IDynamicResourceExtension.MethodId("a032d549-4823-11e6-82f6-0f210765495b")
    public List<cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IBuildingBlock> GetDependingBuildingBlocks();

    @IDynamicResourceExtension.MethodId("68a66aec-4910-11e6-be22-874cc08f42ce")
    public List<cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IBuildingBlock> GetDependingBuildingBlocksWithinParent();

    @IDynamicResourceExtension.MethodId("15cae2bf-4914-11e6-be22-874cc08f42ce")
    public List<cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IBuildingBlock> GetDependingBuildingBlocksOutsideParent();

    @IDynamicResourceExtension.MethodId("b07d4c71-894c-11e6-ad04-d1961316644a")
    public List<cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IBuildingBlock> GetAllDependencies();

    @IDynamicResourceExtension.MethodId("88b09502-8958-11e6-ad04-d1961316644a")
    public List<cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IBuildingBlock> DisjuntedDependencies();

    @IDynamicResourceExtension.MethodId("caa2cbf5-8959-11e6-ad04-d1961316644a")
    public List<cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IBuildingBlock> GetAllDuplicatedDependencies();
  ...
  public static interface IBuildingBlockFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("88b09502-8958-11e6-ad04-d1961316644a")
    public List<cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IBuildingBlock> DisjuntedDependencies(final List<cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IBuildingBlock> buildingBlockList);
  ...
  public static class BuildingBlockFunctions {
    ...
    public static List<cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IBuildingBlock> DisjuntedDependencies(final List<cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IBuildingBlock> buildingBlockList) {
  ...
  public static interface IDependencyFunctions extends IDynamicResourceExtension {
    ...
    public List<cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IBuildingBlock> GetAllAllowedBuildingBlock();

    @IDynamicResourceExtension.MethodId("c5959139-c07c-11e6-beed-bb6789615dd5")
    public List<cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IBuildingBlock> GetAllNotAllowedDependencies();
    ...
    public List<cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IBuildingBlock> GetDecomposingBuildingBlocks();

    @IDynamicResourceExtension.MethodId("755d5492-c086-11e6-beed-bb6789615dd5")
    public cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IBuildingBlock GetBuildingBlock();
  ...
  public static interface IDecompositionBuildingBlockFunctions extends IDynamicResourceExtension {
    ...
    public java.lang.Integer GetLevelNr(final java.lang.Integer level, final cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IBuildingBlock parent);

    @IDynamicResourceExtension.MethodId("49a6b322-894c-11e6-ad04-d1961316644a")
    public cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IBuildingBlock GetAllDecomposeBuildingBlocks();
  ...
  public static interface IDecompositionBuildingBlockFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("d1d1146d-4394-11e6-a883-1f8f2b17c061")
    public java.lang.Integer GetLevelNr(final cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IDecompositionBuildingBlock decompositionBuildingBlock);

    @IDynamicResourceExtension.MethodId("83431bc4-4395-11e6-a883-1f8f2b17c061")
    public java.lang.Integer GetLevelNr(final java.lang.Integer level, final cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IBuildingBlock parent, final cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IDecompositionBuildingBlock decompositionBuildingBlock);
  ...
  public static class DecompositionBuildingBlockFunctions {
    ...
    public static java.lang.Integer GetLevelNr(final cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IDecompositionBuildingBlock decompositionBuildingBlock) {
    ...
    public static java.lang.Integer GetLevelNr(final java.lang.Integer level, final cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IBuildingBlock parent, final cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IDecompositionBuildingBlock decompositionBuildingBlock) {
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,3aea3d68-44bf-11e5-93ef-c50f9659357a,pvUoS/XBAKda3RVoeSHJcDrUgTI=] */
