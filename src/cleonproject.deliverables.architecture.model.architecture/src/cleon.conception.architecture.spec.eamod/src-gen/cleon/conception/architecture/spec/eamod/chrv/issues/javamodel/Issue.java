...
public class Issue extends DynamicResource implements IIssue {
  ...
  public java.lang.String selectResolution() {
    return _getSingleAttribute(java.lang.String.class, cleon.conception.architecture.spec.eamod.chrv.issues.IssuesPackage.Issue_resolution);
  }
    
  public void setResolution(java.lang.String resolution) {
     _setSingleAttribute(cleon.conception.architecture.spec.eamod.chrv.issues.IssuesPackage.Issue_resolution, resolution);
  }
  ...
  public java.util.List<? extends cleon.conception.architecture.spec.eamod.chrv.issues.javamodel.ICategory> selectCategory() {
    return _getList(cleon.conception.architecture.spec.eamod.chrv.issues.javamodel.ICategory.class, cleon.conception.architecture.spec.eamod.chrv.issues.IssuesPackage.Issue_category);
  }

  public Issue setCategory(java.util.List<? extends cleon.conception.architecture.spec.eamod.chrv.issues.javamodel.ICategory> category) {
    _setList(cleon.conception.architecture.spec.eamod.chrv.issues.IssuesPackage.Issue_category, category);
    return this;
  }
  ...
  public java.util.List<? extends cleon.conception.architecture.spec.eamod.chrv.requirements.subjectareas.requirement.javamodel.IRequirement> selectConcerns() {
    return _getList(cleon.conception.architecture.spec.eamod.chrv.requirements.subjectareas.requirement.javamodel.IRequirement.class, cleon.conception.architecture.spec.eamod.chrv.issues.IssuesPackage.Issue_concerns);
  }

  public Issue setConcerns(java.util.List<? extends cleon.conception.architecture.spec.eamod.chrv.requirements.subjectareas.requirement.javamodel.IRequirement> concerns) {
    _setList(cleon.conception.architecture.spec.eamod.chrv.issues.IssuesPackage.Issue_concerns, concerns);
    return this;
  }
  ...
  public Issue setOriginatesFromSource(java.util.List<? extends cleon.conception.architecture.spec.eamod.chrv.motivation.sources.javamodel.ISource> originatesFromSource) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingleAttribute(java.lang.String.class, cleon.conception.architecture.spec.eamod.chrv.issues.IssuesPackage.Issue_resolution, visitor);
    // relations
    ...
    _acceptList(cleon.conception.architecture.spec.eamod.chrv.issues.javamodel.ICategory.class, cleon.conception.architecture.spec.eamod.chrv.issues.IssuesPackage.Issue_category, visitor);
    _acceptList(cleon.conception.architecture.spec.eamod.chrv.requirements.subjectareas.requirement.javamodel.IRequirement.class, cleon.conception.architecture.spec.eamod.chrv.issues.IssuesPackage.Issue_concerns, visitor);
  ...
  public static java.util.List<cleon.conception.architecture.spec.eamod.chrv.issues.javamodel.IIssue> selectToMeConcerns(cleon.conception.architecture.spec.eamod.chrv.requirements.subjectareas.requirement.javamodel.IRequirement object) {
    return _getToMeList(object.getRepository(), cleon.conception.architecture.spec.eamod.chrv.issues.javamodel.IIssue.class, cleon.conception.architecture.spec.eamod.chrv.issues.IssuesPackage.Issue_concerns, object.getResource());
  }
  
  public static java.util.List<cleon.conception.architecture.spec.eamod.chrv.issues.javamodel.IIssue> selectToMeCategory(cleon.conception.architecture.spec.eamod.chrv.issues.javamodel.ICategory object) {
    return _getToMeList(object.getRepository(), cleon.conception.architecture.spec.eamod.chrv.issues.javamodel.IIssue.class, cleon.conception.architecture.spec.eamod.chrv.issues.IssuesPackage.Issue_category, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,d0da468c-bdee-11e5-965a-07bc81ea9ca9,Ceb3atKP/UOplkim3RBTuEdxR3I=] */
