...
public class FunctionSpace {
  ...
  public static interface IPrincipleFunctions extends IDynamicResourceExtension {
    ...
    public List<cleon.conception.architecture.spec.eamod.chrv.motivation.principles.javamodel.IPrinciple> GetAllPrinciples();
  ...
  public static interface IPrincipleFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("4a0d89e4-c58d-11e5-aeea-1db9268c0ee9")
    public java.lang.String GetId(final cleon.conception.architecture.spec.eamod.chrv.motivation.principles.javamodel.IPrinciple principle);
  ...
  public static class PrincipleFunctions {
    ...
    public static java.lang.String GetId(final cleon.conception.architecture.spec.eamod.chrv.motivation.principles.javamodel.IPrinciple principle) {
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,4a0d89e2-c58d-11e5-aeea-1db9268c0ee9,lgH/7XwJQsj3Xgcy+TGBiHqEWys=] */
