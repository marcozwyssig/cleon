...
public class Principle extends DynamicResource implements IPrinciple {
  ...
  public Principle setAchieves(java.util.List<? extends cleon.conception.architecture.spec.eamod.chrv.motivation.goals.javamodel.IGoal> achieves) {
  ...
  public java.util.List<? extends cleon.conception.architecture.spec.eamod.chrv.motivation.principles.javamodel.IPrinciple> selectAggregation() {
    return _getList(cleon.conception.architecture.spec.eamod.chrv.motivation.principles.javamodel.IPrinciple.class, cleon.conception.architecture.spec.eamod.chrv.motivation.principles.PrinciplesPackage.Principle_aggregation);
  }

  public Principle setAggregation(java.util.List<? extends cleon.conception.architecture.spec.eamod.chrv.motivation.principles.javamodel.IPrinciple> aggregation) {
    _setList(cleon.conception.architecture.spec.eamod.chrv.motivation.principles.PrinciplesPackage.Principle_aggregation, aggregation);
    return this;
  }
  ...
  public Principle setOriginatesFromSource(java.util.List<? extends cleon.conception.architecture.spec.eamod.chrv.motivation.sources.javamodel.ISource> originatesFromSource) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptList(cleon.conception.architecture.spec.eamod.chrv.motivation.principles.javamodel.IPrinciple.class, cleon.conception.architecture.spec.eamod.chrv.motivation.principles.PrinciplesPackage.Principle_aggregation, visitor);
  ...
  public static cleon.conception.architecture.spec.eamod.chrv.motivation.principles.javamodel.IPrinciple selectToMeAggregation(cleon.conception.architecture.spec.eamod.chrv.motivation.principles.javamodel.IPrinciple object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.architecture.spec.eamod.chrv.motivation.principles.javamodel.IPrinciple.class, cleon.conception.architecture.spec.eamod.chrv.motivation.principles.PrinciplesPackage.Principle_aggregation, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,6f06a6ec-a951-11e5-bda2-a7fc3bd7c783,GhtwfKT8Ir0B3qd5KxvqKNIugL4=] */
