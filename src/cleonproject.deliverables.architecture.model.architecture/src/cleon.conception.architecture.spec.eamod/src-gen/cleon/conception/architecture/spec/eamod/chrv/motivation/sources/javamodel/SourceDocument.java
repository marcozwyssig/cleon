...
public class SourceDocument extends DynamicResource implements ISourceDocument {
  ...
  public java.net.URL selectUrl() {
    return _getSingleAttribute(java.net.URL.class, cleon.conception.architecture.spec.eamod.chrv.motivation.sources.SourcesPackage.SourceDocument_url);
  }
    
  public void setUrl(java.net.URL url) {
     _setSingleAttribute(cleon.conception.architecture.spec.eamod.chrv.motivation.sources.SourcesPackage.SourceDocument_url, url);
  }
  ...
  @Override
  public java.util.List<? extends cleon.conception.architecture.spec.eamod.chrv.motivation.sources.javamodel.ISourceChapter> selectChapters() {
    return _getList(cleon.conception.architecture.spec.eamod.chrv.motivation.sources.javamodel.ISourceChapter.class, cleon.conception.architecture.spec.eamod.chrv.motivation.sources.SourcesPackage.SourceDocument_chapters);
  }

  public SourceDocument setChapters(java.util.List<? extends cleon.conception.architecture.spec.eamod.chrv.motivation.sources.javamodel.ISourceChapter> chapters) {
    _setList(cleon.conception.architecture.spec.eamod.chrv.motivation.sources.SourcesPackage.SourceDocument_chapters, chapters);
    return this;
  }
  ...
  public SourceDocument setComposites(java.util.List<? extends cleon.conception.architecture.spec.eamod.chrv.motivation.sources.javamodel.ISource> composites) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingleAttribute(java.net.URL.class, cleon.conception.architecture.spec.eamod.chrv.motivation.sources.SourcesPackage.SourceDocument_url, visitor);
    // relations
    ...
    _acceptList(cleon.conception.architecture.spec.eamod.chrv.motivation.sources.javamodel.ISourceChapter.class, cleon.conception.architecture.spec.eamod.chrv.motivation.sources.SourcesPackage.SourceDocument_chapters, visitor);
  ...
  public static cleon.conception.architecture.spec.eamod.chrv.motivation.sources.javamodel.ISourceDocument selectToMeChapters(cleon.conception.architecture.spec.eamod.chrv.motivation.sources.javamodel.ISourceChapter object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.architecture.spec.eamod.chrv.motivation.sources.javamodel.ISourceDocument.class, cleon.conception.architecture.spec.eamod.chrv.motivation.sources.SourcesPackage.SourceDocument_chapters, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,0322fa0c-bb80-11e5-b2f7-f515c847fa35,27ZAIMaZFxI9LMfChEnRI+Xqhmc=] */
