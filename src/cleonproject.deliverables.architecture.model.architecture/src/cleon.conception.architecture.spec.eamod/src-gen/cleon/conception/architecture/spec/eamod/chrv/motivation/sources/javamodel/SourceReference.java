...
public class SourceReference extends DynamicResource implements ISourceReference {
  ...
  @Override
  public cleon.conception.architecture.spec.eamod.chrv.motivation.sources.javamodel.ISourceChapter selectComposite() {
    return _getSingle(cleon.conception.architecture.spec.eamod.chrv.motivation.sources.javamodel.ISourceChapter.class, cleon.conception.architecture.spec.eamod.chrv.motivation.sources.SourcesPackage.SourceReference_composite);
  }

  public SourceReference setComposite(cleon.conception.architecture.spec.eamod.chrv.motivation.sources.javamodel.ISourceChapter composite) {
    _setSingle(cleon.conception.architecture.spec.eamod.chrv.motivation.sources.SourcesPackage.SourceReference_composite, composite);
    return this;
  }
  ...
  public SourceReference setComposites(java.util.List<? extends cleon.conception.architecture.spec.eamod.chrv.motivation.sources.javamodel.ISource> composites) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(cleon.conception.architecture.spec.eamod.chrv.motivation.sources.javamodel.ISourceChapter.class, cleon.conception.architecture.spec.eamod.chrv.motivation.sources.SourcesPackage.SourceReference_composite, visitor);
  ...
  public static cleon.conception.architecture.spec.eamod.chrv.motivation.sources.javamodel.ISourceReference selectToMeComposite(cleon.conception.architecture.spec.eamod.chrv.motivation.sources.javamodel.ISourceChapter object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.architecture.spec.eamod.chrv.motivation.sources.javamodel.ISourceReference.class, cleon.conception.architecture.spec.eamod.chrv.motivation.sources.SourcesPackage.SourceReference_composite, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,6c70c4b2-06f6-11e6-8d3e-13e5be4bd43b,HGFn4QvkYIOpq6A981NUoxEgs04=] */
