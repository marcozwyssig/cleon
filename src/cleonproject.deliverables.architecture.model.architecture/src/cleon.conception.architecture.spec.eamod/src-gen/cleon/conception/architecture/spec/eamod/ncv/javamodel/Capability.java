...
public class Capability extends DynamicResource implements ICapability {
  ...
  public Capability setCapabilityComposition(java.util.List<? extends cleon.conception.architecture.spec.eamod.ncv.javamodel.ICapability> capabilityComposition) {
  ...
  public Capability setCapabilityDependency(java.util.List<? extends cleon.conception.architecture.spec.eamod.ncv.javamodel.ICapability> capabilityDependency) {
  ...
  public Capability setCapabilitySpecialisation(cleon.conception.architecture.spec.eamod.ncv.javamodel.ICapability capabilitySpecialisation) {
  ...
  public static cleon.conception.architecture.spec.eamod.ncv.javamodel.ICapability selectToMeCapabilityComposition(cleon.conception.architecture.spec.eamod.ncv.javamodel.ICapability object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.architecture.spec.eamod.ncv.javamodel.ICapability.class, cleon.conception.architecture.spec.eamod.ncv.NcvPackage.Capability_capabilityComposition, object.getResource());
  }
  
  public static java.util.List<cleon.conception.architecture.spec.eamod.ncv.javamodel.ICapability> selectToMeCapabilitySpecialisation(cleon.conception.architecture.spec.eamod.ncv.javamodel.ICapability object) {
    return _getToMeList(object.getRepository(), cleon.conception.architecture.spec.eamod.ncv.javamodel.ICapability.class, cleon.conception.architecture.spec.eamod.ncv.NcvPackage.Capability_capabilitySpecialisation, object.getResource());
  }
  
  public static java.util.List<cleon.conception.architecture.spec.eamod.ncv.javamodel.ICapability> selectToMeCapabilityDependency(cleon.conception.architecture.spec.eamod.ncv.javamodel.ICapability object) {
    return _getToMeList(object.getRepository(), cleon.conception.architecture.spec.eamod.ncv.javamodel.ICapability.class, cleon.conception.architecture.spec.eamod.ncv.NcvPackage.Capability_capabilityDependency, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,6c58e62c-bc80-11e6-beb6-85da12323ce9,Ql1SN2yr5JoLDq1hmeqQ9fP0D40=] */
