...
public class ServiceLifetime extends DynamicResource implements IServiceLifetime {
  ...
  public boolean isNA__F___S___F_NotAvailable() {
    return getResource().equals(cleon.conception.architecture.spec.eamod.nsov.v1.lifetime.LifetimePackage.ServiceLifetime_NA__F___S___F_NotAvailable);
  }
  
  @Override
  public boolean isPL__F___S___F_Planned() {
    return getResource().equals(cleon.conception.architecture.spec.eamod.nsov.v1.lifetime.LifetimePackage.ServiceLifetime_PL__F___S___F_Planned);
  }
  
  @Override
  public boolean isGA__F___S___F_General__F_Availability() {
    return getResource().equals(cleon.conception.architecture.spec.eamod.nsov.v1.lifetime.LifetimePackage.ServiceLifetime_GA__F___S___F_General__F_Availability);
  }
  
  @Override
  public boolean isEOL__F___S___F_EndOfLife() {
    return getResource().equals(cleon.conception.architecture.spec.eamod.nsov.v1.lifetime.LifetimePackage.ServiceLifetime_EOL__F___S___F_EndOfLife);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,8710140c-c149-11e6-8f58-ad3c6ee7602f,AFX6T/DyrENNAQJZryKk3g+/NAw=] */
