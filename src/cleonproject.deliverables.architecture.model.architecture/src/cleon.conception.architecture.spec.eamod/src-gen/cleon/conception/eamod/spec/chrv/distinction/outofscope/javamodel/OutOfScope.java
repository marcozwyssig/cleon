...
public class OutOfScope extends DynamicResource implements IOutOfScope {
  ...
  public java.lang.String selectRejectReason() {
    return _getSingleAttribute(java.lang.String.class, cleon.conception.eamod.spec.chrv.distinction.DistinctionPackage.Destinction_rejectReason);
  }
    
  public void setRejectReason(java.lang.String rejectReason) {
     _setSingleAttribute(cleon.conception.eamod.spec.chrv.distinction.DistinctionPackage.Destinction_rejectReason, rejectReason);
  }
  ...
  public OutOfScope setIssues(java.util.List<? extends cleon.conception.eamod.spec.chrv.issues.javamodel.IIssue> issues) {
  ...
  public OutOfScope setOriginatesFromSource(java.util.List<? extends cleon.conception.eamod.spec.chrv.motivation.sources.javamodel.ISource> originatesFromSource) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingleAttribute(java.lang.String.class, cleon.conception.eamod.spec.chrv.distinction.DistinctionPackage.Destinction_rejectReason, visitor);
    // relations
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,8e42702d-0c7e-11e6-86c5-87a8b520dd59,FzhlnOy7jJlXOtzwYRbel7POefg=] */
