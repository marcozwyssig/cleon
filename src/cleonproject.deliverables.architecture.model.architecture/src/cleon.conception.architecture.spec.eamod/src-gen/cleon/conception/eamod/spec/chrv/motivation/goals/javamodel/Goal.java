...
public class Goal extends DynamicResource implements IGoal {
  ...
  @Override
  public java.util.List<? extends cleon.conception.eamod.spec.chrv.motivation.drivers.javamodel.IDriver> selectAddresses() {
    return _getList(cleon.conception.eamod.spec.chrv.motivation.drivers.javamodel.IDriver.class, cleon.conception.eamod.spec.chrv.motivation.drivers.DriversPackage.DriverAware_addresses);
  }

  public Goal setAddresses(java.util.List<? extends cleon.conception.eamod.spec.chrv.motivation.drivers.javamodel.IDriver> addresses) {
    _setList(cleon.conception.eamod.spec.chrv.motivation.drivers.DriversPackage.DriverAware_addresses, addresses);
    return this;
  }
  ...
  public java.util.List<? extends cleon.conception.eamod.spec.chrv.motivation.goals.javamodel.IGoal> selectGoalAggregation() {
    return _getList(cleon.conception.eamod.spec.chrv.motivation.goals.javamodel.IGoal.class, cleon.conception.eamod.spec.chrv.motivation.goals.GoalsPackage.Goal_goalAggregation);
  }

  public Goal setGoalAggregation(java.util.List<? extends cleon.conception.eamod.spec.chrv.motivation.goals.javamodel.IGoal> goalAggregation) {
    _setList(cleon.conception.eamod.spec.chrv.motivation.goals.GoalsPackage.Goal_goalAggregation, goalAggregation);
    return this;
  }
  ...
  public Goal setOriginatesFromSource(java.util.List<? extends cleon.conception.eamod.spec.chrv.motivation.sources.javamodel.ISource> originatesFromSource) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    // relations
    _acceptList(cleon.conception.eamod.spec.chrv.motivation.drivers.javamodel.IDriver.class, cleon.conception.eamod.spec.chrv.motivation.drivers.DriversPackage.DriverAware_addresses, visitor);
    ...
    _acceptList(cleon.conception.eamod.spec.chrv.motivation.goals.javamodel.IGoal.class, cleon.conception.eamod.spec.chrv.motivation.goals.GoalsPackage.Goal_goalAggregation, visitor);
  ...
  public static cleon.conception.eamod.spec.chrv.motivation.goals.javamodel.IGoal selectToMeGoalAggregation(cleon.conception.eamod.spec.chrv.motivation.goals.javamodel.IGoal object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.eamod.spec.chrv.motivation.goals.javamodel.IGoal.class, cleon.conception.eamod.spec.chrv.motivation.goals.GoalsPackage.Goal_goalAggregation, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,31468bb8-a951-11e5-bda2-a7fc3bd7c783,HJHFXydV37WVqBtLE2zOfqycHsU=] */
