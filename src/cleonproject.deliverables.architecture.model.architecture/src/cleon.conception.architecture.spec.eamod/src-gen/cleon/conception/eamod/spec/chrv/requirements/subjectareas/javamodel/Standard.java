...
public class Standard extends DynamicResource implements IStandard {
  ...
  public Standard setAchieves(java.util.List<? extends cleon.conception.eamod.spec.chrv.motivation.goals.javamodel.IGoal> achieves) {
  ...
  public Standard setRequirements(java.util.List<? extends cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.javamodel.IRequirement> requirements) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,bfe27688-0c77-11e6-86c5-87a8b520dd59,JHOHnVqFC8/ZchQ+kucw4KBkAJU=] */
