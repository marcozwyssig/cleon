...
public class ConstraintRequirement extends DynamicResource implements IConstraintRequirement {
  ...
  public ConstraintRequirement setAbstractionLevel(cleon.conception.eamod.spec.chrv.requirements.subjectareas.abstraction_level.javamodel.IAbstractionLevel abstractionLevel) {
  ...
  public ConstraintRequirement setAchieves(java.util.List<? extends cleon.conception.eamod.spec.chrv.motivation.goals.javamodel.IGoal> achieves) {
  ...
  public ConstraintRequirement setAggregates(java.util.List<? extends cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.javamodel.IRequirement> aggregates) {
  ...
  public ConstraintRequirement setConcretizes(java.util.List<? extends cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.javamodel.IRequirement> concretizes) {
  ...
  public ConstraintRequirement setConflicts(java.util.List<? extends cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.javamodel.IRequirement> conflicts) {
  ...
  public ConstraintRequirement setEstimate(cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.javamodel.IEffort estimate) {
  ...
  public ConstraintRequirement setIssues(java.util.List<? extends cleon.conception.eamod.spec.chrv.issues.javamodel.IIssue> issues) {
  ...
  public ConstraintRequirement setOriginatesFromSource(java.util.List<? extends cleon.conception.eamod.spec.chrv.motivation.sources.javamodel.ISource> originatesFromSource) {
  ...
  public ConstraintRequirement setOwners(java.util.List<? extends cleon.conception.eamod.spec.chrv.motivation.stakeholder.javamodel.IStakeholder> owners) {
  ...
  public ConstraintRequirement setState(cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.javamodel.IRequirementState state) {
  ...
  public ConstraintRequirement setTemplate(cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.template.javamodel.INonFunctionalTemplate template) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,a994ec69-a95d-11e5-bda2-a7fc3bd7c783,L53A50s2CnD14OeyfxItipkkRVc=] */
