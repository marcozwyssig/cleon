...
public class Event extends DynamicResource implements IEvent {
  ...
  public java.util.List<? extends cleon.conception.uml.spec.uml.structural.classes.javamodel.IClassifier> selectEventType() {
    return _getList(cleon.conception.uml.spec.uml.structural.classes.javamodel.IClassifier.class, cleon.conception.architecture.spec.soa.SoaPackage.Event_eventType);
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    // relations
    _acceptList(cleon.conception.uml.spec.uml.structural.classes.javamodel.IClassifier.class, cleon.conception.architecture.spec.soa.SoaPackage.Event_eventType, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

  // toMeRelations
  
  public static java.util.List<cleon.conception.architecture.spec.soa.javamodel.IEvent> selectToMeEventType(cleon.conception.uml.spec.uml.structural.classes.javamodel.IClassifier object) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,3789a935-a3ba-11e3-8095-f11af53ab806,Wbj5aJ7G3HIQBJ3aKemeg/WzDsQ=] */
