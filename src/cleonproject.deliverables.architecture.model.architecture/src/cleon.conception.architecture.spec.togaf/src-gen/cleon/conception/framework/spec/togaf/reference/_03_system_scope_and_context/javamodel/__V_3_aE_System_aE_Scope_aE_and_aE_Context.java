package cleon.conception.framework.spec.togaf.reference._03_system_scope_and_context.javamodel;
...
public class __V_3_aE_System_aE_Scope_aE_and_aE_Context extends DynamicResource implements I__V_3_aE_System_aE_Scope_aE_and_aE_Context {
  ...
  @Override
  public cleon.conception.framework.spec.togaf.reference._05_architecturebuildingblock_view.javamodel.ISystem selectSystem() {
    return _getSingle(cleon.conception.framework.spec.togaf.reference._05_architecturebuildingblock_view.javamodel.ISystem.class, cleon.conception.framework.spec.togaf.reference._03_system_scope_and_context._03_system_scope_and_contextPackage.__V_3_aE_System_aE_Scope_aE_and_aE_Context_system);
  }

  public __V_3_aE_System_aE_Scope_aE_and_aE_Context setSystem(cleon.conception.framework.spec.togaf.reference._05_architecturebuildingblock_view.javamodel.ISystem system) {
    _setSingle(cleon.conception.framework.spec.togaf.reference._03_system_scope_and_context._03_system_scope_and_contextPackage.__V_3_aE_System_aE_Scope_aE_and_aE_Context_system, system);
    return this;
  }
  ...
  public static cleon.conception.framework.spec.togaf.reference._03_system_scope_and_context.javamodel.I__V_3_aE_System_aE_Scope_aE_and_aE_Context selectToMeSystem(cleon.conception.framework.spec.togaf.reference._05_architecturebuildingblock_view.javamodel.ISystem object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.framework.spec.togaf.reference._03_system_scope_and_context.javamodel.I__V_3_aE_System_aE_Scope_aE_and_aE_Context.class, cleon.conception.framework.spec.togaf.reference._03_system_scope_and_context._03_system_scope_and_contextPackage.__V_3_aE_System_aE_Scope_aE_and_aE_Context_system, object.getResource());
  }
