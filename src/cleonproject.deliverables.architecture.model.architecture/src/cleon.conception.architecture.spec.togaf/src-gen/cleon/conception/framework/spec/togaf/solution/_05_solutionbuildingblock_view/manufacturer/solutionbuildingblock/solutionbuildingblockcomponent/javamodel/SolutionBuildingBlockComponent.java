...
public class SolutionBuildingBlockComponent extends DynamicResource implements ISolutionBuildingBlockComponent {
  ...
  public SolutionBuildingBlockComponent setHasDependency(java.util.List<? extends cleon.conception.uml.spec.uml.structural.components.javamodel.IComponentDependency> hasDependency) {
    _setList(cleon.conception.framework.spec.togaf.solution._05_solutionbuildingblock_view.manufacturer.solutionbuildingblock.solutionbuildingblockcomponent.SolutionbuildingblockcomponentPackage.SolutionBuildingBlockComponent_hasDependency, hasDependency);
    return this;
  }
  ...
  public static cleon.conception.framework.spec.togaf.solution._05_solutionbuildingblock_view.manufacturer.solutionbuildingblock.solutionbuildingblockcomponent.javamodel.ISolutionBuildingBlockComponent selectToMeHasDependency(cleon.conception.uml.spec.uml.structural.components.javamodel.IComponentDependency object) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,31890305-33a2-11e6-94cd-fbf6c8ccd08d,cejJv9+1/42Wruw5zvRJeB4S9ws=] */
