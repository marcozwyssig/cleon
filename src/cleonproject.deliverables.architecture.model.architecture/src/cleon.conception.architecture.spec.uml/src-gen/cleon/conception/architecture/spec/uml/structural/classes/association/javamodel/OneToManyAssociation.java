...
public class OneToManyAssociation extends DynamicResource implements IOneToManyAssociation {
  ...
  public OneToManyAssociation setAssocationType(cleon.conception.architecture.spec.uml.structural.classes.association.javamodel.IAssociationType assocationType) {
  ...
  public OneToManyAssociation setCollectionType(cleon.conception.architecture.spec.uml.structural.classes.association.javamodel.ICollectionType collectionType) {
  ...
  public OneToManyAssociation setTo(cleon.conception.architecture.spec.uml.structural.classes.javamodel.IClassifier to) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,e11893b8-2783-11e3-a466-eda9d7258bca,l8mGXvS6vnmNJ06AJF5Bh9Axwdc=] */
