...
public class InterfaceService extends DynamicResource implements IInterfaceService {
  ...
  public InterfaceService setData(java.util.List<? extends cleon.conception.architecture.spec.uml.structural.classes.interfaces.javamodel.IInterfaceData> data) {
  ...
  public InterfaceService setMethods(java.util.List<? extends cleon.conception.architecture.spec.uml.structural.classes.method.javamodel.IMethod> methods) {
  ...
  public static java.util.List<cleon.conception.architecture.spec.uml.structural.classes.interfaces.javamodel.IInterfaceService> selectToMeData(cleon.conception.architecture.spec.uml.structural.classes.interfaces.javamodel.IInterfaceData object) {
    return _getToMeList(object.getRepository(), cleon.conception.architecture.spec.uml.structural.classes.interfaces.javamodel.IInterfaceService.class, cleon.conception.architecture.spec.uml.structural.classes.interfaces.InterfacesPackage.InterfaceService_data, object.getResource());
  }
