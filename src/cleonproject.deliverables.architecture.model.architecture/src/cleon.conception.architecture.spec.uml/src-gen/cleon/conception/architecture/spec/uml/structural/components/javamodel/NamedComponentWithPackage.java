...
public class NamedComponentWithPackage extends DynamicResource implements INamedComponentWithPackage {
  ...
  public NamedComponentWithPackage setDecompose(java.util.List<? extends cleon.conception.architecture.spec.buildingblock.javamodel.IDecomposite> decompose) {
  ...
  public NamedComponentWithPackage setDecomposePackages(java.util.List<? extends cleon.conception.architecture.spec.uml.structural.packages.javamodel.IPackageDecomposition> decomposePackages) {
  ...
  public NamedComponentWithPackage setHasDependency(java.util.List<? extends cleon.conception.architecture.spec.uml.structural.components.javamodel.IComponentDependency> hasDependency) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,46835629-41b0-11e5-86f2-816f5628b22b,YYUzR6fQdF4y9+mvesyzBSYKmgY=] */
