...
public class Package extends DynamicResource implements IPackage {
  ...
  public Package setDecomposeClasses(java.util.List<? extends cleon.conception.architecture.spec.uml.structural.packages.javamodel.IPackageInClassifierDecomposition> decomposeClasses) {
  ...
  public Package setSubPackages(java.util.List<? extends cleon.conception.architecture.spec.uml.structural.packages.javamodel.IPackageDecomposition> subPackages) {
  ...
  public static cleon.conception.architecture.spec.uml.structural.packages.javamodel.IPackage selectToMeSubPackages(cleon.conception.architecture.spec.uml.structural.packages.javamodel.IPackageDecomposition object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.architecture.spec.uml.structural.packages.javamodel.IPackage.class, cleon.conception.architecture.spec.uml.structural.packages.PackagesPackage.Package_subPackages, object.getResource());
  }
  
  public static cleon.conception.architecture.spec.uml.structural.packages.javamodel.IPackage selectToMeDecomposeClasses(cleon.conception.architecture.spec.uml.structural.packages.javamodel.IPackageInClassifierDecomposition object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.architecture.spec.uml.structural.packages.javamodel.IPackage.class, cleon.conception.architecture.spec.uml.structural.packages.PackagesPackage.Package_decomposeClasses, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,2f4eebfb-92f9-11e3-a63e-fb8038f76aec,z0DIe/9pTH7FZpJT3Y1dp3siOug=] */
