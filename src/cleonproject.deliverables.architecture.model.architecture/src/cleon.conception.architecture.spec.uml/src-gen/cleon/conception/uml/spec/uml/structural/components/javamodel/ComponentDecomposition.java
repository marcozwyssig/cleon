...
public class ComponentDecomposition extends DynamicResource implements IComponentDecomposition {
  ...
  @Override
  public cleon.conception.uml.spec.uml.structural.packages.javamodel.IPackage selectDecompose() {
    return _getSingle(cleon.conception.uml.spec.uml.structural.packages.javamodel.IPackage.class, cleon.conception.uml.spec.uml.structural.components.ComponentsPackage.ComponentDecomposition_decompose);
  }

  public ComponentDecomposition setDecompose(cleon.conception.uml.spec.uml.structural.packages.javamodel.IPackage decompose) {
    _setSingle(cleon.conception.uml.spec.uml.structural.components.ComponentsPackage.ComponentDecomposition_decompose, decompose);
    return this;
  }
  ...
  public static cleon.conception.uml.spec.uml.structural.components.javamodel.IComponentDecomposition selectToMeDecompose(cleon.conception.uml.spec.uml.structural.packages.javamodel.IPackage object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.uml.spec.uml.structural.components.javamodel.IComponentDecomposition.class, cleon.conception.uml.spec.uml.structural.components.ComponentsPackage.ComponentDecomposition_decompose, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,d4692e40-1755-11e5-9ca7-d1bb57b73459,FLtXqaUGlYbjs95fb1XsslHAi8Q=] */
