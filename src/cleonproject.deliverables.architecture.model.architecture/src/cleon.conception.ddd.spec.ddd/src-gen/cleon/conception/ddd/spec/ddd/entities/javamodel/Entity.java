package cleon.conception.ddd.spec.ddd.entities.javamodel;
...
public class Entity extends DynamicResource implements IEntity {
  ...
  public Entity setCustomEvents(java.util.List<? extends cleon.conception.uml.spec.uml.structural.classes.events.javamodel.ICustomEvent> customEvents) {
  ...
  public Entity setDocumentElements(java.util.List<? extends cleon.common.doc.spec.doc.javamodel.IDocumentElement> documentElements) {
  ...
  public Entity setEvents(java.util.List<? extends cleon.conception.uml.spec.uml.structural.classes.events.javamodel.IEvent> events) {
    _setList(cleon.conception.uml.spec.uml.structural.classes.ClassesPackage.EventClass_events, events);
    return this;
  }
    
  @Override
  public cleon.conception.ddd.spec.ddd.entities.javamodel.IEntity selectExtends() {
    return _getSingle(cleon.conception.ddd.spec.ddd.entities.javamodel.IEntity.class, cleon.conception.ddd.spec.ddd.entities.EntitiesPackage.Entity_extends);
  }

  public Entity setExtends(cleon.conception.ddd.spec.ddd.entities.javamodel.IEntity extends_) {
    _setSingle(cleon.conception.ddd.spec.ddd.entities.EntitiesPackage.Entity_extends, extends_);
    return this;
  }
  ...
  public Entity setFieldEvents(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.conception.uml.spec.uml.structural.classes.events.javamodel.IEventForField> fieldEvents) {
  ...
  public Entity setFields(java.util.List<? extends cleon.conception.uml.spec.uml.structural.classes.fields.javamodel.IField> fields) {
  ...
  public Entity setHasDependency(java.util.List<? extends cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IDependency> hasDependency) {
  ...
  public Entity setMethods(java.util.List<? extends cleon.conception.uml.spec.uml.structural.classes.method.javamodel.IMethod> methods) {
  ...
  public Entity setRelations(java.util.List<? extends cleon.conception.uml.spec.uml.structural.classes.association.javamodel.IAssociation> relations) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(cleon.conception.ddd.spec.ddd.entities.javamodel.IEntity.class, cleon.conception.ddd.spec.ddd.entities.EntitiesPackage.Entity_extends, visitor);
  ...
  public static java.util.List<cleon.conception.ddd.spec.ddd.entities.javamodel.IEntity> selectToMeExtends(cleon.conception.ddd.spec.ddd.entities.javamodel.IEntity object) {
    return _getToMeList(object.getRepository(), cleon.conception.ddd.spec.ddd.entities.javamodel.IEntity.class, cleon.conception.ddd.spec.ddd.entities.EntitiesPackage.Entity_extends, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,8914497d-10c0-11e3-b60e-ab478a3e1eca,wtNmUdMXzT6e4S1ykV+qwa/ovcI=] */
