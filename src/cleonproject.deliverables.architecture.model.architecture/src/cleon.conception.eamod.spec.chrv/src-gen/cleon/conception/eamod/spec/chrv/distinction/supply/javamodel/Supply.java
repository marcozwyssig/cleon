...
public class Supply extends DynamicResource implements ISupply {
  ...
  public Supply setAuthors(java.util.List<? extends cleon.common.doc.spec.doc.document.properties.member.javamodel.IMember> authors) {
  ...
  public Supply setIssues(java.util.List<? extends cleon.conception.eamod.spec.chrv.issues.javamodel.IIssue> issues) {
  ...
  public Supply setOriginatesFromSource(java.util.List<? extends cleon.conception.eamod.spec.chrv.motivation.sources.javamodel.ISource> originatesFromSource) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,9d823f2f-0c7e-11e6-86c5-87a8b520dd59,0FeypbPif4Mj1r1jfegS+/kDhq4=] */
