...
public class FunctionSpace {
  ...
  public static interface ISourceFunctions extends IDynamicResourceExtension {
    ...
    public List<cleon.conception.eamod.spec.chrv.motivation.sources.javamodel.ISource> GetAllSources();
  ...
  public static interface ISourceFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("4b8d7404-c58d-11e5-aeea-1db9268c0ee9")
    public java.lang.String GetId(final cleon.conception.eamod.spec.chrv.motivation.sources.javamodel.ISource source);
  ...
  public static class SourceFunctions {
    ...
    public static java.lang.String GetId(final cleon.conception.eamod.spec.chrv.motivation.sources.javamodel.ISource source) {
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,4b8d7402-c58d-11e5-aeea-1db9268c0ee9,44elsUisFkkC4V+5A6he16AXhGM=] */
