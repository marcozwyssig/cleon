...
public class SourceChapter extends DynamicResource implements ISourceChapter {
  ...
  public SourceChapter setComposites(java.util.List<? extends cleon.conception.eamod.spec.chrv.motivation.sources.javamodel.ISource> composites) {
    _setList(cleon.conception.eamod.spec.chrv.motivation.sources.SourcesPackage.Source_composites, composites);
    return this;
  }
    
  @Override
  public java.util.List<? extends cleon.conception.eamod.spec.chrv.motivation.sources.javamodel.ISourceReference> selectReferences() {
    return _getList(cleon.conception.eamod.spec.chrv.motivation.sources.javamodel.ISourceReference.class, cleon.conception.eamod.spec.chrv.motivation.sources.SourcesPackage.SourceChapter_references);
  }

  public SourceChapter setReferences(java.util.List<? extends cleon.conception.eamod.spec.chrv.motivation.sources.javamodel.ISourceReference> references) {
    _setList(cleon.conception.eamod.spec.chrv.motivation.sources.SourcesPackage.SourceChapter_references, references);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptList(cleon.conception.eamod.spec.chrv.motivation.sources.javamodel.ISourceReference.class, cleon.conception.eamod.spec.chrv.motivation.sources.SourcesPackage.SourceChapter_references, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

  // toMeRelations
  
  public static cleon.conception.eamod.spec.chrv.motivation.sources.javamodel.ISourceChapter selectToMeReferences(cleon.conception.eamod.spec.chrv.motivation.sources.javamodel.ISourceReference object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.eamod.spec.chrv.motivation.sources.javamodel.ISourceChapter.class, cleon.conception.eamod.spec.chrv.motivation.sources.SourcesPackage.SourceChapter_references, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,1165cb74-bb80-11e5-b2f7-f515c847fa35,xOgqr6+SzyCtgsNIZpIKe5DP22w=] */
