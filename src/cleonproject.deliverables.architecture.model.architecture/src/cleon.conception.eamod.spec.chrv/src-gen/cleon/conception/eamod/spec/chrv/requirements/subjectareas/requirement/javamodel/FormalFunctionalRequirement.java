...
public class FormalFunctionalRequirement extends DynamicResource implements IFormalFunctionalRequirement {
  ...
  public FormalFunctionalRequirement setAbstractionLevel(cleon.conception.eamod.spec.chrv.requirements.subjectareas.abstraction_level.javamodel.IAbstractionLevel abstractionLevel) {
  ...
  public FormalFunctionalRequirement setAchieves(java.util.List<? extends cleon.conception.eamod.spec.chrv.motivation.goals.javamodel.IGoal> achieves) {
  ...
  public FormalFunctionalRequirement setAggregates(java.util.List<? extends cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.javamodel.IRequirement> aggregates) {
  ...
  public FormalFunctionalRequirement setConcretizes(java.util.List<? extends cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.javamodel.IRequirement> concretizes) {
  ...
  public FormalFunctionalRequirement setConflicts(java.util.List<? extends cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.javamodel.IRequirement> conflicts) {
  ...
  public FormalFunctionalRequirement setIssues(java.util.List<? extends cleon.conception.eamod.spec.chrv.issues.javamodel.IIssue> issues) {
  ...
  public FormalFunctionalRequirement setOriginatesFromSource(java.util.List<? extends cleon.conception.eamod.spec.chrv.motivation.sources.javamodel.ISource> originatesFromSource) {
  ...
  public FormalFunctionalRequirement setOwners(java.util.List<? extends cleon.conception.eamod.spec.chrv.motivation.stakeholder.javamodel.IStakeholder> owners) {
  ...
  public FormalFunctionalRequirement setState(cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.javamodel.IRequirementState state) {
  ...
  @Override
  public cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.template.function.javamodel.IFunctionTemplate selectTemplate() {
    return _getSingle(cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.template.function.javamodel.IFunctionTemplate.class, cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.RequirementPackage.FormalFunctionalRequirement_template);
  }

  public FormalFunctionalRequirement setTemplate(cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.template.function.javamodel.IFunctionTemplate template) {
    _setSingle(cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.RequirementPackage.FormalFunctionalRequirement_template, template);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.template.function.javamodel.IFunctionTemplate.class, cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.RequirementPackage.FormalFunctionalRequirement_template, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

  // toMeRelations
  
  public static cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.javamodel.IFormalFunctionalRequirement selectToMeTemplate(cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.template.function.javamodel.IFunctionTemplate object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.javamodel.IFormalFunctionalRequirement.class, cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.RequirementPackage.FormalFunctionalRequirement_template, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,7244f943-a962-11e5-bda2-a7fc3bd7c783,9eNYpwIJcMeUyDmapWpb1UwXMtg=] */
