...
public class CapabilityDocument extends DynamicResource implements ICapabilityDocument {
  ...
  @Override
  public cleon.conception.eamod.spec.ncv.javamodel.ICapability selectRootCapability() {
    return _getSingle(cleon.conception.eamod.spec.ncv.javamodel.ICapability.class, cleon.conception.eamod.spec.ncv.NcvPackage.CapabilityDocument_rootCapability);
  }

  public CapabilityDocument setRootCapability(cleon.conception.eamod.spec.ncv.javamodel.ICapability rootCapability) {
    _setSingle(cleon.conception.eamod.spec.ncv.NcvPackage.CapabilityDocument_rootCapability, rootCapability);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(cleon.conception.eamod.spec.ncv.javamodel.ICapability.class, cleon.conception.eamod.spec.ncv.NcvPackage.CapabilityDocument_rootCapability, visitor);
  ...
  public static cleon.conception.eamod.spec.ncv.javamodel.ICapabilityDocument selectToMeRootCapability(cleon.conception.eamod.spec.ncv.javamodel.ICapability object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.eamod.spec.ncv.javamodel.ICapabilityDocument.class, cleon.conception.eamod.spec.ncv.NcvPackage.CapabilityDocument_rootCapability, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,40249800-ea1d-11e6-9264-5588938e0d2c,lD+sN909zmML270YFMFJM8dOQ78=] */
