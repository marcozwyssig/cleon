...
public class BaseProductGroup extends DynamicResource implements IBaseProductGroup {
  ...
  public java.util.List<? extends cleon.conception.eamod.spec.nsov.v2.productcatalog.product.javamodel.IBaseProduct> selectBaseProducts() {
    return _getList(cleon.conception.eamod.spec.nsov.v2.productcatalog.product.javamodel.IBaseProduct.class, cleon.conception.eamod.spec.nsov.v2.productcatalog.productgroup.ProductgroupPackage.BaseProductGroup_baseProducts);
  }

  public BaseProductGroup setBaseProducts(java.util.List<? extends cleon.conception.eamod.spec.nsov.v2.productcatalog.product.javamodel.IBaseProduct> baseProducts) {
    _setList(cleon.conception.eamod.spec.nsov.v2.productcatalog.productgroup.ProductgroupPackage.BaseProductGroup_baseProducts, baseProducts);
    return this;
  }
  ...
  public BaseProductGroup setProducts(java.util.List<? extends cleon.conception.eamod.spec.nsov.v2.productcatalog.product.javamodel.IProduct> products) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptList(cleon.conception.eamod.spec.nsov.v2.productcatalog.product.javamodel.IBaseProduct.class, cleon.conception.eamod.spec.nsov.v2.productcatalog.productgroup.ProductgroupPackage.BaseProductGroup_baseProducts, visitor);
  ...
  public static cleon.conception.eamod.spec.nsov.v2.productcatalog.productgroup.javamodel.IBaseProductGroup selectToMeBaseProducts(cleon.conception.eamod.spec.nsov.v2.productcatalog.product.javamodel.IBaseProduct object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.eamod.spec.nsov.v2.productcatalog.productgroup.javamodel.IBaseProductGroup.class, cleon.conception.eamod.spec.nsov.v2.productcatalog.productgroup.ProductgroupPackage.BaseProductGroup_baseProducts, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,e3dfe296-67c8-11e7-afcc-6df3a81a4d17,Kq7mASnE3LTDz6F9eEHDn5iwJuE=] */
