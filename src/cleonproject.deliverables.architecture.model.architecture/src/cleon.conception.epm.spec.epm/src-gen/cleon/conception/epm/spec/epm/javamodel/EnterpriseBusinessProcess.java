...
public class EnterpriseBusinessProcess extends DynamicResource implements IEnterpriseBusinessProcess {
  ...
  public cleon.conception.epm.spec.epm.operational.javamodel.IOperational selectOperational() {
    return _getSingle(cleon.conception.epm.spec.epm.operational.javamodel.IOperational.class, cleon.conception.epm.spec.epm.EpmPackage.EnterpriseBusinessProcess_operational);
  }

  public EnterpriseBusinessProcess setOperational(cleon.conception.epm.spec.epm.operational.javamodel.IOperational operational) {
    _setSingle(cleon.conception.epm.spec.epm.EpmPackage.EnterpriseBusinessProcess_operational, operational);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    // relations
    _acceptSingle(cleon.conception.epm.spec.epm.operational.javamodel.IOperational.class, cleon.conception.epm.spec.epm.EpmPackage.EnterpriseBusinessProcess_operational, visitor);
  ...
  public static cleon.conception.epm.spec.epm.javamodel.IEnterpriseBusinessProcess selectToMeOperational(cleon.conception.epm.spec.epm.operational.javamodel.IOperational object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.epm.spec.epm.javamodel.IEnterpriseBusinessProcess.class, cleon.conception.epm.spec.epm.EpmPackage.EnterpriseBusinessProcess_operational, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,037d0836-bb6a-11e3-bf59-6b10d9dd6d36,sSPKVmBLD0tcx9w3KGMea6ENT4A=] */
