...
public class SecurityRequirement extends DynamicResource implements ISecurityRequirement {
  ...
  public SecurityRequirement setAbstractionLevel(cleon.conception.eamod.spec.chrv.requirements.subjectareas.abstraction_level.javamodel.IAbstractionLevel abstractionLevel) {
  ...
  public SecurityRequirement setAchieves(java.util.List<? extends cleon.conception.eamod.spec.chrv.motivation.goals.javamodel.IGoal> achieves) {
  ...
  public SecurityRequirement setAggregates(java.util.List<? extends cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.javamodel.IRequirement> aggregates) {
  ...
  public SecurityRequirement setConcretizes(java.util.List<? extends cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.javamodel.IRequirement> concretizes) {
  ...
  public SecurityRequirement setConflicts(java.util.List<? extends cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.javamodel.IRequirement> conflicts) {
  ...
  public SecurityRequirement setCoverageQualities(java.util.List<? extends cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.quality.iso_25000.spec.javamodel.ISoftwareQuality> coverageQualities) {
  ...
  public SecurityRequirement setEstimate(cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.javamodel.IEffort estimate) {
  ...
  public SecurityRequirement setIssues(java.util.List<? extends cleon.conception.eamod.spec.chrv.issues.javamodel.IIssue> issues) {
  ...
  public SecurityRequirement setOriginatesFromSource(java.util.List<? extends cleon.conception.eamod.spec.chrv.motivation.sources.javamodel.ISource> originatesFromSource) {
  ...
  public SecurityRequirement setOwners(java.util.List<? extends cleon.conception.eamod.spec.chrv.motivation.stakeholder.javamodel.IStakeholder> owners) {
  ...
  public SecurityRequirement setState(cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.javamodel.IRequirementState state) {
  ...
  public SecurityRequirement setTemplate(cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.template.javamodel.INonFunctionalTemplate template) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,8f44a06a-a95d-11e5-bda2-a7fc3bd7c783,qKTD6xHGj+KXEP/QJJg876q9BZ8=] */
