...
public class ModuleUtilizationWithService extends DynamicResource implements IModuleUtilizationWithService {
  ...
  public ModuleUtilizationWithService setAchiviesDeliverable(java.util.List<? extends cleon.support.projectmanagement.spec.planning.scope.deliverable.javamodel.IDeliverable> achiviesDeliverable) {
  ...
  public ModuleUtilizationWithService setModule(cleon.support.projectmanagement.spec.planning.scope.module.javamodel.IModule module) {
  ...
  public java.util.Map<ch.actifsource.core.Resource, ? extends cleon.conception.eamod.spec.nsov.v1.nsov.usage.javamodel.IServiceUsage> selectRequiredDeliverable() {
    return _getMap(cleon.conception.eamod.spec.nsov.v1.nsov.usage.javamodel.IServiceUsage.class, cleon.conception.eamod.spec.nsov.v1.nsov.usage.UsagePackage.ModuleUtilizationWithService_requiredDeliverable);
  }

  public ModuleUtilizationWithService setRequiredDeliverable(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.conception.eamod.spec.nsov.v1.nsov.usage.javamodel.IServiceUsage> requiredDeliverable) {
    _setMap(cleon.conception.eamod.spec.nsov.v1.nsov.usage.UsagePackage.ModuleUtilizationWithService_requiredDeliverable, requiredDeliverable);
    return this;
  }
  ...
  public ModuleUtilizationWithService setRoleUtilizations(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.support.projectmanagement.spec.planning.scope.workpackage.utilization.javamodel.IRoleUtilization> roleUtilizations) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptMap(cleon.conception.eamod.spec.nsov.v1.nsov.usage.javamodel.IServiceUsage.class, cleon.conception.eamod.spec.nsov.v1.nsov.usage.UsagePackage.ModuleUtilizationWithService_requiredDeliverable, visitor);
  ...
  public static cleon.conception.eamod.spec.nsov.v1.nsov.usage.javamodel.IModuleUtilizationWithService selectToMeRequiredDeliverable(cleon.conception.eamod.spec.nsov.v1.nsov.usage.javamodel.IServiceUsage object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.eamod.spec.nsov.v1.nsov.usage.javamodel.IModuleUtilizationWithService.class, cleon.conception.eamod.spec.nsov.v1.nsov.usage.UsagePackage.ModuleUtilizationWithService_requiredDeliverable, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,2f11960a-c6c4-11e6-8242-2f0ed6756d77,ku8jb9RgyCBLOK+QTx8E+pUPAEc=] */
