...
public class ServiceProducers extends DynamicResource implements IServiceProducers {
  ...
  public java.util.Map<ch.actifsource.core.Resource, ? extends cleon.conception.eamod.spec.nsov.v1.nsov.usage.javamodel.IServiceUsage> selectServices() {
    return _getMap(cleon.conception.eamod.spec.nsov.v1.nsov.usage.javamodel.IServiceUsage.class, cleon.conception.eamod.spec.nsov.v1.nsov.usage.UsagePackage.ServiceProducers_services);
  }

  public ServiceProducers setServices(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.conception.eamod.spec.nsov.v1.nsov.usage.javamodel.IServiceUsage> services) {
    _setMap(cleon.conception.eamod.spec.nsov.v1.nsov.usage.UsagePackage.ServiceProducers_services, services);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptMap(cleon.conception.eamod.spec.nsov.v1.nsov.usage.javamodel.IServiceUsage.class, cleon.conception.eamod.spec.nsov.v1.nsov.usage.UsagePackage.ServiceProducers_services, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

  // toMeRelations
  
  public static cleon.conception.eamod.spec.nsov.v1.nsov.usage.javamodel.IServiceProducers selectToMeServices(cleon.conception.eamod.spec.nsov.v1.nsov.usage.javamodel.IServiceUsage object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.eamod.spec.nsov.v1.nsov.usage.javamodel.IServiceProducers.class, cleon.conception.eamod.spec.nsov.v1.nsov.usage.UsagePackage.ServiceProducers_services, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,e164d2a6-c690-11e6-8242-2f0ed6756d77,CSTFnskNKkL/sjriGiknC87XkBc=] */
