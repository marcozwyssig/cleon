...
public class ArchitectureSolutionBuildingBlock extends DynamicResource implements IArchitectureSolutionBuildingBlock {
  ...
  public ArchitectureSolutionBuildingBlock setDecompose(java.util.List<? extends cleon.conception.modelinglanguage.spec.buildingblock.javamodel.IDecomposite> decompose) {
  ...
  public ArchitectureSolutionBuildingBlock setDecomposePackages(java.util.List<? extends cleon.conception.uml.spec.uml.structural.packages.javamodel.IPackageDecomposition> decomposePackages) {
  ...
  public ArchitectureSolutionBuildingBlock setDocumentElements(java.util.List<? extends cleon.common.doc.spec.doc.javamodel.IDocumentElement> documentElements) {
  ...
  public ArchitectureSolutionBuildingBlock setHasDependency(java.util.List<? extends cleon.conception.uml.spec.uml.structural.components.javamodel.IComponentDependency> hasDependency) {
  ...
  public ArchitectureSolutionBuildingBlock setNoPackages(cleon.conception.uml.spec.uml.structural.packages.javamodel.IPackageDecomposition noPackages) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,5b960871-3a07-11e6-a354-253097f89a49,yw/SbQNtBVKKE3ghSO29seNHRnA=] */
