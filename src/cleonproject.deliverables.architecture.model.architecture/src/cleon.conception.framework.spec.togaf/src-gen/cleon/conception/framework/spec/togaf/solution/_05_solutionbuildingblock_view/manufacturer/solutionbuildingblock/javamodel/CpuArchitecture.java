...
public class CpuArchitecture extends DynamicResource implements ICpuArchitecture {
  ...
  public boolean isX86_32bit() {
    return getResource().equals(cleon.conception.framework.spec.togaf.solution._05_solutionbuildingblock_view.manufacturer.solutionbuildingblock.SolutionbuildingblockPackage.CpuArchitecture_x86_aE_32bit);
  }
  
  @Override
  public boolean isX86_64bit() {
    return getResource().equals(cleon.conception.framework.spec.togaf.solution._05_solutionbuildingblock_view.manufacturer.solutionbuildingblock.SolutionbuildingblockPackage.CpuArchitecture_x86_aE_64bit);
  }
  
  @Override
  public boolean isX86_32_64_bit() {
    return getResource().equals(cleon.conception.framework.spec.togaf.solution._05_solutionbuildingblock_view.manufacturer.solutionbuildingblock.SolutionbuildingblockPackage.CpuArchitecture_x86_aE_32_aE_64_aE_bit);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,0bba3407-2d73-11e6-959f-d1cef44ff5fd,53Gt3118V8qoxZxI5TLhBiSZNI4=] */
