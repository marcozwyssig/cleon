...
public class Property extends DynamicResource implements IProperty {
  ...
  @Override
  public cleon.conception.uml.spec.uml.structural.classes.association.javamodel.ICollectionType selectAsCollection() {
    return _getSingle(cleon.conception.uml.spec.uml.structural.classes.association.javamodel.ICollectionType.class, cleon.conception.uml.spec.uml.structural.classes.fields.FieldsPackage.Property_asCollection);
  }

  public Property setAsCollection(cleon.conception.uml.spec.uml.structural.classes.association.javamodel.ICollectionType asCollection) {
    _setSingle(cleon.conception.uml.spec.uml.structural.classes.fields.FieldsPackage.Property_asCollection, asCollection);
    return this;
  }
  ...
  public Property setReturnType(cleon.conception.uml.spec.uml.structural.classes.javamodel.IClassifier returnType) {
  ...
  public Property setType(cleon.conception.uml.spec.uml.structural.classes.javamodel.IClassifier type) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    // relations
    _acceptSingle(cleon.conception.uml.spec.uml.structural.classes.association.javamodel.ICollectionType.class, cleon.conception.uml.spec.uml.structural.classes.fields.FieldsPackage.Property_asCollection, visitor);
  ...
  public static java.util.List<cleon.conception.uml.spec.uml.structural.classes.fields.javamodel.IProperty> selectToMeAsCollection(cleon.conception.uml.spec.uml.structural.classes.association.javamodel.ICollectionType object) {
    return _getToMeList(object.getRepository(), cleon.conception.uml.spec.uml.structural.classes.fields.javamodel.IProperty.class, cleon.conception.uml.spec.uml.structural.classes.fields.FieldsPackage.Property_asCollection, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,123c8e93-13ba-11e3-bec7-f1e135382475,sHjn8+9yrox3yJireClnvIADoBc=] */
