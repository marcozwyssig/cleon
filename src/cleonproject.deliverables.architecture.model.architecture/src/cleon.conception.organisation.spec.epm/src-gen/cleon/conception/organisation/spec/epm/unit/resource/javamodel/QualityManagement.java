...
public class QualityManagement extends DynamicResource implements IQualityManagement {
  ...
  public QualityManagement setResponsible(cleon.initialization.processlanguage.spec.bpmn.organisational.role.javamodel.IRole responsible) {
  ...
  public QualityManagement setStaff(java.util.List<? extends cleon.initialization.processlanguage.spec.bpmn.organisational.role.javamodel.IRole> staff) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,5ef0c365-daa6-11e3-ae07-89aa80d5ec3d,Gfu98uUnBnLAoNithHfiawgnrMw=] */
