...
public class FactoryPackage extends DynamicResource implements IFactoryPackage {
  ...
  public FactoryPackage setDecompose(java.util.List<? extends cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IDecomposite> decompose) {
  ...
  public FactoryPackage setDecomposeClasses(java.util.List<? extends cleon.conception.uml.spec.uml.structural.packages.javamodel.IPackageInClassifierDecomposition> decomposeClasses) {
  ...
  @Override
  public cleon.conception.gof.spec.gof.creational.factorymethod.javamodel.IFactoryCreator selectFactory() {
    return _getSingle(cleon.conception.gof.spec.gof.creational.factorymethod.javamodel.IFactoryCreator.class, cleon.conception.gof.spec.gof.creational.factorymethod.FactorymethodPackage.FactoryPackage_factory);
  }

  public FactoryPackage setFactory(cleon.conception.gof.spec.gof.creational.factorymethod.javamodel.IFactoryCreator factory) {
    _setSingle(cleon.conception.gof.spec.gof.creational.factorymethod.FactorymethodPackage.FactoryPackage_factory, factory);
    return this;
  }
  ...
  public FactoryPackage setSubPackages(java.util.List<? extends cleon.conception.uml.spec.uml.structural.packages.javamodel.IPackageDecomposition> subPackages) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(cleon.conception.gof.spec.gof.creational.factorymethod.javamodel.IFactoryCreator.class, cleon.conception.gof.spec.gof.creational.factorymethod.FactorymethodPackage.FactoryPackage_factory, visitor);
  ...
  public static cleon.conception.gof.spec.gof.creational.factorymethod.javamodel.IFactoryPackage selectToMeFactory(cleon.conception.gof.spec.gof.creational.factorymethod.javamodel.IFactoryCreator object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.gof.spec.gof.creational.factorymethod.javamodel.IFactoryPackage.class, cleon.conception.gof.spec.gof.creational.factorymethod.FactorymethodPackage.FactoryPackage_factory, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,46daf4f0-ddd3-11e4-b0b5-6911fa4e24e5,cKMA4Sva74D2AqfHgbsdVOoJ+EM=] */
