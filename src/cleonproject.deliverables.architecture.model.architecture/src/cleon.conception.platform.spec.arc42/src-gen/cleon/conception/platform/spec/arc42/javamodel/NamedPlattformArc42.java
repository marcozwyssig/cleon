package cleon.conception.platform.spec.arc42.javamodel;

import ch.actifsource.util.collection.IMultiMapOrdered;
import ch.actifsource.core.dynamic.*;

@edu.umd.cs.findbugs.annotations.SuppressWarnings("EQ_DOESNT_OVERRIDE_EQUALS")
public class NamedPlattformArc42 extends DynamicResource implements INamedPlattformArc42 {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<INamedPlattformArc42> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<INamedPlattformArc42>() {
    
    @Override
    public INamedPlattformArc42 create() {
      return new NamedPlattformArc42();
    }
    
    @Override
    public INamedPlattformArc42 create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new NamedPlattformArc42(resourceRepository, resource);
    }
  
  };

  public NamedPlattformArc42() {
    super(INamedPlattformArc42.TYPE_ID);
  }
  
  public NamedPlattformArc42(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
    super(resourceRepository, resource, INamedPlattformArc42.TYPE_ID);
  }
  ...
  public NamedPlattformArc42 set__V_1_aE_introduction_aE_and_aE_goals(cleon.conception.architecture.spec.arc42._01_introduction_and_goals.javamodel.I__V_1_aE_IntroductionAndGoals __V_1_aE_introduction_aE_and_aE_goals) {
  ...
  public NamedPlattformArc42 set__V_2_aE_architecture_aE_constraints(cleon.conception.architecture.spec.arc42._02_architecture_constraints.javamodel.I__V_2_aE_Architecture_aE_Constraints __V_2_aE_architecture_aE_constraints) {
  ...
  public NamedPlattformArc42 set__V_3_aE_system_aE_scope_aE_and_aE_context(cleon.conception.architecture.spec.arc42._03_system_scope_and_context.javamodel.I__V_3_aE_System_aE_Scope_aE_and_aE_Context __V_3_aE_system_aE_scope_aE_and_aE_context) {
  ...
  public NamedPlattformArc42 set__V_5_aE_buildingblockview(cleon.conception.architecture.spec.arc42._05_buildingblock_view.javamodel.I__V_5_aE_BuildingBlockView __V_5_aE_buildingblockview) {
  ...
  public NamedPlattformArc42 set__V_7_aE_deploymentview(cleon.conception.architecture.spec.arc42._07_deployment_view.javamodel.I__V_7_aE_DeploymentView __V_7_aE_deploymentview) {
  ...
  public NamedPlattformArc42 setDocumentElements(java.util.List<? extends cleon.common.doc.spec.doc.javamodel.IDocumentElement> documentElements) {
  ...
  public NamedPlattformArc42 setGlossary(cleon.common.glossary.spec.glossary.javamodel.IGlossary glossary) {
  ...
  public NamedPlattformArc42 setProperties(cleon.common.doc.spec.doc.document.properties.javamodel.IProperties properties) {
  ...
  public NamedPlattformArc42 setStyle(cleon.common.doc.spec.doc.document.style.javamodel.IStyle style) {
  ...
  public NamedPlattformArc42 setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,fdba55dd-99a9-11e8-8f58-219af2c5d6d9,mQUMVGerziLyARDZxTkL2yT2pxs=] */
