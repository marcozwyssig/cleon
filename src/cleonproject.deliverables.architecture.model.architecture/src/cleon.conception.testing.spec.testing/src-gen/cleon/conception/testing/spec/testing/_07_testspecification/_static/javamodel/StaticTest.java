...
public class StaticTest extends DynamicResource implements IStaticTest {
  ...
  public java.util.Map<ch.actifsource.core.Resource, ? extends cleon.conception.testing.spec.testing._07_testspecification._static.javamodel.IStaticTest> selectTestRequirements() {
    return _getMap(cleon.conception.testing.spec.testing._07_testspecification._static.javamodel.IStaticTest.class, cleon.conception.testing.spec.testing._07_testspecification._static._staticPackage.StaticTest_testRequirements);
  }

  public StaticTest setTestRequirements(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.conception.testing.spec.testing._07_testspecification._static.javamodel.IStaticTest> testRequirements) {
    _setMap(cleon.conception.testing.spec.testing._07_testspecification._static._staticPackage.StaticTest_testRequirements, testRequirements);
    return this;
  }
  ...
  public java.util.Map<ch.actifsource.core.Resource, ? extends cleon.conception.testing.spec.testing._09_test_execution.javamodel.ITestResult> selectTestResult() {
    return _getMap(cleon.conception.testing.spec.testing._09_test_execution.javamodel.ITestResult.class, cleon.conception.testing.spec.testing._07_testspecification._static._staticPackage.StaticTest_testResult);
  }

  public StaticTest setTestResult(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.conception.testing.spec.testing._09_test_execution.javamodel.ITestResult> testResult) {
    _setMap(cleon.conception.testing.spec.testing._07_testspecification._static._staticPackage.StaticTest_testResult, testResult);
    return this;
  }
  ...
  public static cleon.conception.testing.spec.testing._07_testspecification._static.javamodel.IStaticTest selectToMeTestResult(cleon.conception.testing.spec.testing._09_test_execution.javamodel.ITestResult object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.testing.spec.testing._07_testspecification._static.javamodel.IStaticTest.class, cleon.conception.testing.spec.testing._07_testspecification._static._staticPackage.StaticTest_testResult, object.getResource());
  }
  
  public static cleon.conception.testing.spec.testing._07_testspecification._static.javamodel.IStaticTest selectToMeTestRequirements(cleon.conception.testing.spec.testing._07_testspecification._static.javamodel.IStaticTest object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.testing.spec.testing._07_testspecification._static.javamodel.IStaticTest.class, cleon.conception.testing.spec.testing._07_testspecification._static._staticPackage.StaticTest_testRequirements, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,7cffe5db-1cf1-11e6-aaba-9db7fdc64d7e,e9tGaoRUipjWattS1CrgNcPR2SY=] */
