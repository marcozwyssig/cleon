...
public class ClassierDependency extends DynamicResource implements IClassierDependency {
  ...
  public static java.util.List<cleon.conception.uml.spec.uml.structural.classes.javamodel.IClassierDependency> selectToMeTo(cleon.conception.uml.spec.uml.structural.classes.javamodel.IClassifier object) {
    return _getToMeList(object.getRepository(), cleon.conception.uml.spec.uml.structural.classes.javamodel.IClassierDependency.class, cleon.conception.uml.spec.uml.structural.classes.ClassesPackage.ClassierDependency_to, object.getResource());
  }
