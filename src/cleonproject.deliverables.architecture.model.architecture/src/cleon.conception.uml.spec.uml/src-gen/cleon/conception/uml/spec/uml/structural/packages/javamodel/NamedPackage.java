...
public class NamedPackage extends DynamicResource implements INamedPackage {
  ...
  public NamedPackage setDecompose(java.util.List<? extends cleon.conception.arc.spec.arc42._05_buildingblock_view.buildingblock.javamodel.IDecomposite> decompose) {
  ...
  public NamedPackage setDecomposeClasses(java.util.List<? extends cleon.conception.uml.spec.uml.structural.packages.javamodel.IPackageInClassifierDecomposition> decomposeClasses) {
  ...
  public NamedPackage setSubPackages(java.util.List<? extends cleon.conception.uml.spec.uml.structural.packages.javamodel.IPackageDecomposition> subPackages) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,25dd5ea1-7aed-11e4-a6e2-23d949480f96,chuXOoN6AyLaJ4hrtpr3VTc37iE=] */
