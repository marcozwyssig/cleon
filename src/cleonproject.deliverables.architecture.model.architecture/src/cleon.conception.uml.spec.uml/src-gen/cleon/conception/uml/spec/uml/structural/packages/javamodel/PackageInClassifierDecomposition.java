...
public class PackageInClassifierDecomposition extends DynamicResource implements IPackageInClassifierDecomposition {
  ...
  public PackageInClassifierDecomposition setInto(cleon.conception.uml.spec.uml.structural.classes.javamodel.IClassifier into) {
  ...
  public static cleon.conception.uml.spec.uml.structural.packages.javamodel.IPackageInClassifierDecomposition selectToMeInto(cleon.conception.uml.spec.uml.structural.classes.javamodel.IClassifier object) {
    return _getToMeSingle(object.getRepository(), cleon.conception.uml.spec.uml.structural.packages.javamodel.IPackageInClassifierDecomposition.class, cleon.conception.uml.spec.uml.structural.packages.PackagesPackage.PackageInClassifierDecomposition_into, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,c64a4da0-1757-11e5-9ca7-d1bb57b73459,CXSilCeX6P89FPeNnXpbpBWWCDo=] */
