...
public class StaticTest extends DynamicResource implements IStaticTest {
  ...
  public cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.javamodel.IRequirement selectRequirement() {
    return _getSingle(cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.javamodel.IRequirement.class, cleon.implementation.testing.spec.testing._07_testspecification._static._staticPackage.StaticTest_requirement);
  }

  public StaticTest setRequirement(cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.javamodel.IRequirement requirement) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.javamodel.IRequirement.class, cleon.implementation.testing.spec.testing._07_testspecification._static._staticPackage.StaticTest_requirement, visitor);
  ...
  public static java.util.List<cleon.implementation.testing.spec.testing._07_testspecification._static.javamodel.IStaticTest> selectToMeRequirement(cleon.conception.eamod.spec.chrv.requirements.subjectareas.requirement.javamodel.IRequirement object) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,7cffe5db-1cf1-11e6-aaba-9db7fdc64d7e,gl2Q2W3EfM32Ze5iUgokNzMNIOM=] */
