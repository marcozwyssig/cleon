package cleon.initialization.processlanguage.spec.bpmn.javamodel;
...
public class Bpmn extends DynamicResource implements IBpmn {
  ...
  public Bpmn setOrganigram(cleon.initialization.processlanguage.spec.bpmn.organigram.javamodel.IOrganigram organigram) {
  ...
  public Bpmn setOrganisational(cleon.initialization.processlanguage.spec.bpmn.organisational.javamodel.IOrganisational organisational) {
  ...
  public static cleon.initialization.processlanguage.spec.bpmn.javamodel.IBpmn selectToMeOrganisational(cleon.initialization.processlanguage.spec.bpmn.organisational.javamodel.IOrganisational object) {
    return _getToMeSingle(object.getRepository(), cleon.initialization.processlanguage.spec.bpmn.javamodel.IBpmn.class, cleon.initialization.processlanguage.spec.bpmn.BpmnPackage.Bpmn_organisational, object.getResource());
  }
  
  public static cleon.initialization.processlanguage.spec.bpmn.javamodel.IBpmn selectToMeOrganigram(cleon.initialization.processlanguage.spec.bpmn.organigram.javamodel.IOrganigram object) {
    return _getToMeSingle(object.getRepository(), cleon.initialization.processlanguage.spec.bpmn.javamodel.IBpmn.class, cleon.initialization.processlanguage.spec.bpmn.BpmnPackage.Bpmn_organigram, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,b0d96e05-7e49-11e5-85ce-e7c8e0b30f03,vMPoFz8RUDbQTx6huESRQjdlp7s=] */
