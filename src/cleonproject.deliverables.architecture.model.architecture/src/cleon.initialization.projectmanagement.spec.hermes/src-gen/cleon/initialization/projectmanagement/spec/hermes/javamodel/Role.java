...
public class Role extends DynamicResource implements IRole {
  ...
  public java.util.List<java.lang.String> selectAuthority() {
    return _getListAttribute(java.lang.String.class, cleon.initialization.projectmanagement.spec.hermes.HermesPackage.Role_authority);
  }
    
  public void setAuthority(java.util.List<java.lang.String> authority) {
     _setListAttribute(cleon.initialization.projectmanagement.spec.hermes.HermesPackage.Role_authority, authority);
  }
  ...
  public java.util.List<java.lang.String> selectResponsibility() {
    return _getListAttribute(java.lang.String.class, cleon.initialization.projectmanagement.spec.hermes.HermesPackage.Role_responsibility);
  }
    
  public void setResponsibility(java.util.List<java.lang.String> responsibility) {
     _setListAttribute(cleon.initialization.projectmanagement.spec.hermes.HermesPackage.Role_responsibility, responsibility);
  }

  @Override
  public java.util.List<java.lang.String> selectSkills() {
    return _getListAttribute(java.lang.String.class, cleon.initialization.projectmanagement.spec.hermes.HermesPackage.Role_skills);
  }
    
  public void setSkills(java.util.List<java.lang.String> skills) {
     _setListAttribute(cleon.initialization.projectmanagement.spec.hermes.HermesPackage.Role_skills, skills);
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    // attributes
    _acceptListAttribute(java.lang.String.class, cleon.initialization.projectmanagement.spec.hermes.HermesPackage.Role_authority, visitor);
    ...
    _acceptListAttribute(java.lang.String.class, cleon.initialization.projectmanagement.spec.hermes.HermesPackage.Role_responsibility, visitor);
    _acceptListAttribute(java.lang.String.class, cleon.initialization.projectmanagement.spec.hermes.HermesPackage.Role_skills, visitor);
    // relations
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,92f47870-31ca-11e8-8a84-6f139e67278b,7SmV4oAOjJAHW/7Qe2u8464Yfb0=] */
