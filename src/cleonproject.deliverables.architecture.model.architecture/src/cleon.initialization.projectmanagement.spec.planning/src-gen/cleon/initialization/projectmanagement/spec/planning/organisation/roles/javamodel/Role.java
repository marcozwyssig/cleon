...
public class Role extends DynamicResource implements IRole {
  ...
  @Override
  public java.util.Map<ch.actifsource.core.Resource, ? extends cleon.initialization.projectmanagement.spec.planning.organisation.roles.javamodel.ISkillUtilization> selectRequiredSkills() {
    return _getMap(cleon.initialization.projectmanagement.spec.planning.organisation.roles.javamodel.ISkillUtilization.class, cleon.initialization.projectmanagement.spec.planning.organisation.roles.RolesPackage.Role_requiredSkills);
  }

  public Role setRequiredSkills(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.initialization.projectmanagement.spec.planning.organisation.roles.javamodel.ISkillUtilization> requiredSkills) {
    _setMap(cleon.initialization.projectmanagement.spec.planning.organisation.roles.RolesPackage.Role_requiredSkills, requiredSkills);
    return this;
  }
  ...
  public static cleon.initialization.projectmanagement.spec.planning.organisation.roles.javamodel.IRole selectToMeRequiredSkills(cleon.initialization.projectmanagement.spec.planning.organisation.roles.javamodel.ISkillUtilization object) {
    return _getToMeSingle(object.getRepository(), cleon.initialization.projectmanagement.spec.planning.organisation.roles.javamodel.IRole.class, cleon.initialization.projectmanagement.spec.planning.organisation.roles.RolesPackage.Role_requiredSkills, object.getResource());
  }
