...
public class SkillUtilization extends DynamicResource implements ISkillUtilization {
  ...
  public cleon.common.resources.spec.resources.importance.javamodel.IImportance selectImportance() {
    return _getSingle(cleon.common.resources.spec.resources.importance.javamodel.IImportance.class, cleon.initialization.projectmanagement.spec.planning.organisation.roles.RolesPackage.SkillUtilization_importance);
  }

  public SkillUtilization setImportance(cleon.common.resources.spec.resources.importance.javamodel.IImportance importance) {
    _setSingle(cleon.initialization.projectmanagement.spec.planning.organisation.roles.RolesPackage.SkillUtilization_importance, importance);
    return this;
  }
  ...
  public static java.util.List<cleon.initialization.projectmanagement.spec.planning.organisation.roles.javamodel.ISkillUtilization> selectToMeImportance(cleon.common.resources.spec.resources.importance.javamodel.IImportance object) {
    return _getToMeList(object.getRepository(), cleon.initialization.projectmanagement.spec.planning.organisation.roles.javamodel.ISkillUtilization.class, cleon.initialization.projectmanagement.spec.planning.organisation.roles.RolesPackage.SkillUtilization_importance, object.getResource());
  }
