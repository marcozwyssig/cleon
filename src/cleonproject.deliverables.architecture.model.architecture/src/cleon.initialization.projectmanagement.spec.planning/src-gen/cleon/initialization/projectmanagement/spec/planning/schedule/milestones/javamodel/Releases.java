...
public class Releases extends DynamicResource implements IReleases {
  ...
  public java.lang.Integer selectDaysPerSprint() {
    return _getSingleAttribute(java.lang.Integer.class, cleon.initialization.projectmanagement.spec.planning.schedule.milestones.MilestonesPackage.Releases_daysPerSprint);
  }
    
  public void setDaysPerSprint(java.lang.Integer daysPerSprint) {
     _setSingleAttribute(cleon.initialization.projectmanagement.spec.planning.schedule.milestones.MilestonesPackage.Releases_daysPerSprint, daysPerSprint);
  }
  ...
  public java.util.List<? extends cleon.initialization.projectmanagement.spec.planning.schedule.milestones.javamodel.IPhase> selectPhases() {
    return _getList(cleon.initialization.projectmanagement.spec.planning.schedule.milestones.javamodel.IPhase.class, cleon.initialization.projectmanagement.spec.planning.schedule.milestones.MilestonesPackage.Releases_phases);
  }

  public Releases setPhases(java.util.List<? extends cleon.initialization.projectmanagement.spec.planning.schedule.milestones.javamodel.IPhase> phases) {
    _setList(cleon.initialization.projectmanagement.spec.planning.schedule.milestones.MilestonesPackage.Releases_phases, phases);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingleAttribute(java.lang.Integer.class, cleon.initialization.projectmanagement.spec.planning.schedule.milestones.MilestonesPackage.Releases_daysPerSprint, visitor);
    ...
    _acceptList(cleon.initialization.projectmanagement.spec.planning.schedule.milestones.javamodel.IPhase.class, cleon.initialization.projectmanagement.spec.planning.schedule.milestones.MilestonesPackage.Releases_phases, visitor);
  ...
  public static cleon.initialization.projectmanagement.spec.planning.schedule.milestones.javamodel.IReleases selectToMePhases(cleon.initialization.projectmanagement.spec.planning.schedule.milestones.javamodel.IPhase object) {
    return _getToMeSingle(object.getRepository(), cleon.initialization.projectmanagement.spec.planning.schedule.milestones.javamodel.IReleases.class, cleon.initialization.projectmanagement.spec.planning.schedule.milestones.MilestonesPackage.Releases_phases, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,3161251a-a7d9-11e5-82dd-3b995d9c840c,Tf0XlcxfixMtRpTdzicb8UyiaIU=] */
