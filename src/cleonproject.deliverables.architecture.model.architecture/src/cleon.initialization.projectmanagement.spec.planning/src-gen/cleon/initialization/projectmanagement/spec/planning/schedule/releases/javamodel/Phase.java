...
public class Phase extends DynamicResource implements IPhase {
  ...
  public java.util.List<? extends cleon.initialization.projectmanagement.spec.planning.schedule.releases.javamodel.IRelease> selectReleases() {
    return _getList(cleon.initialization.projectmanagement.spec.planning.schedule.releases.javamodel.IRelease.class, cleon.initialization.projectmanagement.spec.planning.schedule.releases.ReleasesPackage.Phase_releases);
  }

  public Phase setReleases(java.util.List<? extends cleon.initialization.projectmanagement.spec.planning.schedule.releases.javamodel.IRelease> releases) {
    _setList(cleon.initialization.projectmanagement.spec.planning.schedule.releases.ReleasesPackage.Phase_releases, releases);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptList(cleon.initialization.projectmanagement.spec.planning.schedule.releases.javamodel.IRelease.class, cleon.initialization.projectmanagement.spec.planning.schedule.releases.ReleasesPackage.Phase_releases, visitor);
  ...
  public static cleon.initialization.projectmanagement.spec.planning.schedule.releases.javamodel.IPhase selectToMeReleases(cleon.initialization.projectmanagement.spec.planning.schedule.releases.javamodel.IRelease object) {
    return _getToMeSingle(object.getRepository(), cleon.initialization.projectmanagement.spec.planning.schedule.releases.javamodel.IPhase.class, cleon.initialization.projectmanagement.spec.planning.schedule.releases.ReleasesPackage.Phase_releases, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,bcd1f820-d719-11e6-a422-8b5491da3f30,DrvZrEqNcTxnDmz5CNdY5Ittk6Y=] */
