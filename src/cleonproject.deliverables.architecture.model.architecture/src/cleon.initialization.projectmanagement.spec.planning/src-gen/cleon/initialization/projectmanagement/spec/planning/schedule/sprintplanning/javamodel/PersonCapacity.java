...
public class PersonCapacity extends DynamicResource implements IPersonCapacity {
  ...
  public java.lang.Integer selectProductivity() {
    return _getSingleAttribute(java.lang.Integer.class, cleon.initialization.projectmanagement.spec.planning.schedule.sprintplanning.SprintplanningPackage.PersonCapacity_productivity);
  }
    
  public void setProductivity(java.lang.Integer productivity) {
     _setSingleAttribute(cleon.initialization.projectmanagement.spec.planning.schedule.sprintplanning.SprintplanningPackage.PersonCapacity_productivity, productivity);
  }
  ...
  public java.util.Map<ch.actifsource.core.Resource, ? extends cleon.initialization.projectmanagement.spec.planning.schedule.sprintplanning.javamodel.ICapacityPerDay> selectCapacityPerDay() {
    return _getMap(cleon.initialization.projectmanagement.spec.planning.schedule.sprintplanning.javamodel.ICapacityPerDay.class, cleon.initialization.projectmanagement.spec.planning.schedule.sprintplanning.SprintplanningPackage.PersonCapacity_capacityPerDay);
  }

  public PersonCapacity setCapacityPerDay(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.initialization.projectmanagement.spec.planning.schedule.sprintplanning.javamodel.ICapacityPerDay> capacityPerDay) {
    _setMap(cleon.initialization.projectmanagement.spec.planning.schedule.sprintplanning.SprintplanningPackage.PersonCapacity_capacityPerDay, capacityPerDay);
    return this;
  }
  ...
  public static cleon.initialization.projectmanagement.spec.planning.schedule.sprintplanning.javamodel.IPersonCapacity selectToMeCapacityPerDay(cleon.initialization.projectmanagement.spec.planning.schedule.sprintplanning.javamodel.ICapacityPerDay object) {
    return _getToMeSingle(object.getRepository(), cleon.initialization.projectmanagement.spec.planning.schedule.sprintplanning.javamodel.IPersonCapacity.class, cleon.initialization.projectmanagement.spec.planning.schedule.sprintplanning.SprintplanningPackage.PersonCapacity_capacityPerDay, object.getResource());
  }
