...
public class Deliverables extends DynamicResource implements IDeliverables {
  ...
  public Deliverables setDeliverables(java.util.List<? extends cleon.initialization.projectmanagement.spec.planning.scope.deliverable.javamodel.IDeliverable> deliverables) {
  ...
  public static cleon.initialization.projectmanagement.spec.planning.scope.deliverable.javamodel.IDeliverables selectToMeDeliverables(cleon.initialization.projectmanagement.spec.planning.scope.deliverable.javamodel.IDeliverable object) {
    return _getToMeSingle(object.getRepository(), cleon.initialization.projectmanagement.spec.planning.scope.deliverable.javamodel.IDeliverables.class, cleon.initialization.projectmanagement.spec.planning.scope.deliverable.DeliverablePackage.Deliverables_deliverables, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,53cc7703-bbcc-11e6-997f-d73ea5a3671c,m58K0nsjldDGIma/PFmhAL9hvg0=] */
