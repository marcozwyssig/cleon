package cleon.initialization.projectmanagement.spec.planning.scope.module;
...
public class FunctionSpace {
  ...
  public static interface IModuleFunctions extends IDynamicResourceExtension {
    ...
    public cleon.initialization.projectmanagement.spec.planning.schedule.milestones.javamodel.ISprint GetStartSprint();

    @IDynamicResourceExtension.MethodId("fde15e4d-3fc2-11e7-9016-2b91d722d429")
    public cleon.initialization.projectmanagement.spec.planning.schedule.milestones.javamodel.ISprint GetEndSprint();
  ...
  public static interface IModuleFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("b7a8e864-c13b-11e6-8f58-ad3c6ee7602f")
    public java.lang.String GetId(final cleon.initialization.projectmanagement.spec.planning.scope.module.javamodel.IModule module);

    @IDynamicResourceExtension.MethodId("87caceb9-3fc2-11e7-9016-2b91d722d429")
    public cleon.common.resources.spec.calendar.javamodel.IDay GetStartDay(final cleon.initialization.projectmanagement.spec.planning.scope.module.javamodel.IModule module);

    @IDynamicResourceExtension.MethodId("93062c5c-3fc2-11e7-9016-2b91d722d429")
    public cleon.common.resources.spec.calendar.javamodel.IDay GetEndDay(final cleon.initialization.projectmanagement.spec.planning.scope.module.javamodel.IModule module);

    @IDynamicResourceExtension.MethodId("f4fa7823-3fc2-11e7-9016-2b91d722d429")
    public cleon.initialization.projectmanagement.spec.planning.schedule.milestones.javamodel.ISprint GetStartSprint(final cleon.initialization.projectmanagement.spec.planning.scope.module.javamodel.IModule module);

    @IDynamicResourceExtension.MethodId("fde15e4d-3fc2-11e7-9016-2b91d722d429")
    public cleon.initialization.projectmanagement.spec.planning.schedule.milestones.javamodel.ISprint GetEndSprint(final cleon.initialization.projectmanagement.spec.planning.scope.module.javamodel.IModule module);
  ...
  public static class ModuleFunctions {
    ...
    public static java.lang.String GetId(final cleon.initialization.projectmanagement.spec.planning.scope.module.javamodel.IModule module) {
      return DynamicResourceUtil.invoke(IModuleFunctionsImpl.class, ModuleFunctionsImpl.INSTANCE, module).GetId(module);
    }

    public static cleon.common.resources.spec.calendar.javamodel.IDay GetStartDay(final cleon.initialization.projectmanagement.spec.planning.scope.module.javamodel.IModule module) {
      return DynamicResourceUtil.invoke(IModuleFunctionsImpl.class, ModuleFunctionsImpl.INSTANCE, module).GetStartDay(module);
    }

    public static cleon.common.resources.spec.calendar.javamodel.IDay GetEndDay(final cleon.initialization.projectmanagement.spec.planning.scope.module.javamodel.IModule module) {
      return DynamicResourceUtil.invoke(IModuleFunctionsImpl.class, ModuleFunctionsImpl.INSTANCE, module).GetEndDay(module);
    }

    public static cleon.initialization.projectmanagement.spec.planning.schedule.milestones.javamodel.ISprint GetStartSprint(final cleon.initialization.projectmanagement.spec.planning.scope.module.javamodel.IModule module) {
      return DynamicResourceUtil.invoke(IModuleFunctionsImpl.class, ModuleFunctionsImpl.INSTANCE, module).GetStartSprint(module);
    }

    public static cleon.initialization.projectmanagement.spec.planning.schedule.milestones.javamodel.ISprint GetEndSprint(final cleon.initialization.projectmanagement.spec.planning.scope.module.javamodel.IModule module) {
