...
public class DocumentStage extends DynamicResource implements IDocumentStage {
  ...
  public boolean isDraft() {
    return getResource().equals(cleon.initialization.projectmanagement.spec.planning.scope.outcomes.OutcomesPackage.DocumentStage_Draft);
  }
  
  @Override
  public boolean isReview() {
    return getResource().equals(cleon.initialization.projectmanagement.spec.planning.scope.outcomes.OutcomesPackage.DocumentStage_Review);
  }
  
  @Override
  public boolean isFinal() {
    return getResource().equals(cleon.initialization.projectmanagement.spec.planning.scope.outcomes.OutcomesPackage.DocumentStage_Final);
  }
  
  @Override
  public boolean isApproved() {
    return getResource().equals(cleon.initialization.projectmanagement.spec.planning.scope.outcomes.OutcomesPackage.DocumentStage_Approved);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,784a1bc2-bff7-11e8-a3d0-5394fd9291a1,jhXZTd3B61uSJCTS6bliznFjz40=] */
