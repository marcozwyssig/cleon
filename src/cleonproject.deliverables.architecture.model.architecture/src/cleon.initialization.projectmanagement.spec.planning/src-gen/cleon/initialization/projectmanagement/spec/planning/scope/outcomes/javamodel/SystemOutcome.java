...
public class SystemOutcome extends DynamicResource implements ISystemOutcome {
  ...
  public SystemOutcome setDeadlines(java.util.List<? extends cleon.initialization.projectmanagement.spec.planning.schedule.targetdates.javamodel.IDeadline> deadlines) {
  ...
  public SystemOutcome setDeliverable(cleon.initialization.projectmanagement.spec.planning.scope.deliverable.javamodel.IDeliverable deliverable) {
  ...
  public SystemOutcome setDependsOn(java.util.List<? extends cleon.initialization.projectmanagement.spec.planning.scope.outcomes.javamodel.IOutcomeDependency> dependsOn) {
  ...
  public SystemOutcome setDocumentElements(java.util.List<? extends cleon.common.doc.spec.doc.javamodel.IDocumentElement> documentElements) {
  ...
  public SystemOutcome setOwner(cleon.initialization.projectmanagement.spec.resource.persons.javamodel.IPerson owner) {
  ...
  public SystemOutcome setState(cleon.initialization.projectmanagement.spec.planning.scope.javamodel.IState state) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,ac8b4c03-bfeb-11e8-a3d0-5394fd9291a1,HYin+aFclSwq7k0prPYIaVxV3QA=] */
