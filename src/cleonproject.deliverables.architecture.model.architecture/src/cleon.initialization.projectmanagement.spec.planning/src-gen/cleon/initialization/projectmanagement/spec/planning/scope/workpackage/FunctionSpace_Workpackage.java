...
public class FunctionSpace_Workpackage {
  ...
  public static interface IWorkpackageFunctions extends IDynamicResourceExtension {
    ...
    public List<cleon.initialization.projectmanagement.spec.planning.schedule.releases.javamodel.ISprint> GetSprintsBetweenStartAndEndMilestone();
  ...
  public static interface IWorkpackageFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("74637dd8-d66f-11e6-ad1f-c967b4caaf09")
    public List<cleon.initialization.projectmanagement.spec.planning.schedule.releases.javamodel.ISprint> GetSprintsBetweenStartAndEndMilestone(final cleon.initialization.projectmanagement.spec.planning.scope.workpackage.javamodel.IWorkpackage workpackage);
  ...
  public static class WorkpackageFunctions {
    ...
    public static List<cleon.initialization.projectmanagement.spec.planning.schedule.releases.javamodel.ISprint> GetSprintsBetweenStartAndEndMilestone(final cleon.initialization.projectmanagement.spec.planning.scope.workpackage.javamodel.IWorkpackage workpackage) {
