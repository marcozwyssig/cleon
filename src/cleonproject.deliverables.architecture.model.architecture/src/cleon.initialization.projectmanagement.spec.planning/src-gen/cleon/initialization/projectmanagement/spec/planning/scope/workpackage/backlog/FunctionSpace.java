...
public class FunctionSpace {
  ...
  public static interface IBacklogFunctions extends IDynamicResourceExtension {
    ...
    public cleon.initialization.projectmanagement.spec.planning.schedule.milestones.javamodel.ISprint LastPlannedSprint();

    @IDynamicResourceExtension.MethodId("6bdb7163-3fc5-11e7-9016-2b91d722d429")
    public cleon.initialization.projectmanagement.spec.planning.schedule.milestones.javamodel.ISprint FirstPlannedSprint();
  ...
  public static interface IBacklogFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("8d95f53c-34a2-11e6-8839-1f6631cc77ac")
    public cleon.initialization.projectmanagement.spec.planning.schedule.milestones.javamodel.ISprint LastPlannedSprint(final cleon.initialization.projectmanagement.spec.planning.scope.workpackage.backlog.javamodel.IBacklog backlog);

    @IDynamicResourceExtension.MethodId("6bdb7163-3fc5-11e7-9016-2b91d722d429")
    public cleon.initialization.projectmanagement.spec.planning.schedule.milestones.javamodel.ISprint FirstPlannedSprint(final cleon.initialization.projectmanagement.spec.planning.scope.workpackage.backlog.javamodel.IBacklog backlog);
  ...
  public static class BacklogFunctions {
    ...
    public static cleon.initialization.projectmanagement.spec.planning.schedule.milestones.javamodel.ISprint LastPlannedSprint(final cleon.initialization.projectmanagement.spec.planning.scope.workpackage.backlog.javamodel.IBacklog backlog) {
    ...
    public static cleon.initialization.projectmanagement.spec.planning.schedule.milestones.javamodel.ISprint FirstPlannedSprint(final cleon.initialization.projectmanagement.spec.planning.scope.workpackage.backlog.javamodel.IBacklog backlog) {
  ...
  public static interface IWorkItemGroupFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("d8f9e4cd-346b-11e7-a759-67451fcdb3cc")
    public cleon.initialization.projectmanagement.spec.planning.schedule.milestones.javamodel.ISprint GetSprint(final cleon.initialization.projectmanagement.spec.planning.scope.workpackage.backlog.featuregroup.javamodel.IWorkItemGroup workItemGroup);
  ...
  public static class WorkItemGroupFunctions {
    ...
    public static cleon.initialization.projectmanagement.spec.planning.schedule.milestones.javamodel.ISprint GetSprint(final cleon.initialization.projectmanagement.spec.planning.scope.workpackage.backlog.featuregroup.javamodel.IWorkItemGroup workItemGroup) {
