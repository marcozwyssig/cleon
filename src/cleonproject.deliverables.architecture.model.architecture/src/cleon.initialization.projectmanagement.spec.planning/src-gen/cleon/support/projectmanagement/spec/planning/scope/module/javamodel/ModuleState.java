...
public class ModuleState extends DynamicResource implements IModuleState {
  ...
  public boolean isOpen() {
    return getResource().equals(cleon.support.projectmanagement.spec.planning.scope.module.ModulePackage.ModuleState_Open);
  }
  
  @Override
  public boolean isIn__F_Progress() {
    return getResource().equals(cleon.support.projectmanagement.spec.planning.scope.module.ModulePackage.ModuleState_In__F_Progress);
  }
  
  @Override
  public boolean isDone() {
    return getResource().equals(cleon.support.projectmanagement.spec.planning.scope.module.ModulePackage.ModuleState_Done);
  }
  
  @Override
  public boolean isOnHold() {
    return getResource().equals(cleon.support.projectmanagement.spec.planning.scope.module.ModulePackage.ModuleState_OnHold);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,5b3641a5-c767-11e6-9515-3d3c9e104ed6,5bvjH88/uzvn7VDQkEsXiQpsO78=] */
