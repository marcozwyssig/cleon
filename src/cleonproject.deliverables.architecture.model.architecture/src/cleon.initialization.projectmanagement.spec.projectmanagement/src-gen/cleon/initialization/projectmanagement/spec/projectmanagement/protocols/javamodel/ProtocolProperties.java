...
public class ProtocolProperties extends DynamicResource implements IProtocolProperties {
  ...
  public cleon.common.doc.spec.doc.document.properties.member.javamodel.IMember selectAutor() {
    return _getSingle(cleon.common.doc.spec.doc.document.properties.member.javamodel.IMember.class, cleon.initialization.projectmanagement.spec.projectmanagement.protocols.ProtocolsPackage.ProtocolProperties_autor);
  }

  public ProtocolProperties setAutor(cleon.common.doc.spec.doc.document.properties.member.javamodel.IMember autor) {
    _setSingle(cleon.initialization.projectmanagement.spec.projectmanagement.protocols.ProtocolsPackage.ProtocolProperties_autor, autor);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(cleon.common.doc.spec.doc.document.properties.member.javamodel.IMember.class, cleon.initialization.projectmanagement.spec.projectmanagement.protocols.ProtocolsPackage.ProtocolProperties_autor, visitor);
  ...
  public static java.util.List<cleon.initialization.projectmanagement.spec.projectmanagement.protocols.javamodel.IProtocolProperties> selectToMeAutor(cleon.common.doc.spec.doc.document.properties.member.javamodel.IMember object) {
    return _getToMeList(object.getRepository(), cleon.initialization.projectmanagement.spec.projectmanagement.protocols.javamodel.IProtocolProperties.class, cleon.initialization.projectmanagement.spec.projectmanagement.protocols.ProtocolsPackage.ProtocolProperties_autor, object.getResource());
  }
