...
public class Maturity extends DynamicResource implements IMaturity {
  ...
  public boolean is__0___F___S___F_Senior() {
    return getResource().equals(cleon.initialization.projectmanagement.spec.resource.persons.experience.ExperiencePackage.Maturity___0___F___S___F_Senior);
  }
  
  @Override
  public boolean is__Y___F___S___F_Professional() {
    return getResource().equals(cleon.initialization.projectmanagement.spec.resource.persons.experience.ExperiencePackage.Maturity___Y___F___S___F_Professional);
  }
  
  @Override
  public boolean is__W___F___S___F_Junior() {
    return getResource().equals(cleon.initialization.projectmanagement.spec.resource.persons.experience.ExperiencePackage.Maturity___W___F___S___F_Junior);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,b802c383-b509-11e5-aa95-235930e9af3d,AWMjatIYGi0bWNYcwSlA1WldofQ=] */
