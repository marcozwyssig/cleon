...
public class ModuleLampState extends DynamicResource implements IModuleLampState {
  ...
  public boolean isRed() {
    return getResource().equals(cleon.initialization.projectmanagement.spec.steering.controlling.module.ModulePackage.ModuleLampState_Red);
  }
  
  @Override
  public boolean isYellow() {
    return getResource().equals(cleon.initialization.projectmanagement.spec.steering.controlling.module.ModulePackage.ModuleLampState_Yellow);
  }
  
  @Override
  public boolean isGreen() {
    return getResource().equals(cleon.initialization.projectmanagement.spec.steering.controlling.module.ModulePackage.ModuleLampState_Green);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,60427122-3386-11e6-b251-57783f5929b3,oU7xvPQd5FK/otFah429JDLTKCQ=] */
