...
public class Impediment extends DynamicResource implements IImpediment {
  ...
  public java.util.List<java.lang.String> selectResolutionsDetails() {
    return _getListAttribute(java.lang.String.class, cleon.initialization.projectmanagement.spec.steering.impediments.ImpedimentsPackage.Impediment_resolutionsDetails);
  }
    
  public void setResolutionsDetails(java.util.List<java.lang.String> resolutionsDetails) {
     _setListAttribute(cleon.initialization.projectmanagement.spec.steering.impediments.ImpedimentsPackage.Impediment_resolutionsDetails, resolutionsDetails);
  }
  ...
  public cleon.common.resources.spec.calendar.javamodel.IDay selectEntryDate() {
    return _getSingle(cleon.common.resources.spec.calendar.javamodel.IDay.class, cleon.initialization.projectmanagement.spec.steering.impediments.ImpedimentsPackage.Impediment_entryDate);
  }

  public Impediment setEntryDate(cleon.common.resources.spec.calendar.javamodel.IDay entryDate) {
    _setSingle(cleon.initialization.projectmanagement.spec.steering.impediments.ImpedimentsPackage.Impediment_entryDate, entryDate);
    return this;
  }
  ...
  public static java.util.List<cleon.initialization.projectmanagement.spec.steering.impediments.javamodel.IImpediment> selectToMeEntryDate(cleon.common.resources.spec.calendar.javamodel.IDay object) {
    return _getToMeList(object.getRepository(), cleon.initialization.projectmanagement.spec.steering.impediments.javamodel.IImpediment.class, cleon.initialization.projectmanagement.spec.steering.impediments.ImpedimentsPackage.Impediment_entryDate, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,b33bed18-3383-11e6-b251-57783f5929b3,atAIH7Qw/i+ZjxG0xSshttIHA7U=] */
