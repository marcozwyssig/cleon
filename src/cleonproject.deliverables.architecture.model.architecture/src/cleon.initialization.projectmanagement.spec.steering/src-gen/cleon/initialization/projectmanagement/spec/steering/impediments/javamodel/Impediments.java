...
public class Impediments extends DynamicResource implements IImpediments {
  ...
  public java.util.List<? extends cleon.initialization.projectmanagement.spec.steering.impediments.javamodel.IImpediment> selectImpediments() {
    return _getList(cleon.initialization.projectmanagement.spec.steering.impediments.javamodel.IImpediment.class, cleon.initialization.projectmanagement.spec.steering.impediments.ImpedimentsPackage.Impediments_impediments);
  }

  public Impediments setImpediments(java.util.List<? extends cleon.initialization.projectmanagement.spec.steering.impediments.javamodel.IImpediment> impediments) {
    _setList(cleon.initialization.projectmanagement.spec.steering.impediments.ImpedimentsPackage.Impediments_impediments, impediments);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptList(cleon.initialization.projectmanagement.spec.steering.impediments.javamodel.IImpediment.class, cleon.initialization.projectmanagement.spec.steering.impediments.ImpedimentsPackage.Impediments_impediments, visitor);
  ...
  public static cleon.initialization.projectmanagement.spec.steering.impediments.javamodel.IImpediments selectToMeImpediments(cleon.initialization.projectmanagement.spec.steering.impediments.javamodel.IImpediment object) {
    return _getToMeSingle(object.getRepository(), cleon.initialization.projectmanagement.spec.steering.impediments.javamodel.IImpediments.class, cleon.initialization.projectmanagement.spec.steering.impediments.ImpedimentsPackage.Impediments_impediments, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,af7dac0a-3383-11e6-b251-57783f5929b3,QMy/oiaQ4qvfUlRu6LQU/Xc+YbM=] */
