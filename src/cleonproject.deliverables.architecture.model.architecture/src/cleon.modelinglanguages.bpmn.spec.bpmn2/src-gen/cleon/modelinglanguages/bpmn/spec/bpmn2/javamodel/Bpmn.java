...
public class Bpmn extends DynamicResource implements IBpmn {
  ...
  public Bpmn setOrganigram(cleon.modelinglanguages.bpmn.spec.bpmn2.organigram.javamodel.IOrganigram organigram) {
  ...
  public Bpmn setOrganisational(cleon.modelinglanguages.bpmn.spec.bpmn2.organisational.javamodel.IOrganisational organisational) {
  ...
  public static cleon.modelinglanguages.bpmn.spec.bpmn2.javamodel.IBpmn selectToMeOrganisational(cleon.modelinglanguages.bpmn.spec.bpmn2.organisational.javamodel.IOrganisational object) {
    return _getToMeSingle(object.getRepository(), cleon.modelinglanguages.bpmn.spec.bpmn2.javamodel.IBpmn.class, cleon.modelinglanguages.bpmn.spec.bpmn2.Bpmn2Package.Bpmn_organisational, object.getResource());
  }
  
  public static cleon.modelinglanguages.bpmn.spec.bpmn2.javamodel.IBpmn selectToMeOrganigram(cleon.modelinglanguages.bpmn.spec.bpmn2.organigram.javamodel.IOrganigram object) {
    return _getToMeSingle(object.getRepository(), cleon.modelinglanguages.bpmn.spec.bpmn2.javamodel.IBpmn.class, cleon.modelinglanguages.bpmn.spec.bpmn2.Bpmn2Package.Bpmn_organigram, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,b0d96e05-7e49-11e5-85ce-e7c8e0b30f03,thieemCtPqRBLxJMzGyxEw93xKk=] */
