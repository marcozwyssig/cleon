...
public class Group extends DynamicResource implements IGroup {
  ...
  public ch.actifsource.core.javamodel.IColor selectColor() {
    return _getSingle(ch.actifsource.core.javamodel.IColor.class, cleon.modelinglanguages.network.spec.network.NetworkPackage.Group_color);
  }

  public Group setColor(ch.actifsource.core.javamodel.IColor color) {
    _setSingle(cleon.modelinglanguages.network.spec.network.NetworkPackage.Group_color, color);
    return this;
  }
  ...
  public static java.util.List<cleon.modelinglanguages.network.spec.network.javamodel.IGroup> selectToMeColor(ch.actifsource.core.javamodel.IColor object) {
    return _getToMeList(object.getRepository(), cleon.modelinglanguages.network.spec.network.javamodel.IGroup.class, cleon.modelinglanguages.network.spec.network.NetworkPackage.Group_color, object.getResource());
  }
