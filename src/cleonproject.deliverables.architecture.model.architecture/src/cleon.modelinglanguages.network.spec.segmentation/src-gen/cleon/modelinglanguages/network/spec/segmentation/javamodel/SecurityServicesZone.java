...
public class SecurityServicesZone extends DynamicResource implements ISecurityServicesZone {
  ...
  public SecurityServicesZone setAllowed(java.util.List<? extends cleon.modelinglanguages.network.spec.segmentation.javamodel.ISecurityZone> allowed) {
  ...
  public SecurityServicesZone setSecuritySubZones(java.util.List<? extends cleon.modelinglanguages.network.spec.segmentation.javamodel.ISecuritySubZone> securitySubZones) {
  ...
  public SecurityServicesZone setZones(java.util.List<? extends cleon.modelinglanguages.network.spec.segmentation.javamodel.IZone> zones) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,0e3a9edc-0b76-11e9-a136-69d076e48ed1,QoaEjVgArQGXI2lHdP8mqWxsJyM=] */
