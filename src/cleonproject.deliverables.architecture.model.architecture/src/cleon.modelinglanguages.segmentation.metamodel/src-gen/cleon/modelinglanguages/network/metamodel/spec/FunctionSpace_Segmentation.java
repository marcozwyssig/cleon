...
public class FunctionSpace_Segmentation {
  ...
  public static interface IZoneFunctions extends IDynamicResourceExtension {
    ...
    public List<cleon.modelinglanguages.network.metamodel.spec.javamodel.IZone> GetAllParents();

    @IDynamicResourceExtension.MethodId("72a38c28-0b79-11e9-a136-69d076e48ed1")
    public cleon.modelinglanguages.network.metamodel.spec.javamodel.INetDomainZone GetNetDomainZone();
    ...
    public List<cleon.modelinglanguages.network.metamodel.spec.javamodel.IZone> GetAllChildrenZone();
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,49bf1abf-0b79-11e9-a136-69d076e48ed1,QXt0FjqZP7dWp+LzIEJdLyLE8bo=] */
