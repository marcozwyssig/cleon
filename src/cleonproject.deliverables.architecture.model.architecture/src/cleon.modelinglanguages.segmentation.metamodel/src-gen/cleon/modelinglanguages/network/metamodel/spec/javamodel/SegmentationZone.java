...
public class SegmentationZone extends DynamicResource implements ISegmentationZone {
  ...
  public cleon.modelinglanguages.network.metamodel.spec.javamodel.IZone selectZone() {
    return _getSingle(cleon.modelinglanguages.network.metamodel.spec.javamodel.IZone.class, cleon.modelinglanguages.network.metamodel.spec.SpecPackage.SegmentationZone_zone);
  }

  public SegmentationZone setZone(cleon.modelinglanguages.network.metamodel.spec.javamodel.IZone zone) {
    _setSingle(cleon.modelinglanguages.network.metamodel.spec.SpecPackage.SegmentationZone_zone, zone);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(cleon.modelinglanguages.network.metamodel.spec.javamodel.IZone.class, cleon.modelinglanguages.network.metamodel.spec.SpecPackage.SegmentationZone_zone, visitor);
  }

  // toMeRelations
  
  public static cleon.modelinglanguages.network.metamodel.spec.javamodel.ISegmentationZone selectToMeZone(cleon.modelinglanguages.network.metamodel.spec.javamodel.IZone object) {
    return _getToMeSingle(object.getRepository(), cleon.modelinglanguages.network.metamodel.spec.javamodel.ISegmentationZone.class, cleon.modelinglanguages.network.metamodel.spec.SpecPackage.SegmentationZone_zone, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,ccaeef49-0d1d-11e9-be4f-03130cc057ef,Bl8KxvMQfkbr+EE9C0k2tgQDJc4=] */
