...
public class SingleState extends DynamicResource implements ISingleState {
  ...
  public SingleState setChapters(java.util.List<? extends cleon.common.doc.doc.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public SingleState setDocumentElements(java.util.List<? extends cleon.common.doc.doc.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.behavioral.statemachine.javamodel.IStateInheritance> selectInherits() {
    return _getList(cleon.modelinglanguages.uml.spec.uml2.behavioral.statemachine.javamodel.IStateInheritance.class, cleon.modelinglanguages.uml.spec.uml2.behavioral.statemachine.StatemachinePackage.SingleState_inherits);
  }

  public SingleState setInherits(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.behavioral.statemachine.javamodel.IStateInheritance> inherits) {
    _setList(cleon.modelinglanguages.uml.spec.uml2.behavioral.statemachine.StatemachinePackage.SingleState_inherits, inherits);
    return this;
  }
  ...
  public SingleState setParagraphs(java.util.List<? extends cleon.common.doc.doc.spec.paragraph.javamodel.IParagraph> paragraphs) {
  ...
  public java.util.Map<ch.actifsource.core.Resource, ? extends cleon.modelinglanguages.uml.spec.uml2.behavioral.statemachine.javamodel.ITransition> selectTransition() {
    return _getMap(cleon.modelinglanguages.uml.spec.uml2.behavioral.statemachine.javamodel.ITransition.class, cleon.modelinglanguages.uml.spec.uml2.behavioral.statemachine.StatemachinePackage.SingleState_transition);
  }

  public SingleState setTransition(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.modelinglanguages.uml.spec.uml2.behavioral.statemachine.javamodel.ITransition> transition) {
    _setMap(cleon.modelinglanguages.uml.spec.uml2.behavioral.statemachine.StatemachinePackage.SingleState_transition, transition);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptList(cleon.modelinglanguages.uml.spec.uml2.behavioral.statemachine.javamodel.IStateInheritance.class, cleon.modelinglanguages.uml.spec.uml2.behavioral.statemachine.StatemachinePackage.SingleState_inherits, visitor);
    ...
    _acceptMap(cleon.modelinglanguages.uml.spec.uml2.behavioral.statemachine.javamodel.ITransition.class, cleon.modelinglanguages.uml.spec.uml2.behavioral.statemachine.StatemachinePackage.SingleState_transition, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

  // toMeRelations
  
  public static cleon.modelinglanguages.uml.spec.uml2.behavioral.statemachine.javamodel.ISingleState selectToMeTransition(cleon.modelinglanguages.uml.spec.uml2.behavioral.statemachine.javamodel.ITransition object) {
    return _getToMeSingle(object.getRepository(), cleon.modelinglanguages.uml.spec.uml2.behavioral.statemachine.javamodel.ISingleState.class, cleon.modelinglanguages.uml.spec.uml2.behavioral.statemachine.StatemachinePackage.SingleState_transition, object.getResource());
  }
  
  public static cleon.modelinglanguages.uml.spec.uml2.behavioral.statemachine.javamodel.ISingleState selectToMeInherits(cleon.modelinglanguages.uml.spec.uml2.behavioral.statemachine.javamodel.IStateInheritance object) {
    return _getToMeSingle(object.getRepository(), cleon.modelinglanguages.uml.spec.uml2.behavioral.statemachine.javamodel.ISingleState.class, cleon.modelinglanguages.uml.spec.uml2.behavioral.statemachine.StatemachinePackage.SingleState_inherits, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,7f13ba82-b07c-11e4-bca8-71d5b3e72cd6,k7gjfO9JFXakDByHJMbf+NszdtU=] */
