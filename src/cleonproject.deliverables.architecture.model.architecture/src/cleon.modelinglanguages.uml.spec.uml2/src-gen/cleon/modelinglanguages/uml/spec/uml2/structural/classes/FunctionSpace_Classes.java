package cleon.modelinglanguages.uml.spec.uml2.structural.classes;
...
import cleon.modelinglanguages.uml.spec.uml2.structural.classes.javamodel.*;
import cleon.modelinglanguages.uml.spec.uml2.structural.classes.javamodel.Class;
import cleon.modelinglanguages.uml.spec.uml2.structural.classes.method.messageExchange.javamodel.*;
/* End Protected Region   [[8a4e3836-0e63-11e3-ba64-7778a0a14717,imports]] */

public class FunctionSpace_Classes {
  ...
  public static interface IClassifierFunctions extends IDynamicResourceExtension {
    ...
    public List<cleon.modelinglanguages.uml.spec.uml2.structural.packages.javamodel.IPackage> GetPackagesReverse();
  ...
  public static interface IMethodFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("2bc4106e-a482-11e3-a07f-f96d34c3de8f")
    public java.lang.Boolean IsAsync(final cleon.modelinglanguages.uml.spec.uml2.structural.classes.method.javamodel.IMethod method);
  ...
  public static class MethodFunctions {
    ...
    public static java.lang.Boolean IsAsync(final cleon.modelinglanguages.uml.spec.uml2.structural.classes.method.javamodel.IMethod method) {
  ...
  public static interface IClassFunctions extends IDynamicResourceExtension {
    ...
    public cleon.modelinglanguages.uml.spec.uml2.structural.classes.javamodel.IClass GetBase();
  ...
  public static interface IClassFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("9e151a85-5c32-11e3-b5c2-4929c5d760c5")
    public cleon.modelinglanguages.uml.spec.uml2.structural.classes.javamodel.IClass GetBase(final cleon.modelinglanguages.uml.spec.uml2.structural.classes.javamodel.IClass class_);

    @IDynamicResourceExtension.MethodId("b186134b-5c36-11e3-b5c2-4929c5d760c5")
    public java.lang.Boolean IsBase(final cleon.modelinglanguages.uml.spec.uml2.structural.classes.javamodel.IClass class_);

    @IDynamicResourceExtension.MethodId("6270d67f-5c39-11e3-b5c2-4929c5d760c5")
    public java.lang.Boolean IsNotAbstract(final cleon.modelinglanguages.uml.spec.uml2.structural.classes.javamodel.IClass class_);

    @IDynamicResourceExtension.MethodId("cb3aca5f-5ccf-11e3-b5c2-4929c5d760c5")
    public java.lang.Boolean isSubClass(final cleon.modelinglanguages.uml.spec.uml2.structural.classes.javamodel.IClass class_);
  ...
  public static class ClassFunctions {
    ...
    public static cleon.modelinglanguages.uml.spec.uml2.structural.classes.javamodel.IClass GetBase(final cleon.modelinglanguages.uml.spec.uml2.structural.classes.javamodel.IClass class_) {
      return DynamicResourceUtil.invoke(IClassFunctionsImpl.class, ClassFunctionsImpl.INSTANCE, class_).GetBase(class_);
    }

    public static java.lang.Boolean IsBase(final cleon.modelinglanguages.uml.spec.uml2.structural.classes.javamodel.IClass class_) {
      return DynamicResourceUtil.invoke(IClassFunctionsImpl.class, ClassFunctionsImpl.INSTANCE, class_).IsBase(class_);
    }

    public static java.lang.Boolean IsNotAbstract(final cleon.modelinglanguages.uml.spec.uml2.structural.classes.javamodel.IClass class_) {
      return DynamicResourceUtil.invoke(IClassFunctionsImpl.class, ClassFunctionsImpl.INSTANCE, class_).IsNotAbstract(class_);
    }

    public static java.lang.Boolean isSubClass(final cleon.modelinglanguages.uml.spec.uml2.structural.classes.javamodel.IClass class_) {
  ...
  public static interface IAssociationFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("cac65a1a-6ecb-11e3-b3c1-7d834d89b418")
    public java.lang.Boolean IsSuppressSubjectAutoProperty(final cleon.modelinglanguages.uml.spec.uml2.structural.classes.association.javamodel.IAssociation association);

    @IDynamicResourceExtension.MethodId("52158130-6ed4-11e3-b3c1-7d834d89b418")
    public java.lang.Boolean IsObjectReadOnly(final cleon.modelinglanguages.uml.spec.uml2.structural.classes.association.javamodel.IAssociation association);

    @IDynamicResourceExtension.MethodId("d09589e8-6ed4-11e3-b3c1-7d834d89b418")
    public java.lang.Boolean IsSubjectReadOnly(final cleon.modelinglanguages.uml.spec.uml2.structural.classes.association.javamodel.IAssociation association);
  ...
  public static class AssociationFunctions {
    ...
    public static java.lang.Boolean IsSuppressSubjectAutoProperty(final cleon.modelinglanguages.uml.spec.uml2.structural.classes.association.javamodel.IAssociation association) {
    ...
    public static java.lang.Boolean IsObjectReadOnly(final cleon.modelinglanguages.uml.spec.uml2.structural.classes.association.javamodel.IAssociation association) {
    ...
    public static java.lang.Boolean IsSubjectReadOnly(final cleon.modelinglanguages.uml.spec.uml2.structural.classes.association.javamodel.IAssociation association) {
  ...
  public static interface IPackageFunctions extends IDynamicResourceExtension {
    ...
    public cleon.modelinglanguages.uml.spec.uml2.structural.packages.javamodel.IPackage GetPackage();

    @IDynamicResourceExtension.MethodId("48e0af88-01f4-11e4-8e4d-5f45fa20862b")
    public List<cleon.modelinglanguages.uml.spec.uml2.structural.classes.javamodel.IClassifier> GetClassifier();

    @IDynamicResourceExtension.MethodId("fa6cf58c-01f4-11e4-8e4d-5f45fa20862b")
    public List<cleon.modelinglanguages.uml.spec.uml2.structural.packages.javamodel.IPackage> GetPackages();
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,8a4e3836-0e63-11e3-ba64-7778a0a14717,CZRZH1iUirh5mYBYkWrjJtRNdFQ=] */
