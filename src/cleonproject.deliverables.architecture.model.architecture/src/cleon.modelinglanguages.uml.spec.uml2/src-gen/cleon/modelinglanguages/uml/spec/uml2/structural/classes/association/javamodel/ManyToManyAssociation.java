...
public class ManyToManyAssociation extends DynamicResource implements IManyToManyAssociation {
  ...
  public ManyToManyAssociation setAssocationType(cleon.modelinglanguages.uml.spec.uml2.structural.classes.association.javamodel.IAssociationType assocationType) {
  ...
  @Override
  public cleon.modelinglanguages.uml.spec.uml2.structural.classes.association.javamodel.ICollectionType selectCollectionType() {
    return _getSingle(cleon.modelinglanguages.uml.spec.uml2.structural.classes.association.javamodel.ICollectionType.class, cleon.modelinglanguages.uml.spec.uml2.structural.classes.association.AssociationPackage.CollectionAssociation_collectionType);
  }

  public ManyToManyAssociation setCollectionType(cleon.modelinglanguages.uml.spec.uml2.structural.classes.association.javamodel.ICollectionType collectionType) {
    _setSingle(cleon.modelinglanguages.uml.spec.uml2.structural.classes.association.AssociationPackage.CollectionAssociation_collectionType, collectionType);
    return this;
  }
  ...
  public ManyToManyAssociation setTo(cleon.modelinglanguages.uml.spec.uml2.structural.classes.javamodel.IClassifier to) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(cleon.modelinglanguages.uml.spec.uml2.structural.classes.association.javamodel.ICollectionType.class, cleon.modelinglanguages.uml.spec.uml2.structural.classes.association.AssociationPackage.CollectionAssociation_collectionType, visitor);
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,f0515d32-2783-11e3-a466-eda9d7258bca,N76tDQQ77lMsmTF7zWgG1UERS/A=] */
