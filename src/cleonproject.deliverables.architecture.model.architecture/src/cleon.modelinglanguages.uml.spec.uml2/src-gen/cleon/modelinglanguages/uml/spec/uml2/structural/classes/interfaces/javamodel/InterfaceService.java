...
public class InterfaceService extends DynamicResource implements IInterfaceService {
  ...
  public InterfaceService setData(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.classes.interfaces.javamodel.IInterfaceData> data) {
  ...
  public InterfaceService setMethods(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.classes.method.javamodel.IMethod> methods) {
  ...
  public static java.util.List<cleon.modelinglanguages.uml.spec.uml2.structural.classes.interfaces.javamodel.IInterfaceService> selectToMeData(cleon.modelinglanguages.uml.spec.uml2.structural.classes.interfaces.javamodel.IInterfaceData object) {
    return _getToMeList(object.getRepository(), cleon.modelinglanguages.uml.spec.uml2.structural.classes.interfaces.javamodel.IInterfaceService.class, cleon.modelinglanguages.uml.spec.uml2.structural.classes.interfaces.InterfacesPackage.InterfaceService_data, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,b626174f-26c1-11e3-a71a-b71d2dda9f8e,ttVW7cHUTEz9s31sZlTmeqC9Q7E=] */
