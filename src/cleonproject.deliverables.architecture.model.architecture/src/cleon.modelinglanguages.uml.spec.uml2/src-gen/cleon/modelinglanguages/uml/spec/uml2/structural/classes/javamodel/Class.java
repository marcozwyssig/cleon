...
public class Class extends DynamicResource implements IClass {
  ...
  public Class setCustomEvents(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.classes.events.javamodel.ICustomEvent> customEvents) {
  ...
  public Class setEvents(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.classes.events.javamodel.IEvent> events) {
  ...
  public Class setExtends(cleon.modelinglanguages.uml.spec.uml2.structural.classes.javamodel.IClass extends_) {
  ...
  public Class setFieldEvents(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.modelinglanguages.uml.spec.uml2.structural.classes.events.javamodel.IEventForField> fieldEvents) {
  ...
  public Class setFields(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.classes.fields.javamodel.IField> fields) {
  ...
  public Class setHasDependency(java.util.List<? extends cleon.common.modularity.spec.buildingblock.javamodel.IDependency> hasDependency) {
  ...
  public Class setMethods(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.classes.method.javamodel.IMethod> methods) {
  ...
  public Class setRelations(java.util.List<? extends cleon.modelinglanguages.uml.spec.uml2.structural.classes.association.javamodel.IAssociation> relations) {
  ...
  public static java.util.List<cleon.modelinglanguages.uml.spec.uml2.structural.classes.javamodel.IClass> selectToMeExtends(cleon.modelinglanguages.uml.spec.uml2.structural.classes.javamodel.IClass object) {
    return _getToMeList(object.getRepository(), cleon.modelinglanguages.uml.spec.uml2.structural.classes.javamodel.IClass.class, cleon.modelinglanguages.uml.spec.uml2.structural.classes.ClassesPackage.Class_extends, object.getResource());
  }
  
  public static cleon.modelinglanguages.uml.spec.uml2.structural.classes.javamodel.IClass selectToMeFieldEvents(cleon.modelinglanguages.uml.spec.uml2.structural.classes.events.javamodel.IEventForField object) {
    return _getToMeSingle(object.getRepository(), cleon.modelinglanguages.uml.spec.uml2.structural.classes.javamodel.IClass.class, cleon.modelinglanguages.uml.spec.uml2.structural.classes.ClassesPackage.Class_fieldEvents, object.getResource());
  }
  
  public static cleon.modelinglanguages.uml.spec.uml2.structural.classes.javamodel.IClass selectToMeCustomEvents(cleon.modelinglanguages.uml.spec.uml2.structural.classes.events.javamodel.ICustomEvent object) {
    return _getToMeSingle(object.getRepository(), cleon.modelinglanguages.uml.spec.uml2.structural.classes.javamodel.IClass.class, cleon.modelinglanguages.uml.spec.uml2.structural.classes.ClassesPackage.Class_customEvents, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,accc5089-2f5a-11e3-b966-57aab741cf17,MEayUeOHXX3cTeRxX0pI0XMgMwA=] */
