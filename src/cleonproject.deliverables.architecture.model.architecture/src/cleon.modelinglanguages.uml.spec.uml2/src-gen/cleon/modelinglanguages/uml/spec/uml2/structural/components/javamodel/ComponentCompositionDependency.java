...
public class ComponentCompositionDependency extends DynamicResource implements IComponentCompositionDependency {
  ...
  public ComponentCompositionDependency setTo(cleon.modelinglanguages.uml.spec.uml2.structural.components.javamodel.IComponentComposition to) {
  ...
  public static java.util.List<cleon.modelinglanguages.uml.spec.uml2.structural.components.javamodel.IComponentCompositionDependency> selectToMeTo(cleon.modelinglanguages.uml.spec.uml2.structural.components.javamodel.IComponentComposition object) {
    return _getToMeList(object.getRepository(), cleon.modelinglanguages.uml.spec.uml2.structural.components.javamodel.IComponentCompositionDependency.class, cleon.modelinglanguages.uml.spec.uml2.structural.components.ComponentsPackage.ComponentCompositionDependency_to, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,72e79576-ffc4-11e4-ac0a-959b440f987f,wS2hflP3b+xUSsFvWaZnkw6ZesE=] */
