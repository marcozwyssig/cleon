...
public class DocumentStage extends DynamicResource implements IDocumentStage {
  ...
  public boolean isDraft() {
    return getResource().equals(cleon.projectmethods.hermes.metamodel.spec.modules.projectmanagement.planning.scope.outcomes.OutcomesPackage.DocumentStage_Draft);
  }
  
  @Override
  public boolean isReview() {
    return getResource().equals(cleon.projectmethods.hermes.metamodel.spec.modules.projectmanagement.planning.scope.outcomes.OutcomesPackage.DocumentStage_Review);
  }
  
  @Override
  public boolean isFinal() {
    return getResource().equals(cleon.projectmethods.hermes.metamodel.spec.modules.projectmanagement.planning.scope.outcomes.OutcomesPackage.DocumentStage_Final);
  }
  
  @Override
  public boolean isApproved() {
    return getResource().equals(cleon.projectmethods.hermes.metamodel.spec.modules.projectmanagement.planning.scope.outcomes.OutcomesPackage.DocumentStage_Approved);
  }
