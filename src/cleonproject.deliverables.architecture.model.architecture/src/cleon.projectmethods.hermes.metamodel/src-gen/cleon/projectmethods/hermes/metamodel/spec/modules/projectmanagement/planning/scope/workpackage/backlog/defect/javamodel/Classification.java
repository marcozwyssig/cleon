...
public class Classification extends DynamicResource implements IClassification {
  ...
  public boolean is__W___F___N_leichter__F_Fehler__O_() {
    return getResource().equals(cleon.projectmethods.hermes.metamodel.spec.modules.projectmanagement.planning.scope.workpackage.backlog.defect.DefectPackage.Classification___W___F___N_leichter__F_Fehler__O_);
  }
  
  @Override
  public boolean is__X___F___N_wesentlicher__F_Fehler__O_() {
    return getResource().equals(cleon.projectmethods.hermes.metamodel.spec.modules.projectmanagement.planning.scope.workpackage.backlog.defect.DefectPackage.Classification___X___F___N_wesentlicher__F_Fehler__O_);
  }
  
  @Override
  public boolean is__Y___F___N_kritischer__F_Fehler__O_() {
    return getResource().equals(cleon.projectmethods.hermes.metamodel.spec.modules.projectmanagement.planning.scope.workpackage.backlog.defect.DefectPackage.Classification___Y___F___N_kritischer__F_Fehler__O_);
  }
