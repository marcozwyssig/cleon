...
public class Maturity extends DynamicResource implements IMaturity {
  ...
  public boolean is__0___F___S___F_Senior() {
    return getResource().equals(cleon.projectmethods.hermes.metamodel.spec.modules.projectmanagement.resource.persons.experience.ExperiencePackage.Maturity___0___F___S___F_Senior);
  }
  
  @Override
  public boolean is__Y___F___S___F_Professional() {
    return getResource().equals(cleon.projectmethods.hermes.metamodel.spec.modules.projectmanagement.resource.persons.experience.ExperiencePackage.Maturity___Y___F___S___F_Professional);
  }
  
  @Override
  public boolean is__W___F___S___F_Junior() {
    return getResource().equals(cleon.projectmethods.hermes.metamodel.spec.modules.projectmanagement.resource.persons.experience.ExperiencePackage.Maturity___W___F___S___F_Junior);
  }
