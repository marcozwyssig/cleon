...
public class RiskType extends DynamicResource implements IRiskType {
  ...
  public boolean isRisk() {
    return getResource().equals(cleon.projectmethods.hermes.metamodel.spec.modules.projectsteering.riskmanagement.risks.RisksPackage.RiskType_Risk);
  }
  
  @Override
  public boolean isChance() {
    return getResource().equals(cleon.projectmethods.hermes.metamodel.spec.modules.projectsteering.riskmanagement.risks.RisksPackage.RiskType_Chance);
  }
