...
public class Role_ResponsibilityElementHandler extends AbstractXMLElementHandler {
	...
	public void setCharacters(IXMLElementContext context, char[] ch, int start, int length) throws SAXException {
		...
		// String : responsibility (Mandatory)
		context.getImportContext().putInfo("setting attribute String : responsibility (Mandatory)");
		setOrUpdateStringProperty(context, context.getParentResourceNotNull(), new Resource("220fe0f5-31ce-11e8-8a84-6f139e67278b"), value); 
	}	
}

/* Actifsource ID=[33d860ec-3293-11e8-925e-0378e2266aa0,0bd0e551-3297-11e8-925e-0378e2266aa0,BHmiY6z/maEFP8VoCIe0McI+G88=] */
