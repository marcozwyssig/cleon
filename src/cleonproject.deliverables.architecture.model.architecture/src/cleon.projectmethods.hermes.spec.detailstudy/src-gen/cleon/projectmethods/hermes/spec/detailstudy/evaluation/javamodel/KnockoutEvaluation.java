...
public class KnockoutEvaluation extends DynamicResource implements IKnockoutEvaluation {
  ...
  public java.lang.Boolean selectFulfiils() {
    return _getSingleAttribute(java.lang.Boolean.class, cleon.projectmethods.hermes.spec.detailstudy.evaluation.EvaluationPackage.KnockoutEvaluation_fulfiils);
  }
    
  public void setFulfiils(java.lang.Boolean fulfiils) {
     _setSingleAttribute(cleon.projectmethods.hermes.spec.detailstudy.evaluation.EvaluationPackage.KnockoutEvaluation_fulfiils, fulfiils);
  }

  // relations
  
  @Override
  public cleon.projectmethods.hermes.spec.detailstudy.drivers.criterias.knockout.javamodel.IKnockoutCriteria selectCriteria() {
    return _getSingle(cleon.projectmethods.hermes.spec.detailstudy.drivers.criterias.knockout.javamodel.IKnockoutCriteria.class, cleon.projectmethods.hermes.spec.detailstudy.evaluation.EvaluationPackage.KnockoutEvaluation_criteria);
  }

  public KnockoutEvaluation setCriteria(cleon.projectmethods.hermes.spec.detailstudy.drivers.criterias.knockout.javamodel.IKnockoutCriteria criteria) {
    _setSingle(cleon.projectmethods.hermes.spec.detailstudy.evaluation.EvaluationPackage.KnockoutEvaluation_criteria, criteria);
    return this;
  }
  ...
  public static java.util.List<cleon.projectmethods.hermes.spec.detailstudy.evaluation.javamodel.IKnockoutEvaluation> selectToMeCriteria(cleon.projectmethods.hermes.spec.detailstudy.drivers.criterias.knockout.javamodel.IKnockoutCriteria object) {
    return _getToMeList(object.getRepository(), cleon.projectmethods.hermes.spec.detailstudy.evaluation.javamodel.IKnockoutEvaluation.class, cleon.projectmethods.hermes.spec.detailstudy.evaluation.EvaluationPackage.KnockoutEvaluation_criteria, object.getResource());
  }
