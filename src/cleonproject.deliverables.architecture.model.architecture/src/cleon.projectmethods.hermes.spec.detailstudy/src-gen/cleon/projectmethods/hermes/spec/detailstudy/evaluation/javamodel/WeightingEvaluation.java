...
public class WeightingEvaluation extends DynamicResource implements IWeightingEvaluation {
  ...
  public cleon.projectmethods.hermes.spec.detailstudy.drivers.criterias.weighting.javamodel.IWeightingCriteria selectCriteria() {
    return _getSingle(cleon.projectmethods.hermes.spec.detailstudy.drivers.criterias.weighting.javamodel.IWeightingCriteria.class, cleon.projectmethods.hermes.spec.detailstudy.evaluation.EvaluationPackage.WeightingEvaluation_criteria);
  }

  public WeightingEvaluation setCriteria(cleon.projectmethods.hermes.spec.detailstudy.drivers.criterias.weighting.javamodel.IWeightingCriteria criteria) {
    _setSingle(cleon.projectmethods.hermes.spec.detailstudy.evaluation.EvaluationPackage.WeightingEvaluation_criteria, criteria);
    return this;
  }
    
  @Override
  public cleon.projectmethods.hermes.spec.detailstudy.evaluation.javamodel.IScore selectScore() {
    return _getSingle(cleon.projectmethods.hermes.spec.detailstudy.evaluation.javamodel.IScore.class, cleon.projectmethods.hermes.spec.detailstudy.evaluation.EvaluationPackage.WeightingEvaluation_score);
  }

  public WeightingEvaluation setScore(cleon.projectmethods.hermes.spec.detailstudy.evaluation.javamodel.IScore score) {
    _setSingle(cleon.projectmethods.hermes.spec.detailstudy.evaluation.EvaluationPackage.WeightingEvaluation_score, score);
    return this;
  }
  ...
  public static java.util.List<cleon.projectmethods.hermes.spec.detailstudy.evaluation.javamodel.IWeightingEvaluation> selectToMeScore(cleon.projectmethods.hermes.spec.detailstudy.evaluation.javamodel.IScore object) {
    return _getToMeList(object.getRepository(), cleon.projectmethods.hermes.spec.detailstudy.evaluation.javamodel.IWeightingEvaluation.class, cleon.projectmethods.hermes.spec.detailstudy.evaluation.EvaluationPackage.WeightingEvaluation_score, object.getResource());
  }
  
  public static java.util.List<cleon.projectmethods.hermes.spec.detailstudy.evaluation.javamodel.IWeightingEvaluation> selectToMeCriteria(cleon.projectmethods.hermes.spec.detailstudy.drivers.criterias.weighting.javamodel.IWeightingCriteria object) {
    return _getToMeList(object.getRepository(), cleon.projectmethods.hermes.spec.detailstudy.evaluation.javamodel.IWeightingEvaluation.class, cleon.projectmethods.hermes.spec.detailstudy.evaluation.EvaluationPackage.WeightingEvaluation_criteria, object.getResource());
  }
