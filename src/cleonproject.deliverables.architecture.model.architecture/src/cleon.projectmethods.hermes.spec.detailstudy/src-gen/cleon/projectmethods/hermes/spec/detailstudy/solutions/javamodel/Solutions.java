package cleon.projectmethods.hermes.spec.detailstudy.solutions.javamodel;
...
public class Solutions extends DynamicResource implements ISolutions {
  ...
  public Solutions setChapters(java.util.List<? extends cleon.common.doc.doc.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public Solutions setDocumentElements(java.util.List<? extends cleon.common.doc.doc.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public Solutions setParagraphs(java.util.List<? extends cleon.common.doc.doc.spec.paragraph.javamodel.IParagraph> paragraphs) {
    _setList(cleon.common.doc.doc.spec.chapter.ChapterPackage.ParagraphAware_paragraphs, paragraphs);
    return this;
  }
    
  @Override
  public java.util.List<? extends cleon.projectmethods.hermes.spec.detailstudy.solutions.javamodel.ISolution> selectSolutions() {
    return _getList(cleon.projectmethods.hermes.spec.detailstudy.solutions.javamodel.ISolution.class, cleon.projectmethods.hermes.spec.detailstudy.solutions.SolutionsPackage.Solutions_solutions);
  }

  public Solutions setSolutions(java.util.List<? extends cleon.projectmethods.hermes.spec.detailstudy.solutions.javamodel.ISolution> solutions) {
    _setList(cleon.projectmethods.hermes.spec.detailstudy.solutions.SolutionsPackage.Solutions_solutions, solutions);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptList(cleon.projectmethods.hermes.spec.detailstudy.solutions.javamodel.ISolution.class, cleon.projectmethods.hermes.spec.detailstudy.solutions.SolutionsPackage.Solutions_solutions, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

  // toMeRelations
  
  public static cleon.projectmethods.hermes.spec.detailstudy.solutions.javamodel.ISolutions selectToMeSolutions(cleon.projectmethods.hermes.spec.detailstudy.solutions.javamodel.ISolution object) {
    return _getToMeSingle(object.getRepository(), cleon.projectmethods.hermes.spec.detailstudy.solutions.javamodel.ISolutions.class, cleon.projectmethods.hermes.spec.detailstudy.solutions.SolutionsPackage.Solutions_solutions, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,d6243e22-3c14-11e5-9962-cf3035adb922,+9F7ThyLFNJAKkncbQ0i4NrsIUU=] */
