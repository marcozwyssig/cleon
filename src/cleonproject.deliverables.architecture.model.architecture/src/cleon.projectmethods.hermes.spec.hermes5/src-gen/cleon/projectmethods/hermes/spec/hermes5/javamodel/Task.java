...
public class Task extends DynamicResource implements ITask {
  ...
  public java.lang.String selectPurpose() {
    return _getSingleAttribute(java.lang.String.class, cleon.projectmethods.hermes.spec.hermes5.Hermes5Package.Task_purpose);
  }
    
  public void setPurpose(java.lang.String purpose) {
     _setSingleAttribute(cleon.projectmethods.hermes.spec.hermes5.Hermes5Package.Task_purpose, purpose);
  }

  // relations
  
  @Override
  public cleon.projectmethods.hermes.spec.hermes5.javamodel.IRole selectResponsibleRole() {
    return _getSingle(cleon.projectmethods.hermes.spec.hermes5.javamodel.IRole.class, cleon.projectmethods.hermes.spec.hermes5.Hermes5Package.Task_responsibleRole);
  }

  public Task setResponsibleRole(cleon.projectmethods.hermes.spec.hermes5.javamodel.IRole responsibleRole) {
    _setSingle(cleon.projectmethods.hermes.spec.hermes5.Hermes5Package.Task_responsibleRole, responsibleRole);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingleAttribute(java.lang.String.class, cleon.projectmethods.hermes.spec.hermes5.Hermes5Package.Task_purpose, visitor);
    // relations
    _acceptSingle(cleon.projectmethods.hermes.spec.hermes5.javamodel.IRole.class, cleon.projectmethods.hermes.spec.hermes5.Hermes5Package.Task_responsibleRole, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

  public static java.util.List<cleon.projectmethods.hermes.spec.hermes5.javamodel.ITask> selectToMeResponsibleRole(cleon.projectmethods.hermes.spec.hermes5.javamodel.IRole object) {
    return _getToMeList(object.getRepository(), cleon.projectmethods.hermes.spec.hermes5.javamodel.ITask.class, cleon.projectmethods.hermes.spec.hermes5.Hermes5Package.Task_responsibleRole, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,df8e50c8-31ce-11e8-8a84-6f139e67278b,42aAGnQWWbrQgly4hDiFX05IFFw=] */
