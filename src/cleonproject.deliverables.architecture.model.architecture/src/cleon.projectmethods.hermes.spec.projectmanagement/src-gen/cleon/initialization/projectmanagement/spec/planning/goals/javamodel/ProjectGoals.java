...
public class ProjectGoals extends DynamicResource implements IProjectGoals {
  ...
  public ProjectGoals setGoals(java.util.List<? extends cleon.initialization.projectmanagement.spec.planning.goals.javamodel.IGoal> goals) {
    _setList(cleon.initialization.projectmanagement.spec.planning.goals.GoalsPackage.AbstractGoals_goals, goals);
    return this;
  }
    
  @Override
  public java.util.List<? extends cleon.initialization.projectmanagement.spec.planning.goals.javamodel.IProjectGoal> selectProjectGoals() {
    return _getList(cleon.initialization.projectmanagement.spec.planning.goals.javamodel.IProjectGoal.class, cleon.initialization.projectmanagement.spec.planning.goals.GoalsPackage.ProjectGoals_projectGoals);
  }

  public ProjectGoals setProjectGoals(java.util.List<? extends cleon.initialization.projectmanagement.spec.planning.goals.javamodel.IProjectGoal> projectGoals) {
    _setList(cleon.initialization.projectmanagement.spec.planning.goals.GoalsPackage.ProjectGoals_projectGoals, projectGoals);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptList(cleon.initialization.projectmanagement.spec.planning.goals.javamodel.IProjectGoal.class, cleon.initialization.projectmanagement.spec.planning.goals.GoalsPackage.ProjectGoals_projectGoals, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

  // toMeRelations
  
  public static cleon.initialization.projectmanagement.spec.planning.goals.javamodel.IProjectGoals selectToMeProjectGoals(cleon.initialization.projectmanagement.spec.planning.goals.javamodel.IProjectGoal object) {
    return _getToMeSingle(object.getRepository(), cleon.initialization.projectmanagement.spec.planning.goals.javamodel.IProjectGoals.class, cleon.initialization.projectmanagement.spec.planning.goals.GoalsPackage.ProjectGoals_projectGoals, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,f5d2463d-210d-11e8-9bf6-d910b575bad9,e3qrE/aQutnxH2GagXMxklrSc9g=] */
