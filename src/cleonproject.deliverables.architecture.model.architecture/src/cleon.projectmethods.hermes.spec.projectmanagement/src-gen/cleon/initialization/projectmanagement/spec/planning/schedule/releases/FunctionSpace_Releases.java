package cleon.initialization.projectmanagement.spec.planning.schedule.releases;
...
public class FunctionSpace_Releases {
  ...
  public static interface ISprintFunctions extends IDynamicResourceExtension {
    ...
    public cleon.initialization.projectmanagement.spec.planning.schedule.releases.javamodel.IReleases GetRelasePlanning();

    @IDynamicResourceExtension.MethodId("4f0e534b-8a0f-11e6-8085-d9bdba2de943")
    public cleon.initialization.projectmanagement.spec.planning.schedule.releases.javamodel.ISprint LastSprint();
    ...
    public cleon.initialization.projectmanagement.spec.planning.schedule.releases.javamodel.IRelease GetMilestone();

    @IDynamicResourceExtension.MethodId("f6a0163b-d66b-11e6-ad1f-c967b4caaf09")
    public cleon.initialization.projectmanagement.spec.planning.schedule.releases.javamodel.IReleases GetMilestones();

    @IDynamicResourceExtension.MethodId("455700f4-d71a-11e6-a422-8b5491da3f30")
    public cleon.initialization.projectmanagement.spec.planning.schedule.releases.javamodel.IPhase GetPhase();

    @IDynamicResourceExtension.MethodId("0e3853a4-d71b-11e6-a422-8b5491da3f30")
    public List<cleon.initialization.projectmanagement.spec.planning.schedule.releases.javamodel.IRelease> GetMilestoneList();
  ...
  public static interface ISprintFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("4f0e534b-8a0f-11e6-8085-d9bdba2de943")
    public cleon.initialization.projectmanagement.spec.planning.schedule.releases.javamodel.ISprint LastSprint(final cleon.initialization.projectmanagement.spec.planning.schedule.releases.javamodel.ISprint sprint);
  ...
  public static class SprintFunctions {
    ...
    public static cleon.initialization.projectmanagement.spec.planning.schedule.releases.javamodel.ISprint LastSprint(final cleon.initialization.projectmanagement.spec.planning.schedule.releases.javamodel.ISprint sprint) {
  ...
  public static interface IReleasesFunctions extends IDynamicResourceExtension {
    ...
    public cleon.initialization.projectmanagement.spec.planning.schedule.releases.javamodel.ISprint CurrentSprint();

    @IDynamicResourceExtension.MethodId("9cc04b4c-2f22-11e6-8bd9-a77b8d2a3a0e")
    public cleon.initialization.projectmanagement.spec.planning.schedule.releases.javamodel.ISprint BeforeCurrentSprint();

    @IDynamicResourceExtension.MethodId("59a78067-34a0-11e6-8839-1f6631cc77ac")
    public List<cleon.initialization.projectmanagement.spec.planning.schedule.releases.javamodel.ISprint> GetAllSprints();

    @IDynamicResourceExtension.MethodId("80ddb44e-36c1-11e6-ba0a-8d94de7675ef")
    public cleon.initialization.projectmanagement.spec.planning.schedule.releases.javamodel.ISprint GetSprint(final java.lang.Integer sprintId);
  ...
  public static interface IReleasesFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("9f89e48d-2f1d-11e6-8bd9-a77b8d2a3a0e")
    public cleon.initialization.projectmanagement.spec.planning.schedule.releases.javamodel.ISprint CurrentSprint(final cleon.initialization.projectmanagement.spec.planning.schedule.releases.javamodel.IReleases releases);

    @IDynamicResourceExtension.MethodId("9cc04b4c-2f22-11e6-8bd9-a77b8d2a3a0e")
    public cleon.initialization.projectmanagement.spec.planning.schedule.releases.javamodel.ISprint BeforeCurrentSprint(final cleon.initialization.projectmanagement.spec.planning.schedule.releases.javamodel.IReleases releases);

    @IDynamicResourceExtension.MethodId("80ddb44e-36c1-11e6-ba0a-8d94de7675ef")
    public cleon.initialization.projectmanagement.spec.planning.schedule.releases.javamodel.ISprint GetSprint(final java.lang.Integer sprintId, final cleon.initialization.projectmanagement.spec.planning.schedule.releases.javamodel.IReleases releases);
  ...
  public static class ReleasesFunctions {
    ...
    public static cleon.initialization.projectmanagement.spec.planning.schedule.releases.javamodel.ISprint CurrentSprint(final cleon.initialization.projectmanagement.spec.planning.schedule.releases.javamodel.IReleases releases) {
    ...
    public static cleon.initialization.projectmanagement.spec.planning.schedule.releases.javamodel.ISprint BeforeCurrentSprint(final cleon.initialization.projectmanagement.spec.planning.schedule.releases.javamodel.IReleases releases) {
    ...
    public static cleon.initialization.projectmanagement.spec.planning.schedule.releases.javamodel.ISprint GetSprint(final java.lang.Integer sprintId, final cleon.initialization.projectmanagement.spec.planning.schedule.releases.javamodel.IReleases releases) {
  ...
  public static interface ISprintPlanningAwareFunctions extends IDynamicResourceExtension {
    ...
    public cleon.initialization.projectmanagement.spec.planning.scope.outcomes.javamodel.IOutcome GetModule();
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,7833baaa-349b-11e6-8839-1f6631cc77ac,9ZFKkzn1iuJjBzn8oREeNvPZCpE=] */
