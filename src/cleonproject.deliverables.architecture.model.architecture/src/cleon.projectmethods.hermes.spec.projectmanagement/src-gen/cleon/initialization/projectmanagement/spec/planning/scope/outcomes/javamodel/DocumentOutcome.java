...
public class DocumentOutcome extends DynamicResource implements IDocumentOutcome {
  ...
  public DocumentOutcome setDeadlines(java.util.List<? extends cleon.initialization.projectmanagement.spec.planning.schedule.targetdates.javamodel.IDeadline> deadlines) {
  ...
  public DocumentOutcome setDeliverable(cleon.initialization.projectmanagement.spec.planning.scope.deliverable.javamodel.IDeliverable deliverable) {
  ...
  public DocumentOutcome setDependsOn(java.util.List<? extends cleon.initialization.projectmanagement.spec.planning.scope.outcomes.javamodel.IOutcomeDependency> dependsOn) {
  ...
  public cleon.initialization.projectmanagement.spec.planning.scope.outcomes.javamodel.IDocumentStage selectDocumentStage() {
    return _getSingle(cleon.initialization.projectmanagement.spec.planning.scope.outcomes.javamodel.IDocumentStage.class, cleon.initialization.projectmanagement.spec.planning.scope.outcomes.OutcomesPackage.DocumentOutcome_documentStage);
  }

  public DocumentOutcome setDocumentStage(cleon.initialization.projectmanagement.spec.planning.scope.outcomes.javamodel.IDocumentStage documentStage) {
    _setSingle(cleon.initialization.projectmanagement.spec.planning.scope.outcomes.OutcomesPackage.DocumentOutcome_documentStage, documentStage);
    return this;
  }
  ...
  public DocumentOutcome setOwner(cleon.initialization.projectmanagement.spec.resource.persons.javamodel.IPerson owner) {
  ...
  public DocumentOutcome setState(cleon.initialization.projectmanagement.spec.planning.scope.javamodel.IState state) {
  ...
  public cleon.common.resources.spec.resources.versions.javamodel.ISemanticVersion selectVersion() {
    return _getSingle(cleon.common.resources.spec.resources.versions.javamodel.ISemanticVersion.class, cleon.initialization.projectmanagement.spec.planning.scope.outcomes.OutcomesPackage.DocumentOutcome_version);
  }

  public DocumentOutcome setVersion(cleon.common.resources.spec.resources.versions.javamodel.ISemanticVersion version) {
    _setSingle(cleon.initialization.projectmanagement.spec.planning.scope.outcomes.OutcomesPackage.DocumentOutcome_version, version);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(cleon.initialization.projectmanagement.spec.planning.scope.outcomes.javamodel.IDocumentStage.class, cleon.initialization.projectmanagement.spec.planning.scope.outcomes.OutcomesPackage.DocumentOutcome_documentStage, visitor);
    ...
    _acceptSingle(cleon.common.resources.spec.resources.versions.javamodel.ISemanticVersion.class, cleon.initialization.projectmanagement.spec.planning.scope.outcomes.OutcomesPackage.DocumentOutcome_version, visitor);
  }

  // toMeRelations
  
  public static java.util.List<cleon.initialization.projectmanagement.spec.planning.scope.outcomes.javamodel.IDocumentOutcome> selectToMeDocumentStage(cleon.initialization.projectmanagement.spec.planning.scope.outcomes.javamodel.IDocumentStage object) {
    return _getToMeList(object.getRepository(), cleon.initialization.projectmanagement.spec.planning.scope.outcomes.javamodel.IDocumentOutcome.class, cleon.initialization.projectmanagement.spec.planning.scope.outcomes.OutcomesPackage.DocumentOutcome_documentStage, object.getResource());
  }
  
  public static cleon.initialization.projectmanagement.spec.planning.scope.outcomes.javamodel.IDocumentOutcome selectToMeVersion(cleon.common.resources.spec.resources.versions.javamodel.ISemanticVersion object) {
    return _getToMeSingle(object.getRepository(), cleon.initialization.projectmanagement.spec.planning.scope.outcomes.javamodel.IDocumentOutcome.class, cleon.initialization.projectmanagement.spec.planning.scope.outcomes.OutcomesPackage.DocumentOutcome_version, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,bab231a7-bfeb-11e8-a3d0-5394fd9291a1,N17h0Z4BolqJKO7GKxJxGcA3Ku4=] */
