...
public class ManagementOutcome extends DynamicResource implements IManagementOutcome {
  ...
  public ManagementOutcome setDeadlines(java.util.List<? extends cleon.initialization.projectmanagement.spec.planning.schedule.targetdates.javamodel.IDeadline> deadlines) {
  ...
  public ManagementOutcome setDeliverable(cleon.initialization.projectmanagement.spec.planning.scope.deliverable.javamodel.IDeliverable deliverable) {
  ...
  public ManagementOutcome setDependsOn(java.util.List<? extends cleon.initialization.projectmanagement.spec.planning.scope.outcomes.javamodel.IOutcomeDependency> dependsOn) {
  ...
  public ManagementOutcome setOwner(cleon.initialization.projectmanagement.spec.resource.persons.javamodel.IPerson owner) {
  ...
  public ManagementOutcome setState(cleon.initialization.projectmanagement.spec.planning.scope.javamodel.IState state) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,cc207995-bfeb-11e8-a3d0-5394fd9291a1,1H/YFr4n7PiRdQlUAtIfqWL8HcA=] */
