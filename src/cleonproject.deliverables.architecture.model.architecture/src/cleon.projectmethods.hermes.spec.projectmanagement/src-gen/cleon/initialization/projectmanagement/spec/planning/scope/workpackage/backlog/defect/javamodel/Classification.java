...
public class Classification extends DynamicResource implements IClassification {
  ...
  public boolean is__W___F___N_leichter__F_Fehler__O_() {
    return getResource().equals(cleon.initialization.projectmanagement.spec.planning.scope.workpackage.backlog.defect.DefectPackage.Classification___W___F___N_leichter__F_Fehler__O_);
  }
  
  @Override
  public boolean is__X___F___N_wesentlicher__F_Fehler__O_() {
    return getResource().equals(cleon.initialization.projectmanagement.spec.planning.scope.workpackage.backlog.defect.DefectPackage.Classification___X___F___N_wesentlicher__F_Fehler__O_);
  }
  
  @Override
  public boolean is__Y___F___N_kritischer__F_Fehler__O_() {
    return getResource().equals(cleon.initialization.projectmanagement.spec.planning.scope.workpackage.backlog.defect.DefectPackage.Classification___Y___F___N_kritischer__F_Fehler__O_);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,9a8462a1-3765-11e5-95d9-2b04d7ab02d9,wAzPw5RcPaIAfFyq5SB4MTNLg6Q=] */
