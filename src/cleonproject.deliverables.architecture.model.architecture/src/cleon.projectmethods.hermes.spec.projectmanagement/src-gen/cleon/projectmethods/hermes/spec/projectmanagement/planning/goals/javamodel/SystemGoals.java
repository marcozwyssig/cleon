...
public class SystemGoals extends DynamicResource implements ISystemGoals {
  ...
  public SystemGoals setChapters(java.util.List<? extends cleon.common.doc.doc.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public SystemGoals setDocumentElements(java.util.List<? extends cleon.common.doc.doc.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public SystemGoals setGoals(java.util.List<? extends cleon.projectmethods.hermes.spec.projectmanagement.planning.goals.javamodel.IGoal> goals) {
  ...
  public SystemGoals setParagraphs(java.util.List<? extends cleon.common.doc.doc.spec.paragraph.javamodel.IParagraph> paragraphs) {
    _setList(cleon.common.doc.doc.spec.chapter.ChapterPackage.ParagraphAware_paragraphs, paragraphs);
    return this;
  }
    
  @Override
  public java.util.List<? extends cleon.projectmethods.hermes.spec.projectmanagement.planning.goals.javamodel.ISystemGoal> selectSystemGoals() {
    return _getList(cleon.projectmethods.hermes.spec.projectmanagement.planning.goals.javamodel.ISystemGoal.class, cleon.projectmethods.hermes.spec.projectmanagement.planning.goals.GoalsPackage.SystemGoals_systemGoals);
  }

  public SystemGoals setSystemGoals(java.util.List<? extends cleon.projectmethods.hermes.spec.projectmanagement.planning.goals.javamodel.ISystemGoal> systemGoals) {
    _setList(cleon.projectmethods.hermes.spec.projectmanagement.planning.goals.GoalsPackage.SystemGoals_systemGoals, systemGoals);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptList(cleon.projectmethods.hermes.spec.projectmanagement.planning.goals.javamodel.ISystemGoal.class, cleon.projectmethods.hermes.spec.projectmanagement.planning.goals.GoalsPackage.SystemGoals_systemGoals, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

  // toMeRelations
  
  public static cleon.projectmethods.hermes.spec.projectmanagement.planning.goals.javamodel.ISystemGoals selectToMeSystemGoals(cleon.projectmethods.hermes.spec.projectmanagement.planning.goals.javamodel.ISystemGoal object) {
    return _getToMeSingle(object.getRepository(), cleon.projectmethods.hermes.spec.projectmanagement.planning.goals.javamodel.ISystemGoals.class, cleon.projectmethods.hermes.spec.projectmanagement.planning.goals.GoalsPackage.SystemGoals_systemGoals, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,1fabee5e-210e-11e8-9bf6-d910b575bad9,7iAeWv4pcreCLyqBEIm1sybfj1Y=] */
