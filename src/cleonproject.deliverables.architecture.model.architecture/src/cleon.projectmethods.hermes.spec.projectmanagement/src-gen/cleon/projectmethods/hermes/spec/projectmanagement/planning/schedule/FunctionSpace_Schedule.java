package cleon.projectmethods.hermes.spec.projectmanagement.planning.schedule;
...
public class FunctionSpace_Schedule {
  ...
  public static interface ITargetDateFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("b5d11302-20c6-11e6-9bb5-2b7a5dccc043")
    public java.lang.Boolean IsLate(final cleon.projectmethods.hermes.spec.projectmanagement.resource.javamodel.ITargetDate targetDate);
  ...
  public static class TargetDateFunctions {
    ...
    public static java.lang.Boolean IsLate(final cleon.projectmethods.hermes.spec.projectmanagement.resource.javamodel.ITargetDate targetDate) {
  ...
  public static interface IScheduleFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("234caa05-aaa6-11e8-b25a-7dd9f85a27ad")
    public List<cleon.common.resources.spec.calendar.javamodel.IMonth> SelectMonths(final cleon.projectmethods.hermes.spec.projectmanagement.planning.schedule.javamodel.ISchedule schedule);
  ...
  public static class ScheduleFunctions {
    ...
    public static List<cleon.common.resources.spec.calendar.javamodel.IMonth> SelectMonths(final cleon.projectmethods.hermes.spec.projectmanagement.planning.schedule.javamodel.ISchedule schedule) {
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,acb90998-20c6-11e6-9bb5-2b7a5dccc043,TerV23bhkGcJWEoMBJoeSTuVHSw=] */
