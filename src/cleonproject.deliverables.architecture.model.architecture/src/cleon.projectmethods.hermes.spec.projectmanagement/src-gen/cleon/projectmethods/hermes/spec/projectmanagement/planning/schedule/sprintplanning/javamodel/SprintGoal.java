...
public class SprintGoal extends DynamicResource implements ISprintGoal {
  ...
  public java.util.List<java.lang.String> selectGoalDescriptions() {
    return _getListAttribute(java.lang.String.class, cleon.projectmethods.hermes.spec.projectmanagement.planning.schedule.sprintplanning.SprintplanningPackage.SprintGoal_goalDescriptions);
  }
    
  public void setGoalDescriptions(java.util.List<java.lang.String> goalDescriptions) {
     _setListAttribute(cleon.projectmethods.hermes.spec.projectmanagement.planning.schedule.sprintplanning.SprintplanningPackage.SprintGoal_goalDescriptions, goalDescriptions);
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptListAttribute(java.lang.String.class, cleon.projectmethods.hermes.spec.projectmanagement.planning.schedule.sprintplanning.SprintplanningPackage.SprintGoal_goalDescriptions, visitor);
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,a13c005f-c126-11e5-bfd0-47571a06cb62,M+jVX6VNGvC+ehZyQce5UOt9TIo=] */
