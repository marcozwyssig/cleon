...
public class State extends DynamicResource implements IState {
  ...
  public boolean isOpen() {
    return getResource().equals(cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.ScopePackage.State_Open);
  }
  
  @Override
  public boolean isIn__F_Progress() {
    return getResource().equals(cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.ScopePackage.State_In__F_Progress);
  }
  
  @Override
  public boolean isDone() {
    return getResource().equals(cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.ScopePackage.State_Done);
  }
  
  @Override
  public boolean isOnHold() {
    return getResource().equals(cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.ScopePackage.State_OnHold);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,5b3641a5-c767-11e6-9515-3d3c9e104ed6,ZQJV+hjsYlsFnTR+x3JP7fBhVYA=] */
