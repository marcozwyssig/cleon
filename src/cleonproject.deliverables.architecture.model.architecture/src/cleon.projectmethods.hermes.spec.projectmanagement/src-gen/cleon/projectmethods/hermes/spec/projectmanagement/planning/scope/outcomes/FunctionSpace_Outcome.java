package cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.outcomes;
...
import cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.workpackage.backlog.javamodel.Backlog;
...
public class FunctionSpace_Outcome {
  ...
  public static interface IOutcomeFunctions extends IDynamicResourceExtension {
    ...
    public cleon.projectmethods.hermes.spec.projectmanagement.planning.schedule.javamodel.ISchedule GetSchedule();

    @IDynamicResourceExtension.MethodId("3782abf4-36c0-11e6-ba0a-8d94de7675ef")
    public cleon.projectmethods.hermes.spec.projectmanagement.planning.schedule.sprintplanning.javamodel.ISprintPlannings GetSprintPlannings();
    ...
    public cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.workpackage.javamodel.IWorkpackage GetWorkpackage();
    ...
    public cleon.projectmethods.hermes.spec.projectmanagement.planning.schedule.releases.javamodel.ISprint GetStartSprint();

    @IDynamicResourceExtension.MethodId("fde15e4d-3fc2-11e7-9016-2b91d722d429")
    public cleon.projectmethods.hermes.spec.projectmanagement.planning.schedule.releases.javamodel.ISprint GetEndSprint();

    @IDynamicResourceExtension.MethodId("bed73809-bfed-11e8-a3d0-5394fd9291a1")
    public cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.outcomes.javamodel.IOutcomes GetOutcomes();
  ...
  public static interface IOutcomeFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("b7a8e864-c13b-11e6-8f58-ad3c6ee7602f")
    public java.lang.String GetId(final cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.outcomes.javamodel.IOutcome outcome);

    @IDynamicResourceExtension.MethodId("87caceb9-3fc2-11e7-9016-2b91d722d429")
    public cleon.common.resources.spec.calendar.javamodel.IDay GetStartDay(final cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.outcomes.javamodel.IOutcome outcome);

    @IDynamicResourceExtension.MethodId("93062c5c-3fc2-11e7-9016-2b91d722d429")
    public cleon.common.resources.spec.calendar.javamodel.IDay GetEndDay(final cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.outcomes.javamodel.IOutcome outcome);
  ...
  public static class OutcomeFunctions {
    ...
    public static java.lang.String GetId(final cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.outcomes.javamodel.IOutcome outcome) {
      return DynamicResourceUtil.invoke(IOutcomeFunctionsImpl.class, OutcomeFunctionsImpl.INSTANCE, outcome).GetId(outcome);
    }

    public static cleon.common.resources.spec.calendar.javamodel.IDay GetStartDay(final cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.outcomes.javamodel.IOutcome outcome) {
      return DynamicResourceUtil.invoke(IOutcomeFunctionsImpl.class, OutcomeFunctionsImpl.INSTANCE, outcome).GetStartDay(outcome);
    }

    public static cleon.common.resources.spec.calendar.javamodel.IDay GetEndDay(final cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.outcomes.javamodel.IOutcome outcome) {
  ...
  public static interface IOutcomesFunctions extends IDynamicResourceExtension {
    ...
    public List<cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.outcomes.javamodel.IOutcome> GetAllOutcomes();
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,afa77083-349b-11e6-8839-1f6631cc77ac,D1i9fYpVdNKRWp/Yw5tr2KuRcGA=] */
