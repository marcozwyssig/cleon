...
public class FunctionSpace_Outcome {
  ...
  public static interface IOutcomeFunctions extends IDynamicResourceExtension {
    ...
    public cleon.projectmethods.hermes.spec.projectmanagement.planning.schedule.sprints.javamodel.ISprint GetStartSprint();

    @IDynamicResourceExtension.MethodId("fde15e4d-3fc2-11e7-9016-2b91d722d429")
    public cleon.projectmethods.hermes.spec.projectmanagement.planning.schedule.sprints.javamodel.ISprint GetEndSprint();
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,afa77083-349b-11e6-8839-1f6631cc77ac,NgE+m60TchCB9fxGk+/v7MyRX1Q=] */
