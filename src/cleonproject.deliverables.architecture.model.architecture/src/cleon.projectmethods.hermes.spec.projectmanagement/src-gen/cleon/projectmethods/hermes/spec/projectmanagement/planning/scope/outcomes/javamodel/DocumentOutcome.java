...
public class DocumentOutcome extends DynamicResource implements IDocumentOutcome {
  ...
  public DocumentOutcome setChapters(java.util.List<? extends cleon.common.doc.doc.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public DocumentOutcome setDeadlines(java.util.List<? extends cleon.projectmethods.hermes.spec.projectmanagement.planning.schedule.targetdates.javamodel.IDeadline> deadlines) {
  ...
  public DocumentOutcome setDeliverable(cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.deliverable.javamodel.IDeliverable deliverable) {
  ...
  public DocumentOutcome setDependsOn(java.util.List<? extends cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.outcomes.javamodel.IOutcomeDependency> dependsOn) {
  ...
  public DocumentOutcome setDocumentElements(java.util.List<? extends cleon.common.doc.doc.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.outcomes.javamodel.IDocumentStage selectDocumentStage() {
    return _getSingle(cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.outcomes.javamodel.IDocumentStage.class, cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.outcomes.OutcomesPackage.DocumentOutcome_documentStage);
  }

  public DocumentOutcome setDocumentStage(cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.outcomes.javamodel.IDocumentStage documentStage) {
    _setSingle(cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.outcomes.OutcomesPackage.DocumentOutcome_documentStage, documentStage);
    return this;
  }
  ...
  public DocumentOutcome setOwner(cleon.projectmethods.hermes.spec.projectmanagement.resource.persons.javamodel.IPerson owner) {
  ...
  public DocumentOutcome setParagraphs(java.util.List<? extends cleon.common.doc.doc.spec.paragraph.javamodel.IParagraph> paragraphs) {
  ...
  public DocumentOutcome setState(cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.javamodel.IState state) {
  ...
  public cleon.common.resources.spec.resources.versions.javamodel.ISemanticVersion selectVersion() {
    return _getSingle(cleon.common.resources.spec.resources.versions.javamodel.ISemanticVersion.class, cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.outcomes.OutcomesPackage.DocumentOutcome_version);
  }

  public DocumentOutcome setVersion(cleon.common.resources.spec.resources.versions.javamodel.ISemanticVersion version) {
    _setSingle(cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.outcomes.OutcomesPackage.DocumentOutcome_version, version);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.outcomes.javamodel.IDocumentStage.class, cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.outcomes.OutcomesPackage.DocumentOutcome_documentStage, visitor);
    ...
    _acceptSingle(cleon.common.resources.spec.resources.versions.javamodel.ISemanticVersion.class, cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.outcomes.OutcomesPackage.DocumentOutcome_version, visitor);
  }

  // toMeRelations
  
  public static java.util.List<cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.outcomes.javamodel.IDocumentOutcome> selectToMeDocumentStage(cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.outcomes.javamodel.IDocumentStage object) {
    return _getToMeList(object.getRepository(), cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.outcomes.javamodel.IDocumentOutcome.class, cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.outcomes.OutcomesPackage.DocumentOutcome_documentStage, object.getResource());
  }
  
  public static cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.outcomes.javamodel.IDocumentOutcome selectToMeVersion(cleon.common.resources.spec.resources.versions.javamodel.ISemanticVersion object) {
    return _getToMeSingle(object.getRepository(), cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.outcomes.javamodel.IDocumentOutcome.class, cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.outcomes.OutcomesPackage.DocumentOutcome_version, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,bab231a7-bfeb-11e8-a3d0-5394fd9291a1,I+qrtnpLKKMGVKmt7HtL0q81KdQ=] */
