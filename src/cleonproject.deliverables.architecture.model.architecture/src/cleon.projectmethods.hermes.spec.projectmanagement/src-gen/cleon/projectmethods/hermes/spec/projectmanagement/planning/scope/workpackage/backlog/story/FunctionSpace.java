package cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.workpackage.backlog.story;
...
public class FunctionSpace {
  ...
  public static interface IStoryFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("db2a8186-c58b-11e5-aeea-1db9268c0ee9")
    public java.lang.String GetId(final cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.workpackage.backlog.story.javamodel.IStory story);
  ...
  public static class StoryFunctions {
    ...
    public static java.lang.String GetId(final cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.workpackage.backlog.story.javamodel.IStory story) {
  ...
  public static interface IActivityFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("a9d10320-1e7a-11e7-ba0d-79d7a7c79635")
    public java.lang.String GetId(final cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.workpackage.backlog.story.javamodel.IActivity activity);
  ...
  public static class ActivityFunctions {
    ...
    public static java.lang.String GetId(final cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.workpackage.backlog.story.javamodel.IActivity activity) {
  ...
  public static interface IDefectFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("b6d1def8-1e7a-11e7-ba0d-79d7a7c79635")
    public java.lang.String GetId(final cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.workpackage.backlog.defect.javamodel.IDefect defect);
  ...
  public static class DefectFunctions {
    ...
    public static java.lang.String GetId(final cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.workpackage.backlog.defect.javamodel.IDefect defect) {
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,d5f9ec72-c58b-11e5-aeea-1db9268c0ee9,S6IVrBTPNhwgvqsp1P6mk5h3E40=] */
