...
public class FunctionSpace_Protocols {
  ...
  public static interface IProtocolFunctions extends IDynamicResourceExtension {
    ...
    public List<cleon.projectmethods.hermes.spec.projectmanagement.protocols.protocolsitems.javamodel.ITask> SelectAllTasks();
  ...
  public static interface IProtocolItemFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("9375b6ee-2ef1-11e6-8bd9-a77b8d2a3a0e")
    public java.lang.String GetId(final cleon.projectmethods.hermes.spec.projectmanagement.protocols.javamodel.IProtocolItem protocolItem);
  ...
  public static class ProtocolItemFunctions {
    ...
    public static java.lang.String GetId(final cleon.projectmethods.hermes.spec.projectmanagement.protocols.javamodel.IProtocolItem protocolItem) {
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,e643372c-20b6-11e6-9bb5-2b7a5dccc043,uJyBTCYPZRZxZa21S9b0OLRWtu8=] */
