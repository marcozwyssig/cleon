...
public class HasAssets extends DynamicResource implements IHasAssets {
  ...
  public HasAssets setAssets(java.util.List<? extends cleon.projectmethods.hermes.spec.projectmanagement.resource.infrastructure.javamodel.IAsset> assets) {
  ...
  public static cleon.projectmethods.hermes.spec.projectmanagement.resource.infrastructure.javamodel.IHasAssets selectToMeAssets(cleon.projectmethods.hermes.spec.projectmanagement.resource.infrastructure.javamodel.IAsset object) {
    return _getToMeSingle(object.getRepository(), cleon.projectmethods.hermes.spec.projectmanagement.resource.infrastructure.javamodel.IHasAssets.class, cleon.projectmethods.hermes.spec.projectmanagement.resource.infrastructure.InfrastructurePackage.HasAssets_assets, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,c80d50de-bbd6-11e6-997f-d73ea5a3671c,DOOGvnQDBLeQ9wmQ7mPjy7u/Hu0=] */
