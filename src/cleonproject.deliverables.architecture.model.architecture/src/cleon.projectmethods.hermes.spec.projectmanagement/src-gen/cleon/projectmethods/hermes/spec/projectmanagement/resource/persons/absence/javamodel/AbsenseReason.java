...
public class AbsenseReason extends DynamicResource implements IAbsenseReason {
  ...
  public boolean isVacation() {
    return getResource().equals(cleon.projectmethods.hermes.spec.projectmanagement.resource.persons.absence.AbsencePackage.AbsenseReason_Vacation);
  }
  
  @Override
  public boolean isEducation() {
    return getResource().equals(cleon.projectmethods.hermes.spec.projectmanagement.resource.persons.absence.AbsencePackage.AbsenseReason_Education);
  }
  
  @Override
  public boolean isFree() {
    return getResource().equals(cleon.projectmethods.hermes.spec.projectmanagement.resource.persons.absence.AbsencePackage.AbsenseReason_Free);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,9314d460-c4c7-11e5-8558-4b8affb7767c,aBI0pVPxcnvaARITUpKi+4kBicE=] */
