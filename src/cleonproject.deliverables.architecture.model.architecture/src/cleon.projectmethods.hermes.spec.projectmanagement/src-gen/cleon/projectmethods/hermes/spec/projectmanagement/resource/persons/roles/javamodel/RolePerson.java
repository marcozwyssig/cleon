...
public class RolePerson extends DynamicResource implements IRolePerson {
  ...
  public cleon.projectmethods.hermes.spec.projectmanagement.resource.roles.javamodel.IRole selectRole() {
    return _getSingle(cleon.projectmethods.hermes.spec.projectmanagement.resource.roles.javamodel.IRole.class, cleon.projectmethods.hermes.spec.projectmanagement.resource.persons.roles.RolesPackage.RolePerson_role);
  }

  public RolePerson setRole(cleon.projectmethods.hermes.spec.projectmanagement.resource.roles.javamodel.IRole role) {
    _setSingle(cleon.projectmethods.hermes.spec.projectmanagement.resource.persons.roles.RolesPackage.RolePerson_role, role);
    return this;
  }
  ...
  public static java.util.List<cleon.projectmethods.hermes.spec.projectmanagement.resource.persons.roles.javamodel.IRolePerson> selectToMeRole(cleon.projectmethods.hermes.spec.projectmanagement.resource.roles.javamodel.IRole object) {
    return _getToMeList(object.getRepository(), cleon.projectmethods.hermes.spec.projectmanagement.resource.persons.roles.javamodel.IRolePerson.class, cleon.projectmethods.hermes.spec.projectmanagement.resource.persons.roles.RolesPackage.RolePerson_role, object.getResource());
  }
