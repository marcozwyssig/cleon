...
public class Teams extends DynamicResource implements ITeams {
  ...
  public Teams setChapters(java.util.List<? extends cleon.common.doc.doc.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public Teams setDocumentElements(java.util.List<? extends cleon.common.doc.doc.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public Teams setParagraphs(java.util.List<? extends cleon.common.doc.doc.spec.paragraph.javamodel.IParagraph> paragraphs) {
    _setList(cleon.common.doc.doc.spec.chapter.ChapterPackage.ParagraphAware_paragraphs, paragraphs);
    return this;
  }
    
  @Override
  public java.util.List<? extends cleon.projectmethods.hermes.spec.projectmanagement.resource.teams.javamodel.ITeam> selectTeams() {
    return _getList(cleon.projectmethods.hermes.spec.projectmanagement.resource.teams.javamodel.ITeam.class, cleon.projectmethods.hermes.spec.projectmanagement.resource.teams.TeamsPackage.Teams_teams);
  }

  public Teams setTeams(java.util.List<? extends cleon.projectmethods.hermes.spec.projectmanagement.resource.teams.javamodel.ITeam> teams) {
    _setList(cleon.projectmethods.hermes.spec.projectmanagement.resource.teams.TeamsPackage.Teams_teams, teams);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptList(cleon.projectmethods.hermes.spec.projectmanagement.resource.teams.javamodel.ITeam.class, cleon.projectmethods.hermes.spec.projectmanagement.resource.teams.TeamsPackage.Teams_teams, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

  // toMeRelations
  
  public static cleon.projectmethods.hermes.spec.projectmanagement.resource.teams.javamodel.ITeams selectToMeTeams(cleon.projectmethods.hermes.spec.projectmanagement.resource.teams.javamodel.ITeam object) {
    return _getToMeSingle(object.getRepository(), cleon.projectmethods.hermes.spec.projectmanagement.resource.teams.javamodel.ITeams.class, cleon.projectmethods.hermes.spec.projectmanagement.resource.teams.TeamsPackage.Teams_teams, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,6744688b-2eea-11e6-8bd9-a77b8d2a3a0e,K36WDXB7yK655RPRYejA/s2j0tA=] */
