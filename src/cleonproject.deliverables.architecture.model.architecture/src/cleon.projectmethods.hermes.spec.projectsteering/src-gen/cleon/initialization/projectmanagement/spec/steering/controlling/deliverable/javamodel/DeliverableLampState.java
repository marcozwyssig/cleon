...
public class DeliverableLampState extends DynamicResource implements IDeliverableLampState {
  ...
  public boolean isRed() {
    return getResource().equals(cleon.initialization.projectmanagement.spec.steering.controlling.deliverable.DeliverablePackage.DeliverableLampState_Red);
  }
  
  @Override
  public boolean isYellow() {
    return getResource().equals(cleon.initialization.projectmanagement.spec.steering.controlling.deliverable.DeliverablePackage.DeliverableLampState_Yellow);
  }
  
  @Override
  public boolean isGreen() {
    return getResource().equals(cleon.initialization.projectmanagement.spec.steering.controlling.deliverable.DeliverablePackage.DeliverableLampState_Green);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,60427122-3386-11e6-b251-57783f5929b3,cRAOBtqMZA5X4pNyv4DLnBTrOZQ=] */
