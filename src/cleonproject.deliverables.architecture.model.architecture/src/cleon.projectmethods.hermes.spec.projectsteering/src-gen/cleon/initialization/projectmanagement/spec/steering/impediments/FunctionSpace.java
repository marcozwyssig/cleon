...
public class FunctionSpace {
  ...
  public static interface IImpedimentFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("4bf6efcf-3385-11e6-b251-57783f5929b3")
    public java.lang.String GetId(final cleon.initialization.projectmanagement.spec.steering.impediments.javamodel.IImpediment impediment);
  ...
  public static class ImpedimentFunctions {
    ...
    public static java.lang.String GetId(final cleon.initialization.projectmanagement.spec.steering.impediments.javamodel.IImpediment impediment) {
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,46612fb6-3385-11e6-b251-57783f5929b3,Y5YTp2ozbZ4MN0SdvzSvE89zTpg=] */
