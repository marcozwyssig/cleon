...
public class ProbabilityOfOccurrence extends DynamicResource implements IProbabilityOfOccurrence {
  ...
  public boolean is__W_() {
    return getResource().equals(cleon.initialization.projectmanagement.spec.steering.riskmanagement.assessments.analysis.AnalysisPackage.ProbabilityOfOccurrence___W_);
  }
  
  @Override
  public boolean is__X_() {
    return getResource().equals(cleon.initialization.projectmanagement.spec.steering.riskmanagement.assessments.analysis.AnalysisPackage.ProbabilityOfOccurrence___X_);
  }
  
  @Override
  public boolean is__Y_() {
    return getResource().equals(cleon.initialization.projectmanagement.spec.steering.riskmanagement.assessments.analysis.AnalysisPackage.ProbabilityOfOccurrence___Y_);
  }
  
  @Override
  public boolean is__Z_() {
    return getResource().equals(cleon.initialization.projectmanagement.spec.steering.riskmanagement.assessments.analysis.AnalysisPackage.ProbabilityOfOccurrence___Z_);
  }
  
  @Override
  public boolean is__0_() {
    return getResource().equals(cleon.initialization.projectmanagement.spec.steering.riskmanagement.assessments.analysis.AnalysisPackage.ProbabilityOfOccurrence___0_);
  }
  
  @Override
  public boolean is__1_() {
    return getResource().equals(cleon.initialization.projectmanagement.spec.steering.riskmanagement.assessments.analysis.AnalysisPackage.ProbabilityOfOccurrence___1_);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,9957e084-2eff-11e6-8bd9-a77b8d2a3a0e,rUadvOXA2xutgeDV3XShdBFBVwc=] */
