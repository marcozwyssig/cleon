...
public class DeliverableRisks extends DynamicResource implements IDeliverableRisks {
  ...
  public DeliverableRisks setChapters(java.util.List<? extends cleon.common.doc.doc.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public DeliverableRisks setDocumentElements(java.util.List<? extends cleon.common.doc.doc.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public DeliverableRisks setParagraphs(java.util.List<? extends cleon.common.doc.doc.spec.paragraph.javamodel.IParagraph> paragraphs) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,dd556bb4-2f0a-11e6-8bd9-a77b8d2a3a0e,FFF9gdK5V0Z/4tpOhzY4ug40oYs=] */
