...
public class DeliverablesControlling extends DynamicResource implements IDeliverablesControlling {
  ...
  public DeliverablesControlling setChapters(java.util.List<? extends cleon.common.doc.doc.spec.chapter.javamodel.IAbstractChapter> chapters) {
    _setList(cleon.common.doc.doc.spec.SpecPackage.ChapterAware_chapters, chapters);
    return this;
  }
    
  @Override
  public java.util.Map<ch.actifsource.core.Resource, ? extends cleon.projectmethods.hermes.spec.projectsteering.controlling.deliverable.javamodel.IDeliverableControlling> selectDeliverableControllings() {
    return _getMap(cleon.projectmethods.hermes.spec.projectsteering.controlling.deliverable.javamodel.IDeliverableControlling.class, cleon.projectmethods.hermes.spec.projectsteering.controlling.deliverable.DeliverablePackage.DeliverablesControlling_deliverableControllings);
  }

  public DeliverablesControlling setDeliverableControllings(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.projectmethods.hermes.spec.projectsteering.controlling.deliverable.javamodel.IDeliverableControlling> deliverableControllings) {
    _setMap(cleon.projectmethods.hermes.spec.projectsteering.controlling.deliverable.DeliverablePackage.DeliverablesControlling_deliverableControllings, deliverableControllings);
    return this;
  }
  ...
  public DeliverablesControlling setDocumentElements(java.util.List<? extends cleon.common.doc.doc.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public DeliverablesControlling setParagraphs(java.util.List<? extends cleon.common.doc.doc.spec.paragraph.javamodel.IParagraph> paragraphs) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    // relations
    _acceptMap(cleon.projectmethods.hermes.spec.projectsteering.controlling.deliverable.javamodel.IDeliverableControlling.class, cleon.projectmethods.hermes.spec.projectsteering.controlling.deliverable.DeliverablePackage.DeliverablesControlling_deliverableControllings, visitor);
  ...
  public static cleon.projectmethods.hermes.spec.projectsteering.controlling.deliverable.javamodel.IDeliverablesControlling selectToMeDeliverableControllings(cleon.projectmethods.hermes.spec.projectsteering.controlling.deliverable.javamodel.IDeliverableControlling object) {
    return _getToMeSingle(object.getRepository(), cleon.projectmethods.hermes.spec.projectsteering.controlling.deliverable.javamodel.IDeliverablesControlling.class, cleon.projectmethods.hermes.spec.projectsteering.controlling.deliverable.DeliverablePackage.DeliverablesControlling_deliverableControllings, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,daab8237-bdfc-11e6-a3f0-c7681ee45a3f,QuPh0SFSDccK/u35+M23MmWEPX0=] */
