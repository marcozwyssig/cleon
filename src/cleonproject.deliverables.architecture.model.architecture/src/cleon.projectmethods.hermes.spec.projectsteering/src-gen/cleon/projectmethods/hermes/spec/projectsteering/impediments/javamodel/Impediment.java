...
public class Impediment extends DynamicResource implements IImpediment {
  ...
  public java.util.List<java.lang.String> selectResolutionsDetails() {
    return _getListAttribute(java.lang.String.class, cleon.projectmethods.hermes.spec.projectsteering.impediments.ImpedimentsPackage.Impediment_resolutionsDetails);
  }
    
  public void setResolutionsDetails(java.util.List<java.lang.String> resolutionsDetails) {
     _setListAttribute(cleon.projectmethods.hermes.spec.projectsteering.impediments.ImpedimentsPackage.Impediment_resolutionsDetails, resolutionsDetails);
  }
  ...
  public cleon.common.resources.spec.calendar.javamodel.IDay selectEntryDate() {
    return _getSingle(cleon.common.resources.spec.calendar.javamodel.IDay.class, cleon.projectmethods.hermes.spec.projectsteering.impediments.ImpedimentsPackage.Impediment_entryDate);
  }

  public Impediment setEntryDate(cleon.common.resources.spec.calendar.javamodel.IDay entryDate) {
    _setSingle(cleon.projectmethods.hermes.spec.projectsteering.impediments.ImpedimentsPackage.Impediment_entryDate, entryDate);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptListAttribute(java.lang.String.class, cleon.projectmethods.hermes.spec.projectsteering.impediments.ImpedimentsPackage.Impediment_resolutionsDetails, visitor);
    // relations
    _acceptSingle(cleon.common.resources.spec.calendar.javamodel.IDay.class, cleon.projectmethods.hermes.spec.projectsteering.impediments.ImpedimentsPackage.Impediment_entryDate, visitor);
  ...
  public static java.util.List<cleon.projectmethods.hermes.spec.projectsteering.impediments.javamodel.IImpediment> selectToMeEntryDate(cleon.common.resources.spec.calendar.javamodel.IDay object) {
    return _getToMeList(object.getRepository(), cleon.projectmethods.hermes.spec.projectsteering.impediments.javamodel.IImpediment.class, cleon.projectmethods.hermes.spec.projectsteering.impediments.ImpedimentsPackage.Impediment_entryDate, object.getResource());
  }
