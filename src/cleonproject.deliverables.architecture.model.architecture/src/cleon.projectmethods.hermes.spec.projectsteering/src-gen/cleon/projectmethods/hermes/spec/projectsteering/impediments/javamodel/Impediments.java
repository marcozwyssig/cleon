package cleon.projectmethods.hermes.spec.projectsteering.impediments.javamodel;
...
public class Impediments extends DynamicResource implements IImpediments {
  ...
  public Impediments setChapters(java.util.List<? extends cleon.common.doc.doc.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public Impediments setDocumentElements(java.util.List<? extends cleon.common.doc.doc.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public Impediments setDocumentLanguage(java.util.List<? extends cleon.common.doc.doc.spec.documentlanguage.javamodel.IDocumentLanguage> documentLanguage) {
  ...
  public Impediments setImpediments(java.util.List<? extends cleon.projectmethods.hermes.spec.projectsteering.impediments.javamodel.IImpediment> impediments) {
    _setList(cleon.projectmethods.hermes.spec.projectsteering.impediments.ImpedimentsPackage.Impediments_impediments, impediments);
    return this;
  }
  ...
  public Impediments setProperties(cleon.common.doc.doc.spec.document.properties.javamodel.IProperties properties) {
  ...
  public Impediments setStyle(cleon.common.doc.doc.spec.document.style.javamodel.IStyle style) {
  ...
  public static cleon.projectmethods.hermes.spec.projectsteering.impediments.javamodel.IImpediments selectToMeImpediments(cleon.projectmethods.hermes.spec.projectsteering.impediments.javamodel.IImpediment object) {
    return _getToMeSingle(object.getRepository(), cleon.projectmethods.hermes.spec.projectsteering.impediments.javamodel.IImpediments.class, cleon.projectmethods.hermes.spec.projectsteering.impediments.ImpedimentsPackage.Impediments_impediments, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,af7dac0a-3383-11e6-b251-57783f5929b3,6ZM/wQbqo3LeTODoz/YFAQkPzbA=] */
