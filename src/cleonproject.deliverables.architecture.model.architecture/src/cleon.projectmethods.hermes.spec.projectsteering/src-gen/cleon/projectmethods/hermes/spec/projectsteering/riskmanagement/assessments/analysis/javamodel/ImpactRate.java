...
public class ImpactRate extends DynamicResource implements IImpactRate {
  ...
  public boolean is__W_() {
    return getResource().equals(cleon.projectmethods.hermes.spec.projectsteering.riskmanagement.assessments.analysis.AnalysisPackage.ImpactRate___W_);
  }
  
  @Override
  public boolean is__X_() {
    return getResource().equals(cleon.projectmethods.hermes.spec.projectsteering.riskmanagement.assessments.analysis.AnalysisPackage.ImpactRate___X_);
  }
  
  @Override
  public boolean is__Y_() {
    return getResource().equals(cleon.projectmethods.hermes.spec.projectsteering.riskmanagement.assessments.analysis.AnalysisPackage.ImpactRate___Y_);
  }
  
  @Override
  public boolean is__Z_() {
    return getResource().equals(cleon.projectmethods.hermes.spec.projectsteering.riskmanagement.assessments.analysis.AnalysisPackage.ImpactRate___Z_);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,68e06d85-2f01-11e6-8bd9-a77b8d2a3a0e,79VTh41SQnuX9g4OJJZMHaeK2JI=] */
