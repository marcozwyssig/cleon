...
public class RiskState extends DynamicResource implements IRiskState {
  ...
  public boolean isIn__F_Plan() {
    return getResource().equals(cleon.projectmethods.hermes.spec.projectsteering.riskmanagement.risks.RisksPackage.RiskState_In__F_Plan);
  }
  
  @Override
  public boolean isIn__F_Watchlist() {
    return getResource().equals(cleon.projectmethods.hermes.spec.projectsteering.riskmanagement.risks.RisksPackage.RiskState_In__F_Watchlist);
  }
  
  @Override
  public boolean isIn__F_Steering() {
    return getResource().equals(cleon.projectmethods.hermes.spec.projectsteering.riskmanagement.risks.RisksPackage.RiskState_In__F_Steering);
  }
  
  @Override
  public boolean isMaterialised() {
    return getResource().equals(cleon.projectmethods.hermes.spec.projectsteering.riskmanagement.risks.RisksPackage.RiskState_Materialised);
  }
  
  @Override
  public boolean isClosed() {
    return getResource().equals(cleon.projectmethods.hermes.spec.projectsteering.riskmanagement.risks.RisksPackage.RiskState_Closed);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,f854e5b5-324e-11e6-ab4d-73a9260c8088,AWT8E15FKYVtphVcDNMYbtzitFQ=] */
