...
public class RiskType extends DynamicResource implements IRiskType {
  ...
  public boolean isRisk() {
    return getResource().equals(cleon.projectmethods.hermes.spec.projectsteering.riskmanagement.risks.RisksPackage.RiskType_Risk);
  }
  
  @Override
  public boolean isChance() {
    return getResource().equals(cleon.projectmethods.hermes.spec.projectsteering.riskmanagement.risks.RisksPackage.RiskType_Chance);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,c8f9d029-3394-11e6-94cd-fbf6c8ccd08d,zX1++n9fW7Jo/y+DrNFP63Rvhd0=] */
