...
public class FunctionSpace_DocBook_Planning {
  ...
  public static interface IAbstractGoalsFunctions extends IDynamicResourceExtension {
    ...
    public List<cleon.projectmethods.hermes.spec.projectmanagement.planning.scope.deliverable.javamodel.IDeliverable> GetAllDeliverables();

    @IDynamicResourceExtension.MethodId("f5c6615e-2127-11e8-8246-67c1f1659098")
    public cleon.projectmethods.hermes.spec.projectmanagement.planning.goals.javamodel.IGoals GetGoals();
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,2cf3f1a9-c1d8-11e6-8517-1bc2821627a9,CDIDG8DwNVAwtNHp+OXq/UFDq34=] */
