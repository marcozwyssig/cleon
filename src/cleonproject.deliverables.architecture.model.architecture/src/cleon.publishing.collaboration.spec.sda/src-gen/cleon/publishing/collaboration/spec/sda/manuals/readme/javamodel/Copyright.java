...
public class Copyright extends DynamicResource implements ICopyright {
  ...
  public Copyright setChapters(java.util.List<? extends cleon.common.doc.doc.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public Copyright setDocumentElements(java.util.List<? extends cleon.common.doc.doc.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public Copyright setParagraphs(java.util.List<? extends cleon.common.doc.doc.spec.paragraph.javamodel.IParagraph> paragraphs) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,494f17e7-4e6d-11e5-a091-3f804edda9db,od7DKzJbbkpbphCHgPLxK/1tWmY=] */
