...
public class SampleBuildingBlock extends DynamicResource implements ISampleBuildingBlock {
  ...
  public java.util.List<? extends cleon.common.modularity.spec.buildingblock.javamodel.IDecomposite> selectDecompose() {
    return _getList(cleon.common.modularity.spec.buildingblock.javamodel.IDecomposite.class, cleon.collaboration.sample.arc42.Arc42Package.SampleBuildingBlock_decompose);
  }

  public SampleBuildingBlock setDecompose(java.util.List<? extends cleon.common.modularity.spec.buildingblock.javamodel.IDecomposite> decompose) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    // relations
    _acceptList(cleon.common.modularity.spec.buildingblock.javamodel.IDecomposite.class, cleon.collaboration.sample.arc42.Arc42Package.SampleBuildingBlock_decompose, visitor);
  ...
  public static cleon.collaboration.sample.arc42.javamodel.ISampleBuildingBlock selectToMeDecompose(cleon.common.modularity.spec.buildingblock.javamodel.IDecomposite object) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,a19c100c-4376-11e6-a9d7-97cf4f7c398b,uHSdkKpnmSOBGN27+jT2CBxO7e0=] */
