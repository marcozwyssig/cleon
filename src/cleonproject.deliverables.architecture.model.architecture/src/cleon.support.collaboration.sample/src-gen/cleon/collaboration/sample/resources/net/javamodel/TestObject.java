package cleon.collaboration.sample.resources.net.javamodel;
...
public class TestObject extends DynamicResource implements ITestObject {
  ...
  public java.net.URL selectUrl() {
    return _getSingleAttribute(java.net.URL.class, cleon.collaboration.sample.resources.net.NetPackage.TestObject_url);
  }
    
  public void setUrl(java.net.URL url) {
     _setSingleAttribute(cleon.collaboration.sample.resources.net.NetPackage.TestObject_url, url);
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingleAttribute(java.net.URL.class, cleon.collaboration.sample.resources.net.NetPackage.TestObject_url, visitor);
    // relations
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,5aaac29e-b791-11e6-85e2-39e149963066,HH8TpGY9H2i1kBOXBqes2xO1dCM=] */
