...
:render
echo now rendering
"%ProgramFiles(x86)%\DocumentGenerator\bin\render.exe" -z -t template.docx -L 2 -P -l=de-CH -f "Analyse_A.xml" ^
-D=Title:"Analyse_A" ^
-D=EAMod_Reviewers:""
...
REM Actifsource ID=[0498e2c9-3f84-11e6-85d8-3328a679e82b,77e5cb75-024b-11e6-9b87-a94a5128b9df,Tuc+7HTye467LebEZCeiJSC061I=]
