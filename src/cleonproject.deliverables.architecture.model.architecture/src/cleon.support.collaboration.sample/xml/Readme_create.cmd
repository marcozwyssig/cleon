...
:render
echo now rendering
"%ProgramFiles(x86)%\DocumentGenerator\bin\render.exe" -z -t template.docx -L 2 -P -l=de-CH -f "Readme.xml" ^
-D=Title:"Readme" ^
-D=EAMod_Reviewers:""
...
REM Actifsource ID=[0498e2c9-3f84-11e6-85d8-3328a679e82b,5f4255e5-4e6e-11e5-a091-3f804edda9db,kmhnDv5zI5YIq+V+cq1NIRvcljM=]
