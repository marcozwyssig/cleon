...
public class ProjectDistinction extends DynamicResource implements IProjectDistinction {
  ...
  public cleon.support.projectmanagement.spec.planning.javamodel.IPlanning selectProject() {
    return _getSingle(cleon.support.projectmanagement.spec.planning.javamodel.IPlanning.class, cleon.support.projectmanagement.spec.planning.constraints.ConstraintsPackage.Constraint_project);
  }

  public ProjectDistinction setProject(cleon.support.projectmanagement.spec.planning.javamodel.IPlanning project) {
    _setSingle(cleon.support.projectmanagement.spec.planning.constraints.ConstraintsPackage.Constraint_project, project);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(cleon.support.projectmanagement.spec.planning.javamodel.IPlanning.class, cleon.support.projectmanagement.spec.planning.constraints.ConstraintsPackage.Constraint_project, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IResource.class, ch.actifsource.core.CorePackage.Decorator_target, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,8ad64111-d42e-11e6-8a1d-7fdd5d29730e,qS4dD9AoVRt+WUnoY2wCkvdhK9Q=] */
