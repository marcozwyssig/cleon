...
public class Phase extends DynamicResource implements IPhase {
  ...
  public java.util.List<? extends cleon.support.projectmanagement.spec.planning.schedule.milestones.javamodel.IRelease> selectReleases() {
    return _getList(cleon.support.projectmanagement.spec.planning.schedule.milestones.javamodel.IRelease.class, cleon.support.projectmanagement.spec.planning.schedule.milestones.MilestonesPackage.Phase_releases);
  }

  public Phase setReleases(java.util.List<? extends cleon.support.projectmanagement.spec.planning.schedule.milestones.javamodel.IRelease> releases) {
    _setList(cleon.support.projectmanagement.spec.planning.schedule.milestones.MilestonesPackage.Phase_releases, releases);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptList(cleon.support.projectmanagement.spec.planning.schedule.milestones.javamodel.IRelease.class, cleon.support.projectmanagement.spec.planning.schedule.milestones.MilestonesPackage.Phase_releases, visitor);
  ...
  public static cleon.support.projectmanagement.spec.planning.schedule.milestones.javamodel.IPhase selectToMeReleases(cleon.support.projectmanagement.spec.planning.schedule.milestones.javamodel.IRelease object) {
    return _getToMeSingle(object.getRepository(), cleon.support.projectmanagement.spec.planning.schedule.milestones.javamodel.IPhase.class, cleon.support.projectmanagement.spec.planning.schedule.milestones.MilestonesPackage.Phase_releases, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,bcd1f820-d719-11e6-a422-8b5491da3f30,n82INwH1UF0s5ckYbKtQDS+O6o8=] */
