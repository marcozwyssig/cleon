...
public class WorkItemState extends DynamicResource implements IWorkItemState {
  ...
  public boolean isInput() {
    return getResource().equals(cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.BacklogPackage.WorkItemState_Input);
  }
  
  @Override
  public boolean isUnderstanding() {
    return getResource().equals(cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.BacklogPackage.WorkItemState_Understanding);
  }
  
  @Override
  public boolean isImplementing() {
    return getResource().equals(cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.BacklogPackage.WorkItemState_Implementing);
  }
  
  @Override
  public boolean isConfirming() {
    return getResource().equals(cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.BacklogPackage.WorkItemState_Confirming);
  }
  
  @Override
  public boolean isDone() {
    return getResource().equals(cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.BacklogPackage.WorkItemState_Done);
  }
  
  @Override
  public boolean isReadyForImplement() {
    return getResource().equals(cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.BacklogPackage.WorkItemState_ReadyForImplement);
  }
  
  @Override
  public boolean isReadyForConfirm() {
    return getResource().equals(cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.BacklogPackage.WorkItemState_ReadyForConfirm);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,b27abc8f-cb92-11e5-b911-69bd21f5af67,q8/zLw9lMxZWnhaM+y8fhCKMQro=] */
