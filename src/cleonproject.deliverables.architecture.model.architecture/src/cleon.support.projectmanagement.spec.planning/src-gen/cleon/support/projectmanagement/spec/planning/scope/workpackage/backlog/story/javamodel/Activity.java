...
public class Activity extends DynamicResource implements IActivity {
  ...
  public Activity setAnalysis(cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.javamodel.IText analysis) {
  ...
  public Activity setEstimate(cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.javamodel.IEffort estimate) {
  ...
  public Activity setPreconditions(java.util.List<? extends cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.javamodel.IWorkItem> preconditions) {
  ...
  public Activity setState(cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.javamodel.IWorkItemState state) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,e19c230e-3777-11e5-95d9-2b04d7ab02d9,eONgOM2W2o7gTeEa0G6W+KgRQHc=] */
