...
public class Constraint extends DynamicResource implements IConstraint {
  ...
  public Constraint setAnalysis(cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.javamodel.IText analysis) {
  ...
  public Constraint setEstimate(cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.javamodel.IEffort estimate) {
  ...
  public Constraint setPreconditions(java.util.List<? extends cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.javamodel.IWorkItem> preconditions) {
  ...
  public cleon.support.projectmanagement.spec.resource.persons.javamodel.IPerson selectRequestedBy() {
    return _getSingle(cleon.support.projectmanagement.spec.resource.persons.javamodel.IPerson.class, cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.story.StoryPackage.Story_requestedBy);
  }

  public Constraint setRequestedBy(cleon.support.projectmanagement.spec.resource.persons.javamodel.IPerson requestedBy) {
    _setSingle(cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.story.StoryPackage.Story_requestedBy, requestedBy);
    return this;
  }
  ...
  public Constraint setState(cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.javamodel.IWorkItemState state) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(cleon.support.projectmanagement.spec.resource.persons.javamodel.IPerson.class, cleon.support.projectmanagement.spec.planning.scope.workpackage.backlog.story.StoryPackage.Story_requestedBy, visitor);
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,d9e271ef-3777-11e5-95d9-2b04d7ab02d9,x8H5/FSFbVYhpfew1EfO6vOMgWA=] */
