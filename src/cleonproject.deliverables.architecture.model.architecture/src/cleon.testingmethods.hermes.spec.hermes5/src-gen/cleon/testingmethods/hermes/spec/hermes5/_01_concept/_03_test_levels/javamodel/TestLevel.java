...
public class TestLevel extends DynamicResource implements ITestLevel {
  ...
  public boolean isUnittest() {
    return getResource().equals(cleon.testingmethods.hermes.spec.hermes5._01_concept._03_test_levels._03_test_levelsPackage.TestLevel_Unittest);
  }
  
  @Override
  public boolean isUnitintegrationtest() {
    return getResource().equals(cleon.testingmethods.hermes.spec.hermes5._01_concept._03_test_levels._03_test_levelsPackage.TestLevel_Unitintegrationtest);
  }
  
  @Override
  public boolean isSystemtest() {
    return getResource().equals(cleon.testingmethods.hermes.spec.hermes5._01_concept._03_test_levels._03_test_levelsPackage.TestLevel_Systemtest);
  }
  
  @Override
  public boolean isSystemintegrationtest() {
    return getResource().equals(cleon.testingmethods.hermes.spec.hermes5._01_concept._03_test_levels._03_test_levelsPackage.TestLevel_Systemintegrationtest);
  }
  
  @Override
  public boolean isFAT() {
    return getResource().equals(cleon.testingmethods.hermes.spec.hermes5._01_concept._03_test_levels._03_test_levelsPackage.TestLevel_FAT);
  }
  
  @Override
  public boolean isSAT() {
    return getResource().equals(cleon.testingmethods.hermes.spec.hermes5._01_concept._03_test_levels._03_test_levelsPackage.TestLevel_SAT);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,4731eb51-5153-11e9-bb61-971a423d31e9,OKOHofpqKvg7d8+bYJUcqr2/x+0=] */
