package cleon.testingmethods.hermes.spec.hermes5._01_concept.test_constraints.failureclass.javamodel;
...
public class FailureClass extends DynamicResource implements IFailureClass {
  ...
  public boolean is__W___F___S___F_Unwesentlicher__F_Mangel() {
    return getResource().equals(cleon.testingmethods.hermes.spec.hermes5._01_concept.test_constraints.failureclass.FailureclassPackage.FailureClass___W___F___S___F_Unwesentlicher__F_Mangel);
  }
  
  @Override
  public boolean is__X___F___S___F_Leichter__F_Mangel() {
    return getResource().equals(cleon.testingmethods.hermes.spec.hermes5._01_concept.test_constraints.failureclass.FailureclassPackage.FailureClass___X___F___S___F_Leichter__F_Mangel);
  }
  
  @Override
  public boolean is__Y___F___S___F_Schwerer__F_Mangel() {
    return getResource().equals(cleon.testingmethods.hermes.spec.hermes5._01_concept.test_constraints.failureclass.FailureclassPackage.FailureClass___Y___F___S___F_Schwerer__F_Mangel);
  }
  
  @Override
  public boolean is__Z___F___S___F_Kritischer__F_Mangel() {
    return getResource().equals(cleon.testingmethods.hermes.spec.hermes5._01_concept.test_constraints.failureclass.FailureclassPackage.FailureClass___Z___F___S___F_Kritischer__F_Mangel);
  }
