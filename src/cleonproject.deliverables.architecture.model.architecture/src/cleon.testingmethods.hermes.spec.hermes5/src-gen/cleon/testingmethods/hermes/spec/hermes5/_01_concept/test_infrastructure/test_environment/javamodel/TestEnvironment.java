...
public class TestEnvironment extends DynamicResource implements ITestEnvironment {
  ...
  @Override
  public cleon.architecturemethods.itarc42.spec.itarc42.deployment_view.environment.javamodel.IEnvironment selectEnvironmentView() {
    return _getSingle(cleon.architecturemethods.itarc42.spec.itarc42.deployment_view.environment.javamodel.IEnvironment.class, cleon.testingmethods.hermes.spec.hermes5._01_concept.test_infrastructure.test_environment.Test_environmentPackage.TestEnvironment_environmentView);
  }

  public TestEnvironment setEnvironmentView(cleon.architecturemethods.itarc42.spec.itarc42.deployment_view.environment.javamodel.IEnvironment environmentView) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    // relations
    _acceptSingle(cleon.architecturemethods.itarc42.spec.itarc42.deployment_view.environment.javamodel.IEnvironment.class, cleon.testingmethods.hermes.spec.hermes5._01_concept.test_infrastructure.test_environment.Test_environmentPackage.TestEnvironment_environmentView, visitor);
  ...
  public static java.util.List<cleon.testingmethods.hermes.spec.hermes5._01_concept.test_infrastructure.test_environment.javamodel.ITestEnvironment> selectToMeEnvironmentView(cleon.architecturemethods.itarc42.spec.itarc42.deployment_view.environment.javamodel.IEnvironment object) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,8dd0a331-6761-11e9-9ec9-5fbc84faaeb1,yKgf6xFgVhENBJvriiBVkR5didY=] */
