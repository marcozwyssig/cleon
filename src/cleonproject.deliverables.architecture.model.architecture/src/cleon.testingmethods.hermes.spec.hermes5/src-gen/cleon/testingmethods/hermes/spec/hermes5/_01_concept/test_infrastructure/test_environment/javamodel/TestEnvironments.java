...
public class TestEnvironments extends DynamicResource implements ITestEnvironments {
  ...
  public TestEnvironments setChapters(java.util.List<? extends cleon.common.doc.doc.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public TestEnvironments setDocumentElements(java.util.List<? extends cleon.common.doc.doc.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public TestEnvironments setNoChapters(cleon.common.doc.doc.spec.chapter.javamodel.IAbstractChapter noChapters) {
  ...
  public TestEnvironments setParagraphs(java.util.List<? extends cleon.common.doc.doc.spec.paragraph.javamodel.IParagraph> paragraphs) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,0681f04a-eabf-11e5-838a-6dbe7118dd11,tLBq5X6sT4mpG0O71wyi+E9xDWQ=] */
