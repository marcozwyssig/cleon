...
public class TestLevels extends DynamicResource implements ITestLevels {
  ...
  public TestLevels setChapters(java.util.List<? extends cleon.common.doc.doc.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public TestLevels setDocumentElements(java.util.List<? extends cleon.common.doc.doc.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public TestLevels setParagraphs(java.util.List<? extends cleon.common.doc.doc.spec.paragraph.javamodel.IParagraph> paragraphs) {
    _setList(cleon.common.doc.doc.spec.chapter.ChapterPackage.ParagraphAware_paragraphs, paragraphs);
    return this;
  }
    
  @Override
  public java.util.Map<ch.actifsource.core.Resource, ? extends cleon.testingmethods.hermes.spec.hermes5._01_concept.test_levels.javamodel.ITestLevelUsage> selectTestLevels() {
    return _getMap(cleon.testingmethods.hermes.spec.hermes5._01_concept.test_levels.javamodel.ITestLevelUsage.class, cleon.testingmethods.hermes.spec.hermes5._01_concept.test_levels.Test_levelsPackage.TestLevels_testLevels);
  }

  public TestLevels setTestLevels(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.testingmethods.hermes.spec.hermes5._01_concept.test_levels.javamodel.ITestLevelUsage> testLevels) {
    _setMap(cleon.testingmethods.hermes.spec.hermes5._01_concept.test_levels.Test_levelsPackage.TestLevels_testLevels, testLevels);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptMap(cleon.testingmethods.hermes.spec.hermes5._01_concept.test_levels.javamodel.ITestLevelUsage.class, cleon.testingmethods.hermes.spec.hermes5._01_concept.test_levels.Test_levelsPackage.TestLevels_testLevels, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

  // toMeRelations
  
  public static cleon.testingmethods.hermes.spec.hermes5._01_concept.test_levels.javamodel.ITestLevels selectToMeTestLevels(cleon.testingmethods.hermes.spec.hermes5._01_concept.test_levels.javamodel.ITestLevelUsage object) {
    return _getToMeSingle(object.getRepository(), cleon.testingmethods.hermes.spec.hermes5._01_concept.test_levels.javamodel.ITestLevels.class, cleon.testingmethods.hermes.spec.hermes5._01_concept.test_levels.Test_levelsPackage.TestLevels_testLevels, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,9de9654b-264b-11e6-ae54-e50d44645ae7,4dYUKUCr1CuvEx7lyRexqTNoCXI=] */
