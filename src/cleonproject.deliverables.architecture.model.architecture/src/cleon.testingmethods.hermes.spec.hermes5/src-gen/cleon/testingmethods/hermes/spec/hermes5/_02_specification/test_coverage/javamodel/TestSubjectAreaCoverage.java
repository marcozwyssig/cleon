...
public class TestSubjectAreaCoverage extends DynamicResource implements ITestSubjectAreaCoverage {
  ...
  public TestSubjectAreaCoverage setChapters(java.util.List<? extends cleon.common.doc.doc.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public TestSubjectAreaCoverage setDocumentElements(java.util.List<? extends cleon.common.doc.doc.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public TestSubjectAreaCoverage setParagraphs(java.util.List<? extends cleon.common.doc.doc.spec.paragraph.javamodel.IParagraph> paragraphs) {
    _setList(cleon.common.doc.doc.spec.chapter.ChapterPackage.ParagraphAware_paragraphs, paragraphs);
    return this;
  }
    
  @Override
  public java.util.Map<ch.actifsource.core.Resource, ? extends cleon.testingmethods.hermes.spec.hermes5._02_specification.test_coverage.javamodel.ITestRequirementCoverage> selectRequirementCoverage() {
    return _getMap(cleon.testingmethods.hermes.spec.hermes5._02_specification.test_coverage.javamodel.ITestRequirementCoverage.class, cleon.testingmethods.hermes.spec.hermes5._02_specification.test_coverage.Test_coveragePackage.TestSubjectAreaCoverage_requirementCoverage);
  }

  public TestSubjectAreaCoverage setRequirementCoverage(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.testingmethods.hermes.spec.hermes5._02_specification.test_coverage.javamodel.ITestRequirementCoverage> requirementCoverage) {
    _setMap(cleon.testingmethods.hermes.spec.hermes5._02_specification.test_coverage.Test_coveragePackage.TestSubjectAreaCoverage_requirementCoverage, requirementCoverage);
    return this;
  }
  ...
  public static cleon.testingmethods.hermes.spec.hermes5._02_specification.test_coverage.javamodel.ITestSubjectAreaCoverage selectToMeRequirementCoverage(cleon.testingmethods.hermes.spec.hermes5._02_specification.test_coverage.javamodel.ITestRequirementCoverage object) {
    return _getToMeSingle(object.getRepository(), cleon.testingmethods.hermes.spec.hermes5._02_specification.test_coverage.javamodel.ITestSubjectAreaCoverage.class, cleon.testingmethods.hermes.spec.hermes5._02_specification.test_coverage.Test_coveragePackage.TestSubjectAreaCoverage_requirementCoverage, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,2498cbe6-5169-11e9-bb61-971a423d31e9,WBopsI5ViKl+ezHu85PmSDCHyKA=] */
