...
public class DynamicTestDependencyPrecondition extends DynamicResource implements IDynamicTestDependencyPrecondition {
  ...
  @Override
  public cleon.testingmethods.hermes.spec.hermes5._02_specification.test_specification._dynamic.javamodel.IDynamicTest selectDependsOn() {
    return _getSingle(cleon.testingmethods.hermes.spec.hermes5._02_specification.test_specification._dynamic.javamodel.IDynamicTest.class, cleon.testingmethods.hermes.spec.hermes5._02_specification.test_precondition.Test_preconditionPackage.DynamicTestDependencyPrecondition_dependsOn);
  }

  public DynamicTestDependencyPrecondition setDependsOn(cleon.testingmethods.hermes.spec.hermes5._02_specification.test_specification._dynamic.javamodel.IDynamicTest dependsOn) {
    _setSingle(cleon.testingmethods.hermes.spec.hermes5._02_specification.test_precondition.Test_preconditionPackage.DynamicTestDependencyPrecondition_dependsOn, dependsOn);
    return this;
  }
  ...
  public static java.util.List<cleon.testingmethods.hermes.spec.hermes5._02_specification.test_precondition.javamodel.IDynamicTestDependencyPrecondition> selectToMeDependsOn(cleon.testingmethods.hermes.spec.hermes5._02_specification.test_specification._dynamic.javamodel.IDynamicTest object) {
    return _getToMeList(object.getRepository(), cleon.testingmethods.hermes.spec.hermes5._02_specification.test_precondition.javamodel.IDynamicTestDependencyPrecondition.class, cleon.testingmethods.hermes.spec.hermes5._02_specification.test_precondition.Test_preconditionPackage.DynamicTestDependencyPrecondition_dependsOn, object.getResource());
  }
