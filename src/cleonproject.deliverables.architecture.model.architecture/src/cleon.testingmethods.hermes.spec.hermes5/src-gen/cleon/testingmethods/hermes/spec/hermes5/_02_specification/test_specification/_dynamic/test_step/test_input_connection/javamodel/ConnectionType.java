...
public class ConnectionType extends DynamicResource implements IConnectionType {
  ...
  public boolean isRDP() {
    return getResource().equals(cleon.testingmethods.hermes.spec.hermes5._02_specification.test_specification._dynamic.test_step.test_input_connection.Test_input_connectionPackage.ConnectionType_RDP);
  }
  
  @Override
  public boolean isSSH() {
    return getResource().equals(cleon.testingmethods.hermes.spec.hermes5._02_specification.test_specification._dynamic.test_step.test_input_connection.Test_input_connectionPackage.ConnectionType_SSH);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,fbcfa2cf-6ce5-11e9-a6d3-775c09e81e2d,QDGph4/kxZNBM0BdxLv8AHhYv/4=] */
