package cleon.testingmethods.hermes.spec.hermes5._03_execution.test_execution;
...
public class FunctionSpace_Test_Execution {
  ...
  public static interface ITestResultFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("0057e3c8-20dd-11e6-9368-9172b77c2cff")
    public java.lang.Boolean IsPassed(final cleon.testingmethods.hermes.spec.hermes5._03_execution.test_execution.javamodel.ITestResult testResult);
  ...
  public static class TestResultFunctionsImpl implements ITestResultFunctionsImpl {
    ...
    public java.lang.Boolean IsPassed(final cleon.testingmethods.hermes.spec.hermes5._03_execution.test_execution.javamodel.ITestResult testResult) {
      /* Begin Protected Region [[0057e3c8-20dd-11e6-9368-9172b77c2cff]] */
        if( testResult instanceof cleon.testingmethods.hermes.spec.hermes5._03_execution.test_execution.javamodel.ITestSuccess)
        {
      	return true;  
        }
        return false;   
  ...
  public static class TestResultFunctions {
    ...
    public static java.lang.Boolean IsPassed(final cleon.testingmethods.hermes.spec.hermes5._03_execution.test_execution.javamodel.ITestResult testResult) {
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,103de61d-20da-11e6-9368-9172b77c2cff,xYgmryqxVL78Alglq+CkL2Z74zA=] */
