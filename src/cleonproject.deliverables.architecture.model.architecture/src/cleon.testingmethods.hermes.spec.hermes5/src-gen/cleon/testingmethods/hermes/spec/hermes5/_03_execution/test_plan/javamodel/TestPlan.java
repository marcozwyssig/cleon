...
public class TestPlan extends DynamicResource implements ITestPlan {
  ...
  public TestPlan setChapters(java.util.List<? extends cleon.common.doc.doc.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public TestPlan setDocumentElements(java.util.List<? extends cleon.common.doc.doc.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public TestPlan setParagraphs(java.util.List<? extends cleon.common.doc.doc.spec.paragraph.javamodel.IParagraph> paragraphs) {
  ...
  public cleon.testingmethods.hermes.spec.hermes5._03_execution.test_plan.test_scheduling.javamodel.ITestScheduling selectTestScheduling() {
    return _getSingle(cleon.testingmethods.hermes.spec.hermes5._03_execution.test_plan.test_scheduling.javamodel.ITestScheduling.class, cleon.testingmethods.hermes.spec.hermes5._03_execution.test_plan.Test_planPackage.TestPlan_testScheduling);
  }

  public TestPlan setTestScheduling(cleon.testingmethods.hermes.spec.hermes5._03_execution.test_plan.test_scheduling.javamodel.ITestScheduling testScheduling) {
    _setSingle(cleon.testingmethods.hermes.spec.hermes5._03_execution.test_plan.Test_planPackage.TestPlan_testScheduling, testScheduling);
    return this;
  }
    
  @Override
  public cleon.testingmethods.hermes.spec.hermes5._03_execution.test_plan.test_scope.javamodel.ITestScope selectTestScope() {
    return _getSingle(cleon.testingmethods.hermes.spec.hermes5._03_execution.test_plan.test_scope.javamodel.ITestScope.class, cleon.testingmethods.hermes.spec.hermes5._03_execution.test_plan.Test_planPackage.TestPlan_testScope);
  }

  public TestPlan setTestScope(cleon.testingmethods.hermes.spec.hermes5._03_execution.test_plan.test_scope.javamodel.ITestScope testScope) {
    _setSingle(cleon.testingmethods.hermes.spec.hermes5._03_execution.test_plan.Test_planPackage.TestPlan_testScope, testScope);
    return this;
  }
  ...
  public static cleon.testingmethods.hermes.spec.hermes5._03_execution.test_plan.javamodel.ITestPlan selectToMeTestScope(cleon.testingmethods.hermes.spec.hermes5._03_execution.test_plan.test_scope.javamodel.ITestScope object) {
    return _getToMeSingle(object.getRepository(), cleon.testingmethods.hermes.spec.hermes5._03_execution.test_plan.javamodel.ITestPlan.class, cleon.testingmethods.hermes.spec.hermes5._03_execution.test_plan.Test_planPackage.TestPlan_testScope, object.getResource());
  }
  
  public static cleon.testingmethods.hermes.spec.hermes5._03_execution.test_plan.javamodel.ITestPlan selectToMeTestScheduling(cleon.testingmethods.hermes.spec.hermes5._03_execution.test_plan.test_scheduling.javamodel.ITestScheduling object) {
    return _getToMeSingle(object.getRepository(), cleon.testingmethods.hermes.spec.hermes5._03_execution.test_plan.javamodel.ITestPlan.class, cleon.testingmethods.hermes.spec.hermes5._03_execution.test_plan.Test_planPackage.TestPlan_testScheduling, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,8bf93951-eabe-11e5-838a-6dbe7118dd11,VKb5+x/QsUjo1lVEkXnr4SSD1C0=] */
