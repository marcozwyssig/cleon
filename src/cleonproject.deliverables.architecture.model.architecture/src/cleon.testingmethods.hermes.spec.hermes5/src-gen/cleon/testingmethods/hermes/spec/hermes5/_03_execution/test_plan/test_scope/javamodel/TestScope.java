...
public class TestScope extends DynamicResource implements ITestScope {
  ...
  public TestScope setChapters(java.util.List<? extends cleon.common.doc.doc.spec.chapter.javamodel.IAbstractChapter> chapters) {
  ...
  public TestScope setDocumentElements(java.util.List<? extends cleon.common.doc.doc.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public TestScope setParagraphs(java.util.List<? extends cleon.common.doc.doc.spec.paragraph.javamodel.IParagraph> paragraphs) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,4ca652f8-9184-11e9-97b2-b9ddd2a0520b,CrMBdUzLfRlXhUiUFancqWz5/yQ=] */
