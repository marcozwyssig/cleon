...
public class ServiceDekomposition extends DynamicResource implements IServiceDekomposition {
  ...
  public ServiceDekomposition setDescription(java.util.List<? extends cleon.doc.spec.chapter.paragraph.javamodel.ITextParagraph> description) {
  ...
  public ServiceDekomposition setParagraphes(java.util.List<? extends cleon.doc.spec.chapter.paragraph.javamodel.IParagraph> paragraphes) {
