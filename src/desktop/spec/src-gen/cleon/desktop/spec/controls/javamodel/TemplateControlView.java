...
public class TemplateControlView extends DynamicResource implements ITemplateControlView {
  ...
  public TemplateControlView setBindingPattern(cleon.desktop.spec.mvvm.binding.javamodel.IBinding bindingPattern) {
  ...
  public TemplateControlView setChapters(java.util.List<? extends cleon.doc.spec.chapter.javamodel.IChapter> chapters) {
  ...
  public TemplateControlView setCustomEvents(java.util.List<? extends cleon.uml.spec.structural.classes.events.javamodel.ICustomEvent> customEvents) {
  ...
  public TemplateControlView setDecompose(java.util.List<? extends cleon.arc42.spec._05_buildingblockview.javamodel.IDecomposite> decompose) {
  ...
  public TemplateControlView setDescription(java.util.List<? extends cleon.doc.spec.chapter.paragraph.javamodel.ITextParagraph> description) {
  ...
  public TemplateControlView setEvents(java.util.List<? extends cleon.uml.spec.structural.classes.events.javamodel.IEvent> events) {
  ...
  public TemplateControlView setExtends(cleon.desktop.spec.mvvm.javamodel.IView extends_) {
  ...
  public TemplateControlView setFieldEvents(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.uml.spec.structural.classes.events.javamodel.IEventForField> fieldEvents) {
  ...
  public TemplateControlView setFields(java.util.List<? extends cleon.uml.spec.structural.classes.fields.javamodel.IField> fields) {
  ...
  public TemplateControlView setHasDependency(java.util.List<? extends cleon.arc42.spec._05_buildingblockview.javamodel.IDependency> hasDependency) {
  ...
  public TemplateControlView setMethods(java.util.List<? extends cleon.uml.spec.structural.classes.method.javamodel.IMethod> methods) {
  ...
  public TemplateControlView setOwnDocumentElements(java.util.List<? extends cleon.doc.spec.javamodel.IDocumentElement> ownDocumentElements) {
  ...
  public TemplateControlView setParagraphes(java.util.List<? extends cleon.doc.spec.chapter.paragraph.javamodel.IParagraph> paragraphes) {
  ...
  public TemplateControlView setRelations(java.util.List<? extends cleon.uml.spec.structural.classes.association.javamodel.IAssociation> relations) {
  ...
  public TemplateControlView setViewModel(cleon.desktop.spec.mvvm.javamodel.IViewModelDependency viewModel) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,594575f1-634e-11e3-9288-bdf1907ca1e3,hqy0SzdBiHFwluBB0BXlHiBOkKk=] */
