...
public class UserControlView extends DynamicResource implements IUserControlView {
  ...
  public UserControlView setBindingPattern(cleon.desktop.spec.mvvm.binding.javamodel.IBinding bindingPattern) {
  ...
  public UserControlView setChapters(java.util.List<? extends cleon.doc.spec.chapter.javamodel.IChapter> chapters) {
  ...
  public UserControlView setCustomEvents(java.util.List<? extends cleon.uml.spec.structural.classes.events.javamodel.ICustomEvent> customEvents) {
  ...
  public UserControlView setDecompose(java.util.List<? extends cleon.arc42.spec._05_buildingblockview.javamodel.IDecomposite> decompose) {
  ...
  public UserControlView setDescription(java.util.List<? extends cleon.doc.spec.chapter.paragraph.javamodel.ITextParagraph> description) {
  ...
  public UserControlView setEvents(java.util.List<? extends cleon.uml.spec.structural.classes.events.javamodel.IEvent> events) {
  ...
  public UserControlView setExtends(cleon.desktop.spec.mvvm.javamodel.IView extends_) {
  ...
  public UserControlView setFieldEvents(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.uml.spec.structural.classes.events.javamodel.IEventForField> fieldEvents) {
  ...
  public UserControlView setFields(java.util.List<? extends cleon.uml.spec.structural.classes.fields.javamodel.IField> fields) {
  ...
  public UserControlView setHasDependency(java.util.List<? extends cleon.arc42.spec._05_buildingblockview.javamodel.IDependency> hasDependency) {
  ...
  public UserControlView setMethods(java.util.List<? extends cleon.uml.spec.structural.classes.method.javamodel.IMethod> methods) {
  ...
  public UserControlView setOwnDocumentElements(java.util.List<? extends cleon.doc.spec.javamodel.IDocumentElement> ownDocumentElements) {
  ...
  public UserControlView setParagraphes(java.util.List<? extends cleon.doc.spec.chapter.paragraph.javamodel.IParagraph> paragraphes) {
  ...
  public UserControlView setRelations(java.util.List<? extends cleon.uml.spec.structural.classes.association.javamodel.IAssociation> relations) {
  ...
  public UserControlView setViewModel(cleon.desktop.spec.mvvm.javamodel.IViewModelDependency viewModel) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,4947868f-634e-11e3-9288-bdf1907ca1e3,rKjHRIFI+NDhZhPHCaiuxw8erSc=] */
