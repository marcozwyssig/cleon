...
public class ForwardProperty extends DynamicResource implements IForwardProperty {
  ...
  public void setIsReadOnly(java.lang.Boolean isReadOnly) {
     _setSingleAttribute(cleon.desktop.spec.mvvm.MvvmPackage.ForwardProperty_isReadOnly, isReadOnly);
  }
  ...
  @Override
  public cleon.uml.spec.structural.classes.fields.javamodel.IField selectField() {
    return _getSingle(cleon.uml.spec.structural.classes.fields.javamodel.IField.class, cleon.desktop.spec.mvvm.MvvmPackage.ForwardProperty_field);
  }

  public ForwardProperty setField(cleon.uml.spec.structural.classes.fields.javamodel.IField field) {
    _setSingle(cleon.desktop.spec.mvvm.MvvmPackage.ForwardProperty_field, field);
    return this;
  }
  ...
  public static java.util.List<cleon.desktop.spec.mvvm.javamodel.IForwardProperty> selectToMeField(cleon.uml.spec.structural.classes.fields.javamodel.IField object) {
    return _getToMeList(object.getRepository(), cleon.desktop.spec.mvvm.javamodel.IForwardProperty.class, cleon.desktop.spec.mvvm.MvvmPackage.ForwardProperty_field, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,623e0e7c-c0c2-11e4-b2f2-bbf951b71ec4,SOCtJedmdDJvggtD7qPK3WHafQs=] */
