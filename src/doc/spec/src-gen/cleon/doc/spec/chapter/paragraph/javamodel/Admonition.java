...
public class Admonition extends DynamicResource implements IAdmonition {
  ...
  public java.util.List<? extends cleon.doc.spec.chapter.paragraph.javamodel.IParagraph> selectPararaphs() {
    return _getList(cleon.doc.spec.chapter.paragraph.javamodel.IParagraph.class, cleon.doc.spec.chapter.paragraph.ParagraphPackage.Admonition_pararaphs);
  }

  public Admonition setPararaphs(java.util.List<? extends cleon.doc.spec.chapter.paragraph.javamodel.IParagraph> pararaphs) {
    _setList(cleon.doc.spec.chapter.paragraph.ParagraphPackage.Admonition_pararaphs, pararaphs);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptList(cleon.doc.spec.chapter.paragraph.javamodel.IParagraph.class, cleon.doc.spec.chapter.paragraph.ParagraphPackage.Admonition_pararaphs, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

  // toMeRelations
  
  public static cleon.doc.spec.chapter.paragraph.javamodel.IAdmonition selectToMePararaphs(cleon.doc.spec.chapter.paragraph.javamodel.IParagraph object) {
    return _getToMeSingle(object.getRepository(), cleon.doc.spec.chapter.paragraph.javamodel.IAdmonition.class, cleon.doc.spec.chapter.paragraph.ParagraphPackage.Admonition_pararaphs, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,6e2a6478-308a-11e5-8cdc-d5b441c8c3df,pwv14E6rp36sEVIZ1Vt/dLrK2XU=] */
