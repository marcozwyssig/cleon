...
public class Column extends DynamicResource implements IColumn {
  ...
  public java.lang.String selectWidth() {
    return _getSingleAttribute(java.lang.String.class, cleon.doc.spec.chapter.paragraph.table.TablePackage.Column_width);
  }
    
  public void setWidth(java.lang.String width) {
     _setSingleAttribute(cleon.doc.spec.chapter.paragraph.table.TablePackage.Column_width, width);
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingleAttribute(java.lang.String.class, cleon.doc.spec.chapter.paragraph.table.TablePackage.Column_width, visitor);
    // relations
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,06fe17d8-3c4a-11e5-871f-6beac6a7c24b,Z9zziN/liKBrCiW9GyTwV06zGn4=] */
