...
public class NamedDocument extends DynamicResource implements INamedDocument {
  ...
  public NamedDocument setChapters(java.util.List<? extends cleon.doc.spec.chapter.javamodel.IChapter> chapters) {
  ...
  public NamedDocument setDocuments(java.util.List<? extends cleon.doc.spec.document.javamodel.IDocument> documents) {
  ...
  public NamedDocument setParagraphes(java.util.List<? extends cleon.doc.spec.chapter.paragraph.javamodel.IParagraph> paragraphes) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,3e870b86-d86d-11e4-aa2f-c11242a92b60,nN2PJ2dj4yevrJ2iKz798qhWHqs=] */
