...
public class NoSubDocuments extends DynamicResource implements INoSubDocuments {

  public static final ch.actifsource.core.dynamic.IDynamicResource.IFactory<INoSubDocuments> FACTORY = new ch.actifsource.core.dynamic.IDynamicResource.IFactory<INoSubDocuments>() {
    
    @Override
    public INoSubDocuments create() {
      return new NoSubDocuments();
    }
    
    @Override
    public INoSubDocuments create(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
      return new NoSubDocuments(resourceRepository, resource);
    }
  
  };

  public NoSubDocuments() {
    super(INoSubDocuments.TYPE_ID);
  }
  
  public NoSubDocuments(IDynamicResourceRepository resourceRepository, ch.actifsource.core.Resource resource) {
  ...
  public NoSubDocuments setChapters(java.util.List<? extends cleon.doc.spec.chapter.javamodel.IChapter> chapters) {
  ...
  public NoSubDocuments setDocuments(java.util.List<? extends cleon.doc.spec.document.javamodel.IDocument> documents) {
  ...
  public NoSubDocuments setNoDocuments(cleon.doc.spec.document.javamodel.IDocument noDocuments) {
  ...
  public NoSubDocuments setOwnDocumentElements(java.util.List<? extends cleon.doc.spec.javamodel.IDocumentElement> ownDocumentElements) {
  ...
  public NoSubDocuments setParagraphes(java.util.List<? extends cleon.doc.spec.chapter.paragraph.javamodel.IParagraph> paragraphes) {
  ...
  public NoSubDocuments setTypeOf(ch.actifsource.core.javamodel.IClass typeOf) {
  ...
  public NoSubDocuments setUseDocumentElements(java.util.List<? extends cleon.doc.spec.javamodel.IDocumentElement> useDocumentElements) {
  ...
  public static cleon.doc.spec.document.javamodel.INoSubDocuments selectToMeNoDocuments(cleon.doc.spec.document.javamodel.IDocument object) {
