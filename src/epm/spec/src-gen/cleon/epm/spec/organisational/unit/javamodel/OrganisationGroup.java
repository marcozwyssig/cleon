...
public class OrganisationGroup extends DynamicResource implements IOrganisationGroup {
  ...
  public OrganisationGroup setResponsible(cleon.epm.spec.organisational.role.javamodel.ILeader responsible) {
  ...
  public OrganisationGroup setStaff(java.util.List<? extends cleon.epm.spec.organisational.role.javamodel.IStaff> staff) {
  ...
  public OrganisationGroup setSubOrganisations(java.util.List<? extends cleon.epm.spec.organisational.unit.javamodel.IOrganisationUnit> subOrganisations) {
  ...
  public static cleon.epm.spec.organisational.unit.javamodel.IOrganisationGroup selectToMeSubOrganisations(cleon.epm.spec.organisational.unit.javamodel.IOrganisationUnit object) {
    return _getToMeSingle(object.getRepository(), cleon.epm.spec.organisational.unit.javamodel.IOrganisationGroup.class, cleon.epm.spec.organisational.unit.UnitPackage.OrganisationGroup_subOrganisations, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,a7b9016a-ba7b-11e3-9206-f19b78f4aff0,GO21TFVrQ2aJVnAG6bHNukAFdxg=] */
