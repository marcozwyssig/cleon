...
public class Purchase extends DynamicResource implements IPurchase {
  ...
  public Purchase setResponsible(cleon.bpmn.spec.organisational.role.javamodel.IRole responsible) {
  ...
  public Purchase setStaff(java.util.List<? extends cleon.bpmn.spec.organisational.role.javamodel.IRole> staff) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,260c5fdb-daa9-11e3-ae07-89aa80d5ec3d,KBMlHqoAuRVzFOciuBtSeSKa8V8=] */
