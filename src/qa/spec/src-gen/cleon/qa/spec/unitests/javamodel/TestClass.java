...
public class TestClass extends DynamicResource implements ITestClass {
  ...
  public TestClass setDescription(java.util.List<? extends cleon.doc.spec.paragraph.javamodel.ITextParagraph> description) {
  ...
  @Override
  public IMultiMapOrdered<ch.actifsource.core.Resource, ? extends cleon.qa.spec.unitests.javamodel.ITestMethod> selectTestMethods() {
    return _getMultiMap(cleon.qa.spec.unitests.javamodel.ITestMethod.class, cleon.qa.spec.unitests.UnitestsPackage.TestClass_testMethods);
  }

  public TestClass setTestMethods(IMultiMapOrdered<ch.actifsource.core.Resource, ? extends cleon.qa.spec.unitests.javamodel.ITestMethod> testMethods) {
    _setMultiMap(cleon.qa.spec.unitests.UnitestsPackage.TestClass_testMethods, testMethods);
    return this;
  }
    
  @Override
  public IMultiMapOrdered<ch.actifsource.core.Resource, ? extends cleon.qa.spec.unitests.javamodel.ITestProperty> selectTestProperties() {
    return _getMultiMap(cleon.qa.spec.unitests.javamodel.ITestProperty.class, cleon.qa.spec.unitests.UnitestsPackage.TestClass_testProperties);
  }

  public TestClass setTestProperties(IMultiMapOrdered<ch.actifsource.core.Resource, ? extends cleon.qa.spec.unitests.javamodel.ITestProperty> testProperties) {
    _setMultiMap(cleon.qa.spec.unitests.UnitestsPackage.TestClass_testProperties, testProperties);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptMultiMap(cleon.qa.spec.unitests.javamodel.ITestMethod.class, cleon.qa.spec.unitests.UnitestsPackage.TestClass_testMethods, visitor);
    _acceptMultiMap(cleon.qa.spec.unitests.javamodel.ITestProperty.class, cleon.qa.spec.unitests.UnitestsPackage.TestClass_testProperties, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

  // toMeRelations
  
  public static cleon.qa.spec.unitests.javamodel.ITestClass selectToMeTestMethods(cleon.qa.spec.unitests.javamodel.ITestMethod object) {
    return _getToMeSingle(object.getRepository(), cleon.qa.spec.unitests.javamodel.ITestClass.class, cleon.qa.spec.unitests.UnitestsPackage.TestClass_testMethods, object.getResource());
  }
  
  public static cleon.qa.spec.unitests.javamodel.ITestClass selectToMeTestProperties(cleon.qa.spec.unitests.javamodel.ITestProperty object) {
    return _getToMeSingle(object.getRepository(), cleon.qa.spec.unitests.javamodel.ITestClass.class, cleon.qa.spec.unitests.UnitestsPackage.TestClass_testProperties, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,c17728d0-df47-11e2-b229-cd1bd4a07953,5+Sm3WZV7y24Uk2N7bqcVn0NnZQ=] */
