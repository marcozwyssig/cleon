...
public class DefectFeatureGroup extends DynamicResource implements IDefectFeatureGroup {
  ...
  public java.util.List<? extends cleon.sda.spec.projectmanagement.scope.backlog.defect.javamodel.IDefect> selectDefects() {
    return _getList(cleon.sda.spec.projectmanagement.scope.backlog.defect.javamodel.IDefect.class, cleon.sda.spec.projectmanagement.scope.backlog.BacklogPackage.DefectFeatureGroup_defects);
  }
  ...
  public DefectFeatureGroup setDefects(java.util.List<? extends cleon.sda.spec.projectmanagement.scope.backlog.defect.javamodel.IDefect> defects) {
    _setList(cleon.sda.spec.projectmanagement.scope.backlog.BacklogPackage.DefectFeatureGroup_defects, defects);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    // relations
    _acceptList(cleon.sda.spec.projectmanagement.scope.backlog.defect.javamodel.IDefect.class, cleon.sda.spec.projectmanagement.scope.backlog.BacklogPackage.DefectFeatureGroup_defects, visitor);
  ...
  public static cleon.sda.spec.projectmanagement.scope.backlog.javamodel.IDefectFeatureGroup selectToMeDefects(cleon.sda.spec.projectmanagement.scope.backlog.defect.javamodel.IDefect object) {
    return _getToMeSingle(object.getRepository(), cleon.sda.spec.projectmanagement.scope.backlog.javamodel.IDefectFeatureGroup.class, cleon.sda.spec.projectmanagement.scope.backlog.BacklogPackage.DefectFeatureGroup_defects, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,d243a7a6-369e-11e5-95d9-2b04d7ab02d9,H9ntNv+5kE/C1w751F9Ufln28aM=] */
