...
public class State extends DynamicResource implements IState {
  ...
  public boolean isOpen() {
    return getResource().equals(cleon.sda.spec.requirementmanagement.requirements.RequirementsPackage.State_Open);
  }
  
  @Override
  public boolean isIn__F_Progress() {
    return getResource().equals(cleon.sda.spec.requirementmanagement.requirements.RequirementsPackage.State_In__F_Progress);
  }
  
  @Override
  public boolean isDone() {
    return getResource().equals(cleon.sda.spec.requirementmanagement.requirements.RequirementsPackage.State_Done);
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,db79c858-294d-11e5-b035-b579d7e91534,EKM5/phomgIASmmgdcu+NFKpmfs=] */
