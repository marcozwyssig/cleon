...
public class UserStory extends DynamicResource implements IUserStory {
  ...
  public UserStory setAnalysis(cleon.sdp.spec.project.backlog.javamodel.IText analysis) {
  ...
  public UserStory setDescription(cleon.sdp.spec.project.backlog.javamodel.IText description) {
  ...
  public UserStory setRequestedBy(cleon.sdp.spec.project.javamodel.IPerson requestedBy) {
  ...
  public cleon.sdp.spec.requirements.javamodel.IRequirement selectRequirement() {
    return _getSingle(cleon.sdp.spec.requirements.javamodel.IRequirement.class, cleon.sdp.spec.project.backlog.story.StoryPackage.UserStory_requirement);
  }

  public UserStory setRequirement(cleon.sdp.spec.requirements.javamodel.IRequirement requirement) {
    _setSingle(cleon.sdp.spec.project.backlog.story.StoryPackage.UserStory_requirement, requirement);
    return this;
  }
  ...
  public UserStory setSprint(cleon.sdp.spec.project.release.javamodel.ISprint sprint) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(cleon.sdp.spec.requirements.javamodel.IRequirement.class, cleon.sdp.spec.project.backlog.story.StoryPackage.UserStory_requirement, visitor);
  ...
  public static java.util.List<cleon.sdp.spec.project.backlog.story.javamodel.IUserStory> selectToMeRequirement(cleon.sdp.spec.requirements.javamodel.IRequirement object) {
    return _getToMeList(object.getRepository(), cleon.sdp.spec.project.backlog.story.javamodel.IUserStory.class, cleon.sdp.spec.project.backlog.story.StoryPackage.UserStory_requirement, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,693cc9f9-ff9c-11e4-ac0a-959b440f987f,lmQEaoM0TkaggzRkXdNABeb80qc=] */
