...
public class FeatureGroupComposite extends DynamicResource implements IFeatureGroupComposite {
  ...
  public java.util.List<? extends cleon.sdp.spec.projectmanagement.backlog.javamodel.IFeatureGroup> selectSubfeatureGroup() {
    return _getList(cleon.sdp.spec.projectmanagement.backlog.javamodel.IFeatureGroup.class, cleon.sdp.spec.projectmanagement.backlog.BacklogPackage.FeatureGroupComposite_subfeatureGroup);
  }

  public FeatureGroupComposite setSubfeatureGroup(java.util.List<? extends cleon.sdp.spec.projectmanagement.backlog.javamodel.IFeatureGroup> subfeatureGroup) {
    _setList(cleon.sdp.spec.projectmanagement.backlog.BacklogPackage.FeatureGroupComposite_subfeatureGroup, subfeatureGroup);
    return this;
  }
  ...
  public FeatureGroupComposite setWorkItems(java.util.List<? extends cleon.sdp.spec.projectmanagement.backlog.javamodel.IWorkItem> workItems) {
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    // relations
    _acceptList(cleon.sdp.spec.projectmanagement.backlog.javamodel.IFeatureGroup.class, cleon.sdp.spec.projectmanagement.backlog.BacklogPackage.FeatureGroupComposite_subfeatureGroup, visitor);
  ...
  public static cleon.sdp.spec.projectmanagement.backlog.javamodel.IFeatureGroupComposite selectToMeSubfeatureGroup(cleon.sdp.spec.projectmanagement.backlog.javamodel.IFeatureGroup object) {
    return _getToMeSingle(object.getRepository(), cleon.sdp.spec.projectmanagement.backlog.javamodel.IFeatureGroupComposite.class, cleon.sdp.spec.projectmanagement.backlog.BacklogPackage.FeatureGroupComposite_subfeatureGroup, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,66562d7f-369c-11e5-95d9-2b04d7ab02d9,kKqGucqQp++2qD4W5f+3gexb4Vc=] */
