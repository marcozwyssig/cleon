...
public class Activity extends DynamicResource implements IActivity {
  ...
  public Activity setAnalysis(cleon.sdp.spec.projectmanagement.backlog.javamodel.IText analysis) {
  ...
  public Activity setDescription(cleon.sdp.spec.projectmanagement.backlog.javamodel.IText description) {
  ...
  public Activity setOwner(cleon.sdp.spec.projectmanagement.javamodel.IPerson owner) {
  ...
  public Activity setRequestedBy(cleon.sdp.spec.projectmanagement.javamodel.IPerson requestedBy) {
  ...
  public Activity setSprint(cleon.sdp.spec.projectmanagement.release.javamodel.ISprint sprint) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,e19c230e-3777-11e5-95d9-2b04d7ab02d9,ZM5gQKI9Rc2CrUW05jYplxRMOQQ=] */
