...
public class Constraint extends DynamicResource implements IConstraint {
  ...
  public Constraint setAnalysis(cleon.sdp.spec.projectmanagement.backlog.javamodel.IText analysis) {
  ...
  public Constraint setDescription(cleon.sdp.spec.projectmanagement.backlog.javamodel.IText description) {
  ...
  public Constraint setOwner(cleon.sdp.spec.projectmanagement.javamodel.IPerson owner) {
  ...
  public Constraint setRequestedBy(cleon.sdp.spec.projectmanagement.javamodel.IPerson requestedBy) {
  ...
  public Constraint setSprint(cleon.sdp.spec.projectmanagement.release.javamodel.ISprint sprint) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,d9e271ef-3777-11e5-95d9-2b04d7ab02d9,e/doY7AWVs2aJ1Izr7AFiFsyhd8=] */
