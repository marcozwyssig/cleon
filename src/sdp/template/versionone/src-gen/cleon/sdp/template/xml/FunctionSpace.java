...
public class FunctionSpace {
  ...
  public static interface IReproducibilityFunctionsImpl extends IDynamicResourceExtensionJavaImpl {
    ...
    @IDynamicResourceExtension.MethodId("2077d5cf-376f-11e5-95d9-2b04d7ab02d9")
    public List<java.lang.String> RenderContent(final cleon.sdp.spec.projectmanagement.backlog.defect.javamodel.IReproducibility reproducibility);
  ...
  public static class ReproducibilityFunctions {
    ...
    public static List<java.lang.String> RenderContent(final cleon.sdp.spec.projectmanagement.backlog.defect.javamodel.IReproducibility reproducibility) {
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,d17ca089-375d-11e5-95d9-2b04d7ab02d9,ZavVJJGQnJDsZ8Mxm4pDWhndeQo=] */
