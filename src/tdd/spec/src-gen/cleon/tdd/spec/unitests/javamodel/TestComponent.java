...
public class TestComponent extends DynamicResource implements ITestComponent {
  ...
  public cleon.tdd.spec.unitests.javamodel.ITestComponentDependency selectComponentUnderTest() {
    return _getSingle(cleon.tdd.spec.unitests.javamodel.ITestComponentDependency.class, cleon.tdd.spec.unitests.UnitestsPackage.TestComponent_componentUnderTest);
  }

  public TestComponent setComponentUnderTest(cleon.tdd.spec.unitests.javamodel.ITestComponentDependency componentUnderTest) {
    _setSingle(cleon.tdd.spec.unitests.UnitestsPackage.TestComponent_componentUnderTest, componentUnderTest);
    return this;
  }
  ...
  public TestComponent setDescription(java.util.List<? extends cleon.doc.spec.paragraph.javamodel.ITextParagraph> description) {
  ...
  public java.util.Map<ch.actifsource.core.Resource, ? extends cleon.tdd.spec.unitests.javamodel.ITestPackageDecomposition> selectTestPackages() {
    return _getMap(cleon.tdd.spec.unitests.javamodel.ITestPackageDecomposition.class, cleon.tdd.spec.unitests.UnitestsPackage.TestComponent_testPackages);
  }

  public TestComponent setTestPackages(java.util.Map<ch.actifsource.core.Resource, ? extends cleon.tdd.spec.unitests.javamodel.ITestPackageDecomposition> testPackages) {
    _setMap(cleon.tdd.spec.unitests.UnitestsPackage.TestComponent_testPackages, testPackages);
    return this;
  }
  ...
  public void accept(IPropertyValueVisitor visitor) {
    ...
    _acceptSingle(cleon.tdd.spec.unitests.javamodel.ITestComponentDependency.class, cleon.tdd.spec.unitests.UnitestsPackage.TestComponent_componentUnderTest, visitor);
    ...
    _acceptMap(cleon.tdd.spec.unitests.javamodel.ITestPackageDecomposition.class, cleon.tdd.spec.unitests.UnitestsPackage.TestComponent_testPackages, visitor);
    _acceptSingle(ch.actifsource.core.javamodel.IClass.class, ch.actifsource.core.CorePackage.Resource_typeOf, visitor);
  }

  // toMeRelations
  
  public static cleon.tdd.spec.unitests.javamodel.ITestComponent selectToMeTestPackages(cleon.tdd.spec.unitests.javamodel.ITestPackageDecomposition object) {
    return _getToMeSingle(object.getRepository(), cleon.tdd.spec.unitests.javamodel.ITestComponent.class, cleon.tdd.spec.unitests.UnitestsPackage.TestComponent_testPackages, object.getResource());
  }
  
  public static cleon.tdd.spec.unitests.javamodel.ITestComponent selectToMeComponentUnderTest(cleon.tdd.spec.unitests.javamodel.ITestComponentDependency object) {
    return _getToMeSingle(object.getRepository(), cleon.tdd.spec.unitests.javamodel.ITestComponent.class, cleon.tdd.spec.unitests.UnitestsPackage.TestComponent_componentUnderTest, object.getResource());
  }
  
}
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,a5ae6ce6-df47-11e2-b229-cd1bd4a07953,CMLX0oLgTrJz95IFDZjFjDGJBK8=] */
