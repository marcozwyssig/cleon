...
public class FunctionSpace {
  ...
  public static interface IStateMachineFunctions extends IDynamicResourceExtension {
    ...
    public List<cleon.uml.spec.behavioral.statemachine.javamodel.IState> GetStates();
...
/* Actifsource ID=[5349246f-db37-11de-82b8-17be2e034a3b,8a042bd0-345d-11e5-909a-4bcced25d7ee,Tq8aIbxAISLLPxeqMd29PWXYkBQ=] */
