...
public class EventForField extends DynamicResource implements IEventForField {
  ...
  public EventForField setDescription(java.util.List<? extends cleon.doc.spec.paragraph.javamodel.ITextParagraph> description) {
  ...
  public EventForField setNoChapters(cleon.doc.spec.chapter.javamodel.IChapter noChapters) {
  ...
  public EventForField setParagraphes(java.util.List<? extends cleon.doc.spec.paragraph.javamodel.IParagraph> paragraphes) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,1b6f35fa-7fc7-11e4-842a-1924f269f20b,ynHxa6LDQdKglzaUL+smLnbM5c4=] */
