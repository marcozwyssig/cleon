...
public class NamedComponentComposition extends DynamicResource implements INamedComponentComposition {
  ...
  public NamedComponentComposition setDescription(java.util.List<? extends cleon.doc.spec.chapter.paragraph.javamodel.ITextParagraph> description) {
  ...
  public NamedComponentComposition setParagraphes(java.util.List<? extends cleon.doc.spec.chapter.paragraph.javamodel.IParagraph> paragraphes) {
