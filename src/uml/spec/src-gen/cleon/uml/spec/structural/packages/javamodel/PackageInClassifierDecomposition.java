...
public class PackageInClassifierDecomposition extends DynamicResource implements IPackageInClassifierDecomposition {
  ...
  public PackageInClassifierDecomposition setDescription(java.util.List<? extends cleon.doc.spec.chapter.paragraph.javamodel.ITextParagraph> description) {
  ...
  public PackageInClassifierDecomposition setParagraphes(java.util.List<? extends cleon.doc.spec.chapter.paragraph.javamodel.IParagraph> paragraphes) {
