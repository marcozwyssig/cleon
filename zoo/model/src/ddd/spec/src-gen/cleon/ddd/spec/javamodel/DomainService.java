...
public class DomainService extends DynamicResource implements IDomainService {
  ...
  public DomainService setChapters(java.util.List<? extends cleon.doc.spec.javamodel.IChapter> chapters) {
  ...
  public DomainService setDocumentElements(java.util.List<? extends cleon.doc.spec.javamodel.IDocumentElement> documentElements) {
  ...
  public DomainService setOwnDecompositions(java.util.List<? extends cleon.arc42.spec._05_buildingblockview.javamodel.IBuildingBlock> ownDecompositions) {
  ...
  public DomainService setUseDecompositions(java.util.List<? extends cleon.arc42.spec._05_buildingblockview.javamodel.IUseBuildingBlock> useDecompositions) {
...
/* Actifsource ID=[4d723cb5-db37-11de-82b8-17be2e034a3b,9d00b1dd-a37b-11e3-9113-ffc7f11b0a42,oMUptpQtrXpirJh2Se9xOQlhIDQ=] */
